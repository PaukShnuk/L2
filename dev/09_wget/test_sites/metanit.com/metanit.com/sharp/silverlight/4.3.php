...
<html >
<head>
<title>Текстовые элементы в Silverlight</title>
<meta charset="utf-8" />
<meta name="description" content="Текстовые элементы в Silverlight - TextBlock и TextBox и их использование">
...
<h2>Текстовые элементы в Silverlight</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<h3>TextBlock</h3>
<p>Элемент предназначен для вывода текстовой информации и по своему функционалу напоминает простую метку. 
Для изменения параметров отображаемого текста данный элемент имеет такие свойства, как <span class="bb">LineHeight</span>, <span class="bb">TextWrapping</span> и <strong>TextAllignment</strong>.
<p><b>LineHeight</b> указывает на высоту строк.</p>
<p><b>TextWrapping</b> позволяет переносить текст при установке этого свойства <code>TextWrapping="Wrap"</code>. По умолчанию текст не переносится.</p>
<p><b>TextAllignment</b> выравнивает текст по центру, правому или левому краю.</p>
<p>Для форматирования текста используется свойство <span class="bb">TextDecorations</span>, например, если <code>TextDecorations="Underline"</code>, то текст будет подчеркнут.</p>
<p>С помощью  свойства <span class="bb">MaxLength</span> можно задать максимальное количество символов.</p>
<p>Хотя текст элемента можно задать с помощью свойства Text, для сложного форматирования текста можно использовать встроенные элементы форматирования 
текста, такие как <span class="bb">Bold</span>, <span class="bb">Run</span>, <span class="bb">LineBreak</span>. Например,</p>
<pre class="brush:xml;">
...
<img src="silpics/4.4.jpg" />
<p>Чтобы создать подобный пример в коде, нам пришлось бы написать следующий код:</p>
<pre class="brush:c#;">
...
<h3>TextBox</h3>
<p>Элемент представляет поле для ввода текстовой информации. Он также имеет свойства <span class="bb">TextWrapping</span>,<span class="bb">MaxLength</span>, <span class="bb">TextAllignment</span> и <span class="bb">TextDecorations</span>.</p>
...
<p>После установки свойства <span class="bb">AcceptsReturn</span>="True" TextBox будет поддерживать клавишу Enter, а после установки свойства <span class="bb">AcceptsTab</span>="True" - клавишу Tab и станет возможным создавать длинные пробелы.
Чтобы элемент был доступен только для чтения, надо установить свойство <span class="bb">IsReadOnly</span>="True".</p>
<p>Для управления выделением текста есть свойства <span class="bb">SelectionStart</span>, <span class="bb">SelectionLength</span> и <span class="bb">SelectionText</span>. </p>
<h3>PasswordBox</h3>
<p>Элемент предназначен для ввода парольной информации. Свойство <span class="bb">PasswordChar</span> устанавливает символ, отображаемый при вводе пароля. 
