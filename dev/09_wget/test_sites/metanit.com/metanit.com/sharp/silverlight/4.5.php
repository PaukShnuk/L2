...
<html >
<head>
<title>Элементы, основанные на диапазонах значений</title>
<meta charset="utf-8" />
<meta name="description" content="Описание элементов Slider и ProgressBar и их использование для хранения и отображения числовых данных">
...
<h2>Элементы, основанные на диапазонах значений</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Данный класс элементов управления представлен элементами ScrollBar, ProgressBar, Slider. 
Они хранят и отображают числовые данные на определенном диапазоне.</p>
<p>Все они являются наследниками класса <span class="bb">RangeBase</span>, поэтому наследуют такие его свойства, как:</p>
<ul>
<li><p><span class="bb">Value</span> указывает на текущее значение элемента (представлено типом <code>Double</code>)</p></li>
<li><p><span class="bb">Maximum</span>/<span class="bb">Minimum</span> указывает на максимальное/минимальное значение элемента</p></li>
</ul>
<p>При изменении значения возникает событие <code>ValueChanged</code>. Его синтаксис: </p>
<pre class="brush: c#;">
private void slider1_ValueChanged(object sender, RoutedPropertyChangedEventArgs&lt;double&gt; e)
{}
 </pre>
 <h3>Slider</h3>
 <p>Представляет собой обычный ползунок. С помощью свойства Orientation можно задать вертикальное или горизонтальное расположение ползунка.</p>
<h3>ProgressBar</h3>
<p>Индикатор, отображающий выполнение определенного процесса. 
Также имеет свойство <span class="bb">Orientation</span>, указывающее вертикальное или горизонтальное расположение индикатора. 
Для связи с реальными процессами вся логика изменения индикатора, его свойства Value должна отрабатываться в коде.</p>
<pre class="brush:xml;">
