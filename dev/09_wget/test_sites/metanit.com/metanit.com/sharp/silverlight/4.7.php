...
<meta charset="utf-8" />
<meta name="description" content="Рассмотрение элемента image и его использование для вывода и манипуляции изображениями">
...
<h2>Работа с изображениями</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<h3>Image</h3>
<p>Для вывода изображений на экран предназначен элемент Image. С помощью свойства <span class="bb">Source</span> можно задать путь к изображению.
</p>
<p>Также элемент позвляет проводить некоторые простейшие транформации с изображениями. Например, с помощью объекта <span class="bb">FormatConvertedBitmap</span> и его свойства <span class="bb">DestinationFormat</span> можно получить новое изображение:</p>
<pre class="brush:xml;">
&lt;Image&gt;
    &lt;Image.Source&gt;
        &lt;FormatConvertedBitmap Source="D:\Exp\Photos\SL731815.jpg"  
        DestinationFormat="Gray32Float" /&gt;    
    &lt;/Image.Source&gt;
&lt;/Image&gt;</pre>
<img src="silpics/4.18.jpg" />
...
<div class="nav"><p><a href="4.6.php">Назад</a><a href="./">Содержание</a><a href="5.php">Вперед</a></p></div></div>
<div class="socBlock">
