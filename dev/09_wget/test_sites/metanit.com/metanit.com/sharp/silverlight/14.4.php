...
<html >
<head>
<title>Silverlight 5 Toolkit</title>
<meta charset="utf-8" />
<meta name="description" content="Описание работы и установки Silverlight 5 Toolkit для создания трехмерных объектов">
...
<h2>Silverlight 5 Toolkit</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для разработки трехмерной графики в помощью программистам в рамках open-source проекта был содан инструмент под названием Silverlight 5 Toolkit. 
Его можно найти на сайте <a href="http://silverlight.codeplex.com/">http://silverlight.codeplex.com/</a>. Этот тулкит имеет несколько шаблонов 
для 3D проектов. Загрузите его и установите. Перед установкой убедитесь, что соблюдены все предварительные требования: должны быть установлена XNA 4.0 
Game Studio, пакет обновления SP1, Silverlight 5 Tools for Visual Studio.</p>
<p>Также надо учесть, что для установки Silverlight 5 Toolkit лучше использовать полнофункциональную версию Visual Studio 2010, 
например, Professional или Ultimate. На Web Developer 2010 Express тулкит ряд ли будет работать, по крайней мере у меня не получилось его установить на 
экспресс-версию после целого дня шаманских танцев с бубном.</p>
<p>После установки тулкита вы должны быть установлены следующие файлы шаблонов:</p>
<ul>
<li><p>Silverlight3dApp.zip</p></li>
<li><p>Silverlight3dLib.zip</p></li>
<li><p>Silverlight Unit Test Project.zip</p></li>
</ul>
<p>Теперь откройте Visual Studio 2010 и вы увидите новые шаблоны проектов:</p>
<img src="silpics/14.8.jpg" />
<p>Кроме того, вы можете наряду с шаблонами найти в каталоге, куда 
установился тулкит, примеры кода с использованием 3D, в частности с использованием своих вершинных и пиксельных шейдеров и применением моделей. 
А с моделями гораздо легче работать, чем создавать сложные объекты из таких примитивов, как линии и треугольники.  
Вообщем Silverlight 5 Toolkit дает довольно большие возможности по созданию трехмерного контента в приложениях Silverlight.</p>
...
<div class="nav"><p><a href="14.3.php">Назад</a><a href="./">Содержание</a><a href="">Вперед</a></p></div></div>
<div class="socBlock">
