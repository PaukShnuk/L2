...
<html >
<head>
<title>Canvas в Windows Phone 8.1</title>
<meta charset="utf-8" />
...
<h2>Canvas</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Контейнер Canvas является наиболее простым контейнером. Для размещения внутри Canvas надо указать для элементов точные координаты. 
Для установки координат элементов применяются свойства <span class="bb">Canvas.Left</span> (отступ от левого края контейнера) и 
<span class="bb">Canvas.Top</span> (отступ от верхнего края контейнера).</p>
...
<img src="pics/3.5.png" alt="Canvas in Windows Phone 8.1" />
<p>Кроме координат для позиционирования Canvas позволяет определить свойство <span class="bb">Canvas.ZIndex</span>, которое указывает на порядок следования 
элементов по виртуальной оси z. В примере выше, хотя желтая кнопка определена после зеленой, 
но зеленая ее частично перекрывает, так как у ней выше значение свойства <code>Canvas.ZIndex</code>.</p>
