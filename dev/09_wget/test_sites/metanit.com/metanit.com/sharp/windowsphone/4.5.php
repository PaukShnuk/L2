...
<html >
<head>
<title>ComboBox в Windows Phone 8.1</title>
<meta charset="utf-8" />
...
<h2>ComboBox</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>ComboBox представляет выпадающий список. Каждый элемент этого списка является объектом ComboBoxItems:</p>
<pre class="brush:xml;">
&lt;ComboBox&gt;
    &lt;ComboBoxItem&gt;Windows Phone 8.1&lt;/ComboBoxItem&gt;
    &lt;ComboBoxItem&gt;Android 5.0 Lollipop&lt;/ComboBoxItem&gt;
    &lt;ComboBoxItem&gt;iOS 8&lt;/ComboBoxItem&gt;
&lt;/ComboBox&gt;
</pre>
<img src="pics/4.11.png" alt="ComboBox in Windows Phone 8.1" />
<p>Обрабатывая событие <code>SelectionChanged</code>, мы можем динамически получать выделенный элемент:</p>
<pre class="brush:xml;">
&lt;StackPanel&gt;
    &lt;ComboBox PlaceholderText="Выбрать платформу" SelectionChanged="ComboBox_Selected"&gt;
...
private void ComboBox_Selected(object sender, RoutedEventArgs e)
{
    ...
    textBlock1.Text=selectedItem.Content.ToString();
}
</pre>
<h3>ComboBoxItem</h3>
<p>В предыдущем примере ComboBoxItem содержал текст, однако так как это элемент управления содержимым, то он может включать в себя и другие элементы. Например:</p>
<pre class="brush:xml;">
&lt;ComboBox&gt;
