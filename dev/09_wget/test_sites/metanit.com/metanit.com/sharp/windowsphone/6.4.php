...
<html >
<head>
<title>Файл Package.appxmanifest в Windows Phone 8.1</title>
<meta charset="utf-8" />
...
<h2>Файл Package.appxmanifest</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Файл <b>Package.appxmanifest</b> описывает метаданные приложения, например, название приложения, какая икона у этого приложения будет на стартовом экране и т.д.</p>
<p>Формально он представляет xml-файл, однако если мы его откроем, к нашему удобству он будет представлен в виде графической формы для редактирования:</p>
<img src="pics/6.1.png" />
<p>Package.appxmanifest имеет семь блоков-вкладок, которые позволяют задавать конфигурацию приложения:</p>
<ul>
<li><p>Application - задает общие настройки, такие, как название приложения, язык, предпочтительные форматы и т.д.</p></li>
<li><p>Visual Assets - позволяет задать иконки, логотипы и изображения для отображения на стартовом экране ОС Windows Phone</p>
<img src="pics/6.2.png" />
</li>
<li><p>Вкладка Requirements позволяет установить требования к запуску приложения: наличие задней и фронтальной камеры, NFS и т.д. Например, если приложение использует камеру, то при ее отсутствии не имеет смысла использовать 
приложение.</p>
<img src="pics/6.3.png" /></li>
<li><p>Вкладка Capabilities содержит набор функциональностей, которые могут быть использованы приложением. Однако при работе с этими функциональностями 
приложение запросит у пользователя разрешения для их использования, так как эти функциональности связаны с работой с личной информацией.</p>
<img src="pics/6.4.png" /></li>
<li><p>Вкладка Declarations позволяет задать для операционной системы запуск отдельных функций приложения. Например, запускать приложения раз в час.</p>
<img src="pics/6.5.png" /></li>
<li><p>Вкладка Content URIs задает адреса ресурсов, с которыми будет взаимодействовать приложение</p></li>
<li><p>И вкладка Packaging устанавливает информацию о пакете</p>
<img src="pics/6.6.png" />
<p>Название пакета задается в виде значения GUID, которое позволяет уникально идентифицировать приложение среди множества других. Хотя разработчик также может 
задать и другое название.</p></li>
</ul>
...
<div class="nav"><p><a href="6.3.php">Назад</a><a href="./">Содержание</a><a href="7.1.php">Вперед</a></p></div></div>
<div class="socBlock">
