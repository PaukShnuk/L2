...
<html >
<head>
<title>Изменение шаблона WebView App в Windows Phone 8.1</title>
<meta charset="utf-8" />
...
<h2>Изменение шаблона WebView App</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Возьмем созданный в прошлой теме проект и изменим страницу <i>index.html</i> следующим образом:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь был добавлен элемент ссылки для перехода на страницу 2. Ее пока нет в проекте, и поэтому добавим в проект в папку Html. Для этого нажмем правой кнопкой мыши 
на папку Html и выберем в появившемся меню Add-&gt;New Item и окне добавления нового элемента выберем пункт <span class="bb">Html Page</span>:</p>
<img src="pics/9.4.png" />
<p>Назовем ее <i>page2.html</i>, и после этого в проект в каталог Html будет добавлена страница page2.html с некоторым содержанием по умолчанию. Создадим на 
второй странице какое-нибудь простенькое содержимое, например, мини-игру.</p>
<p>И для начала добавим в проект в библиотеку jQuery, которая может нам понадобится. Для этого нажмем на узел References правой кнопкой мыши и в появившемся контекстном меню 
выберем пункт <span class="bb">Manage Nuget Packages...</span>. В окне поиска пакетного менеджера введем jquery, найдем нужную нам библиотеку и установим ее.</p>
<img src="pics/9.5.png" />
<p>После установки в проект будет добавлена папка Scripts, в которой можно будет найти стандартную и минимизированную версию библиотеки jquery. Вырежем эту папку 
из корня проекта и вставим ее в каталог Html:</p>
<img src="pics/9.6.png" />
<p>Теперь изменим содержимое страницы page2.html следующим образом:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Суть игры, создаваемой на этой странице - за минимальное время найти все числа по порядку по возрастанию.</p>
<p>Запустим игру на устройстве и попробуем найти по порядку все числа:</p>
<img src="pics/9.7.png" />
...
<div class="nav"><p><a href="9.1.php">Назад</a><a href="./">Содержание</a><a href="10.1.php">Вперед</a></p></div></div>
<div class="socBlock">
