...
<html >
<head>
<title>StackPanel в Windows Phone 8.1</title>
<meta charset="utf-8" />
...
<h2>StackPanel</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>StackPanel располагает все элементы в ряд либо по горизонтали, либо по вертикали в зависимости от ориентации. Например, расположим элементы по вертикали:</p>
<pre class="brush:xml;">
&lt;Page
   ...
   &lt;Grid&gt;
        &lt;StackPanel HorizontalAlignment="Center"&gt;
            &lt;Button Background="Blue" Content="Blue" Width="200" /&gt;
            &lt;Button Background="White" Content="White" Foreground="Black" Width="200" /&gt;
            &lt;Button Background="Red" Content="Red" Width="200" /&gt;
        &lt;/StackPanel&gt;
    &lt;/Grid&gt;
&lt;/Page&gt;
</pre>
<img src="pics/3.3.png" alt="StackPanel in Windows Phone 8.1" />
<p>По умолчанию свойство Orientation элемента StackPanel использует значение Vertical, то есть создается вертикальный ряд, в который помещаются все 
вложенные элементы сверху вниз. Мы также можем задать горизонтальный стек. Для этого нам надо указать свойство Orientation="Horizontal":</p>
<pre class="brush:xml;">
&lt;StackPanel Orientation="Horizontal" VerticalAlignment="Top" HorizontalAlignment="Center"&gt;
    &lt;Button Background="Blue" Content="Blue" Width="100" /&gt;
    &lt;Button Background="White" Content="White" Foreground="Black" Width="100" /&gt;
    &lt;Button Background="Red" Content="Red" Width="100" /&gt;
&lt;/StackPanel&gt;
</pre>
<img src="pics/3.4.png" alt="Горизонтальный StackPanel" />
<p>По умолчанию при горизонтальной ориентации все элементы располагаются слева направо. Если мы хотим, чтобы наполнение стека начиналось справа налево, 
то нам надо задать свойство FlowDirection: <code>&lt;StackPanel Orientation="Horizontal" FlowDirection="RightToLeft"&gt;</code>. 
По умолчанию это свойство имеет значение LeftToRight, то есть слева направо.</p>
