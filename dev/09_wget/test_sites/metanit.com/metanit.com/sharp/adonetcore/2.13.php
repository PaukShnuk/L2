...
<html >
<head>
<title>ADO.NET и MS SQL Server | Сохранение и извлечение файлов из базы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Сохранение и извлечение файлов из базы данных MS SQL Server в ADO.NET и C#, varbinary">
...
<h2>Сохранение и извлечение файлов из базы данных</h2><div class="date">Последнее обновление: 11.02.2021</div>
...
<h3>Создание базы данных и таблицы для ханения файлов</h3>
<p>Рассмотрим, как мы можем сохранять файлы, в частности, файлы изображений в базу данных. Для этого создадим новую базу данных и в ней новую таблицу 
Files с четырьмя столбцами:</p>
<ul>
<li><p>Id  - первичный ключ и идентификатор, имеет тип int)
<li><p>FileName будет хранить имя файла и имеет тип nvarchar</p></li>
<li><p>Title будет хранить заголовок файла и также имеет тип nvarchar</p></li>
<li><p>ImageData будет содержать бинарные данные файла и имеет тип varbinary(MAX)</p></li>
</ul>
...
<img src="./pics/1.6.png" alt="Сохранение изображений в базе данных MS SQL Server в C# и .NET" />
...
<img src="./pics/1.7.png" alt="Извлечение файлов из базе данных MS SQL Server в C# и .NET" />
