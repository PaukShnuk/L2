...
<html >
<head>
<title>Редактирование и удаление пользователей в HelpDesk</title>
<meta charset="utf-8" />
<meta name="description" content="Редактирование и удаление пользователей в приложении HelpDesk в asp.net mvc">
...
<h2>Редактирование и удаление пользователей</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>И, наконец, добавим функцию удаления и редактирования пользователей. Добавим в контроллер UserController следующие методы:</p>
<pre class="brush:c#;">
[HttpGet]
...
<p>Оба действия также доступны только администратору. При передаче ролей в представление мы передаем в качестве четвертого параметра в 
конструктор SelectList текущее значение данного свойства объекта User: <code>new SelectList(db.Roles, "Id", "Name", user.RoleId)</code>.</p>
<p>Представление <i>Edit.cshtml</i> буде выглядеть таким образом:</p>
<pre class="brush:xml;">
