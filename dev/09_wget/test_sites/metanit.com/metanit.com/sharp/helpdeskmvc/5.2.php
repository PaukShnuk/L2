...
<html >
<head>
<title>Создание активов в HelpDesk</title>
<meta charset="utf-8" />
...
<h2>Создание активов</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Модель актива представляет у нас кабинет, связанный с определенным отделом. Итак, добавим в контроллер ServiceController следующие методы:</p>
<pre class="brush:c#;">
[HttpGet]
...
<p>Общая логика работы похожа на ту, что мы сделали для отделов. И для действия Activ добавим представление <i>Activ.cshtml</i>:</p>
<pre class="brush:xml;">
@model Activ
...
<p>Тут простейший код, в принципе все то же самое, что и в случае с отделами, только добавляется связанный список отделов.</p>
