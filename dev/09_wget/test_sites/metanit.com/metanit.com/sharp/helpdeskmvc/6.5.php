...
<html >
<head>
<title>Администрирование заявок в HelpDesk</title>
<meta charset="utf-8" />
<meta name="description" content="Просмотр админом всех заявок в приложении helpdesk на asp.net mvc, вывод всей информации в представление">
...
<h2>Просмотр админом всех заявок</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>У нас администратор, как и все другие пользователи, могут создавать заявки по определенной проблеме. И как пользователь, он может просматривать свои 
заявки. Однако почему бы ему, как администратору, также не просматривать заявки всех остальных? Добавим подобную функцию. По сути тут мало что 
будет отличаться от связки метод Index + представление Index.cshtml. Добавим в контроллер RequestController метод RequestList:</p>
<pre class="brush:c#;">
...
<p>Представление будет примерно таким же, как и Index.cshtml, только уберем возможность удаления:</p>
<pre class="brush:xml;">
