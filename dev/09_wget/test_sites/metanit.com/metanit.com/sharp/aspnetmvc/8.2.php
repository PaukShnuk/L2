...
<html >
<head>
<title>ASP.NET Core MVC и C# | Передача данных во View Component</title>
<meta charset="utf-8" />
<meta name="description" content="Передача параметров и dependency injection во View Component в ASP.NET Core MVC и C#">
...
<h2>Передача данных во View Component</h2><div class="date">Последнее обновление: 05.04.2022</div>
...
<p>View Component может извне получаит различные данные. Во-первых, View Component может принимать некоторые параметры, которые ему передаются при вызове 
...
<p>В методе Invoke компонент принимает один параметр - <span class="b">includeSeconds</span>, который представляет тип bool. Если этот параметр равен true, то строка со временем также содерджит секунды, 
...
<img src="./pics/8.3.png" alt="Параметры в View Component в ASP.NET Core MVC и C#" />
...
<img src="./pics/8.4.png" alt="Передача параметров в компонент представления View Component в ASP.NET Core MVC и C#" />

<p>При необходимости для параметров во View Component можно устанавить значения по умолчанию:</p>
<pre class="brush:c#;">
using Microsoft.AspNetCore.Mvc;
...
<img src="./pics/8.5.png" alt="Значения по умолчанию для параметров в View Component в ASP.NET Core" />
<h3>Передача сложных данных в View Component</h3>
<p>При этом View Component может принимать более сложные данные. Например, определим в проекте папку <span class="b">Models</span> следующий класс <span class="b">Person</span>:</p>
<pre class="brush:c#;">
...
<p>В папке <span class="b">Components</span> определим новый View Component - класс <span class="b">PersonInfoViewComponent</span>:</p>
<pre class="brush:c#;">
...
<p>Данный компонент принимает объкт Person и возвращает его данные в виде строки.</p>
...
<img src="./pics/8.6.png" alt="Передача сложных данных в View Component в ASP.NET Core MVC и C#" />
<h3>Внедрение зависимостей</h3>
<p>Как и другие классы, View Component может получать внеденные в приложение зависимости.</p>
<p>Например, в файле <span class="b">Program.cs</span> определен следующий код:</p>
<pre class="brush:c#;">
...
<p>Здесь добавляется сервис ITimeService в виде класса SimpleTimeService.</p>
<p>Используем этот сервис и для этого изменим код компонента Timer:</p>
<pre class="brush:c#;">
using Microsoft.AspNetCore.Mvc;
