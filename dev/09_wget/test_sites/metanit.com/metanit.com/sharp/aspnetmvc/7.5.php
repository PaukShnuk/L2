...
<html >
<head>
<title>ASP.NET Core MVC и C# | EnvironmentTagHelper</title>
<meta charset="utf-8" />
<meta name="description" content="Применение EnvironmentTagHelper в представлениях ASP.NET Core MVC и C#, вывод в зависимости от окружения проекта, роль переменной ASPNETCORE_ENVIRONMENT">
...
<h2>EnvironmentTagHelper</h2><div class="date">Последнее обновление: 04.04.2022</div>
...
<p>Атрибут <span class="b">names</span> позволяет через запятую перечислить, к каким состояниям среды приложения применяется этот тег. 
В данном случае, если проект на стадии Development (то есть в разработке), то подключается локальный файл <span class="b">bootstrap.min.css</span>, который расположен в проекте 
в папке <span class="b">wwwroot/css</span>.</p>
<p>Если же проект находится в процессе тестирования (Staging) или уже опубликован (Production), то подключается файл <span class="b">bootstrap.min.css</span> из CDN.</p>
...
значение "Development". Для управления этой переменной можно использовать файл <span class="b">launchSettings.json</span>, 
который расположен в проекте в папке <span class="b">Properties</span>:</p>
<img src="./pics/7.8.png" alt="environmenttaghelper и настройка окружения ASP.NET Core MVC и C#" />
...
<pre class="brush:xml;">&lt;link rel="stylesheet" href="/css/bootstrap.css" /&gt;</pre>
<p>Если же мы изменим значение ASPNETCORE_ENVIRONMENT на <span class="b">Production</span>:</p>
<img src="./pics/7.9.png" alt="Переменная ASPNETCORE_ENVIRONMENT в ASP.NET Core MVC и C#" />
<p>В этом случае тег environment сгенерирует следующую разметку:</p>
<pre class="brush:xml;">&lt;link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" /&gt;</pre>
...
<p>Например, если приложение находится в состоянии "Development":</p>
<img src="./pics/7.10.png" alt="Profile ASPNETCORE_ENVIRONMENT в ASP.NET Core MVC и C#" />
