...
<html >
<head>
<title>ASP.NET Core MVC и C# | Отправка файлов</title>
<meta charset="utf-8" />
<meta name="description" content="Отправка файлов в ASP.NET Core MVC и C#, классы PhysicalFileResult, FileContentResult, FileStreamResult, VirtualFileResult">
...
<h2>Отправка файлов</h2><div class="date">Последнее обновление: 21.03.2022</div>
...
<img src="./pics/2.19.png" alt="Отправка файла по физическому пути в ASP.NET Core MVC и C#" />
...
которое возвращает путь к папке, где находится текущее приложение.</p>
<p>И, при обращении, например, по пути <span class="ii">Home/GetFile</span> нам будет предложено сохранить данный файл на локальном компьютере.</p>
...
<img src="./pics/2.20.png" alt="Отправка файла в контроллере ASP.NET Core MVC и C#" />
