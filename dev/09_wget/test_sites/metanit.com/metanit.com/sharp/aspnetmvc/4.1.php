...
<html >
<head>
<title>ASP.NET Core MVC и C# | Маршрутизация</title>
<meta charset="utf-8" />
<meta name="description" content="Маршрутизация в ASP.NET Core MVC и C#, определение маршрутов и получение данных маршрута, метод MapControllerRoute, объект RouteData">
...
<h1>Маршрутизация</h1><h2>Добавление маршрутизации</h2><div class="date">Последнее обновление: 24.03.2022</div>
...
<p>Чтобы связать контроллеры MVC и их действия с запросами применяется система маршрутизации. Чтобы задействовать систему маршрутизации для контроллеров 
MVC, можно использовать различные способы. Например, определим в проекте ASP.NET Core в файле <span class="b">Program.cs</span> следующий код:</p>
<pre class="brush:c#;">
...
<p>Здесь для добавления маршрута, который будет сопоставляться с методами контроллеров, у объекта <span class="b">IEndpointRouteBuilder</span> (в качестве которого выступает объект 
WebApplication) вызывается метод <span class="b">MapControllerRoute()</span>. 
