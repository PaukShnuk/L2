...
<html >
<head>
<title>ASP.NET Core MVC и C# | Отправка статусных кодов</title>
<meta charset="utf-8" />
<meta name="description" content="Отправка статусных кодов в ASP.NET Core MVC и C#, методы StatusCode, NotFound, Unauthorized, BadRequest">
...
<h2>Отправка статусных кодов</h2><div class="date">Последнее обновление: 21.03.2022</div>
...
определена богатая палитра классов, которые можно использовать для отправки статусного кода.</p>
...
<img src="./pics/2.17.png" alt="NotFoundResult и ошибка 404 в ASP.NET Core MVC и C#" />
...
<img src="./pics/2.18.png" alt="Статусные коды в ASP.NET Core MVC и C#" />
...
Второй класс в дополнении к статусному коду позволяет отправить дополнительную информацию, которая потом отправляется клиенту в формате json.</p>
