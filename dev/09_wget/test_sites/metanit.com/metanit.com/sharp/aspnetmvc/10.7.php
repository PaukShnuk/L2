...
<html >
<head>
<title>ASP.NET Core MVC и C# | Фильтры исключений</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтры исключений в ASP.NET Core MVC и C#, интерфейсы IExceptionFilter и IAsyncExceptionFilterr">
...
<h2>Фильтры исключений</h2><div class="date">Последнее обновление: 10.04.2022</div>
...
<p><span class="b">Фильтры исключений</span> обрабатывают необработанные исключения, в том числе те, которые возникли при создании контроллера и привязки модели. 
...
<img src="./pics/10.9.png" alt="Фильтры исключений в ASP.NET Core MVC и C#" />
...
<div class="nav"><p><a href="./10.6.php">Назад</a><a href="./">Содержание</a><a href="./11.1.php">Вперед</a></p></div></div>
<div class="socBlock">
