...
<html >
<head>
<title>ASP.NET Core MVC и C# | Строго типизированные хелперы</title>
<meta charset="utf-8" />
<meta name="description" content="Строго типизированные хелперы форм в  ASP.NET Core MVC и C#, Html.TextBoxFor, Html.DropDownListFor, Html.LabelFor">
...
<h2>Строго типизированные хелперы</h2><div class="date">Последнее обновление: 29.03.2022</div>
...
<p>Кроме базовых html-хелперов форм в ASP.NET Core MVC можно использовать их двойники - строго типизированные хелперы. Этот вид хелперов принимает в 
...
<p>Посмотрим на примере. Допустим, в проекте в папке <span class="b">Models</span> у нас есть следующая модель <span class="b">User</span>:</p>
<pre class="brush:c#;">
...
<img src="./pics/6.5.png" alt="строго типизированные хелперы в ASP.NET Core MVC и C#" />
...
модель, которая будет использоваться:</p>
<pre class="brush:c#;">@model MvcApp.Models.User</pre>
<p>То есть, в вызове 
...
<p>Выражение <code>@Html.CheckBoxFor(m=&gt;m.Enable, false)</code> формирует элемент:</p>
<p><code>&lt;input id="Enable" name="Enable" type="checkbox" value="true" /&gt;</code></p></li>
