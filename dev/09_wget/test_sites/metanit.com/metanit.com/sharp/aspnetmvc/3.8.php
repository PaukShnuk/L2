...
<html >
<head>
<title>ASP.NET Core MVC и C# | Работа с формами</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с элементами формам в представления ASP.NET Core MVC и C#, отправка данных из формы на контроллер, элементы input, select">
...
<h2>Работа с формами</h2><div class="date">Последнее обновление: 24.03.2022</div>
...
<p>Формы html представляют одну из форм передачи наборов данных на сервер. Обычно для создания форм и их элементов в MVC применяются либо html-хелперы, либо 
...
<p>В одной из прошлых тем было рассмотрено, как MVC связывает отправленные значения формы с параметрами метода. Например, у нас есть действие Index:</p>
<pre class="brush:c#;">
...
<p>Теперь создадим само представление. Пусть в папке <span class="b">Views/Home</span> есть представление <span class="b">Index.cshtml</span> со следующим кодом:</p>
<pre class="brush:xml;">
...
<img src="./pics/3.26.png" alt="Отправка форм из представлений в контроллер в ASP.NET Core MVC в C#" />
...
<p>Тогда форма в представлении могла бы выглядеть следующим образом:</p>
<pre class="brush:xml;">
&lt;h2&gt;User Form&lt;/h2&gt;
&lt;form method="post"&gt;
    &lt;p&gt;
...
<img src="./pics/3.27.png" alt="Элементы html в ASP.NET Core MVC и C#" />
...
<img src="./pics/3.28.png" alt="radiobuttons in asp.net core mvc и c#" />
...
<pre class="brush:xml;">&lt;option value="csharp"&gt;C#&lt;/option&gt;</pre>
<p>Здесь текст "C#" - это то, что мы увидим в списке, а "csharp" - это значение, которое при выборе данного элемента отправится на сервер.</p>
...
<img src="./pics/3.29.png" alt="Список select в ASP.NET Core MVC и C#" />
...
<img src="./pics/3.30.png" alt="Список select со множественным выбором в ASP.NET Core MVC и C#" />
