...
<html >
<head>
<title>ASP.NET Core MVC и C# | Передача параметров в фильтры и установка зависимостей</title>
<meta charset="utf-8" />
<meta name="description" content="Передача параметров и установка зависимостей в фильтрах ASP.NET Core MVC и C#, применение классов ServiceFilterAttribute и TypeFilterAttribute">
...
<h2>Передача параметров в фильтры и установка зависимостей</h2><div class="date">Последнее обновление: 10.04.2022</div>
...
<code>Microsoft.Extensions.DependencyInjection.ObjectFactory</code>, а с помощью механизма DI устанавливает все зависимости для создаваемого фильтра. Применение TypeFilterAttribute:</p>
<pre class="brush:c#;">
...
<p>Класс <span class="b">ServiceFilterAttribute</span> в отличие от TypeFilterAttribute извлекает экземпляр фильтра напрямую из DI. Для этого при применении ему передается тип фильтра:</p>
<pre class="brush:c#;">
...
<p>Но чтобы данный фильтр стал доступен, его надо зарегистрировать в приложении в качестве сервиса:</p>
<pre class="brush:c#;">
