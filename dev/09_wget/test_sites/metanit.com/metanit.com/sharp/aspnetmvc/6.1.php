...
<html >
<head>
<title>ASP.NET Core MVC и C# | HTML-хелперы</title>
<meta charset="utf-8" />
<meta name="description" content="Введение в HTML-хелперы в ASP.NET Core MVC и C#, создание своих хелперов и использование их в представлениях, класс TagBuilder">
...
<h1>HTML-хелперы</h1><h2>Создание HTML-хелперов</h2><div class="date">Последнее обновление: 29.03.2022</div>
...
<p>Для вывода содержимого в представлении можно применять стандартные html-элементы, которые позволяют создавать блоки, списки, таблицы и т.д. Но кроме 
собственно html-элементов в ASP.NET Core MVC для создания разметки можyj использовать специальные методы - <span class="b">html-хелперы</span>. Вообще helper можно перевести с 
...
<p>Для создания простейшего html-хелпера в проект ASP.NET Core добавим новый класс <span class="b">ListHelper</span>:</p>
<pre class="brush:c#;">
...
<img src="./pics/6.1.png" alt="Html Helper in ASP.NET Core MVC и C#" />
