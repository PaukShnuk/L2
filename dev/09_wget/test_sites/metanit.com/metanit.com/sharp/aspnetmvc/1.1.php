...
<html >
<head>
<title>ASP.NET Core MVC и C# | Введение в MVC</title>
<meta charset="utf-8" />
<meta name="description" content="Введение в ASP.NET Core MVC в C#, основные компоненты паттерна, модель, контроллер, представление, их взаимодействие">
...
<h1>Введение в ASP.NET Core MVC</h1><h2>Фреймворк ASP.NET Core MVC</h2><div class="date">Последнее обновление: 15.03.2022</div>
...
<p>Фреймворк ASP.NET Core MVC является частью платформы ASP.NET Core, его отличительная особенность - применение паттерна MVC. Преимуществом использования 
...
особенно это относится к большим приложениям.</p> 
<p>Стоит отметить, чам паттерн MVC не является исключительной особенностью ASP.NET Core MVC, данный паттерн появился еще в конце 1970-х годов в компании Xerox как способ организации 
...
популярен паттерн MVC в веб-приложениях.</p>
...
<div class="nav"><p><a href="./.php">Назад</a><a href="./">Содержание</a><a href="./1.2.php">Вперед</a></p></div></div>
<div class="socBlock">
