...
<html >
<head>
<title>ASP.NET Core MVC и C# | Внедрение зависимостей в представления</title>
<meta charset="utf-8" />
<meta name="description" content="Dependency Injection / Внедрение зависимостей в представления ASP.NET Core MVC и C#, директива @inject">
...
<h2>Внедрение зависимостей в представления</h2><div class="date">Последнее обновление: 24.03.2022</div>
...
<p>ASP.NET Core MVC поддерживает внедрение зависимостей в представления. За внедрение зависимостей в представление отвечает директива <span class="b">@inject</span>.</p>
<p>Допустим, у нас в проекте в файле <span class="b">Program.cs</span> внедряется сервис ITimeService:</p>
<pre class="brush:c#;">
...
<p>Интерфейс ITimeService определяет свойство Time. В реализации этого интерфейса - классе SimpleTimeService данное свойство возвращает строку с текущим временем. И затем класс SimpleTimeService применяется 
в качестве реализации для сервиса ITimeService.</p>
...
<p>Директива <span class="b">@inject</span> принимает два параметра: первый параметр представляет тип сервиса (в данном случае ITimeService), а второй - название переменной этого типа (в данном случае 
<code>timeService</code>). И после этого мы можем использовать переменную:</p>
<img src="./pics/3.25.png" alt="Dependency Injection in Views in ASP.NET Core MVC и C#" />
