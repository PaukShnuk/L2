...
<html >
<head>
<title>ASP.NET Core MVC и C# | Первый проект на ASP.NET Core MVC</title>
<meta charset="utf-8" />
...
<h2>Первый проект на ASP.NET Core MVC</h2><div class="date">Последнее обновление: 15.03.2022</div>
...
<p>Для создания проекта на ASP.NET Core MVC мы можем выбрать любой тип проекта на ASP.NET Core и в нем уже добавлять необходимые компоненты. 
Однако для упрощения Visual Studio уже по умолчанию предоставляет для этого шаблон <span class="b">ASP.NET Core Web App (Model-View-Controller)</span>:</p>
<img src="./pics/1.1.png" alt="Проект ASP.NET Core Web App (Model-View-Controller) на языке программирования C#" />
<p>Выберем данный шаблон для создания проекта. Дальше нам откроется окно для установки имени проекта. Допустим, проект будет называться HelloMvcApp:</p>
<img src="./pics/1.2.png" alt="Первый проект ASP.NET Core Web App (Model-View-Controller) на языке программирования C#" />
<p>Далее нам надо будет настроить стандартные настройки для ASP.NET Core:</p>
<img src="./pics/1.3.png" alt="Настройка проекта ASP.NET Core MVC на языке C#" />
...
<img src="./pics/1.4.png" alt="Структура проекта ASP.NET MVC Core" />
<ul>
...
изображений, скриптов javascript, файлов css и т.д., которые используются приложением.</p>
<li><p><span class="b">Controllers</span>: папка для хранения контроллеров, используемых приложением. По умолчанию здесь уже есть один контроллер - Homecontroller</p></li>
<li><p><span class="b">Models</span>: каталог для хранения моделей. По умолчанию здесь создается модель ErrorviewModel</p></li>
<li><p><span class="b">Views</span>: каталог для хранения представлений. Здесь также по умолчанию добавляются ряд файлов - представлений</p></li>
<li><p><span class="b">appsettings.json</span>: хранит конфигурацию приложения</p></li>
<li><p><span class="b">Program.cs</span>: файл, который определяет входную точку в приложение ASP.NET Core</p></li>
</ul>
...
<img src="./pics/1.5.png" alt="Первый проект на ASP.NET MVC Core и C#" />
