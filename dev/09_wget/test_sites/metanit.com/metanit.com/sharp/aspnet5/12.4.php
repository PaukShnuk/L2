...
<html >
<head>
<title>ASP.NET Core | Сортировка в Entity Framework</title>
<meta charset="utf-8" />
<meta name="description" content="Сортировка данных в ASP.NET Core через Entity Framework, метод OrderBy и OrderByDescending">
...
<h2>Сортировка</h2><div class="date">Последнее обновление: 09.12.2019</div>
...
<p>Рассмотрим, как добавить в приложение сортировку данных. Для начала собственно создадим новый проект ASP.NET Core по типу 
<span class="b">Web Application (Model-View-Controller)</span>. Назовем его, к примеру, 
<span class="b">SortApp</span>.</p>
<img src="./pics/sort1.png" alt="Сортировка в ASP.NET Core" />
...
Далее добавим в папку Models новый класс <span class="b">UsersContext</span>, через который будем взаимодействовать с бд:</p>
<pre class="brush:c#;">
...
<p>В файле Startup.cs установим контекст данных и подключение к базе данных:</p>
<pre class="brush:c#;">
...
Для описания всех этих критериев добавим в папку Models перечисление <span class="b">SortState</span>:</p>
<pre class="brush:c#;">
...
<p>И определим код в представлении <span class="ii">Index.cshtml</span>:</p>
<pre class="brush:xml;">
@using SortApp.Models
@{
...
<img src="./pics/sort2.png" alt="Проект ASP.NET Core для сортировки объектов" />
...
<img src="./pics/sort3.png" alt="Сортировка в ASP.NET Core MVC" />
