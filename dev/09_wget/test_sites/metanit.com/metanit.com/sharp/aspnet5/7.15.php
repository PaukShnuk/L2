...
<html >
<head>
<title>ASP.NET Core | ViewComponentContext</title>
<meta charset="utf-8" />
<meta name="description" content="Контекст ViewComponentContext и его применение в View Component в ASP.NET Core MVC, получение данных запроса">
...
<h2>ViewComponentContext</h2><div class="date">Последнее обновление: 28.11.2019</div>
...
<p>Если мы создаем компонент с помощью наследования от класса ViewComponent, то нам становится доступным контекст компонента через ряд свойств:</p>
<ul>
...
<p>В методе Invoke получаем из строки запроса параметр "number", который призван указать, сколько пользователей надо вывести 
...
<p>В представлении компонента получим все переданные данные:</p>
<pre class="brush:xml;">
...
<img src="./pics/viewcomponent9.png" alt="Контекст в View Component в ASP.NET Core" />
...
<div class="nav"><p><a href="./7.14.php">Назад</a><a href="./">Содержание</a><a href="./19.1.php">Вперед</a></p></div></div>
<div class="socBlock">
