...
<html >
<head>
<title>ASP.NET Core | Аннотации данных</title>
<meta charset="utf-8" />
<meta name="description" content="Аннотации данных в ASP.NET Core, использование атрибутов Display, DataType и UIHint">
...
<h2>Аннотации данных</h2><div class="date">Последнее обновление: 08.12.2019</div>
...
<p>Кроме атрибутов валидации модели также могут иметь доплнительные атрибуты, которые называются аннотации данных и которые располагаются в пространстве имен 
...
<p>Атрибут Display задает параметры отображения для свойства. Например, пусть у ас еть следующая модель Person:</p>
<pre class="brush:c#;">
public class Person
{
...
<img src="./pics/dataannotations1.png" alt="Аннотации данные в ASP.NET Core" />
...
<p>И в этом случае мы можем задать с помощью атрибута Display отображаемую метку для свойства:</p>
<pre class="brush:c#;">
...
<img src="./pics/dataannotations2.png" alt="Атрибут Display в ASP.NET Core" />
...
<img src="./pics/dataannotations4.png" alt="Атрибут DataType в ASP.NET Core" />
...
<img src="./pics/dataannotations5.png" alt="Атрибут UIHint в ASP.NET Core" />
<h3>DisplayFormat</h3>
...
<img src="./pics/dataannotations3.png" alt="Атрибут DisplayFormat в ASP.NET Core" />
...
<div class="nav"><p><a href="./19.5.php">Назад</a><a href="./">Содержание</a><a href="./12.1.php">Вперед</a></p></div></div>
<div class="socBlock">
