...
<html >
<head>
<title>ASP.NET Core | Создание и вывод из базы данных в Razor Pages</title>
<meta charset="utf-8" />
<meta name="description" content="Создание и вывод объектов из базы данных в Razor Pages в ASP.NET Core">
...
<h2>Создание и вывод из базы данных в Razor Pages</h2><div class="date">Последнее обновление: 10.12.2019</div>
...
<p>Продолжим работу с проектом из прошлой темы, где уже настроено подключение и создана база данных. Теперь добавим в проект в папку Pages новый каталог 
<span class="b">People</span>. В этот каталог добавим новую страницу Razor, которую назовем <span class="b">Index.cshtml</span>:</p>
<img src="./pics/razorpages20.png" alt="Взаимодействие с базой данных из Razor Pages" />
<p>После ее добавления в папке <span class="ii">Pages/People</span> появятся два файла: <span class="b">Index.cshtml</span> и <span class="b">Index.cshtml.cs</span>. 
Эта страница будет предназначена для вывода список пользователей из базы данных.</p>
<p>Изменим файл <span class="b">Index.cshtml.cs</span>:</p>
<pre class="brush:c#;">
...
<p>Поскольку в классе Startup контекст данных ApplicationContext добавляется в качестве сервиса, то в конструкторе PageModel, также как и в конструкторе 
контроллеров MVC, мы можем получить этот контекст и затем использовать его для взаимодействия с базой данных.</p>
<p>И изменим файл <span class="b">Index.cshtml</span> для вывода списка данных:</p>
<pre class="brush:xml;">
@page
...
<p>Сверху над таблицей эта страница будет содержать ссылку на другую страницу - Create, которая будет предназначена для добавления объектов.</p>
<p>Теперь аналогичным образом добавим в папку <span class="ii">Pages/People</span> еще одну страницу Razor - Create.cshtml. И вначале изменим 
файл <span class="b">Create.cshtml.cs</span>:</p>
<pre class="brush:c#;">
...
<p>В методе OnPostAsync происходит добавление объекта в базу данных, после чего идет редирект на страницу Index.</p>
<p>А на странице Create.cshtml определим форму ввода данных:</p>
<pre class="brush:xml;">
@page
...
<p>Таким образом, у нас получится следующий проект:</p>
<img src="./pics/razorpages23.png" alt="проект для RazorPages в ASP.NET Core MVC" />
<p>Запустим проект. Вначале у нас нет объектов в бд, поэтому перейдем к странице Create.cshtml и добавим один объект:</p>
<img src="./pics/razorpages21.png" alt="Добавление в базу данных в Razor Pages" />
<p>И после добавления страница Index отобразит добавленный объект:</p>
<img src="./pics/razorpages22.png" alt="Вывод объектов из базы данных в Razor Pages" />
...
<div class="nav"><p><a href="./29.9.php">Назад</a><a href="./">Содержание</a><a href="./29.11.php">Вперед</a></p></div></div>
<div class="socBlock">
