...
<html >
<head>
<title>ASP.NET Core | Фабрика логгера и провайдеры логгирования</title>
<meta charset="utf-8" />
<meta name="description" content="Фабрика логгера ILoggerFactory в ASP.NET Core, использование ILoggerBuilder для конфигурации логгера, встроенные провайдеры логгирования">
...
<h2>Фабрика логгера и провайдеры логгирования</h2><div class="date">Последнее обновление: 06.11.2019</div>
...
<p>В данном случае с помощью метода <span class="b">LoggerFactory.Create</span> создается фабрика логгера. В качестве параметра метод принимает 
лямбда-выражения, котороое устанавает некоторые настройки логгирования. В частности, метод <span class="b">AddConsole()</span> объекта ILoggingBuilder 
устанавливает вывод сообщений лога на консоль. Затем метод <code>CreateLogger()</code> фабрики собственно создает логгер:</p>
<pre class="brush:c#;">ILogger logger = loggerFactory.CreateLogger&lt;Startup&gt;();</pre>
<p>То есть мы получим тот же вывод сообщений на консоль. Но преимущество использования фабрики логгеров состоит в том, что мы можем дополнительно настроить 
...
<span class="b">AddDebug()</span></p></li>
...
<img src="./pics/logger6.png" alt="Провайдеры логгирования logging providers in ASP.NET Core" />
...
<div class="nav"><p><a href="./2.10.php">Назад</a><a href="./">Содержание</a><a href="./2.28.php">Вперед</a></p></div></div>
<div class="socBlock">
