...
<html >
<head>
<title>ASP.NET Core | Работа с конфигурацией</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с конфигурацией в ASP.NET Core, получение настроек в файлах json и xml, использование секций">
...
<h2>Работа с конфигурацией</h2><div class="date">Последнее обновление: 14.11.2019</div>
...
<p>Например, если у нас есть следующая конфигурация:</p>
<pre class="brush:js;">
{
  "ConnectionStrings": {
...
<pre class="brush:c#;">string con = AppConfiguration.GetSection("ConnectionStrings:DefaultConnection").Value;</pre>
...
<pre class="brush:c#;">string con = AppConfiguration["ConnectionStrings:DefaultConnection"];</pre>
...
<pre class="brush:c#;">string con = AppConfiguration.GetConnectionString("DefaultConnection");</pre>
<p>Используя выше рассмотренные методы, мы можем провести анализ всего файла конфигурации. Например, 
пусть в проекте определен следующий конфигурационный файл <span class="ii">project.json</span>:</p>
<pre class="brush:js;">
{
  "dependencies": {
...
<img src="./pics/2.23.png" alt="Конфигурация json в ASP.NET Core MVC" />
...
<div class="nav"><p><a href="./2.23.php">Назад</a><a href="./">Содержание</a><a href="./2.15.php">Вперед</a></p></div></div>
<div class="socBlock">
