...
<html >
<head>
<title>ASP.NET Core | Фильтры ресурсов</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтры ресурсов (Resource Filters) в ASP.NET Core, реализация интерфейса IResourceFilter">
...
<h2>Фильтры ресурсов</h2><div class="date">Последнее обновление: 11.12.2019</div>
...
<p>Фильтр ресурсов, как правило, применяется для переопределения результата действия. Это может быть полезно, например, в ситуации с кэшированием: 
...
непосредственно контроллеру или странице Razor Page.</p>
...
<div class="nav"><p><a href="./18.5.php">Назад</a><a href="./">Содержание</a><a href="./18.3.php">Вперед</a></p></div></div>
<div class="socBlock">
