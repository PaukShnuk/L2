...
<html >
<head>
<title>ASP.NET Core | Подключение к базе данных в Razor Pages</title>
<meta charset="utf-8" />
<meta name="description" content="Подключение к базе данных в Razor Pages в ASP.NET Core, настройка подключения и создание бд">
...
<h2>Подключение к базе данных в Razor Pages</h2><div class="date">Последнее обновление: 10.12.2019</div>
...
<p>Рассмотрим создание простейшего CRUD-интерфейса и взаимодействие с БД из Razor Pages. Пусть у нас есть проект для ASP.NET Core по типу 
Web Application.</p>
<img src="./pics/razorpages1.png" alt="Проект Razor Pages in ASP.NET Core MVC" />
<p>Добавим в проект в папку Models класс <span class="b">Person</span>, который будет представлять хранимые в бд данные:</p>
<pre class="brush:c#;">
public class Person
{
...
И также добавим в папку Models класс контекста данных <span class="b">ApplicationContext</span>:</p>
<pre class="brush:c#;">
...
<p>И изменим файл <span class="b">Startup.cs</span>, чтобы указать строку подключения для сервиса ApplicationContext:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="./29.8.php">Назад</a><a href="./">Содержание</a><a href="./29.10.php">Вперед</a></p></div></div>
<div class="socBlock">
