...
<html >
<head>
<title>ASP.NET Core | Фильтрация в Entity Framework</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтрация данных в ASP.NET Core MVC через Entity Framework">
...
<h2>Фильтрация</h2><div class="date">Последнее обновление: 09.12.2019</div>
...
<p>Рассмотрим, как фильтровать данные по определенным критериям в ASP.NET Core MVC. Для работы возьмем следующие модели:</p>
<pre class="brush:c#;">
public class User
{
...
<p>И в классе Startup методе <code>ConfigureServices()</code> настроим использование этого контекста данных:</p>
<pre class="brush:c#;">
...
<p>Три свойства - для списка пользователей, компаний, введенного для поиска имени.</p>
<p>Для вывода данных модели определим представление:</p>
<pre class="brush:xml;">
@model FilterApp.Models.UserListViewModel
...
<img src="./pics/filtering2.png" alt="Фильтрация в ASP.NET Core MVC" />
