...
<html >
<head>
<title>ASP.NET Core | Маршруты и генерация ссылок</title>
<meta charset="utf-8" />
<meta name="description" content="Влияние системы маршрутизации на генерацию ссылок и адресов URL в ASP.NET Core">
...
<h2>Маршруты и генерация ссылок</h2><div class="date">Последнее обновление: 26.11.2019</div>
...
<pre>http://localhost:55994/Products/Index</pre>
...
<p>Данные правила в отношении создания ссылок справедливы не только в отношении Html.ActionLink, но и в отношении хелпера Html.RouteUrl, а также tag-хелпера 
AnchorTagHelper.</p>
<p>Например, вызов</p>
...
<p>А tag-хелпер</p>
<pre class="brush:xml;">&lt;a asp-action="Index" asp-controller="Book"&gt;Книги&lt;/a&gt;</pre>
<p>сгенерирует следующую ссылку:</p>
...
<div class="nav"><p><a href="./11.9.php">Назад</a><a href="./">Содержание</a><a href="./11.11.php">Вперед</a></p></div></div>
<div class="socBlock">
