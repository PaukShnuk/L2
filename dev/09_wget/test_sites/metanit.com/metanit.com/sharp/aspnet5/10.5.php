...
<html >
<head>
<title>ASP.NET Core | Tag-хелперы валидации</title>
<meta charset="utf-8" />
<meta name="description" content="Отображение ошибок валидации в ASP.NET Core MVC c помощью tag-хелперов, ValidationMessageTagHelper">
...
<h2>Tag-хелперы валидации</h2><div class="date">Последнее обновление: 08.12.2019</div>
...
<p>Для валидации на стороне клиента применяется класс ValidationMessageTagHelper. Данный tag-хелпер используется с помощью применения 
...
<p>Атрибут <code>asp-validation-for</code> в качестве значения принимает название свойства модели, для которого будет выводиться сообщение об ошибке валидации.</p>
<p>Данный элемент span будет генерировать следующую разметку:</p>
<pre class="brush:xml;">
&lt;span class="field-validation-valid" data-valmsg-for="Name" data-valmsg-replace="true"&gt;&lt;/span&gt;
</pre>
<h3>ValidationSummaryTagHelper</h3>
<p>ValidationSummaryTagHelper применяется для отображения сводки ошибок валидации. Он применяется к элементу div в виде атрибута <span class="b">asp-validation-summary</span>:</p>
<pre class="brush:xml;">&lt;div class="validation" asp-validation-summary="ModelOnly"/&gt;</pre>
...
<p>При возникновении ошибок в список ul добавляются все сообщения об ошибках.</p>
<p>Теперь применим оба тег-хэлпера. Допустим, мы создаем объект следующей модели Person:</p>
<pre class="brush:c#;">
public class Person
{
...
<p>Пусть в контроллере для создания объекта Person предусмотрено действие Create:</p>
<pre class="brush:c#;">
...
<p>Полная форма для создания этого объекта могла бы выглядеть так:</p>
<pre class="brush:xml;">
...
<p>И в случае некорректного ввода отобразятся ошибки валидации:</p>
<img src="./pics/validationtaghelper.png" alt="ValidationMessageTagHelper и ValidationSummaryTagHelper" />
...
<div class="nav"><p><a href="./19.4.php">Назад</a><a href="./">Содержание</a><a href="./19.5.php">Вперед</a></p></div></div>
<div class="socBlock">
