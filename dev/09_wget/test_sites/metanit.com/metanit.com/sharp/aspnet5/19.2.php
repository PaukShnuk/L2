...
<html >
<head>
<title>ASP.NET Core | Атрибуты валидации</title>
<meta charset="utf-8" />
<meta name="description" content="Атрибуты валидации в ASP.NET Core и их применение, атрибут Required, RegularExpression, StringLength, Remote, удаленная валидация, настрока сообщений об ошибках">
...
<h2>Атрибуты валидации</h2><div class="date">Последнее обновление: 08.12.2019</div>
...
Рассмотрим атрибуты валидации, которые мы можем применить в приложении на ASP.NET Core.</p>
<h3>Атрибут Required</h3>
<p>Применение этого атрибута к свойству модели означает, что данное свойство должно быть обязательно установлено.</p>
<pre class="brush:c#;">
...
<img src="./pics/validation3.png" alt="Атрибут Required в ASP.NET" />
...
<img src="./pics/validation4.png" alt="Атрибут RegularExpression в ASP.NET Core" />
...
<img src="./pics/validation5.png" alt="Атрибут StringLength в ASP.NET Core" />
<h3>Атрибут Range</h3>
<p>Атрибут Range определяет минимальные и максимальные ограничения для числовых данных.</p>
<pre class="brush:c#;">
...
<img src="./pics/validation6.png" alt="Проверка ввода пароля в ASP.NET Core" />
...
<p>В данном случае метод должен возвращать объект JsonResult. Если переданное через параметр значение будет равно или "admin@mail.ru", или "aaa@gmail.com", 
значит, валидация не пройдена, поэтому отправляем в ответ false. Иначе отправляем true.</p>
<img src="./pics/validation12.png" alt="Удаленная валидация Remote Validation в ASP.NET Core" />
