...
<html >
<head>
<title>ASP.NET Core | URL-хелперы</title>
<meta charset="utf-8" />
<meta name="description" content="URL-хелперы Url.Action, Url.RouteUrl, Url.Content и генерация адресов в ASP.NET Core ">
...
<h2>URL-хелперы</h2><div class="date">Последнее обновление: 02.12.2019</div>
...
<pre class="brush:c#;">@Url.Action("GetUser", "Home", new { name = "Тоm", id = 10 }, null)</pre>
<p>Этот путь затем можно применить при формировании ссылки:</p>
<pre class="brush:c#;">&lt;a href='@Url.Action("GetUser", "Home", new { name = "Тоm", id = 10 }, null)'&gt;Ссылка&lt;/a&gt;</pre>
...
<pre class="brush:c#;">@Url.RouteUrl(new { controller = "Home", action = "GetUser", name = "Tom", id = 10 })</pre>
...
<div class="nav"><p><a href="./11.10.php">Назад</a><a href="./">Содержание</a><a href="./10.1.php">Вперед</a></p></div></div>
<div class="socBlock">
