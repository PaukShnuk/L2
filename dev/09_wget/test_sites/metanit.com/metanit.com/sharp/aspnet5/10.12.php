...
<html >
<head>
<title>ASP.NET Core | Атрибут HtmlTargetElement</title>
<meta charset="utf-8" />
<meta name="description" content="Атрибут HtmlTargetElement, его настройка и его использование для создания tag-хелпера в ASP.NET Core MVC">
...
<h2>Атрибут HtmlTargetElement</h2><div class="date">Последнее обновление: 08.12.2019</div>
...
<p>Например, определим в представлении следующие элементы:</p>
<pre class="brush:xml;">
...
<p>Теперь определим новый класс tag-хелпера:</p>
<pre class="brush:c#;">
...
в блоках div, при этом сохраняется. В итоге вместо двух блоков div будут созданы следующие заголовки:</p>
<pre class="brush:xml;">
...
<pre class="brush:xml;">&lt;article-header&gt;Заголовок!&lt;/article-header&gt;</pre>
...
<div class="nav"><p><a href="./10.11.php">Назад</a><a href="./">Содержание</a><a href="./10.9.php">Вперед</a></p></div></div>
<div class="socBlock">
