...
<html >
<head>
<title>ASP.NET Core | AnchorTagHelper</title>
<meta charset="utf-8" />
<meta name="description" content="Создание ссылок в ASP.NET Core MVC с помощью tag-хелпера AnchorTagHelper">
...
<h2>AnchorTagHelper</h2><div class="date">Последнее обновление: 05.12.2019</div>
...
<p>AnchorTagHelper представляет тег-хелпер, который позволяет создавать ссылки. Он может принимать ряд специальных атрибутов:</p>
<ul>
...
<pre class="brush:c#;">&lt;a asp-controller="Home" asp-action="About" asp-route-area="Service"&gt;О сайте&lt;/a&gt;</pre>
...
<pre class="brush:c#;">&lt;a asp-controller="Home" asp-action="About" asp-route-area=""&gt;О сайте&lt;/a&gt;</pre>
...
Например, по умолчанию в проекте определен один маршрут (в методе Configure класса Startup):</p>
<pre class="brush:c#;">
endpoints.MapControllerRoute(
	name: "default",
	pattern: "{controller=Home}/{action=Index}/{id?}");
</pre>
<p>Возьмем прелпоследний пример:</p>
<pre class="brush:xml;">
&lt;a asp-controller="Home" asp-action="GetPerson" asp-route-id="5"  asp-route-age="18" asp-route-name="tom" &gt;Item5&lt;/a&gt;
</pre>
...
<p>Но это только одна из частностей. Возьмем другой пример. Допустим, в классе Startup определено несколько маршрутов:</p>
<pre class="brush:c#;">
...
следующая ссылка:</p>
<pre>http://localhost:xxxxx/Store/SubIndex</pre>
...
<pre>http://localhost:xxxxx/BookStore</pre>
