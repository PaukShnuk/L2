...
<html >
<head>
<title>ASP.NET Core | Внедрение зависимостей в представления в MVC</title>
<meta charset="utf-8" />
<meta name="description" content="Dependency Injection в представлениях в ASP.NET MVC Core, директива @inject">
...
<h2>Внедрение зависимостей в представления</h2><div class="date">Последнее обновление: 19.11.2019</div>
...
<p>ASP.NET MVC Core поддерживает внедрение зависимостей в представления. За внедрение зависимостей в представление отвечает директива <span class="b">@inject</span>.</p>
<p>Допустим, у нас в проекте есть папка Services, в которой есть интерфейс ITimeService:</p>
<pre class="brush:c#;">
...
<p>И пусть в этой же папке находится класс SimpleTimeService, который реализует иданный интерфейс:</p>
<pre class="brush:c#;">
...
<img src="./pics/views8.png" alt="Внедрение зависимостей в представления в ASP.NET Core" />
<p>И вначале необходимо сопоставить зависимости в классе Startup. Изменим его метод <code>ConfigureServices()</code> следующим образом:</p>
<pre class="brush:c#;">
...
<p>И далее мы можем использовать зависимости в представлении. Например, изменим какое-нибудь представление:</p>
<pre class="brush:xml;">
@inject HelloMvcApp.Services.ITimeService Timer
&lt;h2&gt;Текущее время: @Timer.GetTime()&lt;/h2&gt;
</pre>
<p>Директива <span class="b">@inject</span> принимает два параметра: первый параметр представляет тип, а второй - название переменной этого типа. И после этого мы можем использовать переменную:</p>
<img src="./pics/views1.png" alt="Dependency Injection in Views in ASP.NET Core" />
