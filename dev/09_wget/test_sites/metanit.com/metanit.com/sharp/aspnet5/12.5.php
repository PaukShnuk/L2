...
<html >
<head>
<title>ASP.NET Core | Создание tag-хелпера сортировки</title>
<meta charset="utf-8" />
<meta name="description" content="Создание tag-хелпера для сортировки данных в ASP.NET Core MVC">
...
<h2>Создание tag-хелпера сортировки</h2><div class="date">Последнее обновление: 09.12.2019</div>
...
настраивать их. Для этого добавим в проект новую папку <span class="ii">TagHelpers</span>. А в эту папку поместим новый класс <span class="b">SortHeaderTagHelper</span>:</p>
<pre class="brush:c#;">
...
<p>Поскольку создаваемый тег-хелпер использует классы glyphicon, glyphicon-chevron-down и glyphicon-chevron-up, которые визуализируются с помощью библиотеки font-awesome. 
...
все это можно вынести в отдельный css-файл.</p>
...
<img src="./pics/sort4.png" alt="TagHelper и сортировка в ASP.NET Core" />
<p>Запустим проект и отсортируем по разным критериям:</p>
<img src="./pics/sort5.png" alt="TagHelper и сортировка в ASP.NET Core MVC" />
