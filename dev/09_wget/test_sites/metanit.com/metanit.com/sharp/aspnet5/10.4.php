...
<html >
<head>
<title>ASP.NET Core | Tag-хелперы форм</title>
<meta charset="utf-8" />
<meta name="description" content="Использование tag-хелперов в ASP.NET Core MVC для создания формы и ее элементов">
...
<h2>Tag-хелперы форм</h2><div class="date">Последнее обновление: 06.12.2019</div>
...
<img src="./pics/taghelper3.png" alt="Tag-helpers in ASP.NET Core MVC" />
...
<h3>Работа с enum</h3>
<p>Теперь рассмотрим, как привязать объект select к перечислению. Допустим, у нас есть такой тип enum:</p>
<pre class="brush:c#;">
public enum DayTime
{
    [Display(Name ="Утро")]
...
<p>И определим представление <span class="ii">Index.cshtml</span>:</p>
<pre class="brush:xml;">
@using TagHelpersApp.Models
...
<img src="./pics/taghelper2.png" alt="список enum в ASP.NET Core" />
...
<div class="nav"><p><a href="./10.3.php">Назад</a><a href="./">Содержание</a><a href="./10.6.php">Вперед</a></p></div></div>
<div class="socBlock">
