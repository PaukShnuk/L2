...
<html >
<head>
<title>ASP.NET MVC Core | Движок представлений Razor</title>
<meta charset="utf-8" />
<meta name="description" content="Движок представлений и синтаксис Razor в ASP.NET MVC Core, основные элементы синтаксиса">
...
<h2>Движок представлений Razor</h2><div class="date">Последнее обновление: 19.11.2019</div>
...
<p>Представление в ASP.NET MVC может содержать не только стандартный код  html, но и также вставки кода на языке C#. Для обработки кода, содержащего как 
элементы html, так и конструкции C#, используется движок представлений.</p>
...
<p>По умолчанию в ASP.NET MVC Core  используется один движок представлений - <span class="b">Razor</span>. Хотя при желании мы можем также использовать какие-то другие сторонние движки или создать 
свой движок представлений самостоятельно.</p>
<p>Цель движка представлений Razor - определить переход от разметки html к коду C#.</p>
<p>Синтаксис Razor довольно прост - все его конструкции предваряются символом <span class="b">@</span>, после которого происходит переход к коду C#.</p>
...
<pre class="brush:xml;">&lt;p&gt;Дата: @DateTime.Now.ToLongDateString()&lt;/p&gt;</pre>
...
<img src="./pics/razor1.png" alt="Синтаксис движка представлений Razor" />
...
<p>Весь код в пределах блока расценивается как код c#. Однако с помощью конструкции <code>@:</code> мы можем в блоке кода выводить на веб-страницу текст:</p>
<pre class="brush:c#;">
@{ 
...
<img src="./pics/razor2.png" alt="Блоки кода в Razor в ASP.NET MVC" />
...
<p>В этом случае Razor будет рассматривать строку "Добро пожаловать" как набор операторов языка C#, которых, естественно в C# нет, поэтому мы получим ошибку. 
