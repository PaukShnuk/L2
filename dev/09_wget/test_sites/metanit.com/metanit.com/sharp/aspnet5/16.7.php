...
<html >
<head>
<title>ASP.NET Core | Управление пользователями</title>
<meta charset="utf-8" />
<meta name="description" content="Управление пользователями в ASP.NET Core Identity, использование методов UserManager для добавления, изменения и удаления пользователей">
...
<h2>Управление пользователями</h2><div class="date">Последнее обновление: 15.12.2019</div>
...
<p>Для администрирования пользователей продолжим работу с проектом из прошлой темы и добавим в папку Controllers новый контроллер <span class="b">UsersController</span>:</p>
<pre class="brush:c#;">
using System.Linq;
...
<p>Вся работа с пользователями производится с помощью ранее рассмотренных методов класса UserManager.</p>
<p>Для методов Create и Edit в папке ViewModels создадим дополнительные модели представлений:</p>
<pre class="brush:c#;">
...
<p>А в папку Views добавим подкаталог <span class="ii">Users</span> для представлений контроллера. Далее определим в ней представление 
<span class="ii">Index.cshtml</span> для вывода пользователей:</p>
<pre class="brush:xml;">
...
<p>Также добавим представление <span class="ii">Create.cshtml</span> для создания новых пользователей:</p>
<pre class="brush:xml;">
...
<p>И также добавим представление <span class="ii">Edit.cshtml</span> для редактирования пользователей:</p>
<pre class="brush:xml;">
...
<p>В итоге проект изменится следующим образом:</p>
<img src="./pics/customidentity11.png" alt="Администрирование в ASP.NET Core Identity" />
<p>В теперь при обращении к методу Index контроллера Users мы сможем увидеть список пользователей, отредактировать, удалить или добавить новых пользователей:</p>
<img src="./pics/customidentity10.png" alt="Управление пользователями в ASP.NET Core Identity" />
...
<div class="nav"><p><a href="./16.4.php">Назад</a><a href="./">Содержание</a><a href="./16.8.php">Вперед</a></p></div></div>
<div class="socBlock">
