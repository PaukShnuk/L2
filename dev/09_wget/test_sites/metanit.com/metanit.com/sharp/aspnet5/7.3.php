...
<html >
<head>
<title>ASP.NET Core MVC | Передача данных в представление</title>
<meta charset="utf-8" />
<meta name="description" content="Передача данных в представление в ASP.NET MVC Core, модель представления, strongly-typed views, строгая типизация представлений, объекты ViewBag и ViewData">
...
<h2>Передача данных в представление</h2><div class="date">Последнее обновление: 19.11.2019</div>
...
<p>Здесь динамически определяется во ViewData объект с ключом "Message" и значением "Hello ASP.NET Core". При этом в качестве значения может выступать любой объект. 
...
<p>Причем не обязательно устанавливать все объекты во ViewData в контроллере. Так, в данном случае объект с ключом "Title" устанавливается непосредственно в представлении.</p>
<h3>ViewBag</h3>
...
<p>Правда, чтобы выполнять различные операции, может потребоваться приведение типов, как в данном случае.</p>
...
<img src="./pics/viewmodel1.png" alt="Модель представления в ASP.NET MVC Core" />
