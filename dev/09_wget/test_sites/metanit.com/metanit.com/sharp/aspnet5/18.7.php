...
<html >
<head>
<title>ASP.NET Core | Фильтры RazorPages</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтры RazorPages в ASP.NET Core, интерфейсы IPageFilter и IAsyncPageFilter, методы OnPageHandlerExecuting и OnPageHandlerExecuted">
...
<h2>Фильтры RazorPages</h2><div class="date">Последнее обновление: 11.12.2019</div>
...
<img src="./pics/razorpagefilter1.png" alt="Razor Pages Filters in ASP.NET Core" />
...
<img src="./pics/razorpagefilter2.png" alt="Фильтры Razor Pages в ASP.NET Core" />
<p>А теперь обратимся к приложению из Internet Explorera:</p>
<img src="./pics/razorpagefilter3.png" alt="RazorPages Filters in ASP.NET Core MVC" />
...
<div class="nav"><p><a href="./17.2.php">Назад</a><a href="./">Содержание</a><a href="./15.1.php">Вперед</a></p></div></div>
<div class="socBlock">
