...
<html >
<head>
<title>ASP.NET Core | Объединение сортировки, фильтрации и пагинации</title>
<meta charset="utf-8" />
<meta name="description" content="Объединение сортировки, фильтрации и постраничной навигации в ASP.NET Core MVC">
...
<h2>Объединение сортировки, фильтрации и пагинации</h2><div class="date">Последнее обновление: 10.06.2018</div>
...
<p>Для работы с проектом пусть у нас будут определены следующие модели User и Company:</p>
<pre class="brush:c#;">
public class User
{
...
<p>И в классе Startup в методе <code>ConfigureServices()</code> настроим использование этого контекста данных:</p>
<pre class="brush:c#;">
...
<img src="./pics/paging6.png" alt="Создание проекта для пагинации в ASP.NET Core" />
...
фильтрацию, потом сортировку и в конце пагинацию. Исходя из этого, определим в контроллере HomeController следующий код:</p>
<pre class="brush:c#">
...
<p>И также изменим код представления <span class="ii">Index.cshtml</span>:</p>
<pre class="brush:xml;">
@using FilterSortPagingApp.Models
...
<img src="./pics/paging5.png" alt="Сортировка и пагинация в ASP.NET Core MVC" />
