...
<html >
<head>
<title>ASP.NET Core | Проект в Visual Studio for Mac</title>
<meta charset="utf-8" />
<meta name="description" content="Начало работы с ASP.NET Core в Visual Studio for Mac, создание и запуск приложения на MacOS">
...
<h2>Проект ASP.NET Core в Visual Studio for Mac</h2><div class="date">Последнее обновление: 21.06.2017</div>
...
<p>Также создавать приложения на ASP.NET Core мы можем в Visual Studio for Mac. Для этого нам надо сначала загрузить установщик данной среды 
разработки со страницы <a href="https://www.visualstudio.com/ru/downloads/" rel="nofollow">https://www.visualstudio.com/ru/downloads/</a>.</p>
<p>После загрузки запустим программу установки и на первом этапе нам надо обязательно указать опцию <span class="b">.NET Core</span>:</p>
<img src="./pics/mac6.png" alt="Установка Visual Studio for Mac" />
<p>После установки откроем Visual Studio for Mac и для создания нового проекта нажмем на кнопку <span class="b">New Project...</span>:</p>
<img src="./pics/mac1.png" alt="ASP.NET Core in Visual Studio for Mac" />
<p>Далее нам откроется окно выбора шаблона проекта. В левой части окна нам надо выбрать 
    <span class="b">.NET Core -&gt; App</span>. После этого в центральной части появятся типы проектов. Для веба здесь 
    представлены все те же типы проектов, что и в Windows-версии Visual Studio:</p>
    <ul>
        <li><p><span class="b">ASP.NET Core Empty</span></p></li>
        <li><p><span class="b">ASP.NET Core Web App</span></p></li>
        <li><p><span class="b">ASP.NET Core Web API</span></p></li>
    </ul>
<p>В данном случае выберем шаблон <span class="b">ASP.NET Core Empty</span></p>
<img src="./pics/mac2.png" alt="Создание проекта ASP.NET Core в Visual Studio for Mac" />
<p>Далее в следующем окне укажем имя проекта и его расположение на жестком диске. Пусть проект называется 
    HelloApp:</p>
<img src="./pics/mac3.png" alt="ASP.NET Core на MacOS" />
<p>После этого Visual Studio создаст новый проект. Как и в версии для Windows, проект имеет два файла: 
    Program.cs, в котором происходит запуск приложения, и Startup.cs, где определен класс Startup c логикой обработки запроса.</p>
</p>
<p>Класс Startup уже имеет некоторую базовую логику для обработки запроса, суть которой заключается в отправке пользователю 
    в ответ на запрос строки "Hello World". Поэтому запустим проект, нажав на черную стрелку над структурой проекта:
</p>
<img src="./pics/mac4.png" alt="Запуск приложения ASP.NET Core на MacOS" />
<p>И после запуска в браузере по умолчанию отобразится выше указанная строка:</p>
<img src="./pics/mac5.png" alt="Первое приложение ASP.NET Core на MacOS" />
<p>В остальных аспектах разработка приложений на ASP.NET Core на MacOS будет аналогична разработке на Windows.</p>
...
<div class="nav"><p><a href="./1.2.php">Назад</a><a href="./">Содержание</a><a href="./2.13.php">Вперед</a></p></div></div>
<div class="socBlock">
