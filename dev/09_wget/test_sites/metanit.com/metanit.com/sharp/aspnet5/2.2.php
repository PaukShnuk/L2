...
<html >
<head>
<title>ASP.NET Core | Конвейер обработки запроса и middleware</title>
<meta charset="utf-8" />
<meta name="description" content="Конвейер обработки запроса и компоненты middleware и их роль в обработке запроса в ASP.NET Core">
...
<h2>Конвейер обработки запроса и middleware</h2><div class="date">Последнее обновление: 30.10.2019</div>
...
<img src="./pics/middlewarelifecycle1.png" alt="Жизненный цикл middleware в ASP.NET Core" />
<p>Однако при последующих запросах мы увидим, что результат переменной х не равен 4.</p>
<img src="./pics/middlewarelifecycle2.png" alt="Жизненный цикл приложения в ASP.NET Core" />
