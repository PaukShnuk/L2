...
<html >
<head>
<title>ASP.NET Core | Tag-хелперы и сложные объекты и коллекции</title>
<meta charset="utf-8" />
<meta name="description" content="Передача коллекций и сложных объектов в Tag-хелперы в ASP.NET Core MVC, использования одного tag-хелпера в другом">
...
<h2>Tag-хелперы и модели</h2><div class="date">Последнее обновление: 08.12.2019</div>
...
<p>Аналогично идет работа со сложными моделями. Например, пусть у нас определена следующая модель User:</p>
<pre class="brush:c#;">
public class User
{
...
<p>Также, как и в предыдущем случае, через свойство User класс получает переданные из представления данные и с их помощью создает разметку html.</p>
...
<p>Поскольку класс хелпера в названии имеет две части, начинающихся с заглавной буквы: UserInfo (не считая суффикса TagHelper), то этому классу 
будет соответствовать тег <code>user-info</code>. При запуске приложение сгенерирует разметку для вывода информации об объекте User:</p>
<img src="./pics/3.2.png" alt="Tag Helper и модели в ASP.NET Core MVC" />
...
<div class="nav"><p><a href="./10.12.php">Назад</a><a href="./">Содержание</a><a href="./7.6.php">Вперед</a></p></div></div>
<div class="socBlock">
