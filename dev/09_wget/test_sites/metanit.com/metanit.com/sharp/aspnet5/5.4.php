...
<html >
<head>
<title>ASP.NET Core MVC | ContentResult и JsonResult</title>
<meta charset="utf-8" />
<meta name="description" content="ContentResult и JsonResult в ASP.NET Core MVC, отправка результата в виде строки и в формате json">
...
<h2>ContentResult и JsonResult</h2><div class="date">Последнее обновление: 17.11.2019</div>
...
<img src="./pics/controllers5.png" alt="ContentResult в ASP.NET MVC Core" />
<h3>JsonResult</h3>
...
<p>И тогда для отправки клиенту объекта User мы можем написать следующий метод:</p>
<pre class="brush:c#;">
...
<p>При обращении к методу из адресной строки браузера веб-браузер выведет полное описание объекта в формате json:</p>
<img src="./pics/json.png" alt="Отправка JSON в ASP.NET MVC Core" />
