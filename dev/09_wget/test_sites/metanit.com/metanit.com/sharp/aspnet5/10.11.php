...
<html >
<head>
<title>ASP.NET Core | Контекст хелпера и получение зависимостей</title>
<meta charset="utf-8" />
<meta name="description" content="Контекст ViewContext и получение зависимостей в tag-хелпере в ASP.NET Core MVC, получение данных запроса">
...
<h2>Контекст хелпера и получение зависимостей</h2><div class="date">Последнее обновление: 07.12.2019</div>
...
<p>Зарегистрируем сервис ITimeService в методе </p>
<pre class="brush:c#;">
...
<img src="./pics/customtaghelper5.png" alt="ViewContext в Tag Helper в ASP.NET Core MVC" />
...
<div class="nav"><p><a href="./10.10.php">Назад</a><a href="./">Содержание</a><a href="./10.12.php">Вперед</a></p></div></div>
<div class="socBlock">
