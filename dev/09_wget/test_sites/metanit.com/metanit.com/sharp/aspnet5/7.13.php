...
<html >
<head>
<title>ASP.NET Core | ViewViewComponentResult и представления</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с представлениями в View Component в ASP.NET Core MVC, использование класса ViewComponentResult">
...
<h2>ViewViewComponentResult и генерация представления</h2><div class="date">Последнее обновление: 28.11.2019</div>
...
ViewComponent, то для генерации объекта ViewViewComponentResult мы можем вызвать унаследованный метод View.</p>
...
<p>Так, определим следующий класс компонента UsersListViewComponent:</p>
<pre class="brush:c#;">
...
<p>По умолчанию в проекте уже есть контроллер HomeController. И, допустим, наш UsersListViewComponent будет использоваться только в представлениях 
этого контроллера. В этом случае добавим в папку <span class="b">Views/Home</span> новый каталог, который назовем <span class="b">Components</span>. 
...
<img src="./pics/viewcomponent.png" alt="View Component in ASP.NET MVC Core" />
<p>Теперь мы можем использовать компонент. Для этого определим в представлении <span class="ii">Index.cshtml</span> следующие строки:</p>
<pre class="brush:xml;">
&lt;div&gt;
...
<img src="./pics/viewcomponent2.png" alt="View Component в ASP.NET MVC Core" />
