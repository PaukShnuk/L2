...
<html >
<head>
<title>ASP.NET Core | Работа со статическими файлами</title>
<meta charset="utf-8" />
<meta name="description" content="Работа со статическими файлами в ASP.NET Core, файлы по умолчанию, просмотр содержимого каталогов, методы UseDefaultFiles и UseDirectoryBrowser">
...
<h2>Работа со статическими файлами</h2><div class="date">Последнее обновление: 02.11.2019</div>
...
<p>Если файл будет найден, то он будет отправлен в ответ клиенту. Если же файл не будет найден, то продолжается обычная обработка запроса с помощью следующих 
...
<p>В этом случае в качестве страницы по умолчанию будет использоваться файл <i>hello.html</i>.</p>
...
<img src="./pics/UseDirectoryBrowser.png" alt="Метод app.UseDirectoryBrowser в ASP.NET Core" />
...
каталогами. Так, в данном случае путь типа <i>http://localhost:56431/pages/</i> будет сопоставляться с каталогом "wwwroot\html".</p>
<img src="./pics/UseDirectoryBrowser2.png" />
...
в предыдущем примере. И в отличие от первого вызова он обрабатывает запросы по пути <i>http://localhost:xxxx/pages</i>, сопоставляя данные запросы с 
папкой <i>wwwroot/html</i>. К примеру, по запросу <i>http://localhost:56431/pages/index.html</i> мы можем обратиться к файлу <i>wwwroot/html/index.html</i>.</p>
...
<p>В этом случае будет разрешен обзор каталога по пути <span class="ii">http://localhost:xxxx/pages/</span>, но при этом путь <span class="ii">http://localhost:xxxx/html/</span> 
работать не будет.</p>
...
<div class="nav"><p><a href="./2.5.php">Назад</a><a href="./">Содержание</a><a href="./17.1.php">Вперед</a></p></div></div>
<div class="socBlock">
