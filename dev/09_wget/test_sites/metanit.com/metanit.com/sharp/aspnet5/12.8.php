...
<html >
<head>
<title>ASP.NET Core | Tag-хелпер для постраничной навигации</title>
<meta charset="utf-8" />
<meta name="description" content="Создание tag-хелпера для постраничной навигации в ASP.NET Core MVC">
...
<h2>Tag-хелпер для постраничной навигации</h2><div class="date">Последнее обновление: 09.12.2019</div>
...
<p>Но, как правило, для создания постраничной навигации создаются какие-то специальные панельки, где можно увидеть ссылки с номерами страниц, по которым 
...
Поэтому добавим в проект новую папку <span class="ii">TagHelpers</span>, а в эту папку добавим новый класс <span class="b">PageLinkTagHelper</span>:</p>
<pre class="brush:c#;">
...
<p>Для стилизации ссылок применяются классы pagination, page-item и page-link фреймворка bootstrap, который подключается в приложении ASP.NET Core MVC по умолчанию.</p>
...
<img src="./pics/paging3.png" alt="Pagination in ASP.NET Core MVC" />
<p>И при запуске проекта мы увидим набор стилизованных ссылок, по котором сможем перемещаться по страницам:</p>
<img src="./pics/paging4.png" alt="Постраничная навигация в ASP.NET Core" />
...
<div class="nav"><p><a href="./12.7.php">Назад</a><a href="./">Содержание</a><a href="./12.9.php">Вперед</a></p></div></div>
<div class="socBlock">
