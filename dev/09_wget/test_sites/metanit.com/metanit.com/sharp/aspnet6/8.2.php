...
<html >
<head>
<title>ASP.NET Core и C# | Куки</title>
<meta charset="utf-8" />
<meta name="description" content="Установка, получение и удаление кук cookie в ASP.NET Core и C#, коллекция IRequestCookieCollection, Request.Cookies и Response.Cookies">
...
<h2>Куки</h2><div class="date">Последнее обновление: 23.12.2021</div>
...
<p>Куки представляют самый простой способ сохранить данные пользователя. Куки хранятся на компьютере пользователя и могут устанавливаться как на сервере, так и на клиенте. 
...
<p>Например, объединим в приложении установку и получение кук:</p>
<pre class="brush:c#;">
...
<img src="./pics/8.2.png" alt="Куки в ASP.NET Core и C#" />
...
<img src="./pics/8.3.png" alt="Установка и получение cookie куки в ASP.NET Core и C#" />
