...
<html >
<head>
<title>ASP.NET Core и C# | Scoped-сервисы в singleton-объектах</title>
<meta charset="utf-8" />
<meta name="description" content="Singleton-объекты и классы middleware и scoped-сервисы в ASP.NET Core и C#, возможные ошибки и их решение">
...
<h2>Scoped-сервисы в singleton-объектах</h2><div class="date">Последнее обновление: 18.12.2021</div>
...
<p>TimerMiddleware является singleton-объектом. И теперь зарегистрируем сервис TimeService как scoped-объект:</p>
<pre class="brush:c#;">
...
<p>Если мы запустим приложение, то консоль приложения нам отобразит ошибку типа "InvalidOperationException: Cannot resolve scoped service 'TimeService' from root provider.":</p>
<img src="./pics/4.12.png" alt="Cannot resolve scoped service from root provider в ASP.NET Core и C#" />
...
<img src="./pics/4.13.png" alt="Cannot resolve from root provider because it requires scoped service в ASP.NET Core и C#" />
...
<img src="./pics/4.14.png" alt="Cannot consume scoped service from singleton in ASP.NET Core и C#" />
