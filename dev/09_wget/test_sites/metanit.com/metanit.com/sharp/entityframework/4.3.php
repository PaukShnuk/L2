...
<html >
<head>
<title>Сортировка в LINQ to Entities | Entity Framework 6</title>
<meta charset="utf-8" />
...
<h2>Сортировка</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Для упорядочивания полученных из бд данных по возрастанию служит метод <span class="bb">OrderBy</span> или оператор <span class="bb">orderby</span>. Например, отсортируем объекты по возрастанию по свойству Name:</p>
<pre class="brush:c#;">
...
<p>Для сортировки по убыванию применяется метод <span class="bb">OrderByDescending()</span>:</p>
<pre class="brush:c#;">
var phones = db.Phones.OrderByDescending(p=&gt;p.Name);
</pre>
<p>Если нам надо отсортировать данные сразу по нескольким критериям, то мы можем применить методы <span class="bb">ThenBy()</span>(для сортировки по возрастанию) и 
<span class="bb">ThenByDescending()</span>. Например, отсортируем результат проекции по двум столбцам:</p>
<pre class="brush:c#;">
