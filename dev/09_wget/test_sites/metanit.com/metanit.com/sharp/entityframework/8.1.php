...
<html >
<head>
<title>Асинхронность | Entity Framework 6</title>
<meta charset="utf-8" />
...
<h1>Асинхронность в Entity Framework</h1>
<h2>Асинхронные операции</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Начиная с версии 6.0 Entity Framework поддерживает асинхронные операции. Для сохранения результатов в базе данных в асинхронном режиме используется 
метод <span class="bb">SaveChangesAsync</span>.</p>
<p>Чтобы получить объект по id в асинхронном режиме, в классе DbSet определен метод <span class="bb">FindAsync</span>.</p>
<p>Некоторые методы Linq to Entities также имеют асинхронных двойников для осуществления запросов в асинхронном режиме:</p>
<ul>
<li><p><span class="bb">ForEachAsync</span>: асинхронное извлечение данных и выполнение над ними определенных действий</p></li>
<li><p><span class="bb">AllAsync</span>: удовлетворяет ли все элементы в выборке определенному условию</p></li>
<li><p><span class="bb">AnyAsync</span>: удовлетворяет ли хотя бы один элемент выборки определенному условию</p></li>
<li><p><span class="bb">AverageAsync</span>: асинхронное получение среднего значения</p></li>
<li><p><span class="bb">ContainsAsync</span>: содержит ли выборка определенный элемент</p></li>
<li><p><span class="bb">CountAsync</span>: получение размера выборки</p></li>
<li><p><span class="bb">FirstAsync</span>: получение первого элемента</p></li>
<li><p><span class="bb">FirstOrDefaultAsync</span>: получение первого элемента или значения по умолчанию</p></li>
<li><p><span class="bb">LoadAsync</span>: асинхронная загрузка данных в кэш</p></li>
<li><p><span class="bb">MaxAsync</span>: получение максимального значения</p></li>
<li><p><span class="bb">MinAsync</span>: получение минимального значения</p></li>
<li><p><span class="bb">SingleAsync</span>: получение одного элемента</p></li>
<li><p><span class="bb">SingleOrDefaultAsync</span>: получение одного элемента или значения по умолчанию</p></li>
<li><p><span class="bb">SumAsync</span>: асинхронное получение суммы значений</p></li>
</ul>
<p>Все методы возвращают объект задачи <span class="bb">Task</span> или <span class="bb">Task&lt;T&gt;</span></p>
<p>Например, выполним асинхронное сохранение и асинхронную выборку из БД:</p>
<pre class="brush:c#;">
using System;
...
<p>Кроме асинхронных операций Linq to Entities нам  доступно асинхронное осуществление команд в БД с помощью метода <span class="bb">ExecuteSqlCommandAsync</span>:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="7.3.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
