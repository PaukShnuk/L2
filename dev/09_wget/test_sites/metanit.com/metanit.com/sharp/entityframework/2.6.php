...
<html >
<head>
<title>Соглашения по наименованию в Code First | Entity Framework 6</title>
<meta charset="utf-8" />
...
<h2>Соглашения по наименованию в Code First</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>При создании таблиц и их столбцов в базе данных в Entity Framework по умолчанию действуют некоторые соглашения по именованию, которые указывают, какие имена должны 
быть у таблиц, столбцов, какие типы и т.д. Рассмотрим некоторые из этих соглашений.</p>
<h3>Сопоставление типов</h3>
<p>Типы SQL Serverа и C# сопоставляются следующим образом:</p>
<ul>
<li><p>int : int</p></li>
<li><p>bit : bool</p></li>
<li><p>char : string</p></li>
<li><p>date : DateTime</p></li>
<li><p>datetime : DateTime</p></li>
<li><p>datetime2 : DateTime</p></li>
<li><p>decimal : decimal</p></li>
<li><p>float : double</p></li>
<li><p>money : decimal</p></li>
<li><p>nchar : string</p></li>
<li><p>ntext : string</p></li>
<li><p>numeric : decimal</p></li>
<li><p>nvarchar : string</p></li>
<li><p>real : float</p></li>
<li><p>smallint : short</p></li>
<li><p>text : string</p></li>
<li><p>tinyint : byte</p></li>
<li><p>varchar : string</p></li>
</ul>
<h3>NULL и NOT NULL</h3>
<p>Все первичные ключи по умолчанию имеют определение NOT NULL.</p>
<P>Столбцы, сопоставляемые со свойствами ссылочных типов (string, array), в базе данных имеют определение NULL, а все значимые типы (DateTime, bool, char, decimal, 
int, double, float) - NOT NULL.</P>
<P>Если свойство имеет тип <code>Nullable&lt;T&gt;</code>, то оно сопоставляется со столбцом с определением NULL.</P>
<h3>Ключи</h3>
<p>Entity Framework требует наличия первичного ключа, так как это позволяет ему отслеживать объекты. По умолчанию в качестве ключей EF рассматривает свойства с именем <i>Id</i> или <i>[Название_типа]Id</i> (например, PostId в классе Post).</p>
<p>Как правило, ключи имеют тип <code>int</code> или <code>GUID</code>, но также могут представлять и любой другой примитивный тип.</p>
<h3>Названия таблиц и столбцов</h3>
<p>С помощью специального класса <span class="bb">PluralizationService</span> Entity Framework проводит сопоставление между именами классов моделей и именами таблиц. 
При этом таблицы получают по умолчанию в качестве названия множественное число в соответствии с правилами английского языка, например, класс User - таблица Users, 
класс Person - таблица People (но не Persons!).</p>
<p>Названия столбцов получают названия свойств модели.</p>
<p>Если нас не устраивают названия таблиц и столбцов по умолчанию, то мы можем переопределить данный механизм с помощью Fluent API или аннотаций.</p>
...
<div class="nav"><p><a href="2.2.php">Назад</a><a href="./">Содержание</a><a href="2.1.php">Вперед</a></p></div></div>
<div class="socBlock">
