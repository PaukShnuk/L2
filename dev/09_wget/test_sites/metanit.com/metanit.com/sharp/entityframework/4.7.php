...
<html >
<head>
<title>Агрегатные операции в LINQ to Entities | C# Entity Framework 6</title>
<meta charset="utf-8" />
...
<h2>Агрегатные операции</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Linq to Entities поддерживает обращение к встроенным функциями SQL через специальные методы Count, Sum и т.д.</p>
...
<p>Для нахождения минимального, максимального и среднего значений по выборке применяются функции <span class="bb">Min()</span>, <span class="bb">Max()</span> 
и <span class="bb">Average()</span> соответственно. Найдем минимальную, максимальную и среднюю цену по моделям:</p>
<pre class="brush:c#;">
using(PhoneContext db = new PhoneContext())
{
    // минимальная цена
...
<p>Для получения суммы значений используется метод <span class="bb">Sum()</span>:</p>
<pre class="brush:c#;">
using(PhoneContext db = new PhoneContext())
{
...
<div class="nav"><p><a href="4.6.php">Назад</a><a href="./">Содержание</a><a href="1.4.php">Вперед</a></p></div></div>
<div class="socBlock">
