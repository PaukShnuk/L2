...
<html >
<head>
<title>Две модели в одной таблице | Entity Framework 6</title>
<meta charset="utf-8" />
...
<h2>Две модели в одной таблице</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>В предыдущей теме два класса по сути относились к одной модели и хранились в одной таблице. Рассмотрим другую конфигурацию. Две модели связаны между собой, 
и было бы логично хранить их в одной таблице. В то же время мы можем оставить возможность работать с ними независимо друг от друга.</p>
<p>Чтобы две модели сохранялись в одну таблицу, они должны иметь между собой связь одни-ко-одному. а также иметь общий ключ. Например:</p>
<pre class="brush:c#;">
[Table("Mobiles")]
...
<p>Модели Phone и PnoneInfo имеют один и тот же первичный ключ, который также выполняет роль внешнего ключа. В итоге сформируется следующая таблица:</p>
<img src="pics/6.6.png" />
<p>Использование моделей:</p>
<pre class="brush:c#;">
