...
<html >
<head>
<title>Подход TPT | Наследование в Entity Framework 6</title>
<meta charset="utf-8" />
<meta name="description" content="Наследование в Entity Framework 6. Подход TPT">
...
<h2>Подход TPT</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Подход TPT (Table Per Type / Таблица на тип) предполагает сохранение в общей таблице только тех свойств, которые общие для всех классов-наследников, 
то есть которые определены в базовом классе. А те свойства, которые относятся только к производному классу, сохраняются в отдельной таблице.</p>
<p>Чтобы применить подход, возьмем из предыдущего примера систему классов и добавим к классу Smartphone атрибут Table:</p>
<pre class="brush:c#;">
public class Phone
{
...
<p>Все остальное остается также, как и при подходе TPH. Но теперь база данных будет содержать следующие таблицы:</p>
<img src="pics/6.10.png" />
<p>Таблица для смартфонов содержит только оно поле OS, а также ключ Id для связи с таблицей Phones.</p>
<p>Применение моделей будет аналогично подходу TPH:</p>
<pre class="brush:c#;">
