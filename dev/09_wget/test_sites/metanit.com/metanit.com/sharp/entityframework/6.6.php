...
<html >
<head>
<title>Разделение сущности на несколько таблиц | Entity Framework 6</title>
<meta charset="utf-8" />
<meta name="description" content="Разделение сущности на несколько таблиц в Entity Framework 6">
...
<h2>Разделение сущности на несколько таблиц</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/efcore/">Руководство по Entity Framework Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>В предыдущей теме два класса объединялись в одну таблицу. Но мы также можем сделать и обратное действие - сохранить разные свойства одного класса 
в разных таблицах. Например, нам потребовалось важную информацию о модели сохранить в одной таблице, а вспомогательную информацию - в другой.</p>
<pre class="brush:c#;">
public class Phone
{
...
<p>С помощью метода Map осуществляется сопоставление отдельных свойств с таблицами. Так, данные для свойства Name будут храниться в таблице <i>Mobiles</i>, 
а данные для свойств Company и Price - в таблице <i>MobilesInfo</i>. Id мы можем опустить, так как данное поле будет указываться для обеих таблиц для их связи.</p>
<p>В итоге сформируются две таблицы:</p>
<img src="pics/6.7.png" />
<p>Работа с моделью будет проходить аналогично стандартным моделям:</p>
<pre class="brush:c#;">
