...
<html >
<head>
<title>Entity Framework Core и C# | Запросы LINQ to Entities</title>
<meta charset="utf-8" />
<meta name="description" content="Введение в LINQ to Entities в Entity Framework Core и C#, выполнение запросов к базе данных, основные методы">
...
<h1>Запросы LINQ to Entities</h1><h2>Введение в LINQ to Entities</h2><div class="date">Последнее обновление: 21.11.2021</div>
...
<p>Для извлечения данных из базы данных Entity Framework Core использует технологию <span class="b">LINQ to Entities</span>. 
В основе данной технологии лежит язык интегрированных запросов LINQ (Language Integrated Query). LINQ предлагает простой и интуитивно понятный подход 
для получения данных с помощью выражений, которые по форме близки выражениям языка SQL.</p>
<p>Хотя при работе с базой данных мы оперируем запросами LINQ, но, реляционные базы данных как MS SQL Server или SQLite, понимают только запросы на 
языке SQL. Поэтому Entity Framework Core, используя выражения LINQ to Entities, транслирует их в определенные запросы, понятные для используемого источника данных.</p>
