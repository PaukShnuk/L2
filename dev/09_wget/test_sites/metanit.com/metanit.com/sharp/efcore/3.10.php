...
<html >
<head>
<title>Entity Framework Core и C# | Настройка внешнего ключа через аннотации данных и Fluent API</title>
<meta charset="utf-8" />
<meta name="description" content="Настройка внешнего ключа через аннотации данных и Fluent API в Entity Framework Core в языке программирования C#, атрибут ForeignKey и методы HasForeignKey и HasPrincipalKey">
...
<h2>Настройка внешнего ключа через аннотации данных и Fluent API</h2><div class="date">Последнее обновление: 20.11.2021</div>
...
<p>В случае БД SQLite будут генерироваться следующие таблицы:</p>
<pre class="brush:sql;">
CREATE TABLE "Users" (
	"Id"	INTEGER NOT NULL,
	"Name"	TEXT,
...
<p>Для настройки отношений между моделями с помощью Fluent API применяются специальные методы: <span class="b">HasOne / HasMany / WithOne / WithMany</span>. 
Методы <span class="b">HasOne</span> и <span class="b">HasMany</span> устанавливают навигационное свойство для сущности, для которой производится конфигурация. Далее 
...
Методы <span class="b">HasOne/WithOne</span> применяются для обычного навигационного свойства, представляющего одиночный объект, а методы 
...
<p>В этом случе будут сгенерированы такие же таблицы, как и в предыдущем примере.</p>
<h3>Установка в качестве внешнего ключа произвольного свойства</h3>
...
<p>Определение таблицы Users в SQLite будет выглядеть следующим образом:</p>
<pre class="brush:sql;">
CREATE TABLE "Users" (
	"Id"	INTEGER NOT NULL,
	"Name"	TEXT,
...
<p>В программе при добавлении объектов в БД в этом случае можно установить как навигационное свойство, так и свойство внешнего ключа:</p>
<pre class="brush:c#;">
