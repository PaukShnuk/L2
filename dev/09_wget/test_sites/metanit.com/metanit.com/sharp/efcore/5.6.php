...
<html >
<head>
<title>Entity Framework Core и C# | IEnumerable и IQueryable</title>
<meta charset="utf-8" />
<meta name="description" content="Использование интерфейсов IEnumerable и IQueryable в Entity Framework Core и языке C#, их отличия и влияние на выполнение запроса">
...
<h2>IEnumerable и IQueryable</h2><div class="date">Последнее обновление: 21.11.2021</div>
...
<p>Для примера здесь получаем всех пользователей, у которых id меньше 10.</p>
...
<p>Чтобы совместить фильтры, нам надо было сразу применить метод Where: <code>db.Users.Where(p =&gt; p.Id &lt; 10);</code></p>
...
<p>Таким образом, все методы суммируются, запрос оптимизируется, и только потом, когда идет обращеие к методу <span class="b">ToList()</span>, происходит выборка из базы данных.</p>
