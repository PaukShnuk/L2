...
<html >
<head>
<title>Entity Framework Core и C# | PostgreSQL</title>
<meta charset="utf-8" />
...
<h2>PostgreSQL</h2><div class="date">Последнее обновление: 22.11.2021</div>
...
<p>Для работы с базой данных PostgreSQL в проект необходимо добавить 
...
<p>Для подключения к существующей базе данных в PostgreSQL необходимо в окне <span class="b">Package Manager Console</span> выполнить команду Scaffold-DbContext, 
...
<pre class="brush:c#;">Scaffold-DbContext "Host=localhost;Port=5432;Database=usersdb;Username=postgres;Password=123456789"</pre>
...
<div class="nav"><p><a href="./7.2.php">Назад</a><a href="./">Содержание</a><a href="./2.1.php">Вперед</a></p></div></div>
<div class="socBlock">
