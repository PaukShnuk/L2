...
<html >
<head>
<title>Entity Framework Core и C# | MS SQL Server</title>
<meta charset="utf-8" />
<meta name="description" content="MS SQL Server в Entity Framework Core и C#, провайдер Microsoft.EntityFrameworkCore.SqlServer, метод UseSqlServer">
...
<h1>Провайдеры баз данных</h1><h2>MS SQL Server</h2><div class="date">Последнее обновление: 23.11.2021</div>
...
<p>Для работы с базой данных MS SQL Server через Entity Framework Core в проект необходимо добавить 
Nuget-пакет <span class="b">Microsoft.EntityFrameworkCore.SqlServer</span>:</p>
<img src="./pics/7.4.png" alt="MS SQL Server в Entity Framework Core и C#" />
...
<p>Для подключения к SQL Server у класса <span class="b">DbContextOptionsBuilder</span> определен метод расширения <span class="b">UseSqlServer</span>, 
в который передается строка подключения для соединения с MS SQL Server. Строка подключения разбивается на несколько частей:</p>
<ul>
...
специально для нужд разработки. Для MS SQL Server Express этот параметр, как правило, имеет значение <code>.\SQLEXPRESS</code></p></li>
<li><p><span class="b">Database</span>: название базы данных</p></li>
<li><p><span class="b">Trusted_Connection</span>: устанавливает проверку подлинности</p></li>
</ul>
<p>В данном случае мы определяем, что в качестве сервера будет использоваться 
движок <span class="b">localdb</span>, который предназначен специально для разработки:<code>("Server=(localdb)\mssqllocaldb")</code>, 
а база данных будет называться <code>helloappdb</code> (<code>"Database=helloappdb"</code>).</p>
<p>Подробно про элементы строки подключения к MS SQL Server можно найти здесь: <a href="https://metanit.com/sharp/adonetcore/2.1.php">Строка подключения для MS SQL Server</a></p>
...
<div class="nav"><p><a href="./2.2.php">Назад</a><a href="./">Содержание</a><a href="./7.2.php">Вперед</a></p></div></div>
<div class="socBlock">
