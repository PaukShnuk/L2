...
<html >
<head>
<title>Entity Framework Core и C# | Каскадное удаление</title>
<meta charset="utf-8" />
<meta name="description" content="Каскадное удаление в Entity Framework Core и C#, отключение удаления, установка значения null для свойства">
...
<h2>Каскадное удаление</h2><div class="date">Последнее обновление: 20.11.2021</div>
...
<p>Здесь свойство внешнего ключа имеет тип <code>int</code>, оно не допускает значения null и требует наличия конкретного значения - id 
связанного объекта Company (При этом то, что навигационное свойство Company допускает null, не имеет значения). 
...
<p>Аналогичная связь будет устанавливаться, если свойство-внешний ключа отсутствует, а навигационное свойство НЕ представляет nullable-тип:</p>
<pre class="brush:c#;">
public class User
{
    Company? company;
...
<p>Такая же таблица создается, если навигационное свойство представляет nullable-тип, но оно определено как обязательное, например, с помощью атрибута <span class="b">Required</span>:</p>
<pre class="brush:c#;">
...
<p>Аналогичная связь будет устанавливаться, если свойство-внешний ключа отсутствует, а навигационное свойство представляет nullable-тип:</p>
<pre class="brush:c#;">
public class User
{
    public int Id { get; set; }
