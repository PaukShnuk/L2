...
<html >
<head>
<title>C# и WPF | ListBox</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент ListBox в WPF, его основные свойства и принципы работы, взаимодействие с коллекциями и массивами">
...
<h2>ListBox</h2><div class="date">Последнее обновление: 18.01.2016</div>
...
<p>Представляет собой обычный список. Содержит коллекцию элементов ListBoxItem, которые являются типичными элементами управления содержимым. 
...
<img src="./pics/4.14.png" alt="Элемент ListBox в WPF" />
<p>Все эти элементы будут находиться в коллекции <code>phonesList.Items</code> и, таким образом, по счетчику можно к ним обращаться, например, 
<code>phonesList.Items[0]</code> - первый элемент ListBox, который в данном случае представляет TextBlock. Также мы можем установить элемент: 
<code>phonesList.Items[2]="LG G 4";</code><p>
...
<img src="./pics/4.15.png" />
<p>Мы можем использовать элементы как внутри элемента ListBoxItem, так и непосредственно вставляя их в список. Однако на следующем примере видно, 
что использование ListBoxItem имеет небольшое преимущество, так как мы можем задать некоторые дополнительные свойства, например, отступы.</p>
