...
<html >
<head>
<title>C# и WPF | Анимация пути</title>
<meta charset="utf-8" />
<meta name="description" content="Анимация пути в WPF, использование объекта PathGeometry для создания анимаций, примеры использования">
...
<h2>Анимация пути</h2><div class="date">Последнее обновление: 04.03.2016</div>
...
<p>Еще один вид анимаций - это анимация пути (path-based animation). Она также анимирует определенное свойство. Ее особенность в том, что для анимации 
свойства используется объект <span class="b">PathGeometry</span>.</p>
<p>Анимации пути представлены тремя классами: DoubleAnimationUsingPath, MatrixAnimationUsingPath, PointAnimationUsingPath.</p>
<p>Каждый объект анимации с помощью свойства <code>PathGeometry</code> устанавливает ссылку на объект PathGeometry, а свойство <code>Source</code> 
получает или задает аспект объекта анимации PathGeometry, определяющий ее выходное значение.</p>
<p>Особенно полезны такие анимации при позиционировании объекта в окне приложения:</p>
<pre class="brush: xml;">
...
<p>При запуске мы увидим, как небольшой шарик бегает по прямоугольному контуру:</p>
<img src="./pics/17.1.png" alt="Path-Based Animation в WPF" />
<p>Здесь одна из применяемых анимаций имеет следующую форму:</p>
<pre class="brush:xml;">
&lt;DoubleAnimationUsingPath Storyboard.TargetProperty="(Canvas.Left)"
        Duration="0:0:5" RepeatBehavior="Forever"
        PathGeometry="{StaticResource geometryPath}" Source="X" &gt;
</pre>
<p>В данном случае анимация применяется к свойству <code>Canvas.Left</code> объекта Ellipse. Длится 5 секунд и бесконечно повторяется.</p>
<p>PathGeometry устанавливает ссылку на ресурс, а атрибут Source указывает, что для нового значения свойства Canvas.Left будет использоваться параметр X (координата по оси X) 
у точек, которые составляют PathGeometry.</p>
