...
<html >
<head>
<title>C# и WPF | ToolBar</title>
<meta charset="utf-8" />
<meta name="description" content="Создание панели инструментов в WPF с помощью элемента ToolBar, наполнение ее объектами, создание стека панелей с использованием класса ToolBarTray">
...
<h2>ToolBar</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Этот элемент, как правило, применяется для обеспечения быстрого доступа к наиболее часто используемым операциям. Он может содержать прочие 
элементы как кнопки, текстовые поля, объекты Menu и др. </p>
<pre class="brush:xml;">
...
<img src="./pics/4.22.png" alt="Элемент ToolBar в WPF" />
<p>Также можно создавать сразу несколько связанных элементов <span class="bb">ToolBar</span> внутри <span class="bb">ToolBarTray</span>. 
Преимущество его использования заключается в возможности задать как горизонтальное, так и вертикальное расположение элементов ToolBar в окне приложения.</p>
<pre class="brush:xml;">
&lt;ToolBarTray&gt;
     &lt;ToolBar Height="25" VerticalAlignment="Top"&gt;
		&lt;ToggleButton&gt;&lt;Image Source="icon0.gif" /&gt;&lt;/ToggleButton&gt;
...
<img src="./pics/4.23.png" alt="Элемент ToolBarTray в WPF" />
<p>Используя свойство Orientation мы можем настроить у ToolBarTray ориентацию. По умолчанию она горизонтальная, но мы можем расположить его вертикально:</p>
<pre class="brush:xml;">
...
<p>Еще один элемент - <b>StatusBar</b>, во многом напоминает ToolBar и выполняет схожие функции, только в отличие о ToolBar его располагают обычно внизу окна приложения.</p>
