...
<html >
<head>
<title>C# и WPF | StackPanel</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер StackPanel в WPF, создание стека элементов, горизонтальное и вертикальное размещение элементов в StackPanel, примеры использования">
...
<h2>StackPanel</h2><div class="date">Последнее обновление: 16.01.2016</div>
...
<p>Это более простой элемент компоновки. Он располагает все элементы в ряд либо по горизонтали, либо по вертикали в зависимости от ориентации. Например,</p>
<pre class="brush:xml;">
...
<img src="./pics/3.6.png" alt="Вертикальный StackPanel в WPF" />
<p>В данном случае для свойства Orientation по умолчанию используется значение <code>Vertical</code>, то есть StackPanel создает вертикальный ряд, 
...
<img src="./pics/3.7.png" alt="Горизонтальный StackPanel в  WPF" />
<p>При горизонтальной ориентации все вложенные элементы располагаются слева направо. Если мы хотим, чтобы наполнение стека начиналось справа налево, 
то нам надо задать свойство <code>FlowDirection</code>: <code>&lt;StackPanel Orientation="Horizontal" FlowDirection="RightToLeft"&gt;</code>. 
По умолчанию это свойство имеет значение <code>LeftToRight</code> - то есть слева направо.</p>
