...
<html >
<head>
<title>C# и WPF | Круглое окно</title>
<meta charset="utf-8" />
<meta name="description" content="Создание в WPF окон нестандартной непрямоугольной формы с помощью переопределени шаблонов">
...
<h2>Круглое окно</h2><div class="date">Последнее обновление: 15.02.2016</div>
...
<p>Для практики с шаблонами переопределим шаблон окна, чтобы оно имело нестандартную непрямоугольную форму:</p>
<pre class="brush:xml;">
...
<p>Важно здесь отметить установку трех свойств элемента Window:</p>
<ul>
<li><p><code>AllowsTransparency</code>: позволяет сделать форму прозрачной, невидимой</p></li>
<li><p><code>WindowStyle</code>: позволяет убрать у окна стиль при установке значения "None"</p></li>
<li><p><code>Background</code>: устанавливает прозрачнй фон с помощью значения <code>Transparent</code></p></li>
</ul>
<p>И также в файле кода c# изменим код окна, определив необходимые обработчики событий:</p>
<pre class="brush: c#;">
...
<img src="./pics/8.6.png" alt="Непрямоугольная форма в WPF" />
...
<div class="nav"><p><a href="12.3.php">Назад</a><a href="./">Содержание</a><a href="14.1.php">Вперед</a></p></div></div>
<div class="socBlock">
