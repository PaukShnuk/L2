...
<html >
<head>
<title>C# и WPF | TreeView</title>
<meta charset="utf-8" />
<meta name="description" content="Создание древовидных представлений в WPF с помощью элемента TreeView, наполнение его объектами TreeViewItem, работа с деревом, обработка выбора элемента">
...
<h2>TreeView</h2><div class="date">Последнее обновление: 18.01.2016</div>
...
<p>Данный элемент управления предназначен для древовидного отображения данных в окне приложения. Может содержать как коллекцию элементов <b>TreeViewItem</b>, так и 
другое содержимое, например, текстовые блоки:</p>
<pre class="brush:xml;">
&lt;TreeView&gt;
...
<img src="./pics/4.25.png" alt="Элемент TreeView в WPF" />
<p>Однако все же лучше обертывать элементы в объекты TreeViewItem. С помощью его свойства <span class="b">Header</span> мы можем установить текстовую метку или заголовок узла дерева. 
Элемент TreeViewItem предлагает также ряд свойств для управления состоянием: 
<span class="b">IsExpanded</span> (принимает логическое значение и показывает, раскрыт ли узел) и <span class="b">IsSelected</span> (показывает, 
выбран ли узел).</p>
<p>Чтобы отследить выбор или раскрытие узла, мы можем обработать соответствующие события. Событие <span class="b">Expanded</span> возникает при раскрытии узла, 
а событие <span class="b">Collapsed</span>, наоборот, при его сворачивании.</p>
<p>Выбор узла дерева мы можем обработать с помощью обработки события <span class="b">Selected</span>. Например:</p>
<pre class="brush:xml;">
&lt;TreeView&gt;
...
<p>Теперь добавим в файл связанного кода C# обработчики для этих событий:</p>
<pre class="brush:c#;">
...
<img src="./pics/4.48.png" alt="TreeViewItem в WPF" />
