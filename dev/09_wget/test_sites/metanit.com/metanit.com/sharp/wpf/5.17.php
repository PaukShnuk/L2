...
<html >
<head>
<title>C# и WPF | Работа с изображениями. Image и InkCanvas</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с изображениями в WPF. Элементы Image и InkCanvas и их основные свойства">
...
<h2>Работа с изображениями. Image и InkCanvas</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<h3>Элемент Image</h3>
<p>Элемент Image предназначен для работы с изображениями. Свойство <span class="b">Source</span> позволяет задать путь к изображению, например:</p>
<pre class="brush:xml;">&lt;Image Source="myPhoto.jpg" /&gt;</pre>
<p>WPF поддерживает различны форматы изображений: .bmp, .png, .gif, .jpg и т.д.</p>
<p>Также элемент позволяет проводить некоторые простейшие транформации с изображениями. Например, с помощью объекта <span class="b">FormatConvertedBitmap</span> 
и его свойства <span class="b">DestinationFormat</span> можно получить новое изображение:</p>
<pre class="brush:xml;">
...
<img src="./pics/4.34.png" alt="Элемент Image в WPF" />
<h3>InkCanvas</h3>
<p>InkCanvas представляет собой полотно, на котором можно рисовать. Первоначально оно предназначалось для стилуса, но в WPF есть поддержка также и для мыши 
для обычных ПК. Его очень просто использовать:</p>
<pre class="brush:xml;">
&lt;InkCanvas Background="LightCyan" /&gt;
</pre>
<p>Либо мы можем вложить в InkCanvas какое-нибудь изображение и на нем уже рисовать:</p>
<pre class="brush:xml;">
&lt;InkCanvas&gt;
    &lt;Image Source="2.jpg"  Width="300" Height="250"  /&gt;
&lt;/InkCanvas&gt;
</pre>
<img src="./pics/4.35.png" alt="Элемент InkCanvas в WPF" />
<p>Все рисование в итоге представляется в виде штрихов - элементов класса <code>System.Windows.Ink.Stroke</code> и хранится в коллекции Strokes, 
определенной в классе InkCanvas.</p>
<h4>Режим рисования</h4>
<p>InkCanvas имеет несколько режимов, они задаются с помощью свойства <span class="bb">EditingMode</span>, значения для которого берутся из перечисления 
<span class="b">InkCanvasEditingMode.</span>. Эти значения бывают следующими:</p>
<ul>
<li><p><span class="b">Ink</span>: используется по умолчанию и предполагает рисование стилусом или мышью</p></li>
<li><p><span class="b">InkAndGesture</span>: рисование с помощью мыши/стилуса, а также с помощью жестов (Up, Down, Tap и др.)</p></li>
<li><p><span class="b">GestureOnly</span>: рисование только с помощью жестов пользователя</p></li>
<li><p><span class="b">EraseByStroke</span>: стирание всего штриха стилусом</p></li>
<li><p><span class="b">EraseByPoint</span>: стирание только части штриха, к которой прикоснулся стилус</p></li>
<li><p><span class="b">Select</span>: выделение всех штрихов при касании</p></li>
<li><p><span class="b">None</span>: отсутствие какого-либо действия</p></li>
</ul>
<p>Используя эти значения и обрабатывая события InkCanvas, такие как StrokeCollected (штрих нарисован), StrokeErased (штрих стерли) и др., 
можно управлять набором штрихов и создавать более функциональные приложения на основе InkCanvas.</p>
...
<div class="nav"><p><a href="5.16.php">Назад</a><a href="./">Содержание</a><a href="13.php">Вперед</a></p></div></div>
<div class="socBlock">
