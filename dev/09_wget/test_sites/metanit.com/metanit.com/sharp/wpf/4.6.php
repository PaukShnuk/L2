...
<html >
<head>
<title>C# и WPF | WrapPanel</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер WrapPanel в WPF, расположение элементов внутри контейнера в одной колонке или столбце, ориентация WrapPanel">
...
<h2>WrapPanel</h2><div class="date">Последнее обновление: 16.01.2016</div>
...
<p>Эта панель, подобно StackPanel, располагает все элементы в одной строке или колонке в зависимости от того, какое значение имеет свойство Orientation - Horizontal или Vertical.
 Главное отличие от StackPanel - если элементы не помещаются в строке или столбце, создаются новые столбец или строка для не поместившихся элементов.</p>
<pre class="brush:xml;">
...
<img src="./pics/3.10.png" alt="Горизонтальный контейнер WrapPanel в WPF" />
<p>В горизонтальном стеке те элементы, у которых явным образом не установлена высота, будут автоматически принимать высоту самого большого элемента из стека.</p>
<p>Вертикальный WrapPanel делается аналогично:</p>
<pre class="brush:xml;">
...
<img src="./pics/3.17.png" alt="Вертикальный контейнер WrapPanel в WPF" />
<p>В вертикальном стеке элементы, у которых явным образом не указана ширина, автоматически принимают ширину самого широкого элемента.</p>
<p>Мы также можем установить для всех вложенных элементов какую-нибудь определенную ширину (с помощью свойства <code>ItemWidth</code>) или высоту (свойство <code>ItemHeight</code>):</p>
<pre class="brush:xml;">
...
<img src="./pics/3.11.png" alt="Элемент WrapPanel в WPF" />
