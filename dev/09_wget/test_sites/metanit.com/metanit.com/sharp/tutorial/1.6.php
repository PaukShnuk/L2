...
<html >
<head>
<title>C# и .NET | Первая программа на MacOS</title>
<meta charset="utf-8" />
<meta name="description" content="Первая программа на языке программирования C# и .NET в Visual Studio for Mac">
...
<h2>Первая программа на MacOS</h2><div class="date">Последнее обновление: 17.01.2022</div>
...
<p>Фреймворк .NET является кроссплатформенным, соответственно создать приложения на C# можно не только на Windows, но и на других 
поддерживаемых операционных системах, например, на MacOS. Для работы с C# на MacOS можно использовать как .NET CLI, писать код программы в любом текстовом редакторе и 
компилировать в терминале. Но также для работы в MacOS можно использовать среду разработки <span class="b">Visual Studio for Mac</span>. 
Для этого нам надо сначала загрузить установщик данной среды разработки со страницы <a href="https://visualstudio.microsoft.com/ru/vs/mac/" rel="nofollow">https://visualstudio.microsoft.com/ru/vs/mac/</a>. 
Для работы с .NET 6 и C# нам потребуется именно версия <span class="b">Visual Studio for Mac 2022</span></p>
<p>После загрузки запустим программу установки и нажмем на кнопку установки:</p>
<img src="./pics/mac1.png" alt="Установка Visual Studio for Mac and C#" />
<p>Далее нам откроется программа установки, где нам надо указать устанавливаемые компоненты. Если Visual Studio или отдельные компоненты 
уже были установлены, то отобразиться список компонентов, которые надо обновить:</p>
<img src="./pics/mac2.png" alt="Установка .NET 6 и C# 10 в Visual Studio for Mac" />
<p>Нажмем на кнопку установки, и начнется процесс установки:</p>
<img src="./pics/mac3.png" alt="Установка .NET 6 и Visual Studio for Mac" />
<p>После завершения установки откроем Visual Studio for Mac:</p>
<img src="./pics/mac4.png" alt="Первый проект на C# в Visual Studio for Mac" />
<p>Для создания нового проекта нажмем на кнопку <span class="b">New</span></p>
<p>Далее нам откроется окно выбора шаблона проекта. В данном случае выберем шаблон <span class="b">Console Application</span></p>
<img src="./pics/mac5.png" alt="Создание проекта консольного приложения C# 10 в Visual Studio for Mac" />
<p>Далее в следующем окне укажем в качестве версии фреймворка .NET 6:</p>
<img src="./pics/mac6.png" alt="Установка версии .NET для приложения C# на MacOS" />
<p>Далее в следующем окне укажем имя проекта и его расположение на жестком диске. Пусть проект называется 
    HelloApp:</p>
<img src="./pics/mac7.png" alt="Первый проект .NET и C# на MacOS" />
<p>После этого Visual Studio создаст новый проект. Как и в версии для Windows, проект имеет один файл Program.cs. 
Он содержит простейший код, которые выводит сообщение на консоль:</p>
<pre class="brush:c#;">Console.WriteLine("Hello, World!");</pre>
<p>Запустим проект, нажав на черную стрелку над структурой проекта:</p>
<img src="./pics/mac8.png" alt="Запуск приложения на .NET 6 и C# в Visiual Studio for MacOS" />
<p>И после запуска внизу в Visiual Studio for MacOS отобразится выше указанная строка:</p>
<img src="./pics/mac9.png" alt="Первое приложение на .NET и C# на MacOS" />
<p>В остальных аспектах разработка приложений на .NET и C# на MacOS будет аналогична разработке в Windows.</p>
