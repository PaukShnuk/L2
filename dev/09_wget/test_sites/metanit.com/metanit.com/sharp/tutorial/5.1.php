...
<html >
<head>
<title>C# и .NET | Работа с файловой системой</title>
<meta charset="utf-8" />
<meta name="description" content="Пространство имен System.IO, получение информации о жестких дисках в языке программирования C# и .NET, класс DriveInfo и его метод GetDrives и свойства, пример использования">
...
<h1>Работа с файловой системой</h1><div class="date">Последнее обновление: 07.01.2022</div>
...
<p>Большинство задач в программировании так или иначе связаны с работой с файлами и каталогами. Нам может потребоваться прочитать текст из 
...
пространстве имен <span class="b">System.IO</span>. Классы, расположенные в этом пространстве имен (такие как Stream, StreamWriter, FileStream и др.), 
позволяют управлять файловым вводом-выводом.</p>
<h2>Работа с дисками</h2>
<p>Работу с файловой системой начнем с самого верхнего уровня - дисков. Для представления диска в пространстве имен <code>System.IO</code> 
имеется класс <span class="b">DriveInfo</span>.</p>
<p>Этот класс имеет статический метод <span class="b">GetDrives()</span>, который возвращает имена всех логических дисков компьютера. Также он предоставляет 
ряд полезных свойств:</p>
<ul>
<li><p><span class="b">AvailableFreeSpace</span>: указывает на объем доступного свободного места на диске в байтах</p></li>
<li><p><span class="b">DriveFormat</span>: получает имя файловой системы</p></li>
<li><p><span class="b">DriveType</span>: представляет тип диска</p></li>
<li><p><span class="b">IsReady</span>: готов ли диск (например, DVD-диск может быть не вставлен в дисковод)</p></li>
<li><p><span class="b">Name</span>: получает имя диска</p></li>
<li><p><span class="b">RootDirectory</span>: возвращает корневой каталог диска</p></li>
<li><p><span class="b">TotalFreeSpace</span>: получает общий объем свободного места на диске в байтах</p></li>
<li><p><span class="b">TotalSize</span>: общий размер диска в байтах</p></li>
<li><p><span class="b">VolumeLabel</span>: получает или устанавливает метку тома</p></li>
</ul>
...
<div class="nav"><p><a href="./8.4.php">Назад</a><a href="./">Содержание</a><a href="./5.2.php">Вперед</a></p></div></div>
<div class="socBlock">
