...
<html >
<head>
<title>C# и .NET | Переменные и константы</title>
<meta charset="utf-8" />
<meta name="description" content="Переменные и константы в языке программирования C#, объявление переменных, их инициализация и использование, правила определения переменной, модификатор const">
...
<h2>Переменные и константы</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Для хранения данных в программе применяются <span class="b">переменные</span>. Переменная представляет именнованную область памяти, 
...
<pre class="brush:c#;">тип имя_переменной;</pre>
...
<p>В данном случае определена переменная name, которая имеет тип <span class="b">string</span>. то есть переменная представляет строку. Поскольку определение переменной представляет 
...
<pre class="brush:c#;">string name = "Tom";</pre>
...
C# есть константы. <span class="b">Константа</span> должна быть обязательно инициализирована при определении, и после определения значение константы не может быть изменено</p>
...
ключевое слово <span class="b">const</span>, которое указывается перед типом константы:</p>
<pre class="brush:c#;">
const string NAME = "Tom";  // определяем константу
</pre>
<p>Так, в данном случае определена константа <code>NAME</code>, которая хранит строку "Tom". Нередко для название констант используется верхний регистр, но это не более чем условность.</p>
...
<ul>
<li><a title="Вопросы для самопроверки" href="../questions/1.9.php"><i class="fa fa-lg fa-question"></i><span class="dop-txt">Вопросы для самопроверки</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./1.5.php">Назад</a><a href="./">Содержание</a><a href="./2.26.php">Вперед</a></p></div></div>
<div class="socBlock">
