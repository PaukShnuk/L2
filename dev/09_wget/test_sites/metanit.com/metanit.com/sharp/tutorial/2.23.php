...
<html >
<head>
<title>C# и .NET | Операции присваивания</title>
<meta charset="utf-8" />
<meta name="description" content="Операции присваивания в языке программирования C# и платформе .NET, присвоение после арифметических и поразрядных операций">
...
<h2>Операции присваивания</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Операции присвоения устанавливают значение. В операциях присвоения участвуют два операнда, причем левый операнд может представлять только модифицируемое именованное выражение, например, переменную</p>
<p>Как и во многих других языках программирования, в C# имеется базовая операция присваивания <span class="b">=</span>, которая присвоивает 
значение правого операнда левому операнду:</p>
<pre class="brush:c#;">
int number = 23;
</pre>
<p>Здесь переменной number присваивается число 23. Переменная number представляет левый операнд, которому присваивается значение правого операнда, то есть числа 23.</p>
<p>Также можно выполнять множественно присвоение сразу нескольких переменным одновременно:</p>
<pre class="brush:c#;">
int a, b, c;
a = b = c = 34;
</pre>
<p>Стоит отметить, что операции присвоения имеют низкий приоритет. И вначале будет вычисляться значение правого операнда и только потом будет идти присвоение этого значения левому операнду. 
Например:</p>
<pre class="brush:c#;">
int a, b, c;
a = b = c = 34 * 2 / 4; // 17
</pre>
<p>Сначала будет вычисляться выражение <code>34 * 2 / 4</code>, затем полученное значение будет присвоено переменным.</p>
<p>Кроме базовой операции присвоения в C# есть еще ряд операций:</p>
<ul>
<li><p><span class="b">+=</span>: присваивание после сложения. Присваивает левому операнду сумму левого и правого операндов: выражение 
<span class="b">A += B</span> равнозначно выражению <span class="b">A = A + B</span></p></li>
...
<p>В данном случае выполнение выражения будет идти следующим образом:</p>
<ol>
<li><p>b -= 5 (6-5=1)</p></li>
<li><p>a += (b-=5) (8+1 = 9)</p></li>
<li><p>c = (a += (b-=5)) (c = 9)</p></li>
</ol>
...
<div class="nav"><p><a href="./2.22.php">Назад</a><a href="./">Содержание</a><a href="./2.2.php">Вперед</a></p></div></div>
<div class="socBlock">
