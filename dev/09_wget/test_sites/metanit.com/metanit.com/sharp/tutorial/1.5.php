...
<html >
<head>
<title>C# и .NET | Структура программы</title>
<meta charset="utf-8" />
<meta name="description" content="Структура программы на языке C#, инструкции, блоки кода, типы комментариев, метод main, регистрозависимость">
...
<h2>Структура программы</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Весь код программы на языке C# помещается в файлы с расширением <span class="b">.cs</span>. По умолчанию в проекте, который создается в 
Visual Studio (а также при использовании .NET CLI) уже есть один файл с кодом C# - файл <span class="b">Program.cs</span> со следующим содержимым:</p>
<pre class="brush:c#;">
// See https://aka.ms/new-console-template for more information
Console.WriteLine("Hello, World!");
</pre>
<img src="./pics/2.14.png" alt="Выполнение программы на языке программирования C#" />
<p>Именно код файла <span class="b">Program.cs</span> выполняется по умолчанию, если мы запустим проект на выполнение. Но при 
необходимости мы также можем добавлять другие файлы с кодом C#.</p>
<h3>Инструкции</h3>
<p>Базовым строительным блоком программы являются <span class="b">инструкции</span> (statement). Инструкция представляет некоторое 
...
<p>Данная строка представляет вызов метода <code>Console.WriteLine</code>, который выводит на консоль строку. В данном случае вызов метода является 
...
закрывающей фигурными скобками. Например, изменим код файла <span class="b">Program.cs</span> на следующий:</p>
<pre class="brush:c#;">
{
...
<img src="./pics/2.15.png" alt="Блок кода на языке программирования C#" />
...
переменные и т.д. Например, для вывода на консоль используется метод <span class="b">WriteLine</span> - его имя начинается именно с 
...
<h3>Файл проекта</h3>
<p>В каждом проекте проекте C# есть файл, который отвечает за общую конфгурацию проекта. По умолчанию этот файл называется <span class="b">Название_проекта.csproj</span>. 
...
<img src="./pics/2.18.png" alt="Файл проекта в C# в Visual Studio" />
...
<ul>
<li><p><span class="b">OutputType</span>: определяет выходной тип проекта. Это может быть выполняемое приложение в виде файла с расширением 
<span class="b">exe</span>, которое запускается по нажатию. И также это может быть файл с расширением <span class="b">.dll</span> - некоторый набор функциональностей, 
...
<li><p><span class="b">TargetFramework</span>: определяет применяемую для компиляции версию фреймворка .NET. 
...
<div class="nav"><p><a href="./1.6.php">Назад</a><a href="./">Содержание</a><a href="./2.25.php">Вперед</a></p></div></div>
<div class="socBlock">
