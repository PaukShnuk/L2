...
<html >
<head>
<title>C# и .NET | Консольный ввод-вывод</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с консолью на C# и .NET, класс Console, вывод строки на консоль и ввод с консоли информации">
...
<h2>Консольный ввод-вывод</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Для вывода информации на консоль мы уже использовали встроенный метод <span class="b">Console.WriteLine</span>. 
...
Это можем значение переменной (<code>{name}</code>) или более сложное выражение (например, операция сложения <code>{4 + 7}</code>). А перед всей строкой ставится знак доллара $.</p>
...
<p>Здесь мы видим, что строка в <code>Console.WriteLine</code> содержит некие числа в фигурных скобках: {0}, {1}, {2}. Это плейсхолдеры, вместо которых при выводе строки на консоль 
...
<pre class="brush:c#;">"Имя: {0}  Возраст: {2}  Рост: {1}м"</pre>
<p>будет заменена на</p>
<pre class="brush:c#;">"Имя: Tom  Возраст: 34  Рост: 1,7м"</pre>
<h4>Console.Write</h4>
<p>Кроме <code>Console.WriteLine()</code> можно также использовать метод <span class="b">Console.Write()</span>, он работает точно так же за тем исключением, 
...
<p>Кроме вывода информации на консоль мы можем получать информацию с консоли. Для этого предназначен метод <span class="b">Console.ReadLine()</span>. Он позволяет получить введенную строку.</p>
<pre class="brush:c#;">
Console.Write("Введите свое имя: ");
string? name = Console.ReadLine();
Console.WriteLine($"Привет {name}");
</pre>
<p>В данном случае все, что вводит пользователь, с помощью метода Console.ReadLine() передается в переменную name.</p
...
<p>Особенностью метода <code>Console.ReadLine()</code> является то, что он может считать информацию с консоли только в виде строки. Кроме того, возможная ситуация, когда для метода 
Console.ReadLine не окажется доступных для считывания строк, то есть когда ему нечего считывать, он возвращаает значение <span class="b">null</span>, то есть, грубо говоря, фактически отсутствие значения. 
И чтобы отразить эту ситуацию мы определяем переменную <code>name</code>, в которую получаем ввод с консоли, как переменную типа <span class="b">string?</span>. Здесь <code>string</code> указывает, 
что переменная может хранить значения типа string, то есть строки. А знак вопроса <span class="b">?</span> указывает, что переменная также может хранить значение <span class="b">null</span>, то есть по сути не иметь никакого значения. Далее мы более подробно разберем 
<code>null</code> и как с ним работать.</p>
...
<ul>
<li><p><span class="b">Convert.ToInt32()</span> (преобразует к типу int)</p></li>
<li><p><span class="b">Convert.ToDouble()</span> (преобразует к типу double)</p></li>
<li><p><span class="b">Convert.ToDecimal()</span> (преобразует к типу decimal)</p></li>
</ul>
