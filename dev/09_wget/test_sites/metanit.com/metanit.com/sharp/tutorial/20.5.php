...
<html >
<head>
<title>C# и .NET | Класс Array и массивы</title>
<meta charset="utf-8" />
<meta name="description" content="Класс Array и работа с массивами в языке программирования C# и .NET, изменение размера массива, копирование элементов, сортировка массивов">
...
<h2>Класс Array и массивы</h2><div class="date">Последнее обновление: 06.01.2022</div>
...
<p>Все массивы в C# построены на основе класса <span class="b">Array</span> из пространства имен System. Этот класс определяет ряд свойств и 
методов, которые мы можем использовать при работе с массивами. Основные свойства и методы:</p>
<ul>
<li><p>Свойство <span class="b">Length</span> возвращает длину массива</p></li>
<li><p>Свойство <span class="b">Rank</span> возвращает размерность массива</p></li>
<li><p><span class="b">int BinarySearch (Array array, object? value)</span> выполняет бинарный поиск в отсортированном массиве и возвращает индекс найденного элемента</p></li>
<li><p><span class="b">void Clear (Array array)</span> очищает массив, устанавливая для всех его элементов значение по умолчанию</p></li>
<li><p><span class="b">void Copy (Array sourceArray, int sourceIndex, Array destinationArray, int destinationIndex, int length)</span> 
копирует из массива sourceArray начиная с индекс sourceIndex length элементов в массив destinationArray начиная с индекса destinationIndex</p></li>
<li><p><span class="b">bool Exists&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> проверяет, содержит ли массив array элементы, которые удовлеворяют условию делегата match</p></li>
<li><p><span class="b">void Fill&lt;T&gt; (T[] array, T value)</span> заполняет массив array значением value</p></li>
<li><p><span class="b">T? Find&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> находит первый элемент, который удовлеворяет определенному условию из делегата match. Если элемент не найден, то возвращается null</p></li>
<li><p><span class="b">T? FindLast&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> находит последний элемент, который удовлеворяет определенному условию из делегата match. Если элемент не найден, то возвращается null</p></li>
<li><p><span class="b">int FindIndex&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> возвращает индекс первого вхождения элемента, который удовлеворяет определенному условию делегата match</p></li>
<li><p><span class="b">int FindLastIndex&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> возвращает индекс последнего вхождения элемента, который удовлеворяет определенному условию</p></li>
<li><p><span class="b">T[] FindAll&lt;T&gt; (T[] array, Predicate&lt;T&gt; match)</span> возвращает все элементы в виде массива, которые удовлеворяет определенному условию из делегата match</p></li>
<li><p><span class="b">int IndexOf (Array array, object? value)</span> возвращает индекс первого вхождения элемента в массив</p></li>
<li><p><span class="b">int LastIndexOf (Array array, object? value)</span> возвращает индекс последнего вхождения элемента в массив</p></li>
<li><p><span class="b">void Resize&lt;T&gt; (ref T[]? array, int newSize)</span> изменяет размер одномерного массива</p></li>
<li><p><span class="b">void Reverse (Array array)</span> располагает элементы массива в обратном порядке</p></li>
<li><p><span class="b">void Sort (Array array)</span> сортирует элементы одномерного массива</p></li>
</ul>
<p>Разберем самые используемые методы.</p>
...
<p>Если элемент не найден в массиве, то методы возвращают -1.</p>
<h3>Поиск элемента по условию</h3>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<h3>Изменение порядка элементов массива</h3>
<p>Например, изменим порядок элементов:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<p>Также можно изменить порядок только части элементов:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<p>В данном случае изменяем порядок только 3 элементов начиная c индекса 1.</p>
<h3>Изменение размера массива</h3>
<p>Для изменения размера массива применяется метод Resize. Его первый параметр - изменяемый массив, а второй параметр - количество элементов, которые должны быть в массиве. Если второй параметр меньше длины массива, 
...
Причем первый параметр передается по ссылке:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<p>Метод <span class="b">Copy</span> копирует часть одного массива в другой:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<p>В данном случае копируем 3 элемента из массива people начиная c индекса 1  и вставляем их в массив employees начиная с индекса 0.</p>
<h3>Сортировка массива</h3>
<p>Отсортируем массив с помощью метода <span class="b">Sort()</span>:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<p>Этот метод имеет много перегрузок. Например, одна из версий позволяет отсортировать только часть массива:</p>
<pre class="brush:c#;">
var people = new string[] { "Tom", "Sam", "Bob", "Kate", "Tom", "Alice" };
...
<div class="nav"><p><a href="./20.4.php">Назад</a><a href="./">Содержание</a><a href="./2.33.php">Вперед</a></p></div></div>
<div class="socBlock">
