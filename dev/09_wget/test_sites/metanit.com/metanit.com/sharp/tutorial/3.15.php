...
<html >
<head>
<title>C# и .NET | Анонимные методы</title>
<meta charset="utf-8" />
<meta name="description" content="Анонимные методы c#, их использование для создания упрощенной записи методов, связь с делегатами">
...
<h2>Анонимные методы</h2><div class="date">Последнее обновление: 31.12.2021</div>
...
<p>С делегатами тесно связаны <span class="b">анонимные методы</span>. Анонимные методы используются для создания экземпляров делегатов.</p>
<p>Определение анонимных методов начинается с ключевого слова <span class="b">delegate</span>, после которого идет в скобках список параметров и тело метода 
...
<p>При этом параметры анонимного метода не могут быть опущены, если один или несколько параметров определены с модификатором <span class="b">out</span>.</p>
...
<div class="nav"><p><a href="./3.43.php">Назад</a><a href="./">Содержание</a><a href="./3.16.php">Вперед</a></p></div></div>
<div class="socBlock">
