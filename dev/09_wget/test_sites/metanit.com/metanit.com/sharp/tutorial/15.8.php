...
<html >
<head>
<title>C# и .NET | Отложенное и немедленное выполнение LINQ</title>
<meta charset="utf-8" />
<meta name="description" content="Отложенное и немедленное выполнение запросов LINQ в языке программирования C# и .NET">
...
<h2>Отложенное и немедленное выполнение LINQ</h2><div class="date">Последнее обновление: 15.02.2022</div>
...
<p>Есть два способа выполнения запроса LINQ: <span class="b">отложенное</span> (deferred) и <span class="b">немедленное</span> (immediate) выполнение.</p>
<p>При отложенном выполнении LINQ-выражение не выполняется, пока не будет произведена итерация или перебор по выборке, например, в цикле foreach. 
Обычно подобные операции возвращают объект <code>IEnumerable&lt;T&gt;</code> или <code>IOrderedEnumerable&lt;T&gt;</code>. Полный список отложенных операций LINQ:</p>
<ul>
<li><p><span class="b">AsEnumerable</span></p></li></span></p></li>		
<li><p><span class="b">Cast</span></p></li>		
<li><p><span class="b">Concat</span></p></li>	
<li><p><span class="b">DefaultIfEmpty</span></p></li>		
<li><p><span class="b">Distinct</span></p></li>	
<li><p><span class="b">Except</span></p></li>		
<li><p><span class="b">GroupBy</span></p></li>		
<li><p><span class="b">GroupJoin</span></p></li>		
<li><p><span class="b">Intersect</span></p></li>		
<li><p><span class="b">Join</span></p></li>	
<li><p><span class="b">OfType</span></p></li>		
<li><p><span class="b">OrderBy</span></p></li>		
<li><p><span class="b">OrderByDescending		
<li><p><span class="b">Range</span></p></li>		
<li><p><span class="b">Repeat</span></p></li>		
<li><p><span class="b">Reverse</span></p></li>		
<li><p><span class="b">Select</span></p></li>		
<li><p><span class="b">SelectMany</span></p></li>	
<li><p><span class="b">Skip</span></p></li>		
<li><p><span class="b">SkipWhile</span></p></li>	
<li><p><span class="b">Take</span></p></li>		
<li><p><span class="b">TakeWhile</span></p></li>		
<li><p><span class="b">ThenBy</span></p></li>		
<li><p><span class="b">ThenByDescending		
<li><p><span class="b">Union</span></p></li>		
<li><p><span class="b">Where</span></p></li>	
</ul> 
<p>Рассмотрим отложенное выполнение:</p>
<pre class="brush:c#;">
...
<p>То есть фактическое выполнение запроса происходит не в строке определения: <code>var selectedPeople = people.Where...</code>, а при переборе в цикле foreach.</p>
<p>Фактически LINQ-запрос разбивается на три этапа:</p>
<ol>
<li><p>Получение источника данных</p></li>
<li><p>Создание запроса</p></li>
<li><p>Выполнение запроса и получение его результатов</p></li>
</ol>
<p>Как это происходит в нашем случае:</p>
<ol>
<li><p>Получение источника данных - определение массива teams:</p>
<pre class="brush:c#;">string[] people = { "Tom", "Sam", "Bob" };</pre></li>
<li><p>Создание запроса - определение переменной selectedTeams:</p>
<pre class="brush:c#;">var selectedPeople = people.Where(s=&gt;s.Length == 3).OrderBy(s=&gt;s);</pre></li>
<li><p>Выполнение запроса и получение его результатов:</p>
<pre class="brush:c#;">
foreach (string s in selectedPeople)
    Console.WriteLine(s);
</pre></li>
</ol>
<p>После определения запроса он может выполняться множество раз. И до выполнения запроса источник данных может изменяться. Чтобы более наглядно 
увидеть это, мы можем изменить какой-либо элемент до перебора выборки:</p>
<pre class="brush:c#;">
string[] people = { "Tom", "Sam", "Bob" };
...
<p>Теперь выборка будет содержать два элемента, а не три, так как последний элемент после изменения не будет соответствовать условию.</p>
<p>Важно понимать, что переменная запроса сама по себе не выполняет никаких действий и не возвращает никаких данных. Она только хранит набор команд, 
которые необходимы для получения результатов. То есть выполнение запроса после его создания откладывается. Само получение результатов производится при переборе в цикле foreach.</p>
<h3>Немедленное выполнение запроса</h3>
<p>С помощью ряда методов мы можем применить немедленное выполнение запроса. Это методы, которые возвращают одно атомарное значение или один элемент или 
данные типов Array, List и Dictionary. Полный список подобных операций в LINQ:</p>
<ul>
<li><p><span class="b">Aggregate</span></p></li>		
<li><p><span class="b">All</span></p></li>		
<li><p><span class="b">Any</span></p></li>	
<li><p><span class="b">Average</span></p></li>	
<li><p><span class="b">Contains</span></p></li>		
<li><p><span class="b">Count</span></p></li>	
<li><p><span class="b">ElementAt</span></p></li>		
<li><p><span class="b">ElementAtOrDefault</span></p></li>		
<li><p><span class="b">Empty</span></p></li>		
<li><p><span class="b">First</span></p></li>		
<li><p><span class="b">FirstOrDefault		
<li><p><span class="b">Last</span></p></li>		
<li><p><span class="b">LastOrDefault</span></p></li>		
<li><p><span class="b">LongCount</span></p></li>	
<li><p><span class="b">Max</span></p></li>	
<li><p><span class="b">Min</span></p></li>	
<li><p><span class="b">SequenceEqual</span></p></li>		
<li><p><span class="b">Single</span></p></li>		
<li><p><span class="b">SingleOrDefault</span></p></li>	
<li><p><span class="b">Sum</span></p></li>	
<li><p><span class="b">ToArray</span></p></li>	
<li><p><span class="b">ToDictionary</span></p></li>	
<li><p><span class="b">ToList</span></p></li>	
<li><p><span class="b">ToLookup</span></p></li>	
</ul>
<p>Рассмотрим пример с методом <code>Count()</code>, который возвращает число элементов последовательности:</p>
<pre class="brush:c#;">
string[] people = { "Tom", "Sam", "Bob" };
...
<p>Результатом метода Count будет объект <code>int</code>, поэтому сработает немедленное выполнение.</p>
<p>Сначала создается запрос: <code>people.Where(s=&gt;s.Length == 3).OrderBy(s=&gt;s)</code>. Далее к нему применяется метод 
<code>Count()</code>, который выполняет запрос, неявно выполняет перебор по последовательности элементов, генерируемой этим запросом, и возвращает число элементов в 
этой последовательности.</p>
<p>Также мы можем изменить код таким образом, чтобы метод <code>Count()</code> учитывал изменения и выполнялся отдельно от определения запроса:</p>
<pre class="brush:c#;">
string[] people = { "Tom", "Sam", "Bob" };
...
<p>Также для немедленного выполнения LINQ-запроса и кэширования его результатов мы можем применять методы преобразования 
<code>ToArray&lt;T&gt;()</code>, <code>ToList&lt;T&gt;()</code>, <code>ToDictionary()</code> и т.д.. Эти методы получают результат запроса 
в виде объектов Array, List и Dictionary соответственно. Например:</p>
<pre class="brush:c#;">
string[] people = { "Tom", "Sam", "Bob" };
...
<div class="nav"><p><a href="./15.10.php">Назад</a><a href="./">Содержание</a><a href="./15.9.php">Вперед</a></p></div></div>
<div class="socBlock">
