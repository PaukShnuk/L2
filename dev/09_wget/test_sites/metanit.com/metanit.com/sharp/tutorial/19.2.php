...
<html >
<head>
<title>C# и .NET | Форматирование дат и времени</title>
<meta charset="utf-8" />
<meta name="description" content="Форматирование дат и времени в C# и .NET">
...
<h2>Форматирование дат и времени</h2><div class="date">Последнее обновление: 06.01.2022</div>
...
<p>Для форматирования вывода дат и времени применяется ряд строковых форматов:</p>
<table class="tab">
<tr class="tabhead"><td><p>Описатель</p></td><td><p>Описание</p></td></tr>
<tr><td><p>D</p></td><td><p>Полный формат даты. Например, 17 июля 2015 г.</p></td></tr>
<tr><td><p>d</p></td><td><p>Краткий формат даты. Например, 17.07.2015</p></td></tr>
<tr><td><p>F</p></td><td><p>Полный формат даты и времени. Например, 17 июля 2015 г. 17:04:43</p></td></tr>
<tr><td><p>f</p></td><td><p>Полный формат даты и краткий формат времени. Например, 17 июля 2015 г. 17:04</p></td></tr>
<tr><td><p>G</p></td><td><p>Краткий формат даты и полный формат времени. Например, 17.07.2015 17:04:43</p></td></tr>
<tr><td><p>g</p></td><td><p>Краткий формат даты и времени. Например, 17.07.2015 17:04</p></td></tr>
<tr><td><p>M, m</p></td><td><p>Формат дней месяца. Например, 17 июля</p></td></tr>
<tr><td><p>O, o</p></td><td><p>Формат обратного преобразования даты и времени. Вывод даты и времени в соответствии со стандартом ISO 8601 в формате 
"yyyy'-'MM'-'dd'T'HH':'mm':'ss'.'fffffffzzz". Например, 2015-07-17T17:04:43.4092892+03:00</p></td></tr>
<tr><td><p>R, r</p></td><td><p>Время по Гринвичу. Например, Fri, 17 Jul 2015 17:04:43 GMT</p></td></tr>
<tr><td><p>s</p></td><td><p>Сортируемый формат даты и времени. Например, 2015-07-17T17:04:43</p></td></tr>
<tr><td><p>T</p></td><td><p>Полный формат времени. Например, 17:04:43</p></td></tr>
<tr><td><p>t</p></td><td><p>Краткий формат времени. Например, 17:04</p></td></tr>
<tr><td><p>U</p></td><td><p>Полный универсальный полный формат даты и времени. Например, 17 июля 2015 г. 17:04:43</p></td></tr>
<tr><td><p>u</p></td><td><p>Краткий универсальный полный формат даты и времени. Например, 2015-07-17 17:04:43Z</p></td></tr>
<tr><td><p>Y, y</p></td><td><p>Формат года. Например, Июль 2015</p></td></tr>
</table>
<p>Выведем текущею дату и время во всех форматах:</p>
<pre class="brush:c#;">
...
<h3>Настройка формата времени и даты</h3>
<p>Не всегда удобно использование встроенных форматов даты и времени. Иногда бывает необходимо задать сообственную форму отображения объекта DateTime. 
В этом случае мы можем составить свой формат из описателей:</p>
<table class="tab">
<tr class="tabhead"><td><p>Описатель</p></td><td><p>Описание</p></td></tr>
<tr><td><p>d</p></td><td><p>Представляет день месяца от 1 до 31. Одноразрядные числа используются без нуля в начале</p></td></tr>
<tr><td><p>dd</p></td><td><p>Представляет день месяца от 1 до 31. К одноразрядным числам в начале добавляется ноль</p></td></tr>
<tr><td><p>ddd</p></td><td><p>Сокращенное название дня недели</p></td></tr>
<tr><td><p>dddd</p></td><td><p>Полное название дня недели</p></td></tr>
<tr><td><p>f / fffffff</p></td><td><p>Представляет миллисекунды. Количество символов f указывает на число разрядов в миллисекундах</p></td></tr>
<tr><td><p>g</p></td><td><p>Представляет период или эру (например, "н. э.")</p></td></tr>
<tr><td><p>h</p></td><td><p>Часы в виде от 1 до 12. Часы с одной цифрой не дополняются нулем</p></td></tr>
<tr><td><p>hh</p></td><td><p>Часы в виде от 01 до 12. Часы с одной цифрой дополняются нулем</p></td></tr>
<tr><td><p>H</p></td><td><p>Часы в виде от 0 до 23. Часы с одной цифрой не дополняются нулем</p></td></tr>
<tr><td><p>HH</p></td><td><p>Часы в виде от 0 до 23. Часы с одной цифрой дополняются нулем</p></td></tr>
<tr><td><p>K</p></td><td><p>Часовой пояс</p></td></tr>
<tr><td><p>m</p></td><td><p>Минуты от 0 до 59. Минуты с одной цифрой не дополняются начальным нулем</p></td></tr>
<tr><td><p>mm</p></td><td><p>Минуты от 0 до 59. Минуты с одной цифрой дополняются начальным нулем</p></td></tr>
<tr><td><p>M</p></td><td><p>Месяц в виде от 1 до 12</p></td></tr>
<tr><td><p>MM</p></td><td><p>Месяц в виде от 1 до 12. Месяц с одной цифрой дополняется начальным нулем</p></td></tr>
<tr><td><p>MMM</p></td><td><p>Сокращенное название месяца</p></td></tr>
<tr><td><p>MMMM</p></td><td><p>Полное название месяца</p></td></tr>
<tr><td><p>s</p></td><td><p>Секунды в виде числа от 0 до 59. Секунды с одной цифрой не дополняются начальным нулем</p></td></tr>
<tr><td><p>ss</p></td><td><p>Секунды в виде числа от 0 до 59. Секунды с одной цифрой дополняются начальным нулем</p></td></tr>
<tr><td><p>t</p></td><td><p>Первые символы в обозначениях AM и PM</p></td></tr>
<tr><td><p>tt</p></td><td><p>AM или PM</p></td></tr>
<tr><td><p>y</p></td><td><p>Представляет год как число из одной или двух цифр. Если год имеет более двух цифр, то в результате отображаются только две младшие цифры</p></td></tr>
<tr><td><p>yy</p></td><td><p>Представляет год как число из одной или двух цифр. Если год имеет более двух цифр, то в результате отображаются только две младшие цифры. 
Если год имеет одну цифру, то он дополняется начальным нулем</p></td></tr>
<tr><td><p>yyy</p></td><td><p>Год из трех цифр</p></td></tr>
<tr><td><p>yyyy</p></td><td><p>Год из четырех цифр</p></td></tr>
<tr><td><p>yyyyy</p></td><td><p>Год из пяти цифр. Если в году меньше пяти цифр, то он дополняется начальными нулями</p></td></tr>
<tr><td><p>z</p></td><td><p>Представляет смещение в часах относительно времени UTC</p></td></tr>
<tr><td><p>zz</p></td><td><p>Представляет смещение в часах относительно времени UTC. Если смещение представляет одну цифру, то она дополняется начальным нулем.</p></td></tr>
</table>
<p>Создадим пару своих форматов:</p>
<pre class="brush:c#;">
DateTime now = DateTime.Now;
