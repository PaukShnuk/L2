...
<html >
<head>
<title>C# и .NET | Реляционный и логический паттерны</title>
<meta charset="utf-8" />
<meta name="description" content="Pattern matching и Реляционный и логический паттерны в языке программирования C# и .NET, объединение условий в паттернах">
...
<h2>Реляционный и логический паттерны</h2><div class="date">Последнее обновление: 07.01.2022</div>
...
<p>В C# 9.0 в язык были добавлены дополнительные паттерны - реляционный (relational pattern) и логический (logical pattern) паттерны.</p>
<p>Реляционный паттерн позволяет сравнить передаваемое в конструкцию значение с некоторыми значениями с помощью операций сравнения. 
...
использованием реляционного паттерна:</p>
<pre class="brush:c#;">
...
<p>Логический паттерн позволяет использовать логические операторы <span class="b">and</span> (логическое умножение или операция 
логического И) и <span class="b">or</span> (логическое сложение или операция логического ИЛИ) для объединения операций сравнения. 
Например, передадим в метод возраст и возвратим соответствующее сообщение:</p>
<pre class="brush:c#;">
...
<p>Еще один логический оператор - <span class="b">not</span> используется для отрицания и возращает <code>true</code>, если его аргумент равен <code>false</code>:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="./3.57.php">Назад</a><a href="./">Содержание</a><a href="./3.59.php">Вперед</a></p></div></div>
<div class="socBlock">
