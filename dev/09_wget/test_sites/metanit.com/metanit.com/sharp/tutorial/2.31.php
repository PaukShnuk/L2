...
<html >
<head>
<title>C# и .NET | Генерация исключения и оператор throw</title>
<meta charset="utf-8" />
<meta name="description" content="Генерация исключения и оператор throw в языке программирования C#">
...
<h2>Генерация исключения и оператор throw</h2><div class="date">Последнее обновление: 30.12.2021</div>
...
<p>Обычно система сама генерирует исключения при определенных ситуациях, например, при делении числа на ноль. Но язык C# 
также позволяет генерировать исключения вручную с помощью оператора <span class="b">throw</span>. То есть с помощью 
...
<p>После оператора <span class="b">throw</span> указывается объект исключения, через конструктор которого мы можем передать сообщение 
...
<div class="nav"><p><a href="./2.29.php">Назад</a><a href="./">Содержание</a><a href="./3.17.php">Вперед</a></p></div></div>
<div class="socBlock">
