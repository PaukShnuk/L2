...
<html >
<head>
<title>C# и .NET | Двухсвязный список LinkedList</title>
<meta charset="utf-8" />
<meta name="description" content="Двухсвязный список LinkedList&lt;T&gt; в C#, его основные свойства и методы, пример использования">
...
<h2>Двухсвязный список LinkedList&lt;T&gt;</h2><div class="date">Последнее обновление: 04.01.2022</div>
...
<p>Класс <span class="b">LinkedList&lt;T&gt;</span> представляет двухсвязный список, в котором каждый элемент хранит ссылку одновременно на следующий и на предыдущий 
элемент.</p>
...
объект класса <span class="b">LinkedListNode&lt;T&gt;</span>. А добавляемые в связанный список элементы T фактически обертываются в объект LinkedListNode.</p>
<p>Класс LinkedListNode имеет следующие свойства:</p>
<ul>
<li><p><span class="b">Value</span>: возвращает или устанавливает само значение узла, представленное типом T</p></li>
<li><p><span class="b">Next</span>: возвращает ссылку на следующий элемент типа LinkedListNode&lt;T&gt; в списке. Если следующий элемент отсутствует, то имеет значение null</p></li>
<li><p><span class="b">Previous</span>: возвращает ссылку предыдущий элемент типа LinkedListNode&lt;T&gt; в списке. Если предыдущий элемент отсутствует, то имеет значение null</p></li>
</ul>
<h3>Свойства LinkedList</h3>
<p>Класс LinkedList определяет следующие свойства:</p>
<ul>
<li><p><span class="b">Count</span>: количество элементов в связанном списке</p></li>
<li><p><span class="b">First</span>: первый узел в списке в виде объекта LinkedListNode&lt;T&gt;</p></li>
<li><p><span class="b">Last</span>: последний узел в списке в виде объекта LinkedListNode&lt;T&gt;</p></li>
</ul>
...
<ul>
<li><p><span class="b">AddAfter(LinkedListNode&lt;T&gt; node, LinkedListNode&lt;T&gt; newNode)</span>: вставляет узел newNode в список после узла 
node.</p></li>
<li><p><span class="b">AddAfter(LinkedListNode&lt;T&gt; node, T value)</span>: вставляет в список новый узел со значением value после узла node.</p></li>
<li><p><span class="b">AddBefore(LinkedListNode&lt;T&gt; node, LinkedListNode&lt;T&gt; newNode)</span>: вставляет в список узел newNode перед узлом node.</p></li>
<li><p><span class="b">AddBefore(LinkedListNode&lt;T&gt; node, T value)</span>: вставляет в список новый узел со значением value перед узлом node.</p></li>
<li><p><span class="b">AddFirst(LinkedListNode&lt;T&gt; node)</span>: вставляет новый узел в начало списка</p></li>
<li><p><span class="b">AddFirst(T value)</span>: вставляет новый узел со значением value в начало списка</p></li>
<li><p><span class="b">AddLast(LinkedListNode&lt;T&gt; node)</span>: вставляет новый узел в конец списка</p></li>
<li><p><span class="b">AddLast(T value)</span>: вставляет новый узел со значением value в конец списка</p></li>
<li><p><span class="b">RemoveFirst()</span>: удаляет первый узел из списка. После этого новым первым узлом становится узел, следующий за удаленным</p></li>
<li><p><span class="b">RemoveLast()</span>: удаляет последний узел из списка</p></li>
</ul>
