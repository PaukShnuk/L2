...
<html >
<head>
<title>C# и .NET | Изменение документа в LINQ to XML</title>
<meta charset="utf-8" />
<meta name="description" content="Изменение документа xml с помощью LINQ to XML в языке программирования C# и .NET, классы XElement и XAttribute и их методы Add и Remove">
...
<h2>Изменение документа в LINQ to XML</h2><div class="date">Последнее обновление: 21.02.2022</div>
...
<p>Возьмем xml-файл <span class="b">people.xml</span> из прошлых тем:</p>
<pre class="brush:xml;">
...
<p>Для добавления данных в документ xml у объекта XElement применяется метод <span class="b">Add()</span>, в который передается добавляемый объект:</p>
<pre class="brush:c#;">
...
<p>В результате сформируется и сохранится на диск новый документ:</p>
<div class="console">
...
<p>Для изменения данных в документ xml необходимо получить элемент, который надо изменить, и затем можно отредактировать значения его отдельных атрибутов 
или вложенных элементов. Изменим элемент person, в котором атрибут name = "Tom":</p>
<pre class="brush:c#;">
using System.Xml.Linq;
...
<p>Для удаления данных в документе xml у удаляемого объекта XElement вызывается метод <span class="b">Remove()</span>. 
Например, удалим элемент person, в котором атрибут name = "Bob":</p>
<pre class="brush:c#;">
using System.Xml.Linq;
...
<p>Соответственно, если необходимо удалить атрибут, то у удаляемого объекта XAttribute также вызывается метод Remove.</p>
...
<div class="nav"><p><a href="./16.6.php">Назад</a><a href="./">Содержание</a><a href="./6.4.php">Вперед</a></p></div></div>
<div class="socBlock">
