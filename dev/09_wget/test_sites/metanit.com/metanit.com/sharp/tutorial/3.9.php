...
<html >
<head>
<title>C# и .NET | Определение интерфейсов</title>
<meta charset="utf-8" />
<meta name="description" content="Использование интерфейсов в C# и .NET, их определение, модификаторы доступа, реализация интерфейса по умолчанию">
...
<h1>Интерфейсы</h1><h2>Определение интерфейсов</h2><div class="date">Последнее обновление: 01.01.2022</div>
...
<p>Интерфейс представляет ссылочный тип, который может определять некоторый функционал - набор методов и свойств без реализации. 
Затем этот функционал реализуют классы и структуры, которые применяют данные интерфейсы.</p>
<h3>Определение интерфейса</h3>
<p>Для определения интерфейса используется ключевое слово <span class="b">interface</span>. Как правило, названия интерфейсов в C# начинаются с заглавной буквы 
<span class="b">I</span>, например, IComparable, IEnumerable (так называемая венгерская нотация), однако это не обязательное требование, а больше стиль программирования.</p>
...
<span class="b">public</span>, так как цель интерфейса - определение функционала для реализации его классом. Это касается также и констант и 
...
<p>Как и классы, интерфейсы по умолчанию имеют уровень доступа <span class="b">internal</span>, то есть такой интерфейс доступен только 
...
Для добавления интерфейса в проект можно нажать правой кнопкой мыши на проект и в появившемся контекстном меню выбрать <span class="b">Add</span>-&gt;<span class="b">
New Item...</span> и в диалоговом окне добавления нового компонента выбрать пункт <span class="b">Interface</span>:</p>
<img src="./pics/3.2.png" alt="Интерфейсы в C#" />
...
<ul>
<li><a title="Вопросы для самопроверки" href="../questions/2.4.php"><i class="fa fa-lg fa-question"></i><span class="dop-txt">Вопросы для самопроверки</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./3.54.php">Назад</a><a href="./">Содержание</a><a href="./3.49.php">Вперед</a></p></div></div>
<div class="socBlock">
