...
<html >
<head>
<title>C# и .NET | Компиляция в командной строке с .NET CLI</title>
<meta charset="utf-8" />
<meta name="description" content="Компиляция в командной строке приложения на языке программирования C# с .NET CLI">
...
<h2>Компиляция в командной строке с .NET CLI</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Как правило, для создания программ на C# разработчики используют Visual Studio или какие-то другие IDE типа Rider от компании JetBrains. 
...
мы даже можем обойтись без той же Visual Studio, используя только инфраструктуру .NET CLI. Рассмотрим, как использовать .NET CLI и компилировать приложение из командной строки.</p>
<p>Поэтому создадим на диске C какую-нибудь новую папку для проекта. Например, пусть мы создали для проекта папку <span class="b">C:\dotnet\helloapp</span>. Откроем командную строку и с помощью команды <span class="b">cd</span> перейдем к этой папке.</p>
<div class="console"><pre class="consoletext">C:\WINDOWS\system32&gt;cd C:\dotnet\helloapp</pre></div>
<p>Для создания проекта в .NET CLI применяется команда <span class="b">dotnet new</span>, которой передается название проекта. Итак, в введем в командной строке 
следующую команду:</p>
<div class="console"><pre class="consoletext">C:\dotnet\helloapp&gt;dotnet new console</pre></div>
<p>В данном случае мы указываем, что создаваемый проект будет представлять консольное приложение.</p>
<img src="./pics/1.14.png" alt="Создание проекта C# 10 и .NET 6 в консоли" />
<p>После выполнения этой команды в папке helloapp будет создан проект с минимальным набором стандартных файлов и папок.</p>
<img src="./pics/1.5.png" alt=".NET CLI Создание проекта" />
<p>В частности, мы можем найти в папке проекта файл <span class="b">helloapp.csproj</span>. Это главный файл проекта, который определяет его 
...
<img src="./pics/1.11.png" alt="Компиляция программы на C# из командной строки" />
