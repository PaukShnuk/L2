...
<html >
<head>
<title>C# и .NET | Явная реализация интерфейсов</title>
<meta charset="utf-8" />
<meta name="description" content="Явная реализация интерфейсов в C# и .NET, модификаторы доступа у компонентов интерфейса">
...
<h2>Явная реализация интерфейсов</h2><div class="date">Последнее обновление: 01.01.2022</div>
...
<p>Кроме неявного применения интерфейсов, которое было рассмотрено в прошлой статье, сушествует также явная реализация интерфейса. При явной реализации 
...
<p>Следует учитывать, что при явной реализации интерфейса его методы и свойства <span class="b">не являются</span> частью интерфейса класса. 
...
<p>Класс Person определяет один метод <code>Study()</code>, создавая одну общую реализацию для обоих примененных интерфейсов. И вне зависимости от того, 
...
<div class="nav"><p><a href="./3.49.php">Назад</a><a href="./">Содержание</a><a href="./3.47.php">Вперед</a></p></div></div>
<div class="socBlock">
