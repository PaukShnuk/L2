...
<html >
<head>
<title>C# и .NET | Пространства имен</title>
<meta charset="utf-8" />
<meta name="description" content="Пространства имен как контейнеры классов в C# и .NET, file scope namespace, пространства уровня файла, директива using и подключение пространств имен">
...
<h2>Пространства имен</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Обычно определяемые классы и другие типы в .NET не существуют сами по себе, а заключаются в специальные контейнеры - 
<span class="b">пространства имен</span>. Пространства имен позволяют организовать код программы в логические блоки, 
...
<p>Например, определим в файле <span class="b">Program.cs</span> пространство имен, которое будет называться <span class="b">Base</span></p>
<pre class="brush:c#;">
namespace Base
{
    class Person
...
<img src="./pics/3.27.png" alt="пространства имен в языке программирования C# и .NET" />
...
<p>Поскольку класс Person располагается в пространстве имен Base, то его полное имя - <span class="b">Base.Person</span>. Соответственно, используя это имя, мы можем обращаться 
...
И чтобы не писать полное имя класса, мы можем просто подключить пространство имен с помощью директивы <span class="b">using</span>:</p>
<pre class="brush:c#;">
...
<img src="./pics/3.28.png" alt="подключение пространства имен и using в языке программирования C# и .NET" />
...
<code>OrganisationTypes.Company</code> (так как оба класса в итоге находятся в общем пространстве - Base, то его имя можно не указывать в названии класса) или подключать пространство имен класса Company с помощью директивы <code>using</code>. </p>
...
нажмем на название проекта правой кнопкой мыши и в появившемся меню выберем пункт <span class="b">Add -&gt; New Item...</span></p>
<img src="./pics/3.29.png" alt="добавление нового пространства имен C# в Visual Studio" />
<p>В окне добавления нового элемента выберем пункт <span class="b">Class</span> и поле <span class="b">Name</span> в качестве имени файла укажем 
<span class="b">Base.cs</span></p>
<img src="./pics/3.30.png" alt="пространства имен уровня файла C# в Visual Studio" />
<p>После этого в проект будет добавлен файл <span class="b">Base.cs</span>. Удалим из него все содержимое по умолчанию и определим в нем следующий код:</p>
<pre class="brush:c#;">
namespace Base;
...
<p>Директива <code>namespace Base</code> в начале файла указывает, что содержимое файла будет представлять пространство имен Base.</p>
<p>Теперь подключим это пространство имен в файле <span class="b">Program.cs</span>:</p>
<pre class="brush:c#;">
using Base; // подключение пространства имен Base
...
<ul>
<li><a title="Вопросы для самопроверки" href="../questions/2.7.php"><i class="fa fa-lg fa-question"></i><span class="dop-txt">Вопросы для самопроверки</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./2.18.php">Назад</a><a href="./">Содержание</a><a href="./3.52.php">Вперед</a></p></div></div>
<div class="socBlock">
