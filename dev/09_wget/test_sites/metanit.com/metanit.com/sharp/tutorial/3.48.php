...
<html >
<head>
<title>C# и .NET | Наследование интерфейсов</title>
<meta charset="utf-8" />
<meta name="description" content="Наследование интерфейсов в C# и .NET, ограничения при наследовании">
...
<h2>Наследование интерфейсов</h2><div class="date">Последнее обновление: 01.01.2022</div>
...
<p>Однако в отличие от классов мы не можем применять к интерфейсам модификатор <span class="b">sealed</span>, чтобы запретить наследование интерфейсов.</p>
<p>Также мы не можем применять к интерфейсам модификатор <span class="b">abstract</span>, поскольку интерфейс фактически итак, как правило, предоставляет абстрактный функционал, 
который должен быть реализован в классе или структуре (за исключением методов и свойств с реализацией по умолчанию).</p>
<p>Однако методы интерфейсов могут использовать ключевое слово <span class="b">new</span> для скрытия методов из базового интерфейса:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="./3.47.php">Назад</a><a href="./">Содержание</a><a href="./3.40.php">Вперед</a></p></div></div>
<div class="socBlock">
