...
<html >
<head>
<title>C# и .NET | Начало работы с Visual Studio. Первая программа</title>
<meta charset="utf-8" />
<meta name="description" content="Начало работы с языком C#. Где скачать .NET Framework и .NET 6. Установка необходимого инструментария. Среда Visual Studio. Создание первой программы на C#.">
...
<h2>Начало работы. Visual Studio</h2><div class="date">Последнее обновление: 09.11.2021</div>
...
<p>Итак, создадим первое приложение на языке C#. Что для этого потребуется? Во-первых, нам нужен текстовый редактор, 
в котором мы могли бы напечатать код программы. Во-вторых, нам нужен компилятор, который бы скомпилировал набранный в текстовом редакторе код в приложение exe. 
В-третьих, нам нужен фреймворк .NET, который требуется для компиляции и выполнения программы.</p>
<p>Чтобы облегчить написание, а также тестирование и отладку программного кода обычно используют специальные среды разработки, в частности, 
Visual Studio.</p>
<p>Для создания приложений на C# будем использовать бесплатную и полнофункциональную среду разработки - Visual Studio Community 2022, которую можно загрузить по следующему адресу: 
...
В нашем случае нам будет интересовать прежде всего C# и .NET.</p>
<p>Чтобы добавить в Visual Studio поддержку проектов для C# и .NET 6, в программе установки среди рабочих нагрузок можно выбрать только пункт 
...
C#</p>
<img src="./pics/1.10.png" alt="Проект консольного приложения на C# и .NET 6 в Visual Studio 2022" />
<p>Далее на следующем этапе нам будет предложено указать имя проекта и каталог, где будет располагаться проект.</p>
<img src="./pics/1.1.png" alt="Создание первого приложения на C#" />
...
<img src="./pics/1.13.png" alt="Установка C# 10 и .NET 6 в Visual Studio" />
<p>После этого Visual Studio создаст и откроет нам проект:</p>
<img src="./pics/1.2.png" alt="Первый проект на C#" />
...
структура: узел <span class="b">Dependencies</span> - это узел содержит сборки dll, которые добавлены в проект по умолчанию. 
...
<p>Далее идет непосредственно сам файл кода программы <span class="b">Program.cs</span>, который по умолчанию открыт в центральном окне и 
который имеет всего две строки:</p>
<pre class="brush:c#;">
// See https://aka.ms/new-console-template for more information
Console.WriteLine("Hello, World!");
</pre>
<p>Первая строка предваряется символами <code>//</code> и представляет комментарии - пояснения к коду.</p>
<p>Вторая строка собственно представляет собой код программы: <code>Console.WriteLine("Hello World!");</code>. Эта строка выводит на консоль строку "Hello World!".</p>
...
<img src="./pics/1.15.png" alt="Первое приложение на C# и .NET 6" />
...
<pre class="brush:c#;">Console.Write("Введите свое имя: ");</pre>
<p>Метод <span class="b">Console.Write()</span> выводит на консоль некоторую строка. В данном случае это строка "Введите свое имя: ".</p>
...
<p>Переменной <code>name</code> присваивается результат метода <span class="b">Console.ReadLine()</span>, который
...
<p>Выражение <code>string? name</code> указывает, что определяется переменная <code>name</code> типа <code>string?</code>, то есть переменная, которая может хранить строки. 
Здесь <code>string</code> указывает, что переменная может хранить значения типа <code>string</code>, то есть строки. 
А знак вопроса <span class="b">?</span> указывает, что переменная также может хранить значение <span class="b">null</span>, то есть 
по сути не иметь никакого значения.</p>
<p>Затем введенное имя выводится на консоль:</p>
<pre class="brush:c#;">Console.WriteLine($"Привет {name}");</pre>
...
<img src="./pics/1.6.png" alt="Первая программа на C#" />
