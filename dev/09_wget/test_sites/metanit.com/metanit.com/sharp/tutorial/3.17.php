...
<html >
<head>
<title>C# и .NET | Создание классов исключений</title>
<meta charset="utf-8" />
<meta name="description" content="Класс Exception в языке программирования C#, его свойства и методы, создание своих классов исключений и их вызов">
...
<h2>Создание классов исключений</h2><div class="date">Последнее обновление: 30.12.2021</div>
...
<p>Если нас не устраивают встроенные типы исключений, то мы можем создать свои типы. Базовым классом 
...
<div class="nav"><p><a href="./2.31.php">Назад</a><a href="./">Содержание</a><a href="./2.30.php">Вперед</a></p></div></div>
<div class="socBlock">
