...
<html >
<head>
<title>C# и .NET | Перегрузка методов</title>
<meta charset="utf-8" />
<meta name="description" content="Перегрузка методов в C#, правила перегрузки методов">
...
<h2>Перегрузка методов</h2><div class="date">Последнее обновление: 27.12.2021</div>
...
<p>Иногда возникает необходимость создать один и тот же метод, но с разным набором параметров. 
И в зависимости от имеющихся параметров применять определенную версию метода. Такая возможность еще называется <span class="b">перегрузкой методов</span> 
...
<span class="b">Сигнатура</span> складывается из следующих аспектов:</p>
<ul>
...
<p>У данного метода сигнатура будет выглядеть так: <code>Sum(int, int)</code></p>
...
<p>Поэтому данный набор методов не представляет корректные перегрузки метода Sum и <span class="b">работать не будет</span>.</p>
