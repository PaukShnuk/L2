...
<html >
<head>
<title>C# и .NET | Математические вычисления и класс Math</title>
<meta charset="utf-8" />
<meta name="description" content="Математические вычисления и класс Math в C# и .NET, синус, косинус, логарифм, округление чисел">
...
<h2>Математические вычисления и класс Math</h2><div class="date">Последнее обновление: 06.01.2022</div>
...
<p>Для выполнения различных математических операций в библиотеке классов .NET предназначен класс <span class="b">Math</span>. Он является статическим, поэтому все его методы также являются статическими.</p>
<p>Рассмотрим основные методы класса Math:</p>
<ul>
<li><p><code>Abs(double value)</code>: возвращает абсолютное значение для аргумента value</p>
<pre class="brush:c#;">
double result = Math.Abs(-12.4); // 12.4
</pre>
</li>
<li><p><code>Acos(double value)</code>: возвращает арккосинус value. Параметр value должен иметь значение от -1 до 1</p>
<pre class="brush:c#;">
double result = Math.Acos(1); // 0
</pre>
</li>
<li><p><code>Asin(double value)</code>: возвращает арксинус value. Параметр value должен иметь значение от -1 до 1</p></li>
<li><p><code>Atan(double value)</code>: возвращает арктангенс value</p></li>
<li><p><code>BigMul(int x, int y)</code>: возвращает произведение x * y в виде объекта long</p>
<pre class="brush:c#;">
double result = Math.BigMul(100, 9340); // 934000
</pre>
</li>
<li><p><code>Ceiling(double value)</code>: возвращает наименьшее целое число с плавающей точкой, которое не меньше value</p>
<pre class="brush:c#;">
double result = Math.Ceiling(2.34); // 3
</pre>
</li>
<li><p><code>Cos(double d)</code>: возвращает косинус угла d</p></li>
<li><p><code>Cosh(double d)</code>: возвращает гиперболический косинус угла d</p></li>
<li><p><code>DivRem(int a, int b, out int result)</code>: возвращает результат от деления a/b, а остаток помещается в параметр result</p>
<pre class="brush:c#;">
int result;
...
<li><p><code>Exp(double d)</code>: возвращает основание натурального логарифма, возведенное в степень d</p></li>
<li><p><code>Floor(decimal d)</code>: возвращает наибольшее целое число, которое не больше d</p>
<pre class="brush:c#;">
double result = Math.Floor(2.56); // 2
</pre>
</li>
<li><p><code>IEEERemainder(double a, double b)</code>: возвращает остаток от деления a на b</p>
<pre class="brush:c#;">
double result = Math.IEEERemainder(26, 4); // 2 = 26-24
</pre>
</li>
<li><p><code>Log(double d)</code>: возвращает натуральный логарифм числа d</p></li>
<li><p><code>Log(double a, double newBase)</code>: возвращает логарифм числа a по основанию newBase</p></li>
<li><p><code>Log10(double d)</code>: возвращает десятичный логарифм числа d</p></li>
<li><p><code>Max(double a, double b)</code>: возвращает максимальное число из a и b</p></li>
<li><p><code>Min(double a, double b)</code>: возвращает минимальное число из a и b</p></li>
<li><p><code>Pow(double a, double b)</code>: возвращает число a, возведенное в степень b</p></li>
<li><p><code>Round(double d)</code>: возвращает число d, округленное до ближайшего целого числа</p>
<pre class="brush:c#;">
double result1 = Math.Round(20.56); // 21
double result2 = Math.Round(20.46); //20
</pre></li>
<li><p><code>Round(double a, int b)</code>: возвращает число a, округленное до определенного количества знаков после запятой, представленного параметром b</p>
<pre class="brush:c#;">
double result1 = Math.Round(20.567, 2); // 20,57
double result2 = Math.Round(20.463, 1); //20,5
</pre></li>
<li><p><code>Sign(double value)</code>: возвращает число 1, если число value положительное, и -1, если значение value отрицательное. Если value равно 0, то возвращает 0</p>
<pre class="brush:c#;">
int result1 = Math.Sign(15); // 1
int result2 = Math.Sign(-5); //-1
</pre></li>
<li><p><code>Sin(double value)</code>: возвращает синус угла value</p></li>
<li><p><code>Sinh(double value)</code>: возвращает гиперболический синус угла value</p></li>
<li><p><code>Sqrt(double value)</code>: возвращает квадратный корень числа value</p>
<pre class="brush:c#;">
double result1 = Math.Sqrt(16); // 4
</pre></li>
<li><p><code>Tan(double value)</code>: возвращает тангенс угла value</p></li>
<li><p><code>Tanh(double value)</code>: возвращает гиперболический тангенс угла value</p></li>
<li><p><code>Truncate(double value)</code>: отбрасывает дробную часть числа value, возвращаяя лишь целое значние</p>
<pre class="brush:c#;">
double result = Math.Truncate(16.89); // 16
</pre></li>
</ul>
<p>Также класс Math определяет две константы: <code>Math.E</code> и <code>Math.PI</code>. Например, вычислим площадь круга:</p>
<pre class="brush:c#;">
double radius = 50;
...
<div class="nav"><p><a href="./20.1.php">Назад</a><a href="./">Содержание</a><a href="./20.4.php">Вперед</a></p></div></div>
<div class="socBlock">
