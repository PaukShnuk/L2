...
<html >
<head>
<title>C# и .NET | Перечисления enum</title>
<meta charset="utf-8" />
<meta name="description" content="Создание и использование перечислений enum в языке программирования C#, задание типа данных для перечисления">
...
<h2>Перечисления enum</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Кроме примитивных типов данных в языке программирования C# есть такой тип как <span class="b">enum</span> или 
<span class="b">перечисление</span>. Перечисления представляют набор логически связанных констант.</p> 
<p>Объявление перечисления происходит с помощью оператора <span class="b">enum</span>:</p>
<pre class="brush:c#;">
...
<p>После оператора <code>enum</code> идет название перечисления. И затем в фигурных скобках через запятую перечисляются константы перечисления.</p>
...
<p>Здесь определено перечисление DayTime, которое имеет четыре значения: <code>Morning, Afternoon, Evening</code> и <code>Night</code></p>
...
<pre class="brush:c#;">const DayTime dayTime = DayTime.Morning;</pre>
...
<p>Здесь метод <code>PrintMessage()</code> в качестве параметра принимает значение типа перечисления DayTime и зависимости от этого значения 
...
одной из констант перечисления. И также определен метод <code>DoOperation()</code>, который в качестве параметров принимает два числа и 
тип операции в виде константы перечисления и в зависимости от этого типа возвращает из конструкции <code>switch</code> результат определенной операции.</p>
...
Если тип явным образом не указан, то по умолчанию используется тип <span class="b">int</span>.</p>
...
<pre class="brush:c#;">(int) DayTime.Night	// 3</pre>
...
<ul>
<li><a title="Вопросы для самопроверки" href="../questions/1.7.php"><i class="fa fa-lg fa-question"></i><span class="dop-txt">Вопросы для самопроверки</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./3.45.php">Назад</a><a href="./">Содержание</a><a href="./3.1.php">Вперед</a></p></div></div>
<div class="socBlock">
