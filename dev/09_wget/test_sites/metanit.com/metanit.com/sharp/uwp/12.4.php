...
<html >
<head>
<title>UWP | Чтение и запись файлов</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с файлами в Universal Windows Platform, чтение файлов и запись в файлы с помощью классов StorageFile и FileIO">
...
<h2>Чтение и запись файлов</h2><div class="date">Последнее обновление: 24.02.2016</div>
...
<p>Для создания файла применяется метод <span class="b">CreateFileAsync()</span> объекта StorageFolder. Этот метод принимает два параметра:</p>
<ul>
<li><p>Название нового файла</p></li>
<li><p>Значение из перечисления <span class="b">Windows.Storage.CreationCollisionOption</span>, устанавливающее параметры создания. 
Данное перечисление может иметь следующие значения:</p>
<ul>
...
<p>К примеру создадим файл "hello.txt" в локальной папке приложения:</p>
<pre class="brush:c#;">
...
<h3>Запись и чтение файлов</h3>
<p>Для записи и чтения файлов применяется класс <span class="b">FileIO</span>. Он имеет ряд методов для управления файлами:</p>
<ul>
<li><p><span class="b">AppendLinesAsync()</span>: добавляет в файл набор строк</p></li>
<li><p><span class="b">AppendTextAsync()</span>: добавляет в файл строку</p></li>
<li><p><span class="b">ReadBufferAsync()</span>: считывает содержимое файла в буфер</p></li>
<li><p><span class="b">ReadLinesAsync()</span>: считывает файл построчно в набор строк</p></li>
<li><p><span class="b">ReadTextAsync()</span>: считывает все содержимое файла в одну строку</p></li>
<li><p><span class="b">WriteBytesAsync()</span>: записывает в файл массив байтов</p></li>
<li><p><span class="b">WriteBufferAsync()</span>: записывает в файл данные из буфера данных</p></li>
<li><p><span class="b">WriteLinesAsync()</span>: записывает в файл набор строк</p></li>
<li><p><span class="b">WriteTextAsync()</span>: записывает в файл одну строку</p></li>
</ul>
<p>К примеру, запишем и считаем текстовый файл. Для этого определим страницу с двумя кнопками и текстовым полем:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>В файле кода определим следующее содержимое:</p>
<pre class="brush:c#;">
using System;
...
<img src="pics/12.1.png" alt="Сохранение и чтение текстовых файлов в UWP" />
