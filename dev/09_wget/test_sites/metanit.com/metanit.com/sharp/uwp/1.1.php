...
<html >
<head>
<title>UWP | Введение</title>
<meta charset="utf-8" />
<meta name="description" content="Введение в создание универчальных приложений на платформе UWP (Universal Windows Platform) с помощью языка программирования C#">
...
<h1>Введение в UWP</h1><h2>Что такое Universal Windows Platform</h2><div class="date">Последнее обновление: 12.04.2017</div>
...
<p><span class="b">UWP (Universal Windows Platform)</span> представляет собой унифицированную платформу для создания и запуска приложений в Windows 10 и Windows 10 Mobile.</p>
<p>UWP стала результатом эволюции более ранних технологий. Так, с выходом Windows 8 была внедрена новая архитектурная платформа для приложений - Windows Runtime (WinRT), которая позволяла запускать приложения в так называемом режиме Modern (Metro) на десктопах, планшетах. 
...
И в июле 2015 года официально вышла новая ОС Windows 10. Она использует платформу UWP, которая представляет собой развитие Windows Runtime.</p>
<p>Как подсказывает название платформы, она является универсальной - универсальной для всех устройств экосистемы Windows 10. А это обычные дестопы, планшеты, 
мобильные устройства, устройства IoT (интернет вещей), Xbox, устройства Surface Hub. И приложение UWP может одинаково работать на всех этих платформах, если на них установлена Windows 10.</p>
<h3>Почему UWP?</h3>
<p>Программирование под UWP несет ряд преимуществ:</p>
<ul>
<li><p><span class="b">Широта распространения</span>. На текущий момент (апрель 2017) Windows 10 установлена уже более чем на 400 миллионах устройств. 
На десктопах Windows 10 уже опередила Windows 8/8.1.</p></li>
<li><p><span class="b">Поддержка широкого круга устройств</span>. Десктопы, планшеты, смартфоны, большие планшеты Surface Hub, различные IoT-устройства, в перспективе устройства виртуальной реальности 
HoloLens - круг устрйоств, на которых может работать Windows 10 действительно широк.</p></li>
<li><p><span class="b">Поддержка разных языков и технологий программирования</span>. UWP-приложения можно создавать с помощью таких языков, как 
Visual C++, C#, Visual Basic, JavaScript. В качестве технологии для создания графического интерфейса Visual C++, C# и Visual Basic используют XAML, 
 JavaScript применяет HTML. Кроме того, С++ может вместо XAML использовать DirectX. То есть достаточно распространенные и и знакомые многим технологии.</p></li>
<li><p><span class="b">Магазин приложений и удобство распространения</span>. Windows Store представляет собой прекрасное место для распространения 
...
Причем все эти возможности монетизации обесечиваются встроенными инструментами SDK.</p></li>
<li><p><span class="b">Богатые возможности платформы</span>. UWP многое наследует от Windows Runtime из Windows 8.1 и в то же время предоставляет много новых функцональностей, как, 
более богатые возможности по интеграции с облаком, использование Cortana, системы уведомлений в Win10 и многое другое.</p></li>
</ul>
<h3>Что необходимо для разработки под UWP</h3>
<p>Для программирования под UWP необходима ОС Windows 10. Все другие операционные системы, как Windows 8.1/8/7, не говоря уже о Windows XP, <span class="b">не подходят</span>!</p>
<p>Также потребуется среда разработки Visual Studio 2017 Community. Это полнофункциональная бесплатная среда разработки, которую можно загрузить с официального сайта 
по адресу <a href="https://www.visualstudio.com/downloads/download-visual-studio-vs" rel="nofollow">https://www.visualstudio.com/downloads/download-visual-studio-vs</a>. </p>
<p>Также можно использовать версию VS 2015, а все остальные предыдущие версии Visual Studio - 2013, 2012, 2010 и т.д. с UWP не работают.</p>
<p>При установке Visual Studio 2017 в программе установщика необходимо отметить соответствующий пункт:</p>
<img src="pics/1.10.png" alt="Установка Universal Windows Platform" />
<p>Перед чем как начать создание приложений, убедитесь, что в центре обновления в Windows 10 установлена соответствующая опция для разработчиков:</p>
<img src="pics/1.1.png" alt="Центр обновления Windows 10" />
<img src="pics/1.2.png" alt="Опции для разработчиков в центре обновления Windows 10" />
<p>И имея Windows 10 и установленную Visual Studio 2017, можно приступать к разработке приложений.</p>
