...
<html >
<head>
<title>UWP | Диалоговые окна и ContentDialog</title>
<meta charset="utf-8" />
<meta name="description" content="Диалоговые модальные окна в Universal Windows Platform и класс ContentDialog">
...
<h2>ContentDialog</h2><div class="date">Последнее обновление: 13.04.2017</div>
...
<p>Класс <span class="b">ContentDialog</span> используется для создания диалоговых окон. Диалоговое окно можно создать в виде кода или разметки.</p>
<p>Например, определим на странице текстовое поле и кнопку:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>В файле кода пропишем для кнопки обработчик Button_Click:</p>
<pre class="brush:c#;">
using System;
...
<p>Для диалогового окна можно задать ряд свойств. Прежде всего, свойство <span class="b">Title</span> устанавливает заголовок окна, 
а свойство <span class="b">Content</span> - его текст. Свойство <span class="b">PrimaryButtonText</span> определяет текст на первой кнопке, 
а <span class="b">SecondaryButtonText</span> - на второй.</p>
<p>Для отображения диалогового окна надо вызвать асинхонный метод <span class="b">ShowAsync()</span>. Его результатом является объект 
ContentDialogResult, из которого мы можем узнать какую кнопку нажал пользователь. Если результат равен <code>ContentDialogResult.Primary</code>, 
то нажата первая кнопка.</p>
<p>Запустим приложение и нажмем на кнопку:</p>
<img src="pics/4.60.png" alt="Модальное окно ContentDialog в UWP" />
<p>При этом диалоговое окно будет модальным и будет занимать всю страницу. И пока мы не нажмем на определенную кнопку, работать с приложением мы не сможем.</p>
