...
<html >
<head>
<title>UWP | Image и работа с изображениями</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент Image и работа с изображениями в Universal Windows Platform, примеры использования, обрезка изображения">
...
<h2>Image и работа с изображениями</h2><div class="date">Последнее обновление: 12.04.2017</div>
...
<p>Для вывода изображений используется элемент <span class="b">Image</span>. Он работает со следующими форматами файлов: jpeg, png, bmp, tiff, gif, ico.</p>
<p>Чтобы установить отображаемое изображение Image использует свойство <span class="b">Source</span>, которому присваивается путь к изображению. В качестве пути могут 
применяться адреса в интернете или пути к файлам внутри приложения.</p>
<p>Пути к изображению отсчитываются относительно корня проекта. Допустим, в корне проекта лежит графический файл river.png. Выведем его на страницу:</p>
<pre class="brush:xml;">
&lt;Grid Background="{ThemeResource ApplicationPageBackgroundThemeBrush}"&gt;
    &lt;Image Source="river.png" /&gt;
&lt;/Grid&gt;
</pre>
<img src="pics/4.14.png" alt="Image in Universal Windows Platform" />
<p>Мы можем управлять отображением картинки, используя свойство <span class="b">Stretch</span>. Оно принимает следующие значения:</p>
<ul>
<li><p><span class="b">None</span>: отсутствие масштабирования - изображение отображается в натуральную длину и ширину. Если размер изображения превышает размер Image, то 
изображение усекается</p></li>
<li><p><span class="b">Uniform</span>: изображение масштабируется так, чтобы наиболее эффективно вписаться в размеры Image без потери аспектного пространства 
(отношения длины изображения к ширине). Это значение по умолчанию.</p></li>
<li><p><span class="b">Fill</span>: изображение масштабируется таким образом, чтобы заполнить все пространство Image</p></li>
<li><p><span class="b">UniformToFill</span>: изображение масштабируется таким образом, чтобы заполнить все пространство Image с сохранением аспектного отношения</p></li>
</ul>
<p>Выше был приведен пример с <code>Stretch="Uniform"</code>. То же самое изображение при значении <code>Stretch="Fill"</code>:</p>
<img src="pics/4.15.png" alt="Fill Stretch Image in Universal Windows Platform" />
<p>И значение <code>Stretch="UniformToFill"</code>:</p>
<img src="pics/4.16.png" alt="UniformToFill Stretch Image in Universal Windows Platform" />
<h3>Свойство Clip. Обрезка изображения</h3>
<p>С помощью свойства Clip можно вырезать на элементе Image определенную часть изображения. Например:</p>
<pre class="brush:xml;">
&lt;Image Source="river.png" Stretch="Fill"&gt;
    &lt;Image.Clip&gt;
        &lt;RectangleGeometry Rect="20,20,300,250" /&gt;
    &lt;/Image.Clip&gt;
&lt;/Image&gt;
</pre>
<p>Свойство Clip принимает объект RectangleGeometry, которое с помощью свойства Rect устанавливает вырезаемую область:</p>
<h3>Программное создание</h3>
<p>Программное создание объекта Image:</p>
<pre class="brush:c#;">
