...
<html >
<head>
<title>UWP | ScrollViewer</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент ScrollViewer в Universal Windows Platform, создание горизонтальной и вертикальной прокрутки">
...
<h2>ScrollViewer</h2><div class="date">Последнее обновление: 16.02.2016</div>
...
<p>Иногда необходимо вместить на страницу больше элементов, чем она может разместить, либо на ограниченном пространстве расположить много контента, 
...
элемент ScrollViewer.</p>
<p>Элемент ScrollViewer создает горизонтальные и вертикальные полосы прокрутки. Например:</p>
<pre class="brush:xml;">
&lt;Grid>
    &lt;ScrollViewer>
...
<img src="pics/4.58.png" alt="ScrollViewer в Universal Windows Platform" />
<p>В данном случае размеры изображения выходят за текущие границы окна. Однако, так как элемент Image вложен в элемент ScrollViewer, с помощью вертикальной полосы прокрутки 
я могу просмотреть все изображение.</p>
<p>ScrollViewer является элементом управления содержимым и может вмещать в себя только один элемент через свойство Content, поэтому все элементы, помещаемые 
внутрь ScrollViewer, необходимо облачить в еще один контейнер:</p>
<pre class="brush:xml;">
...
<img src="pics/4.59.png" alt="Прокрутка списка в UWP" />
<p>Из свойств ScrollViewer следует отметить свойства <span class="b">HorizontalScrollBarVisibility</span> и <span class="b">VerticalScrollBarVisibility</span>. 
Они управляют соответственно горизонтальной и вертикальной прокруткой. Они могут принимать следующие значения:</p>
<ul>
<li><p><span class="b">Auto</span>: наличие полос прокрутки устанавливается автоматически</p></li>
<li><p><span class="b">Visible</span>: полосы прокрутки отображаются в окне приложения</p></li>
<li><p><span class="b">Hidden</span>: полосы прокрутки не видно, но прокрутка возможна с помощью клавиш клавиатуры</p></li>
<li><p><span class="b">Disabled</span>: полосы прокрутки не используются, а сама прокрутка даже с помощью клавиатуры невозможна</p></li>
</ul>
<p>Из специфичных для ScrollViewer свойств еще можно выделить <span class="b">IsDeferredScrollingEnabled</span>. Если это свойство равно <code>true</code>, 
то прокрутка осуществляется только в тот момент, когда пользователь отпустит ползунок, то есть отложенная прокрутка.</p>
...
<div class="nav"><p><a href="4.20.php">Назад</a><a href="./">Содержание</a><a href="4.22.php">Вперед</a></p></div></div>
<div class="socBlock">
