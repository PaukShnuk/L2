...
<html >
<head>
<title>UWP | RelativePanel</title>
<meta charset="utf-8" />
<meta name="description" content="RelativePanel в Universal Windows Platform и C#, расположение элементов относительно друг друга">
...
<h2>RelativePanel</h2><div class="date">Последнее обновление: 12.11.2017</div>
...
<p><span class="b">RelativePanel</span> представляет контейнер, в котором можно задать позиционирование элемента относительно 
другого элемента. Для этого во всех вложенных элементах можно использовать ряд свойств.</p>
<p>Установка позиции относительно другого элемента:</p>
<ul>
<li><p><span class="b">RelativePanel.Above</span>: размещение над другим элементом</p></li>
<li><p><span class="b">RelativePanel.Below</span>: размещение под другим элементом</p></li>
<li><p><span class="b">RelativePanel.LeftOf</span>: размещение слева от другого элемента</p></li>
<li><p><span class="b">RelativePanel.RightOf</span>: размещение справа от другого элемента</p></li>
</ul>
<p>Вторая группа свойств управляет выравниванием одного элемента относительно другого:</p>
<ul>
<li><p><span class="b">RelativePanel.AlignBottomWith</span>: выравнивает относительно другого элемента по нижнему краю</p></li>
<li><p><span class="b">RelativePanel.AlignHorizontalCenterWith</span>: выравнивает относительно другого элемента по центру по горизонтали</p></li>
<li><p><span class="b">RelativePanel.AlignLeftWith</span>: выравнивает относительно другого элемента слева</p></li>
<li><p><span class="b">RelativePanel.AlignRightWith</span>: выравнивает относительно другого элемента справа</p></li>
<li><p><span class="b">RelativePanel.AlignTopWith</span>: выравнивает относительно другого элемента сверху</p></li>
<li><p><span class="b">RelativePanel.AlignVerticalCenterWith</span>: выравнивает относительно другого элемента по центру по вертикали</p></li>
</ul>
<p>Обе эти группы свойств принимают в качестве значения имя другого элемента, относительно которого надо размещать текущий элемент.</p>
<p>И третья группа свойств выравнивает элемент относительно границ самого контейнера RelativePanel:</p>
<ul>
<li><p><span class="b">RelativePanel.AlignBottomWithPanel</span>: при значении true выравнивает элемент по вертикали по нижнему краю панели</p></li>
<li><p><span class="b">RelativePanel.AlignHorizontalCenterWithPanel</span>: при значении true выравнивает элемент по горизонтали по центру панели</p></li>
<li><p><span class="b">RelativePanel.AlignLeftWithPanel</span>: при значении true выравнивает элемент по левому краю панели</p></li>
<li><p><span class="b">RelativePanel.AlignRightWithPanel</span>: при значении true выравнивает элемент по правому краю панели</p></li>
<li><p><span class="b">RelativePanel.AlignTopWithPanel</span>: при значении true выравнивает элемент по верхнему краю панели</p></li>
<li><p><span class="b">RelativePanel.AlignVerticalCenterWithPanel</span>: при значении true выравнивает элемент по вертикали по центру панели</p></li>
</ul>
<p>Эти свойства принимают логическое значение true или false.</p>
<p>Для достижения нужного эффекта эти свойства можно комбинировать. Например, определим текстовое поле и справа от него кнопку:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>Здесь кнопка прижата к верхнему и правому краю контейнера RelativePanel. А текстовое поле прижато к левой границе контейнера и размещается слева от кнопки.</p>
<img src="pics/3.9.png" alt="RelativePanel in Universal Windows Platform" />
