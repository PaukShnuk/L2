...
<html >
<head>
<title>UWP | Работа с видео</title>
<meta charset="utf-8" />
<meta name="description" content="Работа со видеофайлами в Universal Windows Platform, управление воспроизведением видео, элемент MediaElement">
...
<h2>Видео</h2><div class="date">Последнее обновление: 16.04.2017</div>
...
<p>Для воспроизведения видео применяется все тот же класс <span class="b">MediaElement</span>, поэтому работа с видео в данном случае будет во многом аналогична работе 
аудио.</p>
<p>Так, создадим для видеофайлов в проекте новую папку <span class="ii">video</span> и добавим в нее какой-нибудь видеофайл:</p>
<img src="pics/15.5.png" alt="Видеофайлы в Universal Windows Platform" />
<p>Определим элемент MediaElement для воспроизведения этого файла:</p>
<pre class="brush:xml;">
&lt;Page
    ...
    &lt;Grid Background="{ThemeResource ApplicationPageBackgroundThemeBrush}"&gt;
        &lt;MediaElement x:Name="media" AutoPlay="True" Source="video/20130606_153123.mp4" /&gt;
    &lt;/Grid&gt;
&lt;/Page&gt;
</pre>
<p>И после старта приложения начнет проигрываться видеофайл:</p>
<img src="pics/15.4.png" alt="Работа с видео в UWP" />
<p>Здесь также мы можем настроить программное управление воспроизведением или добавить элементы управления по умолчанию, используя свойство 
<code>AreTransportControlsEnabled="True"</code></p>
<p>Кроме того, при воспроизведении видео могут быть полезными еще ряд свойств:</p>
<ul>
<li><p><span class="b">PosterSource</span>: представляет ссылку на изображение, которое будет отображаться во время загрузки видео</p></li>
<li><p><span class="b">IsFullWindow</span>: при значении true видео будет отображаться на весь экран (для десктопов)</p></li>
</ul>
<p>Например:</p>
<pre class="brush:xml;">
&lt;MediaElement x:Name="media" AutoPlay="True"  
    Source="video/20130606_153123.mp4" PosterSource="images/20130510_154622.jpg" 
...
<div class="nav"><p><a href="13.1.php">Назад</a><a href="./">Содержание</a><a href="16.1.php">Вперед</a></p></div></div>
<div class="socBlock">
