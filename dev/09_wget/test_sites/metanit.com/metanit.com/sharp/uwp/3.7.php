...
<html >
<head>
<title>UWP | Размеры и позиционирование элементов</title>
<meta charset="utf-8" />
<meta name="description" content="Размеры и позиционирование элементов в Universal Windows Platform, минимальная и максимальная высота и ширина, растяжение, выравнивание, отступы между элементами">
...
<h2>Размеры и позиционирование элементов</h2><div class="date">Последнее обновление: 11.02.2016</div>
...
<p>Все элементы в Universal Windows Platform обладают рядом свойств, которые влияют на их компоновку и позиционирование внутри контейнера. Рассмотрим эти свойства.</p>
<h3>Ширина и высота</h3>
<p>Ширина элемента задается с помощью свойства <span class="b">Width</span>, а высота - с помощью свойства <span class="b">Height</span>. 
Эти свойства принимают значение типа <code>double</code>.</p>
<p>Однако если мы хотим получить размеры элемента во время выполнения, то лучше использовать свойства <span class="b">ActualHeight</span> и <span class="b">ActualWidth</span> вместо 
Height и Width.</p>
<p>Также мы можем задать возможный диапазон ширины и высоты с помощью свойств <span class="b">MinWidth/MaxWidth</span> и 
<span class="b">MinHeight/MaxHeight</span>. И при растяжении или сжатии контейнеров элементы с данными заданными свойствами не будут выходить за пределы 
установленных значений.</p>
<h3>Выравнивание</h3>
<h4>HorizontalAlignment</h4>
<p>Свойство <span class="b">HorizontalAlignment</span> позволяет выровнить элемент по горизонтали относительно правой или левой стороны контейнера и 
соответственно может принимать значения Left, Right, Center (положение по центру), Stretch (растяжение по всей ширине). Например:</p>
<pre class="brush:xml;">
&lt;Grid&gt;
...
<img src="pics/3.16.png" alt="HorizontalAlignment в Universal Windows Platform" />
<h4>VerticalAlignment</h4>
<p><span class="b">VerticalAlignment</span> устанавливает выравнивание по вертикали. Это свойство принимает следующие значения: Top 
(положение в верху контейнера), Bottom (положение внизу), Center (положение по центру), Stretch (растяжение по всей высоте). Например:</p>
<pre class="brush:xml;">
...
<img src="pics/3.17.png" alt="VerticalAlignment в Universal Windows Platform" />
<p>Чтобы задать эти свойства в коде, нам надо использовать перечисления <code>HorizontalAlignment</code> и <code>VerticalAlignment</code>:</p>
<pre class="brush:c#;">
Button button1 = new Button();
button1.HorizontalAlignment = HorizontalAlignment.Center;
button1.VerticalAlignment = VerticalAlignment.Center;
</pre>
<h3>Отступы margin и padding</h3>
<p>Свойство <span class="b">Margin</span> устанавливает отступы вокруг элемента. Его синтаксис:</p>
<pre>Margin="левый_отступ верхний_отступ правый_отступ нижний_отступ"</pre>
<p>Свойство <span class="b">Padding</span> устанавливает отступы от границ элемента вокруг его содержимого. Имеет такой же синтаксис:</p>
<pre>Padding="левый_отступ верхний_отступ правый_отступ нижний_отступ"</pre>
<img src="pics/3.18.png" alt="Margin и Padding в Universal Windows Platform" />
<p>Например, установим отступы у одной кнопки слева и сверху, а у другой кнопки справа и снизу:</p>
<pre class="brush:xml;">
...
<img src="pics/3.19.png" alt="Margin в UWP" />
<p>В коде C# свойствам Margin и Padding соответствует объект <span class="b">Thickness</span>:</p>
<pre class="brush:c#;">
Button button1 = new Button();
