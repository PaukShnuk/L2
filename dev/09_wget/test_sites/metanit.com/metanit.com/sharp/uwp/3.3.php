...
<h2>StackPanel</h2><div class="date">Последнее обновление: 11.02.2016</div>
...
&lt;Page
    ...
    &lt;StackPanel&gt;
        &lt;Rectangle Fill="LightBlue" Height="40" /&gt;
        &lt;Rectangle Fill="LightGreen" Height="40" /&gt;
        &lt;Rectangle Fill="LightPink" Height="40" /&gt;
    &lt;/StackPanel&gt;
&lt;/Page&gt;
</pre>
<img src="pics/3.4.png" alt="Vertical StackPanel in Universal Windows Platform" />
<p>По умолчанию свойство <code>Orientation</code> элемента StackPanel использует значение <code>Vertical</code>, то есть создается вертикальный ряд, в 
...
<code>Orientation="Horizontal"</code>:</p>
<pre class="brush:xml;">
&lt;Page
    x:Class="LayoutApp.MainPage"
    xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
...
<img src="pics/3.5.png" alt="Horizontal StackPanel in Universal Windows Platform" />
<p>При горизонтальной ориентации все вложенные элементы располагаются слева направо. Если мы хотим, чтобы наполнение стека начиналось справа налево, то необходимо 
задать свойство <code>FlowDirection="RightToLeft"</code>:</p>
<pre class="brush:xml;">
...
<img src="pics/3.6.png" alt="Направление StackPanel в Universal Windows Platform" />
<p>По умолчанию это свойство имеет значение LeftToRight - то есть слева направо.</p>
<p>Нередко бывает, что StackPanel с элементами не вмещается в область графического окна. И в этом случае StackPanel помещается в ScrollView, который создает полосы прокрутки.</p>
