...
<html >
<head>
<title>UWP | Работа с файлами</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с файлами в Universal Windows Platform, копирование, удаление, переименование файлов, получение детальной информации о файле">
...
<h2>Работа с файлами</h2><div class="date">Последнее обновление: 24.02.2016</div>
...
<p>Для работы с файлами применяется класс <span class="b">StorageFile</span>. С помощью его методов мы можем управлять файлами:</p>
<ul>
<li><p><span class="b">CopyAsync()</span>: создает копию текущего файла</p></li>
<li><p><span class="b">DeleteAsync()</span>: удаляет текущий файл</p></li>
<li><p><span class="b">GetBasicPropertiesAsync()</span>: возвращает основные свойства файла (размер, дата изменения)</p></li>
<li><p><span class="b">GetParentAsync()</span>: возвращает папку файла</p></li>
<li><p><span class="b">MoveAsync()</span>: перемещает файл в новую папку</p></li>
<li><p><span class="b">RenameAsync()</span>: переименовывает файл</p></li>
<li><p><span class="b">CreateFolderAsync()</span>: создает новую папку</p></li>
<li><p><span class="b">OpenAsync()</span>: открывает файл, получая на него поток</p></li>
<li><p><span class="b">OpenReadAsync()</span>: открывает файл для чтения</p></li>
<li><p><span class="b">OpenStreamForReadAsync()</span>: открывает файл для чтения</p></li>
<li><p><span class="b">OpenStreamForWriteAsync()</span>: открывает файл для записи</p></li>
</ul>
<p>Свойства StorageFile позволяют получить детальную информацию о файле:</p>
<ul>
<li><p><span class="b">Attributes</span>: возвращает атрибуты файла</p></li>
<li><p><span class="b">ContentType</span>: возвращает MIME-тип содержимого файла</p></li>
<li><p><span class="b">DateCreated</span>: дата создания файла</p></li>
<li><p><span class="b">DisplayName</span>: отображаемое название файла</p></li>
<li><p><span class="b">FileType</span>: расширение файла</p></li>
<li><p><span class="b">Name</span>: стандартное название</p></li>
<li><p><span class="b">Path</span>: полный путь к файлу</p></li>
<li><p><span class="b">Properties</span>: свойства файла</p></li>
</ul>
<p>Здесь особо следует отметить свойство Properties, которое позволяет получить набор дополнительных свойств файла, причем этот набор может варьироваться в зависимости от 
типа файла. Например, выведем информацию о файлах из папки Видео. Для вывода в коде xaml определим TextBlock:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>А в обработчике загрузки страницы в файле кода выведем информацию о файлах из папки Видео:</p>
<pre class="brush:c#;">
using System;
...
<p>Соответственно, чтобы получить доступ к файлам в папке Видео, нам надо включить пункт VideosLibrary в разделе Capabilities в файле манифеста Package.appxmanifest.</p>
<img src="pics/12.6.png" alt="Свойство файлов в Universal Windows Platform" />
