...
<html >
<head>
<title>UWP | Стрелочный датчик</title>
<meta charset="utf-8" />
<meta name="description" content="Создание стрелочного датчика - измерителя на C# в Universal Windows Platform">
...
<h1>Дополнительные элементы управления</h1><h2>Стрелочный датчик</h2><div class="date">Последнее обновление: 13.04.2016</div>
...
<p>Рассмотрим создание стрелочного датчика на Universal Windows Platform.</p>
<img src="pics/18.2.png" alt="Измерительный прибор в UWP" />
<p>Создадим новый проект и вначале добавим в него через Nuget пакет <span class="b">WinRTXamlToolkitControls.Gauge.UWP</span>:</p>
<img src="pics/18.1.png" alt="Добавление WinRTXamlToolkitControls.Gauge.UWP в проект UWP" />
<p>На главной странице в xaml определим такой код:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>В начал нам надо подключить пространство имен нашего элемента управления:</p>
<pre class="brush:xml;">xmlns:toolkit="using:WinRTXamlToolkit.Controls"</pre>
<p>Затем создаем сам элемент <span class="b">toolkit:Gauge</span>, представляющий стрелочный датчик. Для его настройки используем следующие свойства:</p>
<ul>
<li><p><span class="b">Value</span>: некоторое числовое значение датчика</p></li>
<li><p><span class="b">Unit</span>: единицы измерения. Это могут быть любые произвольные единицы измерения - минуты, часы, километры, граммы и т.д.</p></li>
<li><p><span class="b">ScaleTickBrush</span>: цвет внутренних делений датчика</p></li>
<li><p><span class="b">TickBrush</span>: цвет внешних делений датчика</p></li>
<li><p><span class="b">TickSpacing</span>: ширина пространства между делениями датчика</p></li>
<li><p><span class="b">ScaleWidth</span>: ширина внутренних делений датчика</p></li>
<li><p><span class="b">NeedleBrush</span>: цвет стрелки</p></li>
<li><p><span class="b">TrailBrush</span>: цвет пройденного пространства датчика</p></li>
<li><p><span class="b">ValueBrush</span>: цвет текста значения</p></li>
<li><p><span class="b">UnitBrush</span>: цвет текста единиц измерения</p></li>
</ul>
<p>Экспериментируя с этими настройками, мы можем изменить внешнее отображение датчика:</p>
<pre class="brush:xml;">
...
<img src="pics/18.3.png" alt="Radial Gauge в UWP" />
...
<div class="nav"><p><a href="16.4.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
