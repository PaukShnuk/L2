...
<html >
<head>
<title>UWP | Ресурсы</title>
<meta charset="utf-8" />
<meta name="description" content="Ресурсы в Universal Windows Platform, их определение и использование">
...
<h1>Ресурсы</h1><h2>Концепция ресурсов в Universal Windows Platform</h2><div class="date">Последнее обновление: 11.02.2016</div>
...
<p>Ресурсы - это такие логические объекты (кисти, элементы управления, коллекции объектов и т.д.), которые мы можем определить в коде XAML или C#, а затем 
...
а не о физических ресурсах - файлах изображений, аудио, видео и др.</p>
<p>Ресурсы повышают эффективность: мы можем определить один раз какой-либо ресурс и затем многократно использовать его в различных местах приложения. 
...
во всем приложении.</p>
<p>Для определения ресурсов у большинства элементов в Universal Windows Platform имеется свойство <span class="b">Resources</span>. Это свойство представляет 
объект <span class="b">ResourceDictionary</span> - словарь ресурсов, в котором каждый ресурс имеет уникальный ключ.</p>
<p>Определим в приложении несколько ресурсов:</p>
<pre class="brush:xml;">
&lt;Page
...
<p>Здесь у объекта Page определяются два ресурса: redStyle - объект SolidColorBrush и gradientStyle - кисть 
...
<span class="b">x:Key</span>, которое определяет ключ в словаре и позволяет ссылаться на этот ресурс в других местах приложения.</p>
<p>А у свойства Background у грида и кнопки мы можем применить эти ресурсы: <code>Background="{StaticResource gradientStyle}"</code> - 
здесь после выражения <code>StaticResource</code> идет ключ применяемого ресурса.</p>
<img src="pics/5.1.png" alt="Ресурсы в Universal Windows Platform" />
...
<p>С помощью метода <code>Add()</code> объект кисти и его произвольный ключ добавляются в словарь. Далее мы получаем этот ресурс в словаре и установить 
его в качестве фона: <code>(Brush) this.Resources["buttonGradientBrush"]</code>. Причем, так как этот метод возвращает object, необходимо выполнить 
приведение типов.</p>
<p>У объекта ResourceDictionary можно выделить следующие методы и свойства:</p>
<ul>
...
<li><p>Свойство <span class="b">Source</span> устанавливает источник словаря</p></li>
