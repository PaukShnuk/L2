...
<h2>ViewResult</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Класс ViewResult является наиболее часто возвращаемым результатом действий контроллера. Он производит рендеринг представления в веб-страницу и возвращает 
ее в виде ответа клиенту.</p>
...
<p>Существует несколько способов передачи данных из контроллера в представление. Первый из них представляет использование объекта 
<strong>ViewData</strong>.</p> 
...
<p>Тогда в представлении SomeView.cshtml мы могли бы получить передаваемую строку следующим образом:</p>
<pre class="brush:xml;">
@{
    Layout = null;
}
...
<p>Еще один способ передачи данных представляет объект <strong>ViewBag</strong>. Этот объект позволяет определить различные свойства и присвоить им любое значение. Так, мы могли бы переписать 
...
<p>И еще один способ предлагает объект <span class="bb">TempData</span>. TempData представляет словарь, хранящий пары ключ-значение, как и ViewData, 
...
<div class="nav"><p><a href="3.4.php">Назад</a><a href="./">Содержание</a><a href="3.8.php">Вперед</a></p></div></div>
<div class="socBlock">
