...
<html >
<head>
<title>Шаблонные хелперы</title>
<meta charset="utf-8" />
<meta name="description" content="Шаблонные (также называют шаблонизированные) хелперы позволяют создавать html-разметку для все модели, используя определенный шаблон">
...
<h2>Шаблонные хелперы</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Кроме стандартных html-хелперов, рассмотренных в прошлой главе и генерирующих определенные элементы разметки html, фреймворк MVC 
также имеет <span class="bb">шаблонные (также называют шаблонизированные) хелперы</span>. Зачем они нужны? Они более гибки по сравнению с html-хелперами, 
так как в этом случае нам не надо думать, какой нам надо создать элемент разметки и какой для этого выбрать хелпер. 
Мы просто сообщаем шаблонному хелперу, какое свойство модели мы хотим использовать, а фреймворк уже сам выбирает, какой html-элемент сгенерировать, 
исходя из типа свойства и его метаданных.</p>
<p>Шаблонные хелперы:</p>
<ul>
	<li><p><span class="bb">Display</span></p>
	<p>Создает элемент разметки, который доступен только для чтения, для указанного свойства модели: 
	<code>Html.Display("Name")</code></p></li>
	<li><p><span class="bb">DisplayFor</span></p>
	<p>Строго типизированный аналог хелпера Display: 
	<code>Html.DisplayFor(e =&gt; e.Name)</code></p></li>
	<li><p><span class="bb">Editor</span></p>
	<p>Создает элемент разметки, который доступен для редактирования, для указанного свойства модели: 
	<code>Html.Editor("Name")</code></p></li>
	<li><p><span class="bb">EditorFor</span></p>
	<p>Строго типизированный аналог хелпера Editor: 
	<code>Html.EditorFor(e =&gt; e.Name)</code></p></li>
	<li><p><span class="bb">DisplayText</span></p>
	<p>Создает выражение для указанного свойства модели в виде простой строки: 
	<code>Html.DisplayText("Name")</code></p></li>
	<li><p><strong>DisplayTextFor</strong></p>
	<p>Строго типизированный аналог хелпера DisplayText: 
	<code>Html.DisplayTextFor(e =&gt; e.Name)</code></p></li>
</ul>
<p>Кроме данных шаблонов, которые используются для отдельного свойства модели, есть еще несколько шаблонов, которые позволяют сгенерировать разом 
все поля для определенной модели:</p>
<ul>
	<li><p><span class="bb">DisplayForModel</span></p>
	<p>Создает поля для чтения для всех свойств модели: 
	<code>Html.DisplayForModel()</code></p></li>
	<li><p><span class="bb">EditorForModel</span></p>
	<p>Создает поля для редактирования для всех свойств модели: 
	<code>Html.EditorForModel()</code></p></li>
</ul>
<p>Например, определим в контроллере некоторое действие BookView, которое по id будет выводить информацию об определенной книге: 
</p>
<pre class="brush:c#;">
...
<p>Теперь создадим представление BookView.cshtml, в котором все поля генерируются одним хелпером:</p>
<pre class="brush:xml;">
@{
...
<p>И обратимся к этому ресурсу, набрав в адресной строке браузера <i>Home/BookView/1</i>:</p>
<img src="mvcpics/5.6.png" />
