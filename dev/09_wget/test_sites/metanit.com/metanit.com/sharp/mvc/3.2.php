...
<html >
<head>
<title>Методы действий</title>
<meta charset="utf-8" />
<meta name="description" content="Методы действий (action methods) - это методы, которые обрабатывают определенный запрос по определенному URL и возвращают некоторый результат обработки запроса">
...
<h2>Методы действий</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p><span class="bb">Методы действий (action methods)</span> представляют такие методы контроллера, которые обрабатывают запросы 
