...
<html >
<head>
<title>ASP.NET MVC 4 | AJAX-запросы с помощью jQuery</title>
<meta charset="utf-8" />
<meta name="description" content="AJAX запросы с помощью jQuery в ASP.NET MVC 4">
...
<h2>AJAX-запросы с помощью jQuery</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>И в строке <code>$('#results').load("http://localhost:51805/Home/BookSearch?name=" + name);</code> мы загружаем в элемент с <code>id=results</code> контент, 
