...
<code>&lt;script&gt;</code> мы а веб-станице ссылаемся на данный файл кода.</p>
...
<table class="tab">
	<tr class="tabhead"><td><p>Хелпер</p></td><td><p>Описание</p></td></tr>
	<tr><td><p>Ajax.ActionLink</p></td><td><p>Создает гиперссылку на действие контроллера, по нажатию на которую происходит ajax-запрос к этому действию</p></td></tr>
	<tr><td><p>Ajax.RouteLink</p></td><td><p>Похож на хелпер Ajax.ActionLink, только ссылка создается на определенный маршрут, а не на действие контроллера</p></td></tr>
	<tr><td><p>Ajax.BeginForm</p></td><td><p>Создает html-форму, которая отправляет ajax-запросы к определенному действию определенного контроллера</p></td></tr>
	<tr><td><p>Ajax.BeginRouteForm</p></td><td><p>Похож на Ajax.BeginForm, только ajax-запросы направляются не к действию контроллера, к по определенному маршруту</p></td></tr>
	<tr><td><p>Ajax.GlobalizationScript</p></td><td><p>Создает ссылку на скрипт, который содержит информацию о культуре</p></td></tr>
	<tr><td><p>Ajax.JavaScriptStringEncode</p></td><td><p>Кодирует строку для использования в JavaScript</p></td></tr>
</table>
