...
<p>Затем привязчик использует специальные компоненты - <b>поставщики значений (value provider)</b> для поиска значений в различных частях запроса.</p>
