...
<html >
<head>
<title>Результаты действий</title>
<meta charset="utf-8" />
...
является объект класса, производного от <strong>ActionResult</strong>. 
...
Util, которая будет содержать новый классы. После добавления папки добавим в нее первый класс. Назовем его <span class="bb">HtmlResult</span>. Он у нас будет 
...
<p>И обратившись к этому методу из браузера, например, <i>Home/GetHtml</i>, мы получим html-страничку. Хотя данный пример довольно 
примитивен, но в целом он демонстрирует, как работают классы результатов действий.</p>
