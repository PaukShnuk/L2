...
<html >
<head>
<title>Частичные представления</title>
<meta charset="utf-8" />
<meta name="description" content="Частичное представление помогает осуществлять вкрапления разметки на веб-страницу и имеет большое применение в связке с AJAX">
...
<p>За рендеринг частичных представлений отвечает объект <code>PartialViewResult</code>, который возвращается методом <b>PartialView</b>. 
...
<img src="mvcpics/4.3.png" alt="Создание частичных представлений в ASP.NET MVC 4" />
...
<p>После этого мы можем обратиться к действию Partial, как к обычному действию контроллера, и оно нам вернет частичное представление:</p>
<img src="mvcpics/4.4.png" />
...
Для этого нам надо применить в любом месте обычного представления хелпер <span class="bb">Html.Partial</span>:</p>
...
в представлении <i>Index.сshtml</i>, то в методе Index мы можем написать:</p>
<pre class="brush:c#;">
