...
<h1>jQuery и AJAX</h1>
<h2>Использование JavaScript/jQuery</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>По умолчанию все проекты, кроме проектов по шаблону Empty, уже содержат необходимый набор скриптов, в том числе библиотеки jQuery:</p>
<img src="mvcpics/10.1.png" />
<p>Как вы видите, большинство скриптов имеют свои двойники с суффиксом <span class="ii">min</span>, например, <span class="ii">jquery-1.7.1.js</span> и <span class="ii">jquery-1.7.1.min.js</span>. 
...
большего удобства разработчиков полные и минимизированные скрипты идут вместе.</p>
<p>Вкратце посмотрим, зачем нужны большинство скриптов, идущих по умолчанию:</p>
<ul>
	<li><p><i>jquery-1.7.1.js</i> - базовая библиотека jQuery, на которую опираются большинство других скриптов. В данном случае используется 
	версия 1.7.1. Однако библиотека постоянно обновляется, поэтому можно использовать более новые версии.</p></li>
	<li><p><i>jquery-ui-1.8.20.js</i> - библиотека jQuery UI, которая включает различные виджеты, предназначенные для создания пользовательского интерфейса</p></li>
	<li><p><i>jquery.unobtrusive-ajax.js</i> - представляет функциональность для ненавязчивого JavaScript</p></li>
	<li><p><i>jquery.validate.js</i> - представляет функционал для валидации на стороне клиента</p></li>
	<li><p><i>jquery.validate.unobtrusive.js</i> - предоставляет поддержку ненавязчивой валидации</p></li>
	<li><p><i>jquery-1.7.1-vsdoc.js</i> и <i>jquery.validate-vsdoc.js</i> - используются для поддержки документации и IntelliSense 
	по соответствующим библиотекам в Visual Studio</p></li>
</ul>
<p>Чтобы подключить файл javascript используется метод <code>Render</code> класса <code>System.Web.Optimization.Scripts</code>: 
<code>@Scripts.Render("~/scripts/jquery.unobtrusive-ajax.js")</code></p>
<p>Этот метод принимает в качестве параметра строку - полный путь к скрипту.</p>
<p>Либо мы можем использовать, например, хелпер <code>Url.Content</code> : <code>&lt;script src="@Url.Content("~/scripts/jquery.validate.unobtrusive.js")" type="text/javascript"&gt;&lt;/script&gt;</code></p>
