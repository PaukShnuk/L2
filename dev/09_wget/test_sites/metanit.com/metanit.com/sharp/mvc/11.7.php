...
<html >
<head>
<title>Web Site Administration Tool</title>
<meta charset="utf-8" />
<meta name="description" content="Использование инструмента Web Site Administration Tool для управления пользователями и роля в приложении ASP.NET MVC">
...
<h2>Web Site Administration Tool</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Кроме добавления и изменения настроек учетных записей через формы регистрации, изменения пароля и другие, мы можем использовать 
средство администрирования <span class="bb">Web Site Administration Tool</span> - графический интерфейс для управления членство и ролями. 
Для этого выберем в меню Project пункт ASP.NET Configuration. После этого у нас откроется в веб-браузере страница администрирования веб-приложения:</p>
<img src="mvcpics/11.10.png" />
<p>На вкладке Security мы можем произвести управление учетными записями: создать, изменить или удалить пользователей, добавить роли и 
установить для пользователей роли:</p>
<img src="mvcpics/11.11.png" />
<p>Для создания нового пользователя выберем ссылку <span class="bb">Create user</span>. После этого нам откроется форма создания нового пользователя:</p>
<img src="mvcpics/11.12.png" alt="Создание нового пользователя в WSAT" />
<p>Либо мы могли бы выбрать ссылку <span class="bb">Manage users</span> и изменить информацию об уже добавленном пользователе, применить к нему роли и т.д.:</p>
<img src="mvcpics/11.13.png" alt="Редактирование пользователя в WSAT" />
<p>Чтобы включить роли, нажмем на ссылку <span class="ii">Enable roles</span>, затем нажмем на появившуюся ссылку <span class="ii">Create or Manage roles</span> 
и и нам откроется форма добавления роли:</p>
<img src="mvcpics/11.14.png" alt="Добавление роли в WSAT" />
<p>Поскольку действия в Web Site Administration Tool синхронизированы с бд в проекте, то добавленная роль сразу же появится в таблице 
Roles (как и добавляемые пользователи в соответствующих таблицах). И после этого мы можем назначать роли пользователю.</p>
<p>Вкладка <span class="bb">Application</span> предназначена для установки графически настроек приложения, а вкладка 
<span class="bb">Provider</span> предназначена для установки провайдеров членства и ролей для приложения.</p>
<p>В завершении разговора о Web Site Administration Tool надо отметить, что этот инструмент не совместим с использованием SimpleMembershipProvider и может использоваться только для 
при работе с традиционными или универсальными провайдерами членства и ролей. </p>
...
<div class="nav"><p><a href="11.6.php">Назад</a><a href="./">Содержание</a><a href="11.8.php">Вперед</a></p></div></div>
<div class="socBlock">
