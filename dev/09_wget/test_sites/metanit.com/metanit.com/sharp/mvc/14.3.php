...
<html >
<head>
<title>Применение CSS в мобильных приложениях</title>
<meta charset="utf-8" />
<meta name="description" content="Особенности использования стилей css в мобильных веб-приложенях, правило media для указания разных стилей для разных устройств, функции CSS3 Media Query">
...
<h2>Применение CSS в мобильных приложениях</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Учитывая особенности мобильных устройств - размеры, поддержку тех или иных стилей CSS и т.д. - может потребоваться определить какой-то 
особенный стиль для мобильных устройств.</p>
...
<code>media="screen"</code> применяется к десктопным сайтам.</p>
...
<p>Для решения этой проблемы в CSS3 были введен механизм <b>CSS3 Media Query</b>. Например, чтобы применить стиль только к мобильным устройствам 
...
<p>Значение атрибута media <code>screen and (max-device-width:480px)</code> говорит нам о том, что стили из файла mobile.css будут 
...
<p>Как вариант, можно использовать правила CSS3 Media Query в самом файле css:</p>
<pre class="brush:css;">
@media screen{
	body {
...
<p>К примеру настройка стилей под смартфоны, планшеты и десктопы может выглядеть так:</p>
<pre class="brush:css;">
...
<ul>
<li><p><span class="bb">aspect-ratio</span>: отношение ширины к высоте области отображения (браузера)</p></li>
<li><p><span class="bb">device-aspect-ratio</span>: отношение ширины к высоте экрана устройства</p></li>
<li><p><span class="bb">max-width/min-width и max-height/min-height</span>: максимальная и минимальная ширина и высота области отображения (браузера)</p></li>
<li><p><span class="bb">max-device-width/min-device-width и max-device-height/min-device-height</span>: максимальная и минимальная ширина и высота 
экрана мобильного устройства</p></li>
<li><p><span class="bb">orientation</span>: ориентация (портретная или альбомная)</p></li>
</ul>
...
<p>Таким образом, мы меняем лишь определение стилей в зависимости от устройства, а сами стили css по сути остаются теми же, что мы используем для создания обычных сайтов. 
Теперь посмотрим, как мы можем создавать мобильные приложения непосредственно на платформе ASP.NET MVC 4.</p>
