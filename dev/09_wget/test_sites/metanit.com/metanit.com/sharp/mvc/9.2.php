...
<html >
<head>
<title>DefaultModelBinder</title>
<meta charset="utf-8" />
...
<code>System.ComponentModel.TypeDescriptor</code>. Если же свойство представляет сложный тип - то опять повторяется рефлексия и весь цикл.</p>
...
<p>В данном случае выборочная привязки применена к методу Create. Что если нам надо осуществить выборочную привязку глобально во всем приложении? 
