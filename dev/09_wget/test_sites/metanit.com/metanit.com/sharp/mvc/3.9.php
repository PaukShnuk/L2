...
<html >
<head>
<title>Отправка файлов в ASP.NET MVC</title>
<meta charset="utf-8" />
...
<h2>Отправка файлов в ASP.NET MVC</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Для отправки клиенту файлов предназначен класс <span class="bb">FileResult</span>. Однако так как это абстрактный класс, то фактически мы будем иметь дело с его наследниками:</p>
<ul>
...
<div class="nav"><p><a href="3.8.php">Назад</a><a href="./">Содержание</a><a href="3.5.php">Вперед</a></p></div></div>
<div class="socBlock">
