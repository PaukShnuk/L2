...
<html >
<head>
<title>Управление мышью в MonoGame</title>
<meta charset="utf-8" />
...
<h2>Управление мышью</h2><div class="date">Последнее обновление: 14.11.2015</div>
...
<p>Для работы с устройством мыши в MonoGame имеется класс <span class="b">Mouse</span>. Этот класс имеет метод <code>GetState()</code>, который извлекает текущее состояние устройства мыши в виде 
структуры <span class="b">MouseState</span>. С помощью этой структуры можно получить состояния отдельных кнопок мыши, узнать, нажаты они или нет. Основные свойства MouseState:</p>
<ul>
<li><p><code>LeftButton</code>: возвращает состояние левой кнопки мыши в виде объекта ButtonState</p></li>
<li><p><code>MiddleButton</code>: возвращает состояние средней кнопки мыши в виде объекта ButtonState</p></li>
<li><p><code>RightButton</code>: возвращает состояние правой кнопки мыши в виде объекта ButtonState</p></li>
<li><p><code>ScrollWheelValue</code>: возвращает суммарное перемещение колеса мыши с начала игры</p></li>
<li><p><code>XButton1</code>: возвращает состояние дополнительной кнопки мыши (при ее наличии)</p></li>
<li><p><code>XButton2</code>: возвращает состояние другой дополнительной кнопки мыши (при ее наличии)</p></li>
<li><p><code>X</code>: возвращает x-координату указателя мыши</p></li>
<li><p><code>Y</code>: возвращает y-координату указателя мыши</p></li>
</ul>
<p>Еще один метод класса Mouse - метод <code>SetPosition(int x, int y)</code> устанавливает координаты указателя мыши по отношению к 
верхнему левому углу игрового поля.</p>
<p>По молчанию указатель мыши в MonoGame невидим, и для его отображения надо у класса Game установить свойство <span class="b">IsMouseVisible</span> равным <code>true</code>.</p>
<p>Итак, перепишем приложение из прошлой темы так, чтобы в нем поведение спрайта управлялось указателем мыши:</p>
<pre class="brush:c#;">
...
<p>Переменная lastMouseState фиксирует последнюю позицию курсора. И если значение в currentMouseState отличается от lastMouseState, то спрайт перемещается на новую позицию.</p>
