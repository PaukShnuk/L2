...
<html >
<head>
<title>Вопросы по C# | Перегрузка операторов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Перегрузка операторов в C#">
...
<h2>Перегрузка операторов</h2><div class="date">Последнее обновление: 13.08.2018</div>
...
<p>Оператор + (сложение) при применении к двум объектам типа int возвращает их сумму.</p>
<pre class="brush:c#;">
int x = 9;
int y = 10;
int z = x + y;	// 19
</pre>
<p>Как можно переопределить оператор + для типа int, чтобы этот оператор возвращал не сумму, а произведение двух объектов int?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-1" name="checkbox-accordion" />
<label for="checkbox-1">Ответ</label>
<div class="answer-content">
<p>Никак. Мы не можем переопределить или перегрузить операторы для типов, которые есть в .NET по умолчанию.</p>
</div>
</div>
</div>
...
<p>В этом классе определен оператор сложения, который позволяет складывать объект Counter с объектом типа int следующим образом:</p>
<pre class="brush:c#;">
Counter counter = new Counter { Number = 45 };
int x = counter + 6;
Console.WriteLine(x);  // 51
</pre>
<p>Какой именно оператор сложения определен в классе Counter? Варианты ответов (правильных вариантов может быть несколько)</p>
<ol>
<li>
<pre class="brush:c#;">
public int operator + (Counter counter, int val)
{
...
<li>
<pre class="brush:c#;">
public static Counter operator + (Counter counter, int val)
{
...
<li>
<pre class="brush:c#;">
public static Counter operator + (int val, Counter counter)
{
	return new Counter {Number  = counter.Number + val};
}
</pre></li>
...
<div class="answer-content">
<p>Первый параметр оператора сложения в классе Counter представляет тип int, а второй - тип Counter. Поэтому при применении операции сложения 
левый операнд должен представлять тип int, а правый - объект Counter:</p>
<pre class="brush:c#;">
int x = 6 + counter;
// вместо
// int x = counter + 6;
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.36.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.8.php">Назад</a><a href="./">Содержание</a><a href="2.3.php">Вперед</a></p></div></div>
<div class="socBlock">
