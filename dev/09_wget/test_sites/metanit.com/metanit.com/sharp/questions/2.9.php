...
<html >
<head>
<title>Вопросы по C# | Свойства</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Свойства в C#">
...
<h2>Свойства</h2><div class="date">Последнее обновление: 29.07.2018</div>
...
<p>На консоль будет выведено число 15.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>На консоль будет выведена строка "Tom". Потому что для автосвойства будет создана переменная, которой будет присвоено значение "Bob". 
Однако во время выполнения программы при инициализации объекта это значение будет заменяться на строку "Tom".</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Данная программа не скомпилируется, потому что блок get имеет тот же модификатор доступа, что и свойство. Для блока get в данном случае можно использовать 
более ограничивающие модификаторы - private.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.4.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
