...
<html >
<head>
<title>Вопросы по C# | Структуры</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме cтруктуры в C# их создание и конструкторы">
...
<h2>Структуры</h2><div class="date">Последнее обновление: 02.10.2018</div>
...
<p>Если для создания объекта структуры не используется конструктор, то перед обращением к полям и методам подобного объекта 
необходимо проинициализировать все поля этого объекта.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Если структура определяет конструктор, то в нем должным быть инициализированы все поля этой структуры. В примере из вопроса 
инициализировано только поле name.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.13.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.1.php">Назад</a><a href="./">Содержание</a><a href="2.13.php">Вперед</a></p></div></div>
<div class="socBlock">
