...
<html >
<head>
<title>Вопросы по C# | Перечисления</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Перечисления в C#">
...
<h2>Перечисления</h2><div class="date">Последнее обновление: 03.10.2018</div>
...
<p>Какое числовое значение имеет константа <code>Season.Summer</code> в следующем перечислении?</p>
<pre class="brush:c#;">
enum Season
{
	Winter = 250,
...
<p>Константа <code>Season.Summer</code> имеет значение 252.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Программа не скомпилируется, поскольку для перечисления указан тип byte, следовательно, константы перечисления 
не могут иметь значения больше 255. Однако поскольку константе <code>Season.Winter</code> присвоено значение 254, то все последующие 
...
<p>Какое значение имеет константа Sunday в следующем перечислении?</p>
<pre class="brush:c#;">
enum Day
{
	Monday = 5,
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.12.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
