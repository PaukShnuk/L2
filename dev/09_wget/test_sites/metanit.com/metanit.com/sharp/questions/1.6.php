...
<html >
<head>
<title>Вопросы по C# | Область видимости переменных</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Область видимости переменных в C#">
...
<h2>Область видимости переменных</h2><div class="date">Последнее обновление: 17.07.2018</div>
...
<p>Приведенная выше программа не скомпилируется, так как переменная message является локальной для метода Main и может использоваться 
только в рамках метода Main, но она недоступна из метода Display.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.18.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
