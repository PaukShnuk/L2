...
<html >
<head>
<title>Вопросы по C# | Преобразование базовых типов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Преобразование базовых типов данных в C#">
...
<h2>Преобразование базовых типов</h2><div class="date">Последнее обновление: 12.10.2018</div>
...
<li><p>Из <code>bool</code> в <code>string</code></p></li>
...
<p>Для чего нужен оператор <span class="b">checked</span>?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-2" name="checkbox-accordion" />
<label for="checkbox-2">Ответ</label>
<div class="answer-content">
<p>При применении к операции преобразования типов оператор checked позволяет сгенерировать исключение при переполнении разрядности типа.</p>
</div>
</div>
</div>
