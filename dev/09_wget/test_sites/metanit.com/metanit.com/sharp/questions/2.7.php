...
<html >
<head>
<title>Вопросы по C# | Пространства имен</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Пространства имен в C#">
...
<h2>Пространства имен</h2><div class="date">Последнее обновление: 17.07.2018</div>
...
<p>Как в методе Main можно обратиться к имени Baz (например, создать объект класса Baz)?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-1" name="checkbox-accordion" />
<label for="checkbox-1">Ответ</label>
<div class="answer-content">
<p>Через Foo.Boo.Baz</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.25.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.18.php">Назад</a><a href="./">Содержание</a><a href="2.19.php">Вперед</a></p></div></div>
<div class="socBlock">
