...
<html >
<head>
<title>Вопросы по C# | Модификаторы доступа</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Модификаторы доступа в C#">
...
<h2>Модификаторы доступа</h2><div class="date">Последнее обновление: 10.08.2018</div>
...
<p>Какие модификаторы доступа есть в C#?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-1" name="checkbox-accordion" />
<label for="checkbox-1">Ответ</label>
<div class="answer-content">
<p>В C# есть следующие модификаторы досупа:</p>
<ul>
<li><p>private</p></li>
<li><p>private protected</p></li>
<li><p>protected</p></li>
<li><p>internal</p></li>
...
<p>Вам надо определить в классе переменную, которая должна быть доступна из любого места в текущем проекте. Какой модификатор (или модификаторы, 
если их несколько) вы будете использовать?</p>
</div>
<div class="answer">
...
<p>В чем различие между модификаторами <span class="b">protected</span> и <span class="b">private protected</span>?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-3" name="checkbox-accordion" />
<label for="checkbox-3">Ответ</label>
<div class="answer-content">
<p>Члены класса, определенные с этими модификаторами, могу быть доступны только в текущем классе или в классах-наследниках. 
Но если модификатор protected гарантирует доступ для любого класса-наследника вне зависимости от того, в каком прокте (сборке) он расположен. 
А модификатор <span class="b">private protected</span> делает члены класса доступными только для классов-наследников, которые размещены 
в том же проекте, где определен исходный класс.</p>
</div>
</div>
</div>
...
<p>Если классы и члены класса не имеют никаких модификаторов, какие модификаторы доступа к ним применяются по умолчанию?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-4" name="checkbox-accordion" />
<label for="checkbox-4">Ответ</label>
<div class="answer-content">
<p>Для классов, размещенных непосредственно в пространстве имен, модификатор доступа по умолчанию - <span class="b">internal</span>. Для 
классов, размещенных внутри других классов (вложенных классов), модификатор по умолчанию <span class="b">private</span>. 
А для членов класса модификатор доступа по умолчанию - <span class="b">private</span>.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Программа не скомпилируется, поскольку переменная name, к которой мы хотим обратиться в методе Main, не имеет модификаторов. Следовательно, 
по умолчанию она имеет модификатор доступа <span class="b">private</span>. Поэтому вне класса Person к этой переменной мы обратиться не можем.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.2.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.1.php">Назад</a><a href="./">Содержание</a><a href="2.9.php">Вперед</a></p></div></div>
<div class="socBlock">
