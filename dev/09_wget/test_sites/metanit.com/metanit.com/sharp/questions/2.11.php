...
<html >
<head>
<title>Вопросы по C# | Виртуальные методы и свойства</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Виртуальные методы и свойства в C#">
...
<h2>Виртуальные методы и свойства</h2><div class="date">Последнее обновление: 03.08.2018</div>
...
<p>Какое ключевое слово применяется для переопределения виртуальных методов и свойств:</p>
<ul>
<li><p>overridable</p></li>
<li><p>override</p></li>
...
<div class="answer-content">
<p>На консоль будет выведена строка "Employee Sam". Потому что переменная person хранит ссылку на объект Employee, и при вызове метода Display будет использоваться 
именно реализация данного метода в классе Employee.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>На консоль будет выведена строка "Manager Bob". Потому что переменная person хранит ссылку на объект Manager. При преобразовании к типу Employee 
ссылка по прежнему представляет объект типа Manager, и при вызове метода Display будет использоваться реализация метода из класса Manager.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Программа не скомпилируется, потому что переопределяемый метод в производном классе должен иметь тот же модификатор доступа, что и виртуальный метод в 
базовом классе.</p>
</div>
</div>
</div>
...
<p>Для чего нужен модификатор <span class="b">sealed</span>?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-5" name="checkbox-accordion" />
<label for="checkbox-5">Ответ</label>
<div class="answer-content">
<p>Модификатор <span class="b">sealed</span> позволяет запретить наследование от класса и переопределение метода.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Данная программа не скомпилируется, так как модификатор <span class="b">sealed</span> применяется только в связке с оператором override.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.19.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
