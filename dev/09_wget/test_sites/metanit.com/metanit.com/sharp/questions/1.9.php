...
<html >
<head>
<title>Вопросы по C# | Переменные</title>
<meta charset="utf-8" />
<meta name="description" content="Вопросы по теме Переменные в C#">
...
<h2>Переменные</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<div class="answer">
<p>Данная программа не скомпилируется. Метод <code>Console.WriteLine()</code> пытается вывести на консоль значение переменной 
<code>Name</code>, однако в программе нет такой переменной. В программе есть только переменная <code>name</code>. Но поскольку C# регистрозависимый язык, то <code>name</code> не 
эквивалентно <code>Name</code></p>
</div>
</details>
</div>
...
<li><p>Sam</p></li>
<li><p>person</p></li>
<li><p>Программа завершит выполнение с ошибкой</p></li>
</ul>
<details>
<summary>Ответ</summary>
<div class="answer">
<p>На консоль будет выведена строка "Sam"</p>
</div>
</details>
</div>
...
<li><p><pre class="brush:c#;">person = "Tom";</pre></p></li>
<li><p><pre class="brush:c#;">string person;</pre></p></li>
<li><p><pre class="brush:c#;">string "Tom";</pre></p></li>
</ol>
<details>
<summary>Ответ</summary>
<div class="answer">
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.25.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./">Содержание</a><a href="./1.10.php">Вперед</a></p></div></div>
<div class="socBlock">
