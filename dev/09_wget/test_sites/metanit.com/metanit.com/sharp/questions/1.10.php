...
<html >
<head>
<title>Вопросы по C# | Базовые типы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Вопросы по теме Базовые типы данных в C#">
...
<h2>Базовые типы данных</h2><div class="date">Последнее обновление: 10.11.2021</div>
...
<p>Какие из нижеперечисленных НЕ являются встроенными типами языка C#?</p>
<ul>
<li><p>uint</p></li>
<li><p>sbyte</p></li>
<li><p>real</p></li>
...
<div class="answer">
<p>Не являются встроенными типами языка C# следующие:</p>
<ul>
<li><p>real</p></li>
<li><p>int128</p></li>
<li><p>float64</p></li>
...
<p>Какой тип данных языка C# будет представлять следующая переменная?</p>
<pre class="brush:c#;">bool enabled = true;</pre>
<details>
<summary>Ответ</summary>
<div class="answer">
<p>Переменная <code>enabled</code> представляет тип <code>bool</code></p>
</div>
</details>
</div>
...
<p>Какой тип данных языка C# будет представлять следующая переменная?</p>
<pre class="brush:c#;">var weight = 84.45f;</pre>
<details>
<summary>Ответ</summary>
<div class="answer">
<p>Переменная <code>weight</code> представляет тип <code>float</code></p>
</div>
</details>
</div>
...
<p>Сколько байт занимает значение типа <span class="b">uint</span>?</p>
<details>
<summary>Ответ</summary>
<div class="answer">
<p>Значение типа <span class="b">uint</span> занимает 4 байта</p>
</div>
</details>
</div>
...
<ol>
<li><p><pre class="brush:c#;">string person = "Tom";</pre></p></li>
<li><p><pre class="brush:c#;">var person = "Tom";</pre></p></li>
<li><p><pre class="brush:c#;">var person;</pre></p></li>
<li><p><pre class="brush:c#;">string person;</pre></p></li>
</ol>
<details>
<summary>Ответ</summary>
<div class="answer">
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.1.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="./1.9.php">Назад</a><a href="./">Содержание</a><a href="./1.1.php">Вперед</a></p></div></div>
<div class="socBlock">
