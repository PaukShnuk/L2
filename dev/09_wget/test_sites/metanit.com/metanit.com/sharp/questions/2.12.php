...
<html >
<head>
<title>Вопросы по C# | Абстрактные классы и члены классов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Абстрактные классы и члены классов в C#">
...
<h2>Абстрактные классы и члены классов</h2><div class="date">Последнее обновление: 04.08.2018</div>
...
<p>Следующая программа не компилируется. В чем ошибка?</p>
<pre class="brush:c#;">
class Base
{
...
<p>Варианты ответов (правильно может быть несколько вариантов):</p>
<ul>
<li><p>Абстрактный класс не может наследоваться от неабстрактного</p></li>
<li><p>Абстрактный класс может содержать только абстрактные методы</p></li>
<li><p>Нельзя использовать конструктор абстрактного класса для создания объекта этого класса</p></li>
<li><p>Абстрактный класс не может переопределять виртуальные методы базового класса</p></li>
</ul>
</div>
<div class="answer">
...
<p>Нельзя использовать конструктор абстрактного класса для создания объекта этого класса. Поэтому на строке</p>
<pre class="brush:c#;">Base _base = new Derived();</pre>
...
<p>Какие члены класса могут быть определены как абстрактные?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-2" name="checkbox-accordion" />
<label for="checkbox-2">Ответ</label>
<div class="answer-content">
<p>Абстрактными могут быть методы, свойства, индексаторы и события.</p>
</div>
</div>
</div>
...
<p>Есть ли в следующем коде ошибка? Если есть, то какая?</p>
<pre class="brush:c#;">
abstract class Base
{
...
<div class="answer-content">
<p>Данная программа не скомпилируется, потому что производный неабстрактный класс Derived должен реализовать все абстрактные методы 
класса Base. В данном же случае метод Do не реализован.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.8.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.11.php">Назад</a><a href="./">Содержание</a><a href="2.6.php">Вперед</a></p></div></div>
<div class="socBlock">
