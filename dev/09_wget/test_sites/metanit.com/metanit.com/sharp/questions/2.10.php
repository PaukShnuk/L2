...
<html >
<head>
<title>Вопросы по C# | Статические члены класса</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Статические члены класса в C#">
...
<h2>Статические члены класса</h2><div class="date">Последнее обновление: 27.07.2018</div>
...
<p>Какой результат будет у следующей программы и почему?</p>
<pre class="brush:c#;">
class Person
{
...
<p>Программа не скомпилируется, потому что статические методы имеют доступ только к статическим полям. Нестатические поля класса не могут использоваться 
...
<p>При выполнении какой строки кода в методе Main будет вызван конструктор класса Person?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-2" name="checkbox-accordion" />
<label for="checkbox-2">Ответ</label>
<div class="answer-content">
<p>Статический конструктор вызывается либо при создании самого первого объекта класса, либо при первом обращении к статическим членам класса. 
В данном случае статический конструктор класса Person будет вызван при выполнении строки кода</p>
<pre class="brush:c#;">
tom = new Person(34);
</pre>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.6.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.2.php">Назад</a><a href="./">Содержание</a><a href="2.8.php">Вперед</a></p></div></div>
<div class="socBlock">
