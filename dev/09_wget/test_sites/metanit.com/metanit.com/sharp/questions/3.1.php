...
<html >
<head>
<title>Вопросы по C# | Асинхронные методы, async, await</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Асинхронные методы, async, await в C#">
...
<h2>Асинхронные методы, async, await</h2><div class="date">Последнее обновление: 16.10.2018</div>
...
<p>Является ли следующий метод асинхронным? Если да, то почему? Если нет, то почему?</p>
<pre class="brush:c#;">
...
<p>Этот метод не является асинхронным, так как он не используется выражения await.</p>
</div>
</div>
</div>
...
<p>Какими признаками должен обладать асинхронный метод?</p>
</div>
<div class="answer">
...
<div class="answer-content">
<ul>
<li><p>В определении асинхронного метода используется модификатор <span class="b">async</span></p></li>
<li><p>Асинхронный метод содержит одно или несколько выражений <span class="b">await</span></p></li>
<li><p>Возвращаемыми типами асинхронного метода могут быть <code>void</code>, <code>Task</code>, 
<code>Task&lt;T&gt;</code> или <code>ValueTask&lt;T&gt;</code></p></li>
</ul>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/13.3.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
