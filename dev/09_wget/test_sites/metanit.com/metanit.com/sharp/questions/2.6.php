...
<html >
<head>
<title>Вопросы по C# | Обобщения</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Обобщения в C#">
...
<h2>Обобщения</h2><div class="date">Последнее обновление: 18.07.2018</div>
...
<p>Что такое упаковка (boxing) и распаковка (unboxing)?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-1" name="checkbox-accordion" />
<label for="checkbox-1">Ответ</label>
<div class="answer-content">
<p>Упаковка представляет преобразование объекта значимого типа (например, типа int) к типу object или к типу реализуемого интерфейса и сохранение преобразованного объекта 
в управляемой куче (хипе). Распаковка (unboxing) представляет преобразование объекта типа object к значимому типу.</p>
</div>
</div>
</div>
...
<p>Что не так в следующем коде?</p>
<pre class="brush:c#;">
...
<div class="answer-content">
<p>Хотя данный код и скомпилируется, но один и тот же параметр T определен и для класса и для метода. В данном случае можно переименовать параметр либо у класса, либо у метода:</p>
<pre class="brush:c#;">
...
<p>Либо можно убрать один из параметров либо у класса, либо у метода.</p>
<pre class="brush:c#;">
public class StringGetter&lt;T&gt;
{
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.12.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.12.php">Назад</a><a href="./">Содержание</a><a href="2.4.php">Вперед</a></p></div></div>
<div class="socBlock">
