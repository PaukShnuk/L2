...
<html >
<head>
<title>Вопросы по C# | Перегрузка методов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Перегрузка методов в C#">
...
<h2>Перегрузка методов</h2><div class="date">Последнее обновление: 18.07.2018</div>
...
<p>Каким образом можно перегрузить метод?</p>
</div>
<div class="answer">
...
<ul>
<li><p>Определить версию метода с другим количеством параметров</p></li>
<li><p>Определить версию метода с другим типами параметров</p></li>
<li><p>Определить версию метода, где порядок параметров будет иным</p></li>
<li><p>Изменить модификаторы параметров</p></li>
</ul>
</div>
</div>
</div>
...
<p>Корректна ли следующая перегрузка методов? Если да, то почему? Если нет, то почему?</p>
<pre class="brush:c#;">
...
<div class="answer-content">
<p>Перегрузка корректна, потому что параметры метода имеют разные модификаторы</p>
</div>
</div>
</div>
