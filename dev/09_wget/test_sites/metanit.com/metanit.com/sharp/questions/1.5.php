...
<html >
<head>
<title>Вопросы по C# | Массивы параметров и params</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Массивы параметров и params в C#">
...
<h2>Массивы параметров и params</h2><div class="date">Последнее обновление: 17.07.2018</div>
...
<p>Какие из следующих вариантов представляют правильный способ вызова данного метода (правильных вариантов может быть несколько):</p>
<ul>
<li><p><code>Display();</code></p></li>
<li><p><code>Display(1);</code></p></li>
<li><p><code>Display(1, 2);</code></p></li>
<li><p><code>Display(1, 2, 3);</code></p></li>
<li><p><code>Display(new int[] { 1, 2, 3 });</code></p></li>
</ul>
</div>
<div class="answer">
...
<p>Все предложенные выше варианты представляют корректный вызов метода Display.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Корректный вызов метода Display представляет только один вариант: <code>Display(new int[] { 1, 2, 3 });</code>.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Программа не скомпилируется, потому что в методе Display после параметра с ключевым словом params определен еще один параметр.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/2.10.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
