...
<html >
<head>
<title>Вопросы по C# | Операции</title>
<meta charset="utf-8" />
<meta name="description" content="Вопросы по теме Операции в C#">
...
<h2>Операции</h2><div class="date">Последнее обновление: 10.08.2018</div>
...
<p>Используя приоритеты операций, разложите выражение <code>int result = n2 * 3 + 20 / 2 * n1--</code> по шагам.</p>
</div>
<div class="answer">
...
<div class="nav"><p><a href="./1.10.php">Назад</a><a href="./">Содержание</a><a href="./1.2.php">Вперед</a></p></div></div>
<div class="socBlock">
