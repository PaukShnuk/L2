...
<html >
<head>
<title>Вопросы по C# | Константы и поля для чтения</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Константы и поля для чтения в C#">
...
<h2>Константы и поля для чтения</h2><div class="date">Последнее обновление: 27.07.2018</div>
...
<p>В чем различие между константами и полями для чтения (readonly)?</p>
</div>
<div class="answer">
<input type="checkbox" id="checkbox-1" name="checkbox-accordion" />
<label for="checkbox-1">Ответ</label>
<div class="answer-content">
<p>Значения констант должны быть установлены к моменту компиляции. Значения полей для чтения можно устанавливать при выполнении программы в конструкторе.</p>
</div>
</div>
</div>
...
<p>Почему не компилируется следующая программа?</p>
<pre class="brush:c#;">
class Example
{
...
<ul>
<li><p>При определении константы нельзя использовать модиифкаторы доступа, например, модификатор public</p></li>
<li><p>Константы с модификатором public могут располагаться только в классе, который тоже определен с модификатором public</p></li>
<li><p>Константа не может быть статической (то есть не может быть определена с модиифкатором static)</p></li>
<li><p>Значение поля для чтения может быть установлено только один раз, здесь же оно устанавливается два раза</p></li>
</ul>
</div>
<div class="answer">
...
<div class="answer-content">
<p>Программа не скомпилируется, потому что константы не могут быть статическими.</p>
</div>
</div>
</div>
...
<p>Какие числа выведет на консоль следующая программа?</p>
<pre class="brush:c#;">
class Example
{
...
<div class="answer-content">
<p>Программа не выведет никакие значения, так как она не будет скомпилирована. Поскольку мы не можем обращаться к константе через имя экземпляра 
класса (<code>Console.WriteLine(example.KOEF);</code>), к константе необходимо обращаться по имени класса: <code>Example.KOEF</code>.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.3.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.10.php">Назад</a><a href="./">Содержание</a><a href="2.15.php">Вперед</a></p></div></div>
<div class="socBlock">
