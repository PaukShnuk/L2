...
<html >
<head>
<title>Вопросы по C# | Делегаты</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Делегаты, определение и вызов делегатов в C#">
...
<h2>Делегаты</h2><div class="date">Последнее обновление: 10.10.2018</div>
...
<p>Есть следующий делегат:</p>
<pre class="brush:c#;">delegate int Operation (int val);</pre>
<p>Какие из следующих методов соответствуют данному делегату:</p>
<pre class="brush:c#;">
...
<p>Ни один из предложенных методов не соответствует делегату Operation.</p>
</div>
</div>
</div>
...
<p>Что будет выведено на консоль в результате выполнения следующей программы:</p>
<pre class="brush:c#;">
class Program
{
...
<div class="answer-content">
<p>На консоль будет выведено число 30 - результат последнего метода, добавленного в список методов делегата.</p>
</div>
</div>
</div>
...
<p>Какой будет консольный вывод при выполнении следующей программы:</p>
<pre class="brush:c#;">
class Program
{
...
<div class="answer-content">
<p>Консольный вывод данной прогаммы:</p>
<div class="console">
...
<div class="answer-content">
<p>При выполнении прогаммы, точнее при выполнении делегата возникнет исключение, поскольку список вызова делегата пуст.</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.13.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
<div class="nav"><p><a href="2.4.php">Назад</a><a href="./">Содержание</a><a href="2.18.php">Вперед</a></p></div></div>
<div class="socBlock">
