...
<html >
<head>
<title>Вопросы по C# | Массивы</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Массивы в C#">
...
<h2>Массивы</h2><div class="date">Последнее обновление: 02.10.2018</div>
...
<p>Массив <code>new int[3, 2, 3]</code> имеет 18 элементов.</p>
</div>
</div>
</div>
...
<p>Сколько измерений (размерность) имеет следующий массив?</p>
<pre class="brush:c#;">
...
<div class="answer-content">
<p>Массив <code>new int[3, 3]</code> имеет 2 измерения, то есть это двухмерный массив.</p>
</div>
</div>
</div>
...
<div class="answer-content">
<p>Консоль ничего не выведет, так как программа выбросит во время выполнения исключение System.IndexOutOfRangeException, 
