...
<html >
<head>
<title>Вопросы по C# | Анонимные типы</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и вопросы по теме Анонимные типы в C#">
...
<h2>Анонимные типы</h2><div class="date">Последнее обновление: 15.10.2018</div>
...
<p>Программа не скомпилируется, потому что свойства анонимных объектов только для чтения, и мы можем присваивать им значения только при 
инициализации анонимного объекта.</p>
</div>
</div>
</div>
...
<p>Анонимные типы представляют значимый или ссылочный тип?</p>
</div>
<div class="answer">
...
<p>Скомпилируется ли следующая программа? Если скомпилируется, то что будет выведено на консоль? Если не скомпилируется, то почему?</p>
<pre class="brush:c#;">
class Auto
{
...
<div class="answer-content">
<p>Программа скомпилируется, и на консоль будет выведена строка "Ford"</p>
</div>
</div>
</div>
...
<ul>
<li><a title="Теоретический материал" href="../tutorial/3.20.php"><i class="fa fa-lg fa-file-text-o"></i><span class="dop-txt">Статья по теме</span></a></li>
</ul>
</fieldset></div>
