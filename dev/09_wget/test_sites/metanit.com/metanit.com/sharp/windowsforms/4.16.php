...
<html >
<head>
<title>PictureBox в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>Элемент PictureBox</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>PictureBox предназначен для показа изображений. Он позволяет отобразить файлы в формате bmp, jpg, gif, а также метафайлы ищображений 
и иконки. Для установки изображения в PictureBox можно использовать ряд свойств:</p>
<ul>
<li><p><span class="bb">Image</span>: устанавливает объект типа Image</p></li>
<li><p><span class="bb">ImageLocation</span>: устанавливает путь к изображению на диске или в интернете</p></li>
<li><p><span class="bb">InitialImage</span>: некоторое начальное изображение, которое будет отображаться во время загрузки главного изображения, 
которое хранится в свойстве Image</p></li>
<li><p><span class="bb">ErrorImage</span>: изображение, которое отображается, если основное изображение не удалось загрузить в PictureBox</p></li>
</ul>
<p>Чтобы установить изображение в Visual Studio, надо в панели Свойств PictureBox выбрать свойство Image. В этом случае нам откроется окно импорта изображения 
в проект, где мы собственно и сможем выбрать нужное изображение на компьютере и установить его для PictureBox:</p>
<img src="pics/4.53.png" alt="Установка изображения для PictureBox" />
<p>И затем мы сможем увидеть данное изображение в PictureBox:</p>
<img src="pics/4.54.png" alt="Элемент PictureBox в Windows Forms" />
<p>Либо можно загрузить изображение в коде:</p>
<pre class="brush:c#;">
pictureBox1.Image = Image.FromFile("C:\Users\Eugene\Pictures\12.jpg");
</pre>
<h3>Размер изображения</h3>
<p>Для установки изображения в PictureBox используется свойство <span class="bb">SizeMode</span>, которое принимает следующие значения:</p>
<ul>
<li><p><code>Normal</code>: изображение позиционируется в левом верхнем углу PictureBox, и размер изображения не изменяется. Если 
PictureBox больше размеров изображения, то по справа и снизу появляются пустоты, если меньше - то изображение обрезается</p></li>
<li><p><code>StretchImage</code>: изображение растягивается или сжимается таким обраом, чобы вместиться по всей ширине и высоте элемента PictureBox</p></li>
<li><p><code>AutoSize</code>: элемент PictureBox автоматически растягивается, подстраиваясь под размеры изображения</p></li>
<li><p><code>CenterImage</code>: если PictureBox меньше изображения, то изображение обрезается по краям и выводится только его центральная часть. 
Если же PictureBox больше изображения, то оно позиционируется по центру.</p></li>
<li><p><code>Zoom</code>: изоражение подстраивается под размеры PictureBox, сохраняя при этом пропорции</p></li>
</ul>
<img src="pics/4.55.png" alt="Размер изображений в Windows Forms" />
