...
<html >
<head>
<title>ImageList в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>ImageList</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>ImageList не является визуальным элементом управления, однако он представляет компонент, который используется элементами управления. Он определяет 
набор изображений, который могут использовать такие элементы, как ListView или TreeView.</p>
<p>Чтобы его добавить в проект, его также можно перенести на форму с Панели Инструментов:</p>
<img src="pics/4.28.png" alt="Компонент ImageList в Windows Forms" />
<p>Так как компонент не является визуальным элементом, то мы увидим его под формой.</p>
<p>Ключевым свойством ImageList является свойство <span class="bb">Images</span>, которое задает коллекцию изображений.</p>
<img src="pics/4.29.png" alt="Свойства ImageList" />
<p>При выборе данного свойства нам окроется окно редактора изображений, в котором мы можем добавить новое изображение или удалить имеющееся.</p>
<img src="pics/4.30.png" alt="Images Collection Editor" />
<p>Чтобы установить размер изображений для данного ImageList можно использовать его свойство <span class="bb">ImageSize</span>. По умолчанию 
ширина и высота имеют значение 16 пикселей, но мы можем установить любое другое, но не больше 256 пикселей.</p>
<p>Также можно добавлять/удалять изображения из списка программно:</p>
<pre class="brush:c#;">
...
<p>Чтобы делать разобраться, как использовать ImageList, добавим в него три изображения и поместим на форму три чекбокса. У каждого чекбокса уберем тест и установим 
свойство ImageList и укажем в свойстве ImageIndex индекс изобраения из imageList1:</p>
<img src="pics/4.31.png" />
<p>И получим форму наподобие следующей:</p>
<img src="pics/4.32.png" alt="CheckBox и ImageList в Windows Forms" />
