...
<html >
<head>
<title>Строка состояния StatusStrip в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>Строка состояния StatusStrip</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>StatusStrip представляет строку состояния, во многом аналогичную панели инструментов ToolStrip. Строка состояния предназначена для отображения текущей информации 
о состоянии работы приложения.</p>
<p>При добавлении на форму StatusStrip автоматически размещается в нижней части окна приложения (как и в большинстве приложений). Однако при необходимости мы 
сможем его иначе позиционировать, управляя свойством <code>Dock</code>, которое может принимать следующие значения:</p>
<ul>
<li><p><code>Bottom</code>: размещение внизу (значение по умолчанию)</p></li>
<li><p><code>Top</code>: прикрепляет статусную строку к верхней части формы</p></li>
<li><p><code>Fill</code>: растягивает на всю форму</p>
<li><p><code>Left</code>: размещение в левой части формы</p></li>
<li><p><code>Right</code>: размещение в правой части формы</p></li>
<li><p><code>None</code>: произвольное положение</p></li>
</ul>
<p>StatusStrip может содержать различные элементы. В режиме дизайнера мы можем добавить следующие типы элементов:</p>
<img src="pics/5.11.png" alt="StatusStrip в Windows Forms" />
<ul>
<li><p><code>StatusLabel</code>: метка для вывода текстовой информации. Представляет объект ToolStripLabel</p></li>
<li><p><code>ProgressBar</code>: индикатор прогресса. Представляет объект ToolStripProgressBar</p></li>
<li><p><code>DropDownButton</code>: кнопка с выпадающим списком по клику. Представляет объект ToolStripDropDownButton</p></li>
<li><p><code>SplitButton</code>: еще одна кнопка, во многом аналогичная DropDownButton. Представляет объект ToolStripSplitButton</p>
</ul>
<p>Либо можно обратиться на панели свойств к свойству Items компонента StatusStrip и открывшемся окне добавить и настроить все элементы:</p>
<img src="pics/5.12.png" />
<p>Также мы можем добавить элементы программно. Создадим небольшую программу. Определим следующий код формы:</p>
<pre class="brush:c#;">
...
<p>Здесь создаются три метки на строке состояния и таймер. После создания формы таймер запускается, и срабатывает его событие Tick, 
в обработчике которого устанавливаем текст меток.</p>
<img src="pics/5.13.png" alt="Строка состояния в C# и Windows Forms" />
