...
<html >
<head>
<title>WebBrowser в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>Элемент WebBrowser</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>WebBrowser предоставляет функции интернет-браузера, позволяя загружать и отображать контент из сети интернет. В то же время важно понимать, что данный 
элемент не является полноценным веб-браузером, и возможности по его настройки и изменению довольно ограничены.</p>
<p>Рассмотрим основные его свойства:</p>
<ul>
<li><p><span class="bb">AllowWebBrowserDrop</span>: при установке для данного свойства значения <code>true</code> можно будет с помощью 
мыши переносить документы в веб-браузер и открывать их.</p></li>
<li><p><span class="bb">CanGoBack</span>: определяет, может ли веб-браузер переходить назад по истории просмотров</p></li>
<li><p><span class="bb">CanGoForward</span>: определяет, может ли веб-браузер переходить вперед</p></li>
<li><p><span class="bb">Document</span>: возвращает открытый в веб-браузере документ</p></li>
<li><p><span class="bb">DocumentText</span>: возвращает текстовое содержание документа</p></li>
<li><p><span class="bb">DocumentTitle</span>: возвращает заголовок документа</p></li>
<li><p><span class="bb">DocumentType</span>: возвращает тип документа</p></li>
<li><p><span class="bb">IsOffline</span>: возвращает true, если отсутствует подключение к интернету</p></li>
<li><p><span class="bb">ScriptErrorsSuppressed</span>: указывает, будут ли отображаться ошибки javascript в диалоговом окне</p></li>
<li><p><span class="bb">ScrollBarsEnabled</span>: определяет, будет ли использоваться прокрутка</p></li>
<li><p><span class="bb">URL</span>: возвращает или устанавливает URL документа в веб-браузере</p></li>
</ul>
<p>Кроме того, WebBrowser содержит ряд методов, которые позволяют осуществлять навигацию между документами:</p>
<ul>
<li><p><span class="bb">GoBack()</span>: осуществляет переход к предыдущей странице в истории навигации (если таковая имеется)</p></li>
<li><p><span class="bb">GoForward()</span>: осуществляет переход к следующей странице в истории навигации</p></li>
<li><p><span class="bb">GoHome()</span>: осуществляет переход к домашней странице веб-браузера</p></li>
<li><p><span class="bb">GoSearch()</span>: осуществляет переход к странице поиска</p></li>
<li><p><span class="bb">Navigate</span>: осуществляет переход к определенному адресу в сети интернет</p></li>
</ul>
<p>Таким образом, чтобы перейти к определенному документу, надо исользовать метод Navigate:</p>
<pre class="brush:c#;">
...
<p>Создадим небольшй веб-браузер. Для этого поместим на форму элементы WebBrowser, TextBox (в него будем вводить адрес) и 
Button. И в файле формы пропишем следующий код:</p>
<pre class="brush:c#;">
...
<p>И по нажатию кнопки произойдет переход к адресу, введенному в текстовое поле:</p>
<img src="pics/4.56.png" alt="Веб-браузер в Windows Forms" />
...
<div class="nav"><p><a href="4.16.php">Назад</a><a href="./">Содержание</a><a href="4.18.php">Вперед</a></p></div></div>
<div class="socBlock">
