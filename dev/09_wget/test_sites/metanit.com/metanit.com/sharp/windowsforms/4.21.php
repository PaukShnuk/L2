...
<html >
<head>
<title>FontDialog и ColorDialog в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>FontDialog и ColorDialog</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<h3>FontDialog</h3>
<p>Для выбора шифта и его параметров используется <span class="bb">FontDialog</span>. Для его использования перенесем компонент с Панели инструментов на 
форму. И пусть на форме имеется кнопка button1. Тогда в коде формы пропишем следующее:</p>
<pre class="brush:c#;">
...
<p>FontDialog имеет ряд свойств, среди которых стоит отметить следующие:</p>
<ul>
<li><p><code>ShowColor</code>: при значении <code>true</code> позволяет выбирать цвет шрифта</p></li>
<li><p><code>Font</code>: выбранный в диалоговом окне шрифт</p></li>
<li><p><code>Color</code>: выбранный в диалоговом окне цвет шрифта</p></li>
</ul>
<p>Для отображения диалогового окна используется метод <code>ShowDialog()</code>.</p>
<p>И если мы запустим приложение и нажмем на кнопку, то нам отобразится диалоговое окно, где мы можем задать все параметры шрифта. И после выбоа установленные 
настройки будут применены к шрифту кнопки:</p>
<img src="pics/4.61.png" alt="FontDialog в Windows Forms" />
<h3>ColorDialog</h3>
<p>ColorDialog позволяет выбрать настройки цвета. Также перенесем его с Панели инструментов на форму. И изменим код формы:</p>
<pre class="brush:c#;">
public partial class Form1 : Form
{
    public Form1()
...
<p>Среди свойств ColorDialog следует отметить следующие:</p>
<ul>
<li><p><code>FullOpen</code>: при значении <code>true</code> отображается диалоговое окно с расширенными настройками для выбора цвета</p></li>
<li><p><code>SolidColorOnly</code>: при значении <code>true</code> позволяет выбирать только между отнотонные оттенки цветов</p></li>
<li><p><code>Color</code>: выбранный в диалоговом окне цвет</p></li>
</ul>
<p>И при нажатии кнопку нам отобразится диалоговое окно, в котором можно установить цвет формы:</p>
<img src="pics/4.62.png" alt="ColorDialog в Windows Forms" />
