...
<html >
<head>
<title>Элемент ComboBox в Windows Forms | Visual C#</title>
<meta charset="utf-8" />
...
<h2>Элемент ComboBox</h2><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Элемент ComboBox образует выпадающий список и совмещает функциональность компонентов ListBox и TextBox. Для хранения элементов списка в ComboBox также предназначено свойство 
<span class="bb">Items</span>.</p>
<p>Подобным образом, как и с ListBox, мы можем в окне свойств на свойство Items и нам отобразится окно для добавления элементов ComboBox:</p>
<img src="pics/4.15.png" alt="Добавление элементов в ComboBox" />
<p>И как и с компонентом ListBox, здесь мы также можем программно управлять элементами.</p>
...
<p>При добавлении с помощью методов Add / AddRange все новые элементы помещаются в конец списка. Однако если мы зададим у ComboBox свойство 
<code>Sorted</code> равным <code>true</code>, тогда при добавлении будет автоматически производиться сортировка.</p>
...
<p>Мы можем получить элемент по индексу и производить с ним разные действия. Например, изменить его:</p>
<pre class="brush:c#;">
comboBox1.Items[0] = "Парагвай";
</pre>
<h3>Настройка оформления ComboBox</h3>
<p>С помощью ряда свойств можно настроить стиль оформления компонента. Так, свойство <span class="bb">DropDownWidth</span> задает ширину выпадающего списка. 
С помощью свойства <span class="bb">DropDownHeight</span> можно установить высоту выпадающего списка.</p>
<p>Еще одно свойство <span class="bb">MaxDropDownItems</span> позволяет задать число видимых элементов списка - от 1 до 100. По умолчанию это число равно 8.</p>
<p>Другое свойство <span class="bb">DropDownStyle</span> задает стиль ComboBox. Оно может принимать три возможных значения:</p>
<ul>
<li><p><span class="bb">Dropdown</span>: используется по умолчанию. Мы можем открыть выпадающий список вариантов при вводе значения в текстовое поле или нажав на кнопку со стрелкой 
в правой части элемента, и нам отобразится собственно выпадающий список, в котором можно выбрать возможный вариант</p></li>
<li><p><span class="bb">DropdownList</span>: чтобы открыть выпадающий список, надо нажать на кнопку со стрелкой в правой стороне элемента</p></li>
<li><p><span class="bb">Simple</span>: ComboBox представляет простое текстовое поле, в котором для перехода между элементами мы можем использовать клавиши 
клавиатуры вверх/вниз</p></li>
</ul>
<img src="pics/4.16.png" alt="Элемент ComboBox в Windows Forms" />
<h3>Событие SelectedIndexChanged</h3>
<p>Наиболее важным событием для ComboBox также является событие <code>SelectedIndexChanged</code>, позволяющее отследить выбор элемента в списке:</p>
<pre class="brush:c#;">
...
<p>Здесь также свойство <code>SelectedItem</code> будет ссылаться на выбранный элемент.</p>
