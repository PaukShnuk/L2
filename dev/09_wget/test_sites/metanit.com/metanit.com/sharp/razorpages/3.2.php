...
<html >
<head>
<title>Razor Pages и C# | Файл _ViewImports.cshtml</title>
<meta charset="utf-8" />
<meta name="description" content="Файл _ViewImports.cshtml в Razor Pages в ASP.NET Core и C#, подключение функционала на страницы Razor">
...
<h2>Файл _ViewImports.cshtml</h2><div class="date">Последнее обновление: 18.04.2022</div>
...
<p>Файл <span class="b">_ViewImports.cshtml</span> позволяет по умолчанию подключить на страницы Razor некоторый функционал. Сначала рассмотрим ситуацию, с которой мы 
можем столкнуться. Пусть у нас в проекте есть некоторый класс <span class="b">Person:</span></p>
<pre class="brush:c#;">
...
<p>Допустим, мы хотим использовать тип Person на странице <span class="b">Index.cshtml</span>:</p>
<pre class="brush:c#;">
@page
...
<p>Чтобы использовать тип Person на странице Razor, мы вынуждены импортировать с помощью директивы <span class="b">using</span> пространство имен, где этот тип определен. 
...
<p>Итак, добавим в проект в папку <span class="b">Pages</span> файл <span class="b">_ViewImports.cshtml</span>. Для его добавления в Visual Studio можно применять шаблон 
<span class="b">Razor View Imports</span>:</p>
<img src="./pics/3.7.png" alt="_ViewImports.cshtml в Razor Pages ASP.NET Core и C#" />
<p>Далее добавим в этот файл подключение пространства имен класса Person:</p>
<pre class="brush:c#;">
@* Подключаем пространство имен класса Person *@
@using RazorPagesApp
</pre>
<img src="./pics/3.8.png" alt="файл _ViewImports.cshtml в ASP.NET Core Razor Pages и C#" /> 
<p>В этом случае функциональность пространства имен <code>RazorPagesApps</code> будет автоматически подключаться на все страницы Razor.</p>
<p>И тогда мы можем убрать из страницы <span class="b">Index.cshtml</span> подключение пространства имен:</p>
<pre class="brush:c#;">
@page 
...
<img src="./pics/3.9.png" alt="файл _ViewImports.cshtml и подключение на страницу Razor Pages в ASP.NET Core и C#" />
