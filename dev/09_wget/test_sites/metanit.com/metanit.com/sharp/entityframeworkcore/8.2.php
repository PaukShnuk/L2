...
<html >
<head>
<title>Entity Framework Core | Проекция запросов на представления</title>
<meta charset="utf-8" />
<meta name="description" content="Query Types в Entity Framework Core, сопоставление классов с представлением в базе данных, DbQuery, CREATE VIEW">
...
<h2>Проекция запросов на представления</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>Как правило, каждая таблица в БД сопоставляется с определенным классом модели в Entity Framework. Но в EF Core мы также 
можем сопоставлять наборы DbSet в контексте данных с представлениями в базе данных, а классы C# - с данными, которые возвращаются этими представлениями.</p>
