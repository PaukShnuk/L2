...
<html >
<head>
<title>Entity Framework Core | Наследование. Подход TPT - Table Per Type</title>
<meta charset="utf-8" />
<meta name="description" content="Наследование в Entity Framework Core, подход Table Per Type, таблица для каждого производного класса, организация базы данных">
...
<p>Начиная с версии 5.0 в EntityFramework Core стал доступен подход TPT или Table Per Type. Он позволяет выделить для 
каждого класса из одной иерархии классов в базе данных отдельную таблицу. Для его реализации мы можем использовать два способа: через атрибуты или через Fluent API.</p>
