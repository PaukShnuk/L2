...
<html >
<head>
<title>Entity Framework Core | Отношение один к одному</title>
<meta charset="utf-8" />
<meta name="description" content="Отношение один к одному в Entity Framework Core, определение главной и зависимой сущности">
...
<h2>Отношение один к одному</h2><div class="date">Последнее обновление: 17.11.2020</div>
...
<p>В итоге для сущности UserProfile будет создана следующая таблица в базе данных:</p>
<pre class="brush:sql;">
...
<p>В Entity Framework Core можно хранить данные моделей, которые связаны отношением один-к-одному, в одной таблице. Например, возьмем те же 
...
<p>В этом случае будет создаваться одна таблица Users:</p>
<pre class="brush:sql;">
