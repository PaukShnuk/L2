...
<html >
<head>
<title>Entity Framework Core | Скомпилированные запросы</title>
<meta charset="utf-8" />
<meta name="description" content="Скомпилированные запросы в Entity Framework Core, кэширование запросов, метод EF.CompileQuery">
...
<h2>Скомпилированные запросы</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>Скомпилированные запросы позволяют приложению кэшировать перевод запроса в форму, понятную для источника данных. Поэтому достаточно один раз 
создать такой запрос и затем выполнять его много раз, что повышает производительность приложения.</p>
...
<p>Например, возьмем следующие модели:</p>
<pre class="brush:c#;">
