...
<html >
<head>
<title>Entity Framework Core | Параллелизм</title>
<meta charset="utf-8" />
<meta name="description" content="Проблема параллельного доступа в Entity Framework Core, переопределение типа данных, ConcurrencyCheck, IsConcurrencyToken, RowVersion">
...
<h1>Дополнительные статьи</h1><h2>Параллелизм</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>Вместо атрибута мы можем использовать Fluent API:</p>
<pre class="brush:c#;">
public class User
{
	public int Id { get; set; }
