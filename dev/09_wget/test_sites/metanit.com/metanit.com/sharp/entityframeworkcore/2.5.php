...
<html >
<head>
<title>Entity Framework Core | Свойства моделей</title>
<meta charset="utf-8" />
<meta name="description" content="Свойства моделей в Entity Framework Core, исключение сопоставления свойств">
...
<h2>Свойства моделей</h2><div class="date">Последнее обновление: 15.11.2020</div>
...
<p>По умолчанию модель включает все свойства, которые определены как публичные и которые открыты для записи и чтения. Например,</p>
<pre class="brush:c#;">
...
<p>Класс Product имеет три публичных свойства, поэтому при чтении или записи в базу данных Entity Framework будет автоматически сопоставлять столбцы из таблицы с 
...
<p>Исключение с помощью Fluent API:</p>
<pre class="brush:c#;">
...
<p>Здесь свойство Description исключается из модели.</p>
...
<p>В обоих случаях при миграции будет создана таблица Products, которая не будет содержать столбца для свойства Description, и оно не будет участвовать в сопоставлениях 
при операциях с бд:</p>
<img src="./pics/2.5.png" alt="Column Mapping in Entity Framework Core" />
