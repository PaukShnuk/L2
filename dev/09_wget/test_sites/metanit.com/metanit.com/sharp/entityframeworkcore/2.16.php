...
<html >
<head>
<title>Entity Framework Core | Логгирование операций</title>
<meta charset="utf-8" />
<meta name="description" content="Логгирование операций в Entity Framework Core с помощью метода LogTo, вывод лога в файл и на консоль, настройка и фильтрация логгирования">
...
<h2>Логгирование операций</h2><div class="date">Последнее обновление: 17.11.2020</div>
...
<p>Для контроля операций, которые выполняет контекст данных, мы можем использовать логгирование. 
Entity Framework Core поддерживает логгирование, причем мы мжем воспользоваться как встроенными возможностями, так и создать и встроить 
свою инфраструктуру логгирования. Рассмотрим оба варианта и начнем со встроенных возможностей.</p>
<h3>Метод LogTo</h3>
<p>В EntityFramework Core 5.0 было существенно упрощено логгирование. В частности, был добавлен <span class="b">LogTo()</span>, который позволяет 
логгировать информацию. Он применяется при конфигурации класса контекста данных.</p>
...
и ничего не возвращает. Именно такое действие представляет традиционный метод <code>Console.WriteLine()</code>, который выводит строку на консоль. И поскольку класс Console расположен в 
пространстве имен System, то прописываем System.Console.WriteLine.</p>
...
<img src="./pics/2.12.png" alt="Метод LogTo в Entity Framework Core 5.0" />
<p>Подобным образом можно логгировать в другие места. Например, логгирование в окно отладки (что в программе производится с помощью метода 
<code>Debug.WriteLine()</code>):</p>
<pre class="brush:c#;">
optionsBuilder.LogTo(message =&gt; System.Diagnostics.Debug.WriteLine(message));
</pre>
<img src="./pics/2.13.png" alt="Метод LogTo и Debug.WriteLine в Entity Framework Core 5.0" />
...
описываются классом <code>SqlServerEventId</code>. Сообщения более общего характера, описывются классом <code>CoreEventId</code>, 
а сообщения, связанные с выполнением запросов, - класом <code>RelationalEventId</code>. 
...
<pre class="brush:c#;">optionsBuilder.LogTo(Console.WriteLine, new[] { RelationalEventId.CommandExecuted});</pre>
<img src="./pics/2.14.png" alt="сообщения и события в логгировании в EntityFramework Core 5" />
...
<div class="nav"><p><a href="2.2.php">Назад</a><a href="./">Содержание</a><a href="2.12.php">Вперед</a></p></div></div>
<div class="socBlock">
