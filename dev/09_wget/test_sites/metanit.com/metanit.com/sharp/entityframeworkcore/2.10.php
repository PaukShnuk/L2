...
<html >
<head>
<title>Entity Framework Core | Типы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Сопоставление типов данных C# и SQL в Entity Framework Core, переопределение типа данных">
...
<h2>Типы данных</h2><div class="date">Последнее обновление: 25.09.2016</div>
...
<p>По умолчанию провайдер определенной СУБД выбирает для столбцов типы данных на основе типов данных свойств сущности.</p>
<p>Если в качестве целевой СУБД используется MS SQL Server, то типы SQL Serverа и C# сопоставляются следующим образом:</p>
<ul>
<li><p>int : int</p></li>
<li><p>bit : bool</p></li>
...
<p>Например, по умолчанию Entity Framework для свойства с типом string будет использовать столбец с типом nvarchar.</p>
<p>В провайдерах для других СУБД система сопоставления типов может отличаться.</p>
<h3>Аннотации данных</h3>
<p>С помощью атрибута <span class="b">Column</span> можно задать тип данных для бд:</p>
<pre class="brush:c#;">
public class User
{
...
<h3>Fluent API</h3>
<p>В Fluent API для подобной задачи применяется метод <span class="b">HasColumnType</span>:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="2.9.php">Назад</a><a href="./">Содержание</a><a href="2.13.php">Вперед</a></p></div></div>
<div class="socBlock">
