...
<html >
<head>
<title>Entity Framework Core | Провайдеры логгирования</title>
<meta charset="utf-8" />
...
<h2>Провайдеры логгирования</h2><div class="date">Последнее обновление: 15.11.2020</div>
...
<p>Вначале рассмотрим, как создать свой провайдер логгирования. Это может быть полезно, если нас не устраивают встроенные седства 
логгирования, например, рассмотренный в прошлой теме метод <code>LogTo()</code>, и мы хотим по своему настроить 
...
<p>Допустим, у нас будут следующая модель и контекст данных:</p>
<pre class="brush:c#;">
public class User
{
...
<p>Чтобы установить провайдер логгирования, нам нужна фабрика логгера - объект ILoggerFactory. Для этого определяем статическую переменную 
...
<div class="nav"><p><a href="2.16.php">Назад</a><a href="./">Содержание</a><a href="2.3.php">Вперед</a></p></div></div>
<div class="socBlock">
