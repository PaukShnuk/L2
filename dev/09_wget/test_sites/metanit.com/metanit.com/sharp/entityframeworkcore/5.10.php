...
<html >
<head>
<title>Entity Framework Core | Cортировка и проекция из базы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Cортировка и проекция из базы данных в LINQ to Entities в Entity Framework Core, методы OrderBy, ThenByDescending, Select">
...
<h2>Cортировка и проекция из базы данных</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>В качестве альтернативы методу OrderBy можно использовать оператор <code>orderby</code>:</p>
<pre class="brush:c#;">
...
<p>В этом случае к выражению SQL будет добавляться ключевое слово DESC:</p>
<pre class="brush:sql;">
SELECT [u].[Id], [u].[CompanyId], [u].[Name], [u].[Age]
FROM [Users] AS [u]
