...
<html >
<head>
<title>Entity Framework Core | Агрегатные операции</title>
<meta charset="utf-8" />
<meta name="description" content="Агрегатные операции в LINQ to Entities в Entity Framework Core, методы All, Any, Count, Sum, Min, Max, Average">
...
<h2>Агрегатные операции</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>Entity Framework Core поддерживает обращение к встроенным функциями SQL через специальные методы Count, Sum и т.д. Для примера возьмем модели из прошлой темы:</p>
<pre class="brush:c#;">
...
<p>Эти запросы трансформируются в следующие SQL-выражения:</p>
<pre class="brush:sql;">
SELECT MIN([u].[Age])
FROM [Users] AS [u]
