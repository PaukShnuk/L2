...
<html >
<head>
<title>Entity Framework Core | Настройка ключей</title>
<meta charset="utf-8" />
...
<h2>Настройка ключей</h2><div class="date">Последнее обновление: 15.11.2020</div>
...
<p>В данном случае свойство Passport (серия и номер паспорта) будет альтернативным ключом. Созданная таблица Users в итоге будет описываться следующим 
SQL-скриптом:</p>
<pre class="brush:sql;">
