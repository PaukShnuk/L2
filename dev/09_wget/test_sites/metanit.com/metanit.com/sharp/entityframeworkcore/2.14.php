...
<html >
<head>
<title>Entity Framework Core | Инициализация БД начальными данными</title>
<meta charset="utf-8" />
<meta name="description" content="Инициализация базы данных начальными данными в Entity Framework Core, метод HasData">
...
<h2>Инициализация БД начальными данными</h2><div class="date">Последнее обновление: 16.11.2020</div>
...
<p>Иногда необходимо, чтобы при первом запуске база данных уже содержала некоторые данные. И 
Entity Framework Core обладает возможностью инициализировать базу данных при ее создании некоторыми начальными 
