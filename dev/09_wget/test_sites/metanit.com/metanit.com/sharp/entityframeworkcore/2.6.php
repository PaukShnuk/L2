...
<html >
<head>
<title>Entity Framework Core | Сопоставление таблиц и столбцов</title>
<meta charset="utf-8" />
<meta name="description" content="Сопоставление моделей с таблицами и свойств классов со столбцами в Entity Framework Core, атрибуты Table и Column, применение методов ToTable и HasColumnName">
...
<h2>Сопоставление таблиц и столбцов</h2><div class="date">Последнее обновление: 15.11.2020</div>
...
<p>По умолчанию каждая сущность сопоставляется с таблицей, которая называется по имени свойства <span class="b">DbSet&lt;T&gt;</span> в контексте данных, представляющего данную сущность. 
