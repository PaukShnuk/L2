...
<html >
<head>
<title>Entity Framework Core | Хранимые процедуры</title>
<meta charset="utf-8" />
...
<h2>Хранимые процедуры</h2><div class="date">Последнее обновление: 18.11.2020</div>
...
<p>Не меньше хранимых функций для взаимодействия с базой данных применяются хранимые процедуры. Рассмотрим, как вызывать хранимые процедуры из кода на C# 
через Entity Framework Core.</p>
<p>Пусть наша база данных, как и в прошлой теме, описывается следующим контекстом данных и моделями:</p>
<pre class="brush:c#;">
...
{
    Microsoft.Data.SqlClient.SqlParameter param = new Microsoft.Data.SqlClient.SqlParameter("@name", "Microsoft");
