...
<html >
<head>
<title>Entity Framework Core | Генерация значений свойств</title>
<meta charset="utf-8" />
<meta name="description" content="Генерация значений свойств в Entity Framework Core, установка ключей и значений по умолчанию">
...
<h2>Генерация значений свойств и столбцов</h2><div class="date">Последнее обновление: 15.11.2020</div>
...
Если для свойства явным образом не установлено значение, то для свойства устанавливается значение по умолчанию (<code>null</code> для <code>string</code>, 0 
...
<p>Атрибут <span class="b">DatabaseGeneratedAttribute</span> преставляет аннотацию, которая позволяет изменить поведение базы данных при добавлении или 
изменении.</p>
...
<h3>Fluent API</h3>
<p>Отключение автогенерации значения для свойства:</p>
<pre class="brush:c#;">
public class ApplicationContext : DbContext
{
    public DbSet&lt;User&gt; Users { get; set; }
...
<p>Для генерации значения этого свойства в базе данных можно вызывать функцию <span class="b">GETDATE()</span>:</p>
<pre class="brush:c#;">
public class ApplicationContext : DbContext
{
	public DbSet&lt;User&gt; Users { get; set; }
...
<p>В метод <code>HasDefaultValueSql()</code> передается SQL-выражение, которые вызывается при добавлении объекта User в базу данных.</p>
