...
<html >
<head>
<title>Entity Framework Core | Комплексные типы</title>
<meta charset="utf-8" />
<meta name="description" content="Комплексные типы в Entity Framework Core, их определение, метод OwnsOne, хранение в базе данных">
...
<h2>Собственные типы</h2><div class="date">Последнее обновление: 17.11.2020</div>
...
<p>Как правило, каждый тип сопоставляется с отдельной таблицей. Однако бывают случаи, когда определенный класс существует не сам по себе, 
...
<p>Для создания связки "главный тип - зависимые типы" можно использовать либо атрибут OwnedAttribute, либо настройки Fluent API.</p>
...
<p>Одни собственные типы могут иметь другие собственные типы, уввеличия сложность структуры классов. Например, определим следующие классы:</p>
<pre class="brush:c#;">
public class User
{
	public int Id { get; set; }
...
объекты еще одного класса - Claim, который представляет отдельные данные по принципу ключ-значение.</p>
...
<div class="nav"><p><a href="3.6.php">Назад</a><a href="./">Содержание</a><a href="4.1.php">Вперед</a></p></div></div>
<div class="socBlock">
