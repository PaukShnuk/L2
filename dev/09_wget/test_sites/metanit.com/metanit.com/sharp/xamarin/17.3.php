...
<html >
<head>
<title>Xamarin Forms | Выравнивание строк и столбцов в FlexLayout</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание строк и столбцов в FlexLayout в Xamarin Forms, свойство AlignContent">
...
<h2>Выравнивание строк и столбцов. AlignContent</h2><div class="date">Последнее обновление: 11.01.2021</div>
...
<p>Свойство <span class="b">AlignContent</span> управляет выравниванием элементов. Это свойство в качестве значения принимает одну из 
констант из перечисления <span class="b">FlexAlignContent</span>:</p>
<ul>
<li><p><span class="b">Stretch</span>: элементы растягиваются по всему пространству контейнера, значение по умолчанию</p></li>
<li><p><span class="b">Center</span>: элементы позиционируются по центру контейнера</p></li>
<li><p><span class="b">Start</span>: элементы располагаются в начале контейнера. Понятие "начало" зависит от направления элементов: при расположении 
в строку элементы прижимаются к верху, а при расположении в столбик элементы прижимаются к левому краю контейнера</p></li>
<li><p><span class="b">End</span>: элементы располагаются в конце контейнера: при расположении 
в строку элементы прижимаются к низу, а при расположении в столбик элементы - к правому краю контейнера</p></li>
<li><p><span class="b">SpaceAround</span>: устанавливает отступы между строками и верхней и нижней границей контейнера (при расположении в строку) и 
между столбцами и правой и левой границами контейнера (при расположении в столбик)</p></li>
<li><p><span class="b">SpaceBetween</span>: устанавливает равномерные отступы между строками (при расположении в строку) и 
или между столбцами (при расположении в столбик)</p></li>
<li><p><span class="b">SpaceEvenly</span>: устанавливает равномерные отступы между строками (при расположении в строку) и 
или между столбцами (при расположении в столбик) и между границами контейнера</p></li>
</ul>
<h3>Stretch</h3>
<p>Например, возьмем код из прошлой темы:</p>
<pre class="brush:xml;">
...
<p>По умолчанию AlignContent имеет значение Stretch, поэтому строки с элементами (при расположении строку) растягиваются по всей высоте контейнера. 
И мы можем увидить незаполненные протранства между элементами сверху и снизу.</p>
<img src="./pics/flexlayout7.png" alt="FlexLayout Wrap in Xamarin Forms" />
<h3>Start и End</h3>
<p>Теперь применим значение <span class="b">Start</span>:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<p>Теперь элементы прижимаются к верхней границе контейнера:</p>
<img src="./pics/flexlayout9.png" alt="AlignContent in FlexLayout in Xamarin Forms" />
<p>Соответственно если использовать значение End, то при расположении в строку элементы будут примыкать к низу контейнера</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout10.png" alt="Выравнивание элементов FlexLayout in Xamarin Forms" />
<p>При расположении в столбик значения Start и End представляют соответственно выравнивание элементов к левой и правой границе контейнера. 
Например, расположим элементы вдоль левой границы:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout11.png" alt="Выравнивание элементов по вертикали в FlexLayout в Xamarin Forms" />
<h3>Center</h3>
<p>При значении Center элементы располагаются по центру по вертикали или по горизнтали в зависимости от направления элементов:</p>
<pre class="brush:xml;">
...
<p>Стоит отметить, что в этом случае также действует установка <code>Wrap="Wrap"</code>.</p>
<img src="./pics/flexlayout12.png" alt="Выравнивание элементов по центру в FlexLayout в Xamarin Forms" />
<h3>SpaceAround</h3>
<p><span class="b">SpaceAround</span> устанавливает равномерные отступы от границ контейнера до элементов. При расположении в строку отступы устанавливаются от верхней и нижней границы контейнера до строк. 
При расположении в столбик отступы устанавливаются от левой и правой границ контейнера до столбцов.</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<img src="./pics/flexlayout13.png" alt="Равномерные отступы в FlexLayout в Xamarin Forms" />
<h3>SpaceBetween</h3>
<p>Значение <span class="b">SpaceBetween</span> устанавливает равномерные отступы между строками (при расположении в строку) и между столбцами (при расположении в столбик). 
...
расположении в столбик первый столбец прижимается к левой границе, а последний столбец - к правой границе.</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout14.png" alt="SpaceBetween в FlexLayout в Xamarin Forms" />
<p>Если FlexLayout содержит одну строку или один столбец, то они просто прижимаются к границе контейнера.</p>
<h3>SpaceEvenly</h3>
<p>Значение <span class="b">SpaceEvenly</span> устанавливает равномерные отступы между строками (при расположении в строку) и между столбцами (при расположении в столбик). 
...
также устанавливаются равномерные отступы:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout15.png" alt="SpaceEvenly в FlexLayout в Xamarin Forms" />
<p>Если FlexLayout содержит одну строку или один столбец, то они размещаются по центру контейнера.</p>
