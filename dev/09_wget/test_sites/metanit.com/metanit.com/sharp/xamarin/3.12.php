...
<html >
<head>
<title>Xamarin Forms | Элементы Stepper и Slider</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы Stepper и Slider в  Xamarin Forms и выбор из диапазона значений">
...
<h2>Stepper и Slider</h2><div class="date">Последнее обновление: 10.01.2021</div>
...
<h3>Stepper</h3>
<p>Stepper позволяет устанавливать числовое значение:</p>
<pre class="brush:c#;">
using Xamarin.Forms;
using System;
...
<p>Stepper позволяет установить ряд свойств, который настраивают его поведение:</p>
<ul>
<li><p><span class="b">Minimum</span>: устанавливает минимальное значение</p></li>
<li><p><span class="b">Maximum</span>: устанавливает максимальное значение</p></li>
<li><p><span class="b">Increment</span>: устанавливает шаг изменения значения</p></li>
</ul>
<p>Для отслеживания изменения значения можно обработать событие <code>ValueChanged</code></p>
<img src="./pics/2.31.png" alt="Stepper in Xamarin" />
<p>Stepper в xaml:</p>
<pre class="brush:xml;">
&lt;StackLayout&gt;
  &lt;Label x:Name="header" Text="Stepper" FontSize="Large" /&gt;
  &lt;Stepper Minimum="0" Maximum="10" Increment="0.1" ValueChanged="OnStepperValueChanged" /&gt;
&lt;/StackLayout&gt;
</pre>
<p>А в файле связанного кода прописать обработчик OnStepperValueChanged:</p>
<pre class="brush:c#;">
private void OnStepperValueChanged(object sender, ValueChangedEventArgs e)
{
    if (header != null)
...
<h3>Slider</h3>
<p><span class="b">Slider</span> представляет собой горизонтальный ползунок и во многих аспектах он похож на Stepper. Среди его свойств можно выделить следующие:</p>
<ul>
<li><p><span class="b">Minimum</span>: устанавливает минимальное значение</p></li>
<li><p><span class="b">Maximum</span>: устанавливает максимальное значение</p></li>
<li><p><span class="b">Value</span>: текущее значение</p></li>
<li><p><span class="b">ThumbColor</span>: цвет указателя текущего значения</p></li>
<li><p><span class="b">MinimumTrackColor</span>: цвет ползунка до указателя значения</p></li>
<li><p><span class="b">MaximumTrackColor</span>: цвет ползунка после указателя значения</p></li>
</ul>
<p>Например, определение в коде C#</p>
<pre class="brush:c#;">
using Xamarin.Forms;
using System;
...
<p>Slider также позволяет установить минимальное и максимальное, а также текущее значение. И также изменение значения можно обработать с 
помощью обработки события <code>ValueChanged</code></p>
<img src="./pics/2.32.png" alt="Slider in Xamarin" />
<p>Аналогичный слайдер в xaml:</p>
<pre class="brush:xml;">
&lt;StackLayout&gt;
    &lt;Label x:Name="header" Text="Slider" FontSize="Large" /&gt;
    &lt;Slider Minimum="0" Maximum="50" Value="30" ValueChanged="slider_ValueChanged" 
			MinimumTrackColor="DeepPink" MaximumTrackColor="Gray" ThumbColor="DeepPink" /&gt;
&lt;/StackLayout&gt;
</pre>
<p>И в файле связанного кода пропишем обработчик slider_ValueChanged:</p>
<pre class="brush:c#;">
void slider_ValueChanged(object sender, ValueChangedEventArgs e)
{
    if(header!=null)
