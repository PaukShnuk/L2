...
<html >
<head>
<title>Xamarin Forms | Хранение данных и свойство Properites</title>
<meta charset="utf-8" />
<meta name="description" content="Хранение данных с помощью свойства Properites класса Application в Xamarin Forms">
...
<h1>Хранение данных. Файлы</h1><div class="date">Последнее обновление: 13.01.2021</div>
...
<p>При работе с данными мы нередко сталкиваемся с проблемой их сохранения. В Xamarin Forms есть различные способы сохранения данных в зависимости от выбранного типа хранилища. 
Можно выделить четыре типа хранилища данных:</p>
<ul>
<li><p>Коллекция Properites в классе Application, которая предназначена для хранения каких-то временных данных</p></li>
<li><p>Настройки (Preferences) операционной системы для хранения каких-то атомарных данных типа int или string</p></li>
<li><p>Файлы в файловой системе</p></li>
<li><p>Базы данных</p></li>
</ul>
<h2>Свойство Properites</h2>
<p>Свойство <span class="b">Properties</span> класса Application представляет словарь, где каждому ключу с типом string сопоставляется некоторое значение. 
...
в словаре данные.</p>
<p>При этом мы не ограничены только классом Application, в котором собственно определено данное свойство. Мы также можем к нему обращаться в коде страниц с помощью выражения 
<span class="b">App.Current.Properties</span>.</p>
<p>Принципы работы с Properties те же, что и со стандартными словарями.</p>
<p>Добавление данных в словарь:</p>
<pre class="brush:c#;">
App.Current.Properties.Add("name", "Tom");
// или так
App.Current.Properties["name"] = "Tom";
</pre>
<p>Получение значения:</p>
<pre class="brush:c#;">
string name = App.Current.Properties["name"];
</pre>
<p>Получение с проверкой на наличие:</p>
<pre class="brush:c#;">
object name = "";
...
<p>Например, определим в проекте страницу MainPage. В коде xaml пропишем текстовое поле и кнопку:</p>
<pre class="brush:xml;">
...
<p>А в коде C# у страницы определим добавление и извлечение из словаря Properties введенного в текстовое поле текста:</p>
<pre class="brush:c#;">
using System;
using Xamarin.Forms;
...
<img src="./pics/6.14.png" alt="App.Current.Properties в Xamarin Forms" />
...
<div class="nav"><p><a href="./3.22.php">Назад</a><a href="./">Содержание</a><a href="./6.3.php">Вперед</a></p></div></div>
<div class="socBlock">
