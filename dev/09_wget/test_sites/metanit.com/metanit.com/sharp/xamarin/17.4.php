...
<html >
<head>
<title>Xamarin Forms | Выравнивание элементов в FlexLayout</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание элементов в FlexLayout в Xamarin Forms, свойство JustifyContent">
...
<h2>Выравнивание элементов. JustifyContent</h2><div class="date">Последнее обновление: 11.01.2021</div>
...
<p>Свойство <span class="b">JustifyContent</span> управляет выравниванием элементов внутри строк и столбцов. Оно принимает одно из значений 
из перечисления <span class="b">FlexJustify</span>:</p>
<ul>
<li><p><span class="b">Start</span>: элементы начинаются с начала строки или столбца. Значение по умолчанию</p></li>
<li><p><span class="b">End</span>: элементы начинаются с конца строки или столбца.</p></li>
<li><p><span class="b">Center</span>: элементы позиционируются по центру строки или столбца</p></li>
<li><p><span class="b">SpaceAround</span>: устанавливает равномерные отступы между элементами</p></li>
<li><p><span class="b">SpaceBetween</span>: устанавливает равномерные отступы между элементами, при этом первый и последний элементы прижимают к границам контейнера</p></li>
<li><p><span class="b">SpaceEvenly</span>: устанавливает равномерные отступы между элементами и границами контейнера</p></li>
</ul>
<h3>Start и End</h3>
<p>По умолчанию это свойство имеет значение <span class="b">Start</span>. То есть элементы прижимаются к началу строки или столбца. 
Значение <span class="b">End</span> позволяет прижать элементы в концу строку или столбца.</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout16.png" alt="JustifyContent in FlexLayout in Xamarin" />
<h3>Center</h3>
<p>Значение <span class="b">Center</span> выравниваниет элементы по центру строки или столбца:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout17.png" alt="Выравнивание элементов по центру в FlexLayout в Xamarin Forms" />
<h3>SpaceAround</h3>
<p><span class="b">SpaceAround</span> создает равномерные отступы между элементами</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout18.png" alt="SpaceAround in JustifyContent in FlexLayout in Xamarin Forms" />
<h3>SpaceBetween</h3>
<p>Значение <span class="b">SpaceBetween</span> устанавливает равномерные отступы между элементами, но в отличие от SpaceAround элементы прижимаются 
к началу и концу строки или столбца:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout19.png" alt="SpaceBetween in JustifyContent in FlexLayout in Xamarin Forms" />
<h3>SpaceEvenly</h3>
<p><span class="b">SpaceEvenly</span> устанавливает равномерные отступы между элементами и границами контейнера:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout20.png" alt="SpaceEvenly in JustifyContent in FlexLayout in Xamarin Forms" />
