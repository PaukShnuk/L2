...
<html >
<head>
<title>Xamarin Forms | StackLayout и ScrollView</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнеры StackLayout и ScrollView в Xamarin Forms, создание контейнеров в коде C# и XAML, наполнение их элементами">
...
<h2>StackLayout и ScrollView</h2><div class="date">Последнее обновление: 09.01.2021</div>
...
<h3>StackLayout</h3>
<p>StackLayout определяет размещение элементов в виде горизонтального или вертикального стека. Для позиционирования элементо он определяет два свойства:</p>
<ul>
<li><p><span class="b">Orientation</span>: определяет ориентацию стека - вертикальный или горизонтальный</p></li>
<li><p><span class="b">Spacing</span>: устанавливает пространство между элементами в стеке, по молчанию равно 6 единицам</p></li>
</ul>
<p>Например, создадим вертикальный стек элементов Label:</p>
<pre class="brush:c#;">
...
<img src="./pics/2.15.png" alt="Элемент StackLayout в Xamarin Forms" />
<p>При этом элемент <code>StackLayout</code> - обычный элемент, у которого могут использоваться все стандартные свойства типа настройки цвета, отступы и т.д.</p>
<p>По умолчанию создается вертикальный стек элементов. Чтобы создать горизонтальный стек, нам надо присвоить свойству Orientation значение 
<code>StackOrientation.Horizontal</code>:</p>
<pre class="brush:c#;">
...
<img src="./pics/2.59.png" alt="Горизонтальный стек элементов в Xamarin Forms" />
<h3>ScrollView</h3>
<p>При создании стека или любого другого элемента компоновки может сложиться ситуация, когда не все элементы будут помещаться на экране. В этом случае необходимо создать прокрутку с помощью 
элемента <span class="b">ScrollView</span>:</p>
<pre class="brush:c#;">
class MainPage : ContentPage
{
    public MainPage()
...
<div class="nav"><p><a href="./3.1.php">Назад</a><a href="./">Содержание</a><a href="./3.4.php">Вперед</a></p></div></div>
<div class="socBlock">
