...
<html >
<head>
<title>Xamarin Forms | Позиционирование элементов на странице</title>
<meta charset="utf-8" />
<meta name="description" content="Позиционирование элементов на странице в Xamarin Forms, создание отступов, выравнивание элемента по горизонтали и вертикали">
...
<h2>Позиционирование элементов на странице</h2><div class="date">Последнее обновление: 09.01.2021</div>
...
<h3>Отступы</h3>
<p>Для установки отступов у элементов применяются свойства <span class="b">Margin</span> и <span class="b">Padding</span>. Свойство <span class="b">Margin</span> 
определяет внешний отступ элемента от других элементов или контейнера. А свойство <span class="b">Padding</span> устанавливает внутрение отступы - от внутреннего содержимого элемента до его границ. 
Оба этих свойства представляют структуру <span class="b">Thickness</span>.</p>

<p>Например, зададим оба отступа в XAML:</p>
<pre class="brush:xml;">
...
<img src="./pics/2.86.png" alt="Margin и Padding в Xamarin.Forms" />
<p>Установка в коде C#:</p>
<pre class="brush:c#;">
...
<p>Кроме того, структура Thickness имеет свойства Left, Top, Right, Bottom, поэтому задать ее определение мы можем тремя способами:</p>
<ul>
<li><p>Указать одно значение для отступов со всех сторон</p></li>
<li><p>Указать два значения для отступов по горизонтали (слева и справа) и вертикали (сверху и снизу)</p></li>
<li><p>Указать четыре значение для отступов для каждой из сторон</p></li>
</ul>
...
<p>В отношении отступ надо учитывать следующую вещь: так как на устройствах с iOS верхняя панель занимает 20 единиц, то для iOS желательно 
устанавливать отступ сверху размером как минимум в 20 единиц, чтобы текст метки не налазил на панель.</p>
<p>В этом случае мы можем глобально установить отступ сверху для всех платформ в 20 или более единиц. Либо можно задать отступ непосредственно только для iOS:</p>
<pre class="brush:c#;">
public class MainPage : ContentPage
{
    public MainPage()
...
<p>В данном случае с помощью значения <span class="b">Device.RuntimePlatform</span> мы можем получить текстовую метку текущей платформы 
...
- iOS, установить определенный отступ.</p>
<h3>Выравнивание по горизонтали и вертикали</h3>
<p>Все элементы, используемые при создании интерфейса, наследуются от класса <code>View</code>, который определяет два свойства 
<span class="b">HorizontalOptions</span> и <span class="b">VerticalOptions</span>. Они управляют выравнивание элемента соответственно 
по горизонтали и по вертикали.</p>
<p>В качестве значения они принимают структуру <span class="b">LayoutOptions</span>. Данная структура имеет ряд свойств, которые хранят 
объекты опять же LayoutOptions:</p>
<ul>
<li><p><span class="b">Start</span>: выравнивание по левому краю (выравнивание по горизонтали) или по верху (выравнивание по вертикали)</p></li>
<li><p><span class="b">Center</span>: элемент выравнивается по центру</p></li>
<li><p><span class="b">End</span>: выравнивание по правому краю (выравнивание по горизонтали) или по низу (выравнивание по вертикали)</p></li>
<li><p><span class="b">Fill</span>: элемент заполняет все пространство контейнера</p></li>
<li><p><span class="b">StartAndExpand</span>: аналогичен опции <code>Start</code> с применением растяжения</p></li>
<li><p><span class="b">CenterAndExpand</span>: аналогичен опции <code>Center</code> с применением растяжения</p></li>
<li><p><span class="b">EndAndExpand</span>: аналогичен опции <code>End</code> с применением растяжения</p></li>
<li><p><span class="b">FillAndExpand</span>: аналогичен опции <code>Fill</code> с применением растяжения</p></li>
</ul>
<p>Зададим выравнивание в коде C#:</p>
<pre class="brush:c#;">
Label header = new Label() { Text = "Привет из Xamarin Forms" };
...
<img src="./pics/2.54.png" alt="Выравнивание элементов в Xamarin Forms" />
<h3>Выравнивание текста внутри элемента</h3>
<p>Выравнивание текста по горизонтали и вертикали задается с помощью свойств <span class="b">HorizontalTextAlignment</span> и 
<span class="b">VerticalTextAlignment</span> соответственно. В качестве значения эти свойства принимают одну из констант перечисления <span class="b">TextAlignment</span>:</p>
<ul>
<li><p><code>Start</code>: текст выравнивается по левому краю по горизонтали или по верху по вертикали</p></li>
<li><p><code>Center</code>: текст выравнивается по центру</p></li>
<li><p><code>End</code>: текст выравнивается по правому краю по горизонтали или по низу по вертикали</p></li>
</ul>
<p>Пример на c#:</p>
<pre class="brush:c#;">
Label header = new Label() { Text = "Привет из Xamarin Forms" };
...
<div class="nav"><p><a href="./3.6.php">Назад</a><a href="./">Содержание</a><a href="./3.18.php">Вперед</a></p></div></div>
<div class="socBlock">
