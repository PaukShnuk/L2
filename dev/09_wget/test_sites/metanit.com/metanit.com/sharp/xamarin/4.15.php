...
<html >
<head>
<title>Xamarin Forms | Настройка внешнего вида ListView</title>
<meta charset="utf-8" />
<meta name="description" content="Настройка внешнего вида ListView в Xamarin Forms, установка разделителя, заголовков и футера списка, свойства SeparatorVisibility, Header и Footer">
...
<h2>Настройка внешнего вида ListView</h2><div class="date">Последнее обновление: 12.01.2021</div>
...
<h3>Разделитель</h3>
<p>По умолчанию все элементы списка разделяются горизонтальной чертой, которая служит в качестве разделителя. Однако с помощью свойства <span class="b">SeparatorVisibility</span> 
можно отключить этот разделитель. Для этого оно получает значение <code>None</code>. В XAML:</p>
<pre class="brush:xml;">&lt;ListView SeparatorVisibility="None" &gt;</pre>
<p>В коде C#:</p>
<pre class="brush:c#;">listView.SeparatorVisibility = SeparatorVisibility.None;</pre>
<img src="./pics/2.74.png" alt="Отключение разделителя в ListView в Xamarin Forms" />
<p>С помощью свойства <span class="b">SeparatorColor</span> можно настроить цвет разделителя. В XAML:</p>
<pre class="brush:xml;">&lt;ListView SeparatorColor="Red" &gt;</pre>
<p>В коде C#:</p>
<pre class="brush:c#;">listView.SeparatorColor = Color.Red;</pre>
<img src="./pics/2.75.png" alt="Цвет разделителя в ListView в Xamarin Forms" />
<h3>Высота строк</h3>
<p>Свойство <span class="b">RowHeight</span> позволяет задать высоту строки в ListView. Но действовать оно будет только в том случае, если 
другое свойство в ListView - <span class="b">HasUnevenRows</span> равно false.</p>
<p>Установка в XAML:</p>
<pre class="brush:xml;">&lt;ListView RowHeight="100" &gt;</pre>
<p>В коде C#:</p>
<pre class="brush:c#;">listView.RowHeight = 100;</pre>
<h3>Заголовок и футер в ListView</h3>
<p>С помощью свойств <span class="b">Header</span> и <span class="b">Footer</span> у ListView можно задать соответственно заголовок и футер. В качестве значения мы можем задать обычные строки:</p>
<pre class="brush:xml;">
...
<p>Но в данном случае мы лишь увидим небольшие слаборазличимые надписи в начале и в конце списка:</p>
<img src="./pics/3.22.png" alt="Header и Footer в ListView в Xamarin.Forms" />
<p>Однако ListView позволяет задать шаблон для их отображения:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<img src="./pics/3.23.png" alt="Заголовок в ListView в Xamarin.Forms" />
