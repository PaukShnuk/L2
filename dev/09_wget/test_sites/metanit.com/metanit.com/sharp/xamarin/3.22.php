...
<html >
<head>
<title>Xamarin Forms | TabbedPage. Страница с вкладками</title>
<meta charset="utf-8" />
<meta name="description" content="Использование класса TabbedPage для создания вкладок в Xamarin Forms">
...
<h1>Типы страниц</h1><h2>TabbedPage. Страница с вкладками</h2><div class="date">Последнее обновление: 13.01.2021</div>
...
<p>Применение класса <span class="b">TabbedPage</span> в Xamarin Forms позволяет создать страницу с вкладками, где в роли каждой вкладки выступает отдельная страница.</p>
<p>Для примера возьмем проект и вначале добавим в него три обычных однотипных страницы, которые назовем Page1, Page2, Page3. Для добавления страниц 
можно выбрать шаблон  <span class="b">Content Page</span>:</p>
<img src="./pics/2.90.png" alt="Страница XAML для TabbedPage в Xamarin Forms" />
<p>Например, визуальный интерфейс страницы Page1 будет следующим:</p>
<pre class="brush:xml;">
...
<p>В данном случае надо отметить, что в качестве заголовка вкладки будет выступать свойство Title у каждой страницы. Поэтому здесь указывается атрибут Title.</p>
<p>Код страницы Page2:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<p>Код c# у каждой страницы остается тот, который был по умолчанию.</p>
<img src="./pics/2.91.png" alt="TabbedPage in Xamarin Forms" />
<p>По умолчанию главная страница проекта MainPage представляет тип ContentPage. Изменим его на TabbedPage и определим внутри страницы с помощью коллекции <code>Children</code> 
набор страниц, которые будут представлять вкладки:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
...
<p>Также изменим в коде страницы ее тип с ContentPage на TabbedPage:</p>
<pre class="brush:c#;">
using Xamarin.Forms;
...
<p>И после запуска главная страница будет представлять набор вкладок:</p>
<img src="./pics/2.77.png" alt="Вкладки в Xamarin Forms" />
