...
<html >
<head>
<title>Xamarin Forms | Изображения в ListView. ImageCell и ViewCell</title>
<meta charset="utf-8" />
<meta name="description" content="Изображения в ListView. ImageCell и ViewCell в Xamarin Forms, настройка размеров изображений">
...
<h2>Изображения в ListView. ImageCell и ViewCell</h2><div class="date">Последнее обновление: 12.01.2021</div>
...
<p>Для отображения изображений в ListView в простых случаях мы можем использовать класс <span class="b">ImageCell</span>, а в более сложных можно воспользоваться 
ViewCell.</p>
<p>Класс ImageView расширяет класс TextCell, добавляя свойство <code>ImageSource</code>, которое указывает на источник изображения.</p>
<p>Ранее в теме <a href="./3.9.php">Работа с изображениями. Элемент Image</a> уже рассматривалось, как добавлять изображения проект и выводить их на страницу. 
И аналогичным образом добавим в проекты несколько изображений:</p>
<img src="./pics/3.17.png" alt="Images in Xamarin Forms" />
<p>В проект для Android изображения добавляются в папку Drawables, в проект для iOS - через папку папке <span class="b">Assets Catalogs</span>, в проект для UWP - в корневую папку проекта.</p>
<p>Теперь определим класс страницы, которая будет выводить эти изображения через ImageCell:</p>
<pre class="brush:c#;">
...
<p>По сравнению с прошлой темой в класс Phone было добавлено свойство ImagePath, которое хранит путь к изображению в проекте. К этому свойству осуществляется 
привязка свойства ImageSource объекта ImageCell.</p>
<img src="./pics/3.18.png" alt="ImageCell в ListView в Xamarin Forms" />
...
<p>И в файле кода происходит создание источника данных:</p>
<pre class="brush:c#;">
public partial class MainPage : ContentPage
{
    public List&lt;Phone&gt; Phones { get; set; }
...
<h3>Вывод изображения в ViewCell</h3>
<p>В то же время следует отметить, что на UWP, в отличие от Android и iOS, отсутствует масштабирование изображения. И оно отображается в тех размерах, которые имеет. 
В этом случае мы можем выводить элементы списка через ViewCell, задавая у элемента Image явным образом высоту и ширину:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<img src="./pics/3.19.png" alt="Вывод изображений в ListView в Xamarin Forms" />
