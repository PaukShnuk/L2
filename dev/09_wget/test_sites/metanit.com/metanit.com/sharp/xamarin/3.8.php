...
<html >
<head>
<title>Xamarin Forms | Всплывающие окна</title>
<meta charset="utf-8" />
<meta name="description" content="Всплывающие окна в Xamarin Forms, методы DisplayAlert и DisplayActionSheet">
...
<h2>Всплывающие окна</h2><div class="date">Последнее обновление: 10.01.2021</div>
...
<p>В Xamarin Forms для создания всплывающих окон используются специальные методы, которые определены у объекта Page, а поэтому есть у любой страницы:</p>
<pre class="brush:c#;">
...
<p>Первый параметр передает заголовок окна, второй - текст окна, третий - надпись на кнопки отмены.</p>
<img src="./pics/2.70.png" alt="DisplayAlert в Xamarin Forms" />
<p>Эта версия метода просто выводит некоторое диагностическое сообщение. Но если нам необходимо, чтобы всплывающее окно предоставляло пользователю 
некоторый выбор, который надо обработать, то можно использовать вторую версию. Для этого изменим обработчик кнопки:</p>
<pre class="brush:c#;">
...
<img src="./pics/2.71.png" alt="Диалоговое окно в Xamarin Forms" />
<h3>DisplayActionSheet</h3>
<p>Всплывающее окно, которое создается методом <code>DisplayActionSheet()</code>, предоставляет возможность выбра из ряда действий. 
Получив выбранное значение, затем мы можем произвести какие-то действия на основании этого значения.</p> 
<p>Метод <code>DisplayActionSheet()</code> принимает следующие параметры:</p>
<pre class="brush:c#;">
Task&lt;string&gt; DisplayActionSheet (String title, String cancel, String destruction, params String[] buttons)
</pre>
<ul>
<li><p><code>title</code>: заголовок окна</p></li>
<li><p><code>cancel</code>: текст для кнопки отмены. Может быть равен null, если мы хотим скрыть эту кнопку</p></li>
<li><p><code>destruction</code>: текст для кнопки удаления. Также для скрытия этой кнопки можно передать значение null</p></li>
<li><p><code>buttons</code>: текстовые метки для дополнительных кнопок</p></li>
</ul>
<pre class="brush:c#;">
class MainPage : ContentPage
{
...
<img src="./pics/2.73.png" alt="DisplayActionSheet в Xamarin Forms" />
...
<div class="nav"><p><a href="./3.15.php">Назад</a><a href="./">Содержание</a><a href="./3.21.php">Вперед</a></p></div></div>
<div class="socBlock">
