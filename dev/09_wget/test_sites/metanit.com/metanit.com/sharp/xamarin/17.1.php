...
<html >
<head>
<title>Xamarin Forms | FlexLayout</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер FlexLayout в Xamarin Forms, свойство Direction, расположение элементов в строку и в столбец">
...
<h1>FlexLayout</h1><div class="date">Последнее обновление: 11.01.2021</div>
...
<p>Начиная с версии 3.0 в Xamarin Forms был добавлен новый контейнер компоновки - <span class="b">FlexLayout</span>. За основу нового контейнера 
компоновки была взята концепция <a href="https://metanit.com/web/html5/12.1.php">FlexBox</a> - модуля CSS, который 
обеспечивает гибкую настройку размещения вложенных элементов.</p>
<h2>Свойство Direction. Направление элементов</h2>
<p>Свойство <span class="b">Direction</span> устанавливает режим направления элементов: по горизонтали в строку или по вертикали в столбик.</p>
<p>В качестве значения оно принимает одно из значений перечисления <span class="b">FlexDirection</span>:</p>
<ul>
<li><p><span class="b">Row</span>: расположение в строку</p></li>
<li><p><span class="b">RowReverse</span>: расположение в строку в обратном порядке</p></li>
<li><p><span class="b">Column</span>: расположение в столбец</p></li>
<li><p><span class="b">ColumnReverse</span>: расположение в столбец в обратном порядке</p></li>
</ul>
<p>Расположим элементы в строку:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout1.png" alt="Row Direction in FlexLayout in Xamarin" />
<p>При таком расположении по умолчанию высота каждого элемента равна высоте контейнера, а ширина имеет значение, необходимое для отображения данного элемента. 
Однако с помощью свойств <span class="b">HeightRequest</span> и <span class="b">WidthRequest</span> мы можем настроить соответственно высоту и 
ширину элемента.</p>
<pre class="brush:xml;">
&lt;FlexLayout Direction="Row"&gt;
...
<img src="./pics/flexlayout2.png" alt="Установка высоты и ширины элементов в FlexLayout в Xamarin Forms" />
<p>Однако если совокупные размеры элементов превосходят доступное пространство контейнера, то элементы будут масштабироваться 
таким образом, чтобы поместиться в контейнере. Например:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<img src="./pics/flexlayout4.png" alt="Размещение в FlexLayout в Xamarin Forms" />
<p>Теперь расположим элементы в столбик:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout3.png" alt="Column Direction in FlexLayout in Xamarin" />
<p>По умолчанию при размещении в столбик каждый элемент растягивается по всей ширине контейнера и принимает ту ширину, которая для него необходима, чтобы вместить его  содержимое. 
Однако с помощью свойств HeightRequest и WidthRequest мы также можем управлять размерами элементов внутри контейнера.</p>
<p>Также можно комбинировать различные режимы направления элементов:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
             xmlns:x="http://schemas.microsoft.com/winfx/2009/xaml"
...
<img src="./pics/flexlayout5.png" alt="Вложенный FlexLayout в Xamarin Forms" />
<p>В данном случае FlexLayout содержит два других контейнера FlexLayout. Внешний контейнер размещает элементы в столбик, а вложенные контейнеры - в строку. 
Подобным образом мы можем создавать более сложные макеты элементов.</p>
...
<div class="nav"><p><a href="./15.1.php">Назад</a><a href="./">Содержание</a><a href="./17.2.php">Вперед</a></p></div></div>
<div class="socBlock">
