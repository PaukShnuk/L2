...
<html >
<head>
<title>Xamarin Forms | Выпадающий список Picker</title>
<meta charset="utf-8" />
<meta name="description" content="Создание выпадающего списока с помощью элемента Picker в Xamarin Forms">
...
<h2>Выпадающий список Picker</h2><div class="date">Последнее обновление: 10.01.2021</div>
...
<p>Визуально Picker представляет собой обычное текстовое поле, по нажатию на которое открывается список для выбора, что-то наподобие выпадающего списка:</p>
<pre class="brush:c#;">
...
<p>Picker содержит список для выбора, а отследить выбранный элемент мы можем с помощью обработчик события <code>SelectedIndexChanged</code>.</p>
<img src="./pics/2.30.png" alt="Picker in Xamarin" />
<p>Аналог в xaml:</p>
<pre class="brush:xml;">
&lt;StackLayout&gt;
    &lt;Label x:Name="header" Text="Языки программирования" FontSize="Large" /&gt;
...
<p>И тогда в файл связанного кода надо добавить обработчик события:</p>
<pre class="brush:c#;">
void picker_SelectedIndexChanged(object sender, EventArgs e)
{
    header.Text = "Вы выбрали: " + picker.Items[picker.SelectedIndex];
