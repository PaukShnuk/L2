...
<html >
<head>
<title>Xamarin Forms | TextCell</title>
<meta charset="utf-8" />
<meta name="description" content="Класс TextCell и его свойства в Xamarin Forms, вывод текстовой информации в ListView">
...
<h2>TextCell</h2><div class="date">Последнее обновление: 12.01.2021</div>
...
<p>В прошлой теме для настройки вывода списка в ListView использовался объект ViewCell. Этот объект представляет ячейку, которую мы можем настроить по своему усмотрению, 
опеределить в ней различные элементы. Однако кроме ViewCell в ListView для отображения данных можно применять еще несколько типов ячеек:</p>
<ul>
<li><p><span class="b">TextCell</span>: выводит заголовок и некоторое детальное описание</p></li>
<li><p><span class="b">ImageCell</span>: выводит рядом с заголовком и детальным описанием изображение</p></li>
</ul>
<p>Для простых случаев, когда для каждого объекта в списке необходимо вывести заголовок и некоторую аннотацию к нему, можно использовать класс TextCell. 
Его основные свойства, которые могут нам пригодиться:</p>
<ul>
<li><p><span class="b">Text</span>: основной текст, выводится большим шрифтом</p></li>
<li><p><span class="b">Detail</span>: детальное описание, выводится меньшим шрифтом</p></li>
<li><p><span class="b">TextColor</span>: цвет текста</p></li>
<li><p><span class="b">DetailColor</span>: цвет детального описания</p></li>
</ul>
<p>Например, определим в файле кода класс Phone и список объектов:</p>
<pre class="brush:c#;">
...
<p>Настроим привязку и вывод объектов в файле xaml:</p>
<pre class="brush:xml;">
...
<p>В отличие от прошлой темы в плане привязки ничего не изменяется, только заменяется ViewCell на TextCell:</p>
<img src="./pics/3.16.png" alt="TextCell в ListView в Xamarin.Forms" />
<p>Но естественно возможностей по кастомизации меньше, чем в случае с ViewCell.</p>
<p>Аналогичный пример полность в коде C#:</p>
<pre class="brush:c#;">
using System.Collections.Generic;
using Xamarin.Forms;
