...
<html >
<head>
<title>Xamarin Forms | Свойство AlignItems в FlexLayout</title>
<meta charset="utf-8" />
<meta name="description" content="Свойство AlignItems в FlexLayout в Xamarin Forms, выравнивание элементов относительно других элементов">
...
<h2>Свойство AlignItems</h2><div class="date">Последнее обновление: 11.01.2021</div>
...
<p>Свойство <span class="b">AlignItems</span> управляем выравниванием элементов внутри солбца или строки относительно других элементов. В качестве значения оно принимает 
одну из констант перечисления <span class="b">FlexAlignItems</span>:</p>
<ul>
<li><p><span class="b">Stretch</span>: если для элементов не заданы размеры, они растягиваются по высоте (для строк) или 
по ширине (для столбцов) контейнера. Значение по умолчанию</p></li>
<li><p><span class="b">Center</span>: элементы выравниваются по центру самого большого элемента в строке (при расположении в виде строки) или 
самого широкого элемента в столбце (при расположении в виде столбца)</p></li>
<li><p><span class="b">Start</span>: элементы выравниваются по верхней границе самого высокого элемента в строке или по левой границе самого широкого элемента в столбце</p></li>
<li><p><span class="b">End</span>:  элементы выравниваются по нижней границе самого высокого элемента в строке или по правой границе самого широкого элемента в столбце</p></li>
</ul>
<h3>Stretch</h3>
<p>Если для элемента не задана высота, то он растягивается по всей высоте строки. Если для него не задана ширина, он растягивается по всей ширине столбца.</p>
<pre class="brush:xml;">
...
<p>В данном случае для третьей кнопки не задана высота, поэтому она будет растягивается по всей высоте строки:</p>
<img src="./pics/flexlayout21.png" alt="AlignItems in FlexLayout in Xamarin Forms" />
<p>При расположении элементов в столбик аналогично если для элемента не указана ширина, то он будет растягиваться по всей ширине столбца.</p>
<h3>Start</h3>
<p>При значении Start при расположении в строку все элементы будут выравниваться относительно верхней границы строки:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout22.png" alt="Выравнивание по самому большому элементу в FlexLayout в Xamarin Forms" />
<p>При расположении в столбик элементы выравниваются относительно начала столбца.</p>
<h3>End</h3>
<p>При значении End при расположении в строку все элементы будут выравниваться относительно нижней границы самого высокого элемента в строке:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout23.png" alt="Выравнивание в FlexLayout в Xamarin Forms" />
<p>При расположении в столбик элементы выравниваются по правой границе самого широкого элемента в столбце:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout25.png" alt="Выравнивание по самому широкому элементу в FlexLayout в Xamarin Forms" />
<h3>Center</h3>
<p>Center при расположении элементов в строку центрирует все элементы относительно самого высокого элемента в строке:</p>
<pre class="brush:xml;">
...
<img src="./pics/flexlayout24.png" alt="Выравнивание по центру в FlexLayout в Xamarin Forms" />
<p>При расположении элементов в столбик они выравниваются по центру самого широкого элемента в столбце.</p>
...
<div class="nav"><p><a href="./17.4.php">Назад</a><a href="./">Содержание</a><a href="./17.6.php">Вперед</a></p></div></div>
<div class="socBlock">
