...
<html >
<head>
<title>Xamarin Forms | Кнопки</title>
<meta charset="utf-8" />
<meta name="description" content="Создание и использование кнопок в Xamarin Forms">
...
<h2>Кнопки</h2><div class="date">Последнее обновление: 09.01.2021</div>
...
<p>Для произведения какого-либо действия нам понадобятся кнопки, представленные классом <code>Button</code>. Создадим кнопку в коде:</p>
<pre class="brush:c#;">
using Xamarin.Forms;
...
<p>Для кнопки можно задать обработчик нажатия для события <code>Clicked</code>. В данном случае по нажатию просто изменяем текст и цвет фона кнопки.</p>
<p>Обрботчик во многим аналогичен стандартным обработчикам в Windows Forms. Он принимает два параметра: объект типа object (источника события) и 
System.EventArgs (аргумент события, хранящий некоторую дополнительную информацию).</p>
<p>Анлогичная кнопка в xaml:</p>
<pre class="brush:xml;">
...
<p>И тогда в файле отделенного кода MainPage.xaml.cs еще надо прописать обработчик OnButtonClicked:</p>
<pre class="brush:c#;">
using Xamarin.Forms;
...
<img src="./pics/2.63.png" alt="Кнопка в Xamarin Forms" />
<p>Кнопка имеет много различных свойств, из которых следует выделить следующие:</p>
<ul>
<li><p><span class="b">FontFamily</span>: шрифт, который используется для текста на кнопке</p></li>
<li><p><span class="b">FontSize</span>: размер текста на кнопке</p></li>
<li><p><span class="b">FontAttributes</span>: выделение жирным или курсивом текста на кнопке</p></li>
<li><p><span class="b">TextColor</span>: цвет шрифта</p></li>
<li><p><span class="b">BorderColor</span>: цвет границы</p></li>
<li><p><span class="b">BorderWidth</span>: ширина границы</p></li>
<li><p><span class="b">CornerRadius</span>: радиус границы</p></li>
<li><p><span class="b">Image</span>: позволяет задать изображение на кнопке</p></li>
</ul>
...
<div class="nav"><p><a href="./3.19.php">Назад</a><a href="./">Содержание</a><a href="./3.20.php">Вперед</a></p></div></div>
<div class="socBlock">
