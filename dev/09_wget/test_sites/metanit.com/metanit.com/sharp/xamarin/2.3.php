...
<html >
<head>
<title>Xamarin Forms | Создание графического интерфейса</title>
<meta charset="utf-8" />
<meta name="description" content="В Xamarin.Forms визуальный интерфейс состоит из страниц. Страница представляет собой объект класса Page, она занимает все пространство экрана.">
...
<h1>Графический интерфейс в Xamarin Forms</h1><h2>Создание графического интерфейса</h2><div class="date">Последнее обновление: 08.01.2021</div>
...
<div class="nav"><p><a href="./2.8.php">Назад</a><a href="./">Содержание</a><a href="./2.4.php">Вперед</a></p></div></div>
<div class="socBlock">
