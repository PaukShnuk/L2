...
<html >
<head>
<title>Xamarin Forms | Запуск на Windows 10</title>
<meta charset="utf-8" />
<meta name="description" content="Создани и тестирование приложения на Xamarin Forms на Windows 10 под платформу UWP">
...
<h2>Запуск на Windows 10</h2><div class="date">Последнее обновление: 07.01.2021</div>
...
<p>Запуск на Windows 10 может отличаться в зависимости от того, на каком устройстве мы хотим запускать. Для начала отметим проект под UWP (который в нашем случае называется 
HelloApp.UWP) в качестве стартового.</p>
<p>Для запуска этого проекта на текущей рабочей машине под управлением Windows 10, надо выбрать пункт <span class="b">Local Machine</span>:</p>
<img src="./pics/2.40.png" alt="Проект Xamarin для Windows 10" />
<p>После запуска мы увидим ту же надпись, что и приложении для Android:</p>
<img src="./pics/2.41.png" alt="Проект UWP для Xamarin" />
<p>При создании приложения под UWP мы также можем настроить в свойствах проекта ряд опций. В частности, целевую и минимальную версию Windows 10, 
под которые будет компилироваться приложение:</p>
<img src="./pics/2.12.png" alt="Настройка минимальной версии Windows 10 при компиляции приложения Xamarin Forms в UWP" />
<p>А также через кнопку Assembly Information задать ряд свойств самого приложения: информацию о копирайте, номер версии и т.д.</p>
