...
<html >
<head>
<title>Xamarin Forms | Контейнер Frame</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер Frame в Xamarin Forms, использование свойств BorderColor, BackgroundColor, CornerRadius">
...
<h2>Контейнер Frame</h2><div class="date">Последнее обновление: 10.01.2021</div>
...
<p>Контейнер <span class="b">Frame</span>, как правило используется для оформления или создания фона для вложенного элемента.</p>
<p>Среди свойств класса Frame следует выделить следующие:</p>
<ul>
<li><p><span class="b">BorderColor</span>: представляет цвет границы фрейма с помощью структуры Color.</p></li>
<li><p><span class="b">CornerRadius</span>: представляет радиус границы фрейма в виде значения типа float.</p></li>
<li><p><span class="b">HasShadow</span>: хранит значение типа bool, которое указывает, будет ли фрейм отбрасывать тень.</p></li>
</ul>
<p>Стоит учитывать, что фрейм может вмещать только один элемент. Например, создание фрейма в XAML:</p>
<pre class="brush:xml;">
&lt;Frame&gt;
  &lt;Label Text="Hello Xamarin" /&gt;
&lt;/Frame&gt;
</pre>
<p>Создание фрейма в коде C#:</p>
<pre class="brush:c#;">
...
<p>Ключевым моментом использования фреймов является возможность установить некоторое внешнее оформление для вложенного элемента, 
например, с помощью установки цвета границы, ее радиуса, цвета фона.</p>
<pre class="brush:xml;">
...
<img src="./pics/2.16.png" alt="Frame in Xamarin Forms" />
...
<div class="nav"><p><a href="./3.20.php">Назад</a><a href="./">Содержание</a><a href="./3.23.php">Вперед</a></p></div></div>
<div class="socBlock">
