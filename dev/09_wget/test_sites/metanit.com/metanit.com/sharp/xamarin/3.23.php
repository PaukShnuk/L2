...
<html >
<head>
<title>Xamarin Forms | BoxView</title>
<meta charset="utf-8" />
<meta name="description" content="BoxView в Xamarin Forms, создание прямоугольной области, установка размеров, цвета и границы, свойства Color, CornerRadius, WidthRequest и HeightRequest">
...
<h2>BoxView</h2><div class="date">Последнее обновление: 10.01.2021</div>
...
<p><span class="b">BoxView</span> представляет прямоугольник. Чаще всего BoxView используется для создания окрашенных областей, либо в качестве декоративного примитивного графического оформления к другим 
элементам.</p>
<p>Основные свойства класса BoxView:</p>
<ul>
<li><p><span class="b">Color</span>: представляет цвет элемента в виде структуры Color.</p></li>
<li><p><span class="b">CornerRadius</span>: представляет радиус границы BoxView в виде значения типа float.</p></li>
<li><p><span class="b">WidthRequest</span>: представляет ширину элемента (по умолчанию равна 40 единицам).</p></li>
<li><p><span class="b">HeightRequest</span>: представляет высоту элемента (по умолчанию равна 40 единицам).</p></li>
</ul>
<p>Создание BoxView в xaml:</p>
<pre class="brush:xml;">
...
<img src="./pics/2.24.png" alt="Элемент BoxView в Xamarin Forms" />
<p>Аналогичный пример в коде C#:</p>
<pre class="brush:c#;">
using Xamarin.Forms;
...
<p>Также можно использовать BoxView для создания прямоугольного графического декоративного орнамента там, где не нужна сложная графика, 
...
так как тот позволяет определить фиксированное положение, но и в других контейнерах также можно применять. Например, нам надо начертить двойную линию:</p>
<img src="./pics/2.23.png" alt="BoxView in Xamarin" />
<p>Пример в xaml:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0" encoding="utf-8" ?&gt;
&lt;ContentPage xmlns="http://xamarin.com/schemas/2014/forms"
