...
<html >
<head>
<title>Сохранение и извлечение файлов из базы данных MS SQL Server и C#</title>
<meta charset="utf-8" />
<meta name="description" content="Сохранение и извлечение файлов из базы данных MS SQL Server в ADO.NET и C#">
...
<h2>Сохранение и извлечение файлов из базы данных</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/adonetcore/">по ADO.NET и работе с базами данных в .NET 6</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<h3>Сохранение в базу данных файлов</h3>
<p>Рассмотрим, как мы можем сохранять файлы, в частности, файлы изображений в базу данных. Для этого добавим в базу данных новую таблицу 
...
файла и также имеет тип nvarchar) и ImageData (будет содержать бинарные данные файла и имеет тип varbimary(MAX)).</p>
<img src="pics/saveimagetodatabase.png" alt="Сохранение файлов в базу данных" />
...
<p>После выполнения этой программы в базе данных появится соответствующая запись:</p>
<img src="pics/varbinary.png" alt="Сохранение изображений в базе данных" />
<h3>Извлечение файлов из базы данных</h3>
<p>В прошлой теме мы рассмотрели, как добавить файл в базу данных. Теперь произведем обратную операцию - получим файл из БД. Вначале определим класс файла, 
который упростит работу с данными:</p>
<pre class="brush:c#;">
public class Image
{
...
<p>Затем в коде программы определим следующий метод:</p>
<pre class="brush:c#;">
...
<p>В этом методе с помощью SqlDataReader мы получаем значения из БД и по ним создаем объект Image, который потом добавляется в список. 
