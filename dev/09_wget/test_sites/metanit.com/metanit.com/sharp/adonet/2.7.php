...
<html >
<head>
<title>Типизация результатов SqlDataReader в ADO.NET и C#</title>
<meta charset="utf-8" />
<meta name="description" content="Типизация результатов SqlDataReader для выборки из базы данных MS SQL Server в ADO.NET и C#">
...
<h2>Типизация результатов SqlDataReader</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/adonetcore/">по ADO.NET и работе с базами данных в .NET 6</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>В прошлой теме для получения результатов SqlDataReader использовался метод <code>GetValue</code>, который возвращал значение определенного столбца 
...
изменим код программы следующим образом:</p>
<pre class="brush:c#;">
...
<tr><td><p>image и long varbinary</p></td><td><p>Byte[]</p></td><td><p>GetBytes и GetStream</p></td></tr>
...
<tr><td><p>smallint</p></td><td><p>Intl6</p></td><td><p>GetIntl6</p></td></tr>
<tr><td><p>smallmoney</p></td><td><p>Decimal</p></td><td><p>GetDecimal</p></td></tr>
<tr><td><p>sql variant</p></td><td><p>Object</p></td><td><p>GetValue</p></td></tr>
<tr><td><p>long varchar</p></td><td><p>String и Char[]</p></td><td><p>GetString и GetChars</p></td></tr>
