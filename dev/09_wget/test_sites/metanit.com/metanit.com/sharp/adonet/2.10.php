...
<html >
<head>
<title>Выходные параметры запросов в MS SQL Server и C#</title>
<meta charset="utf-8" />
<meta name="description" content="Использование выходных параметров для получения результатов запросов к базе данных MS SQL Server в ADO.NET и C#">
...
<h2>Выходные параметры запросов</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/adonetcore/">по ADO.NET и работе с базами данных в .NET 6</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Параметры, которые используются в командах, могут быть нескольких типов. Тип параметра задается с помощью свойства <code>Direction</code> 
объкта SqlParameter. Данное свойство принимает одно из значений перечисления <span class="b">ParameterDirection</span>:</p>
<ul>
...
Для определения параметра используются его свойства. <code>ParameterName</code> задает имя параметра, <code>SqlDbType</code> указывает на тип параметра, 
...
<pre class="brush:c#;">Console.WriteLine("Id нового объекта: {0}", idParam.Value);</pre>
