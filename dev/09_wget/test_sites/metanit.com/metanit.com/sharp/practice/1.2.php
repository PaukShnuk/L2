...
<html >
<head>
<title>Упражнения по C# | Циклы</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и упражнения по теме Циклы в C#">
...
<h2>Циклы</h2><div class="date">Последнее обновление: 11.07.2018</div>
...
<p>Для вычисления суммы с учетом процентов используйте цикл <span class="b">for</span>. 
Для ввода суммы вклада используйте выражение <code>Convert.ToDecimal(Console.ReadLine())</code> (сумма вклада будет представлять тип decimal).</p>
</div>
<div class="answer">
...
<p>Напишите программу, в которую пользователь вводит два числа и выводит результат их умножения. При этом 
программа должны запрашивать у пользователя ввод чисел, пока оба вводимых числа не окажутся в диапазоне от 0 до 10. 
...
и повторно запросить у пользователя ввод двух чисел. Если введенные числа принадлежат диапазону от 0 до 10, то программа выводит результат умножения.</p>
<p>Для организации ввода чисел используйте бесконечный цикл while и оператор break.</p>
</div>
<div class="answer">
...
<div class="nav"><p><a href="1.1.php">Назад</a><a href="./">Содержание</a><a href="2.4.php">Вперед</a></p></div></div>
<div class="socBlock">
