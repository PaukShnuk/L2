...
<html >
<head>
<title>Упражнения по C# | Массивы</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и упражнения по теме Массивы в C#">
...
<h2>Массивы</h2><div class="date">Последнее обновление: 28.01.2020</div>
...
<p>Задан следующий трехмерный массив:</p>
<pre class="brush:c#;">
int[,,] mas = { { { 1, 2 },{ 3, 4 } }, 
				{ { 4, 5 }, { 6, 7 } }, 
				{ { 7, 8 }, { 9, 10 } }, 
...
<p>С помощью циклов переберите все элементы этого массива и выведите их на консоль в следующем виде:</p>
<div class="console">
...
<div class="nav"><p><a href="1.2.php">Назад</a><a href="./">Содержание</a><a href="2.4.php">Вперед</a></p></div></div>
<div class="socBlock">
