...
<html >
<head>
<title>Упражнения по C# | Перегрузка операторов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и упражнения по теме Перегрузка операторов в C#">
...
<p>Есть класс State, который представляет государство:</p>
<pre class="brush:c#;">
class State
{
...
<p>Добавьте в класс оператор сложения, который бы позволял объединять государства. А также операторы сравнения &lt; и &gt; для сравнения 
государств по какому-нибудь критерию (например, по населению или территории). Наподобие </p>
<pre class="brush:c#;">
...
<p>Как известно, неотъемлемыми компонентами бутерброда являются хлеб и масло. Допустим, у нас есть следующие классы:</p>
<pre class="brush:c#;">
// хлеб
class Bread
{
...
<p>Добавьте в один из классов оператор сложения, чтобы при объединении хлеба и масла получался бутерброд, и, тем самым, 
компилировался и выполнялся без ошибок следующий код:</p>
<pre class="brush:c#;">
...
<div class="nav"><p><a href="1.2.php">Назад</a><a href="./">Содержание</a><a href="2.3.php">Вперед</a></p></div></div>
<div class="socBlock">
