...
<html >
<head>
<title>Упражнения по C# | Обобщения</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка знаний и упражнения по теме Обобщения в C#">
...
<h2>Обобщения</h2><div class="date">Последнее обновление: 30.07.2018</div>
...
<p>Что неправильно в следующем коде? Исправьте его:</p>
<pre class="brush:c#;">
...
<p>Мы не можем использовать конструктор для создания объекта типа T. Если нам нужно создать значение по умолчанию, то для этого необходимо 
использовать оператор <span class="b">default</span>:</p>
<pre class="brush:c#;">
class Instantiator&lt;T&gt;
{
	public T instance;
...
<p>Напишите обобщенный класс, который может хранить в массиве объекты любого типа. Кроме того, данный класс должен 
иметь методы для добавления данных в массив, удаления из массива, получения элемента из массива по индексу и метод, возвращающий длину массива.</p>
<p>Для упрощения работы можно пересоздавать массив при каждой операции добавления и удаления</p>
</div>
<div class="answer">
...
<div class="nav"><p><a href="2.2.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
