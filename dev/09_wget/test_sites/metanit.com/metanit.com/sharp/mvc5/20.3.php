...
<html >
<head>
<title>Профили кэширования в ASP.NET MVC</title>
<meta charset="utf-8" />
...
<h2>Профили кэширования</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Альтернативу определения параметров в атрибуте OutputCache представляет использование профилей кэширования. Определим свой профиль. Для этого перейдем к файлу 
конфигурации <i>web.config</i> и добавим в пределах узла <code>system.web</code> следующий узел <code>caching</code>:</p>
<pre class="brush:xml;">
...
<p>Узел <code>caching</code> определяет конфигурации профилей кэширования. Во вложенном узле <code>outputCacheProfiles</code> можно задать набор профилей. 
...
OutputCache.</p>
<p>И чтобы применить профиль, изменим атрибут OutputCache следующим образом:</p>
<pre class="brush:c#;">
...
<p>Параметр <code>CacheProfile</code> указывает на профиль, который определен в файле web.config.</p>
