...
<html >
<head>
<title>Основы валидации в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
<span class="ii">MVC 5 Controller with views, using Entity Framework</span>, а в качестве класса модели укажем нашу модель Book, а в качестве контекста 
данных = BookContext:</p>
...
<ol>
	...
	<pre class="brush:xml;">
		...
		<li><p>Чтобы настроить стиль отображения на стороне клиента, в файле Site.css по умолчанию указан стиль для соответствующих классов:</p>
		<pre class="brush:xml;">
...
<p>С помощью свойства <span class="bb">ModelState.IsValid</span> мы узнаем, проходит модель валидацию или нет, и зависимости от результата совершаем те или 
иные действия.</p></li>	
</ol>
