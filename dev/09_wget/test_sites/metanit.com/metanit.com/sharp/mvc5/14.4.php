...
<html >
<head>
<title>ASP.NET MVC 5 | Работа с формами в Bootstrap</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с формами в Bootstrap в ASP.NET MVC 5">
...
<h2>Работа с формами в Bootstrap</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Кроме отдельных компонентов Bootstrap поддерживает также работу с формами как с единым целым. Если мы возьмем стандартное представление для регистрации Register.cshtml, 
то мы увидим, что к элементам формы уже применяют классы Bootstrap:</p>
<pre class="brush:xml;">
@{
...
<p>К форме по умолчанию добавляется класс <span class="bb">form-horizontal</span>, который устанавливает выравнивание меток label по правой стороне связанных 
элементов ввода:</p>
<img src="./pics/14.19.png" />
<p>Кроме того, элементы визуально отличаются от стандартных, так как к ним применяются стили из Bootstrap. Для стилизации элементов форм 
служит класс <span class="bb">form-control</span>. Здесь также используется класс <span class="bb">form-group</span>, который задает 
расстояние между элементами форм.</p>
<p>Кроме <code>form-horizontal</code> мы можем применить к форме другой класс: <span class="bb">form-inline</span>, который выстраивает все элементы в линию. Например:</p>
<pre class="brush:xml;">
...
<img src="./pics/14.20.png" />
<p>И в заключение разговора о формах следует сказать, что при использовании шаблонов формирования, когда Visual Studio автоматически генерирует вам 
разметку для представлений для создания и редактирования моделей, а создаваемые автоматически формы уже применяют классы Bootstrap, поэтому вам не придется вручную 
добавлять к ним вышеописанные классы.</p>
