...
<html >
<head>
<title>Шаблонные хелперы в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
<p>Кроме базовых html-хелперов, рассмотренных в прошлой главе и генерирующих определенные элементы разметки html, фреймворк ASP.NET MVC 
также имеет <span class="bb">шаблонные (или шаблонизированные) хелперы</span>. В отличие от рассмотренных в прошлой главе html-хелперов они не генерируют 
...
<li><p><span class="bb">DisplayTextFor</span></p>
...
<p>Например, определим в контроллере некоторое действие BookView, которое по id будет выводить информацию об определенной книге: </p>
<pre class="brush:xml;">
@{
