...
<html >
<head>
<title>Работа с моделями многие-ко-многим в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
этот массив и будут помещаться все значения всех отмеченных на форме флажков. В самом методе после прохождения валидации мы устанавливаем новые значения свойств модели.</p>
<p>Затем нам надо установить в коллекции Courses у студента все отмеченные курсы. Для этого проходим по всем курсам из базы данных, и если они были 
