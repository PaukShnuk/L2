...
<html >
<head>
<title>ASP.NET MVC 5 | Загрузка файла через AJAX в MVC и Web API</title>
<meta charset="utf-8" />
...
<h2>Загрузка файла через AJAX в ASP.NET MVC и Web API</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 1.11.2015</div>
...
<img src="loading_spinner.gif" alt="gif-анимация" />
...
<P>В представлении все то же самое, только данные получаем не в виде частичного представления, а в виде объектов javascript.</P>
...
<div class="nav"><p><a href="./24.11.php">Назад</a><a href="./">Содержание</a><a href="./24.13.php">Вперед</a></p></div></div>
<div class="socBlock">
