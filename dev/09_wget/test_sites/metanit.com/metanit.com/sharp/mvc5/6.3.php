...
<html >
<head>
<title>Создание ограничений для маршрутов в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
<p>С помощью параметра <code>constraints</code> устанавливаются ограничения маршрута. И если мы направим приложению запрос <span class="ii">Book/Index</span>, 
...
<p>Ограничение маршрута применяет этот интерфейс IRouteConstraint. Это вынуждает движок маршрутизации вызвать для ограничения маршрута метод 
