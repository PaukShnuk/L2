...
<html >
<head>
<title>AJAX-ссылки в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
<p>Другим часто используемым AJAX-хелпером является <span class="bb">Ajax.ActionLink</span>. Он во многом похож на хелпер Ajax.BeginForm за тем исключением, что генерирует специальные 
...
<p>В итоге все авторы, передаваемые в представление через ViewBag (например, так: 
<code>ViewBag.Authors = db.Books.Select(s =&gt; s.Author).Distinct();</code>), выводятся в виде ссылок внизу страницы. 
А нажатие на одну из этих ссылок будет иметь то же действие, что и поиск по кнопке:</p>
<img src="./pics/10.13.png" />
