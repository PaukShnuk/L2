...
<html >
<head>
<title>ASP.NET MVC 5 | Ajax-Формы</title>
<meta charset="utf-8" />
...
загрузку данных в <span class="b">асинхронном режиме</span>, что несомненно повышает производительность приложения.</p>
<p>Допустим, у нас в базе данных хранятся объекты следующей модели Book:</p>
<pre class="brush:c#;">
public class Book
{
...
<p>Хелпер <span class="bb">Ajax.BeginForm</span> похож на хелпер <code>Html.BeginForm</code> - он также создает элемент <code>form</code>, который используется 
...
<p>Второй параметр более интересный. Он представляет объект <span class="bb">AjaxOptions</span>, который влияет на отображение результатов. Он принимает ряд параметров, 
...
на странице будет обновляться элемент с id <code>results</code>: в него будет загружаться html-код частичного представления.</p>
<p>Теперь мы можем запустить приложение и осуществить поиск с помощью AJAX:</p>
<img src="./pics/10.4.png" />
<img src="./pics/10.5.png" />
