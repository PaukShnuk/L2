...
<html >
<head>
<title>Модели со связью многие-ко-многим в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
по конкретной дисциплине, так и вести учет различных дисциплин для конкретного студента. Попробуем смоделировать данную ситуацию в приложении ASP.NET MVC 5.</p>
<p>Во-первых, создадим новый проект. Первым делом нам надо создать модели. Итак, у нас есть две модели - студент и курс университетской дисциплины. Сначала добавим модель Student со следующим содержанием:</p>
<pre class="brush:c#;">
