...
<html >
<head>
<title>Отображение ошибок валидации в ASP.NET MVC 5</title>
<meta charset="utf-8" />
...
не жестко установлено, и мы все это можем изменить. В файле стилей <span class="bb">Site.css</span>  мы можем найти 
секцию, которая как раз и отвечает за стилизацию:</p>
<pre class="brush:xml;">
