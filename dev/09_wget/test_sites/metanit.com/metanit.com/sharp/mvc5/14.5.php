...
<h2>Работа с таблицами</h2><p style="color:red;">Данное руководство устарело. Актуальное руководство: <a href="https://metanit.com/sharp/aspnet5/">Руководство по ASP.NET Core</a></p><div class="date">Последнее обновление: 31.10.2015</div>
...
<p>Для оформления таблиц в Bootstrap предназначен класс <span class="bb">table</span>. Например, пусть у нас есть такая таблица:</p>
<pre class="brush:xml;">
&lt;div class="row"&gt;
    &lt;div class="col-md-6"&gt;
        &lt;table class="table"&gt;
...
<p>Тогда применение класса table будет давать следующий вывод:</p>
<img src="./pics/14.21.png" />
<p>Кроме этого класса мы можем использовать в дополнение к нему еще ряд классов. Например, класс <span class="bb">table-striped</span> позволяет 
выделить четные и нечетные строки в таблице:</p>
<pre class="brush:xml;">
...
<img src="./pics/14.22.png" />
<p>Класс <span class="bb">table-bordered</span> создает границы для таблицы и ее ячеек, а класс <span class="bb">table-hover</span> позволяет выделять 
строку при наведении на нее курсором:</p>
<pre class="brush:xml;">
...
<img src="./pics/14.23.png" />
<p>Итак, мы рассмотрели только небольшую часть возможностей, которые предлагает Bootstrap. Но вне сомнения то, что использование данного 
фреймворка позволяет быстрее создавать адаптивные веб-приложения и расширяет арсенал веб-разработчика.</p>
...
<div class="nav"><p><a href="./14.4.php">Назад</a><a href="./">Содержание</a><a href="./14.6.php">Вперед</a></p></div></div>
<div class="socBlock">
