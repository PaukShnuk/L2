...
<html >
<head>
<title>Swift | Вложенные типы</title>
<meta charset="utf-8" />
<meta name="description" content="Вложенные типы (nested types) в языке программирования Swift, определение вложенных структур и классов, их использование">
...
<h2>Вложенные типы</h2><div class="date">Последнее обновление: 04.01.2018</div>
...
<p>Типы могут быть вложенными (nested). Класс или структура может содержать определение другого класса или структуры. Например:</p>
...
<p>Здесь структура UserProfile является вложенной. Вложенные типы также могут определять свойства, методы, инициализаторы. 
А внешний тип может хранить объект вложенного типа.</p>
<p>Также вложенные типы могут использовать вне своего типа, в котором они определены. В этом случае к ним необходимо обращаться 
через имя внешнего типа:</p>
<pre class="brush:swift;">
