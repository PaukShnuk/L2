...
<html >
<head>
<title>Swift | Вложенные и рекурсивные функции</title>
<meta charset="utf-8" />
<meta name="description" content="Рекурсивные функции в языке программирования Swift, функция вычисления факториала и чисел фиббоначчи, вложенные функции (nested functions)">
...
<h2>Вложенные и рекурсивные функции</h2><div class="date">Последнее обновление: 01.01.2018</div>
...
<p>Одни функции могут содержать другие функции. Вложенные функции еще называются локальными. Локальная функция доступна только 
в рамках той функции, внутри которой она определена. Как правило, локальная функция оформляет блок действий, 
которые могут многократно использоваться в рамках внешней функций, но вне этой внешней функции больше нигде не используются.</p>
<p>Например, определим функцию, которая вычисляет разницу площадей двух окружностей:</p>
...
<p>И чтобы не писать повторно один и тот же код для каждой окружности, можно определить одну функцию и затем многократно ее вызывать. 
И если не планируется использовать эту функцию в других частях программы вне функции compare, то ее можно определить как локальную.</p>
<h3>Рекурсивные функции</h3>
<p>Рекурсивные функции представляют особые функции, которые могут вызывать сами себя. Традиционным примером подобных функций служат функции вычисления 
факториала и чисел Фибоначчи. Например, функция факториала:</p>
<pre class="brush:swift;">
...
<p>Здесь функция факториала возвращает 1, если переданное в функцию число равно 0. Иначе функция вызывает саму себя.</p>
<p>Другой пример - функция вычисления чисел Фибоначчи:</p>
<pre class="brush:swift;">
...
<div class="nav"><p><a href="2.16.php">Назад</a><a href="./">Содержание</a><a href="2.21.php">Вперед</a></p></div></div>
<div class="socBlock">
