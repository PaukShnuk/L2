...
<html >
<head>
<title>Python | Checkbutton</title>
<meta charset="utf-8" />
<meta name="description" content="Виджет Checkbutton в tkinter и Python, его параметры, отслеживание измненения его состояния">
...
<h2>Checkbutton</h2><div class="date">Последнее обновление: 13.05.2017</div>
...
<p>Элемент <span class="b">Checkbutton</span> представляет собой флажок, который может находиться в двух состояниях: отмеченном и неотмеченном.</p>
<p>Создадим простейший флажок:</p>
<pre class="brush:py;">
from tkinter import *
...
<p>Отличительной чертой Checkbutton является возможность привязки к компоненту IntVar через параметр <span class="b">variable</span>. В отмеченном состоянии 
привязанный компонент IntVar имеет значение 1, а в неотмеченном - 0. В итоге через IntVar мы можем получать значение, указанное пользователем.</p>
<img src="./pics/9.15.png" alt="Checkbutton в tkinter и Python" />
<p>Конструктор Checkbutton принимает ряд параметров, с помощью которого можно настроить отображение флажков:</p>
<pre class="brush:py;">Checkbutton(master, options)</pre>
<p>Параметр master представляет ссылку на родительское окно, а параметр options представляет набор следующих параметров:</p>
<ul>
<li><p><span class="b">activebackground</span>: фоновый цвет флажка в нажатом состоянии<p></li>
<li><p><span class="b">activeforeground</span>: цвет текста флажка в нажатом состоянии<p></li>
<li><p><span class="b">bg</span>: фоновый цвет флажка<p></li>
<li><p><span class="b">bitmap</span>: монохромное изображение для флажка<p></li>
<li><p><span class="b">bd</span>: граница вокруг флажка<p></li>
<li><p><span class="b">command</span>: ссылка на функцию, которая вызывается при нажатии на флажок<p></li>
<li><p><span class="b">cursor</span>: курсор при наведении на элемент<p></li>
<li><p><span class="b">disabledforeground</span>: цвет текста в состоянии DISABLED<p></li>
...
<li><p><span class="b">offvalue</span>: значение ассоциированной с флажком переменной IntVar в неотмеченном состоянии, по умолчанию равно 0<p></li>
<li><p><span class="b">onvalue</span>: значение ассоциированной с флажком переменной IntVar в отмеченном состоянии, по умолчанию равно 1<p></li>
<li><p><span class="b">padx</span>: отступы справа и слева от текста до границы флажка<p></li>
<li><p><span class="b">pady</span>: отступы сверху и снизу от текста до границы флажка<p></li>
<li><p><span class="b">relief</span>: стиль флажка, по умолчанию имеет значение FLAT<p></li>
<li><p><span class="b">selectcolor</span>: цвет квадратика флажка<p></li>
<li><p><span class="b">selectimage</span>: изображение на флажке, когда он находится в отмеченном состоянии<p></li>
...
<li><p><span class="b">underline</span>: индекс подчеркнутого символа в тексте флажка<p></li>
<li><p><span class="b">variable</span>: ссылка на переменную, как правило, типа IntVar, которая хранит состояние флажка<p></li>
...
<p>Используем некоторые из этих параметров:</p>
<pre class="brush:py;">
from tkinter import *
...
<img src="./pics/9.16.png" alt="checkbox in tkinter and Python" />
...
<div class="nav"><p><a href="9.6.php">Назад</a><a href="./">Содержание</a><a href="9.8.php">Вперед</a></p></div></div>
<div class="socBlock">
