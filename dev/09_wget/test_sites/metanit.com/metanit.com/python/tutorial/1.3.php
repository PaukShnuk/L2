...
<html >
<head>
<title>Python | Первая программа в PyCharm</title>
<meta charset="utf-8" />
<meta name="description" content="Первая программа на Python в среде программирования PyCharm, установка и настройка IDE">
...
<h2>Первая программа в PyCharm</h2><div class="date">Последнее обновление: 05.01.2022</div>
...
<p>В прошлой теме было описано создание простейшего скрипта на языке Python. Для создания скрипта использовался текстовый редактор. В моем случае это был 
Notepad++. Но есть и другой способ создания программ, который представляет использование различных интегрированных сред разработки или IDE.</p>
<p>IDE предоставляют нам текстовый редактор для набора кода, но в отличие от стандартных текстовых редакторов, IDE также обеспечивает 
полноценную подсветку синтаксиса, автодополнение или интеллектуальную подсказку кода, возможность тут же выполнить созданный скрипт, а также многое другое.</p>
<p>Для Python можно использовать различные среды разработки, но одной из самых популярных из них является среда <span class="b">PyCharm</span>, созданная 
компанией JetBrains. Эта среда динамично развивается, постоянно обновляется и доступна для наиболее распространенных операционных систем - Windows, MacOS, Linux.</p>
<p>Правда, она имеет одно важное ограничение. А именно она доступна в двух основных вариантах: платный выпуск Professional и бесплатный Community. 
Многие базовые возможности доступны и в бесплатном выпуске Community. В то же время ряд возможностей, например, веб-разработка, доступны только в платном Professional.</p>
<p>В нашем случае воспользуемся бесплатным выпуском Community. Для этого перейдем на 
<a href="https://www.jetbrains.com/pycharm/download/#section=windows" rel="nofollow">страницу загрузки</a> и загрузим установочный файл PyCharm Community.</p>

<img src="./pics/pycharm8.png" alt="IDE PyCharm" />

<p>После загрузки выполним его установку.</p>
<img src="./pics/pycharm9.png" alt="Установка PyCharm" />
<p>После завершения установки запустим программу. При первом запуске открывается начальное окно:</p>
<img src="./pics/pycharm1.png" alt="Первая программа в PyCharm" />
<p>Создадим проект и для этого выберем пункт <span class="b">New Project</span>.</p>
<p>Далее нам откроется окно для настройки проекта. В поле <span class="b">Location</span> необходимо указать путь к проекту. В моем случае проект будет помещаться в папку HelloApp. Собственно название папки и будет названием проекта.</p>
<img src="./pics/pycharm2.png" alt="Настройка проекта в PyCharm" />
<p>Кроме пути к проекту все остальные настройки оставим <span class="b">по умолчанию</span> и нажмем на кнопку Create для создания проекта.</p>
<p>После этого будет создан пустой проект:</p>
<img src="./pics/pycharm3.png" alt="Первый проект в PyCharm" />
<p>В центре среды будет открыт файл <span class="b">main.py</span> с некоторым содержимым по умолчанию.</p>
<p>Теперь создадим простейшую программу. Для этого изменим код файла <span class="b">main.py</span> следующим образом:</p>
<pre class="brush:py;">
name = input("Введите ваше имя: ")
print("Привет,", name)
</pre>
<p>Для запуска скрипта нажмем на зеленую стрелку в панели инструментов программы:</p>
<img src="./pics/pycharm6.png" alt="Запуск программы в PyCharm" />
<p>Также для запуска можно перейти в меню <span class="b">Run</span> и там нажать на подпункт <span class="b">Run 'main'</span>)</p>
<p>После этого внизу IDE отобразится окно вывода, где надо будет ввести имя и где после этого будет выведено приветствие:</p>
<img src="./pics/pycharm7.png" alt="Запуск программы Python в PyCharm" />
