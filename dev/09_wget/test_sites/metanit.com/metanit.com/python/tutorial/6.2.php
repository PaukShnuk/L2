...
<html >
<head>
<title>Python | Модуль math</title>
<meta charset="utf-8" />
<meta name="description" content="Модуль math в Python, основные арифметические, тригонометрические и логарифмические операции, вычисление логарифмов, косинуса и синуса, округление чисел">
...
<h2>Модуль math</h2><div class="date">Последнее обновление: 04.02.2022</div>
...
<p>Встроенный модуль <span class="b">math</span> в Python предоставляет набор функций для выполнения математических, тригонометрических и 
логарифмических операций. Некоторые из основных функций модуля:</p>
<ul>
<li><p><span class="b">pow(num, power)</span>: возведение числа num в степень power</p></li>
<li><p><span class="b">sqrt(num)</span>: квадратный корень числа num</p></li>
<li><p><span class="b">ceil(num)</span>: округление числа до ближайшего наибольшего целого</p></li>
<li><p><span class="b">floor(num)</span>: округление числа до ближайшего наименьшего целого</p></li>
<li><p><span class="b">factorial(num)</span>: факториал числа</p></li>
<li><p><span class="b">degrees(rad)</span>: перевод из радиан в градусы</p></li>
<li><p><span class="b">radians(grad)</span>: перевод из градусов в радианы</p></li>
<li><p><span class="b">cos(rad)</span>: косинус угла в радианах</p></li>
<li><p><span class="b">sin(rad)</span>: синус угла в радианах</p></li>
<li><p><span class="b">tan(rad)</span>: тангенс угла в радианах</p></li>
<li><p><span class="b">acos(rad)</span>: арккосинус угла в радианах</p></li>
<li><p><span class="b">asin(rad)</span>: арксинус угла в радианах</p></li>
<li><p><span class="b">atan(rad)</span>: арктангенс угла в радианах</p></li>
<li><p><span class="b">log(n, base)</span>: логарифм числа n по основанию base</p></li>
<li><p><span class="b">log10(n)</span>: десятичный логарифм числа n</p></li>
</ul>
<p>Пример применения некоторых функций:</p>
<pre class="brush:py;">
import math
...
<p>Также модуль math предоставляет ряд встроенных констант, такие как PI и E:</p>
<pre class="brush:py;">
import math
radius = 30
