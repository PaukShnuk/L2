...
<html >
<head>
<title>Python | Установка и первая программа на Mac OS</title>
<meta charset="utf-8" />
<meta name="description" content="Установка Python и первая программа на Mac OS, запуск интерпретатора, создание скрипта">
...
<h2>Установка и первая программа на Mac OS</h2><div class="date">Последнее обновление: 22.03.2022</div>
...
<img src="./pics/macos3.png" alt="Установка Python на MacOS" />
<p>Если текущая ОС - Mac OS, то по адресу <a href="https://www.python.org/downloads/" rel="nofollow">https://www.python.org/downloads/</a> будет предложено загрузить графический установщик для MacOS:</p>
<img src="./pics/macos1.png" alt="Установка Python на MacOS" />
<p>При работе на Mac OS стоит учитывать, что данная ОС уже по умолчанию может содержать установку Python более ранних версих - 2.х. В этом случае 
для обращения к python2.х  в консоли применяется команда <span class="b">python</span>, а для обращения к python 3.x - команда <span class="b">python3</span> - с 
тройкой на конце:</p>
<img src="./pics/macos2.png" alt="Проверка установки Python на MacOS" />
<h3>Первая программа</h3>
<p>Сначала определим где-нибудь на жестком диске для скриптов папку <span class="b">python</span>. А в этой папке создадим новый текстовый файл, который 
...
<img src="./pics/macos4.png" alt="Python в Visual Studio code Mac OS" />
...
<p>Теперь запустим командную строку/терминал и с помощью команды cd перейдем к папке, где находится файл с исходным кодом hello.py (например, в моем случае это папка "/Users/eugene/Documents/python").</p>
<div class="console">
<pre class="consoletext">
cd /Users/eugene/Documents/python
</pre>
</div>
<p>Далее для выполнения скрипта hello.py передадим его интерпретатору python:</p>
<div class="console">
<pre class="consoletext">
python3 hello.py
</pre>
...
<img src="./pics/macos5.png" alt="Первое приложение на Python на MacOS" />
