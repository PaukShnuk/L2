...
<html >
<head>
<title>Python | Первая программа в Visual Studio</title>
<meta charset="utf-8" />
<meta name="description" content="Первая программа на Python в среде Visual Studio 2019">
...
<h2>Python в Visual Studio</h2><div class="date">Последнее обновление: 13.05.2017</div>
...
<p>Одной из сред разработки, которая позволяет работать с Python, является Visual Studio. Преимуществом данной IDE по сравнению, скажем, с PyCharm, 
следует отметить прежде всего то, что в ее бесплатной редакции VS 2019 Community бесплатно доступны ряд функций и возможностей, которые в том же PyCharm доступны только в платной версии Professional Edition. 
Например, это веб-разработка, в том числе с помощью различных фреймворков. В то же время средства ля разработки на Python в Visual Studo доступны пока только в версии для Windows.</p>
<p>Итак, загрузим установочный файл Visual Studio 2019 Community по ссылке <a href="https://visualstudio.microsoft.com/downloads/" rel="nofollow">https://visualstudio.microsoft.com/downloads/</a>. 
После запуска установочного файла выберем среди устанавливаемых опций Python:</p>
<img src="./pics/vs1.png" alt="Python в Visual Studio 2017" />
<p>После установки Visual Studio запустим ее. В меню выберем пунт <span class="b">File (Файл) -&gt; New (Создать) -&gt; Project (Проект)</span>, и 
перед нами откроется окно создания нового проекта. В этом окне в левом древовидном меню мы можем перейти к языку Python:</p>
<img src="./pics/vs2.png" alt="Создание проекта Python в Visual Studio 2017" />
<p>Выбрав слева Python, в центральной части окна мы можем увидеть богатую палитру типов проектов, которые мы можем создавать для разработке на данном языке 
...
случае выберем в качестве типа проекта <span class="b">Python Application</span>, то есть тип простых консольных приложений, и назовем новый проект 
HelloApp. Нажмем на кнопку OK, и Visual Studio создаст новый проект:</p>
<img src="./pics/vs3.png" alt="Первый проект на Python в Visual Studio 2017" />
<p>Справа в окне Solution Explorer (Обозреватель решений) можно увидеть структуру проекта. По умолчанию здесь мы можем увидеть следующие элементы:</p>
<ul>
<li><p><span class="b">Python Environments</span>: здесь можно увидеть все используемые среды, в частности, здесь можно найти сведения о компиляторе, который используется.</p></li>
<li><p><span class="b">References</span>: в этот узел помещаются все внешние зависимости, которые используются текущим проектом</p></li>
<li><p><span class="b">Search Paths</span>: этот узел позволяет указать пути поиска для модулей Python</p></li>
<li><p><span class="b">HelloApp.py</span>: собственно файл Python с исходным кодом</p></li>
</ul>
<p>По умолчанию в Visual Studio уже открыт файл HelloApp.py, но он пока пуст. Добавим в него следующую строку:</p>
<pre class="brush:py;">
print("Hello Python from Visual Studio!")
</pre>
<p>И затем в панели инструментов нажмем на зеленую стрелочку для запуска:</p>
<img src="./pics/vs4.png" alt="Запуск скрипта Python в Visual Studio" />
<p>В результате запуска отобразится консоль, которая выведет нужную строку:</p>
<img src="./pics/vs5.png" alt="Первое приложение на Python в Visual Studio" />
