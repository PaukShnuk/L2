...
<html >
<head>
<title>Python | Модуль random</title>
<meta charset="utf-8" />
<meta name="description" content="Модуль random и генерация случайных чисел в Python, работа со списком и возвращение случайного элемента списка">
...
<h2>Модуль random</h2><div class="date">Последнее обновление: 04.02.2022</div>
...
<p>Модуль random управляет генерацией случайных чисел. Его основные функции:</p>
<ul>
<li><p><span class="b">random()</span>: генерирует случайное число от 0.0 до 1.0</p></li>
<li><p><span class="b">randint()</span>: возвращает случайное число из определенного диапазона</p></li>
<li><p><span class="b">randrange()</span>: возвращает случайное число из определенного набора чисел</p></li>
<li><p><span class="b">shuffle()</span>: перемешивает список</p></li>
<li><p><span class="b">choice()</span>: возвращает случайный элемент списка</p></li>
</ul>
<p>Функция <span class="b">random()</span> возвращает случайное число с плавающей точкой в промежутке от 0.0 до 1.0. Если же нам необходимо число из большего диапазона, 
скажем от 0 до 100, то мы можем соответственно умножить результат функции random на 100.</p>
<pre class="brush:py;">
import random
...
<p>Функция <span class="b">randint(min, max)</span> возвращает случайное целое число в промежутке между двумя значениями min и max.</p>
<pre class="brush:py;">
import random
...
<p>Функция <span class="b">randrange()</span> возвращает случайное целое число из определенного набора чисел. Она имеет три формы:</p>
<ul>
<li><p><code>randrange(stop)</code>: в качестве набора чисел, из которых происходит извлечение случайного значения, будет использоваться диапазон от 0 до числа stop</p></li>
<li><p><code>randrange(start, stop)</code>: набор чисел представляет диапазон от числа start до числа stop</p></li>
<li><p><code>randrange(start, stop, step)</code>: набор чисел представляет диапазон от числа start до числа stop, при этом каждое число в диапазоне отличается от предыдущего на шаг step</p></li>
</ul>
<pre class="brush:py;">
import random
...
<p>Для работы со списками в модуле random определены две функции: функция <span class="b">shuffle()</span> перемешивает список случайным образом, а 
функция <span class="b">choice()</span> возвращает один случайный элемент из списка:</p>
<pre class="brush:py;">
...
<div class="nav"><p><a href="./2.10.php">Назад</a><a href="./">Содержание</a><a href="./6.2.php">Вперед</a></p></div></div>
<div class="socBlock">
