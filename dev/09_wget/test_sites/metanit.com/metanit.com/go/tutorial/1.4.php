...
<html >
<head>
<title>Go | Visual Studio Code</title>
<meta charset="utf-8" />
<meta name="description" content="Первая программа на языке программирования Go в текстовом редакторе Visual Studio Code">
...
<h2>Go в Visual Studio Code</h2><div class="date">Последнее обновление: 21.12.2017</div>
...
<p><span class="b">Visual Studio Code</span> представляет кроссплатформенный подвинутый легковесный текстовый редактор от компании Microsoft, который поддерживает подсветку синтаксиса, интеллектуальную 
подсказку для разных языков программирования и многое другое. Рассмотрим, как мы можем использовать данный текстовый редактор для разработки на языке Go.</p>
<p>Прежде всего установим данный текстовый редактор. Инсталлятор для нужной операционной системы (есть поддержка для Windows, Mac OS, Linux) 
можно найти по адресу <a href="https://code.visualstudio.com/" rel="nofollow">https://code.visualstudio.com/</a>.</p>
<p>После установки Visual Studio Code по умолчанию не имеет никакой поддержки языка Go. Поэтому необходимо установить соответствующее расширение. Для этого 
перейдем в Visual Studio Code в меню <span class="b">View</span> -&gt; <span class="b">Extensions</span></p>
<img src="pics/1.17.png" alt="GoLang в Visual Studio Code" />
<p>В строку поиска расширений введем "go", и нам отобразится список найденных расширений. Нам нужно установить первое в этом списке, которое имеет больше всего установок:</p>
<img src="pics/1.18.png" alt="Расширение языка Go для Visual Studio Code" />
<p>После установки расширения определим на жестком диске папку для хранения файлов проекта и откроем эту папку в Visual Studio Code. Открыть папку 
можно через пункт меню <span class="b">File</span> -&gt; <span class="b">Open Folder</span>. Затем создадим в VS Code новый файл, который назовем <span class="b">main.go</span>:</p>
<img src="pics/1.19.png" alt="Первый проект на языке Go в Visual Studio Code" />
<p>Откроем файл main.go и введем в него следующий код:</p>
<pre class="brush:go;">
package main
...
<p>Сохраним введенный код, нажав на комбинацию Ctrl+S.</p>
<img src="pics/1.20.png" />
<p>При работе с файлами go в VS Code могут появляться различные сообщения о необходимости установки дополнительных плагинов. Например, внизу окна в 
...
доустановить. Для их установки надо нажать на кнопку Install.</p>
<p>Преимуществом VS Code является то, что этот редактор имеет встроенный терминал. Откроем терминал через пункт меню <span class="b">View</span> -&gt; 
<span class="b">Integrated Terminal</span>. После этого внизу VS Code откроется встроенный терминал. По умолчанию в нем открывается текущая папка проекта.</p>
<p>Введем в терминал следующую команду и нажмем Enter:</p>
<div class="console"><pre class="consoletext">go run main.go</pre></div>
<p>После этого во встроенном терминале мы увидим вывод программы:</p>
<img src="pics/1.21.png" alt="Запуск программы на Go в Visual Studio Code" />
