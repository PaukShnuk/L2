...
<html >
<head>
<title>Go | Полиморфизм</title>
<meta charset="utf-8" />
<meta name="description" content="Полиморфизм в языке программирования Go, многообразие форм, структуры и интерфейсы">
...
<h2>Полиморфизм</h2><div class="date">Последнее обновление: 06.01.2018</div>
...
<p>Полиморфизм представляет способность принимать многообразные формы. В частности, в предыдущих статьях было рассмотрено использование интерфейсов, 
которым могут соответствовать различные структуры. Например:</p>
<pre class="brush:go;">
package main
import "fmt"
...
<p>В данном случае определен массив vehicles, который содержит набор структур, которые соответствуют интерфейсу Vehicle, то есть объекты Car и Aircraft. 
