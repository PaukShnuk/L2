...
<html >
<head>
<title>Go | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования Go, операции отношения и логические операции, проверка условия, true, false">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 18.12.2017</div>
...
<p>Условные выражения представляют логические операции и операции отношения. Они представляют некоторое условие и возвращают значение типа bool: 
<code>true</code> (если условие истинно) или <code>false</code> (если условие ложно).</p>
<h3>Операции отношения</h3>
<p>Операции отношения позволяют сравнить два значения. В языке Go есть следующие операции отношения:</p>
<ul>
<li>
...
<p>Логические операции сравнивают два условия. Как правило, они применяются к отношениям и объединяют несколько операций отношения. К логическим операциям относят следующие:</p>
<ul>
<li>
<p><span class="b">!</span> (операция отрицания)</p>
<p>Инвертирует значение. Если операнд равен true, то возвращает false, иначе возвращает true.</p>
<pre class="brush:go;">
var a bool = true
var b bool = !a		//false
var c bool = !b		// true
...
<pre class="brush:go;">
var b bool = 4 &gt; 5 &amp;&amp 6 &gt; 8		//false
var c bool = 3 &lt;= 5 &amp;&amp; 10 &gt; 8	// true
</pre>
</li>
<li>
<p><span class="b">||</span> (дизъюнкция, логическое сложение)</p>
<p>Возвращает true, если хотя бы один операнд не равен false. Возвращает false, если оба операнда равны false.</p>
<pre class="brush:go;">
