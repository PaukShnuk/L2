...
<html >
<head>
<title>Go | Стандартные потоки ввода-вывода и io.Copy</title>
<meta charset="utf-8" />
<meta name="description" content="Стандартные потоки ввода-вывода os.Stdout и os.Stdin в языке программирования Go, чтение и запись с консоли, копирование данных из одного потока в другой с помощью функции io.Copy">
...
<h2>Стандартные потоки ввода-вывода и io.Copy</h2><div class="date">Последнее обновление: 15.01.2018</div>
...
<p>Пакет <span class="b">os</span> определяет три переменных: <span class="b">os.Stdin</span>, <span class="b">os.Stdout</span> и <span class="b">os.Stderr</span>, 
которые представляют стандартные потоки ввода, вывода и вывода ошибок соответственно. Так, стандартный поток вывода <span class="b">os.Stdout</span> представляет 
вывод информации на консоль.</p>
<p>Например, мы можем использовать функцию <span class="b">io.Copy()</span> для копирования данных из одного потока в другой:</p>
<pre class="brush:go;">n, err = io.Copy(io.Writer, io.Reader)</pre>
<p>Эта функция упрощает копирование данных из объекта <code>io.Reader</code> в объект <code>io.Writer</code>. В качестве результата функция возвращает количество 
скопированных файлов и информацию об ошибке.</p>
<p>И при выводе из файла текстовой информации на консоль гораздо проще передать данные из файлового потока в 
os.Stdout, через выводить данные отдельными порциями:</p>
<pre class="brush:go;">
package main
import (
	"fmt"
