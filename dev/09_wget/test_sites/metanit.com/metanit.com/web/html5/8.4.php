...
<html >
<head>
<title>HTML5 | Выравнивание столбцов по высоте</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание колонок по высоте в HTML 5, помещение блоков в контейнер для выравивания их высоты">
...
<h2>Выравнивание столбцов по высоте</h2><div class="date">Последнее обновление: 24.04.2016</div>
...
<p>При блочной верстке мы можем столкнуться с проблемой высоты с столбцов, которая может особенно сильно проявиться, если плавающие блоки имеют определенный фон. 
Рассмотрим проблему на примере:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Здесь уже установлено обтекание, и оно прекрасно работает, вот только в зависимости от количества содержимого одна колонка может быть больше другой:</p>
<img src="pics/7.9.png" alt="Обтекание элементов с фоном в HTML5 и CSS3" />
<p>В данном случае, если в главном блоке много текста, то блок с меню имеет недостаточную длину.</p>
<p>Наиболее распространенным решением данной проблемы является оборачивание плавающего элемента и блока, его обтекающего, в отдельный элемент, у которого устанавливается фон. 
Затем этот фон используется наименьшим по длине блоком. В итоге получается иллюзия, что блоки имеют равную длину, а фон у блоков установлен корректно.</p>
<p>Так, изменим выше созданную страницу следующим образом:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/7.10.png" alt="Установка равной высоты обтекающих элементов в HTML5 и CSS3" />
<p>В данном случае плавающий блок menu и обтекающий его блок main обертываются в один элемент wrapper, в котором устанавливается фон для элемента menu. 
А элемент main, как наибольший элемент, может использовать собственную установку фона.</p>
