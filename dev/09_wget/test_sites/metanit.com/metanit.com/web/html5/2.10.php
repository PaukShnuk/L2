...
<html >
<head>
<title>HTML5 | Элементы figure и figcaption</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы figure и figcaption в HTML5, создание заголовков и аннотаций к изображениям">
...
<h2>Элементы figure и figcaption</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <span class="b">figure</span> применяется для аннотации различных иллюстраций, диаграмм, фотографий и т.д. А элемент 
<span class="b">figcaption</span> просто обертывает заголовок для содержимого внутри элемента figure.</p>
<p>Для использования элемента figure нам надо поместить в него некоторое содержимое, например, изображение:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.34.png" alt="Figure и figcaption в HTML5" />
