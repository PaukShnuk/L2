...
<html >
<head>
<title>HTML5 | Рисование текста на Canvas</title>
<meta charset="utf-8" />
<meta name="description" content="Рисование текста на Canvas в HTML5, определение шрифта, метод fillText">
...
<h2>Рисование текста</h2><div class="date">Последнее обновление: 02.05.2016</div>
...
<p>Наряду с геометрическими фигурами и изображениями canvas позволяет выводить текст. Доля этого вначале надо установить у контекста canvas свойство <span class="b">font</span>:</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
context.font = "22px Verdana";
</pre>
<p>Свойство <code>font</code> в качестве значения принимает опредление шрифта. В данном случае это шрифт Verdana высотой 22 пикселя. В качестве шрифтов используются 
стандартные шрифты.</p>
<p>Далее мы можем вывести некоторый текст с помощью метода <span class="b">fillText()</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/6.8.png" alt="Текст на canvas в HTML5" />
<p>Метод <code>fillText(text, x, y)</code> принимает три параметра: выводимый текст и x и y координаты точки, с которой выводится текст.</p>
<p>Для вывода текста можно также применять метод <span class="b">strokeText()</span>, который создает границу для выводимых символов:</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
...
<img src="pics/6.10.png" alt="strokeText на canvas в HTML5" />
<h3>Свойство textAlign</h3>
<p>Свойство <span class="b">textAlign</span> позволяет выровнить текст относительно одной из сторон. Это свойство может принимать следующие значения:</p>
<ul>
<li><p><code>left</code>: текст начинается с указанной позиции</p></li>
<li><p><code>right</code>: текст завершается до указанной позиции</p></li>
<li><p><code>center</code>: текст располагается по центру относительно указанной позиции</p></li>
<li><p><code>start</code>: значение по умолчанию, текст начинается с указанной позиции</p></li>
<li><p><code>end</code>: текст завершается до указанной позиции</p></li>
</ul>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
...
<img src="pics/6.9.png" alt="textAlign в canvas в HTML5" />
<h3>Свойство lineWidth</h3>
<p>Свойство <span class="b">lineWidth</span> задает ширину линии текста:</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
context.font = "30px Verdana";
...
<img src="pics/6.11.png" alt="lineWidth в canvas в HTML5" />

<h3>Свойство textBaseline</h3>
<p>Свойство <span class="b">textBaseline</span> задает выравнивание текста по базовой линии. Оно может принимать следующие значения:</p>
<ul>
<li><p><code>top</code></p></li>
<li><p><code>middle</code></p></li>
<li><p><code>bottom</code></p></li>
<li><p><code>alphabetic</code></p></li>
<li><p><code>hanging</code></p></li>
<li><p><code>ideographic</code></p></li>
</ul>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
...
<img src="pics/6.12.png" alt="textBaseline в canvas в HTML5" />
<h3>Определение ширины текста</h3>
<p>С помощью метода <span class="b">measureText()</span> можно определить ширину текста на canvase:</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
	context = canvas.getContext("2d");
context.font = "18px Verdana";
