...
<html >
<head>
<title>HTML5 | Элементы fieldset и legend</title>
<meta charset="utf-8" />
<meta name="description" content="Группировка элементов форм в HTML5 с помощью fieldset, элемент legend и создание заголовка группы">
...
<h2>Элементы fieldset и legend</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Для группировки элементов формы нередко применяется элемент <span class="b">fieldset</span>. Он создает границу вокруг вложенных элементов, 
как бы создавая из них группу. Вместе с ним используется элемент <span class="b">legend</span>, который устанавливает заголовок для группы элементов:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/2.38.png" alt="Группировка элементов формы в HTML5" />
<p>При необходимости мы можем создать на одной форме несколько групп с помощью элементов fieldset.</p>
