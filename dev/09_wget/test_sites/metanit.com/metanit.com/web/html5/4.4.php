...
<html >
<head>
<title>HTML5 | Элементы header, footer и address</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы header, footer и address в семантической разметке в HTML5, создание заголовков и футера">
...
<h2>Элементы header, footer и address</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<h3>Header</h3><p>Элемент <span class="b">header</span> является как бы вводным элементом, предваряющим основное содержимое. Здесь могут быть заголовки, 
элементы навигации или какие-либо другие вспомогательные элементы, например, логотип, форма поиска и т.п. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<p>Элемент header нельзя помещать в такие элементы как address, footer или другой header.</p>
<h3>Footer</h3>
<p>Элемент <span class="b">footer</span> обычно содержит информацию о том, кто автор контента на веб-странице, копирайт, дата публикации, 
блок ссылок на похожие ресурсы и т.д. Как правило, подобная информация располагается в конце веб-страницы или основного содержимого, однако, 
footer не имеет четкой привязки к позиции и может использоваться в различных местах веб-страницы.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
	...
	&lt;body&gt;
		...
		&lt;footer&gt;
			...
			Copyright &copy; 2016. SomeSite.com&lt;/p&gt;
		&lt;/footer&gt;
	&lt;/body&gt;
&lt;/html&gt;
</pre>
<p>Здесь определен футер для всей веб-страницы. В него помещена ссылка на лицензионное соглашение использования сервисом и информация о копирайте.</p>
<p>Футер необязательно должен быть определен для всей страницы. Это может быть и отдельная секция контента:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<p>Элемент footer не следует помещать в такие элементы как address, header или другой footer.</p>
<h3>Address</h3>
<p>Элемент <span class="b">address</span> предназначен для отображения контактной информации, которая связана с ближайшим элементом article или body. 
Нередко данный элемент размещается в футере:</p>
<pre class="brush:xml;">
&lt;footer&gt;
	&lt;address&gt;	
		Контакты для связи &lt;a href="mailto:js@example.com"&gt;Том Смит&lt;/a&gt;.
	&lt;/address&gt;
	&lt;p&gt;&copy; copyright 2016 Example Corp.&lt;/p&gt;
&lt;/footer&gt;
</pre>
