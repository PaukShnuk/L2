...
<html >
<head>
<title>HTML5 | Выравнивание строк и столбцов. align-content</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание строк и столбцов во Flexbox в HTML5 и CSS3, свойство align-content">
...
<h2>Выравнивание строк и столбцов. align-content</h2><div class="date">Последнее обновление: 18.04.2017</div>
...
<p>Свойство <span class="b">align-content</span> управляет выравниванием рядов (строк и столбцов) во flex-контейнере и поэтому применяется, если 
свойство <code>flex-wrap</code> имеет значение <code>wrap</code> или <code>wrap-reverse</code>. Свойство align-content может иметь следующие значения:</p>
<ul>
<li><p><span class="b">stretch</span>: значение по умолчанию, при котором строки (столбцы) растягиваются, занимая все свободное место</p></li>
<li><p><span class="b">flex-start</span>: строки (столбцы) выравниваются по началу контейнера (для строк - это верхний край, для столбцов - это левый край контейнера)</p></li>
<li><p><span class="b">flex-end</span>: строки (столбцы) выравниваются по концу контейнера (строки - по нижнему краю, столбцы - по правому краю)</p></li>
<li><p><span class="b">center</span>: строки (столбцы) позиционируются по центру контейнера</p></li>
<li><p><span class="b">space-between</span>: строки (столбцы) равномерно распределяются по контейнеру, а между ними образуются одинаковые отступы. Если же имеющегося в контейнере места недостаточно, 
то действует аналогично значению <code>flex-start</code></p></li>
<li><p><span class="b">space-around</span>: строки (столбцы) равным образом распределяют пространство контейнера, а растояние между первой и последней строкой (столбцом) 
и границами контейнера составляет половину расстояния между соседними строками (столбцами).</p></li>
</ul>
<p>Стоит учитывать, что это свойство имеет смысл, если в контейнере две и больше строки (столбца).</p>
<p>Например, расположение строк в начале контейнера:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox19.png" alt="align-content в flexbox и css3" />
<p>Изменим стиль контейнера:</p>
<pre class="brush:css;">
.flex-container {
	display: flex;
	border:1px #ccc solid;
...
<p>И в этом случае мы получим ряд столбцов, разделенных отступами:</p>
<img src="pics/flexbox20.png" alt="align-content в flexbox и html5" />
