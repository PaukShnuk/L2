...
<html >
<head>
<title>CSS3 | Стилизация списков</title>
<meta charset="utf-8" />
<meta name="description" content="Стилизация списков в CSS 3, установка маркера элементов списка, свойства list-style-type и list-style-image">
...
<h2>Стилизация списков</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>CSS предоставляет специальные свойства по стилизации списков. Одним из таких свойств является <span class="b">list-style-type</span>. Оно может принимать 
следующие значения для нумерованных списков:</p>
<ul>
...
<li><p><code>lower-roman</code>: строчные латинские цифры, например, i, ii, iii, iv, v</p></li>
<li><p><code>upper-roman</code>: заглавные латинские цифры, например, I, II, III, IV, V…</p></li>
<li><p><code>lower-alpha</code>: строчные латинские буквы, например, a, b, c..., z</p></li>
<li><p><code>upper-alpha</code>: заглавные латинские буквы, например, A, B, C, … Z</p></li>
</ul>
<p>Для ненумерованных списков:</p>
<ul>
...
<img src="pics/4.35.png" alt="list-style-type в CSS 3" />
<p>Чтобы вообще отключить маркеры у элементов списка, используется значение <code>none</code>:</p>
<pre class="brush:css;">
ul{
	list-style-type: none;
}
</pre>
<p>Данное свойство может применяться как ко всему списку, так и к отдельным элементам. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Веб-браузеры обычно отображают маркеры списка слева от элементов списка. С помощью свойства <span class="b">list-style-position</span> мы можем 
настроить их позиционирование. Это свойство принимает два значения: <code>outside</code> (по умолчанию) и <code>inside</code> (обеспечивает равномерное распределение по ширине).</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.36.png" alt="list-style-position в CSS 3" />
<h3>list-style-image</h3>
<p>Свойство <span class="b">list-style-image</span> позволяет задать в качестве маркера изображение:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.37.png" alt="list-style-image в CSS 3" />
<p>Свойство <code>list-style-image</code> в качестве значения принимает путь к изображению <code>url(phone_touch.png)</code>, 
где "phone_touch.png" - это название файла изображения. То есть в данном случае предполагается, что в одной папке с веб-страницей 
находится файл изображения phone_touch.png.</p>
