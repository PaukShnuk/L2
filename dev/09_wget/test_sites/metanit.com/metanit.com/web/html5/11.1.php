...
<html >
<head>
<title>HTML5 | Адаптивный дизайн</title>
<meta charset="utf-8" />
<meta name="description" content="Адаптивный дизайн в HTML 5 и CSS 3, тестирование адаптивных веб-страниц">
...
<h1>Адаптивный дизайн</h1><h2>Введение в адаптивный дизайн</h2><div class="date">Последнее обновление: 03.05.2016</div>
...
<p>Сейчас все большее распространение находят различные гаджеты - смартфоны, планшеты, "умные часы" и другие устройства, которые позволяют выходить в интернет, 
...
продвижению информационных услуг и т.д. Но вместе с тем появляются и новые проблемы.</p>
<p>Главная проблема заключается в том, что стандартная веб-страница будет по разному выглядеть для разных устройств с разным разрешением экрана. Первоначальным 
решением данной проблемы было создание специальных версий для мобильных устройств.</p>
<p>На заре распространения мобильных телефонов пользователи могли через телефон по протоколу WAP получать доступ к специальным wap-сайтам, 
которые были написаны на языке wml - языке на основе xml, похожем на html. К примеру, простейшая веб-страница на этом языке разметке могла иметь следющий код:</p>
<pre class="brush:xml;">
&lt;?xml version="1.0"?&gt;
...
<p>Визуально она выглядела так:</p>
<img src="pics/9.1.png" alt="Веб-страница на языке wml для wap-сайта" />
<p>Однако развитие самих гаджетов, их возможностей привело к тому, что сейчас мобильные телефоны представляют куда большие возможности по получению и 
отображению содержимого сайтов, а в написании подобных сайтов используется те же HTML5 и CSS3, что и для обычных сайтов.</p>
<p>Кроме того, появление все большего количества разнообразных устройств привело к тому, что веб-страницы необходимо подстраивать не только под небольшие экраны 
...
иметь доступ к интернету.</p>
<p>И для решения проблемы совместимости веб-страниц с самыми различными разрешениями самых различных устройств возникла концепция адаптивного дизайна. Ее суть 
заключается в том, чтобы должным образом масштабировать элементы веб-страницы в зависимости от ширины экрана.</p>
<p>Хотя нередко до сих пор можно встретить ситуацию, когда для сайта создается отдельная мобильная версия, часто с префиксом <span class="b">m</span>, 
например, <i>m.vk.com</i>. Однако концепция адаптивного становится все более распространенной и доминирующей.</p>
<h3>Тестирование адаптивного дизайна</h3>
<p>При разработке адаптивных веб-страниц мы можем столкнуться с трудностями тестирования, так как, как правило, разработка идет на обычных компьютерах. Но к счастью 
многие совеременные браузеры позволяют нам эмулировать запуск веб-страницы на том или ином устройстве с различной шириной экрана.</p>
<p>Например, в Google Chrome надо перейти в меню <span class="b">Дополнительные инструменты -&gt; Инструменты разработчика</span>. После октрытия панели 
...
до широкоформатных телевизоров:</p>
<img src="pics/9.2.png" alt="Адаптивный дизайн в Google Chrome" />
<p>В данном случае отображается веб-страница как она бы выглядела на устройстве Samsung Galaxy S III. Но при желании можно выбрать другое устройство, либо даже 
создать эмуляцию какого-то нового устройства, которого нет во встроенном списке.</p>
<p>Подобные инструменты есть и в других современных веб-браузерах. Например, в Mozilla Firefox для их открытия надо перейти в меню 
<span class="b">Разработка -&gt; Адаптивный дизайн</span></p>
<p>Еще одно решение заключается в использовании эмуляторы мобильных устройств. Небольшой список подобных эмуляторов можно найти по следующему адресу: 
<a href="http://www.mobilexweb.com/emulators" rel="nofollow">http://www.mobilexweb.com/emulators</a>.</p>
<p>Наиболее популярным является эмулятор браузера Opera Mobile, который можно найти по адресу 
<a href="http://www.opera.com/ru/developer/mobile-emulator" rel="nofollow">http://www.opera.com/ru/developer/mobile-emulator</a>.</p>
