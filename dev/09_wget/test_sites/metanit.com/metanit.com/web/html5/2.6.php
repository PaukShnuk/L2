...
<html >
<head>
<title>HTML5 | Элемент details</title>
<meta charset="utf-8" />
<meta name="description" content="Создание раскрываемого списка в HTML5 с помощью элемента details и summary, accordion">
...
<h2>Элемент details</h2><div class="date">Последнее обновление: 14.07.2021</div>
...
<p>Элемент <span class="b">details</span> позволяет создавать раскрываемый блок, который по умолчанию скрыт. Иногда такой элемент еще называют accordion.</p>
<p>Данный элемент содержит элемент <span class="b">summary</span>, который представляет заголовок для блока, и этот заголовок отображается в скрытом 
режиме. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<p>По умолчанию мы видим только заголовок summary:</p>
<img src="./pics/1.35.png" alt="Элемент summary в HTML5" />
<p>Нажав на стрелку или заголовок, мы можем раскрыть блок:</p>
<img src="./pics/1.36.png" alt="Элемент details в HTML5" />
<p>Дополнительно про данный элемент можно прочитать в статье <a href="./6.21.php">Стилизация элемента details</a></p>
