...
<html >
<head>
<title>HTML5 | Списки</title>
<meta charset="utf-8" />
<meta name="description" content="Нумерованные и ненумерованные списки в HTML5, элементы ul и ol, их типы и атрибуты">
...
<h2>Списки</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Для создания списков в HTML5 применяются элементы <code>&lt;ol&gt;</code> (нумерованный список) и <code>&lt;ul&gt;</code> (ненумерованный список):</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.24.png" alt="Списки в HTML5" />
<p>В нумерованном списке для нумерации элементов по умолчанию используется стандартные цифры от 1. В ненумерованном списке каждый элемент предваряется черной точкой.</p>
<p>При необходимости мы можем настроить нумерацию или отражаемый рядом с элементом символ с помощью стиля <span class="b">list-style-type</span>. 
...
<code>list-style-type</code> может принимать следующие значения:</p>
<ul>
<li><p><code>decimal</code>: десятичные числа, отсчет идет от 1</p></li>
<li><p><code>decimal-leading-zero</code>: десятичные числа, которые предваряются нулем, например, 01, 02, 03, … 98, 99</p></li>
<li><p><code>lower-roman</code>: строчные римские цифры, например, i, ii, iii, iv, v</p></li>
<li><p><code>upper-roman</code>: заглавные римские цифры, например, I, II, III, IV, V…</p></li>
<li><p><code>lower-alpha</code>: строчные римские буквы, например, a, b, c..., z</p></li>
<li><p><code>upper-alpha</code>: заглавные римские буквы, например, A, B, C, … Z</p></li>
</ul>
<p>Для нумерованных список с помощью атрибута <span class="b">start</span> можно дополнительно задать символ, с которого будет начинаться нумерация. Например:</p>
<pre class="brush:xml;">
...
<img src="pics/1.25.png" alt="Нумерованный список в HTML5" />
<p>Для ненумерованного списка атрибут <code>list-style-type</code> может принимать следующие значения:</p>
<ul>
<li><p><code>disc</code>: черный диск</p></li>
<li><p><code>circle</code>: пустой кружочек</p></li>
<li><p><code>square</code>: черный квадратик</p></li>
</ul>
<p>Например:</p>
<pre class="brush:xml;">
...
<img src="pics/1.26.png" alt="Неупорядоченный список в HTML5" />
<p>Еще одну интересную возможность по настройке списков предоставляет стиль <span class="b">list-style-image</span>. Он задает изображение, которое будет 
отображаться рядом с элементом списка:</p>
<pre class="brush:xml;">
...
<img src="pics/1.27.png" alt="Картинки в списке в HTML5" />
<p>Стиль <code>list-style-image</code> в качестве значения принимает <code>url(phone_touch.png)</code>, где "phone_touch.png" - это название файла изображения. 
То есть в данном случае предполагается, что в одной папке с веб-страницей index.html у меня находится файл изображения <i>phone_touch.png</i>.</p>
<h3>Горизонтальный список</h3>
<p>Одним из распространенных способов стилизации списков представляет создание горизонтального списка. Для этого для всех элементов списка надо 
установить стиль <code>display:inline</code>: </p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
