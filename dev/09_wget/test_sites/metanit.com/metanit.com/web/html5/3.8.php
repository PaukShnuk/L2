...
<html >
<head>
<title>HTML5 | Элементы для ввода цвета, url, email, телефона</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы для url, email, телефона в HTML5, установка цвета">
...
<h2>Элементы для ввода цвета, url, email, телефона</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<h3>Установка цвета</h3>
<p>За установку цвета в HTML5 отвечает специальный элемент input с типом <span class="b">color</span>:</p>
<pre class="brush:xml;">
&lt;label for="favcolor"&gt;Выберите цвет&lt;/label&gt;
&lt;input type="color" id="favcolor" name="favcolor" /&gt;
</pre>
<p>Элемент отображает выбранный цвет. А при нажатии на него появляется специальное диалоговое окно для установки цвета:</p>
<img src="pics/2.36.png" alt="Элемент установки цвета в HTML5" />
<p>Значением этого элемента будет числовой шестнадцатеричный код выбранного цвета.</p>
<p>С помощью элемента <code>datalist</code> мы можем задать набор цветов, из который пользователь может выбрать нужный:</p>
<pre class="brush:xml;">
&lt;label for="favcolor"&gt;Выберите цвет&lt;/label&gt;
...
<img src="pics/2.37.png" alt="Выбор цвета в HTML5" />
<p>Каждый элемент <code>option</code> в <code>datalist</code> должен в качестве значения принимать шестнадцатеричный код цвета, например, <code>"#0000FF"</code>. 
После выбора цвета данный числовой код устанавливается в качестве значения в элементе input.</p>
<h3>Поля для ввода url, email, телефона</h3>
<p>Ряд полей input предназначены для ввода таких данных, как url, адреса электронной почты и телефонного номера. Они однотипны и во многом отличаются только тем, 
что для атрибута <code>type</code> принимают соответственно значения <code>email</code>, <code>tel</code> и <code>url</code>.</p>
<p>Для их настройки мы можем использовать те же атрибуты, что и для обычного текстового поля:</p>
<ul>
<li><p><span class="b">maxlength</span>: максимально допустимое количество символов в поле</p></li>
<li><p><span class="b">pattern</span>: определяет шаблон, которому должен соответствовать вводимый текст</p></li>
<li><p><span class="b">placeholder</span>: устанавливает текст, который по умолчанию отображается в поле</p></li>
...
<li><p><span class="b">size</span>: устанавливает ширину поля в видимых символах</p></li>
<li><p><span class="b">value</span>: устанавливает значение по умолчанию для поля</p></li>
<li><p><span class="b">list</span>: устанавливает привязку к элементу datalist со списком возможных значений</p></li>
</ul>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="pics/2.17.png" alt="Ввод email, url, телефона в HTML5" />
<p>Основное преимущество подобных полей ввода перед обычными текстовыми полями состоит в том, что поля ввода для email, url, телефона для проверки ввода 
используют соответствующий шаблон. Например, если мы введем в какое-либо поле некорректное значение и попробуем отправить форму, то браузер может отобразить 
нам сообщение о некорректном вводе, а форма не будет отправлена:</p>
<img src="pics/2.18.png" alt="Валидация email в HTML5" />
