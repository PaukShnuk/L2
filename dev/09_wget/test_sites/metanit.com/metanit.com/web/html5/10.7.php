...
<html >
<head>
<title>HTML5 | Добавление теней на Canvas</title>
<meta charset="utf-8" />
<meta name="description" content="Добавление теней к фигурам и тексту на Canvas в HTML5, метод drawImage">
...
<h2>Добавление теней</h2><div class="date">Последнее обновление: 02.05.2016</div>
...
<ul>
<li><p><span class="b">shadowOffsetX</span>: горизонтальное смещение в пикселях справа (или слева при отрицательном значении)</p></li>
<li><p><span class="b">shadowOffsetY</span>: вертикальное смещение в пикселях снизу (или сверху при отрицательном значении)</p></li>
<li><p><span class="b">shadowBlur</span>: число пикселей ля установки размыти тени</p></li>
<li><p><span class="b">shadowColor</span>: цвет тени</p></li>
</ul>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="pics/6.27.png" alt="Тени на canvas в HTML5" />
