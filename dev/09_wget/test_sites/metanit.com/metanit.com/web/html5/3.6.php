...
<html >
<head>
<title>HTML5 | Элементы для ввода чисел</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы для ввода чисел в HTML5, элемент input type="number", ограничения для ввода чисел, создания ползунка">
...
<h2>Элементы для ввода чисел</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<h3>Простое числовое поле</h3>
<p>Для ввода чисел используется элемент <code>input</code> с атрибутом <span class="b">type="number"</span>. Он создает числовое поле, 
которое мы можем настроить с помощью следующих атрибутов:</p>
<ul>
<li><p><code>min</code>: минимально допустимое значение</p></li>
<li><p><code>max</code>: максимально допустимое значение</p></li>
<li><p><code>readonly</code>: доступно только для чтения</p></li>
<li><p><code>required</code>: указывает, что данное поле обязательно должно иметь значение</p></li>
<li><p><code>step</code>: значение, на которое будет увеличиваться число в поле</p></li>
<li><p><code>value</code>: значение по умолчанию</p></li>
</ul>
<p>Используем числовое поле:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<p>Здесь числовое поле по умолчанию имеет значение 10 (<code>value="10"</code>), минимально допустимое значение, которое мы можем ввести, - 1, 
а максимальное допустимое значение - 100. И атрибут <code>step="1"</code> устанавливает, что значение будет увеличиваться на единицу.</p>
<p>В зависимости от браузера визуализация этого поля может отличаться:</p>
<img src="pics/2.11.png" alt="Ввод чисел в HTML5" />
<p>Но как правило, у большинства современных браузеров, кроме IE 11 и Microsoft Edge, справа в поле ввода имеются стрелки для увеличения/уменьшения значения 
на величину, указанную в атрибуте step.</p>
<p>Как и в случае с текстовым полем мы можем здесь прикрепить список datalist с диапазоном возможных значений:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.12.png" alt="Ввод чисел из datalist в HTML5" />
<h3>Ползунок</h3>
<p>Ползунок представляет шкалу, на которой мы можем выбрать одно из значений. Для создания ползунка применяется элемент <code>input</code> с атрибутом 
<span class="b">type="range"</span>. Во многом ползунок похож на простое поле для ввода чисел. Он также имеет атрибуты <code>min</code>, <code>max</code>, 
<code>step</code> и <code>value</code>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.13.png" alt="Ползунок в HTML5" />
