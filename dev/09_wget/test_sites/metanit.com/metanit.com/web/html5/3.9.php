...
<html >
<head>
<title>HTML5 | Элементы для ввода даты и времени</title>
<meta charset="utf-8" />
<meta name="description" content="Элементы для ввода даты и времени в HTML5, режимы отображения дат и времени">
...
<h2>Элементы для ввода даты и времени</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Для работы с датами и временем в HTML5 предназначено несколько типов элементов input:</p>
<ul>
<li><p><span class="b">datetime-local</span>: устанавливает дату и время</p></li>
<li><p><span class="b">date</span>: устанавливает дату</p></li>
<li><p><span class="b">month</span>: устанавливает текущий месяц и год</p></li>
<li><p><span class="b">time</span>: устанавливает время</p></li>
<li><p><span class="b">week</span>: устанавливает текущую неделю</p></li>
</ul>
<p>Например, используем поле для установки даты:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<p>И при вводе в поле для даты будет открываться календарик:</p>
<img src="pics/2.19.png" alt="Установка даты в HTML5" />
<p>Правда, здесь надо отметить, что действие этого элемента зависит от браузера. В данном случае используется Google Chrome. В последних версиях Opera 
элемент не будет сильно отличаться. А вот в Microsoft Edge элемент будет выглядеть так:</p>
<img src="pics/2.20.png" alt="Установка даты в Microsoft Edge" />
<p>Применение остальных элементов:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.21.png" alt="Дата и время в HTML5" />
<p>При использовании этих элементов также надо учитывать, что Firefox поддерживает только элементы <code>date</code> и <code>time</code>, для остальных создаются 
обычные текстовые поля. А IE11 и вовсе не поддерживают эти элементы.</p>
