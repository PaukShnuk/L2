...
<html >
<head>
<title>HTML5 | Настройка рисования на Canvas</title>
<meta charset="utf-8" />
<meta name="description" content="Настройка рисования на Canvas в HTML5, функции strokeStyle и fillStyle, работа с цветом">
...
<h2>Настройка рисования</h2><div class="date">Последнее обновление: 31.10.2016</div>
...
<ul>
<li><p><span class="b">strokeStyle</span>: устанавливает цвет линий или цвет контура. По умолчанию установлен черный цвет</p></li>
<li><p><span class="b">fillStyle</span>: устанавливает цвет заполнения фигур. По умолчанию установлен черный цвет</p></li>
<li><p><span class="b">lineWidth</span>: устанавливает толщину линий. По умолчанию равно 1.0</p></li>
<li><p><span class="b">lineJoin</span>: устанавливает стиль соединения линий</p></li>
<li><p><span class="b">globalAlpha</span>: устанавливает прозрачность отрисовки на canvas</p></li>
<li><p><span class="b">setLineDash</span>: создает линию из коротких черточек</p></li>
</ul>
<p>В прошлой теме при отрисовке прямоугольников мы явным образом не устанавливали никаких цветов, поэтому для цвета линий и заливки прямоцгольников 
использовался цвет по умолчанию - черный. Теперь используем други цвета:</p>
<p>Чтобы рисовать какие-то видимые фигуры, нам нужно задать цвет. Установить цвет можно разными способами. Во-первых, мы можем задать цвет контура или 
границы фигур с помощью свойства <span class="b">strokeStyle</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/6.31.png" alt="Настройка цвета рисования на canvas в HTML5" />
<p>В качестве значения свойства <code>strokeStyle</code> и <code>fillStyle</code> получают название цвета в виде строки, либо в виде шестнадцатиричного 
значения цвета (например, "#00FFFF"), либо в виде значений rgb ("rgb(0, 0, 255)") и rgba ("rgba(0, 0, 255, 0.5)").</p>
<p>Свойство <code>lineWidth</code> позволяет установить толщину линии:</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
    context = canvas.getContext("2d");
...
<img src="pics/6.32.png" alt="Настройка толщины линий на canvas в HTML5" />
<h3>setLineDash</h3>
<p>Метод <code>setLineDash()</code> в качестве параметра принимает массив чисел, которые устанавливают расстояния между линиями. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/6.42.png" alt="Линии с черточками на canvas в HTML5" />
<h3>Тип соединения линий</h3>
<p>Свойство <code>lineJoin</code> отвечает за тип соединения линий в фигуре. Оно может принимать следующие значения:</p>
<ul>
<li><p><code>miter</code>: прямые соединения, которые образуют прямые углы. Это значение по умолчанию</p></li>
<li><p><code>round</code>: закругленные соединения</p></li>
<li><p><code>bevel</code>: конические соединения</p></li>
</ul>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="pics/6.33.png" alt="Соединение линий на canvas в HTML5" />
<h3>Прозрачность</h3>
<p>Свойство <code>globalAlpha</code> задает прозрачность отрисовки. Оно может принимать в качестве значения число от 0 (полностью прозрачный) до 1.0 (не прозрачный):</p>
<pre class="brush:js;">
var canvas = document.getElementById("myCanvas"), 
    context = canvas.getContext("2d");
...
<p>Здесь на canvas выводятся два прямоугольника: синий и красный. Но до вывода красного прямоугольника установлена полупроразность отрисовки, поэтому 
сквозь красный прямоугольник мы сможем увидеть и синий:</p>
<img src="pics/6.35.png" alt="Установка прозрачности на canvas в HTML5" />
...
<div class="nav"><p><a href="10.1.php">Назад</a><a href="./">Содержание</a><a href="10.2.php">Вперед</a></p></div></div>
<div class="socBlock">
