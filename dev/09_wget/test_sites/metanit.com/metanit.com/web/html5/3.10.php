...
<html >
<head>
<title>HTML5 | Отправка файлов</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент для выбора файлов в HTML5, множественный выбор, элемент input type="file"">
...
<h2>Отправка файлов</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>За выбор файлов на форме отвечает элемент <code>input</code> с атрибутом <span class="b">type="file"</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.23.png" alt="Выбор файла в HTML5" />
<p>При нажатии на кнопку "Выберите файл" открывается диалоговое окно для выбора файла. А после выбора рядом с кнопкой отображается имя выбранного файла.</p>
<p>Важно отметить, что для отправки файла на сервер форма должна иметь атрибут <code>enctype="multipart/form-data"</code>.</p>
<p>С помощью ряда атрибутов мы можем дополнительно настроить элементы выбора файла:</p>
<ul>
<li><p><span class="b">accept</span>: устанавливает тип файл, которые допустимы для выбора</p></li>
<li><p><span class="b">multiple</span>: позволяет выбирать множество файлов</p></li>
<li><p><span class="b">required</span>: требует обязательной установки файла</p></li>
</ul>
<p>Например, множественный выбор файлов:</p>
<pre class="brush:xml;">
&lt;form enctype="multipart/form-data" method="post" action="http://localhost:8080/postfile.php"&gt;
	&lt;p&gt;
...
<p>При нажатии на кнопку также открывается диалоговое окно для выбора файлов, только теперь, зажав клавишу CTRL или Shift, мы можем выбрать несколько файлов, 
а после выбора рядом с кнопкой отобразится количество выбранных файлов:</p>
<img src="pics/2.24.png" alt="Множественный выбор файлов в HTML5" />
