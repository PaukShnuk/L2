...
<html >
<head>
<title>HTML5 | Выравнивание элементов. align-items и align-self</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание по поперечной оси cross axis во Flexbox в HTML5 и CSS3, свойства align-items и align-self">
...
<h2>Выравнивание элементов. align-items и align-self</h2><div class="date">Последнее обновление: 18.04.2017</div>
...
<h3>Свойство align-items</h3>
<p>Свойство <span class="b">align-items</span> также выравнивает элементы, но уже по поперечной оси (cross axis) (при расположении в виде строки по вертикали, при расположении в виде столбца - по горизонтали). 
Это свойство может принимать следующие значения:</p>
<ul>
<li><p><span class="b">stretch</span>: значение по умолчанию, при котором flex-элементы растягиваются по всей высоте (при расположении в строку) или по всей ширине 
(при расположении в столбик) flex-контейнера</p></li>
<li><p><span class="b">flex-start</span>: элементы выравниваются по верхнему краю (при расположении в строку) или по левому краю 
(при расположении в столбик) flex-контейнера</p></li>
<li><p><span class="b">flex-end</span>: элементы выравниваются по нижнему краю (при расположении в строку) или по правому краю 
(при расположении в столбик) flex-контейнера</p></li>
<li><p><span class="b">center</span>: элементы выравниваются по центру flex-контейнера</p></li>
<li><p><span class="b">baseline</span>: элементы выравниваются в соответствии со своей базовой линией</p></li>
</ul>
<p>Выравнивание при расположении в строку:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox11.png" alt="align-items в Flexbox и CSS3" />
<p>Аналогично свойство работает при расположении в столбик. Например, изменим стили flex-контейнера следующим образом:</p>
<pre class="brush:css;">
.flex-container {
	display: flex;
	border:1px #ccc solid;
...
<img src="pics/flexbox12.png" alt="align-items и column в Flexbox и CSS3" />
<h3>Свойство align-self</h3> 
<p>Свойство <span class="b">align-self</span> позволяет переопределить значение свойства <code>align-items</code> для одного элемента. 
Оно может принимать все те же значения плюс значение "auto":</p>
<ul>
<li><p><span class="b">auto</span>: значение по умолчанию, при котором элемент получает значение от свойства <code>align-items</code>, которое определено 
в flex-контейнере. Если в контейнере такой стиль не определен, то применяется значение <code>stretch</code>.</p></li>
<li><p><span class="b">stretch</span></p></li>
<li><p><span class="b">flex-start</span></p></li>
<li><p><span class="b">flex-end</span></p></li>
<li><p><span class="b">center</span></p></li>
<li><p><span class="b">baseline</span></p></li>
</ul>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<p>Здесь для flex-контейнера задано растяжение по высоте с помощью значения <code>align-items: stretch;</code>. Однако каждый из элементов переопределяет это поведение:</p>
<img src="pics/flexbox13.png" alt="align-self в flexbox и css3" />
...
<div class="nav"><p><a href="12.5.php">Назад</a><a href="./">Содержание</a><a href="12.7.php">Вперед</a></p></div></div>
<div class="socBlock">
