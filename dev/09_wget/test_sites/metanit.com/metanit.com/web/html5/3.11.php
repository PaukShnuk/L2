...
<html >
<head>
<title>HTML5 | Список select</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент select в HTML5, создание выпадающего списка, элементы option, список со множественным выбором">
...
<h2>Список select</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <span class="b">select</span> создает список. В зависимости от настроек это может быть выпадающий список для выбора одного элемента, 
либо раскрытый список, в котором можно выбрать сразу несколько элементов.</p>
<p>Создадим выпадающий список:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.25.png" alt="Выпадающий список в HTML5" />
<p>Внутрь элемента select помещаются элементы <span class="b">option</span> - элементы списка. Каждый элемент <code>option</code> содержит атрибут 
<code>value</code>, который хранит значение элемента. При этом значение элемента option не обязательно должно совпадать с отображаемым им текстом. Например:</p>
<pre class="brush:xml;">&lt;option value="apple"&gt;iPhone 6S&lt;/option&gt;</pre>
<p>С помощью атрибута <code>selected</code> мы можем установить выбранный по умолчанию элемент - это необязательно должен быть первый элемент в списке:</p>
<pre class="brush:xml;">
&lt;select id="phone" name="phone"&gt;
	&lt;option value="iphone 6s"&gt;iPhone 6S&lt;/option&gt;
	&lt;option value="lumia 950"&gt;Lumia 950&lt;/option&gt;
...
<p>С помощью другого атрибута <code>disabled</code> можно запретить выбор определенного элемента. Как правило, элементы с этим атрибутом служат для создания заголовков:</p>
<pre class="brush:xml;">
&lt;select id="phone" name="phone"&gt;
...
<p>Для создания списка с множественным выбором к элементу select надо добавить атрибут <span class="b">multiple</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<p>Зажав клавишу Ctrl, мы можем выбрать в таком списке несколько элементов:</p>
<img src="pics/2.26.png" alt="multiple select in HTML5" />
<p>Select также позволяет группировать элементы с помощью тега <span class="b">&lt;optgroup&gt;</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.27.png" alt="optgroup в HTML5" />
<p>Использование групп элементов применимо как к выпадающему списку, так и к списку со множественным выбором.</p>
