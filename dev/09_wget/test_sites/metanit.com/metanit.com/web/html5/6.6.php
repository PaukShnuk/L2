...
<html >
<head>
<title>CSS3 | Стилизация абзацев</title>
<meta charset="utf-8" />
<meta name="description" content="Стилизация абзацев в CSS 3, установка высоты строки, свойство line-height, выравнивание текста и text-align, создание отступа первой строки абзаца, text-indent">
...
<h2>Стилизация абзацев</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Отдельная группа свойств CSS позволяет стилизовать большие группы текста, например, установить высоту строки или выравнивание текста.</p>
<h3>line-height</h3>
<p>Свойство <span class="b">line-height</span> определяет межстрочный интервал. Для его установки можно использовать пиксели, проценты или единицы 
em. Как правило, применяются либо проценты, либо em. Например:</p>
<pre class="brush:css;">
p{
	line-height: 150%;
}
</pre>
<p>Если это свойство не установлено, то по умолчанию используется значение <code>line-height: 120%;</code>.</p>
<img src="pics/4.32.png" alt="line-height в CSS 3" />
<h3>text-align</h3>
<p>Свойство <span class="b">text-align</span> выравнивает текст относительно одной из сторон веб-страницы. Оно принимает следующие значения:</p>
<ul>
<li><p><code>left</code>: текст выравнивается по левой стороне</p></li>
<li><p><code>right</code>: текст выравнивается по правой стороне</p></li>
<li><p><code>justify</code>: выравнивание по ширине, слова равномерно распределяются по строке</p></li>
...
<img src="pics/4.33.png" alt="Выравнивание текста и text-align в CSS 3" />
<h3>text-indent</h3>
<p>Свойство <span class="b">text-indent</span> задает отступ первой строки абзаца. Для установки отступа могут применяться стандартные единицы измерения, например, em или 
пиксели:</p>
<pre class="brush:css;">
p{
	text-indent: 35px;
...
<img src="pics/4.34.png" alt="Отступ текста и text-indent в CSS 3" />
