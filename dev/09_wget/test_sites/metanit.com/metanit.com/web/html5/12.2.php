...
<html >
<head>
<title>HTML5 | Направление flex-direction</title>
<meta charset="utf-8" />
<meta name="description" content="Направление элементов и свойство flex-direction во Flexbox в HTML5 и CSS3, расположение элементов flex в виде строки или столбца">
...
<h2>Направление flex-direction</h2><div class="date">Последнее обновление: 18.04.2017</div>
...
<p>Flex-элементы во flex-контейнере могут иметь определенное направление, а именно они могут располагаться в виде строк или в виде столбцов. Для управления направлением элементов 
CSS3 предоставляет свойство flex-direction. Оно определяет направление элементов и может принимать следующие значения:</p>
<ul>
<li><p><span class="b">row</span>: значение по умолчанию, при котором элементы располагаются в виде строки слева направо</p></li>
<li><p><span class="b">row-reverse</span>: элементы также располагаются в виде стоки только в обратном порядке справа налево</p></li>
<li><p><span class="b">column</span>: элементы располагаются в столбик сверху вниз</p></li>
<li><p><span class="b">column-reverse</span>: элементы располагаются в столбик в обратном порядке снизу вверх</p></li>
</ul>
<p>Например, расположение в виде строки:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox3.png" alt="Flex-direction в Flexbox и CSS3" />
<p>Аналогично работает расположение в виде столбца:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox4.png" alt="Column в Flexbox и CSS3" />
