...
<html >
<head>
<title>HTML5 | Рисование мышью</title>
<meta charset="utf-8" />
<meta name="description" content="Рисование мышью на Canvas в HTML5, захват нажатий указателя мыши и рисование линий">
...
<h2>Рисование мышью</h2><div class="date">Последнее обновление: 31.10.2016</div>
...
<p>Ранее мы рассматривали в основном статическую графику на canvas. Но мы также можем создавать фигуры динамически, просто рисуя указателем мыши.</p>
<p>Для этого определим следующую страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Для обработки движения мыши для элемента canvas определены три обработчика - нажатия мыши, перемещения и отпускания мыши. При нажатии мыши мы устанавливаем 
переменную draw равным true. То есть идет рисование. Также при нажатии мы фиксируем точку, с которой будет идти рисование.</p>
<p>При перемещении мыши получаем точку, на которую переместился указатель, и рисуем линию. При отпускании указателя закрываем графический путь методом 
<code>context.closePath()</code> и сбрасываем переменную draw в false.</p>
<img src="pics/6.44.png" alt="Перемещение на canvas в HTML5" />
...
<div class="nav"><p><a href="10.10.php">Назад</a><a href="./">Содержание</a><a href="12.1.php">Вперед</a></p></div></div>
<div class="socBlock">
