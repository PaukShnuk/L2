...
<html >
<head>
<title>CSS3 | Контуры элементов</title>
<meta charset="utf-8" />
<meta name="description" content="Контуры элементов в CSS 3, свойство outline и его настройка, отличие контуров от границ">
...
<h2>Контуры элементов</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Концепция контуров похожа на использование границ у элементов. Не стоит путать или заменять границы контурами, они имеют разное значение. 
Контуры полезны тем, что позволяют выделить элемент, чтобы привлечь к нему внимание в какой-то ситуации. Контуры располагаются вне элемента сразу за его границами.</p>
<p>Контур в CSS 3 представлен свойством <span class="b">outline</span>, хотя данное свойство является сокращением следующих свойств:</p>
<ul>
<li><p><span class="b">outline-color</span>: цвет контура</p></li>
<li><p><span class="b">outline-offset</span>: смещение контура</p></li>
<li><p><span class="b">outline-style</span>: стиль контура. Оно принимает те же значения, что и <code>border-style</code>:</p>
<ul>
<li><p><code>none</code>: контур отсутствует</p></li>
<li><p><code>solid</code>: контур в виде обычной линии</p></li>
<li><p><code>dashed</code>: штриховая линия</p></li>
<li><p><code>dotted</code>: линия в виде последовательности точек</p></li>
<li><p><code>double</code>: контур в виде двух параллельных линий</p></li>
</ul></li>
<li><p><span class="b">outline-width</span>: толщина контура</p></li>
</ul>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="pics/4.54.png" alt="Контур outline в CSS 3" />
<p>С помощью свойства <code>outline</code> данное определение контура можно сократить следующим образом:</p>
<pre class="brush:css;">outline: red dashed 2px;</pre>
...
<div class="nav"><p><a href="6.15.php">Назад</a><a href="./">Содержание</a><a href="6.17.php">Вперед</a></p></div></div>
<div class="socBlock">
