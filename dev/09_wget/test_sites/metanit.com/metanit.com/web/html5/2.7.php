...
<html >
<head>
<title>HTML5 | Список определений</title>
<meta charset="utf-8" />
<meta name="description" content="Список определений в HTML5, элементы dl, dt, dd">
...
<h2>Список определений</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Список определений (definition list) представляет такой список, который содержит термин и определение к этому термину. И таких пар термин-определение в списке 
может быть множество. Для создания списка определений применяются теги <span class="b">&lt;dl&gt;</span> и <span class="b">&lt;/dl&gt;</span>. Внутрь 
этих тегов помещаются элементы списка.</p>
<p>Каждый элемент списка состоит из термина и определения. Термин помещается в теги <span class="b">&lt;dt&gt;</span> и <span class="b">&lt;/dt&gt;</span> 
(dt - сокращение от "definition term"), а определение - в теги <span class="b">&lt;dd&gt;</span> и <span class="b">&lt;/dd&gt;</span> 
(dd - сокращение от "definition description")</p>
<p>Рассмотрим простейший список определений:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.28.png" alt="definition list в HTML5" />
