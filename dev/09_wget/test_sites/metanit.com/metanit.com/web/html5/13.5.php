...
<html >
<head>
<title>HTML5 | Отступы между столбцами и строками в Grid Layout</title>
<meta charset="utf-8" />
<meta name="description" content="Отступы между столбцами и строками в Grid Layout в CSS3, свойства grid-column-gap, grid-row-gap, grid-gap и grid">
...
<h2>Отступы между столбцами и строками</h2><div class="date">Последнее обновление: 09.05.2017</div>
...
<p>Для создания отступов между столбцами и строками применяются свойства <span class="b">grid-column-gap</span> и <span class="b">grid-row-gap</span> соответственно.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/grid26.png" alt="Отступы между столбцами и строками в Grid Layout и CSS3" />
<p>Если значения свойств <span class="b">grid-column-gap</span> и <span class="b">grid-row-gap</span> совпадают, то вместо них можно определить одно свойство 
<span class="b">gap</span> (ранее назвалось <span class="b">grid-gap</span>), которое установит оба отступа:</p>
<pre class="brush:css;">
.grid-container {
	height: 100vh;
	display: grid;
