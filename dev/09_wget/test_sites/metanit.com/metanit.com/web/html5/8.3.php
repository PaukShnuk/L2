...
<html >
<head>
<title>HTML5 | Вложенные плавающие блоки</title>
<meta charset="utf-8" />
<meta name="description" content="Вложенные плавающие блоки в HTML 5, разделение одного блока на несколько столбцов в CSS">
...
<h2>Вложенные плавающие блоки</h2><div class="date">Последнее обновление: 24.04.2016</div>
...
<p>Нередко встречается ситуация, когда к вложенным в обтекающий блок элементам также применяется обтекание. Например, блок основного содержимого 
может включать блок собственно содержимого и блок меню. В принципе к таким блокам будут применяться все те же правила, что были рассмотрены ранее.</p>
<p>Определим сначала последовательно все блоки веб-страницы:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Опять же в главном блоке вложенные блоки идут последовательно: сначала блок меню, а потом блок основного текста.</p>
<img src="pics/7.6.png" alt="Блочная верстка вложенных элементов в HTML5 и CSS3" />
<p>Теперь применим обтекание к блоку меню:</p>
<pre class="brush:css;">
#menu{
	background-color: #ddd;
	float: left;
...
<p>Опять же у плавающего элемента, коим является блок меню, устанавливаются свойства <code>float</code> и <code>width</code>. А у обтекающего его блока content 
устанавливается отступ слева.</p>
<img src="pics/7.7.png" alt="Блочная верстка вложенных элементов и float в HTML и CSS" />
<p>Аналогично можно сделать блок меню справа:</p>
<pre class="brush:css;">
#menu{
	background-color: #ddd;
	float: right;
...
<img src="pics/7.8.png" alt="Параметры блочной верстки в HTML и CSS" />
