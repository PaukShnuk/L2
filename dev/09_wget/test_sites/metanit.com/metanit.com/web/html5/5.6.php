...
<html >
<head>
<title>CSS3 | Псевдоэлементы</title>
<meta charset="utf-8" />
<meta name="description" content="Псевдоэлементы в CSS 3, селекторы first-letter, first-line, before, after, selection">
...
<h2>Псевдоэлементы</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Псевдоэлементы обладают рядом дополнительных возможностей по выбору элементов веб-страницы и похожи на псевдоклассы. Список доступных псевдоэлементов:</p>
<ul>
<li><p><span class="b">::first-letter</span>: позволяет выбрать первую букву из текста</p></li>
<li><p><span class="b">::first-line</span>: стилизует первую строку текста</p></li>
<li><p><span class="b">::before</span>: добавляет сообщение до определенного элемента</p></li>
<li><p><span class="b">::after</span>: добавляет сообщение после определенного элемента</p></li>
<li><p><span class="b">::selection</span>: выбирает выбранные пользователем элементы</p></li>
</ul>
<p>В CSS2 перед псевдоэлементами, как и перед псевдоклассами, ставилось одно двоеточие. В CSS3 для отличия их от псевдоклассов 
...
использование одного двоеточия: <code>:before</code>.</p>
<p>Стилизуем текст, используя псевдоэлементы <code>first-letter</code> и <code>first-line</code>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.8.png" alt="Псевдоэлементы в CSS3" />
<p>Используем псевдоэлементы <code>before</code> и <code>after</code>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.9.png" alt="Псевдоэлементы before и after в CSS3" />
<p>Здесь псевдоэлеметы применяются к элементу с классом <code>warning</code>. Оба псевдоэлемента принимают свойство <span class="b">content</span>, 
которое хранит вставляемый текст. И также для повышения внимания псевдоэлементы используют выделение текста жирным с помощью свойства <code>font-weight: bold;</code>.</p>
<p>Используем псевдоэлемент <code>selection</code> для стилизации выбранных элементов:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.10.png" alt="Псевдоэлемент selection в CSS3" />
