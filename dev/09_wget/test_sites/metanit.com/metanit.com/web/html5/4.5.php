...
<html >
<head>
<title>HTML5 | Элемент aside</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент aside в семантической разметке в HTML5, создание сайдбаров">
...
<h2>Элемент aside</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <span class="b">aside</span> представляет содержимое, которое косвенно связано с остальным контентом веб-станицы и которое может 
рассматриваться независимо от него. Данный элемент можно использовать, например, для сайдбаров, для рекламных блоков, блоков навигационных элементов, 
различных плагинов типа твиттера или фейсбука и т.д.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/3.4.png" alt="Элемент aside в HTML5" />
<p>Здесь содержимое блока aside довольно косвенно связано с основным контентом из элемента article. Поэтому все это содержимое мы можем поместить в aside.</p>
