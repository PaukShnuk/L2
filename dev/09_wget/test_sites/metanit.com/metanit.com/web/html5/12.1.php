...
<html >
<head>
<title>HTML5 | Flexbox</title>
<meta charset="utf-8" />
<meta name="description" content="Flexbox в HTML5 и CSS3, новый подход к построению интерфейса, Flex Container и его элементы, поддержка браузерами">
...
<h1>Flexbox</h1><h2>Что такое Flexbox. Flex Container</h2><div class="date">Последнее обновление: 18.04.2017</div>
...
<p><span class="b">Flexbox</span> - это общее название для модуля <span class="b">Flexible Box Layout</span>, который имеется в CSS3. Данный модуль определяет особый режим компоновки/верстки пользовательского 
интерфейса, который называется <span class="b">flex layout</span>. В этом плане Flexbox предоставляет иной подход к созданию пользовательского интерфейса, 
который отличается от табличной или блочной верстки. Развернутое описание стандарта по модулю можно посмотреть в <a href="https://drafts.csswg.org/css-flexbox/">спецификации</a>.</p>
<p>Благодаря Flexbox проще создавать сложные, комплексные интерфейсы, где мы с легкостью можем переопределять направление и выравнивание элементов, создавать адаптивные 
...
Microsoft Edge, Opera, Google Chrome, Safari, Firefox, имеют полную поддержку данного модуля.</p>
<p>Основными составляющими компоновки flexbox являются flex-контейнер (flex container) и flex-элементы (flex items). <span class="b">Flex container</span> представляет 
некоторый элемент, внутри которого размещены flex-элементы.</p>
<h3>Основные понятия</h3>
<p>Прежде чем переходить к изучению верстки flexbox, стоит рассмотреть некоторые основные понятия.</p>
<p>Одно из ключевых понятий представляет <span class="b">main axis</span> или центральная ось. Это условная ось во flex-контейнере, 
вдоль которой позиционируются flex-элементы.</p>
<img src="pics/flexbox21.png" alt="Main axis и cross axiss в flexbox и css 3" />
<p>Элементы в контейнере могут располагаться по горизонтали в виде строки и по вертикали в виде столбца. В зависимости от типа расположения будет меняться и центральная ось. 
Если расположение в виде строки, то центральная ось направлена горизонтально слева направо. Если расположение в виде столбца, то центральная ось направлена вертикально сверху вниз.</p>
<p>Термины <span class="b">main start</span> и <span class="b">main end</span> описывают соответственно начало и конец центральной оси, а расстояние между между ними обозначается 
как <span class="b">main size</span>.</p>
<p>Кроме основной оси существует также поперечная ось или <span class="b">cross axis</span>. Она перпендикулярна основной. При расположении элементов в виде строки cross axis 
направлена сверху вниз, а при расположении в виде столбца она направлена слева направо. Начало поперечной оси обозначается как <span class="b">cross start</span>, а ее 
конец - как <span class="b">cross end</span>. Расстояние между ними описывается термином <span class="b">cross size</span>.</p>
<p>То есть, если элементы располагаются в строку, то main size будет представлять ширину контейнера или элементов, а cross size - их высоту. Если же 
элементы располагаются в столбик, то, наоборот, main size представляет высоту контейнера и элементов, а cross size - их ширину.</p>
<h3>Создание flex-контейнера</h3>
<p>Для создания flex-контейнера необходимо присвоить его стилевому свойству <span class="b">display</span> одно из двух значений: 
<span class="b">flex</span> или <span class="b">inline-flex</span>.</p>
<p>Создадим простейшую веб-страницу, которая применяет flexbox:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Для контейнера flex-container установлено свойство <code>display:flex</code>. В нем располагается три flex-элемента.</p>
<img src="pics/flexbox1.png" alt="Flex Container в CSS3" />
<p>Если значение <code>flex</code> определяет контейнер как блочный элемент, то значение <code>inline-flex</code> определяет элемент как строчный (inline). Рассмотрим оба способа на примере:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox2.png" alt="inline-flex и flexbox в CSS3" />
<p>В частности, в первом случае flex-контейнер растягивается по ширине страницы, а во втором случае занимает именно столько места, сколько необходимо для flex-элементов.</p>
...
<div class="nav"><p><a href="10.11.php">Назад</a><a href="./">Содержание</a><a href="12.2.php">Вперед</a></p></div></div>
<div class="socBlock">
