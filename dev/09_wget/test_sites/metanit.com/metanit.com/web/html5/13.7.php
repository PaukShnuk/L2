...
<html >
<head>
<title>HTML5 | Наложение элементов в Grid Layout</title>
<meta charset="utf-8" />
<meta name="description" content="Наложение элементов друг на друга в Grid Layout в CSS3, создание слоев в гриде">
...
<h2>Наложение элементов</h2><div class="date">Последнее обновление: 09.05.2017</div>
...
<p>Манипулируя положением элементов мы легко можем осуществить их наложение, создать своего рода слои из элементов. Например, определим следующий грид:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Здесь первый элемент занимает то же пространство, что и пять следующих элементов. Благодаря установке свойства <code>z-index: 1</code> у всех элементов 
получается, что как первый элемент как-будто лежит фоном под другими пятью элементами.</p>
<img src="pics/grid24.png" alt="Создание слоя в Grid Layout и CSS3" />
<p>При необходимости слой из первого элемента можно наоборот перенести ближе к пользователю, накрыв остальные элементы. Для этого надо увеличить у него значение z-index:</p>
<pre class="brush:css;">
.item1{
	grid-area: 1 / 1 / 3 / 4;
	opacity: 0.8;
...
<img src="pics/grid25.png" alt="Наложение элементов в Grid Layout и CSS3" />
