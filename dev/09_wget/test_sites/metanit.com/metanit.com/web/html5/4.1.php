...
<html >
<head>
<title>HTML5 | Элемент article</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент article в семантической разметке в HTML5, его использование">
...
<h1>Семантическая структура страницы</h1><h2>Элемент article</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <span class="b">article</span> представляет целостный блок информации на странице, который может рассматриваться отдельно и использоваться 
независимо от других блоков. Например, это может быть пост на форуме или статья в блоге, онлайн-журнале, комментарий пользователя.</p>
<p>Один элемент article может включать несколько элементов article. Например, мы можем заключить в элемент article всю статью в блоге, и этот элемент будет содержать другие элементы 
article, которые представляют комментарии к этой статье в блоге. То есть статья в блоге может рассматриваться нами как отдельная семантическая единица, 
и в то же время комментарии также могут рассматривать отдельно вне зависимости от другого содержимого.</p>
<p>Использование article на примере статьи из блога с комментариями:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/3.1.png" alt="Семантическая разметка и элемент article в HTML5" />
<p>Здесь вся статья может быть помещена в элемент article, и в то же время каждый отдельный комментарий также представляет отдельный элемент article.</p>
<p>При использовании article надо учитывать, что каждый элемент article должен быть идентифицирован с помощью включения в него заголовка h1-h6.</p>
...
<div class="nav"><p><a href="3.14.php">Назад</a><a href="./">Содержание</a><a href="4.2.php">Вперед</a></p></div></div>
<div class="socBlock">
