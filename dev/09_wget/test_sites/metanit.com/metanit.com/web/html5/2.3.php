...
<html >
<head>
<title>HTML5 | Форматирование текста</title>
<meta charset="utf-8" />
<meta name="description" content="Форматирование текста в HTML5, выделение жирным, курсивом, подчеркивание и зачеркивание текста, различие между тегами b и strong">
...
<h2>Форматирование текста</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Ряд элементов html предназначены для форматирования текстового содержимого, например, для выделения жирным или курсивом и т.д. Рассмотрим эти 
элементы:</p>
<ul>
<li><p><span class="b">&lt;b&gt;</span>: выделяет текст жирным</p></li>
<li><p><span class="b">&lt;del&gt;</span>: зачеркивает текст</p></li>
<li><p><span class="b">&lt;i&gt;</span>: выделяет текст курсивом</p></li>
<li><p><span class="b">&lt;em&gt;</span>: выделяет текст курсивом, в отличие от тега <code>&lt;i&gt;</code> носит логическое значение, придает 
выделяемому тексту оттенок важности</p></li>
<li><p><span class="b">&lt;s&gt;</span>: зачеркивает текст</p></li>
<li><p><span class="b">&lt;small&gt;</span>: делает текст чуть меньше размером, чем окружающий</p></li>
<li><p><span class="b">&lt;strong&gt;</span>: выделяет текст жирным. В отличие от тега <code>&lt;b&gt;</code> предназначен для логического выделения, 
чтобы показать важность текста. А <code>&lt;b&gt;</code> не носит характера логического выделения, выполняет функции только форматирования</p></li>
<li><p><span class="b">&lt;sub&gt;</span>: помещает текст под строкой</p></li>
<li><p><span class="b">&lt;sup&gt;</span>: помещает текст над строкой</p></li>
<li><p><span class="b">&lt;u&gt;</span>: подчеркивает текст</p></li>
<li><p><span class="b">&ltins&gt;</span>: определяет вставленный (или добавленный) текст</p></li>
<li><p><span class="b">&lt;mark&gt;</span>: выделяет текст цветом, придавая ему оттенок важности</p></li>
</ul>
<p>Применим все эти элементы:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.21.png" alt="Форматирование текста в HTML5" />
