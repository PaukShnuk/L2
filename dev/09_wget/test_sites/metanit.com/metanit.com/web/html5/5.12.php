...
<html >
<head>
<title>CSS3 | Псевдоклассы форм</title>
<meta charset="utf-8" />
<meta name="description" content="Псевдоклассы форм в CSS 3, селекторы :checked, :enabled, :disabled, :required, :valid">
...
<h2>Псевдоклассы форм</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Ряд псевдоклассов используется для работы с элементами форм:</p>
<ul>
<li><p><span class="b">:enabled</span>: выбирает элемент, если он доступен для выбора (то есть у него не установлен атрибут disabled)</p></li>
<li><p><span class="b">:disabled</span>: выбирает элемент, если он не доступен для выбора (то есть у него установлен атрибут disabled)</p></li>
<li><p><span class="b">:checked</span>: выбирает элемент, если у него установлен атрибут checked (для флажков и радиокнопок)</p></li>
<li><p><span class="b">:default</span>: выбирает элементы по умолчанию</p></li>
<li><p><span class="b">:valid</span>: выбирает элемент, если его значение проходит валидацию HTML5</p></li>
<li><p><span class="b">:invalid</span>: выбирает элемент, если его значение не проходит валидацию</p></li>
<li><p><span class="b">:in-range</span>: выбирает элемент, если его значение находится в определенном диапазоне (для элементов типа ползунка)</p></li>
<li><p><span class="b">:out-of-range</span>: выбирает элемент, если его значение не находится в определенном диапазоне</p></li>
<li><p><span class="b">:required</span>: выбирает элемент, если у него установлен атрибут required</p></li>
<li><p><span class="b">:optional</span>: выбирает элемент, если у него не установлен атрибут required</p></li>
</ul>
<h3>Псевдоклассы enabled и disabled</h3>
<p>Псевдоклассы enabled и disabled выбирают элементы форм в зависимости от того, установлен ли у них атрибут <span class="b">disabled</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.71.png" alt="Псевдокласс enabled и disabled в CSS 3" />
<h3>Псевдокласс checked</h3>
<p>Псевдокласс <span class="b">checked</span> стилизует элементы формы, у которых установлен атрибут <code>checked</code>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Селектор <code>:checked + span</code> позволяет выбрать элемент, соседний с отмеченным элементом формы.</p>
<img src="pics/4.72.png" alt="Псевдокласс checked в CSS 3" />
<h3>Псевдокласс default</h3>
<p>Псевдокласс <span class="b">:default</span> выбирает стандартный элемент на форме. Как правило, в роли такого элемента выступает кнопка отправки:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.73.png" alt="Псевдокласс default в CSS 3" />
<h3>Псевдоклассы valid и invalid</h3>
<p>Псевдоклассы <span class="b">:valid</span> и <span class="b">:invalid</span> стилизуют элементы формы в зависимости от того, проходят они валидацию или нет.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.74.png" alt="Псевдоклассы valid и invalid в CSS 3" />
<h3>Псевдоклассы in-range и out-of-range</h3>
<p>Псевдоклассы <span class="b">:in-range</span> и <span class="b">:out-of-range</span> стилизуют элементы формы в зависимости от того, попадает ли 
их значение в определенный диапазон. Это в первую очередь относится к элементу <code>&lt;input type="number" &gt;</code>.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Здесь атрибуты <code>min</code> и <code>max</code> задают диапазон, в которое должно попадать вводимое в поле значение:</p>
<img src="pics/4.75.png" alt="Псевдоклассы in-range и out-of-range в CSS 3" />
<h3>Псевдоклассы required и optional</h3>
<p>Псевдоклассы <span class="b">:required</span> и <span class="b">:optional</span> стилизуют элемент в зависимости от того, установлен ли у него атрибут <code>required</code>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/4.76.png" alt="Псевдоклассы required и optional в CSS 3" />
...
<div class="nav"><p><a href="5.11.php">Назад</a><a href="./">Содержание</a><a href="5.6.php">Вперед</a></p></div></div>
<div class="socBlock">
