...
<html >
<head>
<title>HTML5 | Аудио</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с аудио в HTML5, элемент audio и воспроизведене звука, поддерживаемые форматы, кроссбраузерность, атрибуты и настройка элемента">
...
<h2>Аудио</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Для воспроизведения звука без видео в HTML5 применяется элемент <span class="b">audio</span>. Он во многом похож на элемент video. Для настройки элемента 
audio мы можем использовать следующие его атрибуты:</p>
<ul>
<li><p><code>src</code>: путь к аудиофайлу</p></li>
...
<li><p><code>loop</code>: задает повторение аудиофайла</p></li>
<li><p><code>muted</code>: отключает звук по умолчанию</p></li>
<li><p><code>preload</code>: устанавливает режим загрузки файла</p></li>
</ul>
<p>Действие всех этих атрибутов будет аналогично их действию в элементе video.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/5.2.png" alt="Аудио в HTML5" />
<p>Опять же в зависимости от браузера внешний вид элементов управления может отличаться. Выше приведен пример для Google Chrome. А в Firefox они будут 
выглядеть немного иначе:</p>
<img src="pics/5.3.png" alt="Audio в HTML5 в Firefox" />
<h3>Поддержка форматов аудио</h3>
<p>Ключевым моментом для работы с аудио является поддержка браузером тех или иных форматов. На данный момент подавляющее большинство браузеров поддерживают mp3. 
...
элемент <code>source</code> и указать аудио в иных форматах:</p>
<pre class="brush:xml;">
...
<p>Как и в случае с элементом <code>video</code>, здесь у элемента source устанавливается атрибут <code>src</code> с ссылкой на файл и атрибут <code>type</code> - тип файла.</p>
