...
<html >
<head>
<title>HTML5 | Grid Layout</title>
<meta charset="utf-8" />
<meta name="description" content="Модуль Grid Layout в HTML5 и CSS3, создание веб-страницы в виде сетки, определение grid-контейнера">
...
<h1>Grid Layout</h1><h2>Что такое Grid Layout. Grid Container</h2><div class="date">Последнее обновление: 09.05.2017</div>
...
<p>Grid Layout представляет специальный модуль CSS3, который позволяет позиционировать элементы в виде сетки или таблицы. Как и Flexbox, Grid Layout представляет гибкий подход к компоновке элементов, только если flexbox размещает вложенные элементы в одном направлении - по горизонтали в виде столбиков или 
по вертикали в виде строк, то Grid позиционирует элементы сразу в двух направлениях - в виде строк и столбцов, образуя тем самым таблицу.</p>
<p>Полностью спецификацию модуля Grid Layout можно посмотреть на странице <a href="www.w3.org/TR/css-grid-1/" rel="nofollow">www.w3.org/TR/css-grid-1/</a>.</p>
<h3>Поддержка браузерами</h3>
<p>При использовании Grid Layout следует учитывать, что только относительно недавно производители браузеров стали внедрять поддержку этого модуля в свои браузеры. Ниже приводится для браузеров 
список версий, начиная с которых была внедрена полноценная поддержка Grid Layout:</p>
<ul>
<li><p>Google Chrome - с версии 57</p></li>
<li><p>Mozilla Firefox - с версии 52</p></li>
<li><p>Opera - с версии 44</p></li>
<li><p>Safari - с версии 10.1</p></li>
<li><p>iOS Safari - с версии 10.3</p></li>
</ul>
<p>Как можно заметить, большинство этих версий браузеров вышли в начале 2017 года. То есть на более старые версии этих браузеров рассчитывать не приходится.</p>
<p>Кроме того, IE (начиная с версии 10) и Microsoft Edge имеет лишь частичную поддержку модуля. А Android Browser, Opera Mini, UC Browser вовсе 
ее не имеют.</p>
<h3>Создание grid-контейнера</h3>
<p>Основой для определения компоновки Grid Layout является grid container, внутри которого размещаются элементы. Для создания grid-контейнера необходимо присвоить его стилевому свойству <span class="b">display</span> одно из двух значений: <span class="b">grid</span> или 
<span class="b">inline-grid</span>.</p>
<p>Создадим простейшую веб-страницу, которая применяет Grid Layout:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>Для контейнера grid-container установлено свойство <code>display:grid</code>. В нем располагается пять grid-элементов.</p>
<img src="pics/grid2.png" alt="Grid Container в Grid Layout в CSS3" />
<p>Если значение grid определяет контейнер как блочный элемент, то значение inline-grid определяет элемент как строчный (inline):</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>В этом случае весь грид занимает только то пространство, которое необходимо для размещения его элементов.</p>
<img src="pics/grid3.png" alt="inline-grid в CSS 3" />
...
<div class="nav"><p><a href="12.10.php">Назад</a><a href="./">Содержание</a><a href="13.2.php">Вперед</a></p></div></div>
<div class="socBlock">
