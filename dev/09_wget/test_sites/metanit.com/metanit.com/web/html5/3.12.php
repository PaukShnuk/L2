...
<meta charset="utf-8" />
<meta name="description" content="Многострочное текстовое поле в HTML5, элемент textarea и его настройка">
...
<h2>Textarea</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <code>&lt;input type="text" /&gt;</code> позволяет создавать простое однострочное текстовое поле. Однако возможностей этого элемента по вводу текста бывает недостаточно, 
и в этой ситуации мы можем использовать многострочное текстовое поле, представленное элементом <span class="b">textarea</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.28.png" alt="Textarea в HTML5" />
<p>С помощью дополнительных атрибутов <span class="b">cols</span> и <code>rows</code> можно задать соответственно количество столбцов и строк:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/2.29.png" alt="Настройка textarea в HTML5" />
