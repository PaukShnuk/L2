...
<html >
<head>
<title>HTML5 | Блочная верстка</title>
<meta charset="utf-8" />
<meta name="description" content="Блочная верстка в HTML 5, создание макета страницы из нескольких колонок">
...
<h2>Блочная верстка. Часть 2</h2><div class="date">Последнее обновление: 24.04.2016</div>
...
<p>В прошлой теме было рассмотрено создание страницы с двумя колонками. Подобным образом мы можем добавить на страницу и 
большее количество колонок и сделать более сложную структуру. Например, добавим на веб-страницу второй сайдбар:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/7.4.png" alt="Блочная верстка из трех колонок в HTML5" />
<p>Здесь опять же код обоих сайдбаров должен идти до блока с основным содержимым, который обтекает их.</p>
<p>Теперь изменим стили обоих сайдбаров и основного блока:</p>
<pre class="brush:css;">
#leftSidebar{
	background-color: #ddd;
	float: left;
...
<p>Опять же у обоих плавающих блоков - сайдбаров нам надо установить ширину и свойство <code>float</code> - у одного значение <code>left</code>, а у 
другого <code>right</code>.</p>
<img src="pics/7.5.png" alt="Блочная верстка из трех колонок в CSS3" />
