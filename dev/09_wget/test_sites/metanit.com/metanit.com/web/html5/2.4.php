...
<html >
<head>
<title>HTML5 | Работа с изображениями</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с изображениями в HTML5, элемент img и его атрибуты">
...
<h2>Работа с изображениями</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Для вывода изображений в HTML используется элемент <span class="b">img</span>. Этот элемент представляет нам два важных атрибута:</p>
<ul>
<li><p><span class="b">src</span>: путь к изображению. Это может быть относительный или абсолютный путь в файловой системе или адрес в интернете</p></li>
<li><p><span class="b">alt</span>: текстовое описание изображения. Если браузер по каким-то причинам не может отобразить изображение (например, если у атрибута 
src некорректно задан путь), то браузер показывает вместо самой картинки данное текстовое описание.</p>
<p>Атрибут <code>alt</code> еще важен тем, что поисковые системы по текстовому описанию могут индексировать изображение.</p></li>
</ul>
<p>Например, положим в ту же папку, где у нас лежит файл <i>index.html</i>, какой-нибудь файл изображения. И затем отобразим его на веб-странице:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.22.png" alt="Тег img в HTML5" />
<p>В моем случае файл изображения называется <i>dubi.png</i>, и он находится в одной папке с веб-странице index.html. При этом надо учитывать, что <code>img</code> является пустым элементом, то есть не содержим закрывающегося тега.</p>
<p>Используя стилевые особенности, в частности, отступы и обтекание, можно комбинировать изображения с текстом. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.23.png" alt="Обтекание изображения текстом в HTML5" />
