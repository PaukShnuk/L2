...
<html >
<head>
<title>CSS3 | Внутренние отступы</title>
<meta charset="utf-8" />
<meta name="description" content="Внутренние отступы в CSS 3, свойство padding">
...
<h2>Внутренние отступы</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Свойство <span class="b">padding</span> задает внутренние отступы от границы элемента до его внутреннего содержимого. Как и для свойство margin, в CSS 
имеются четыре свойства, которые устанавливают отступы для каждой из сторон:</p>
<ul>
<li><p><span class="b">padding-top</span>: отступ сверху</p></li>
<li><p><span class="b">padding-bottom</span>: отступ снизу</p></li>
<li><p><span class="b">padding-left</span>: отступ слева</p></li>
<li><p><span class="b">padding-right</span>: отступ справа</p></li>
</ul>
<p>Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
...
<img src="pics/4.42.png" alt="Padding в CSS 3" />
<p>Для установки значения отступов, как и в margin, могут применяться либо конкретные значения в пикселях, так и процентные значения (относительно 
размеров элементов).</p>
<p>Для записи отступов также можно использовать сокращенную запись:</p>
<pre class="brush:css;">
...
<p>Если все четыре значения совпадают, то можно писать указать только одно значение для всех отступов:</p>
<pre class="brush:css;">
div.outer{
