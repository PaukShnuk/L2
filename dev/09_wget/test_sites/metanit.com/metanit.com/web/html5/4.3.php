...
<html >
<head>
<title>HTML5 | Элемент nav</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент nav в семантической разметке в HTML5, создание элементов навигации">
...
<h2>Элемент nav</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент <span class="b">nav</span> призван содержать элементы навигации по сайту. Как правило, это ненумерованный список с набором ссылок.</p>
<p>На одной веб-странице можно использовать несколько элементов nav. Например, один элемент навигации для перехода по страницам на сайте, а другой - 
для перехода внутри html-документа.</p>
<p>Не все ссылки обязательно помещать в элемент <span class="b">nav</span>. Например, некоторые ссылки могут не представлять связанного блока 
навигации, например, ссылка на главную страницу, на лицензионное соглашение по поводу использования сервиса и подобные ссылки, которые часто помещаются внизу страницы. 
Как правило, их достаточно определить в элементе footer, а элемент nav для них использовать необязательно.</p>
<p>Используем элемент nav для создания навигационного меню:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/3.3.png" alt="Элемент nav в HTML5" />
<p>В данном случае определены два блока nav - один для межстраничной навигации, а другой - для навигации внутри страницы.</p>
<p>Необязательно все ссылки помещать в элементы nav. Так, в данном случае ряд ссылок располагаются в элементе footer.</p>
