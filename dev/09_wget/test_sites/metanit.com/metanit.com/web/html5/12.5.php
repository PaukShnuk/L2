...
<html >
<head>
<title>HTML5 | Выравнивание элементов. justify-content</title>
<meta charset="utf-8" />
<meta name="description" content="Выравнивание элементов по основной оси main axis во Flexbox в HTML5 и CSS3, свойство justify-content">
...
<h2>Выравнивание элементов. justify-content</h2><div class="date">Последнее обновление: 18.04.2017</div>
...
<p>Иногда мы можем сталкиваться с тем, что пространство flex-контейнеров по размеру отличается от пространства, необходимого для flex-элементов. Например:</p>
<ul>
<li><p>flex-элементы не используют все пространство flex-контейнера</p></li>
<li><p>flex-элементам требуется большее пространство, чем доступно во flex-контейнере. В этом случае элементы выходят за пределы контейнера.</p></li>
</ul>
<p>Для управления этими ситуациями мы можем применять свойство <span class="b">justify-content</span>. Оно выравнивает элементы вдоль основной оси - main axis 
(при расположении в виде строки по горизонтали, при расположении в виде столбца - по вертикали) и принимает следующие значения:</p>
<ul>
<li><p><span class="b">flex-start</span>: значение по умолчанию, при котором первый элемент выравнивается по левому краю контейнера(при расположении в виде строки) или по верху (при расположении в виде столбца), за ним располагается второй элемент и так далее.</p></li>
<li><p><span class="b">flex-end</span>: последний элемент выравнивается по правому краю (при расположении в виде строки) или по низу (при расположении в виде столбца) контейнера, за ним выравнивается предпоследний элемент и так далее</p></li>
<li><p><span class="b">center</span>: элементы выравниваются по центру</p></li>
<li><p><span class="b">space-between</span>: если в стоке только один элемент или элементы выходят за границы flex-контейнера, то данное значение аналогично 
<code>flex-start</code>. В остальных случаях первый элемент выравнивается по левому краю (при расположении в виде строки) или по верху (при расположении в виде столбца), а 
...
между ними равным образом распределяется между остальными элементами</p></li>
<li><p><span class="b">space-around</span>: если в строке только один элемент или элементы выходят за пределы контейнера, то его действие аналогично значению 
<code>center</code>. В ином случае элементы равным образом распределяют пространство между левым и правым краем контейнера, а расстояние между первым и последним элементом 
и границами контейнера составляет половину расстояния между элементами.</p></li>
</ul>
<p>Выравнивание для расположения элементов в виде строки:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/flexbox9.png" alt="justify-content в Flexbox и CSS3" />
<p>Выравнивание при расположении в виде столбцов:</p>
<img src="pics/flexbox10.png" alt="justify-content и column в Flexbox и CSS3" />
...
<div class="nav"><p><a href="12.4.php">Назад</a><a href="./">Содержание</a><a href="12.6.php">Вперед</a></p></div></div>
<div class="socBlock">
