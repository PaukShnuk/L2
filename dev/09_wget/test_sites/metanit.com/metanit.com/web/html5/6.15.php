...
<html >
<head>
<title>CSS3 | Создание тени у элемента</title>
<meta charset="utf-8" />
<meta name="description" content="Создание тени у элемента в CSS 3, свойство box-shadow">
...
<h2>Создание тени у элемента</h2><div class="date">Последнее обновление: 21.04.2016</div>
...
<p>Свойство <span class="b">box-shadow</span> позволяет создать у элемента тень. Это свойство может принимать сразу несколько значений:</p>
<pre class="brush:css;">box-shadow: hoffset voffset blur spread color inset</pre>
<ul>
<li><p><code>hoffset</code>: горизонтальное смещение тени относительно элемента. При положительном значении тень смещается вправо, а при 
отрицательном - влево</p></li>
<li><p><code>voffset</code>: вертикальное смещение тени относительно элемента. При положительном значении тень смещается вниз, а при 
отрицательном - вверх</p></li>
<li><p><code>blur</code>: необязательное значение, которое определяет радиус размытия тени. Чем больше это значение, 
тем более размытыми будут края тени. По умолчанию имеет значение 0.</p></li>
<li><p><code>spread</code>: необязательное значение, которое определяет направление тени. Положительное значение распространяет тень во вне 
во всех направлениях от элемента, а отрицательное значение направляет тень к элементу</p></li>
<li><p><code>color</code>: необязательное значение, которое устанавливает цвет тени</p></li>
<li><p><code>inset</code>: необязательное значение, которое заставляет рисовать тент внутри блока элемента</p></li>
</ul>
<p>Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
...
<img src="pics/4.53.png" alt="Свойство box-shadow в CSS 3" />
<p>Через запятую можно определить несколько различных теней:</p>
<pre class="brush:xml;">
...
<div class="nav"><p><a href="6.14.php">Назад</a><a href="./">Содержание</a><a href="6.16.php">Вперед</a></p></div></div>
<div class="socBlock">
