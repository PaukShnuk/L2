...
<html >
<head>
<title>HTML5 | Элемент section</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент section в семантической разметке в HTML5, его использование">
...
<h2>Элемент section</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Элемент section объединяет связанные между собой куски информации html-документа, выполняя их группировку. Например, section может включать 
набор вкладок на странице, новости, объединенные по категории и т.д.</p>
<p>Каждый элемент section должен быть идентифицирован с помощью заголовка h1-h6.</p>
<p>При этом элемент section может содержать несколько элементов article, выполняя их группировку, так и один элемент article может содержать несколько элементов section.</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/3.2.png" alt="Семантическая разметка и элемент section в HTML5" />
<p>Здесь для блока основного содержимого создается секция и для набора комментариев также создается элемент section.</p>
