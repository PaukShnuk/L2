...
<html >
<head>
<title>HTML5 | Фреймы</title>
<meta charset="utf-8" />
<meta name="description" content="Фреймы в HTML5, настройка фреймов, элемент iframe, загрузка других веб-страниц">
...
<h2>Фреймы</h2><div class="date">Последнее обновление: 08.04.2016</div>
...
<p>Фреймы позволяют встраивать на веб-страницу еще какую-нибудь другую веб-страницу. Фреймы представлены элементом <span class="b">iframe</span>. Допустим, 
нам надо встроить на веб-страницу стартовую страницу википедии:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
	&lt;head&gt;
...
<img src="pics/1.33.png" alt="iframe в html5" />
<p>Элемент <code>iframe</code> не содержит в себе никакого содержимого. Вся его настройка производится с помощью атрибутов:</p>
<ul>
<li><p><code>src</code>: устанавливает полный путь к загружаемому ресурсу</p></li>
<li><p><code>width</code>: ширина фрейма</p></li>
<li><p><code>height</code>: высота фрейма</p></li>
</ul>
<p>Надо отметить, что не все сайты могут открываться во фреймах, поскольку на стороне веб-сервера могут действовать ограничения на открытие во фреймах.</p>
