...
<html >
<head>
<title>HTML5 | Фиксированное позиционирование</title>
<meta charset="utf-8" />
<meta name="description" content="Фиксированное позиционирование элементов веб-страницы в HTML 5 и CSS, фиксация навигационной панели">
...
<h2>Фиксированное позиционирование</h2><div class="date">Последнее обновление: 28.04.2016</div>
...
<p>Фиксированное позиционирование является распространенным способом удержать в области просмотра браузера некоторые элементы. Достаточно часто на различных сайтах 
можно увидеть фиксированную панель навигации, которая не изменяет своего положения вне зависимости от прокрутки.</p>
<p>Для фиксированного позиционирования у элементов нужно установить значение <span class="b">fixed</span> для свойства <span class="b">position</span>. После 
этого с помощью стандартных свойств <code>left</code>, <code>right</code>, <code>top</code> и <code>bottom</code> можно определить конкретную 
позицию фиксированного элемента.</p>
<p>Создадим к примеру фиксированную панель навигации:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<img src="pics/7.25.png" alt="Фиксированный блок в HTML и CSS" />
<p>Чтобы растянуть фиксированный блок от левой до правой границы страницы, устанавливаются три свойства:</p>
<pre class="brush:css;">
top: 0;
left: 0;
right: 0;
</pre>
<p>Для нижележащего блока с основным содержанием фиксированный элемент фактически не существует разметке, так как блок с фиксированным, как и с абсолютным позиционированием 
...
установив нужный отступ:</p>
<pre class="brush:css;">
margin-top: 50px;
</pre>
<p>Фактически отступ идет от границ области просмотра браузера, поэтому высота отступа должна быть больше высоты фиксированного элемента.</p>
...
<div class="nav"><p><a href="8.9.php">Назад</a><a href="./">Содержание</a><a href="9.1.php">Вперед</a></p></div></div>
<div class="socBlock">
