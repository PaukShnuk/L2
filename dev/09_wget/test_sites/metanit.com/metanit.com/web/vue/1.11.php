...
<html >
<head>
<title>Vue 3 | refs и управление html-элементами</title>
<meta charset="utf-8" />
<meta name="description" content="Ссылка refs и управление html-элементами во Vue 3">
...
<h2>refs и управление html-элементами</h2><div class="date">Последнее обновление: 05.11.2020</div>
...
<p>С помощью параметра <span class="b">refs</span> во Vue 3 позволяет напрямую работать с определенными html-элементами из 
шаблона, например, можно изменять их стили, текст и т.д. Так, определим следующую html-страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>С помощью атрибута <span class="b">ref</span> для html-элемента устанавливается ключ, через который потом можно ссылаться на этот элемент.</p>
<pre class="brush:xml;">&lt;h2 ref="header"&gt;Hello world!&lt;/h2&gt;</pre>
<p>В методах объекта Vue можно обратиться к элементу по установленному ключу через объект <span class="b">$refs</span>:</p>
<pre class="brush:js;">this.$refs.header.innerText = "Welcome to Vue.js";</pre>
<p>С объектом, который представляет html-элемент, (в данном случае <code>this.$refs.header</code>) фактически можно также работать, как и со стандартныи объектами 
JavaScript, которые представляют html-элементы. То есть мы можем обратиться к его свойствам innerText или innerHTML. 
Хотя в реальности объект <code>this.$refs.header</code> будет представлять надстройку над объектом js, который собственно и 
представляет html-элемент. Но фактически через <code>this.$refs.header</code> мы сможем уравлять элементом h2 на веб-странице.</p>
<img src="./pics/34.png" alt="Параметр $refs и управдение html-элементами во Vue 3" />
<p>Подобным образом можно обращаться и к другим свойствам html-элемента и управлять ими.</p>
...
<div class="nav"><p><a href="1.9.php">Назад</a><a href="./">Содержание</a><a href="1.10.php">Вперед</a></p></div></div>
<div class="socBlock">
