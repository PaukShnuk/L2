...
<html >
<head>
<title>Vue 3 | Состояние и поведение компонентов</title>
<meta charset="utf-8" />
<meta name="description" content="Состояние и поведение компонентов во Vue 3, параметры data и methods">
...
<h2>Состояние и поведение компонентов</h2><div class="date">Последнее обновление: 03.11.2020</div>
...
<h3>Параметр data</h3>
<p>Компоненты могут содержать некоторые данные или состояние в виде параметра <span class="b">data</span> - в принципе как и объекты приложения Vue. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/40.png" alt="Данные компонентов и параметр data в Vue 3" />
<p>Подобным образом можно определять данные в локально регистрируемых компонентах:</p>
<pre class="brush:xml;">
&lt;div id="app"&gt;
    &lt;counter&gt;&lt;/counter&gt;
&lt;/div&gt;
...
<p>Может возникнуть вопрос, а что если и объект приложения, и компонент этого приложения одновременно определяют свойство с одинаковым называнием. 
В этом случае компонент будет использовать свое собственное свойство. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/40.1.png" alt="Данные компонентов и приложения в Vue 3" />
<h3>Параметр methods</h3>
<p>Кроме состояния компоненты могут определять поведение в виде методов, которые определяются через параметр methods, как и в объектах Vue:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>В данном случае по нажатию на кнопку вызывается метод increase, который увеличивает значение свойства count.</p>
<img src="./pics/41.png" alt="Методы в компонентах во Vue 3" />
