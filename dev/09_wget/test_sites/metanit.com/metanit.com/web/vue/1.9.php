...
<html >
<head>
<title>Vue 3 | Привязка стилей</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка к стилям в Vue 3, v-bind:style, динамическое управление стилями элемента html, переключение стилей">
...
<h2>Привязка к стилям</h2><div class="date">Последнее обновление: 01.11.2020</div>
...
<p>Подобно классам CSS во Vue 3 с помощью привязки атрибутов можно управлять стилями html-элемента. Для привязки к стилям атрибуту style можно передать 
объект, который содержит стилевые свойства и их значения:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Для установки стилей атрибуту style предаются названия свойств css и их значения. При этом в качестве значения могут выступать как обычные значения стилевых свойств, так и 
свойства из объекта Vue, через которые мы можем манипулировать стилями.</p>
<p>Стоит учитывать, что если свойство css в своем названии имеет дефисы, то название свойства заключается в кавычки, как в случае со свойством background-color.</p>
<img src="./pics/16.png" alt="Привязка стилей и атрибут v-bind:style во Vue 3" />
<p>Если необходимо установливать много различных стилевых свойств, то их можно вынести в отдельное вычисляемое свойство:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Фактически каждый такой объект представляет отдельный стиль.</p>
<p>Если нужно задать для элемента сразу несколько подобных стилей, то они передаются в квадратных скобках:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<div class="nav"><p><a href="1.8.php">Назад</a><a href="./">Содержание</a><a href="1.11.php">Вперед</a></p></div></div>
<div class="socBlock">
