...
<html >
<head>
<title>Vue 3| Управление массивами</title>
<meta charset="utf-8" />
<meta name="description" content="Управление массивами в Vue 3, добавление и удаление элементов, изменение и фильтрация массива">
...
<h2>Управление массивами</h2><div class="date">Последнее обновление: 02.11.2020</div>
...
<p>Для упрощения работы с массивами во Vue 3 для каждого объекта массива определено ряд методов, с помощью которых можно управлять его элементами:</p>
<ul>
...
<p>Все эти методы по сути являются обертками над одноименными <a href="https://metanit.com/web/javascript/5.3.php">стандартными методами</a> javascript для управления массивами и работают точно также. 
Главное их отличие от стандартных методов JavaScript состоит в том, что эти методы-обертки информируют систему Vue 3 о том, что с массивом были произведены некоторые действия, и 
...
<p>При нажатии на кнопку в массив добавляется введенное в текстовое поле значение, которое доступно через свойство newPhone. И в итоге 
произойдет обновление списка на веб-странице, и мы увидим добавленный элемент.</p>
<p>И кроме того, для каждого элемента предусмотрена кнопка, через которую по индексу можно удалить элемент из массива.</p>
<img src="./pics/27.png" alt="Управление массивом, добавление и удаление элементов в массив в Vue 3" />
<h3>Возвращение нового массива</h3>
...
<img src="./pics/28.png" alt="Создание нового массива с помощью функции slice в Vue 3" />
...
<img src="./pics/28.1.png" alt="Создание нового массива без изменения старого в Vue 3" />
