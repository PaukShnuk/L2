...
<html >
<head>
<title>Vue 3 | Наблюдаемые свойства</title>
<meta charset="utf-8" />
<meta name="description" content="Наблюдаемые свойства watcher в Vue.js, параметр watch, отслеживание изменения свойств, асинхронные операции">
...
<h2>Наблюдаемые свойства</h2><div class="date">Последнее обновление: 01.11.2020</div>
...
<p>Кроме вычисляемых свойств Vue 3 позволяет определять <span class="b">наблюдаемые свойства</span> или <span class="b">watchers</span>. 
Наблюдаемые свойства, как правило, применяются для выполнения асинхронных действий, особенно таких, которые могут занять продолжительное время, например, отправка запроса на сервер.</p>
...
свойство age, которое указывает на функцию. Причем в параметре <span class="b">data</span> также определяется свойство age. При изменении свойства age, которое определено в секции data, 
будет вызываться функция age, определенная в параметре watch. Измененное значение будет передаваться в функцию через параметр newAge.</p>
<p>Функция age в зависимости от нового значения свойства age вызывает метод check. В этом методе проверяется введенное значение и 
...
<img src="./pics/30.png" alt="параметр watch и watcher в Vue 3" />
<p>И затем и собственно результат проверки:</p>
<img src="./pics/31.png" alt="наблюдаемые свойства во Vue 3" />
...
<div class="nav"><p><a href="1.6.php">Назад</a><a href="./">Содержание</a><a href="1.8.php">Вперед</a></p></div></div>
<div class="socBlock">
