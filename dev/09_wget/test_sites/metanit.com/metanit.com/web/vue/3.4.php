...
<html >
<head>
<title>Vue 3 | Список select</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка к элементу select во Vue 3, выпадающий список и список с множественным выбором, привязка к коллекции объектов">
...
<h2>Список select</h2><div class="date">Последнее обновление: 02.11.2020</div>
...
<p>Элемент select позволяет создать список с возможностью одиночного либо множественного выбора. При привязке к элементу 
<code>&lt;select&gt;</code> директива <code>v-model</code> отслеживает свойство <code>value</code> вложенных в select элементов <code>&lt;option&gt;</code> 
и событие <code>change</code> для отслеживания изменения выбиранного элемента. При этом значение атрибута <code>selected</code> у элементов option игнорируется.</p>
...
<img src="./pics/3.4.png" alt="Привязка к списку select в Vue 3" />
...
<img src="./pics/3.5.png" alt="Привязка к элементу select с множественным выбором в Vue 3" />
...
<p>В данном случае в списке отображается значение свойства name объекта из массива и это же свойство name будет использоваться в качестве значения при выборе элемента.</p>
<img src="./pics/3.7.png" alt="Привязка выбранного объекта в списке select в Vue 3" />
<p>Однако мы можем выбирать и весь объект в целом:</p>
<pre class="brush:xml;">
&lt;div id="app"&gt;
    &lt;select v-model="selectedUser"&gt;
...
<img src="./pics/3.7.1.png" alt="Выбор объектов в списке select в Vue 3" />
...
<img src="./pics/3.6.png" alt="Множественный выбор с привязкой в select в Vue 3" />
