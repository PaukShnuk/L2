...
<html >
<head>
<title>Vue 3 | Привязка классов</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка классов в Vue 3, v-bind:class, динамическое добавление и удаление класса у элемента html, переключение классов">
...
<h2>Привязка классов</h2><div class="date">Последнее обновление: 01.11.2020</div>
...
<p>Привязка атрибута <code>class</code> во Vue 3 позволяет динамически управлять классами и соответственно визуальным 
отображением элементов. Для примера привязки классов рассмотрим следующую страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь определен элемент <code>div</code> с классом <code>region</code>. Кроме того, к этому элементу применяется условная привязка классов. Она имеет форму:</p>
<pre class="brush:js;">{класс_1: true|false, класс_2: true|false, класс_N: true|false}</pre>
<p>Если для класса определено значение true, то этот класс применяется. В данном случае применение класса зависит от свойства <code>isActive</code>, 
которое определено в приложении Vue. А с помощью события click у элемента div мы можем переключить значение свойства isActive, и, следовательно, включить или отключить класс active.</p>
<p>При этом не столь важно, определены у элемента какие-либо еще классы, все они вместе будут применяться к элементу.</p>
<img src="./pics/13.png" alt="Условное применение классов и привязка классов в Vue 3" />
<p>Подобным образом можно привязать несколько классов:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/13.1png" alt="Множественная привязка классов в Vue 3" />
<p>Если название класса имеет какие-либо неалфавитно-цифровые символы, то оно помещается в кавычки:</p>
<pre class="brush:js;">v-bind:class="{'active-color': isActive, bounded: isBounded}"</pre>
<p>Если необходимо устанавливать много классов, то для них можно определить один вычисляемый объект:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Также можно выполнить простую привязку к свойству, которое хранит название класса:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь привязка атрибута class будет идти к свойству color. С помощью ввода в текстовое поле через двусторонюю привязку мы можем изменить значение 
этого свойства и соответственно поменять класс:</p>
<img src="./pics/14.png" alt="Привязка классов в Vue 3" />
<p>Если надо установить привязку сразу к нескольким классом, то их можно перечислить в квадратных скобках:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/15.png" alt="Классы во Vue 3" />
...
<div class="nav"><p><a href="1.7.php">Назад</a><a href="./">Содержание</a><a href="1.9.php">Вперед</a></p></div></div>
<div class="socBlock">
