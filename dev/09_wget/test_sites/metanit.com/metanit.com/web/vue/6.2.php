...
<html >
<head>
<title>Vue 3 | Навигация и ссылки</title>
<meta charset="utf-8" />
<meta name="description" content="Создание системы навигации во Vue 3, определение ссылок, компонент router-link, стилизация активной ссылки">
...
<h2>Навигация и ссылки</h2><div class="date">Последнее обновление: 04.11.2020</div>
...
<p>Для создания системы ссылок в приложении Vue 3 применяется компонент <span class="b">router-link</span>. С помощью свойства <span class="b">to</span/> у данного компонента 
...
<img src="./pics/router3.png" alt="Навигация в приложении Vue 3 и router-link" />
