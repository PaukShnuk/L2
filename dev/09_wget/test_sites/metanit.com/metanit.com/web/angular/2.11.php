...
<html >
<head>
<title>Директивы стилизации и управления элементами в AngularJS</title>
<meta charset="utf-8" />
...
<h2>Директивы стилизации и управления элементами</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>В особую группу директив можно выделить директивы, которые позволяют стилизовать элементы или управлять ими:</p>
<ul>
<li><p><span class="bb">ng-style</span>: устанавливает у элемента стили css</p></li>
<li><p><span class="bb">ng-class</span>: задает элементу определенный класс</p></li>
<li><p><span class="bb">ng-class-even</span>: устанавливает класс для четных элементов</p></li>
<li><p><span class="bb">ng-class-odd</span>:  устанавливает класс для нечетных элементов</p></li>
<li><p><span class="bb">ng-hide</span>: скрывает элемент</p></li>
<li><p><span class="bb">ng-show</span>: делает элемент видимым</p></li>
<li><p><span class="bb">ng-if</span>: задает для элемента некоторое условие</p></li>
</ul>
<h3>ng-class и ng-style</h3>
<p>Данные директивы служат стилизации элементов. Объявим в контроллере два объекта:</p>
<pre class="brush:js;">
$scope.somestyle={background: '#eee', color:'#333'};
$scope.someclass="myclass";
</pre>
<p>myclass в данном случае - это название класса, который содержит определение в файле стилей css. И на страничке будет такая разметка:</p>
<pre class="brush:xml;">
...
<h3>ng-show и ng-hide</h3>
<p>Директивы ngshow и nghide служат для отображения и скрытия элемента соответственно. Например, создадим в контроллере еще один объект для хранения 
булевых значений:</p>
<pre class="brush:js;">
$scope.data={visible : false};
</pre>
<p>В разметке страницы создадим два параграфа и флажок, переключая который, мы будем управлять видимостью параграфов:</p>
<pre class="brush:xml;">
...
<p>Первоначально у нас объект data.visible равен false, поэтому первый блок будет не виден. Изменяя значение флажка, который привязан к объекту 
visible опять же через директиву ng-model, мы также изменяем значение data.visible, что изменяет видимость параграфов.</p>
<img src="pics/6.png" />
<h3>ng-if</h3>
<p>Действие <code>ng-if</code> во многом похоже на действие <code>ng-show/ng-hide</code>. Если ng-if принимает значение <code>false</code>, то элемент с директивой 
удаляется из структуры DOM, а при значении <code>true</code>, наоборот, добавляется:</p>
<pre class="brush:xml;">
&lt;div ng-controller="phoneController"&gt;
&lt;input type="checkbox" ng-model="data.visible"&gt;Открыть/скрыть
...
<div class="nav"><p><a href="2.10.php">Назад</a><a href="./">Содержание</a><a href="2.3.php">Вперед</a></p></div></div>
<div class="socBlock">
