...
<html >
<head>
<title>Внедрение шаблонов в AngularJS</title>
<meta charset="utf-8" />
<meta name="description" content="Внедрение шаблонов в директивах в AngularJS, transclusion">
...
<h2>Внедрение шаблонов</h2><div class="date">Последнее обновление: 26.04.2017</div>
...
<p>AngularJS при создании директив поддерживает такую функциональность как <span class="b">transclusion</span>, которая представляет внедрение 
html-кода извне в шаблон. Например, возьмем директиву answerList из прошлой темы и изменим ее</p>
<pre class="brush:js;">
...
<p>Параметр <code>transclude: true</code> подключает функциональность внедрения.</p>
<p>Теперь изменим файл шаблона <span class="b">answersTemplate.html</span>:</p>
<pre class="brush:xml;">
&lt;div class="answers"&gt;
...
<p>По сравнению с кодом из прошлой темы здесь был добавлен элемент <code>&lt;div ng-transclude&gt;&lt;/div&gt;</code>. Директива <span class="bb">ng-transclude</span> 
указывает, что в этот элемент будет внедряться внешний код.
<p>Этот код будет указан  на главной странице <soan class="b">index.html</span> в элементе, к которому применяется директива директивы:</p>
<pre class="brush:js;">
&lt;!doctype html&gt;
...
<p>Теперь в блок <code>&lt;div ng-transclude&gt;&lt;/div&gt;</code> будет внедряться элемент заголовка <code>&lt;h3&gt;Ответы&lt;/h3&gt;</code>, которое 
определен внутри элемента, к которому применяется директива.</p>
<img src="pics/transclusion.png" alt="Transclusion in AngularJS" />
