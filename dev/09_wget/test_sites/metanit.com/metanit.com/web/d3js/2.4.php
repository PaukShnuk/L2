...
<html >
<head>
<title>Сортировка данных в D3.js</title>
<meta charset="utf-8" />
...
<h2>Сортировка данных</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для сортировки используется метод <code>sort()</code>, которая использует функцию-компаратор для сравнения данных:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="pics/1.7.png" alt="Сортировка в d3.js" />
<p>Поскольку каждый объект в массиве phones имеет три свойства, здесь определены три функции для сравнения объектов по этим свойствам. Их логика очень простая, 
если цена первого объекта больше второго, то возвращается 1, иначе -1. И то же самое для названий и компаний. Хотя при желании можно определить и более сложную логику сравнения.</p>
<p>Затем эта функция передается в метод sort:</p>
<pre class="brush:js;">
if(comparator){
