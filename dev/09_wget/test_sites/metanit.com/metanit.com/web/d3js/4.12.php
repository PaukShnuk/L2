...
<html >
<head>
<title>Добавление легенды диаграммы в D3.js</title>
<meta charset="utf-8" />
...
<h2>Добавление легенды диаграммы</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>В прошлой теме при построении диаграммы у нас был один минус: надписи секторах не всегда могут уместиться, особенно когда сектора занимают считанные проценты от окружности. 
В этом плане для добавления текстовых меток более эффективно использование легенды, которая соотносит используемые на диаграмме цвета с текстовыми метками секторов. 
Добавим на диаграмму из прошлой темы легенду:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="pics/4.10.png" alt="Легенда диаграммы в D3.js" />
<p>Главная проблема при создании легенды заключается лишь в подборе оптимальных координат для ее размещения. Само создание легенды представляет 
генерацию прямоугольников, окрашенных в цвета соответствующих секторов, и текстовых меток к ним.</p>
...
<div class="nav"><p><a href="4.11.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
