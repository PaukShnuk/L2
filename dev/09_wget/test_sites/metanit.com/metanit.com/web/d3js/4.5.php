...
<html >
<head>
<title>Добавление к графику маркеров и текстовых меток в D3.js</title>
<meta charset="utf-8" />
...
<h2>Добавление к графику маркеров и текстовых меток</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для установки текста, например, в качестве заголовка или различных подписей, используется svg-элемент <span class="bb">text</span>. 
Например, добавим к графику из прошлой темы заголовок и подписи к осям:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="pics/4.2.png" alt="Text in line chart diagram in D3.js" />
<p>При добавлении элемента <code>text</code> надо определить желательные координаты, а также можно задать ряд стилей как, например, <code>font-size</code>. 
С помощью метода <code>text()</code> определяется текстовое содержимое элемента.</p>
<p>В качестве маркеров точек графика чаще используются кружки, и последний метод как раз создает по массиву данных круговые маркеры, опять же используя функции 
интерполяции scaleX и scaleY.</p>
