...
<html >
<head>
<title>Гистограммы в D3.js</title>
<meta charset="utf-8" />
...
<h2>Гистограммы</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Гистограммы (bar chart) отображают данные в виде столбиков. В D3 каждый отдельный элемент диаграммы можно выразить через объект <code>rect</code>.</p>
Например, допустим, у нас есть некоторые данные последовательно за 12 месяцев, и их надо отобразить в виде столбиков:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="pics/4.7.png" alt="Bar Chart in D3.js" />
<p>Ключевыми моментами, которые отличаются от построения линейного графика, здесь последние две цепочки:</p>
<pre class="brush:js;">
// связываем данные с прямоугольниками
g.selectAll("rect.bar")
    .data(data)
...
<p>Здесь важно учитывать все отступы и другие значения при вычислении параметров прямоугольника, иначе прямоугольники будут отображаться некорректно.</p>
