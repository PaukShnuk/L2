...
<html >
<head>
<title>Ext.form.field.Spinner в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование компонента Ext.form.field.Spinner для выбора числовых значений и их использовнаие">
...
<h2>Ext.form.field.Spinner</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Класс Ext.form.field.Spinner создает числовой список:</p>
<pre class="brush:js;">
...
<img src="pics/spinner.png" alt="'Элемент Ext.form.field.Spinner" />
<p>С помощью свойств <code>maxValue</code> и <code>minValue</code> задается максимально и минимально возможные числа для выбора. Если их не задать, нам 
будут доступны все числа.</p>
<p>Кроме того, компонент имеет еще ряд полезных свойств:</p>
<ul>
<li><p><b>allowDecimals</b> - принимает булевое значение и позволяет выбирать десятичные числа. По умолчанию имеет значение true</p></li>
<li><p><b>decimalPrecision</b> - задает точность десятичного числа</p></li>
<li><p><b>step</b> - обозначает шаг, на который будут увеличиваться доступные для выбора числа</p></li>
</ul>
<pre class="brush:js;">
Ext.onReady(function(){
	var numberField=Ext.create('Ext.Panel', {
...
<div class="nav"><p><a href="7.10.php">Назад</a><a href="./">Содержание</a><a href="7.12.php">Вперед</a></p></div></div>
<div class="socBlock">
