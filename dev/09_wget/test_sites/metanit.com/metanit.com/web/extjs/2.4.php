...
<html >
<head>
<title>Статические члены класса и секция Static в Ext JS</title>
<meta charset="utf-8" />
<meta name="description" content="Создание статических членов класса и их использование, применение параметра static для их объявления">
...
<h2>Статические члены класса и секция Static</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>В Ext JS 4 можно использовать статические члены классов. Такие члены классов относятся не к определенному объекту, а ко всему классу. 
Статические члены класса вводятся в секции <code>static</code>:</p>
<pre class="brush:js;">
...
<p>Здесь в секции <code>static</code> мы объявляем, во-первых, статическую переменную <code>instanceCount</code>, которая будет обозначать количество 
созданных объектов данного класса. И данная переменная будет общей для всех объектов этого класса.</p>
<p>Во-вторых, объявляется статическая функция <code>factory</code> создает объект данного класса.</p>
<p>В конструкторе мы обращаемся к классу текущего объекта и увеличиваем переменную на единицу: <code>this.self.instanceCount ++</code></p>
<p>В итоге при обращении к статическим членам объекта нам надо будет указывать имя класса, а не имя объекта: <code>alert(Classes.Person.instanceCount);</code></p>
