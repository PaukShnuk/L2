...
<html >
<head>
<title>Текстовые поля в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование компонентов Ext.form.TextField и Ext.form.field.TextArea для создания текстовых полей и их основные свойства">
...
<h2>Текстовые поля в ExtJS</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Текстовые поля в ExtJS представлены классом <b>Ext.form.TextField</b>:</p>
<pre class="brush:js;">
...
<img src="pics/textfield.png" alt="Ввод текста в ExtJS" />
<p>Данный компонент обладает рядом настроек, которые позволяют настроить его отображение. Например, мы можем в случае отсутствия ввода текста окрасить 
границы красным с помощью свойства allowBlank:</p>
<pre class="brush:js;">
//.....................
items: [{
	xtype: 'textfield',
...
<img src="pics/blanktextfield.png" alt="Пустое текстовое поле при обязательном вводе" />
<p>Мы можем запретить ввод определенных символов, задав маску. Например, второе поле запрещает ввод всех не числовых символов с помощью регулярного 
выражения. Также мы можем задать максимально и минимально допустимое количество или текст по умолчанию:</p>
<pre class="brush:js;">
Ext.onReady(function(){
...
<img src="pics/customtextfield.png" />
<p>Похожую функциональность предоставляет компонент <b>Ext.form.field.TextArea</b>, только в отличие от обычного текстового поля он представляет 
многострочное поле:</p>
<pre class="brush:js;">
Ext.onReady(function(){
	var formPanel = Ext.create('Ext.Panel', {
                    title: 'Форма ввода',
...
<div class="nav"><p><a href="7.14.php">Назад</a><a href="./">Содержание</a><a href="7.16.php">Вперед</a></p></div></div>
<div class="socBlock">
