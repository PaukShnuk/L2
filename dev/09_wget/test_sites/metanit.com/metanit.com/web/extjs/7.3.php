...
<html >
<head>
<title>Контейнер Viewport в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование класса Ext.container.Viewport для создания приложений Ext JS, занимающих все пространство браузера">
...
<h2>Контейнер Viewport</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Контейнер Viewport представлен классом <code>Ext.container.Viewport</code> и является основой веб-приложений, использующих все пространство браузера. 
При изменении размеров браузера, например, при сжимании или растягивании, Viewport также изменяет свои размеры, подстраиваясь под размеры браузера:</p>
<pre class="brush:js;">
