...
<html >
<head>
<title>Гистограммы в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Создание гистограмм в ExtJS, пример использования, особенности построения">
...
<p>Гистограммы создаются с помощью установки опцию <code>type: 'bar'</code> в параметре series:</p>
<pre class="brush:js;">
...
<img src="pics/15.8.png" alt="Гистограммы в ExtJS 4" />
<p>Параметр <code>column: true</code> в series указывает, что мы хотим видеть вертикальные столбики. По умолчанию это свойство равно <code>false</code>, 
что позволяет создавать только горизонтальные гистограммы: например, если у нас процентные значения располагались бы по оси Х, а названия браузеров по оси Y.</p>
