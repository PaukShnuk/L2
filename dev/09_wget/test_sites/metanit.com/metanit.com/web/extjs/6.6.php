...
<html >
<head>
<title>Аккордеоны в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование аккордеонов - специальных контейнеров, которые разворачиваются или сворачиваются по нажатию">
...
<h2>Аккордеоны</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Интересный способ компоновки представляют аккордеоны, которые представляют специальные контейнеры, которые разворачиваются по нажатию, а в 
свернутом положении отображает только заголовок.</p>
<pre class="brush:js;">
...
<p>Значение <code>layout:'accordion'</code> устанавливает компоновку в виде аккордеонов. Чтобы отобразить панель, мы нажимаем на +, чтобы скрыть - на значок -.</p>
<p>Если бы мы закомментировали строку <code>layout:'accordion'</code>, то нам отобразились бы все панели:</p>
