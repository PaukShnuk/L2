...
<html >
<head>
<title>Конструкторы в Ext JS 4</title>
<meta charset="utf-8" />
<meta name="description" content="Использование конструкторов и определение объектов классов с помощью функции Ext.create и ключевого слова new">
...
<h2>Конструкторы</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Конструкторы определяют метод и логику создания нового объекта. Для этого используется секция <code>constructor</code>:</p>
<pre class="brush:js;">
...
<p>В данном случае конструктор представляет безымянную функцию, которая принимает два параметра - имя и фамилию. Функция проверяет, определены ли 
значения для параметров, и если определены - передает их в качестве значений свойств для нового объекта.</p>
<p>Затем мы можем использовать конструктор для создания нового объекта с помощью функции <code>Ext.create</code> или выражения <code>new</code>, 
в которые передаем значения:</p>
<pre class="brush:js;">
...
<p>Создание объекта с помощью <code>Ext.create</code> и с помощью слова <code>new</code>  данном случае эквивалентны. Если в функции <code>Ext.create</code> 
мы не передаем значения, кроме имени класса, тогда используются значения по умолчанию.</p>
