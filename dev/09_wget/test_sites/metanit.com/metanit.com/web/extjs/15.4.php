...
<html >
<head>
<title>Диаграмма с областями в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Создание диаграммы с областями в ExtJS, пример использования, особенности построения">
...
<h2>Диаграмма с областями</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для создания диаграммы областей нам надо установить опцию <code>type: 'area'</code> в параметре series у диаграммы:</p>
<pre class="brush:js;">
...
<img src="pics/15.7.png" alt="Диаграмма с областями в ExtJS 4" />
<p>Здесь мы выводим диаграмму, которая содержит процентную долю пользователей браузеров. Каждый объект хранилища имеет данные в 
следующем формате: <code>{name: 'название_месяца', data1: доля_Google_Chrome, data2: доля_Firefox, data3:доля_IE}</code>. 
Затем эти значения последовательно откладываются по оси Y.</p>
<p>Затем, используя легенду диаграммы, мы связываем области с конкретными браузерами.</p>
