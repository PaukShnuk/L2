...
<html >
<head>
<title>Панель вкладок в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Создание панелей с вкладками в Ext JS с помощью класса Ext.tab.Panel и использование их свойств">
...
<h2>Панель вкладок</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для реализации панели вкладок используется класс <strong>Ext.tab.Panel</strong>. Создадим простую панель с двумя вкладками:</p>
<pre class="brush:js;">
...
<img src="pics/tabpanel.png" />
<p>Свойство items панели вкладок содержит коллекцию объектов <strong>Ext.tab.Tab</strong>, каждый из которых представляет отдельную вкладку.</p>
<p>С помощью параметра <strong>tabConfig</strong> можно настроить дополнительные возможности вкладок. Например, можно добавить всплывающую подсказку при 
наведении на вкладку:</p>
<pre class="brush:js;">
...
<img src="pics/tabtooltip.png" alt="Создание панели вкладок в ExtJS" />
<p>Если бы мы захотели увидеть переключатели вкладок снизу, а не вверху, тогда бы мы установили для панели параметр <code>tabPosition: 'bottom'</code>. 
tabPosition может принимать четыре значения: top, bottom, left и right, располагая вкладки по всем четырем сторонам панели.</p>
<h3>Динамическое добавление/удаление вкладок</h3>
<p>Создадим кнопку для добавления новых вкладок:</p>
<pre class="brush:js;">
...
<p>Похожим образом можно создать кнопку для удаления вкладки по ее id:</p>
<pre class="brush:js;">
	Ext.create('Ext.button.Button', {
		text    : 'Удалить',
		margin: 10,
