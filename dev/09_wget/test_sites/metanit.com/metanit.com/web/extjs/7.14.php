...
<html >
<head>
<title>Ext.form.field.HtmlEditor в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование класса Ext.form.field.HtmlEditor для создания текстовых полей с расщиренной функциональностью и их свойства">
...
<h2>Ext.form.field.HtmlEditor</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Класс Ext.form.field.HtmlEditor позволяет создавать текстовые поля с расширенной функциональностью, наподобие примитивных текстовых редакторов. Например:</p>
<pre class="brush:js;">
...
<img src="pics/extjsrichtext.png" alt="Компонент Ext.form.field.HtmlEditor в ExtJS" />
<p>Данный компонент обладает рядом настроек, которые позволяют изменить, например, некоторые кнопки на панели, убрать ненужные шрифты и т.д. Например:</p>
<pre class="brush:js;">
Ext.onReady(function(){
	var formPanel = Ext.create('Ext.Panel', {
		title: 'Редактор текста',
...
<p>Параметр <code>enableColors: false</code> говорит, что нам надо убрать кнопку выбора цветов. Аналогично с помощью <code>enableLinks: false</code> 
...
параметр fontFamilies указывает набор только тех шрифтов, которые будут отображаться и использоваться в компоненте.</p>
