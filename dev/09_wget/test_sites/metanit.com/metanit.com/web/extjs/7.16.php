...
<html >
<head>
<title>Тулбар в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование компонента Ext.toolbar.Toolbar в ExtJS для создания тулбара, наполнение его компонентами и установка в контейнере">
...
<h2>Тулбар</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для создания различных панелей с инструментами и меню в ExtJS предназначен класс <b>Ext.toolbar.Toolbar</b>. Например:</p>
<pre class="brush:js;">
...
<img src="pics/7.9.png" alt="Панель инструментов в ExtJS" />
<p>Элемент тулбар принимает массив <code>items</code>, в котором мы можем определить другие компоненты. Все компоненты располагаются друг за другом в том 
порядке, в котором они находятся в массиве.</p>
<p>Но также мы можем использовать специальные разделители, чтобы отделить элементы друг от друга. В данном случае мы использовали два разделителя: 
''-' и '-&gt;'. Разделитель '-' представляет класс Ext.toolbar.Separator. В визуальном плане он создает вертикальную черточку-разделитель.</p>
<p>Второй разделитель '-&gt;' представляет компонент Ext.toolbar.Fill, который растягивается по всей ширине тулбара, которая осталась после вычитания ширины всех остальных его компонентов.</p>
<p>Кроме того, мы можем применить еще один разделитель - ' ' обычный пробел, который представляет класс Ext.toolbar.Spacer и визуально также создает пробел между элементами.</p>

<p>Используя свойство <code>dockItems</code>, мы можем прикрепить тулбар к определенной стороне панели. Также мы можем использовать 
свойства панели как tbar, bbar:</p>
<pre class="brush:js;">
Ext.onReady(function(){	
...
<img src="pics/7.10.png" alt="Тулбар на панели в ExtJS" />
...
<div class="nav"><p><a href="7.15.php">Назад</a><a href="./">Содержание</a><a href="7.17.php">Вперед</a></p></div></div>
<div class="socBlock">
