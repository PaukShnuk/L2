...
<html >
<head>
<title>Миксин-классы (Mixin) в ExtJS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование миксин-классов для реализации множественного наследования и применение параметра mixins">
...
<h2>Миксин-классы (Mixin)</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>В прошлом разделе мы разбирали наследование. Некоторое сходство с наследованием имеет использование миксин-классов.</p>
<p>Миксин-классы или миксины представляют такие классы, которые могут быть включены в другие классы. Концепция миксин-классов напоминает множественное наследование 
в с++, а также использование интерфейсов в языках c# и java, хотя аналогия лишь частичная. Например, у нас есть класс Person, представляющий человека. 
Пусть у нас есть класс Car, представляющий машину:</p>
<pre class="brush:js;">
Ext.define('Classes.Car', {
 ...
 <p>Класс машины имеет один метод, который сигнализирует, что машина едет при скорости больше нуля, или что машина останавливается, если скорость равна нулю.</p>
 <p>Наш класс Person, то есть человек, может ездить на машине. И подобную функциональность мы можем определить в классе Person, 
использовав класс Car в качестве миксин-класса:</p>
 <pre class="brush:js;">
...
<p>Здесь в секции <code>mixins</code> мы указываем миксин-класс. Потом при создании класса на этапе предобработки миксин-классы загружаются, 
а все их члены объединяются с текущим классом (то есть в данном случае с классом Person). Поэтому к этими членам класса мы модем обращаться с помощью ключевого слова this: <code>this.drive(speed);</code></p>
