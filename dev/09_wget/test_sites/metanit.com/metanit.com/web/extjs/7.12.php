...
<html >
<head>
<title>Слайдер в Ext JS</title>
<meta charset="utf-8" />
<meta name="description" content="Использование слайдеров с помощью класса Ext.slider.Single и его основные свойства ">
...
<h2>Слайдер в Ext JS</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для создания слайдера или ползунка предназначен класс Ext.slider.Single:</p>
<pre class="brush:js;">
...
<img src="pics/slider.png" alt="'Элемент Ext.slider.Single" />
<p>Свойства слайдера <code>maxValue</code> и <code>minValue</code> задается макcимально и минимально возможные числа для выбора. Если их не задать, нам 
будут доступны все числа от 0 до 100.</p>
<p>Также компонент имеет еще ряд полезных свойств:</p>
<ul>
<li><p><span class="bb">value</span> - первоначальное значение, которое слайдер принимает при загрузке страницы</p></li>
<li><p><span class="bb">increment</span> - задает шаг, на который будут увеличиваться доступные для выбора числа</p></li>
</ul>
<pre class="brush:js;">
Ext.onReady(function(){
	var slider=Ext.create('Ext.slider.Single', {
