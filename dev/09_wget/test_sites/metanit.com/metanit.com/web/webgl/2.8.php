...
<html >
<head>
<title>gl.TRIANGLE_FAN</title>
<meta charset="utf-8" />
<meta name="description" content="Использование в WebGL примитива gl.TRIANGLE_FAN для создания набора треугольников по типу веера с одной общей точкой">
...
<h2>gl.TRIANGLE_FAN</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p><code>gl.TRIANGLE_FAN</code> создает набор треугольников по типу веера, которые имеют одну общую точку.</p>
<p>Также, как и в случае с <code>gl.TRIANGLE_STRIP</code>, общее количество треугольников будет равно count-2, где count - это и есть количество вершин в 
буфере вершин. То есть опять же чтобы построить три треугольника нам потребуется 3+2=5 вершин.</p>
<p>Создадим программу, использующую данный примитив:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Мы определяем пять вершин, которые последовательно соединяются в 3 треугольника:</p>
<img src="pics/2.4.png" alt="gl.TRIANGLE_FAN" />
<p>Таким образом, первый треугольник образуется вершинами m0, m1, m2; второй - m0, m2, m3; а третий треугольник - m0, m3, m4. В итоге получается 
подобие веера, где имеется общая точка m0.</p>
