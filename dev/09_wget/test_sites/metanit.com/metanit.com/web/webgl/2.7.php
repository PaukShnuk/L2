...
<html >
<head>
<title>gl.TRIANGLE_STRIP</title>
<meta charset="utf-8" />
<meta name="description" content="Использование в WebGL примитива gl.TRIANGLE_STRIP для отрисовки набора связанных треугольников">
...
<h2>gl.TRIANGLE_STRIP</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Данный примитив используется для создания набора соединенных треугольников, которые последовательно соединяют определенные в буфере вершины. 
...
вершин по сравнению, например, с gl.TRIANGLES, что приведет к уменьшению объема данных при обработке.</p>
<p>Имея определенное количество вершин, можно подсчитать общее количество треугольников: count-2, где count - это и есть количество вершин в 
буфере вершин. То есть чтобы построить три треугольника нам потребуется 3+2=5 вершин.</p>
...
<img src="pics/2.3.png" alt="gl.TRIANGLE_STRIP" />
