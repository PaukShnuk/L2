...
<html >
<head>
<title>React | React-router и webpack</title>
<meta charset="utf-8" />
<meta name="description" content="Маршрутизация в проекте React, React-router v6 и сборка с помощью webpack">
...
<h2>React-router и webpack</h2><div class="date">Последнее обновление: 02.04.2022</div>
...
<p>Рассмотрим ситуацию, когда приложение, которое использует маршрутизацию, разбито на отдельные файлы, и для его сборки используется webpack.</p>
<p>Вначале создадим новый проект и создадим в проекте файл <span class="b">package.json</span> со следующим определением пакетов:</p>
<pre class="brush:js;">
{
  "name": "routerapp",
...
<p>Далее определим в проекте файл html-страницы <span class="b">index.html</span>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Непосредственно для файлов приложения определим в проекте папку <span class="b">app</span>. А для хранения компонентов в папке app 
создадим каталог <span class="b">components</span>. Затем в папку <span class="b">app/components</span> добавим файл <span class="b">home.jsx</span>:</p>
<pre class="brush:xml;">
...
<p>Далее также в папке <span class="b">app/components</span> определим второй компонент в файле <span class="b">products.jsx</span>:</p>
<pre class="brush:xml;">
import React from "react";
...
<p>И также в эту же папку добавим еще один компонент в файле <span class="b">notfound.jsx</span>:</p>
<pre class="brush:xml;">
import React from "react";
...
<p>Для перехода по ссылкам к этим компонентам определим в каталоге <span class="b">app/components</span> дополнительный компонент навигации и для этого добавим файл 
<span class="b">nav.jsx</span>:</p>
<pre class="brush:xml;">
import React from "react";
...
<p>Это все компоненты, которые мы будем использовать. Далее в папке <span class="b">app</span> определим главный файл приложения 
<span class="b">app.jsx</span>:</p>
<pre class="brush:xml;">
...
<p>Здесь подключаются и используются все ранее определенные компоненты.</p>
<p>И для сборки файлов в корневой каталог проекта добавим файл конфигурации webpack - <span class="b">webpack.config.js</span>:</p>
<pre class="brush:js;">
...
<img src="./pics/4.19.png" alt="React-router и webpack" />
<p>И в конце установим все пакеты с помощью команды <span class="b">npm install</span> и запустим проект на выполнение с помощью 
команды <span class="b">npm run dev</span>.</p>
