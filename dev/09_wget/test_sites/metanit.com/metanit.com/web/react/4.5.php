...
<html >
<head>
<title>React | Ссылки с параметрами</title>
<meta charset="utf-8" />
<meta name="description" content="Ссылки с параметрами в React, переход по ссылкам и получение параметров в компоненте, классы Link и IndexLink">
...
<h2>Ссылки с параметрами</h2><div class="date">Последнее обновление: 02.04.2022</div>
...
<p>Если мы хотим добавить к адресу ссылки параметр, то весь адрес помещается в фигурные скобки. Для примера определим следующую страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Для эмуляции хранилища данных здесь определен массив phones. Для доступа к данным этого массива выводятся ссылки:</p>
<pre class="brush:xml;">&lt;NavLink to={`/products/${item.id}`}&gt;{item.name}&lt;/NavLink&gt;</pre>
<p>И при переходе по адресу "/products" мы увидим набор ссылок:</p>
<img src="./pics/4.12.png" alt="Параметры в ссылках в React" />
<p>При переходе по ссылке компонент Product получит значение параметра и по нему извлекет из массива phones нужный объект:</p>
<img src="./pics/4.13.png" alt="Передача параметров в ссылки в React" />
