...
<html >
<head>
<title>React | React Developer Tools</title>
<meta charset="utf-8" />
<meta name="description" content="Использование React Developer Tools для разработки в React в Google Chrome и Firefox">
...
<h2>React Developer Tools</h2><div class="date">Последнее обновление: 01.04.2022</div>
...
<p>Для работы с React  в браузере Chrome нам могут пригодится специальный инструмент - расширение <span class="b">React Developer Tools</span>, 
которое можно найти на странице <a href="https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi" rel="nofollow">https://chrome.google.com/webstore/detail/react-developer-tools/fmkadmapgofadopljbjfkapdkoienihi</a>.</p>
<img src="./pics/1.10.png" alt="React Developer Tools for Google Chrome" />
<p>Для установки нажмем на кнопку "Установить".</p>
<p>После установки перейдем на странице расширений Google Chrome к расширению "React Developer Tools" и убедимся, что оно включено:</p>
<img src="./pics/1.11.png" alt="Управление React Developer Tools for Google Chrome" />
<p>Также здесь мы можем более детально настроить поведение расширения в рамках предлагаемых опций.</p>
<p>И теперь мы можем инспектировать сайты, которые используют React, смотреть, какие компоненты используются. Например, 
сайт <a href="https://www.airbnb.ru/" rel="nofollow">https://www.airbnb.ru/</a>, откроем его в Google Chrome и затем перейдем в инструменты разработчика.</p>
<p>В инструментах разработчика появится специальная вкладка <span class="b">Components</span>, которая будет содержать всю информацию об используемых компонентах:</p>
<img src="./pics/1.12.png" alt="Просмотр приложения React в Google Chrome" />
<p>В панели инструментов мы можем посмотреть, из каких компонентов состоит сайт, а справа отображается дополнительная панель с информацией о 
состоянии и свойствах компонентов.</p>
<p>Аналогичный инструмент есть и для браузера Mozilla Firefox, который устанавливается в виде расширения для браузера и доступен для загрузки на странице 
<a href="https://addons.mozilla.org/ru/firefox/addon/react-devtools/" rel="nofollow">https://addons.mozilla.org/ru/firefox/addon/react-devtools/</a>.</p>
