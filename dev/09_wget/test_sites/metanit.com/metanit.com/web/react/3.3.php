...
<html >
<head>
<title>React | Валидация форм</title>
<meta charset="utf-8" />
<meta name="description" content="Валидация введенных на форме значений в React.js, создание механизма валидации">
...
<h2>Валидация форм</h2><div class="date">Последнее обновление: 01.04.2022</div>
...
<p>Реализации валидации форм в React.js предусматривает проверку их введенных значений, и если эти значения сооветстуют 
требованиям, тогда происходит изменение состояния компонента. Так, определим следующую страницу index.html:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь добавлено поле для ввода возраста. Дополнительные значения <code>nameValid</code> и <code>ageValid</code> позволяют установить корректность введенных имени и возраста соответственно. Эти значения 
понадобятся для стилизации полей. Так, если введенное значение некорректно, то поле ввода будет иметь красную границу, иначе зеленую.</p>
<pre class="brush:js;">
var nameColor = this.state.nameValid===true?"green":"red";
var ageColor = this.state.ageValid===true?"green":"red";
</pre>
...
<p>И для каждого поля ввода определен свой обработчик onChange, в котором происходит валидация и изменение введенного значения:</p>
<img src="./pics/3.1.png" alt="Формы в React" />
<img src="./pics/3.2.png" alt="Валидация форм в React" />
