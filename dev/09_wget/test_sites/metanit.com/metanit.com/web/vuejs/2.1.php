...
<html >
<head>
<title>Vue.js | Директива v-if</title>
<meta charset="utf-8" />
<meta name="description" content="Директива v-if в Vue.js, условный рендеринг элементов, элемент template, выражение else">
...
<h1>Условный рендеринг и работа с массивами</h1><h2>Директива v-if</h2><div class="date">Последнее обновление: 01.08.2017</div>
...
<p>Ряд директив позволяет по условию изменять структуру DOM, и одной из таких является директива <span class="b">v-if</span>. 
...
<img src="./pics/17.png" alt="Директива v-if в Vue.js" />
...
<img src="./pics/18.png" alt="template и v-if в Vue.js" />
<h3>v-else-if</h3>
...
<div class="nav"><p><a href="1.13.php">Назад</a><a href="./">Содержание</a><a href="2.2.php">Вперед</a></p></div></div>
<div class="socBlock">
