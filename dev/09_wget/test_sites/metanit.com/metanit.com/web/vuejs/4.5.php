...
<meta charset="utf-8" />
<meta name="description" content="Свойства Props во Vue.js, передача данных компонентам извне">
...
<h2>Props</h2><div class="date">Последнее обновление: 26.09.2017</div>
...
<p>Каждый компонент определяет параметр <span class="b">props</span>, через который мы можем передать компоненту извне различные данные.
Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="./pics/44.png" alt="Props in Vue.js" />
<p>В некотором плане свойства props похожи на те свойства, которые определяются через параметр data. При этом надо учитывать, что мы не можем 
определить свойство с одним и тем же именем и в props, и в data:</p>
<pre class="brush:js;">
Vue.component('message-comp', {
  props: ['message'],
  data: function(){
...
<p>И в данном случае будет использоваться свойство message из props, а не из параметра data.</p>
...
<img src="./pics/45.png" alt="Динамические свойства props в Vue.js" />
...
<img src="./pics/46.png" alt="Передача в props сложных объектов в Vue.js" />
