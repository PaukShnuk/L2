...
<html >
<head>
<title>Vue.js | Двусторонняя привязка</title>
<meta charset="utf-8" />
<meta name="description" content="Двусторонняя привязка в Vue.js и ее использование, директива v-model, two-way data binding">
...
<h2>Двусторонняя привязка</h2><div class="date">Последнее обновление: 27.07.2017</div>
...
<p>Ранее были рассмотрены примеры использования односторонней привязки с помощью интерполяции. Но кроме того, Vue.js поддерживает и 
двустороннюю привязку. Для создания подобной привязки используется директива <span class="b">v-model</span>. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь на странице определено два текстовых поля, и оба они привязаны к свойству name из объекта Vue. В этом случае нам не надо добавлять к текстовому полю обработчик события ввода, и в этом обработчике менять вручную значение свойства name. 
При изменении текста в одном из полей автоматически изменится значение в другом. То есть сработает двусторонняя привязка.</p>
<img src="./pics/9.png" alt="Двусторонняя привязка в Vue.js" />
<p>Другой пример - определим программу вычисления факториала:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>При вводе числа в текстовое поле функция factorial автоматически будет перевычислять значение.</p>
<img src="./pics/10.png" alt="Вычисление факториала и привязка в Vue.js" />
