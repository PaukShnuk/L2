...
<html >
<head>
<title>Vue.js | Элементы input и textarea</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с формами в Vue.js, элементы input и textarea, привязка данных с помощью v-model">
...
<h1>Работа с формами</h1><h2>Элементы input и textarea</h2><div class="date">Последнее обновление: 31.08.2017</div>
...
<p>Для работы с элементами ввода, в частности, с элементами input, select, textarea, применяется директива <span class="b">v-model</span>, которая устанавливает 
двустороннюю привязку между элементом ввода и свойством объекта Vue. При этом v-model игнорирует значения атрибутов 
<code>value</code>, <code>checked</code> и <code>selected</code>, которые имеются у элементов ввода.</p>
<p>Например, используем ряд базовых элементов input:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/3.9.png" alt="элементы формы в Vue.js" />
<h3>textarea</h3>
...
<img src="./pics/3.10.png" alt="textarea во Vue.js" />
