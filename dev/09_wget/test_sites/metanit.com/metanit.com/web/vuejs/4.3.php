...
<html >
<head>
<title>Vue.js | Состояние и поведение компонентов</title>
<meta charset="utf-8" />
<meta name="description" content="Состояние и поведение компонентов во Vue.js, параметры data и methods">
...
<h2>Состояние и поведение компонентов</h2><div class="date">Последнее обновление: 10.09.2017</div>
...
<h3>Параметр data</h3>
<p>Как и объекты Vue, компоненты могут содержать некоторые данные или состояние в виде параметра <span class="b">data</span>. 
Но при этом в компонентах параметр data должен представлять функцию, которая в свою очередь и возвращает состояние компонента. Например:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/40.png" alt="Данные компонентов Vue.js" />
...
<p>Здесь по нажатию на кнопку вызывается метод increase, который увеличивает значение свойства count.</p>
<img src="./pics/41.png" alt="Методы в компонентах во Vue.js" />
