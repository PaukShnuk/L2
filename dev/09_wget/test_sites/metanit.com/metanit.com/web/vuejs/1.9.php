...
<html >
<head>
<title>Vue.js | Привязка к стилям</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка к стилям в Vue.js, динамическое управление стилями элемента html, переключение стилей">
...
<h2>Привязка к стилям</h2><div class="date">Последнее обновление: 31.07.2017</div>
...
<p>Кроме классов Vue.js позволяет с помощью привязки атрибутов управлять стилями html-элемента. Для привязки к стилям атрибуту style можно передать 
...
<img src="./pics/16.png" alt="Привязка стилей во Vue.js" />
...
<p>Если необходимо установить для элемента сразу несколько подобных стилей, то они передаются в квадратные скобки:</p>
<pre class="brush:xml;">
&lt;div id="app"&gt;
...
<div class="nav"><p><a href="1.8.php">Назад</a><a href="./">Содержание</a><a href="1.10.php">Вперед</a></p></div></div>
<div class="socBlock">
