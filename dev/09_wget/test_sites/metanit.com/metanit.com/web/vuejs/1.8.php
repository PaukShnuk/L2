...
<html >
<head>
<title>Vue.js | Привязка классов</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка классов в Vue.js, динамическое добавление и удаление класса у элемента html, переключение классов">
...
<h2>Привязка классов</h2><div class="date">Последнее обновление: 31.07.2017</div>
...
<p>С помощью привязки атрибута class во Vue.js можно динамически управлять классами элементов. 
Для условной привязки классов определим следующую страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь определены два блока с классом region. Кроме того, у первого блока применяется условная привязка классов. Она имеет форму: 
<code>{класс_1: true|false, класс_2: true|false, класс_N: true|false}</code>
<p>Если для класса определено значение true, то класс применяется. В данном случае применение класса зависит от свойства isActive, которое определено в объекте Vue. 
А с помощью события click у первого блока мы можем переключить значение свойства isActive, и, следовательно, включить или отключить класс active.</p>
<p>При этом не столь важно, определены у элемента какие-либо еще классы, все они вместе будут применяться к элементу.</p>
<img src="./pics/13.png" alt="Условное применение классов в Vue.js" />
...
<p>В данном случае привязка атрибута class будет идти к свойству color. С помощью ввода в текстовое поле мы можем изменить через двусторонюю привязку значение 
этого свойства и соответственно поменять класс:</p>
<img src="./pics/14.png" alt="Привязка классов в Vue.js" />
...
<img src="./pics/15.png" alt="Классы во Vue.js" />
...
<div class="nav"><p><a href="1.6.php">Назад</a><a href="./">Содержание</a><a href="1.9.php">Вперед</a></p></div></div>
<div class="socBlock">
