...
<html >
<head>
<title>Vue.js | Получение состояния вложенного компонента</title>
<meta charset="utf-8" />
<meta name="description" content="Получение состояния вложенного компонента во Vue.js, объект this.$refs">
...
<h2>Получение состояния вложенного компонента</h2><div class="date">Последнее обновление: 27.09.2017</div>
...
<p>С помощью ссылки <span class="b">this.$refs</span> из объекта Vue мы можем ссылаться на различные элементы веб-станицы внутри объекта шаблона Vue. 
Но кроме того, подобным образом мы можем ссылаться также и на вложенные компоненты и, таким образом, обращаться к внутреннему состоянию компонента.</p>
<p>Например, установим в объекте Vue изменение свойства, которое определено в компоненте:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/51.png" alt="Состояние компонентов в Vue.js" />
