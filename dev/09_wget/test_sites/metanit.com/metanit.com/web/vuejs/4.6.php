...
<html >
<head>
<title>Vue.js | Валидация props</title>
<meta charset="utf-8" />
<meta name="description" content="Валидация свойств props во Vue.js, значение по умолчанию, функция validator, обязательное наличие данных, тип свойств">
...
<h2>Валидация props</h2><div class="date">Последнее обновление: 26.09.2017</div>
...
<p>С помощью props можно передавать извне данные в компонент. Однако не всегда данные, которые передаются приложению, являются крректными. 
Например, для возраста передать отрицательное числового значение или при вводе имени ввести пустую строку. Чтобы избежать подобных ситуаций, когда 
...
<pre class="brush:js;">props: ['name', 'age']</pre>
...
<p>Если свойства не проходят валидацию, то в консоли браузера отображается соответствующее предупреждение.</p>
