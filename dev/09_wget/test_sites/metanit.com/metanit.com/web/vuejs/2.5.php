...
<html >
<head>
<title>Vue.js | Фильтрация и сортировка массива</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтрация и сортировка массива в Vue.js, взаимодействие со свойствами computed">
...
<h2>Фильтрация и сортировка массива</h2><div class="date">Последнее обновление: 18.02.2019</div>
...
<p>Стандартной ситуацией при работе с коллекциями объектов является фильтрация. Как правило, при фильтрации есть некоторый начальный список, а пользователю же 
возвращается некоторый временный результат. Начальный же список при этом не изменяется. И для этого во Vue.js лучше определить привязку к вычисляемому свойству:</p>
<pre class="brush:xml;">
&lt;div id="app"&gt;
...
<img src="./pics/29.png" alt="Фильтрация и живой поиск в Vue.js" />
...
и sortByTitle.</p>
<img src="./pics/2.1.png" alt="Сортировка в Vue.js" />
