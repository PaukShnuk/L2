...
<html >
<head>
<title>Vue.js | Наблюдаемые свойства</title>
<meta charset="utf-8" />
<meta name="description" content="Наблюдаемые свойства watchers в Vue.js, отслеживание изменения свойств, асинхронные операции">
...
<h2>Наблюдаемые свойства</h2><div class="date">Последнее обновление: 06.08.2017</div>
...
<p>Кроме вычисляемых свойств Vue.js позволяет определять наблюдаемые свойства или watchers. Наблюдаемые свойства, как правило, 
применяются для выполнения асинхронных действий, особенно таких, которые могут занять продолжительное время, например, отправка запроса на сервер.</p>
...
<p>Для создания наблюдаемого свойства используется параметр <span class="b">watch</span>. В данном случае определяется наблюдаемое 
свойство number, которое указывает на функцию. Причем в параметре <span class="b">data</span> также определяется свойство number. При изменении свойства number, которое определено в секции data, 
будет вызываться функция number, определенная в параметре watch. Измененное значение будет передаваться в функцию через параметр newNumber.</p>
<p>Функция number в зависимости от нового значения свойства number вызывает метод factorial. В этом методе устанавливается значение свойства result. 
Причем вначале устанавливается некоторое промежуточное значение. Затем для имитации продолжительной операции применяется функция <code>setTimeout()</code>, которая выполняет задержку 
на 2 секунды, после которой вычисляет факториал числа. И в конце вычисленный результат передается свойству result.</p>
<p>Поэтому при изменении числа в текстовом поле вначале мы увидим временную надпись:</p>
<img src="./pics/30.png" alt="watch in Vue.js" />
<p>И затем и собственно результат - факториал числа:</p>
<img src="./pics/31.png" alt="наблюдаемые свойства во Vue.js" />
...
<div class="nav"><p><a href="1.9.php">Назад</a><a href="./">Содержание</a><a href="1.11.php">Вперед</a></p></div></div>
<div class="socBlock">
