...
<html >
<head>
<title>Vue.js | Параметры маршрутов</title>
<meta charset="utf-8" />
<meta name="description" content="Параметры маршрутов во Vue.js, необязательные параметры, получение их значения в компонентах, объект $route.params">
...
<h2>Параметры маршрутов</h2><div class="date">Последнее обновление: 29.10.2017</div>
...
<p>Определяемые во Vue.js маршруты могут содержать параметры. Для определения параметра в конец маршрута добавляется двоеточие, после которого идет 
название параметра:</p>
...
<p>В компоненте Vue.js мы можем получить параметры запроса через объект <span class="b">$route.params</span>, который содержит значения всех параметров. 
...
<img src="./pics/router5.png" alt="Параметры маршрутов в Vue.js" />
...
<img src="./pics/router6.png" alt="params in vuerouter" />
