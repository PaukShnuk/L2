...
<html >
<head>
<title>Vue.js | Вложенные маршруты</title>
<meta charset="utf-8" />
<meta name="description" content="Вложенные маршруты (nested routes) во Vue.js, объект vuerouter, принципы навигации в приложении">
...
<h2>Вложенные маршруты</h2><div class="date">Последнее обновление: 29.10.2017</div>
...
<p>Во Vue.js одни маршруты могут быть вложенными в другие (nested routes), то есть подмаршрутами. Для их использования определим следующую веб-страницу 
index.html:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
...
<img src="./pics/router7.png" alt="nested routes in vue.js" />
<img src="./pics/router8.png" alt="дочерние маршруты vue.js" />
...
<img src="./pics/router9.png" alt="child routes in vuerouter" />
