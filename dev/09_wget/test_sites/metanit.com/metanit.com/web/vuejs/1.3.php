...
<html >
<head>
<title>Vue.js | Привязка данных</title>
<meta charset="utf-8" />
<meta name="description" content="Привязка данных в Vue.js, директивы v-bind, v-once и v-html, привязки кода html и атрибутов">
...
<h2>Привязка данных</h2><div class="date">Последнее обновление: 27.07.2017</div>
...
<p>Vue.js позволяет декларативным образом устанавливать привязку между элементами веб-страницы и данными объекта Vue. Есть различные формы привязки.</p>
<h3>Интерполяция</h3>
<p>Простейшую форму привязки представляет интерполяция строк. В этом случае значение, к которому выполняется привязка, заключается в 
двойные фигурные скобки:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/3.png" alt="Привязка и интерполяция в Vue.js" />
...
<pre class="brush:xml;">&lt;a :href="link"&gt;{{text}}&lt;/a&gt;</pre>
<h3>Однократная привязка</h3>
<p>Если необходимо, чтобы значение было привязано к элементу html только один раз и впоследствии не изменялось, то применяется директива 
<span class="b">v-once</span/>:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/5.png" alt="Привязка html в Vue.js" />
...
<div class="nav"><p><a href="1.2.php">Назад</a><a href="./">Содержание</a><a href="1.7.php">Вперед</a></p></div></div>
<div class="socBlock">
