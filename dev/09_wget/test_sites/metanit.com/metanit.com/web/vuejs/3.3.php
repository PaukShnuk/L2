...
<meta charset="utf-8" />
<meta name="description" content="Работа с переключателями во Vue.js, элементы радиокнопки или radiobutton, привязка к сложным объектам">
...
<h2>Переключатели (radiobutton)</h2><div class="date">Последнее обновление: 31.08.2017</div>
...
<p>Переключатели или радиокнопки позволяют определить группу альтернативных вариантов, из которых одномоментно пользователь может 
выбрать только один. Переключатели привязываются к одному свойству. При выборе переключателя связанное свойство получает выбранное значение:</p>
<pre class="brush:xml;">
&lt;div id="app"&gt;
...
<img src="./pics/3.3.png" alt="RadioButtons in Vue.js" />
...
<img src="./pics/3.12.png" alt="RadioButton и сложные объекты во Vue.js" />
