...
<html >
<head>
<title>Vue.js | Разделяемое состояние компонентов</title>
<meta charset="utf-8" />
<meta name="description" content="Разделяемое состояние компонентов во Vue.js, особенности использования">
...
<h2>Разделяемое состояние компонентов</h2><div class="date">Последнее обновление: 10.09.2017</div>
...
<p>В данном случае объект Vue использует два раза компонент counter. И каждый объект counter работает со своим состоянием. Изменение свойство count 
в одном компоненте никак не скажется на другом.</p>
<img src="./pics/42.png" alt="Состояние компонентов в Vue.js" />
...
<img src="./pics/43.png" alt="Состояние компонентов в Vue.js" />
