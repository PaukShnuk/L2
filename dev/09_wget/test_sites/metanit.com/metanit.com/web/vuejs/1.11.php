...
<html >
<head>
<title>Vue.js | Работа с объектом Vue</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с объектом Vue во Vue.js, его использование в коде JavaScript">
...
<h2>Работа с объектом Vue</h2><div class="date">Последнее обновление: 08.08.2017</div>
...
<p>Объект Vue является стандартным объектом JavaScript, с которым мы можем работать из остального кода на js, в том числе и в других объектах Vue. 
Например, определим следующую страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь определены два объекта Vue, каждый из которых управляет своим шаблоном. Определяя для каждого объекта переменные, мы можем через эти 
переменную манипулировать объектами:</p>
<pre class="brush:js;">
vm1.name = "Sam";
vm1.setName("Mike");
</pre>
<p>В данном случае по нажатию на кнопку во втором объекте Vue мы можем изменить значения в первом объекте Vue.</p>
<img src="./pics/32.png" alt="Работа с объектами Vue" />
<p>Также мы можем определять дополнительные свойства и методы у объекта извне, как и для любого объекта JavaScript:</p>
<pre class="brush:xml;">
&lt;div id="app1"&gt;
    &lt;input type="text" v-model="name" /&gt;
    &lt;input type="number" v-model="age" /&gt;
...
<p>Однако все свойства определяются вне объекта Vue, как в данном случае свойство <code>position</code>, не будут реактивными и не будут автоматически отслеживаться. Соответственно после выполнения 
функции setTimeout в данном случае мы не увидим новое значение для этого свойства, пока не будет изменено значение отслеживаемого свойства name или age.</p>
<img src="./pics/33.png" alt="Отслеживание свойств в Vue.js" />
...
<div class="nav"><p><a href="1.10.php">Назад</a><a href="./">Содержание</a><a href="1.12.php">Вперед</a></p></div></div>
<div class="socBlock">
