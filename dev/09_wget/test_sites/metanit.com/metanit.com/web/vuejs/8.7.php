...
<html >
<head>
<title>Vue.js | Переадресация</title>
<meta charset="utf-8" />
<meta name="description" content="Переадресация в приложении Vue.js, параметр redirect в маршутах, динамический редирект, передача параметров при переадресации">
...
<h2>Переадресация</h2><div class="date">Последнее обновление: 29.10.2017</div>
...
<p>Здесь компонент NotFound обрабатывает запросы по пути "/404". Если путь не соответствует ни одному маршруту, то происходит переадресация по пути "/404".</p>
...
<h3>Переадресация с именованный маршрут</h3>
<p>Чтобы проще было управлять переадресацией можно установить редирект на маршрут по определенному имени:</p>
<pre class="brush:js;">
const routes = [
  { path: '/', component: Home },
...
на какой маршрут перенаправить пользователя.</p>
...
<div class="nav"><p><a href="8.6.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
