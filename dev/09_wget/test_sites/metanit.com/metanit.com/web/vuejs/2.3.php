...
<meta charset="utf-8" />
<meta name="description" content="v-for в Vue.js, вывод массивов, индексы элементов, перебор сложных объектов">
...
<h2>v-for</h2><div class="date">Последнее обновление: 29.08.2017</div>
...
<p>Для рендеринга коллекций предназначена директива <span class="b">v-for</span>. Она имеет следующий синтаксис:</p>
...
<p>Таким образом, для каждого элемента в массиве phones будет создаваться html-элемент <code>&lt;li&gt;</code>.</p>
<img src="./pics/21.png" alt="v-for и работа с массивами в Vue.js" />
...
<img src="./pics/22.png" alt="Перебор массива объектов с помощью v-for в Vue.js" />
<h3>Индексы</h3>
<p>При переборе элементов с помощью дополнительного параметра в v-for мы можем получить индекс элемента в массиве, используя следующий синтаксис:</p>
...
<img src="./pics/23.png" alt="Индексы элементов в массиве в v-for в Vue.js" />
...
<img src="./pics/25.png" alt="Перебор объекта в v-for" />
<h3>template</h3>
...
<img src="./pics/24.png" alt="template и v-for во Vue.js" />
<h3>Перебор чисел</h3>
...
<img src="./pics/26.png" alt="перебор чисел в v-for во Vue.js" />
