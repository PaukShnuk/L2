...
<html >
<head>
<title>Vue.js | Флажки (Checkbox)</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с флажками во Vue.js, элементы checkbox, привязка к сложным объектам">
...
<h2>Флажки (Checkbox)</h2><div class="date">Последнее обновление: 31.08.2017</div>
...
<p>Флажки представляют элементы управления, которые могут находиться в двух состояниях: отмеченном и неотмеченном.</p>
...
<img src="./pics/3.2.png" alt="Checkbox binding in Vue.js" />
...
<img src="./pics/3.8.png" alt="Checkbox in Vue" />
...
<img src="./pics/3.1.png" alt="Checkbox и привязка к массиву в Vue.js" />
...
<img src="./pics/3.11.png" alt="Checkbox и сложные объекты в Vue.js" />
