...
<html >
<head>
<title>Vue.js | Изменение внешних массивов и объектов в компонентах</title>
<meta charset="utf-8" />
<meta name="description" content="Изменение внешних массивов и объектов в компонентах во Vue.js, стратегии взаимодействия дочернего и родительского компонентов">
...
<h2>Изменение внешних массивов и объектов в компонентах</h2><div class="date">Последнее обновление: 29.09.2017</div>
...
<p>В отличие от строк, чисел, логических значений true и false массивы и сложные объекты передаются в компоненты по ссылке. То есть получив 
ссылку, мы манипулировать значением, которое хранится по этой ссылке.</p>
<h3>Изменение массивов</h3>
<p>Определим следующую веб-станицу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/56.png" alt="Изменение массивов в Vue.js" />
<h3>Изменение объектов</h3>
<p>Для изменения внешних объектов в компоненте можно использовать аналогичные техники. В частности, изменим страницу следующим образом:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<img src="./pics/55.png" alt="Изменение объектов в Vue.js" />
