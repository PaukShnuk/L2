...
<html >
<head>
<title>Node.JS | Организация тестов и метод describe</title>
<meta charset="utf-8" />
...
<h2>Организация тестов и метод describe</h2><div class="date">Последнее обновление: 17.01.2017</div>
...
<p>В процессе разработки у нас может быть множество модулей, и для каждого может быть определено несколько тестов. С помощью метода <span class="b">describe()</span>, 
...
другую группу. Разбиение на группы позволит легко идентифицировать, для какого модуля или группы не прошел тест, особенно если тестов очень много.</p>
<p>Например, пусть в проекте будет модуль <span class="ii">operations.js</span>:</p>
<pre class="brush:js;">
module.exports.multiply = function(x,y){return x * y;}
module.exports.add = function(x, y){ return x + y;}
</pre>
<p>Для этого модуля определим файл тестов <span class="ii">operations.test.js</span>:</p>
<pre class="brush:js;">
...
<p>В метод <code>describe()</code> в качестве первого параметра передается описание тестов, а в качестве второго - функция, которая содержит тесты.</p>
<p>Также пусть в проекте будет файл <span class="ii">app.js</span>:</p>
<pre class="brush:js;">
...
<p>Для него определим файл тестов <span class="ii">app.test.js</span>:</p>
<pre class="brush:js;">
...
<p>Запустим тесты:</p>
<img src="pics/5.8.png" alt="Метод describe и тестирование в Node.js" />
