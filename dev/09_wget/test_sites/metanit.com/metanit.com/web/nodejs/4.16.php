...
<html >
<head>
<title>Node.JS | Router в Express</title>
<meta charset="utf-8" />
<meta name="description" content="Объект Router в Express и в Node.js, объединение маршрутов">
...
<h2>Router</h2><div class="date">Последнее обновление: 21.11.2018</div>
...
<p><span class="b">Router</span> позволяет определить дочерние подмаршруты со своими обработчиками относительно 
некоторого главного маршрута. Например, определим следующее приложение:</p>
<pre class="brush:js;">
...
<p>Здесь у нас есть пять маршрутов, которые обрабатываются различными обработчиками. Но три из этих маршрутов начинаются с "/products" и условно 
...
Router позволяет связать подобный функционал в одно целое и упростить управление им. Например, перепишем предыдущий пример с использованием объекта Router:</p>
<pre class="brush:js;">
const express = require("express");
const app = express();
...
<p>Здесь определен объект productRouter, который обрабатывает все запросы по маршруту "/products". Это главный маршрут. 
...
обработчики.</p>
<img src="pics/4.18.png" alt="express.Router в Node.js" />
<img src="pics/4.19.png" alt="Объект Router в Express и Node.js" />
...
<div class="nav"><p><a href="4.15.php">Назад</a><a href="./">Содержание</a><a href="4.6.php">Вперед</a></p></div></div>
<div class="socBlock">
