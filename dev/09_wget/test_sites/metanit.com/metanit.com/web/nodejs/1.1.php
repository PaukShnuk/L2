...
<html >
<head>
<title>Node.JS | Введение и начало работы</title>
<meta charset="utf-8" />
<meta name="description" content="Введение,основные особенности и начало работы с Node.js, первая программа">
...
<h1>Введение в Node JS</h1><h2>Что такое Node JS. Начало работы</h2><div class="date">Последнее обновление: 13.05.2021</div>
...
<p>Node.js представляет среду выполнения кода на JavaScript, которая построена на основе движка  JavaScript Chrome V8, который позволяет 
...
как о платформе для создания веб-приложений.</p>
<p>Node.js является открытым проектом, исходники которого можно посмотреть на <a href="https://github.com/nodejs" rel="nofollow">github.com</a>.</p>
<h3>Установка</h3>
<p>Для загрузки перейдет на официальный сайт <a href="https://nodejs.org/en/" rel="nofollow">https://nodejs.org/en/</a>. На главной странице мы сразу увидим две возможные опции для загрузки: 
самая последняя версия NodeJS и LTS-версия.</p>
<img src="./pics/1.1.png" alt="Загрузка NodeJS" />
<p>Загрузим последнюю версию. В моем случае это версия 16.1.0. Для Windows установщик представляет файл с расширением msi. После запуска откроется программа установщика:</p>
<img src="./pics/1.2.png" alt="Установка Node JS на Windows" />
<p>После успешной установки вы можем ввести в командной строке/терминале команду <span class="b">node -v</span>, и нам отобразится текущая версия node.js:</p>
<div class="console">
...
<p>Версии node.js для других операционных систем наряду с исходниками можно найти по адресу <a href="https://nodejs.org/en/download/" rel="nofollow">https://nodejs.org/en/download/</a></p>
<h3>Инструменты разработки</h3>
<p>Для разработки под Node JS достаточно простейшего текстового редактора, в частности, Notepad++. Также можно использовать более изощренные редакторы типа Atom, Sublime, 
Visual Studio Code, либо среды разработки, которые поддерживают работу с Node.JS, например, Visual Studio или WebStorm.</p>
<h3>REPL</h3>
<p>После установки NodeJS нам становится доступным такой инструмент как REPL. REPL (Read Eval Print Loop) представляет возможность запуска выражений на языке JavaScript в командной строке или терминале.</p>
<p>Так, запустим командную строку (на Windows) или терминал (на OS X или Linux) и введем команду <span class="b">node</span>. После ввода этой команды 
мы можем выполнять различные выражения на JavaScript:</p>
<div class="console">
<pre class="consoletext">
...
<p>Или используем какую-нибудь функцию JS:</p>
<div class="console">
<pre class="consoletext">
...
<p>Можно определять свои функции и затем их вызывать, например, возведение числа в квадрат:</p>
<div class="console">
<pre class="consoletext">
...
<p>Если мы введем что-то неправильно, то REPL укажет об ошибке:</p>
<img src="./pics/1.5.png" alt="REPL in Node JS" />
<h3>Выполнение файла</h3>
<p>Вместо того чтобы вводить весь код напрямую в консоль, удобнее вынести его во внешний файл. Например, создадим на жестком диске 
новый каталог, допустим, <code>C:\node\helloapp</code>, в который поместим новый файл <span class="b">app.js</span> со следующим кодом:</p>
<pre class="brush:js;">console.log("Hello world");</pre>
<p>В командной строке перейдем с помощью команды <span class="b">cd</span> к каталогу helloapp, а затем выполним команду:</p>
<div class="console">
<pre class="consoletext">
node app.js
</pre>
</div>
<p>Данная команда выполнит код из файла app.js:</p>
<img src="./pics/1.6.png" alt="Выполнение файла в Node.js" />
