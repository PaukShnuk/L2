...
<meta charset="utf-8" />
<meta name="description" content="Установка и использование модуля Nodemon в Node.js">
...
<h2>Nodemon</h2><div class="date">Последнее обновление: 17.11.2018</div>
...
<p>В процессе разработки может потребоваться необходимость внести изменения в уже запущенный проект. Допустим, у нас в файле <span class="ii">app.js</span> определен следующий код:</p>
<pre class="brush:js;">
...
<p>Запустим сервер с помощью команды <code>node app.js</code>, и при обращении пользователя по адресу <span class="ii">http://localhost:3000/</span> браузер пользователя отобразит строку "Hello World!". Одновременно строка выводится на консоль.</p>
<img src="pics/2.11.png" alt="Nodemon в Node.js" />
<p>При этом сервер продолжает быть запущенным. И если мы изменим переменную message в файле app.js, то это никак не повлияет на работу сервера, и он будет продолжать 
отдавать клиенту строку "Hello World!".</p>
<p>В этом случае необходимо перезапустить сервер. Однако это не очень удобно, особенно когда необходимо часто делать различные изменения, тестировать выполнение. 
И в этом случае нам может помочь специальный инструмент <span class="b">nodemon</span>.</p>
<p>Установим nodemon в проект с помощью следующей команды:</p>
<div class="console">
<pre class="consoletext">
npm install nodemon -g
</pre>
</div>
<p>Флаг <code>-g</code> представляет сокращение от <code>global</code> и позволяет установить зависимость nodemon глобально для всех проектов на данной локальной машине.</p>
<p>После установки запустим файл app.js с помощью следующей команды:</p>
<div class="console">
<pre class="consoletext">
nodemon app.js
</pre>
</div>
<p>И если вдруг после запуска сервера мы изменим его код, например, поменяем переменную message с "Hello World!" на "Привет мир!", то сервер автоматически 
будет перезапущен:</p>
<img src="pics/2.12.png" alt="Nodemon в Node JS" />
