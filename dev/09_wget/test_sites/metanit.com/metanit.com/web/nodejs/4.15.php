...
<html >
<head>
<title>Node.JS | Параметры маршрута в Express</title>
<meta charset="utf-8" />
<meta name="description" content="Определение и получение параметров маршрута в Express и в Node.js, объект req.params">
...
<h2>Параметры маршрута</h2><div class="date">Последнее обновление: 21.11.2018</div>
...
<p>Параметры маршрута представляют именованные сегменты URL-адреса. Не стоит их путать с параметрами строки запроса. Например:</p>
<pre class="brush:js;">
localhost:3000/about/user?id=3&name=Tome
</pre>
<p>Здесь параметры строки запроса - это то, что идет после вопросительного знака - <code>id=3&name=Tome</code>. Остальная часть, которая идет до 
вопросительного знака может содержать параметры маршрута.</p>
<p>Название параметра должно включать символы из диапазона [A-Za-z0-9_]. В определении маршрута параметры предваряются 
знаком двоеточия:</p>
<pre class="brush:js;">
...
<p>В данном случае параметр называется "productId". Через коллекцию <span class="b">request.params</span> можно получить все параметры и, в частности, 
значение параметра productId.</p>
...
<img src="pics/4.14.png" alt="Параметры в Express и Node.js" />
<img src="pics/4.15.png" alt="Передача параметров в Express и Node.js" />
...
<img src="pics/4.16.png" alt="Получение параметров в Express и Node.js" />
<p>Или к примеру:</p>
<pre class="brush:js;">
...
<img src="pics/4.17.png" alt="Комбинация параметров в Express и Node.js" />
...
<div class="nav"><p><a href="4.5.php">Назад</a><a href="./">Содержание</a><a href="4.16.php">Вперед</a></p></div></div>
<div class="socBlock">
