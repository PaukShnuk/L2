...
<html >
<head>
<title>Node.JS | Определение схемы в Mongoose</title>
<meta charset="utf-8" />
<meta name="description" content="Определение схемы в Mongoose для работы с MongoDB в Node.js">
...
<h2>Определение схемы в Mongoose</h2><div class="date">Последнее обновление: 11.08.2021</div>
...
<p>Подробнее про определение типов можно посмотреть по ссылке <a href="http://mongoosejs.com/docs/schematypes.html" rel="nofollow">http://mongoosejs.com/docs/schematypes.html</a>.</p>
<p>Но название свойств и их тип - это не все, что мы можем здесь определить.</p>
<h3>Значение по умолчанию</h3>
<p>С помощью параметра <span class="b">default</span> мы можем указать значение по умолчанию для свойства. Например:</p>
<pre class="brush:js;">
const userScheme = new Schema({
	name: {
		type: String,
...
<ul>
<li><p><span class="b">required</span>: требует обязательного наличия значения для свойства</p></li>
<li><p><span class="b">min</span> и <span class="b">max</span>: задают минимальное и максимальное значения для числовых данных</p></li>
<li><p><span class="b">minlength</span> и <span class="b">maxlength</span>: задают минимальную и максимальную длину для строк</p></li>
<li><p><span class="b">enum</span>: строка должна представлять одно из значений в указанном массиве строк</p></li>
<li><p><span class="b">match</span>: строка должна соответствовать регулярному выражению</p></li>
</ul>
...
<img src="./pics/7.11.png" alt="Валидация в Mongoose и Node.js" />
<h3>Версия документа</h3>
<p>По умолчанию при сохранении данных Mongoose добавляет специальное поле <span class="b">__v</span>, которое указывает 
на версию документа:</p>
<pre class="brush:js;">
...
<img src="pics/7.12.png" alt="Version в Mongoose и Node.js" />
<p>Не всегда подобное поле необходимо, и его можно отключить, добавив в схему объект <span class="b">{ versionKey: false }</span>:</p>
<pre class="brush:js;">
const userScheme = new Schema(
