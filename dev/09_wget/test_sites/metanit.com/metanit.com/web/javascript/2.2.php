...
<html >
<head>
<title>JavaScript | Типы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Типы данных в языке программирования JavaScript, числа, строки, логические значения true и false, отличие null от undefined">
...
<h2>Типы данных</h2><div class="date">Последнее обновление: 08.09.2021</div>
...
указывается выражение. Так, в примере выше <code>${user}</code> означает, что в этом месте строки надо встроить значение переменной <code>user</code>.</p>
...
<h3>Слабая типизация</h3>
<p>JavaScript является языком со слабой типизацией. Это значит, что переменные могут динамически менять тип. Например:</p>
<pre class="brush:js;">
