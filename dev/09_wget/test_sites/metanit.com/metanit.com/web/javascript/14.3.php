...
<html >
<head>
<title>JavaScript | Множества Set</title>
<meta charset="utf-8" />
<meta name="description" content="Множества Set в языке программирования JavaScript, создание множеств, добавление и удаление элементов, перебор множества">
...
<h2>Множества Set</h2><div class="date">Последнее обновление: 25.08.2021</div>
...
<code>values()</code>, <code>keys()</code>, <code>values()</code>:</p>
<pre class="brush:js;">
const numbers = new Set([1, 2, 3, 5]);
