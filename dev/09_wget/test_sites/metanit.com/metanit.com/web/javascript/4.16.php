...
<html >
<head>
<title>JavaScript | Приватные поля и методы</title>
<meta charset="utf-8" />
<meta name="description" content="Приватные поля и методы в языке программирования JavaScript, символ #, ограничение доступа к свойствам, полям и методам класса, инккапсуляция">
...
<h2>Приватные поля и методы</h2><div class="date">Последнее обновление: 18.08.2021</div>
...
<div class="nav"><p><a href="./4.12.php">Назад</a><a href="./">Содержание</a><a href="./4.17.php">Вперед</a></p></div></div>
<div class="socBlock">
