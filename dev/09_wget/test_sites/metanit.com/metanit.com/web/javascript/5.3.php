...
<html >
<head>
<title>JavaScript | Создание массива и объект Array</title>
<meta charset="utf-8" />
<meta name="description" content="Создание массива и объект Array в языке JavaScript, добавление и получение элементов, перебор массивов, функции Array.of и Array.from">
...
<h1>Массивы</h1><h2>Создание массива и объект Array</h2><div class="date">Последнее обновление: 18.08.2021</div>
...
<div class="nav"><p><a href="./4.15.php">Назад</a><a href="./">Содержание</a><a href="./5.6.php">Вперед</a></p></div></div>
<div class="socBlock">
