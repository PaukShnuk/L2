...
<html >
<head>
<title>JavaScript | Использование псевдонимов при экспорте и импорте</title>
<meta charset="utf-8" />
<meta name="description" content="Использование псевдонимов при экспорте и импорте компонентов модулей в языке программирования JavaScript, операторы as, import и export">
...
<h2>Использование псевдонимов при экспорте и импорте</h2><div class="date">Последнее обновление: 17.09.2021</div>
...
<div class="nav"><p><a href="./19.5.php">Назад</a><a href="./">Содержание</a><a href="./19.6.php">Вперед</a></p></div></div>
<div class="socBlock">
