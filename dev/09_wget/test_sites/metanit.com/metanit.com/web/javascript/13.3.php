...
<html >
<head>
<title>JavaScript | Promise в Ajax-запросах</title>
<meta charset="utf-8" />
<meta name="description" content="Promise в Ajax, асинхронные запросы в JavaScript с помощью XMLHttpRequest, методы then и catch, отправка данных на сервер, обработка ответа и ошибок">
...
<h2>Promise в Ajax-запросах</h2><div class="date">Последнее обновление: 04.02.2022</div>
...
<div class="nav"><p><a href="./13.2.php">Назад</a><a href="./">Содержание</a><a href="./18.1.php">Вперед</a></p></div></div>
<div class="socBlock">
