...
<html >
<head>
<title>JavaScript | Консоль браузера и console.log</title>
<meta charset="utf-8" />
<meta name="description" content="Использование консоли браузера в JavaScript, метод console.log, применение метода document.write для вывода текста на страницу">
...
<h2>Консоль браузера и console.log</h2><div class="date">Последнее обновление: 01.07.2021</div>
...
<p>Незаменимым инструментом при работе с JavaScript является консоль браузера, которая позволяет производить отладку программы. Во многих современных 
браузерах есть подобная консоль. Например, чтобы открыть консоль в Google Chrome, нам надо перейти в меню <span class="b">Дополнительные инструменты (More Tools) -&gt; 
Инструменты разработчика (Developer tools)</span>:</p>
<img src="./pics/1.8.png" alt="Отладка JavaScript в Google Chrome" />
<p>После этого внизу браузера откроется консоль:</p>
<img src="./pics/1.9.png" alt="Консоль JavaScript в Google Chrome" />
<p>Мы можем напрямую вводить в консоль браузера выражения JavaScript, и они будут выполняться. Например, введем в консоли следующий текст:</p>
<pre class="brush:js;">
alert("Привет мир");
</pre>
<p>Функция <span class="b">alert()</span> выводит в браузере окно с сообщением. В итоге после ввода этой команды и нажатия на клавишу Enter 
браузер выполнит эту функцию и отобразит нам окно с сообщением:</p>
<img src="./pics/1.10.png" alt="Ввод команд JavaScript в консоли браузера Google Chrome" />
<p>Для вывода различного рода информации в консоли браузера используется специальная функция <span class="b">console.log()</span>. Например, 
определим следующую веб-страницу:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>В коде javascript с помощью ключевого слова <span class="b">var</span> объявляется переменная <code>a</code>, которой присваивается сумма двух чисел 5 и 8:</p>
<pre class="brush:js;">var a = 5 + 8;</pre>
<p>Далее с помощью метода <code>console.log()</code> на консоль браузера выводится некоторое сообщение</p>
<pre class="brush:js;">console.log("Результат операции");</pre>
<p>И в конце также с помощью метода <code>console.log()</code> на консоль браузера выводится значение переменной a.</p>
<pre class="brush:js;">console.log(a);</pre>
<p>И после запуска веб-страницы в браузере мы увидим в консоли результат выполнения кода:</p>
<img src="./pics/1.11.png" alt="Функция console.log() в JavaScript" />
<p>Что очень полезно, в консоли браузера вы также можете заметить номера строк кода, где именно выполнялся вывод на консоль.</p>
<p>В дальнейшем мы часто будем обращаться к консоли и использовать функцию console.log.</p>
<p>Причем подобный код мы могли бы ввести в самой консоли:</p>
<img src="./pics/1.6.png" alt="Консоль JavaScript в браузере" />
<p>Также последовательно вводим инструкции и после ввода каждой инструкции нажимаем на Enter.</p>
<p>Если нам надо, чтобы код в консоли переносился на новую строку без выполнения, то в конце выражения javascript нажимаем на комбинацию клавиш <span class="b">Shift + Enter</span>. После ввода последней 
инструкции для выполнения введенного кода javascript нажимаем на Enter.</p>
