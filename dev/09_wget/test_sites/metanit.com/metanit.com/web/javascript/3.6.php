...
<meta charset="utf-8" />
<meta name="description" content="Процесс Hoisting в JavaScript, проходы компилятора, использование переменных и функций до их определения">
...
<h2>Hoisting</h2><div class="date">Последнее обновление: 22.11.2016</div>
...
<p>Переменные, которые попадают под hoisting, получают значение undefined.</p>
<p>Например, возьмем следующий простейший код:</p>
...
<p>Поэтому при определении переменных и функций следует учитывать перепетии такого аспекта как hoisting.</p>
