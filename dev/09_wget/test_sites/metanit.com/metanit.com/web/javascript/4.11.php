...
<html >
<head>
<title>JavaScript | Деструктуризация</title>
<meta charset="utf-8" />
<meta name="description" content="Деструктуризация (destructuring) в языке программирования JavaScript, разложение массива и объекта на переменные и константы">
...
<h2>Деструктуризация</h2><div class="date">Последнее обновление: 06.09.2021</div>
