...
<html >
<head>
<title>JavaScript | Асинхронные генераторы</title>
<meta charset="utf-8" />
<meta name="description" content="Асинхронные генераторы в языке программирования JavaScript, оператор yield и возвращение объекта Promise, перебор генератора в цикле for-await-of, оераторы async и await">
...
<h2>Асинхронные генераторы</h2><div class="date">Последнее обновление: 04.09.2021</div>
...
<div class="nav"><p><a href="./17.7.php">Назад</a><a href="./">Содержание</a><a href="./13.1.php">Вперед</a></p></div></div>
<div class="socBlock">
