...
<html >
<head>
<title>JavaScript | Конструкция try..catch..finally</title>
<meta charset="utf-8" />
<meta name="description" content="Обработка ошибок в языке программирования JavaScript, конструкция try..catch..finally, получение информации об ошибке">
...
<h1>Обработка ошибок</h1><h2>Конструкция try..catch..finally</h2><div class="date">Последнее обновление: 30.08.2021</div>
...
<div class="nav"><p><a href="./5.9.php">Назад</a><a href="./">Содержание</a><a href="./16.2.php">Вперед</a></p></div></div>
<div class="socBlock">
