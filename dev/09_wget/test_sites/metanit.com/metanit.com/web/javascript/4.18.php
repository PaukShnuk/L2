...
<html >
<head>
<title>JavaScript | Оператор ?.</title>
<meta charset="utf-8" />
<meta name="description" content="Оператор ?. (optional chaning) в языке программирования JavaScript, проверка объекта и его свойств и методов на null и undefined">
...
<h2>Оператор ?.</h2><div class="date">Последнее обновление: 09.09.2021</div>
...
<div class="nav"><p><a href="./4.11.php">Назад</a><a href="./">Содержание</a><a href="./4.12.php">Вперед</a></p></div></div>
<div class="socBlock">
