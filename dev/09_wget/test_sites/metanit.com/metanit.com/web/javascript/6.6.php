...
<html >
<head>
<title>JavaScrip | Группы в регулярных выражениях</title>
<meta charset="utf-8" />
<meta name="description" content="Группы в регулярных выражениях в языке программирования JavaScript, именнованные группы, получение знчений отдельных групп по номеру и по имени">
...
<h2>Группы в регулярных выражениях</h2><div class="date">Последнее обновление: 07.09.2021</div>
...
<div class="nav"><p><a href="./6.4.php">Назад</a><a href="./">Содержание</a><a href="./5.1.php">Вперед</a></p></div></div>
<div class="socBlock">
