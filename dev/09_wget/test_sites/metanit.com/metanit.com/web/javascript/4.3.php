...
<html >
<head>
<title>JavaScript | Проверка наличия и перебор методов и свойств объекта</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка наличия объекта JavaScript, оператор in, перебор методов и свойств объекта с помощью цикла for, функции Object.keys, Object.values, Object.entries, оператор ?.">
...
<h2>Проверка наличия и перебор методов и свойств</h2><div class="date">Последнее обновление: 08.09.2021</div>
...
<p>Подобным обпазом можно проверить и наличие методов:</p>
<pre class="brush:js;">
...
<div class="nav"><p><a href="./4.13.php">Назад</a><a href="./">Содержание</a><a href="./4.4.php">Вперед</a></p></div></div>
<div class="socBlock">
