...
<html >
<head>
<title>JavaScript | Локализация названий и Intl.DisplayNames</title>
<meta charset="utf-8" />
<meta name="description" content="Локализация названий и объект Intl.DisplayNames в языке программирования JavaScript, форматирование и локализация названий стран и регионов, валют, языков">
...
<h2>Локализация названий и Intl.DisplayNames</h2><div class="date">Последнее обновление: 14.09.2021</div>
