...
<html >
<head>
<title>JavaScript | Параметры функции</title>
<meta charset="utf-8" />
<meta name="description" content="Параметры функции в JavaScript, передача параметрам значений, необязательные параметры, spread-оператор, значения по умолчанию, функция как параметр другой функции">
...
<h2>Параметры функции</h2><div class="date">Последнее обновление: 28.08.2021</div>
...
<div class="nav"><p><a href="./3.1.php">Назад</a><a href="./">Содержание</a><a href="./3.11.php">Вперед</a></p></div></div>
<div class="socBlock">
