...
<html >
<head>
<title>JavaScript | Динамическая загрузка модулей</title>
<meta charset="utf-8" />
<meta name="description" content="Динамическая загрузка модулей в языке программирования JavaScript, обращение к компонентам модуля, загрузка в виде промиса Promise и через оператор await">
...
<h2>Динамическая загрузка модулей</h2><div class="date">Последнее обновление: 17.09.2021</div>
...
<div class="nav"><p><a href="./19.5.php">Назад</a><a href="./">Содержание</a><a href="./20.1.php">Вперед</a></p></div></div>
<div class="socBlock">
