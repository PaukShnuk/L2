...
<html >
<head>
<title>JavaScript | Наследование массивов</title>
<meta charset="utf-8" />
<meta name="description" content="Наследование массивов в языке JavaScript, создание своих коллекций">
...
<h2>Наследование массивов</h2><div class="date">Последнее обновление: 18.08.2021</div>
...
<p>Массив представляет наиболее простой способ определения набора данных. Но иногда базовых возможностей массивов может быть недсотаточно. Например, определим массив, который представляет некоторую команду:</p>
<pre class="brush:js;">
...
<div class="nav"><p><a href="./5.7.php">Назад</a><a href="./">Содержание</a><a href="./6.1.php">Вперед</a></p></div></div>
<div class="socBlock">
