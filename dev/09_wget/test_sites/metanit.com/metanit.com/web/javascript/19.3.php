...
<html >
<head>
<title>JavaScript | Экспорт и импорт компонентов модулей</title>
<meta charset="utf-8" />
<meta name="description" content="Экспорт и импорт компонентов модулей в языке программирования JavaScript, операторы import и export, подключение модулей, экспорт списка компонентов модуля">
...
<h2>Экспорт и импорт компонентов модулей</h2><div class="date">Последнее обновление: 17.09.2021</div>
