...
<html >
<head>
<title>JavaScript | Локализация дат и времени</title>
<meta charset="utf-8" />
<meta name="description" content="Локализация дат и времени и объект Intl.DateTimeFormat в языке программирования JavaScript, настройка форматирования даты и времени">
...
<h2>Локализация дат и времени</h2><div class="date">Последнее обновление: 14.09.2021</div>
...
<li><p><span class="b">timeStyle</span>: определяет стиль форматирования даты. Возможные значения:</p>
<ul>
<li><p><code>"full"</code></p></li>
<li><p><code>"long"</code></p></li>
<li><p><code>"medium"</code></p></li>
...
<li><p><span class="b">day</span>: определяет формат года. Возможные значения:</p>
<ul>
<li><p><code>"numeric"</code> (например, 2)</p></li>
<li><p><code>"2-digit"</code> (в виде двухцифрового кода, например, 02)</p></li>
</ul>
