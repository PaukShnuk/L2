...
<html >
<head>
<title>JavaScript | Область видимости переменных и констант</title>
<meta charset="utf-8" />
<meta name="description" content="Область видимости переменных в JavaScript, глобальные и локальные переменные, режим strict mode, отличие var от let">
...
<h2>Область видимости переменных</h2><div class="date">Последнее обновление: 23.02.2022</div>
...
То есть каждый блок кода определяет новую область видимости, в которой существует переменная. Ве блока кода, где определена переменная, она не существует. 
