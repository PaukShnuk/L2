...
<html >
<head>
<title>JavaScript | Экспорт и импорт по умолчанию</title>
<meta charset="utf-8" />
<meta name="description" content="Экспорт и импорт компонентов модулей по умолчанию в языке программирования JavaScript, операторы default, import и export">
...
<h2>Экспорт и импорт по умолчанию</h2><div class="date">Последнее обновление: 17.09.2021</div>
