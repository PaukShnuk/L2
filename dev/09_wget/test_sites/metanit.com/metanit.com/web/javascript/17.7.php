...
<html >
<head>
<title>JavaScript | Асинхронные итераторы</title>
<meta charset="utf-8" />
<meta name="description" content="Асинхронные итераторы в языке программирования JavaScript, метод Symbol.asyncIterator, цикл for-await-of, метод next и возвращение объекта Promise">
...
<h2>Асинхронные итераторы</h2><div class="date">Последнее обновление: 04.09.2021</div>
...
А свойство <code>done</code> указывает, есть ли в наборе еще объекты, доступные для перебора. Если свойство <code>done</code> равно <code>false</code>, 
...
<div class="nav"><p><a href="./17.6.php">Назад</a><a href="./">Содержание</a><a href="./17.8.php">Вперед</a></p></div></div>
<div class="socBlock">
