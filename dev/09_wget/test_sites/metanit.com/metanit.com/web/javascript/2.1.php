...
<html >
<head>
<title>JavaScript | Переменные и константы</title>
<meta charset="utf-8" />
<meta name="description" content="Определение и использование переменных и констант в языке программирования JavaScript, ключевые слова var, let, const">
...
<h1>Основы javascript</h1><h2>Переменные и константы</h2><div class="date">Последнее обновление: 22.11.2021</div>
