...
<html >
<head>
<title>JavaScript | Передача параметров по значению и по ссылке</title>
<meta charset="utf-8" />
<meta name="description" content="Передача параметров в функцию по значению и по ссылке в JavaScript">
...
<h2>Передача параметров по значению и по ссылке</h2><div class="date">Последнее обновление: 27.03.2018</div>
