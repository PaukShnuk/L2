...
<meta charset="utf-8" />
<meta name="description" content="Коллекция WeakMap в языке программирования JavaScript, отличие от Map, добавление и удаление элементов, слабые ссылки">
...
<h2>WeakMap</h2><div class="date">Последнее обновление: 26.08.2021</div>
...
<p>WeakMap представляет развитие коллекции Map. Особенностью WeakMap является то, что все ее элементы должны представлять объекты. При этом объектами должны быть как ключи, так и значения.</p>
...
<div class="nav"><p><a href="./14.5.php">Назад</a><a href="./">Содержание</a><a href="./17.1.php">Вперед</a></p></div></div>
<div class="socBlock">
