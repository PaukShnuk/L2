...
<html >
<head>
<title>JavaScript | Шаблоны строк</title>
<meta charset="utf-8" />
<meta name="description" content="Шаблоны строк template strings / template literals в JavaScript, вставка значений в строку, передачаша шаблонов в функцию">
...
<h2>Шаблоны строк</h2><div class="date">Последнее обновление: 17.07.2021</div>
...
<p>Шаблоны строк (template strings / template literals) позволяют вставлять в строку различные значения. Подобный прием еще называют интерполяцией. 
