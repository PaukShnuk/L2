...
<html >
<head>
<title>JavaScript | Объект Date. Работа с датами</title>
<meta charset="utf-8" />
<meta name="description" content="Работа с датами и временем в JavaScript, объект Date и его методы">
...
<h1>Встроенные объекты</h1><div class="date">Последнее обновление: 1.11.2015</div>
...
<div class="nav"><p><a href="./6.6.php">Назад</a><a href="./">Содержание</a><a href="./5.2.php">Вперед</a></p></div></div>
<div class="socBlock">
