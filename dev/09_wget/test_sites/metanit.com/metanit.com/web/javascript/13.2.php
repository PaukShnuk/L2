...
<html >
<head>
<title>JavaScript | Отправка данных</title>
<meta charset="utf-8" />
<meta name="description" content="Отправка данных на сервер через ajax в запросе POST с помощью XMLHttpRequest и метода send в языке программирования JavaScript на примере сервера node.js">
...
<h2>Отправка данных</h2><div class="date">Последнее обновление: 04.02.2022</div>
