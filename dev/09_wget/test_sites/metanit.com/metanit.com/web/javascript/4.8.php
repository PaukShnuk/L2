...
<html >
<head>
<title>JavaScript | Функция как объект. Методы call и apply</title>
<meta charset="utf-8" />
<meta name="description" content="Функция как объект в языке программирования JavaScript. Методы call и apply">
...
<h2>Функция как объект. Методы call и apply</h2><div class="date">Последнее обновление: 1.11.2015</div>
