...
<html >
<head>
<title>JavaScript | Функция fetch</title>
<meta charset="utf-8" />
<meta name="description" content="Fetch API в языке программирования JavaScript, функция fetch и обращение к сетевым ресурсам, получение ответа сервера, async и await">
...
<h1>Fetch API</h1><h2>Функция fetch</h2><div class="date">Последнее обновление: 02.12.2021</div>
...
<div class="nav"><p><a href="./19.6.php">Назад</a><a href="./">Содержание</a><a href="./20.2.php">Вперед</a></p></div></div>
<div class="socBlock">
