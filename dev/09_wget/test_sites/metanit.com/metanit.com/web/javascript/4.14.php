...
<html >
<head>
<title>JavaScript | Свойства и методы доступа</title>
<meta charset="utf-8" />
<meta name="description" content="Свойства и методы доступа get и set в языке программирования JavaScript, получение и установка значения свойств, свойства только для записи и для чтения">
...
<h2>Свойства и методы доступа</h2><div class="date">Последнее обновление: 18.08.2021</div>
...
<div class="nav"><p><a href="./4.17.php">Назад</a><a href="./">Содержание</a><a href="./4.15.php">Вперед</a></p></div></div>
<div class="socBlock">
