...
<html >
<head>
<title>JavaScript | Условные операторы ?: и ??</title>
<meta charset="utf-8" />
<meta name="description" content="Условные операторы ?: и ?? в языке программирования JavaScript, проверка переменных и констант на null и undefined, выполнение действие по условию">
...
<h2>Условные операторы ?: и ??</h2><div class="date">Последнее обновление: 10.09.2021</div>
...
<p>Условные операторы позволяют проверить некотоое условие и в зависимости от результата проверки выполнить определенные действия. 
