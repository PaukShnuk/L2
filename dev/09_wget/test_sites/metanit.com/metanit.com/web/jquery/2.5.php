...
<html >
<head>
<title>Поиск в выборке</title>
<meta charset="utf-8" />
<meta name="description" content="Поиск в выборке jquery с помощью метода find, его параметры и примеры использования">
...
<h2>Поиск в выборке</h2><div class="date">Последнее обновление: 1.11.2015</div>
...
<p>Для поиска в выборке предназначен метод <code>find</code>. Он имеет следующие варианты использования:</p>
<ul>
<li><p><code>find(селектор)</code>: поиск в выборке объектов, соответствующих селектору</p></li>
<li><p><code>find(элемент)</code>: поиск в выборке объектов, соответствующих данному элементу html</p></li>
<li><p><code>find(jQuery)</code>: поиск в выборке объектов, соответствующих объекту jQuery</p></li>
</ul>
<p>Метод find на выходе возвращает новую выборку. Например, у нас есть следующая разметка меню в виде списков:</p>
<pre class="brush:xml;">
&lt;ul class="menu"&gt;
	&lt;li&gt;Пункт 1&lt;/li&gt;
	&lt;li&gt;Пункт 2
...
<p>Теперь последовательно осуществим поиск п селектору, элементу и объекту jQuery:</p>
<pre class="brush:js;">
$(function(){
	// поиск по селектору
