...
<html >
<head>
<title>Dart | Операции присваивания и приоритет операций</title>
<meta charset="utf-8" />
<meta name="description" content="Операции присваивания и приоритет операций в языке программирования Dart">
...
<h2>Операции присваивания и приоритет операций</h2><div class="date">Последнее обновление: 12.05.2020</div>
...
<p>В завершении рассмотрим операции присваивания, которые в основном представляют комбинацию простого присваивания с другими операциями:</p>
<ul>
<li><p><code>=</code></p><p> просто приравнивает одно значение другому: <code>c=b;</code></p></li>
<li><p><code>+=</code></p><p><code>c+=b;</code> (переменной c присваивается результат сложения c и b)</p></li>
<li><p><code>-=</code></p><p><code>c-=b;</code> (переменной c присваивается результат вычитания b из c)</p></li>
<li><p><code>*=</code></p><p><code>c*=b;</code> (переменной c присваивается результат произведения c и b)</p></li>
<li><p><code>/=</code></p><p><code>c/=b;</code> (переменной c присваивается результат деления c на b)</p></li>
<li><p><code>~/=</code></p><p><code>c~/=b;</code> (переменной c присваивается результат целочисленного деления c на b)</p></li>
<li><p><code>%=</code></p><p><code>c%=b;</code> (переменной c присваивается остаток от деления c на b)</p></li>
<li><p><code>&amp;=</code></p><p><code>c&amp;=b;</code> (переменной c присваивается значение c&amp;b)</p></li>
<li><p><code>|=</code></p><p><code>c|=b;</code> (переменной c присваивается значение c|b)</p></li>
<li><p><code>^=</code></p><p><code>c^=b;</code> (переменной c присваивается значение c^b)</p></li>
<li><p><code>&lt;&lt;=</code></p><p><code>c&lt;&lt;=b;</code> (переменной c присваивается значение c&lt;&lt;b)</p></li>
<li><p><code>&gt;&gt;=</code></p><p><code>c&gt;&gt;=b;</code> (переменной c присваивается значение c&gt;&gt;b)</p></li>
<li><p><code>??=</code></p><p><code>c ??= b;</code> (если переменная c имеет значение null, то ей присваивается значение переменной b; если переменная c НЕ равна null, 
то она сохраняет свое значение)</p></li>
</ul>
...
<p>При работе с операциями важно понимать их приоритет, который можно описать следующей таблицей:</p>
<table class="tab">
<tr><td><p>expr++ expr--</p></td></tr>
<tr><td><p>-expr !expr ~expr ++expr --expr</p></td></tr>
<tr><td><p>* / % ~/</p></td></tr>
<tr><td><p>+ -</p></td></tr>
<tr><td><p>&lt;&lt; &gt;&gt; &gt;&gt;&gt;</p></td></tr>
<tr><td><p>&amp;</p></td></tr>
<tr><td><p>^</p></td></tr>
<tr><td><p>|</p></td></tr>
<tr><td><p>&lt; &gt; &lt;= &gt;= as is is!</p></td></tr>
<tr><td><p>== !=</p></td></tr>
<tr><td><p>&amp;&amp;</p></td></tr>
<tr><td><p>||</p></td></tr>
<tr><td><p>??</p></td></tr>
<tr><td><p>? : (тернарный оператор)</p></td></tr>
<tr><td><p>.. (spread-оператор)</p></td></tr>
<tr><td><p>= += -= *= /= %= ~/= &= ^= |= &lt;&lt;= &gt;&gt;= (операторы присваивания)</p></td></tr>
</table>
<p>Чем выше оператор в этой таблице, тем больше его приоритет. При этом скобки повышают приоритет операции, используемой в выражении.</p>
