...
<html >
<head>
<title>Dart | Анонимные и вложенные функции</title>
<meta charset="utf-8" />
<meta name="description" content="Анонимные и вложенные функции в языке программирования Dart">
...
<h2>Анонимные и вложенные функции</h2><div class="date">Последнее обновление: 14.05.2020</div>
...
<p>Анонимные функции похожи на обычные функции за тем исключением, что они не имеют названия. Например:</p>
...
<p>В данном случае переменной operation присваивается ссылка на анонимную функцию <code>(a, b) =&gt; a + b</code>, которая принимает два параметра и 
возвращает сумму их значений.</p>
<p>В данном случае анонимная функция имеет сокращенную запись, но мы также ее можем развернуть:</p>
<pre class="brush:dart;">
void main() {
...
<p>Где имеет смысл использовать анонимные функции? Если мы вызываем функцию, которая принимает другую функцию, то для функции-параметра может быть проще использовать 
анонимную функцию, чем определять именованную, особенно если именованная функция нам больше нигде не понадобится:</p>
<pre class="brush:dart;">
void main() {
...
<p>В Dart функции могут быть вложенными в другие функции:</p>
<pre class="brush:dart;">
void main() {
...
<p>Причем определение вложенной функции должно идти до ее вызова. Вложенные функции имеют смысл, если мы планируем использовать некие повторяющиеся действия 
только внутри определенной функции.</p>
<p>Причем вложенные функции сами могут содержать другие вложенные функции:</p>
<pre class="brush:dart;">
void main() {
...
<p>Стоит отметить, что вложенные функции образуют собственный контекст - переменные и константы, к которым внешняя функция не может обратиться. Например:</p>
<pre class="brush:dart;">
void main() {
...
<p>В данном случае переменная message определена внутри функции welcome, поэтому может вызываться только в рамках этой функции, но не вне ее.</p>
...
<ul>
<li><a title="Вопросы для самопроверки" href="../questions/2.1.php"><i class="fa fa-lg fa-question"></i><span class="dop-txt">Вопросы для самопроверки</span></a></li>
</ul>
</fieldset></div>
