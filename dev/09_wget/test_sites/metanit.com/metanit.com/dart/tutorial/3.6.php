...
<html >
<head>
<title>Dart | Замыкания</title>
<meta charset="utf-8" />
<meta name="description" content="Замыкания (closure) в языке программирования Dart, основные понятия, примеры использования">
...
<h2>Замыкания</h2><div class="date">Последнее обновление: 13.05.2020</div>
...
<pre class="brush:dart;">Function fn = outer();</pre>
...
<pre class="brush:dart;">(int m) =&gt; n * m;</pre>
<p>запоминает окружение, в котором она была создана, в частности, значение параметра n.</p>
...
<p>То есть result1 — это замыкание, которое содержит и внутреннюю функцию <code>(int m) =&gt; n * m;</code>, и параметр n, который существовал во время создания замыкания.</p>
<p>При этом важно не запутаться в параметрах. При определении замыкания:</p>
<pre class="brush:dart;">Function func = multiply(5);</pre>
