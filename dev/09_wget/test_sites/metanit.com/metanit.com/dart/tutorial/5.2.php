...
<html >
<head>
<title>Dart | Set</title>
<meta charset="utf-8" />
<meta name="description" content="Коллекция Set в языке программирования Dart, наборы и хештаблицы, операции с множествами">
...
<h2>Set</h2><div class="date">Последнее обновление: 22.06.2019</div>
...
<p>Класс <span class="b">Set</span> представляет неупорядоченный набор уникальных объектов. Для создания Set применяются фигурные скобки <code>{}</code>:</p>
...
<p>Для перебора набора можно использовать цикл <span class="b">for..in</span>:</p>
<pre class="brush:dart;">
void main (){
...
<p>Отличительной особенностью наборов является то, что они содержать только уникальные значения, то есть мы не можем добавить одни и те ж значения в набор 
несколько раз:</p>
<pre class="brush:dart;">
void main (){
...
<h3>Свойства и методы класса Set</h3>
<p>Основные свойства наборов:</p>
<ul>
<li><p><span class="b">first</span>: возвращает первый элемент</p></li>
<li><p><span class="b">last</span>: возвращает последний элемент</p></li>
<li><p><span class="b">length</span>: возвращает длину набора</p></li>
<li><p><span class="b">isEmpty</span>: возвращает true, если набор пуст</p></li>
</ul>
<p>Основные методы наборов:</p>
<ul>
<li><p><span class="b">add(E value)</span>: добавляет элемент в набор</p></li>
<li><p><span class="b">addAll(Iterable&lt;E&gt; iterable)</span>: добавляет в набор другую коллекцию</p></li>
<li><p><span class="b">clear()</span>: удаляет все элементы из набора</p></li>
<li><p><span class="b">difference(Set&lt;Object&gt; other)</span>: возвращает разность текущего набора и набора other в виде другого набора</p></li>
<li><p><span class="b">intersection(Set&lt;Object&gt; other)</span>: возвращает пересечение текущего набора и набора other в виде другого набора</p></li>
<li><p><span class="b">remove(Object value)</span>: удаляет объект из набора</p></li>
<li><p><span class="b">removeAll(Iterable&lt;Object&gt; elements)</span>: удаляет из набора все элементы коллекции elements</p></li>
<li><p><span class="b">union(Set&lt;E&g; other)</span>: возвращает объединение двух наборов - текущего и набора other</p></li>
<li><p><span class="b">contains(Object element)</span>: возвращает true, если элемент содержится в наборе</p></li>
<li><p><span class="b">join([String separator = "" ])</span>: объединяет все элементы набора в строку. Можно указать необязательный параметр separator, который будет раздлять элементы в строке</p></li>
...
<p>Полный список полей/методов/конструкторов класса Set можно посмотреть в 
<a href="https://api.dart.dev/stable/2.4.0/dart-core/Set-class.html" rel="nofollow">документации</a></p>
