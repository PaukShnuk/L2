...
<html >
<head>
<title>Dart | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования Dart">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 17.06.2019</div>
...
<p>Условные выражения представляют собой некоторое условие и возвращают значение типа <span class="b">bool</span>, то есть значение <span class="b">true</span> 
...
<p>Кроме того, в языке Dart есть логические операции, которые также представляют условие и возвращают true или false и обычно объединяют несколько операций 
