...
<html >
<head>
<title>Flutter | Первое приложение в Visual Studio Code</title>
<meta charset="utf-8" />
<meta name="description" content="Создание первого мобильного приложения на Flutter в Visual Studio Code, установка плагина и настройка проекта">
...
<h2>Первое приложение в Visual Studio Code</h2><div class="date">Последнее обновление: 11.10.2021</div>
...
<p>Одним из популярнейших текстовых редакторов на сегодняшний день является Visual Studio Code. И Google предоставляет для него плагин для разработки 
под Flutter.</p>
<p>Для его установки перейдем к пункту меню <span class="b">View -&gt; Extensions</span>.</p>
<img src="./pics/1.22.png" alt="Добавление плагина Flutter в Visual Studio Code" />
<p>После этого откроется панель расширений. Введем в поле поиска слово "Flutter":</p>
<img src="./pics/1.23.png" alt="Установка плагина Flutter в Visual Studio Code" />
<p>Нужный плагин носит имя "Flutter" (как правило, первый результат среди результатов поиска). И для его установки нажмем на кнопку Install.</p>
<p>Поскольку этот плагин зависит от плагина для Dart, то плагин Dart также автоматически будет установлен.</p>
<p>После установки плагина создадим первый проект. Для этого перейдем к пункту меню <span class="b">View -&gt; Command Palette</span>. 
В открышееся окно поиска введем слово "flutter" и среди результатов выберем <span class="b">Flutter: New Application Project</span>.</p>
<img src="./pics/1.25.png" alt="Создание проекта Flutter в Visual Studio Code" />
<p>Затем в новом окне выберем папку, где будет располагаться проект</p>
<img src="./pics/1.26.1.png" alt="Проект Flutter в Visual Studio Code" />
<p>Затем в новом окне введем название проекта, например, "hello_app" и введем Enter</p>
<img src="./pics/1.26.png" alt="Проект Flutter в Visual Studio Code" />
<p>В итоге будет создан проект с той же структурой, что и в предыдущих статьях. А в текстовом редакторе будет открыт 
файл <span class="b">main.dart</span>:</p>
<img src="./pics/1.27.png" alt="Первое приложение Flutter в Visual Studio Code" />
<p>Для запуска приложения подключим мобильное устройство с Android к компьютеру, а в Visual Studio Code перейдем к пункту меню <span class="b">Run -&gt; Start Debugging</span>. 
(Если отладка нам неважна и мы хотим посто запустить проект, то выбирается пункт <span class="b">Run Without Debugging</span>)</p>
<img src="./pics/1.28.1.png" alt="Отладка приложения Flutter Debugging в Visual Studio Code" />
<p>В результате будет построено приложение. Сверху VS Code ообразится панель для управления отладкой, а снизу 
ообразится вся отладочная информация</p>
<img src="./pics/1.28.png" alt="Отладка приложения Flutter в Visual Studio Code" />
<p>А на мобильном устройств будет запущено приложение</p>
