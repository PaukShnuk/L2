...
<html >
<head>
<title>Flutter | Кнопка ElevatedButton</title>
<meta charset="utf-8" />
<meta name="description" content="Кнопка ElevatedButton в Flutter, обработка нажатия и onPressed, VoidCallback, Directionality">
...
<h2>Кнопка ElevatedButton</h2><div class="date">Последнее обновление: 05.02.2021</div>
...
<p>Виджет <span class="b">ElevatedButton</span> представляет кнопку, основная задача которой - реагировать на нажатия и 
по нажатию выполнять некоторое действие.</p>
<p>Этот виджет имеет два конструктора. Первый конструктор:</p>
...
<li><p><span class="b">onPressed</span>: описывает действие, которое вызывается при нажатии</p></li>
<li><p><span class="b">onLongPress</span>: описывает действие, которое вызывается при долгом нажатии</p></li>
<li><p><span class="b">style</span>: стиль кнопки</p></li>
<li><p><span class="b">focusNode</span>: объект, который используется для получения фокуса клавиатуры и для обработки событий клавиатуры</p></li>
<li><p><span class="b">autofocus</span>: указывает, будет ли кнопка получать фокус по умолчанию</p></li>
<li><p><span class="b">clipBehavior</span>: указывает, как содержимое кнопки будет обрезаться</p></li>
<li><p><span class="b">child</span>: содержимое кнопки в виде другого виджета (обычно надпись на кнопке)</p></li>
</ul>
<p>Второй конструктор позволяет дополнительно добавить иконку в виде виджета из параметра <code>icon</code>:</p>
<pre class="brush:dart;">
...
<p>Создание простейшей кнопки ElevatedButton:</p>
<pre class="brush:dart;">
...
<img src="./pics/3.20.png" alt="ElevatedButton и кнопки в Flutter и Dart" />
<p>Как видно из скриншота, по умолчанию кнопка не активна, потому что мы не задали для нее действие, вызываемое при нажатии - 
то есть параметр <code>onPressed</code>.</p>
<p>Этот параметр по сути представляет функцию <code>void Function()</code>, которая ничего не возвращает и не принимает 
никаких параметров. Например, мы можем даже использовать пустую функцию:</p>
<pre class="brush:dart;">
ElevatedButton(
  child: Text("Click", style: TextStyle(fontSize: 22)),
  onPressed:(){}
...
<p>В качестве простейшего примера сделаем по нажатию на кнопку вывод на консоль некоторой строки:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
...
<p>Функция <code>print()</code> вывод информацию на консоль при нажатии кнопки:</p>
<img src="./pics/3.21.png" alt="ElevatedButton и нажатие кнопки onPressed в Flutter и Dart" />
<h3>Виджет Directionality</h3>
<p>При размещении кнопки  ElevatedButton в некоторых контейнерах мы можем столкнуться с ошибкой</p>
<pre class="brush:dart;">No Directionality widget found.</pre>
<p>В этом случае можно обернуть родительской контейнер в виджет Directionality:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
...
<p>Либо использовать другие виджеты, которые неявно применяют Directionality, например, MaterialApp.</p>
