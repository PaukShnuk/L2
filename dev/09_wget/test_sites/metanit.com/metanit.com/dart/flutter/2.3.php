...
<html >
<head>
<title>Flutter | Center</title>
<meta charset="utf-8" />
<meta name="description" content="Виджет Center в Flutter, центрирование и выравнивание элемента по центру">
...
<h2>Center</h2><div class="date">Последнее обновление: 21.06.2020</div>
...
<p><span class="b">Center</span> располагает вложенный элемент по центру. Он унаследован от класса Align, поэтому во многом перенимает у него 
функционал. По умолчанию он растягивается по всей ширине и высоте контейнера, заполняя все его пространство.</p>
<p>Для создания виджета применяется следующий конструктор:</p>
<pre class="brush:dart;">
Center({Key key, double widthFactor, double heightFactor, Widget child})
</pre>
<p>Для установки вложенного элемента, к которому будет применяться 
центрирование, используется параметр child - в его качестве может выступать любой объект Widget, то есть любой виджет.</p>
<p>Дополнительные параметры <span class="b">widthFactor</span> и <span class="b">heightFactor</span> устанавливают коэффициент изменения ширины и высоты виджета 
...
<p>Например, разместим по центру небольшой текст с использованием виджета Center:</p>
<pre class="brush:dart;">
...
<img src="./pics/2.7.png" alt="Виджет Center в Flutter" />
<p>Фактически этот код будет равносилен следующему:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
