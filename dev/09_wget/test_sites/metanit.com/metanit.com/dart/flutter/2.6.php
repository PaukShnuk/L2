...
<meta charset="utf-8" />
<meta name="description" content="Виджет Container в Flutter, фон и размеры контейнера, установка отступов padding и margin, выравнивание элементов Align">
...
<h2>Container</h2><div class="date">Последнее обновление: 21.06.2020</div>
...
<p><span class="b">Container</span> представляет такой виджет, который также может содержать только один вложенный элемент, но при этом 
предоставляет дополнительные возможности по настройке фона, позиционирования и размера вложенных виджетов. По сути Container объединяет возможности 
других виджетов - Padding, Align, ConstrainedBox.</p>
<p>Конструктор контейнера принимает довольно много параметров, которые позвляют настроить отдельные аспекты отображения:</p>
...
<ul>
<li><p><span class="b">key</span>: ключ элемента</p></li>
<li><p><span class="b">alignment</span>: настройки выравнивания вложенного элемента в виде объекта AlignmentGeometry, аналогично настройке выравнивания в виджете Align</p></li>
<li><p><span class="b">padding</span>: настройки отступа вложенного элемента от границ контейнера, аналогично настройке отступов в виджете Padding</p></li>
<li><p><span class="b">color</span>: цвет контейнера</p></li>
<li><p><span class="b">constraints</span>: ограничения длины и ширины в виде объекта BoxConstraints, применяемые к вложенному виджету. 
Аналогично установке размеров в ConstrainedBox</p></li>
<li><p><span class="b">margin</span>: устанавливает отступы текущего виджета Container от границ внешнего контейнера, аналогично настройке параметра padding</p></li>
<li><p><span class="b">width</span>: ширина контейнера</p></li>
<li><p><span class="b">heigt</span>: высота контейнера</p></li>
</ul>
<p>Создадим простейший виджет Container:</p>
<pre class="brush:dart;">
...
<img src="./pics/2.10.png" alt="Виджет Container в Flutter" />
<p>В данном случае в качестве цвета использован встроенный цвет (оттенок светло-синего цвета), описывамый значением <code>Colors.lightBlueAccent</code>. 
По выравниванию установлено центрирование вложенного виджета с помощью значения <code>Alignment.center</code>.</p>
<h3>Отступы margin и padding</h3>
<p>Теперь рассмотрим применение отступов как для margin, так и для padding:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
...
<img src="./pics/2.11.png" alt="Отступы padding и margin в Container в Flutter" />
<p>В данном случае в качестве значения для margin установлен с верху отступ в 30 единиц. То есть виджет Container будет располагаться на 
30 единиц ниже верхней границы экрана. Поэтому в верху экрана смартфона мы увидим черную полоску, которая не заполнена виджетом Container.</p>
<p>Также установлен отступ для вложенного виджета Text относительно границ Container в 40 единиц.</p>
