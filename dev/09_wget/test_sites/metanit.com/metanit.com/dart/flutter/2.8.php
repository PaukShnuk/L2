...
<meta charset="utf-8" />
<meta name="description" content="Виджет Row в Flutter, расположение элементов в строку, горизонтально, текст справа налево, MainAxisAlignment и CrossAxisAlignment, выравнивание по горизонтали и вертикали">
...
<h2>Row</h2><div class="date">Последнее обновление: 30.01.2021</div>
...
<p>Виджет <span class="b">Row</span> располагает элементы горизонтально, в виде строки.</p>
<p>Для создания виджета Row применяется следующий конструктор:</p>
...
<li><p><code>mainAxisAlignment</code>: задает выравнивание по горизонтали</p></li>
<li><p><code>mainAxisSize</code>: задает пространство, занимаемое виджетом по горизонтали</p></li>
<li><p><code>crossAxisAlignment</code>: задает выравнивание по вертикали</p></li>
...
<p>Определим виджет Row, который будет содержать набор виджетов Text:</p>
<pre class="brush:dart;">
...
<img src="./pics/2.20.png" alt="Виджет Row в Flutter" />
<p>Мы видим, что по умолчанию элемент Row располагает все вложенные виджеты по центру по вертикали и слева по горизонтали. Причем все вложенные виджеты находятся друг к другу впритык.</p>
<h3>MainAxisAlignment</h3>
<p>Параметр <code>mainAxisAlignment</code> конструктора позволяет настроить позиционирование вложенных элементов по горизонтали. Он представляет тип <span class="b">MainAxisAlignment</span> 
и может принимать следующие значения:</p>
<ul>
<li><p><span class="b">MainAxisAlignment.center</span>: выравнивание по горизонтали по центру</p></li>
<li><p><span class="b">MainAxisAlignment.end</span>: выравнивание в конце горизонтальной оси. Где находится конец горизонтальной оси, 
зависит от другого параметра конструктора - <code>textDirection</code>. Если он равен <code>TextDirection.ltr</code> (текст слева направо), 
конец горизонтальной оси аналогичен правому краю, а при значении <code>TextDirection.rtl</code> конец аналогичен левому краю.</p></li>
...
расположение "начала" горизонтальной оси зависит от значения параметра <code>textDirection</code></p></li>
<li><p><span class="b">MainAxisAlignment.spaceBetween</span>: свободное пространство Row равным образом распределяется между вложенными виджетами</p></li>
<li><p><span class="b">MainAxisAlignment.spaceEvenly</span>: свободное пространство Row равным образом распределяется между вложенными виджетами, а также перед первым и после последнего виджета</p></li>
<li><p><span class="b">MainAxisAlignment.spaceAround</span>: свободное пространство Row равным образом распределяется между вложенными виджетами, кроме того, перед первым и после последнего виджета добавляются половинные отступы (половина от отступа между виджетами)</p></li>
</ul>
<p>Например, установим отступы между элементами, чтобы они не сливались друг с другом:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
...
<img src="./pics/2.21.png" alt="Отступы между виджтами в Row в Flutter и MainAxisAlignment" />
<h3>CrossAxisAlignment</h3>
<p>Параметр <code>crossAxisAlignment</code> в конструкторе Row указывает, как вложенные виджеты будут располагаться по вертикали. 
Этот параметр представляет класс <span class="b">CrossAxisAlignment</span> и может принимать следующие значения:</p>
<ul>
<li><p><span class="b">CrossAxisAlignment.center</span>: значение по умолчанию, располагает вложенные элементы по центру по вертикали. Это значение по умолчанию.</p></li>
<li><p><span class="b">CrossAxisAlignment.end</span>: располагает вложенные элементы в конце вертикальной оси. Это значение зависит от другого параметра 
конструктора Row - <code>verticalDirection</code>. Если он равен <code>VerticalDirection.down</code> (сверху вниз), 
то элементы выравниваются по нижнему краю. А если он равен <code>VerticalDirection.up</code> (снизу вверх), 
то элементы выравниваются по верхнему краю.</p></li>
<li><p><span class="b">CrossAxisAlignment.start</span>: располагает вложенные элементы в начале вертикальной оси. Его значение, как и <code>CrossAxisAlignment.end</code>, 
зависит от парамета конструктора <code>verticalDirection</code>. Если он равен <code>VerticalDirection.down</code> (сверху вниз), 
то элементы выравниваются по верхнему краю. А если он равен <code>VerticalDirection.up</code> (снизу вверх), 
то элементы выравниваются по нижнему краю.</p></li>
<li><p><span class="b">CrossAxisAlignment.stretch </span>: растягивает вложенные элементы о всей ширине контейнера Row.</p></li>
<li><p><span class="b">CrossAxisAlignment.baseline</span>: выравнивает вложенные элементы по базовой линии - пересекающей оси. 
Аналогично значению <code>CrossAxisAlignment(4)</code>. Требует установки параметра 
...
Вместо этого расположим виджеты в верху:</p>
<pre class="brush:dart;">
import 'package:flutter/material.dart';
...
<img src="./pics/2.22.png" alt="Row и CrossAxisAlignment в Flutter" />
