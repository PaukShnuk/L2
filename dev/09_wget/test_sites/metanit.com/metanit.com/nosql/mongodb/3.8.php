...
<html >
<head>
<title>Удаление данных из MongoDB в PHP</title>
<meta charset="utf-8" />
<meta name="description" content="Удаление данных из базы данных MongoDB в PHP, функция remove и ее параметры, удаление всей базы данных и коллекции и метод drop">
...
<h2>Удаление данных</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Удаление производится с помощью функции <span class="bb">remove</span>. Она принимает два параметра. Первый параметр - объект для удаления. 
Второй параметр представляет набор дополнительный опций:</p>
<ul>
<li><p><span class="bb">justOne</span>: если значение равно <code>true</code>, то удаляется только один элемент выборки</p></li>
...
<p>Удалим один документ, в котором name="Mark":</p>
<pre class="brush:php;">
...
<h3>Удаление коллекции и базы данных</h3>
<p>Как и при работе в консоли mongo в PHP удаление коллекции производится с помощью функции <code>drop</code>:</p>
<pre class="brush:php;">
$con = new MongoClient();
$collection= $con-&gt; test-&gt; persons;
...
<img src="pics/3.2.png" alt="Удаление из MongoDB в PHP" />
<p>Также функция drop может использоваться и для удаления базы данных:</p>
<pre class="brush:php;">
$con = new MongoClient();
$db= $con-&gt; test;
