...
<html >
<head>
<title>Команды группировки в MongoDB</title>
<meta charset="utf-8" />
<meta name="description" content="Команды группировки в MongoDB (count, group, distinct), особенности и примеры их использования, параметры команд">
...
<h2>Команды группировки</h2><div class="date">Последнее обновление: 07.08.2021</div>
...
<p>Отдельно стоит рассмотреть команды группировки: <code>count, distinct</code>.</p>
<h3>Число элементов в коллекции</h3>
<p>С помощью функции <code>count()</code> можно получить число элементов в коллекции:</p>
<pre class="brush:js;">
&gt; db.users.count()
</pre>
<p>Можно группировать параметры поиска и функцию count, чтобы подсчитать, сколько определенных документов, например, у которых name=Tom:</p>
<pre class="brush:js;">
...
<p>Здесь надо отметить, что по умолчанию функция count не используется с функциями limit и skip. Чтобы их использовать, как в примере выше, 
в функцию count надо передать булевое значение <code>true</code></p>
<h3>Функция distinct</h3>
<p>В коллекции могут быть документы, которые содержат одинаковые значения для одного или нескольких полей. Например, в нескольких документах определено <code>name: "Tom"</code>. 
...
функцией <span class="bb">distinct</span>:</p>
<pre class="brush:js;">
&gt; db.users.distinct("name")
["Tom", "Bill", "Bob"]
</pre>
<p>Здесь я запрашиваю только уникальные значения для поля <code>name</code>. И на следующей строке консоль выводит в виде массива найденные уникальные 
значения.</p>
...
<div class="nav"><p><a href="./2.4.php">Назад</a><a href="./">Содержание</a><a href="./2.8.php">Вперед</a></p></div></div>
<div class="socBlock">
