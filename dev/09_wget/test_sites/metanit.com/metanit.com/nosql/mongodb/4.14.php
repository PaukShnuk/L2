...
<html >
<head>
<title>MongoDB и ASP.NET MVC. Редактирование и удаление</title>
<meta charset="utf-8" />
<meta name="description" content="Редактирование и удаление из базы данных MongoDB в ASP.NET MVC 5">
...
<h2>MongoDB и ASP.NET MVC. Работа с объектами</h2><div class="date">Последнее обновление: 11.09.2017</div>
...
<p>В прошлой теме был создан функционал для вывода и добавления объектов Computer. Теперь определим остальные действия для 
управления объектами - редактирование и удаление. Для этого добавим в контроллер HomeController следующие методы::</p>
<pre class="brush:c#;">
...
<p>И добавим представление <span class="ii">Edit.cshtml</span> для редактирования данных:</p>
<pre class="brush:xml;">
@model MongoDBApp.Models.Computer

@{
    ViewBag.Title = "Редактировать модель";
}
...
<p>И теперь мы можем добавлять, изменять и удалять модели. Не хватает только механизма прикрепления к моделям изображений. Создадим его.</p>
