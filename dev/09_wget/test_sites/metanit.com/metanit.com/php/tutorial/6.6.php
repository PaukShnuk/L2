...
<html >
<head>
<title>PHP | Анонимные классы</title>
<meta charset="utf-8" />
<meta name="description" content="Анонимные классы в языке программирования PHP, их свойства, методы и конструкторы">
...
<h2>Анонимные классы</h2><div class="date">Последнее обновление: 18.03.2021</div>
...
<p><span class="b">Анонимные классы</span> - это классы, которые не имеют имени. Обычно такие классы полезны, если нам необходимо один раз создать объект подобного класса. 
И больше этот класс не будет использоваться. Например:</p>
<pre class="brush:php;">
$person = new class {};
</pre>
<p>Для определения переменной аонимного класса, как в случае с обычным классом применяется оператор <span class="b">new</span>, после которого идет 
ключевое слово <code>class</code> и затем - тело класса в фигурных скобках.</p>
<p>Анонимные классы, как и обычные классы могут определять свойства и методы. Например:</p>
<pre class="brush:php;">
$person = new class {
...
<p>Также анонимные классы могут определять конструкторы:</p>
<pre class="brush:php;">
...
<p>При этом вызов конструктора идет сразу после ключевого слова <code>class</code> до открывающей фигурной скобки: <code>new class("Bob") {</code>.</p>
<p>Подобным образом можно определять свойства сразу в конструкторе, сократив тем самым определение класса:</p>
<pre class="brush:php;">
&lt;?php
...
<div class="nav"><p><a href="./6.5.php">Назад</a><a href="./">Содержание</a><a href="./6.2.php">Вперед</a></p></div></div>
<div class="socBlock">
