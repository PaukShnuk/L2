...
<html >
<head>
<title>PHP | Возвращение значений и оператор return</title>
<meta charset="utf-8" />
<meta name="description" content="Возвращение значений и оператор return в языке программирования PHP">
...
<h2>Возвращение значений и оператор return</h2><div class="date">Последнее обновление: 11.03.2021</div>
...
<p>Функция может возвращать некоторое значение - число, строку и т.д., то есть некоторый результат. 
Для возвращения значения в функции применяется оператор <span class="b">return</span>, после которого указывается возвращаемое значение.</p>
<p>Например, получим из функции сумму двух чисел:</p>
<pre class="brush:php;">
&lt;?php
function add($a, $b)
{
...
<p>Функция <code>add()</code> принимает два параметра и возвращает сумму их значений.</p>
<pre class="brush:php;">return $a + $b;</pre>
<p>Поскольку функция возвращает значение, мы его можем присвоить переменной:</p>
<pre class="brush:php;">$result = add(5, 6);</pre>
<p>Либо использовать напрямую:</p>
<pre class="brush:php;">echo add(4, 8);</pre>
<p>Если после инструкции <code>return</code> в функции идут другие инструкции, то они не будут выполняться:</p>
<pre class="brush:php;">
function add($a, $b)
{
	$sum = $a + $b;
...
<p>В реальности даже если функция не использует оператор <code>return</code>, она все равно возвращает значение, только в этом случае это значение - <span class="b">null</span>:</p>
<pre class="brush:php;">
&lt;?php
function add($a, $b)
{
