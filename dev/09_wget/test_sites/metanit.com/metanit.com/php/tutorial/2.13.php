...
<html >
<head>
<title>PHP | Операции с массивами</title>
<meta charset="utf-8" />
<meta name="description" content="Операции с массивами в языке программирования PHP, количество элементов в массиве, сортировка массива, функции count, is_array, asort, arsort, ksort">
...
<h2>Операции с массивами</h2><div class="date">Последнее обновление: 12.03.2021</div>
...
<p>Рассмотрим некоторые встроенные наиболее распространенные функции, которые мы можем применять при работе с массивами.</p>
<h3>Функция is_array</h3>
<p>Функция <span class="b">is_array()</span> проверяет, является ли переменная массивом, и если является, то возвращает <code>true</code>, иначе возвращает 
...
<p>Функция <span class="b">count()</span> и <span class="b">sizeof()</span> получают количество элементов массива:</p>
<pre class="brush:php;">
$users = ["Tom", "Bob", "Sam"];
$number = count($users);
// то же самое, что
...
<p>Функция <span class="b">shuffle</span> перемешивает элементы массивы случайным образом:</p>
<pre class="brush:php;">
...
<p>Функция <span class="b">compact</span> позволяет создать из набора переменных ассоциативный массив, где 
ключами будут имена переменных:</p>
<pre class="brush:php;">
&lt;?php
...
<p>Для сортировки по возрастанию используется функция <span class="b">asort</span>:</p>
<pre class="brush:php;">
$users = ["Tom", "Bob", "Sam", "Alice"];
asort($users);
print_r($users);
...
<pre class="brush:php;">asort($users, SORT_STRING);</pre>
<p>Чтобы отсортировать массив в обратном порядке, применяется функция <span class="b">arsort</span>:</p>
<pre class="brush:php;">arsort($users);</pre>
...
<p>Сортировка по ключам в обратном порядке выполняется функцией <span class="b">krsort()</span>:</p>
<pre class="brush:php;">krsort($states);</pre>
