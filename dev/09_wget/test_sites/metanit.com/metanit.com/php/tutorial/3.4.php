...
<html >
<head>
<title>PHP | Пример обработки форм</title>
<meta charset="utf-8" />
<meta name="description" content="Пример обработки форм в языке программирования PHP, отправка POST-запросов">
...
<h2>Пример обработки форм</h2><div class="date">Последнее обновление: 17.03.2021</div>
...
<p>Рассмотрим комплексный пример обработки форм, в которой объединим обработку различных элементов html. Определим следующую форму:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Здесь определена простейшая стандартная форма ввода анкетных данных.</p>
<p>Теперь определим скрипт <span class="b">input.php</span>, который будет обрабатывать эту форму:</p>
<pre class="brush:php;">
&lt;?php
...
<p>Откроем страницу с формой, введем все данные:</p>
<img src="pics/3.16.png" alt="Ввод данных в PHP" />
<p>И отправим форму на сервер:</p>
<img src="pics/3.17.png" />
...
<div class="nav"><p><a href="./3.3.php">Назад</a><a href="./">Содержание</a><a href="./5.4.php">Вперед</a></p></div></div>
<div class="socBlock">
