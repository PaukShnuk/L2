...
<html >
<head>
<title>PHP | Ассоциативные массивы</title>
<meta charset="utf-8" />
<meta name="description" content="Ассоциативные массивы в языке PHP, ключи элементов массива, перебор и обращение к элементам массива, цикл foreach">
...
<h2>Ассоциативные массивы</h2><div class="date">Последнее обновление: 11.03.2021</div>
...
<p>Ассоциативные массивы представляют подвид массивов, в которых, в отличие от обычных массивов, в качестве ключа применяются строки.</p>
<p>При создании ассоциативного массива мы явным образом указываем ключ элемента, после которого идет оператор <span class="b">=&gt;</span> и значение элемента. 
Например, создание ассоциативного массива с помощью функции <code>array()</code>:</p>
<pre class="brush:php;">
$words = array("red" =&gt; "красный", "blue" =&gt; "синий", "green" =&gt; "зеленый");
</pre>
<p>Здесь создается массив $words из трех элементов. Например, первый элемент имеет ключ "red", а значение - "красный".</p>
<p>Создание аналогичного массива с помощью квадратных скобок:</p>
<pre class="brush:php;">
$words = ["red" =&gt; "красный", "blue" =&gt; "синий", "green" =&gt; "зеленый"];
</pre>
<p>Используя ключ, также как и в обычных массивах, можно обратиться к элементу массива, например, получить или изменить 
его значение:</p>
<pre class="brush:php;">
&lt;?php
...
<p>Для добавления элемента с новым ключом в ассоциативный массив достаточно определить элемент с этим ключом:</p>
<pre class="brush:php;">
$countries = ["Germany" =&gt; "Berlin", "France" =&gt; "Paris", "Spain" =&gt; "Madrid"];
$countries["Italy"] = "Rome";	// определяем новый элемент с ключом "Italy"
echo $countries["Italy"]; // Rome
</pre>
<p>Также необязательно инициализировать переменную массива при ее определении. Можно, как с обычными массивами, добавлять элементы по ходу:</p>
<pre class="brush:php;">
&lt;?php
...
<p>Для перебора ассоциативного массива применяется цикл <span class="b">foreach</span>:<p>
<pre class="brush:php;">
&lt;?php
$words = ["red" =&gt; "красный", "blue" =&gt; "синий", "green" =&gt; "зеленый"];
...
<p>Результат перебора массива:</p>
<pre class="browser">
red : красный
blue : синий
green : зеленый
...
<h3>Смешанные массивы</h3>
<p>PHP позволяет использовать в одном массиве числовые и строковые индексы:</p>
<pre class="brush:php;">
