...
<html >
<head>
<title>PHP | Введение</title>
<meta charset="utf-8" />
<meta name="description" content="Общий обзор языка программирования PHP, его основные особенности, история развития">
...
<h1>Введение в PHP</h1><h2>Общий обзор языка программирования PHP</h2><div class="date">Последнее обновление: 25.02.2021</div>
...
<p>На сегодняшний день PHP является одним из наиболее распространенных языков веб-программирования. 
Подавляющие большинство сайтов и веб-сервисов в интернете написано с помощью PHP. По некоторым оценкам PHP применяется более 
чем на 80% сайтов, среди которых такие сервисы, как facebook.com, vk.com, baidu.com и другие. И такая популярность неудивительна. Простота языка позволяет быстро и легко создавать сайты и порталы различной сложности.</p>
...
<ul>
<li><p>Для всех наиболее распространенных операционных системам (Windows, MacOS, Linux) есть свои версии пакетов разработки на PHP, а это значит, что вы можете создавать веб-сайты на любой из этих 
операционных систем.</p></li>
<li><p>PHP может работать в связке с различными веб-серверами: Apache, Nginx, IIS</p></li>
<li><p>Простота и легкость освоения. Как правило, уже имея небольшой опыт в программировании на PHP, можно создавать простенькие веб-сайты</p></li>
<li><p>PHP похож на язык Си, поэтому, зная Си или один из языков с сиподобным синтаксисом, будет проще овладеть PHP </p></li>
<li><p>PHP поддерживает работу с множеством систем баз данных (MySQL, MSSQL, Oracle, Postgre, MongoDB и другие)</p></li>
<li><p>Распространенность хостинговых услуг и их дешевизна. Так как, как правило, хостинговые компании размещают веб-сайты на PHP на веб-серверах Apache или 
...
использования хостинга</p></li>
<li><p>Постоянное развитие. PHP продолжает развиваться, выходят все новые версии, которые несут новые функции, адаптируя язык программирования к 
новым вызовам. И, как правило, перейти на новую версию не составляет труда.</p>
<p>К настоящему моменту (март 2021) текущей стабильной версией PHP является PHP 8.</p></li>
</ul>
<p>А теперь установим все необходимые инструменты, которые потребуются для программирования на PHP.</p>
