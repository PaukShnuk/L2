...
<html >
<head>
<title>PHP и MySQL | Удаление данных в MySQLi</title>
<meta charset="utf-8" />
<meta name="description" content="Удаление данных в БД MySQL в языке PHP с помощью библиотеки MySQLi, команда DELETE">
...
<h2>Удаление данных в MySQLi</h2><div class="date">Последнее обновление: 09.06.2021</div>
...
<p>Для удаления данных  возьмем использованную в прошлых темах таблицу Users со следующим определением:</p>
...
<p>Вначале определим для вывода всех объектов из БД скрипт <span class="b">index.php</span>:</p>
<pre class="brush:php;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<p>Скрипт <span class="b">delete.php</span>:</p>
<pre class="brush:php;">
&lt;?php
if(isset($_POST["id"]))
{
...
<div class="nav"><p><a href="./3.5.php">Назад</a><a href="./">Содержание</a></p></div></div>
<div class="socBlock">
