...
<html >
<head>
<title>MS SQL Server и T-SQL | UNION</title>
<meta charset="utf-8" />
<meta name="description" content="Объединения в T-SQL в MS SQL Server 2016, оператор UNION и правила применения, соединение двух однотипных выборок">
...
<h2>UNION</h2><div class="date">Последнее обновление: 20.07.2017</div>
...
<p>Оператор <span class="b">UNION</span> подобно inner join или outer join позволяет соединить две таблицы. Но в отличие от inner/outer join 
...
<img src="pics/72.png" alt="UNION в T-SQL" />
...
Но в случае с клиентами столбец будет называться FullName, а в случае с сотрудниками - EmployeeName. Тем не менее для сортировки применяется название столбца из первой выборки и он же будет в результирующей выборке:</p>
<img src="pics/75.png" alt="Сортировка в UNION в T-SQL" />
...
<p>В данном случае первый столбец первой выборки имеет тип NVARCHAR, то есть хранит строку. Первый столбец второй выборки - Id имеет тип INT, то есть хранит число.</p>
...
<img src="pics/74.png" alt="Обединение повторяющихся строк в T-SQL и MS SQL Server" />
...
<img src="pics/73.png" alt="Объединение выборок из той же таблицы" />
