...
<html >
<head>
<title>MS SQL Server и T-SQL | Функции CASE и IIF</title>
<meta charset="utf-8" />
<meta name="description" content="Функции CASE и IIF в T-SQL в MS SQL Server, возвращение значений по условию">
...
<h2>Функции CASE и IIF</h2><div class="date">Последнее обновление: 29.07.2017</div>
...
<h3>CASE</h3>
<p>Функция <span class="b">CASE</span> проверяет значение некоторого выражение, и в зависимости от результата проверки может возвращать тот или иной результат.</p>
<p>CASE принимает следующую форму:</p>
<pre class="brush:sql;">
CASE выражение
...
<p>Здесь значения столбца ProductCount последовательно сравнивается со значениями после операторов WHEN. В 
...
Для возвращаемого результата определен столбец EvaluateCount:</p>
<img src="pics/107.png" alt="Функция CASE в T-SQL и MS SQL Server" />
<p>Также функция <span class="b">CASE</span> может принимать еще одну форму:</p>
<pre class="brush:sql;">
CASE
...
<p>Например, применительно к таблице Products:</p>
<pre class="brush:sql;">
SELECT ProductName, Manufacturer,
	CASE
...
<p>Фактически все то же самое, что и в предыдущем примере, только после CASE не указывается сравниваемое значение. 
А сами выражения сравнения стоят после оператора WHEN. И если выражение после оператора WHEN будет истинно, то возвращается значение, которое идет после соответствующего оператора THEN.</p>
<img src="pics/108.png" alt="CASE WHEN в T-SQL и MS SQL Server" />

<h3>IIF</h3>
<p>Функция <span class="b">IIF</span> в зависимости от результата условного выражения возвращает одно из двух значений. Общая форма функции выглядит следующим образом:</p>
<pre class="brush:sql;">IIF(условие, значение_1, значение_2)</pre>
<p>Если условие в функции IIF истинно то возвращается значение_1, если ложно, то возвращается значение_2. Например:</p>
<pre class="brush:sql;">
SELECT ProductName, Manufacturer,
	IIF(ProductCount&gt;3, 'Много товара', 'Мало товара')
FROM Products
</pre>
<img src="pics/109.png" alt="Функция IIF в T-SQL SQL Server" />
