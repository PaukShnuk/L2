...
<html >
<head>
<title>MS SQL Server и T-SQL | Функции для работы с числами</title>
<meta charset="utf-8" />
<meta name="description" content="Функции для работы с числами в T-SQL в MS SQL Server, Round, Rand, Ceiling, Floor">
...
<h2>Функции для работы с числами</h2><div class="date">Последнее обновление: 29.07.2017</div>
...
<p>Для работы с числовыми данными T-SQL предоставляет ряд функций:</p>
<ul>
<li><p><span class="b">ROUND</span>: округляет число. В качестве первого параметра передается число. Второй параметр указывает на длину. Если длина представляет положительное число, 
...
до какой цифры с конца числа до запятой идет округление</p>
<pre class="brush:sql;">
SELECT ROUND(1342.345, 2)	-- 1342.350
SELECT ROUND(1342.345, -2)	-- 1300.000
</pre>
</li>
<li><p><span class="b">ISNUMERIC</span>: определяет, является ли значение числом. В качестве параметра функция принимает выражение. Если выражение 
является числом, то функция возвращает 1. Если не является, то возвращается 0.</p>
<pre class="brush:sql;">
...
<li><p><span class="b">ABS</span>: возвращает абсолютное значение числа.</p>
<pre class="brush:sql;">SELECT ABS(-123)	-- 123</pre>
</li>
<li><p><span class="b">CEILING</span>: возвращает наименьшее целое число, которое больше или равно текущему значению.</p>
<pre class="brush:sql;">
SELECT CEILING(-123.45)		-- -123
SELECT CEILING(123.45)		-- 124
</pre>
</li>
<li><p><span class="b">FLOOR</span>: возвращает наибольшее целое число, которое меньше или равно текущему значению.</p>
<pre class="brush:sql;">
SELECT FLOOR(-123.45)		-- -124
SELECT FLOOR(123.45)		-- 123
</pre>
</li>
<li><p><span class="b">SQUARE</span>: возводит число в квадрат.</p>
<pre class="brush:sql;">SELECT SQUARE(5)		-- 25</pre>
</li>
<li><p><span class="b">SQRT</span>: получает квадратный корень числа.</p>
<pre class="brush:sql;">SELECT SQRT(225)		-- 15</pre>
</li>
<li><p><span class="b">RAND</span>: генерирует случайное число с плавающей точкой в диапазоне от 0 до 1.</p>
<pre class="brush:sql;">
...
<li><p><span class="b">COS</span>: возвращает косинус угла, выраженного в радианах</p>
<pre class="brush:sql;">
SELECT COS(1.0472)	-- 0.5 - 60 градусов
</pre>
</li>
<li><p><span class="b">SIN</span>: возвращает синус угла, выраженного в радианах</p>
<pre class="brush:sql;">
SELECT SIN(1.5708)	-- 1 - 90 градусов
</pre>
</li>
<li><p><span class="b">TAN</span>: возвращает тангенс угла, выраженного в радианах</p>
<pre class="brush:sql;">
...
<p>Округлим произведение цены товара на количество этого товара:</p>
<pre class="brush:sql;">
