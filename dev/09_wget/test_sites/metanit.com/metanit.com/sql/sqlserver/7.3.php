...
<html >
<head>
<title>MS SQL Server и T-SQL | Outer Join</title>
<meta charset="utf-8" />
<meta name="description" content="Соединение таблиц с помощью Outer Join в T-SQL в MS SQL Server 2016, левостороннее и правосторонее объединение таблиц">
...
<h2>OUTER JOIN</h2><div class="date">Последнее обновление: 20.07.2017</div>
...
<p>В предыдущей теме было рассмотрено внутреннее соединение таблиц. Но MS SQL Server также поддерживает внешнее соединение или outer join. 
В отличие от inner join внешнее соединение возвращает все строки одной или двух таблиц, которые участвуют в соединении.</p>
...
<li><p><span class="b">FULL</span>: выборка будет содержать все строки из обоих таблиц</p></li>
</ul>
...
<img src="pics/67.png" alt="Левостороннее соединение в T-SQL OUTER JOIN" />
...
<img src="pics/61.png" alt="INNER join vs left join в T-SQL"/>
...
<img src="pics/68.png" alt="OUTER JOIN в MS SQL Server" />
...
<img src="pics/69.png" alt="OUTER Join в T-SQL" />
...
у которых цена меньше 45000, и отсортируем по дате заказа:</p>
<pre class="brush:sql;">
SELECT Customers.FirstName, Orders.CreatedAt, 
       Products.ProductName, Products.Manufacturer
FROM Orders 
...
<img src="pics/70.png" alt="LEFT JOIN с фильтрацией и сортировкой в T-SQL" />
...
<img src="pics/71.png" alt="CROSS JOIN в T-SQL" />
