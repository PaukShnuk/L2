...
<html >
<head>
<title>MS SQL Server и T-SQL | Агрегатные функции</title>
<meta charset="utf-8" />
<meta name="description" content="Агрегатные функции в T-SQL в MS SQL Server 2016, avg, sum, count, min, max. Поиск суммы, количества, среднего, наименьшего и наибольшего значений">
...
<h1>Группировка</h1><h2>Агрегатные функции</h2><div class="date">Последнее обновление: 19.07.2017</div>
...
<p>Агрегатные функции выполняют вычисления над значениями в наборе строк. В T-SQL имеются следующие агрегатные функции:</p>
<ul>
<li><p><span class="b">AVG</span>: находит среднее значение</p></li>
...
<p>В качестве аргумента все агрегатные функции принимают выражение, которое представляет критерий дя определения значений. Зачастую, в качестве 
выражения выступает название столбца, над значениями которого надо проводить вычисления.</p>
<p>Выражения в функциях <span class="b">AVG</span> и <span class="b">SUM</span> должно представлять числовое значение. Выражение в функциях 
<span class="b">MIN</span>, <span class="b">MAX</span> и <span class="b">COUNT</span> может представлять числовое или строковое значение или дату.</p>
...
устанавливать.</p>
<img src="pics/80.png" alt="Функция avg в T-SQL" />
...
<img src="pics/81.png" alt="Функция count в T-SQL в MS SQL Server" />
...
<img src="pics/82.png" alt="Функция SUM в T-SQL" />
...
<img src="pics/83.png" alt="Агрегатные функции в T-SQL и MS SQL Server" />
