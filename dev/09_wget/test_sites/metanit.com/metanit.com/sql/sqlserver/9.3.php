...
<html >
<head>
<title>MS SQL Server и T-SQL | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в T-SQL в MS SQL Server, конструкция IF...ELSE, блок кода BEGIN...END">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 14.08.2017</div>
...
<p>Для выполнения действий по условию используется выражение <span class="b">IF ... ELSE</span>. SQL Server вычисляет выражение после ключевого слова <span class="b">IF</span>. И если оно истинно, то выполняются инструкции после ключевого слова IF. 
Если условие ложно, то выполняются инструкции после ключевого слова ELSE.</p>
<p>Если после IF или ELSE располагает блок инструкций, то этот блок заключается между ключевыми словами <span class="b">BEGIN</span> и 
<span class="b">END</span>:</p>
<pre class="brush:sql;">
IF условие
...
<p>Выражение ELSE является необязательным, и его можно опускать.</p>
<p>Например, пусть у нас есть следующие таблицы:</p>
<pre class="brush:sql;">
...
<p>Таблица Orders представляет заказы, а столбец CreatedAt - дату заказов. Узнаем, были ли заказы за последние 10 дней:</p>
<pre class="brush:sql;">
...
<img src="pics/123.png" alt="Выражение IF...ELSE в T-SQL и MS SQL Server" />
<p>Если после IF или ELSE идут две и более инструкций, то они заключаются в блок BEGIN...END:</p>
<pre class="brush:sql;">
...
<img src="pics/124.png" alt="Выражение BEGIN...END в T-SQL и MS SQL Server" />
