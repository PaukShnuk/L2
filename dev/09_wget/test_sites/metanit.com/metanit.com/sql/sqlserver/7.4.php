...
<html >
<head>
<title>MS SQL Server и T-SQL | Группировка в соединениях</title>
<meta charset="utf-8" />
<meta name="description" content="Группировка в соединениях таблиц в T-SQL в MS SQL Server 2016">
...
<h2>Группировка в соединениях</h2><div class="date">Последнее обновление: 20.07.2017</div>
...
<p>В выражениях INNER/OUTER JOIN также можно использовать группировку. Например, выведем для каждого пользователя количество заказов, которые он сделал:</p>
<pre class="brush:sql;">
...
<img src="pics/95.png" alt="Группировка в INNER JOIN в T-SQL" />
...
<p>Если необходимо вывести даже тех покупателей, у которых нет заказов, то применяется OUTER JOIN:</p>
<pre class="brush:sql;">
SELECT FirstName, COUNT(Orders.Id)
...
<img src="pics/96.png" alt="Группировка в OUTER LEFT JOIN в T-SQL" />
...
<img src="pics/102.png" alt="GROUP BY и JOIN в MS SQL Server" />
