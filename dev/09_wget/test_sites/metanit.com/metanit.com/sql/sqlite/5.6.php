...
<html >
<head>
<title>SQLite | INTERSECT</title>
<meta charset="utf-8" />
<meta name="description" content="Пересечение однотипных выборок и таблиц в SQLite с помощью оператора INTERSECT, поиск общих элементов">
...
<h2>INTERSECT</h2><div class="date">Последнее обновление: 30.11.2021</div>
...
<p>В таблице clients хранятся все клиенты банка, а в таблице employees - все его сотрудники. Но сотрудники могут быть одновременно и 
клиентами банка, поэтому их данные могут храниться сразу в двух таблицах. Найдем всех сотрудников банка, которые одновременно 
...
<img src="./pics/7.14.png" alt="Пересечение множеств и оператор INTERSECT в SQLite" />
