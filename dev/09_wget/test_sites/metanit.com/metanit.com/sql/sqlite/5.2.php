...
<html >
<head>
<title>SQLite | Соединение таблиц с помощью INNER JOIN</title>
<meta charset="utf-8" />
<meta name="description" content="Соединение таблиц в SQLite с помощью оператора Inner Join, объединение трех таблиц">
...
<h2>Соединение таблиц с помощью INNER JOIN</h2><div class="date">Последнее обновление: 30.11.2021</div>
...
<p>В прошлой теме было рассмотрено неявное соединение таблиц с помощью простой выборки путем сведения данных. Однако более распространенным подходом 
свдения данных из разных таблиц является применение оператора <span class="b">JOIN</span>. SQLite поддерживает несколько вариантов оператора <span class="b">JOIN</span>. 
В этой статье рассмотрим <span class="b">INNER JOIN</span>. Общий формальный синтаксис этой версии оператора :</p>
<pre class="brush:sql;">
SELECT столбцы
FROM таблица1
	[INNER] JOIN таблица2
...
"orders.items_count".</p>
<img src="./pics/7.4.png" alt="соединение таблиц с помощью Inner Join в SQLite" />
...
<img src="./pics/7.5.png" alt="Соединение таблиц в SQLite" />
