...
<html >
<head>
<title>SQLite | Изменение таблиц и столбцов</title>
<meta charset="utf-8" />
<meta name="description" content="Изменение таблиц и столбцов в SQLite, команда ALTER TABLE, переименование таблицы, добавление и удаление столбцов">
...
<h2>Изменение таблиц и столбцов</h2><div class="date">Последнее обновление: 26.11.2021</div>
...
<p>Если таблица уже была ранее создана, и ее необходимо изменить, то для этого применяется команда <span class="b">ALTER TABLE</span>. Она поддерживает различные опции и 
возможности. Рассмотрим лишь основные сценарии, с которыми мы можем столкнуться.</p>
<h3>Переименование таблицы</h3>
<p>Для переименования таблицы применяется операторы <span class="b">RENAME TO</span>, после которого указывается новое имя таблицы:</p>
<pre class="brush:sql;">
ALTER TABLE users
RENAME TO people;
</pre>
<p>Здесь таблица users переименовывается в "people".</p>
<h3>Добавление нового столбца</h3>
<p>Добавим в таблицу users новый столбец email:</p>
<pre class="brush:sql;">
ALTER TABLE users
ADD COLUMN email TEXT NOT NULL;
</pre>
<p>В данном случае столбец email имеет тип TEXT и для него определено ограничение <code>NOT NULL</code>.</p>
<h3>Переименование столбца</h3>
<p>Переименуем столбец email в login</p>
<pre class="brush:sql;">
ALTER TABLE users
RENAME COLUMN email TO login;
</pre>
<h3>Удаление столбца</h3>
<p>Удалим столбец login из таблицы users:</p>
<pre class="brush:sql;">
ALTER TABLE users
DROP COLUMN login;
</pre>
