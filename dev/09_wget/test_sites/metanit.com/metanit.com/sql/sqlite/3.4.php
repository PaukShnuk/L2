...
<html >
<head>
<title>SQLite | Обновление данных. Команда UPDATE</title>
<meta charset="utf-8" />
<meta name="description" content="Обновление данных в БД SQLite, команда UPDATE, оператор SET, установка значений, условия обновления">
...
<h2>Обновление данных. Команда UPDATE</h2><div class="date">Последнее обновление: 27.11.2021</div>
...
<p>Для обновления данных в SQLite применяется команда <span class="b">UPDATE</span>. Она имеет следующий формальный синтаксис:</p>
<pre class="brush:sql;">
UPDATE имя_таблицы
SET столбец1 = значение1, столбец2 = значение2, ... столбецN = значениеN
[WHERE условие_обновления]
</pre>
<p>Например, возьмем ранее созданную таблицу products:</p>
<pre class="brush:sql;">
...
<p>Увеличим в этой таблице цену всех товаров цену на 3000:</p>
<pre class="brush:sql;">
UPDATE products
SET price = price + 3000;
</pre>
<img src="./pics/3.17.png" alt="Команда UPDATE и обновление данных в SQLite" />
<p>Выше в примере обновлялись все строки. Теперь конкретизируем обновляемые строки с помощью выражения <span class="b">WHERE</span>. 
Например, изменим название производителя с 'Samsung' на 'Samsung Inc.':</p>
<pre class="brush:sql;">
UPDATE products
