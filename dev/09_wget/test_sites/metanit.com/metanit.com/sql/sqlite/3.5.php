...
<html >
<head>
<title>SQLite | Удаление данных. Команда DELETE</title>
<meta charset="utf-8" />
<meta name="description" content="Удаление данных в БД SQLite, команда DELETE, применение условий для удаления, удаление всех строк">
...
<h2>Удаление данных. Команда DELETE</h2><div class="date">Последнее обновление: 27.11.2021</div>
...
<p>Команда <span class="b">DELETE</span> удаляет данные из БД. Она имеет следующий формальный синтаксис:</p>
<pre class="brush:sql;">
DELETE FROM имя_таблицы
[WHERE условие_удаления]
</pre>
<p>Например, возьмем следующую таблицу products, которая хранит некоторый набор товаров:</p>
<pre class="brush:sql;">
...
<p>Удалим из этой таблицы товары, у которых производитель - Huawei:</p>
<pre class="brush:sql;">
DELETE FROM products
WHERE company='Huawei';
</pre>
<img src="./pics/3.18.png" alt="Команда DELETE в SQLite" />
<p>Или удалим все товары, производителем которых является Apple и которые имеют цену меньше 60000:</p>
<pre class="brush:sql;">
DELETE FROM products
