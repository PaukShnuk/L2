...
<html >
<head>
<title>SQLite | Функции для работы с числами</title>
<meta charset="utf-8" />
<meta name="description" content="Функции для работы с числами в SQLite, функция round и random, округление числа, генерация случайного числа">
...
<h2>Функции для работы с числами</h2><div class="date">Последнее обновление: 01.12.2021</div>
...
<p>Для работы с числами SQLite предоставляет ряд функций:</p>
<ul>
<li><p><span class="b">round</span>: округляет число. В качестве первого параметра передается число. Второй параметр указывает, до скольки знаков 
после запятой нужно округлить число:</p>
<pre class="brush:sql;">
...
<li><p><span class="b">random</span>: генерирует псевдослучайное целое число в диапазоне от -9223372036854775808 до +9223372036854775807.</p>
<pre class="brush:sql;">
SELECT random(),	-- -1830670227460582245
	random();		-- -7041802194444300327
</pre>
</li>
<li><p><span class="b">max</span>: возвращает максимальное из чисел.</p>
<pre class="brush:sql;">
select max(12, 10),	-- 12
	max(1, 2, 5); -- 5
</pre>
</li>
<li><p><span class="b">min</span>: возвращает минимальное из чисел.</p>
<pre class="brush:sql;">
select min(12, 10),	--  10
	min(1, 2, 5); 	-- 1
</pre>
...
<div class="nav"><p><a href="./6.1.php">Назад</a><a href="./">Содержание</a><a href="./6.5.php">Вперед</a></p></div></div>
<div class="socBlock">
