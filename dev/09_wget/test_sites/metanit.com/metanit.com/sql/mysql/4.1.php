...
<html >
<head>
<title>MySQL | Выборка уникальных значений. Оператор DISTINCT</title>
<meta charset="utf-8" />
<meta name="description" content="Выборка уникальных значений из БД в MySQL, Оператор DISTINCT">
...
<h1>Запросы</h1><h2>Выборка уникальных значений. Оператор DISTINCT</h2><div class="date">Последнее обновление: 16.05.2018</div>
...
<p>С помощью оператора <span class="b">DISTINCT</span> можно выбрать уникальные данные по определенным столбцам.</p>
...
<img src="pics/4.1.png" alt="Выборка уникальных значений в MySQL" />
<p>Однако при таком запросе производители повторяются. Теперь применим оператор <span class="b">DISTINCT</span> для выборки уникальных значений:</p>
<pre class="brush:sql;">
SELECT DISTINCT Manufacturer FROM Products;
</pre>
<img src="pics/4.2.png" alt="Оператор DISTINCT в MySQL" />
...
<p>В данном случае для выборки используются столбцы Manufacturer и ProductCount. Из пяти строк только для двух строк эти столбцы имеют повторяющиеся значения. 
Поэтому в выборке будет 4 строки:</p>
<img src="pics/4.3.png" alt="Оператор DISTINCT и несколько столбцов в MySQL" />
