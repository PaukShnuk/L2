...
<html >
<head>
<title>MySQL | Удаление данных. Команда DELETE</title>
<meta charset="utf-8" />
<meta name="description" content="Удаление данных из БД в MySQL, команда DELETE, условие удаления, полная очистка таблицы">
...
<h2>Удаление данных. Команда DELETE</h2><div class="date">Последнее обновление: 11.05.2018</div>
...
<p>Например, удалим строки, у которых производитель - Huawei:</p>
<pre class="brush:sql;">
DELETE FROM Products
WHERE Manufacturer='Huawei';
</pre>
<img src="pics/3.14.png" alt="Команда DELETE в MySQL" />
