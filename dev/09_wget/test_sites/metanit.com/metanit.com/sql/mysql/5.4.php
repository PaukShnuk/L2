...
<meta charset="utf-8" />
<meta name="description" content="Обединение таблиц в MySQL с помощью оператора UNION, правила использования">
...
<h2>UNION</h2><div class="date">Последнее обновление: 22.05.2018</div>
...
<p>Оператор <span class="b">UNION</span> позволяет обединить две однотипных выборки. Эти выборки могут быть из разных таблиц или из одной и той же 
...
<p>Здесь из первой таблицы выбираются два значения - имя и фамилия клиента. Из второй таблицы Employees также 
...
<img src="pics/7.10.png" alt="UNION в MySQL" />
<p>При этом названия столбцов объединенной выборки будут совпадать с названия столбцов первой выборки. И если мы захотим при этом еще произвести 
сортировку, то в выражениях <span class="b">ORDER BY</span> необходимо ориентироваться именно на названия столбцов первой выборки:</p>
<pre class="brush:sql;">
...
<p>В данном случае каждая выборка имеет по столбцу FName из первой выборки. Тем не менее при сортировке будет учитываться и 
значение столбца FirstName из второй выборки:</p>
<img src="pics/7.11.png" alt="Сортировка в UNION в MySQL" />
...
При объединении в примерах выше всех дублирующиеся строки удалялись. Если же необходимо при объединении сохранить все, в том числе повторяющиеся строки, то для этого необходимо использовать оператор <span class="b">ALL</span>:</p>
<pre class="brush:sql;">
SELECT FirstName, LastName
FROM Customers
...
<img src="pics/7.12.png" alt="Обединение повторяющихся строк в MySQL" />
...
<img src="pics/7.13.png" alt="Объединение выборок из той же таблицы в MySQL" />
