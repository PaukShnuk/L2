...
<html >
<head>
<title>MySQL | Сортировка. ORDER BY</title>
<meta charset="utf-8" />
<meta name="description" content="Сортировка данных при выборке из БД в MySQL, оператор ORDER BY, сортировка по нескольким столбцам по возрастанию и убыванию">
...
<h2>Сортировка. ORDER BY</h2><div class="date">Последнее обновление: 16.05.2018</div>
...
<img src="pics/4.9.png" alt="Оператор order by и сортировка в MySQL" />
...
<img src="pics/4.10.png" alt="Сортировка по производным столбцам в MySQL" />
...
<img src="pics/4.11.png" alt="Сортировка по убыванию в MySQL" />
...
<p>Здесь строки сначала сортируются по столбцу Manufacturer по возрастанию. Затем если есть две строки, в которых столбец Manufacturer 
...
<img src="pics/4.12.png" alt="Сортировка по нескольким столбцам в MySQL" />
