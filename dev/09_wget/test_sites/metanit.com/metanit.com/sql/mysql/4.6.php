...
<html >
<head>
<title>MySQL | Группировка</title>
<meta charset="utf-8" />
<meta name="description" content="Группировка в MySQL, операторы GROUP BY и HAVING, получение и фильтрация групп данных">
...
<h2>Группировка</h2><div class="date">Последнее обновление: 21.05.2018</div>
...
<p>Операторы <span class="b">GROUP BY</span> и <span class="b">HAVING</span> позволяют сгруппировать данные. Они употребляются в рамках команды SELECT:</p>
<pre class="brush:sql;">
SELECT столбцы
FROM таблица
...
<img src="pics/5.4.png" alt="Группировка и GROUP BY в MySQL" />
...
<img src="pics/5.5.png" alt="GROUP BY в MySQL" />
...
<img src="pics/5.6.png" alt="Оператор HAVING в MySQL" />
...
<img src="pics/5.7.png" alt="HAVING с фильтрацией и сортировкой в MySQL" />
