...
<html >
<head>
<title>MySQL | Функции для работы с числами</title>
<meta charset="utf-8" />
<meta name="description" content="Функции для работы с числами в MySQL, округление чисел, ROUND, CEILING, FLOOR, генерация случайного значения, RAND">
...
<h2>Функции для работы с числами</h2><div class="date">Последнее обновление: 26.05.2018</div>
...
<p>Для работы с числовыми данными MySQL предоставляет ряд функций:</p>
<ul>
...
<li><p><span class="b">TRUNCATE</span>: оставляет в дробной части определенное количество символов</p>
<pre class="brush:sql;">
...
<li><p><span class="b">POWER</span>: возводит число в определенную степень.</p>
<pre class="brush:sql;">
SELECT POWER(5, 2),		-- 25
...
<li><p><span class="b">SIGN</span>: возвращает -1, если число меньше 0, и возвращает 1, если число больше 0. Если число равно 0, то возвращает 0.</p>
<pre class="brush:sql;">
SELECT SIGN(-5),		-- -1
(SELECT SIGN(7));		-- 1
</pre>
