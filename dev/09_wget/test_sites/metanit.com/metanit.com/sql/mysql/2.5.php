...
<html >
<head>
<title>MySQL | Внешние ключи FOREIGN KEY</title>
<meta charset="utf-8" />
<meta name="description" content="Внешние ключи в MySQL, атрибут FOREIGN KEY, связь главной и зависимой таблиц, выражения ON DELETE и ON UPDATE, каскадное удаление">
...
<h2>Внешние ключи FOREIGN KEY</h2><div class="date">Последнее обновление: 27.04.2019</div>
...
<p>В данном случае определены таблицы Customers и Orders. Customers является главной и представляет клиента. Orders является зависимой и 
...
CustomerId является внешним ключом, который указывает на столбец Id из таблицы Customers.</p>
...
умолчанию, которое задается с помощью атрибуты DEFAULT. Несмотря на то, что данная опция в принципе доступна, однако движок InnoDB не поддерживает данное выражение.</p></li>
</ul>
