...
<html >
<head>
<title>MySQL | Получение диапазона строк. Оператор LIMIT</title>
<meta charset="utf-8" />
<meta name="description" content="Получение диапазона строк при выборке из БД в MySQL, оператор LIMIT, установка смешения при выборке">
...
<h2>Получение диапазона строк. Оператор LIMIT</h2><div class="date">Последнее обновление: 16.05.2018</div>
...
<p>Оператор <span class="b">LIMIT</span> позволяет извлечь определенное количество строк и имеет следующий синтаксис:</p>
<pre class="brush:sql;">LIMIT [offset,] rowcount</pre>
...
<img src="pics/4.13.png" alt="Оператор LIMIT в MySQL" />
...
<img src="pics/4.14.png" alt="LIMIT и OFFSET в MySQL" />
<p>Как правило, оператор LIMIT используетс вместе с оператором ORBER BY:</p>
<pre class="brush:sql;">
SELECT * FROM Products
