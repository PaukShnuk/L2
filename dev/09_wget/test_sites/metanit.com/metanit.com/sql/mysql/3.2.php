...
<html >
<head>
<title>MySQL | Выборка данных. Команда SELECT</title>
<meta charset="utf-8" />
<meta name="description" content="Получение данных из БД в MySQL, команда SELECT, псевдонимы столбцов, оператор AS, операции над полученными данными">
...
<h2>Выборка данных. Команда SELECT</h2><div class="date">Последнее обновление: 11.05.2018</div>
...
<p>Для выборки данных из БД в MySQL применяется команда <span class="b">SELECT</span>. В упрощенном виде она имеет следующий синтаксис:</p>
<pre class="brush:sql;">
...
<img src="pics/3.2.png" alt="Команда SELECT и получение данных в MySQL" />
<p>Стоит отметить, что применение звездочки * для получения данных считается не очень хорошей практикой, так как обычно необходимо получить данные по 
...
тогда, когда названия столбцов не известны.</p>
...
<img src="pics/3.3.png" alt="Выборка данных в MySQL" />
...
<p>Здесь при выборке будут создаваться два столбца. Причем второй столбец представляет значение столбца Price, умноженное на значение столбца 
...
<p>Здесь для первого столбца определяется псевдоним Title, хотя в реальности он будет представлять столбец ProductName. 
Второй столбец TotalSum хранит произведение столбцов ProductCount и Price.</p>
<img src="pics/3.4.png" alt="Псевдонимы столбцов и оператор AS в MySQL" />
