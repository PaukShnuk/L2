...
<html >
<head>
<title>PostgreSQL | Перечисления enum</title>
<meta charset="utf-8" />
<meta name="description" content="Перечисления enum как тип данных в PostgreSQL, создание перечислений, команда CREATE TYPE, удаление и изменение перечислений">
