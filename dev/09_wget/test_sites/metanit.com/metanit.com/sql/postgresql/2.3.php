...
<html >
<head>
<title>PostgreSQL | Типы данных</title>
<meta charset="utf-8" />
<meta name="description" content="Типы данных в PostgreSQL, их использование, character varying, integer, serial, decimal, numeric">
...
<ul>
<li><p><span class="b">character(n)</span>: представляет строку из фиксированного количества символов. С помощью параметра задается задается количество 
символов в строке. Имеет псевдоним <span class="b">char(n)</span>.</p></li>
<li><p><span class="b">character varying(n)</span>: представляет строку из переменной длины. С помощью параметра задается задается максимальное количество 
