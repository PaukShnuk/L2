...
<html >
<head>
<title>PostgreSQL | Консольный клиент psql</title>
<meta charset="utf-8" />
<meta name="description" content="Консольный клиент psql, выполнение в нем запросов на SQL к серверу PostgreSQL, создание базы данных и таблиц">
