...
<html >
<head>
<title>PostgreSQL | Получение диапазона строк. LIMIT и OFFSET</title>
<meta charset="utf-8" />
<meta name="description" content="Получение диапазона строк в PostgreSQL с помощью операторов LIMIT и OFFSET">
