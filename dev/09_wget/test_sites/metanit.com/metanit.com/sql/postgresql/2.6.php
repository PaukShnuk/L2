...
<html >
<head>
<title>PostgreSQL | Изменение таблиц</title>
<meta charset="utf-8" />
<meta name="description" content="Изменение таблиц в PostgreSQL, ALTER TABLE и ALTER COLUMN, добавление и удаление столбцов, изменение их типа и ограничени">
...
<code>customers_age_check</code>. Имена ограничений можно посмотреть в таблице через pgAdmin.<p>
<p>Также мы можем явным образом назначить ограничению при добавлении имя с помощью оператора <span class="b">CONSTRAINT</span>.</p>
<pre class="brush:sql;">
ALTER TABLE Customers
