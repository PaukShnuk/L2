...
<html >
<head>
<title>PostgreSQL | Фильтрация. WHERE</title>
<meta charset="utf-8" />
<meta name="description" content="Фильтрация данных из БД в PostgreSQL, оператор WHERE, определение условия выборки, логические операторы AND, OR, NOT">
