...
<meta charset="utf-8" />
<meta name="description" content="ChoiceBox в JavaFX, создание выпадающего списка, получение и установка выбранного значения">
...
<h2>ChoiceBox</h2><div class="date">Последнее обновление: 22.06.2018</div>
...
<p>Класс <span class="b">javafx.scene.control.ChoiceBox&lt;T&gt;</span> представляет выпадающий список, но в отличие от ComboBox в ChoiceBox 
рядом с выбранным элементом устанавливается отметка.</p>
<p>Для создания объекта ChoiceBox можно использовать один из конструкторов класса:</p>
<ul>
<li><span class="b">ChoiceBox()</span>: создает пустой выпадающий список</p></li>
<li><span class="b">ChoiceBox(ObservableList&lt;T&gt; items)</span>: создает выпадающий список, заполненный элементами items</p></li>
</ul>
<p>Из методов ChoiceBox следует выделить следующие:</p>
<ul>
...
<p>Создадим выпадающий список ChoiceBox:</p>
...
<p>После выбора элемента рядом с ним появится отметка:</p>
<img src="./pics/4.17.png" alt="ChoiceBox in JavaFX" />
