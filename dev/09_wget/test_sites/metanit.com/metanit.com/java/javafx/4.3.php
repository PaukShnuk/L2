...
<meta charset="utf-8" />
<meta name="description" content="Класс ToggleButton в JavaFX, переключение состояния кнопки">
...
<h2>ToggleButton</h2><div class="date">Последнее обновление: 17.06.2018</div>
...
<p>Класс <span class="b">javafx.scene.control.ToggleButton</span> представляет кнопку, которая может находиться в двух состояниях: 
включенном и выключенном. Этот класс также наследуется от класса ButtonBase и поэтому имеет некоторую общую для всех кнопок функциональность.</p>
<p>ToggleButton имеет три конструктора:</p>
<ul>
<li><p><code>ToggleButton()</code>: создает кнопку без надписи</p></li>
<li><p><code>ToggleButton​(String text)</code>: создает кнопку с определенной надписью</p></li>
<li><p><code>ToggleButton​(String text, Node graphic)</code>: создает кнопку с определенной надписью и фоновой графикой</p></li>
</ul>
<p>ToggleButton определяет следующие свойства:</p>
<ul>
<li><p><code>BooleanProperty selected</code>: определяет, выделена ли кнопка</p></li>
<li><p><code>ObjectProperty&lt;ToggleGroup&gt; toggleGroup</code>: определяет объект ToggleGroup, к которому принадлежит ToggleButton</p></li>
</ul>
<p>Основные методы ToggleButton:</p>
<ul>
<li><p><code>Boolean isSelected()</code>: возвращает значение true, если кнопка выбрана</p></li>
<li><p><code>void setToggleGroup(ToggleGroup group)</code>: устанавливает объект ToggleGroup, к которому будет принадлежать ToggleButton</p></li>
</ul>
<p>Например, используем объект ToggleButton:</p>
...
<p>В данном случае при нажатии на кнопку мы изменяем надпись на элементе Label:</p>
<img src="./pics/4.4.png" alt="ToggleButton in JavaFX" />
