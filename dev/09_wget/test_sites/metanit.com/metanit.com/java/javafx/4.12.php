...
<meta charset="utf-8" />
<meta name="description" content="Tooltip в JavaFX, создание всплывающей подсказки для элементов управления">
...
<h2>Tooltip</h2><div class="date">Последнее обновление: 23.06.2018</div>
...
<p>Класс <span class="b">javafx.scene.control.Tooltip</span> предоставляет возможность для создания всплывающих подсказок, котоые появляются при 
наведении указателя мыши на какой-нибудь элемент управления.</p>
<p>Установить всплывающую подсказку можно для объекта любого класса, который наследуется от класса Control. Для этого в классе Control определен метод</p>
<pre class="brush:java;">
void setTooltip​(Tooltip value)
</pre>
<p>Для создания всплывающей подсказки мы можем использовать один из двух конструкторов класса Tooltip:</p>
<ul>
<li><p><span class="b">Tooltip()</span>: создает всплывающую подсказку без текста</p></li>
<li><p><span class="b">Tooltip​(String text)</span>: создает всплывающую подсказку с определенным текстом</p></li>
</ul>
<p>Используем Tooltip в программе:</p>
<pre class="brush:java;">
...
<p>Здесь определены вслывающие подсказки для метки и кнопки. Причем если мы хотим, чтобы текст полсказки переносился на следующую строку, мы можем 
использовать управляющую последовательность \n, как в случае с подсказкой для кнопки. И при наведении на элементы управления мы увидим установленные для них подсказки:</p>
<img src="./pics/4.18.png" alt="Tooltip in JavaFX" />
