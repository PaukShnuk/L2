...
<meta charset="utf-8" />
<meta name="description" content="ComboBox в JavaFX, создание выпадающего списка, получение и установка выбранного значения">
...
<h2>ComboBox</h2><div class="date">Последнее обновление: 22.06.2018</div>
...
<p>Класс <span class="b">javafx.scene.control.ComboBox&lt;T&gt;</span> позволяет создать выпадающий список. Данный класс типизируется типом элементов, 
которые будут храниться в списке.</p>
<p>Для создания выпадающего списка можно использовать один из конструкторов класса:</p>
<ul>
<li><span class="b">ComboBox()</span>: создает пустой выпадающий список</p></li>
<li><span class="b">ComboBox​(ObservableList&lt;T&gt; items)</span>: создает выпадающий список, заполненный элементами items</p></li>
</ul>
<p>Из методов ComboBox следуюет выделить следующие:</p>
<ul>
<li><p><span class="b">void setValue(T item)</span>: устанавливает выбранный по умолчанию элемент (если не вызвать данный метод, 
то по умолчанию никакой элемент не будет выбран)</p></li>
<li><p><span class="b">T item getValue()</span>: возвращает текущий выбранный элемент</p></li>
<li><p><span class="b">void setOnAction​(EventHandler&lt;ActionEvent&gt; value)</span>: устанавливает обработчик, 
который срабатывает при выборе элемента в списке</p></li>
</ul>
<p>Создадим и используем выпадающий список:</p>
...
<img src="./pics/4.16.png" alt="ComboBox в JavaFX" />
