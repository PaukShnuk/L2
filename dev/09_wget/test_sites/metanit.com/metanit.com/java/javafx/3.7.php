...
<html >
<head>
<title>JavaFX | AnchorPane</title>
<meta charset="utf-8" />
<meta name="description" content="Панель компоновки AnchorPane в JavaFX, растягивание элементов вдоль границ контейнера">
...
<h2>AnchorPane</h2><div class="date">Последнее обновление: 07.06.2018</div>
...
<p><span class="b">javafx.scene.layout.AnchorPane</span> позволяет позиционировать вложеные элементы вдоль одной из сторон контейнера.</p>
<p>AnchorPane имеет два конструктора:</p>
<ul>
<li><p><span class="b">AnchorPane()</span>: создает пустой объект AnchorPane</p></li>
<li><p><span class="b">AnchorPane(Node... children)</span>: создает объект AnchorPane, заполненный узлами children</p></li>
</ul>
<p>При использовании второго конструкора или при обычном добавлении узлов AnchorPane следует учитывать, что все добавленные узлы по умолчанию будут 
располагать в левом верхнем углу. И чтобы наспроить расположение, мы можем использовать один из статических методов AnchorPane. 
Основные методы класса:</p>
<ul>
<li><p><code>static Double getBottomAnchor​(Node child)</code>: возвращает положение узла child относительно нижнего края контейнера</p></li>
<li><p><code>static Double getLeftAnchor​(Node child)</code>: возвращает положение узла child относительно левого края контейнера</p></li>
<li><p><code>static Double getRightAnchor​(Node child)</code>: возвращает положение узла child относительно правого края контейнера</p></li>
<li><p><code>static Double getTopAnchor​(Node child)</code>: возвращает положение узла child относительно верхнего края</p></li>
<li><p><code>static void setBottomAnchor​(Node child, Double value)</code>: устанавливает отступ value для узла child относительно нижнего края контейнера</p></li>
<li><p><code>static void setLeftAnchor​(Node child, Double value)</code>: устанавливает отступ value для узла child относительно левого края контейнера</p></li>
<li><p><code>static void setRightAnchor(Node child, Double value)</code>: устанавливает отступ value для узла child относительно правого края контейнера</p></li>
<li><p><code>static void setTopAnchor​(Node child, Double value)</code>: устанавливает отступ value для узла child относительно верхнего края контейнера</p></li>
</ul>
<p>Используем эти методы для настройки расположения кнопок:</p>
...
<img src="./pics/3.19.png" alt="Панель компоновки AnchorPane в JavaFX" />
<p>Стоит отметить, что если мы будем растягивать или сживать окно приложения, то отступы останутся неизменными, а элементы также будут растягиваться и сжиматься соразмерно изменению окна.</p>
