...
<meta charset="utf-8" />
<meta name="description" content="Панель компоновки TilePane в JavaFX, сетка тайлов, размещение элементов">
...
<h2>TilePane</h2><div class="date">Последнее обновление: 07.06.2018</div>
...
<p>Класс <span class="b">javafx.scene.layout.TilePane</span> позволяет организовать вложенные элементы в виде тайлов. Фактически тайлы представляют 
ячейки одинаковой высоты и ширины на пересечении строк и столбцов.</p>
<p>Для создания TilePane применяются следующие конструкторы:</p>
<ul>
<li><p><span class="b">TilePane()</span>: создает горизонтальный TilePane</p></li>
<li><p><span class="b">TilePane​(double hgap, double vgap)</span>: создает горизонтальный TilePane и устанавливает отступы между тайлами 
по горизонтали (hgap) и по вертикали (vgap)</p></li>
<li><p><span class="b">TilePane​(double hgap, double vgap, Node... children)</span>: создает горизонтальный TilePane, устанавливает отступы между тайлами 
по горизонтали (hgap) и по вертикали (vgap) и добавляет элементы children</p></li>
<li><p><span class="b">TilePane​(Orientation orientation)</span>: создает TilePane с определенной ориентацией - горизонтальной или вертикальной</p></li>
<li><p><span class="b">TilePane​(Orientation orientation, double hgap, double vgap)</span>: создает TilePane и задает для него ориентацию и отступы между тайлами по вертикали и горизонтали</p></li>
<li><p><span class="b">TilePane​(Orientation orientation, double hgap, double vgap, Node... children)</span>: создает TilePane, задает для него ориентацию, отступы между тайлами по вертикали и горизнотали, а также коллекцию сложенных элементов</p></li>
<li><p><span class="b">TilePane​(Orientation orientation, Node... children)</span>: создает TilePane с определенной ориентацией и элементами</p></li>
<li><p><span class="b">TilePane​(Node... children)</span>: создает горизонтальный TilePane с элементами children</p></li>
</ul>
<p>Простейший TilePane:</p>
...
<p>По умолчанию создается TilePane с горизонтальной ориентацией. То есть все вложенные элементы размещаются в строку. Если места не хватает, то они 
переносятся на новую строку:</p>
<img src="./pics/3.27.png" alt="TilePane in JavaFX" />
<p>Соответственно мы также можем задать вертикальную ориентацию:</p>
<pre class="brush:java;">
import javafx.application.Application;
import javafx.stage.Stage;
import javafx.scene.Scene;
...
<img src="./pics/3.28.png" alt="вертикальный TilePane в JavaFX" />
<p>Некоторые основные методы TilePane:</p>
<ul>
<li><p><code>void setAlignment​(Pos value)</code>: устанавливает выравнивание TilePane</p></li>
<li><p><code>static void setAlignment​(Node node, Pos value)</code>: устанавливает выравнивание элемента node внутри TilePane</p></li>
<li><p><code>void setHgap​(double value)</code>: устанавливает отступы между тайлами по горизонтали</p></li>
<li><p><code>static void setMargin​(Node node, Insets value)</code>: устанавливает отступы элементы от границ тайла</p></li>
<li><p><code>void setOrientation​(Orientation value)</code>: устанавливает ориентацию TilePane</p></li>
<li><p><code>void setPrefTileHeight​(double value)</code>: устанавливает предпочтительную высоту тайла</p></li>
<li><p><code>void setPrefTileWidth​(double value)</code>: устанавливает предпочтительную ширину тайла</p></li>
<li><p><code>void setTileAlignment​(Pos value)</code>: устанавливает выравнивание всех элементов внутри тайлов</p></li>
<li><p><code>void setHgap​(double value)</code>: устанавливает отступы между тайлами по вертикали</p></li>
</ul>
<h3>Размеры тайлов</h3>
<p>По умолчанию размер каждого тайла устанавливается таким образом, чтобы он мог вместить все содержимое вложенного элемента. Но с помощью методов <span class="b">setPrefTileWidth()</span> и <span class="b">setPrefTileHeight()</span> можно установить соответственно ширину и высоту тайлов:</p>
<pre class="brush:java;">
Button first = new Button("First");
Button second = new Button("Second");
Button third = new Button("Third");
...
<img src="./pics/3.29.png" alt="Размер тайлов в TilePane в JavaFX" />
