...
<html >
<head>
<title>Java EE | Вложение jsp-страниц</title>
<meta charset="utf-8" />
<meta name="description" content="Вложение одних страниц JSP в другие, создание общих блоков страницы">
...
<h2>Вложение jsp-страниц</h2><div class="date">Последнее обновление: 04.09.2018</div>
...
<p>В одну JSP-страницу можно вставлять несколько других. Это позволяет определять некоторые общие блоки для всех страниц и 
использовать их повторно на нескольких страницах JSP.</p>
<p>Для этого применяется специальный тег <span class="b">jsp:include</span>, который может использоваться как обычный html-элемент на страницах JSP.</p>
<p>Определим следующий проект.</p>
<img src="pics/jsp21.png" alt="include in JSP" />
<p>Допустим, у нас есть файл <span class="b">header.html</span> с простейшим кодом:</p>
<pre class="brush:xml;">
&lt;nav&gt;&lt;a href="#"&gt;Home&lt;/a&gt; | &lt;a href="#"&gt;Contact&lt;/a&gt; | &lt;a href="#"&gt;About&lt;/a&gt;&lt;/nav&gt;
&lt;h2&gt;Hello JSP&lt;/h2&gt;
</pre>
<p>В данном случае здесь определен обычный код html.</p>
<p>Также пусть в проекте будет определен файл <span class="b">footer.jsp</span> со следующим содержимым:</p>
<pre class="brush:xml;">
&lt;p&gt;Copyright &copy;Simon & Schuster, Inc. 2002.&lt;/p&gt;
</pre>
...
<p>И также определим в проекте файл <span class="b">index.jsp</span> со следующим кодом:</p>
<pre class="brush:xml;">
&lt;!DOCTYPE html&gt;
&lt;html&gt;
    &lt;head&gt;
...
<p>С помощью тега <span class="b">jsp:include</span> содержимое обоих файлов вставляется в данную jsp-страницу. Атрибут page указывает на адрес 
вставляемого файла. Причем это может быть и обычная html-страница, и jsp-файл.</p>
<p>При обращении к странице index.jsp мы сможем увидеть на странице содержимое вставляемых файлов:</p>
<img src="pics/jsp22.png" alt="Вставка файлов в JSP" />
