...
<html >
<head>
<title>Java EE | Интеграция Eclipse с Tomcat</title>
<meta charset="utf-8" />
<meta name="description" content="Интеграция Eclipse с веб-контейнером Tomcat, запуск сервера">
...
<h2>Интеграция Eclipse с Tomcat</h2><div class="date">Последнее обновление: 02.09.2018</div>
...
<p>Apache Tomcat удобен для размещения приложений. Однако для разработки мы будем использовать Eclipse. Соответственно встает вопрос, 
как интегрировать Eclipse с Tomcat. Рассмотрим этот вопрос.</p>
<p>Вначале запустим Eclipse и остановим через панель служб Apache Tomcat, если он работает.</p>
<img src="pics/eclipse1.png" alt="Интеграция Apache Tomcat с Eclipse" />
<p>С левой стороны нажмем на пункт <span class="b">Java EE</span>.</p>
<p>В открывшемся окне перейдем внизу на владку <span class="b">Servers</span> и нажмем на ссылку для добавления сервера.</p>
<img src="pics/eclipse2.png" />
<p>После этого нам откроется окно добавления нового сервера. Поскольку мы ранее установили версию Apache Tomcat 9.0, то 
найдем в списке соответствующий пункт (или тот пункт, который соответствует установленной на комьютере версии Tomcat)</p>
<img src="pics/eclipse3.png" alt="Добавление Apache Tomcat в Eclipse" />
<p>На следующем окне нам будет предложено сконфигурировать подключение к серверу. В частности, необходимо указать путь к папке, в 
которой установлен Tomcat (в моем случае это папка "C:\Program Files\Apache Software Foundation\Tomcat 9.0")</p>
<img src="pics/eclipse4.png" />
<p>После установки путь нажмем на кнопку <span class="b">Finish</span>. И если все сделано правильно, то Eclipse будет интегрирован с 
Apache Tomcat. Соответственно мы сможем управлять контейнером, в частности, запускать и устанавливать его, непосредственно из Eclipse.</p>
<img src="pics/eclipse5.png" alt="Запуск Tomcat из IDE Eclipse" />
...
<div class="nav"><p><a href="2.2.php">Назад</a><a href="./">Содержание</a><a href="4.1.php">Вперед</a></p></div></div>
<div class="socBlock">
