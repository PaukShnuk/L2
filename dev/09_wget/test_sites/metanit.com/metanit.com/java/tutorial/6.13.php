...
<html >
<head>
<title>Класс Console | Java</title>
<meta charset="utf-8" />
...
<h2>Класс Console</h2><div class="date">Последнее обновление: 28.12.2015</div>
...
<p>Специально для работы с консолью в Java определен класс <span class="b">Console</span>, который хранится в пакете <i>java.io</i>. Он не получает консольный ввод-вывод сам по себе, а использует 
уже имеющиеся потоки System.in и System.out. Но в то же время Console значительно упрощает ряд операций, связанных с консолью.</p>
<p>Для получения объекта консоли надо вызвать статический метод <code>System.console()</code>:</p>
<pre class="brush:java;">
Console console = System.console();
</pre>
<p>Основные методы класса Console:</p>
<ul>
<li><p><span class="b">flush()</span>: выводит на консоль все данные из буфера</p></li>
<li><p><span class="b">format()</span>: выводит на консоль строку с использованием форматирования</p></li>
<li><p><span class="b">printf()</span>: выводит на консоль строку с использованием форматирования (фактически то же самое, что и предыдущий метод)</p></li>
<li><p><span class="b">String readLine()</span>: считывает с консоли введенную пользователем строку</p></li>
<li><p><span class="b">char[] readPassword()</span>: считывает с консоли введенную пользователем строку, при этом символы строки не отображаются на консоли</p></li>
</ul>
<p>Используем класс Console:</p>
<pre class="brush:java;">
...
<p>Важно, что доступ к консоли мы можем получить только из самой консоли. При запуске, например, в Netbeans вызов <code>System.console()</code> будет 
возвращать значение <code>null</code>. Поэтому при работе с консолью желательно проверять полученное значение на <code>null</code>. Ну а если 
мы запустим программу в командной строке, то естественно у нас все будет работать:</p>
<img src="./pics/console.png" alt="Консоль в Java" />
...
<div class="nav"><p><a href="6.12.php">Назад</a><a href="./">Содержание</a><a href="7.1.php">Вперед</a></p></div></div>
<div class="socBlock">
