...
<meta charset="utf-8" />
<meta name="description" content="Введение и основные особенности языка программирования Java, история развития, Java Virtual Machine, установка JRE, JDK">
...
<h1>Введение в Java</h1><h2>Язык программирования Java</h2><div class="date">Последнее обновление: 22.03.2022</div>
...
Достаточно вспомнить популярность мобильной ОС Android, большинство программ для которой пишутся именно на Java.</p>
<h3>Особенности Java</h3>
<p>Ключевой особенностью языка Java является то, что его код сначала транслируется в специальный байт-код, независимый от платформы. А затем этот 
...
Windows, Linux, Mac OS и т.д. Для каждой из платформ может быть своя реализация виртуальной машины JVM, но каждая из них может выполнять один и тот же код.</p>
<p>Java является языком с Си-подобным синтаксисом и близок в этом отношении к C/C++ и C#. Поэтому, если вы знакомы с одним из этих языков, 
то овладеть Java будет легче.</p>
<p>Еще одной ключевой особенностью Java является то, что она поддерживает автоматическую сборку мусора. А это значит, что вам не надо освобождать 
вручную память от ранее использовавшихся объектов, как в С++, так как сборщик мусора это сделает автоматически за вас.</p>
<p>Java является объектно-ориентированным языком. Он поддерживает полиморфизм, наследование, 
...
расширяемых приложений.</p>
<h3>Oracle JDK и OpenJDK</h3>
...
Две наиболее популярных реализации - <span class="b">Oracle JDK</span> и <span class="b">OpenJDK</span>. В чем их разница?</p>
<p>Oracle JDK всецело развивается компанией Oracle. OpenJDK же развивается как компанией Oracle, так и еще рядом компаний совместно.</p>
<p>Наибольшие различия с точки зрения лицензирования. Согласно лицензии Oracle JDK можно использовать бесплатно для персональных нужд, 
...
<p>В плане функционала, набора возможностей Oracle JDK и OpenJDK практически не должны отличаться. А вот вплане производительности отмечается, 
...
Oracle JDK более стабильная.</p>
<p>В данном руководстве мы будем использовать Oracle JDK, однако если вы используете OpenJDK, никаких проблем не должно возникнуть.</p>
<h3>Установка Java</h3>
<p>Итак, для разработки программ на Java нам потребуется специальный комплект для разработки JDK 
(Java Development Kit). JDK включает ряд программ и утилит, которые позволяют компилировать, запускать программы на Java, 
а также выполнять ряд других функций.</p>
<p>Загрузить и установить соответствующую версию JDK можно с с официального сайта Oracle: 
<a href="https://www.oracle.com/java/technologies/javase-downloads.html" rel="nofollow">https://www.oracle.com/java/technologies/javase-downloads.html</a></p>
<p>На этой странице найдем и загрузим дистрибутив для нашей операционной системы (Windows, MacOS или Linux):</p>
<img src="./pics/1.11.png" alt="Установка JDK" />
<p>Для большинства ОС есть два варианта загрузки: в виде установщика, либо в виде архива, который не надо устанавливать. 
Например, моя ОС - Windows, поэтому я выбираю пункт "x64 Installer" и загружаю файл, который представляет программу установки.</p>
<p>После загрузки запустим программу установки:</p>
<img src="./pics/1.12.png" alt="Установка Java Development Kit" />
<p>Нажмем на кнопку Next. На следующем экране необходимо указать, в какую папку будет производиться установка:</p>
<img src="./pics/1.13.png" alt="Установка компонентов Java Development Kit" />
<p>Оставим выбор папки по умолчанию и нажмем на Next для выполнения установки.</p>
<p>После завершения установки JDK мы увидим вот такое окно:</p>
<img src="./pics/1.15.png" alt="Завершение установки JDK" />
<p>Итак, после установки JDK создадим первую программу на Java.</p>
