...
<html >
<head>
<title>Java | Наследование и обобщения</title>
<meta charset="utf-8" />
...
<h2>Наследование и обобщения</h2><div class="date">Последнее обновление: 23.04.2018</div>
...
<h3>Базовый обобщенный класс</h3>
...
<p>В конструкторе DepositAccount идет обращение к конструктору базового класса, в который передаются данные о типе.</p>
...
<p>Здесь при наследовании явным образом указывается тип, который будет использоваться конструкциями базового класса, то есть тип <code>Integer</code>. 
Затем в конструктор базового класса передается значение именно этого типа - в данном случае число 5.</p>
<p>Вариант использования:</p>
<pre class="brush:java;">
DepositAccount dAccount1 = new DepositAccount();
System.out.println(dAccount1.getId());
</pre>
<h3>Обобщенный класс-наследник</h3>
...
<h3>Преобразование обобщенных типов</h3>
...
<p>Мы можем привести объект DepositAccount&lt;Integer&gt; к Account&lt;Integer&gt; или DepositAccount&lt;String&gt; к Account&lt;String&gt;:</p>
<pre class="brush:java;">
...
<div class="nav"><p><a href="3.17.php">Назад</a><a href="./">Содержание</a><a href="3.13.php">Вперед</a></p></div></div>
<div class="socBlock">
