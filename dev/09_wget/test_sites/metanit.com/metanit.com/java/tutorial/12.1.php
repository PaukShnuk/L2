...
<html >
<head>
<title>Java | Математические вычисления и класс Math</title>
<meta charset="utf-8" />
<meta name="description" content="Математические вычисления в языке программирования Java, класс Math и его методы, окугление чисел">
...
<h1>Дополнительные классы</h1><h2>Математические вычисления и класс Math</h2><div class="date">Последнее обновление: 28.10.2018</div>
...
<p>Для выполнения различных математических операций в Java в пакете <span class="ii">java.lang</span> определен класс 
<span class="b">Math</span>. Рассмотрим его основные методы:</p>
<ul>
...
<li><p><code>cbrt(double value)</code>: возвращает кубический корень числа value</p>
<pre class="brush:java;">
double result = Math.cbrt(27); // 3
</pre>
</li>
<li><p><code>ceil(double value)</code>: возвращает наименьшее целое число с плавающей точкой, которое не меньше value</p>
<pre class="brush:java;">
...
<li><p><code>floor(double d)</code>: возвращает наибольшее целое число, которое не больше d</p>
<pre class="brush:java;">
double result = Math.floor(2.56); // 2
</pre>
</li>
<li><p><code>floorDiv(int a, int b)</code>: возвращает целочисленный результат деления a на b</p>
<pre class="brush:java;">
...
<li><p><code>log(double a)</code>: возвращает натуральный логарифм числа a</p></li>
<li><p><code>log1p(double d)</code>: возвращает натуральный логарифм числа (d + 1) </p></li>
...
<li><p><code>random()</code>: возвращает случайное число от 0.0 до 1.0</p></li>
<li><p><code>rint(double value)</code>: возвращает число double, которое представляет ближайшее к числу value целое число</p>
<pre class="brush:java;">
...
<li><p><code>scalb(double value, int factor)</code>: возвращает произведение числа value на 2 в степени factor</p>
<pre class="brush:java;">
System.out.println(Math.scalb(5, 3)); // 5*2*2*2 = 40
System.out.println(Math.scalb(3, 4)); // 3*2*2*2*2 = 48
</pre></li>
<li><p><code>signum(double value)</code>: возвращает число 1, если число value положительное, и -1, если значение value отрицательное. Если value равно 0, то возвращает 0</p>
<pre class="brush:java;">
...
<li><p><code>toDegrees(double value)</code> переводит радианы в градусы и <code>toRadians(double value)</code> - градусы в радианы</p>
<pre class="brush:java;">
