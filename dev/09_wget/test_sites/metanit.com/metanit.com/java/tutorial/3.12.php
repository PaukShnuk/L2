...
<html >
<head>
<title>Java | Внутренние и вложенные классы</title>
<meta charset="utf-8" />
<meta name="description" content="Внутренние(inner classes) и вложенные классы (nested classes) в Java, статические внутренние и вложенные классы, особенноси определения и примеры использования">
...
<h2>Внутренние и вложенные классы</h2><div class="date">Последнее обновление: 20.04.2018</div>
...
<p>Классы могут быть вложенными (nested), то есть могут быть определены внутри других классов. 
Частным случаем вложенных классов являются внутренние классы (inner class). Например, имеется класс Person, внутри которого определен класс Account:</p>
...
<p>Внутренний класс имеет доступ ко всем полям внешнего класса, в том числе закрытым с помощью модификатора private. Аналогично внешний класс имеет доступ ко всем членам внутреннего класса, в том числе к 
полям и методам с модификатором private.</p>
...
<p>Объекты внутренних классов могут быть созданы только в том классе, в котором внутренние классы опеределены. В других внешних классах объекты 
внутреннего класса создать нельзя.</p>
...
<h3>Статические вложенные классы</h3>
<p>Кроме внутренних классов также могут быть статические вложенные классы. Статические вложенные классы позволяют скрыть некоторую комплексную информацию внутри внешнего класса:</p>
<pre class="brush:java;">
class Math{
...
<p>Здесь определен вложенный класс для хранения данных о вычислении факториала. Основные действия выполняет метод <code>getFactorial</code>, 
который возвращает объект вложенного класса. И теперь используем классы в методе main:</p>
<pre class="brush:java;">
public static void main(String[] args) {
...
<div class="nav"><p><a href="3.14.php">Назад</a><a href="./">Содержание</a><a href="3.5.php">Вперед</a></p></div></div>
<div class="socBlock">
