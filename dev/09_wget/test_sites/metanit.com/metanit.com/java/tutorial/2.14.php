...
<html >
<head>
<title>Java | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования Java, логические операции и операции сравнения">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 16.04.2018</div>
...
<p>Условные выражения представляют собой некоторое условие и возвращают значение типа <span class="b">boolean</span>, то есть значение <span class="b">true</span> 
(если условие истинно), или значение <span class="b">false</span> (если условие ложно). К условным выражениям относятся операции сравнения и логические 
операции.</p>
<h3>Операции сравнения</h3>
<p>В операциях сравнения сравниваются два операнда, и возвращается значение типа <code>boolean</code> - <code>true</code>, если выражение верно, 
и <code>false</code>, если выражение неверно.</p>
<ul>
<li><p><code>==</code></p><p>сравнивает два операнда на равенство и возвращает <code>true</code> (если операнды равны) и <code>false</code> (если операнды не равны)</p>
...
<li><p><code>!=</code></p><p>сравнивает два операнда и возвращает <code>true</code>, если операнды НЕ равны, и <code>false</code>, если операнды равны</p>
<pre class="brush:java;">
int a = 10;
int b = 4;
boolean c = a != b;    		// true
...
<li><p><span class="b">&lt;</span> (меньше чем)</p><p>Возвращает <code>true</code>, если первый операнд меньше второго, иначе возвращает <code>false</code></p>
<pre class="brush:java;">
int a = 10;
int b = 4;
boolean c = a &lt; b; 	// false
...
<li><p><span class="b">&gt;</span> (больше чем)</p><p>Возвращает <code>true</code>, если первый операнд больше второго, иначе возвращает <code>false</code></p>
<pre class="brush:java;">
int a = 10;
int b = 4;
boolean c = a &gt; b; 	// true
...
<li><p><span class="b">&gt;=</span> (больше или равно)</p><p>Возвращает <code>true</code>, если первый операнд больше второго или равен второму, иначе возвращает <code>false</code></p>
<pre class="brush:java;">
...
<li><p><span class="b">&lt;=</span> (меньше или равно)</p><p>Возвращает <code>true</code>, если первый операнд меньше второго или равен второму, иначе возвращает <code>false</code></p>
<pre class="brush:java;">
boolean c = 10 &lt;= 10; 	// true
...
<p>Также в Java есть логические операции, которые также представляют условие и возвращают true или false и обычно объединяют несколько операций 
сравнения. К логическим операциям относят следующие:</p>
<ul>
<li><p><code>|</code></p>
<p><code>c=a|b;</code> (c равно <code>true</code>, если либо a, либо b (либо и a, и b) равны <code>true</code>, иначе c будет равно <code>false</code>)</p></li>
<li><p><code>&amp;</code></p>
<p><code>c=a&amp;b;</code> (c равно <code>true</code>, если и a, и b равны <code>true</code>, иначе c будет равно <code>false</code>)</p></li>
<li><p><code>!</code></p><p><code>c=!b;</code> (c равно <code>true</code>, если b равно <code>false</code>, иначе c будет равно <code>false</code>)</p></li>
<li><p><code>^</code></p><p><code>c=a^b;</code> (c равно <code>true</code>, если либо a, либо b (но не одновременно) равны <code>true</code>, иначе c будет равно <code>false</code>)</p></li>
<li><p><code>||</code></p><p><code>c=a||b;</code> (c равно <code>true</code>, если либо a, либо b (либо и a, и b) равны <code>true</code>, иначе c будет равно <code>false</code>)</p></li>
<li><p><code>&amp;&amp;</code></p>
<p><code>c=a&amp;&amp;b;</code> (c равно <code>true</code>, если и a, и b равны <code>true</code>, иначе c будет равно <code>false</code>)</p></li>
</ul>
...
<p>Выражение <code>c=a|b;</code> будет вычислять сначала оба значения - a и b и на их основе выводить результат.</p><p>В выражении же 
<code>c=a||b;</code> вначале будет вычисляться значение a, и если оно равно <code>true</code>, то вычисление значения b уже смысла не имеет, 
так как у нас в любом случае уже c будет равно <code>true</code>. Значение b будет вычисляться только в том случае, если a равно <code>false</code></p>
<p>То же самое касается пары операций <code>&amp;/&amp;&amp;</code>. В выражении <code>c=a&amp;b;</code> будут вычисляться оба значения - a и b.</p>
<p>В выражении же <code>c=a&amp;&amp;b;</code> сначала будет вычисляться значение a, 
и если оно равно <code>false</code>, то вычисление значения b уже не имеет смысла, так как значение c в любом случае равно <code>false</code>. 
Значение b будет вычисляться только в том случае, если a равно <code>true</code></p>
<p>Таким образом, операции <code>||</code> и <code>&amp;&amp;</code> более удобны в вычислениях, позволяя сократить время на вычисление значения выражения и тем самым повышая 
