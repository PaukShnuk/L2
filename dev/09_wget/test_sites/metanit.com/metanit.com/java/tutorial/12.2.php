...
<html >
<head>
<title>Java | Большие числа BigInteger и BigDecimal</title>
<meta charset="utf-8" />
<meta name="description" content="Операции с очень большими числами в языке программирования Java, классы BigInteger и BigDecimal">
...
<h2>Большие числа BigInteger и BigDecimal</h2><div class="date">Последнее обновление: 10.11.2018</div>
...
<p>Встроенные примитивные числовые типы не всегда могут подходить для определенных программ. Например, необходимо хранить и использовать в 
...
пакета <span class="b">java.math</span> - <span class="b">BigInteger</span> (для целочисленных данных) и <span class="b">BigDecimal</span> (для чисел с плавающей точкой).</p>

<p>Основные методы класса BigInteger:</p>
<ul>
<li><p><code>BigInteger add(BigInteger other)</code>: возвращает сумму двух чисел</p></li>
<li><p><code>BigInteger subtract(BigInteger other)</code>: возвращает разность двух чисел</p></li>
<li><p><code>BigInteger multiply(BigInteger other)</code>: возвращает произведение двух чисел</p></li>
<li><p><code>BigInteger divide(BigInteger other)</code>: возвращает частное двух чисел</p></li>
<li><p><code>BigInteger mod(BigInteger other)</code>: возвращает остаток от целочисленного деления двух чисел</p></li>
<li><p><code>BigInteger sqrt()</code>: возвращает квадратный корень числа</p></li>
<li><p><code>int compareTo(BigInteger other)</code>: сравнивает два числа. Возвращает -1, если текущий объект меньше числа other, 1 - если текущий объект больше и 0 - если числа равны</p></li>
<li><p><code>static BigInteger valueOf(long x)</code>: возвращает объект BigInteger, значение которого равно числу, переданному в качестве параметра</p></li>
<li><p><code>int intValue()</code>: конвертирует объект BigInteger в объект int</p></li>
<li><p><code>byte byteValue()</code>: преобразует объект BigInteger в byte</p></li>
<li><p><code>short shortValue()</code>: преобразует объект BigInteger в short</p></li>
<li><p><code>long longValue()</code>: преобразует объект BigInteger в long</p></li>
</ul>

<p>Основные методы класса BigDecimal:</p>
<ul>
<li><p><code>BigDecimal add(BigDecimal other)</code>: возвращает сумму двух чисел</p></li>
<li><p><code>BigDecimal subtract(BigDecimal other)</code>: возвращает разность двух чисел</p></li>
<li><p><code>BigDecimal multiply(BigDecimal other)</code>: возвращает произведение двух чисел</p></li>
<li><p><code>BigDecimal divide(BigDecimal other)</code>: возвращает частное двух чисел</p></li>
<li><p><code>BigDecimal divide(BigDecimal other, RoundingMode mode)</code>: результат деления двух чисел, округленное в соответствии с режимом mode</p></li>
<li><p><code>int compareTo(BigDecimal other)</code>: сравнивает два числа. Возвращает -1, если текущий объект меньше числа other, 1 - если текущий объект больше и 0 - если числа равны</p></li>
<li><p><code>static BigDecimal valueOf(double x)</code>: возвращает объект BigDecimal, значение которого равно числу, переданному в качестве параметра</p></li>
<li><p><code>double doubleValue()</code>: преобразует объект BigDecimal в double</p></li>
<li><p><code>float floatValue()</code>: преобразует объект BigDecimal в float</p></li>
</ul>
<p>Пример использования классов BigInteger и BigDecimal:</p>
...
<p>Стоит отметить, несмотря на то, что объекты BigInteger и BigDecimal представляют числа, мы не можем применять с ними стандартные арифметические операции. Все математические 
действия с данными объектами идут через их методы.</p>
