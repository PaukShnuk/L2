...
<html >
<head>
<title>Java | Перегрузка методов</title>
<meta charset="utf-8" />
<meta name="description" content="Перегрузка методов в языке программирования Java, method overloading,  зависимость перегрузок о типа и количества параметров">
...
<h2>Перегрузка методов</h2><div class="date">Последнее обновление: 18.04.2018</div>
...
<p>В программе мы можем использовать методы с одним и тем же именем, но с разными типами и/или количеством параметров. Такой механизм называется 
<span class="b">перегрузкой методов</span> (method overloading).</p>
<p>Например:</p>
...
<p>Здесь определено три варианта или три перегрузки метода <code>sum()</code>, но при его вызове в зависимости от типа и количества передаваемых 
параметров система выберет именно ту версию, которая наиболее подходит.</p>
<p>Стоит отметить, что на перегрузку методов влияют количество и типы параметров. Однако различие в типе возвращаемого значения для перегрузки не имеют никакого значения. 
Например, в следующем случае методы различаются по типу возвращаемого значения:</p>
<pre class="brush:java;">
public class Program{
...
<div class="nav"><p><a href="2.17.php">Назад</a><a href="./">Содержание</a><a href="2.8.php">Вперед</a></p></div></div>
<div class="socBlock">
