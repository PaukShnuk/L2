...
<html >
<head>
<title>Java | Первая программа в Eclipse</title>
<meta charset="utf-8" />
<meta name="description" content="Начало работы со средой Eclipse, создание первой программы на Java">
...
<h2>Первая программа в Eclipse</h2><div class="date">Последнее обновление: 11.03.2022</div>
...
<p>Еще одной очень популярной средой для разработки приложений под Java является <span class="b">Eclipse</span>. 
...
Eclipse является бесплатной средой, которая к тому же обладает большими возможностями, позволяя создавать на Java самые разные приложения.</p>
<p>Для начала установим последнюю версию Eclipse, которую можно найти по адресу 
<a href="https://www.eclipse.org/downloads/" rel="nofollow">https://www.eclipse.org/downloads/</a>. На странице загрузок найдем рядом с названием 
текущей версии Eclipse (на момент написания статьи это версия Oxygen) кнопку "Download" и нажмем на нее.</p>
<img src="./pics/eclipse1.png" alt="Eclipse IDE" />
<p>После нажатия на кнопку нас перенаправит собственно на страницу загрузки, где необходимо будет нажать на кнопку "Download" для загруки установочного пакета:</p>
<img src="./pics/eclipse2.png" alt="Загрузка Eclipse IDE" />
<p>После загрузки установочного пакета запустим его:</p>
<img src="./pics/eclipse3.png" alt="Eclipse IDE for JAVA EE" />
<p>По факту Eclipse - это целый набор сред для разных ситуаций и языков программирования. И программа установки предлагает нам выбрать одну из опций для инсталляции. 
Поскольку мы собираемся работать с Java, то нас будут интересовать в данном случае прежде всего две опции:</p>
<ul>
<li><p><span class="b">Eclipse IDE for Java Developers</span></p>
<li><p><span class="b">Eclipse IDE for Enterprise Java and Web Developers</span></p>
</ul>
<p>Первая опция предоставляет базовые возможности для работы с Java, а вторая позволяет также создавать веб-приложения и сервисы.
По сути вторая опция включает и первую опцию. Поэтому выберем <span class="b">Eclipse IDE for Enterprise Java and Web Developers</span>.</p>
<p>Далее надо будет указать папку для установки (или оставить выбранную папку по умолчанию), а также указать путь к JDK и нажать на кнопку Install:</p>
<img src="./pics/eclipse11.png" alt="Создание первого проекта в Eclipse IDE" />
<p>Далее надо будет принять лицензионное соглашение:</p>
<img src="./pics/eclipse16.png" alt="Установка лицензии для Eclipse IDE" />
<p>И затем собственно начнется установка. После установки запустим Eclipse. Вначале будет предложено установить каталог для проектов. Оставим значение по умолчанию и нажмем на кнорку Launch:</p>
<img src="./pics/eclipse13.png" alt="Delete Eclipse IDE in Windows 10" />
<p>Далее перейдем к пункту меню <span class="b">File -&gt; New -&gt; Project</span>:</p>
<img src="./pics/eclipse4.png" alt="Создание первого проекта на Java в Eclipse IDE" />
<p>Далее нам откроется окно выбора шаблона проекта. Выберем <span class="b">Java Project</span> и нажмем на кнопку Next:</p>
<img src="./pics/eclipse5.png" alt="Java Project in Eclipse IDE" />
<p>Затем будет предложено установить настройки проекта. В частности, в поле <span class="b">Project Name</span> необходимо задать имя проекта. Допустим, оно будет helloapp:</p>
<img src="./pics/eclipse6.png" alt="Настройка проекта Java в Eclipse IDE" />
<p>Также обращаю внимание на поле <span class="b">JRE</span>, которое задает используемую версию Java. Здесь можно использовать версию по 
умолчанию или изменить ее в зависимости от того, какую версию JDK/JRE мы хотим использовать.</p>
<p>Кроме того, в самом низу окна есть поле <span class="b">Create module-info.java file</span>. Пока эта опция не принципиальна, поэтому чтобы не создавать 
лишние файлы в проекте, можно снять отметку с этого поля.</p>
<p>Все остальные настройки можно оставить по умолчанию, и в конце нажмем на кнопку Finish для создания проекта.</p>
<p>Следующее диалоговое окно спросит, надо ли открывать перспективу проекта:</p>
<img src="./pics/eclipse14.png" />
<p>В данном случае эта возможность не имеет значения, но нажмем на кнопку <span class="b">Open Perspective</span>.</p>
<p>После создания проект будет открыт в Eclipse. Если среда не открывает по умолчанию проект, то необходимо нажать на кнопку Restore:</p>
<img src="./pics/eclipse15.png" alt="Restore Project in Eclipse IDE" />
<p>По умолчанию проект будет пуст.</p>
<img src="./pics/eclipse7.png" />
<p>Все файлы с исходным кодом на Java в проекте помещаются в папку <span class="b">src</span>. Нажмем на нее правой кнопкой мыши и в контекстном меню 
выберем <span class="b">New -&gt; Class</span>:</p>
<img src="./pics/eclipse8.png" alt="Добавление класса Java в Eclipse IDE"/>
<p>Затем откроется окно настройки класса. Здесь в поле Name необходимо задать название класса. Допустим, он будет называться Program. Все остальные 
настройки можно оставить по умолчанию:</p>
<img src="./pics/eclipse9.png" alt="Создание программы на Java в Eclipse" />
<p>После этого в проект будет добавлен файл Program.java, а в центральной части Eclipse мы сможем увидеть его код. 
Изменим этот код на следующий:</p>
...
<img src="./pics/eclipse10.png" alt="Первая программа на Java в Eclipse" />
<p>Для запуска проекта нажмем на панели инструментов на зеленую стрелочку, либо на пункт меню <span class="b">Run -&gt; Run</span>. 
И внизу среды в поле Console мы увидим результат работы программы (то есть фактически консольный вывод).</p>
...
<div class="nav"><p><a href="1.3.php">Назад</a><a href="./">Содержание</a><a href="2.11.php">Вперед</a></p></div></div>
<div class="socBlock">
