...
<html >
<head>
<title>Java | Первая программа в IntelliJ IDEA</title>
<meta charset="utf-8" />
<meta name="description" content="Начало работы со средой разработки IntelliJ IDEA. Создание первой программы на Java">
...
<h2>Первая программа в IntelliJ IDEA</h2><div class="date">Последнее обновление: 23.09.2021</div>
...
<p>В прошлой теме мы рассмотрели, как создавать первую программу с последующим ее запуском в командной строке. Однако в реальности, 
...
<span class="b">IntelliJ IDEA</span> от компании JetBrains. Рассмотрим, как использовать данную среду.</p>
<p>Прежде всего загрузим установочный дистрибутив с официального сайта <a href="https://www.jetbrains.com/idea/download" rel="nofollow">https://www.jetbrains.com/idea/download</a>. 
...
<img src="./pics/intellijidea1.png" alt="Установка IntelliJ IDEA" />
<p>Конечно, Community-версия не имеет ряда многих возможностей, которые доступны в Ultimate-версии (в частности, в Community недоступны опции для 
веб-приложений на Java). Но Community-версия тоже довольно функциональна и тоже позволяет делать довольно много, в том числе приложения на JavaFX и Android.</p>
...
<img src="./pics/intellijidea2.png" alt="Создание проекта в IntelliJ IDEA" />
<p>Далее откроется окно создания проекта. В левой части в качестве типа проекта выберем Java.</p>
<img src="./pics/intellijidea3.png" alt="Создание проекта Java в IntelliJ IDEA" />
<p>Кроме того, в поле <span class="b">Project SDK</span> можно указать путь к Java SDK, который будет использоваться 
в проекте. Как правило, это поле по умолчанию уже содержит путь к SDK, который установлен на локальном компьютере. Если это поле пусто, то его надо установить.</p>
<p>После этого нажмем на кнопку Next. Далее будет предложено отметить шаблон проекта. По умолчанию тут один шаблон проекта - <span class="b">Command Line App</span>, который предполагает запуск приложения как 
консольного.</p>
<img src="./pics/intellijidea4.png" alt="Тип проекта Java в IntelliJ IDEA" />
<p>И в конце откроется окно, где надо будет ввести название проекта и пакета, а также указать его расположение на жестком диске. Здесь можно ввести 
любые данные. Ну в данном случае проект будет называться HelloApp, а базовый пакет "com.metanit".</p>
<img src="./pics/intellijidea5.png" alt="Название и пакет проекта Java в IntelliJ IDEA" />
<p>И после этого для создания проекта нажмем на кнопку Finish. После этого среда создаст и откроет проект.</p>
<img src="./pics/intellijidea6.png" alt="Первая программа на Java в IntelliJ IDEA" />
<p>В левой части мы можем увидеть структуру проекта. Все файлы с исходным кодом помещаются в папку <span class="b">src</span>. 
По умолчанию она содержит каталог, который называется по имени пакета и который имеет один файл Main.java.</p>
<p>В центральной части программы открыт исходный код программы в виде класса Main. Изменим его следующим образом:</p>
...
<p>С помощью зеленой стрелки на панели инструментов или через меню <span class="b">Run -&gt; Run</span> запустим проект.</p>
<p>И внизу IntelliJ IDEA отобразится окно вывода, где мы можем увидеть результат работы нашей программы.</p>
<img src="./pics/intellijidea7.png" alt="Java в IntelliJ IDEA" />
