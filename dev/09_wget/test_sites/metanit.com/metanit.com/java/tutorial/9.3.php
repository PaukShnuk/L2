...
<html >
<head>
<title>Java | Встроенные функциональные интерфейсы</title>
<meta charset="utf-8" />
<meta name="description" content="Встроенные функциональные интерфейсы в язые программирования Java, Predicate, BinaryOperator, UnaryOperator, Consumer, Function, Supplier">
...
<h2>Встроенные функциональные интерфейсы</h2><div class="date">Последнее обновление: 03.01.2016</div>
...
<p>В JDK 8 вместе с самой функциональностью лямбда-выражений также было добавлено некоторое количество встроенных функциональных интерфейсов, которые 
мы можем использовать в различных ситуациях и в различные API в рамках JDK 8. В частности, ряд далее рассматриваемых интерфейсов широко применяется в 
Stream API - новом прикладном интерфейсе для работы с данными. Рассмотрим основные из этих интерфейсов:</p>
<ul>
<li><p><span class="b">Predicate&lt;T&gt;</span></p></li>
<li><p><span class="b">Consumer&lt;T&gt;</span></p></li>
<li><p><span class="b">Function&lt;T,R&gt;</span></p></li>
<li><p><span class="b">Supplier&lt;T&gt;</span></p></li>
<li><p><span class="b">UnaryOperator&lt;T&gt;</span></p></li>
<li><p><span class="b">BinaryOperator&lt;T&gt;</span></p></li>
</ul>
<h3>Predicate&lt;T&gt;</h3>
<p>Функциональный интерфейс <code>Predicate&lt;T&gt;</code> проверяет соблюдение некоторого условия. Если оно соблюдается, то возвращается значение <code>true</code>. 
В качестве параметра лямбда-выражение принимает объект типа T:</p>
...
<h3>BinaryOperator&lt;T&gt;</h3>
<p><code>BinaryOperator&lt;T&gt;</code> принимает в качестве параметра два объекта типа T, выполняет над ними бинарную операцию и возвращает ее результат также в виде объекта типа T:</p>
<pre class="brush:java;">
...
<h3>UnaryOperator&lt;T&gt;</h3>
<p><code>UnaryOperator&lt;T&gt;</code> принимает в качестве параметра объект типа T, выполняет над ними операции и возвращает результат операций в виде объекта типа T:</p>
<pre class="brush:java;">
...
<h3>Function&lt;T,R&gt;</h3>
<p>Функциональный интерфейс <code>Function&lt;T,R&gt;</code> представляет функцию перехода от объекта типа T к объекту типа R:</p>
<pre class="brush:java;">
...
<h3>Consumer&lt;T&gt;</h3>
<p><code>Consumer&lt;T&gt;</code> выполняет некоторое действие над объектом типа T, при этом ничего не возвращая:</p>
<pre class="brush:java;">
...
<h3>Supplier&lt;T&gt;</h3>
<p><code>Supplier&lt;T&gt;</code> не принимает никаких аргументов, но должен возвращать объект типа T:</p>
<pre class="brush:java;">
