...
<html >
<head>
<title>Java | Итераторы</title>
<meta charset="utf-8" />
<meta name="description" content="Итераторы в языке Java, перебор коллекций, класс ListIterator">
...
<h2>Итераторы</h2><div class="date">Последнее обновление: 25.04.2018</div>
...
<p>Одним из ключевых методов интерфейса Collection является метод <code>Iterator&lt;E&gt; iterator()</code>. Он возвращает итератор - то есть объект, 
реализующий интерфейс <span class="b">Iterator</span>.</p>
<p>Интерфейс Iterator имеет следующее определение:</p>
...
<p>Используем итератор для перебора коллекции ArrayList:</p>
<pre class="brush:java;">
import java.util.*;
...
<p>Интерфейс Iterator предоставляет ограниченный функционал. Гораздо больший набор методов предоставляет другой итератор - 
интерфейс <span class="b">ListIterator</span>. Данный итератор используется классами, реализующими интерфейс <code>List</code>, то есть классами 
LinkedList, ArrayList и др.</p>
<p>Интерфейс ListIterator расширяет интерфейс Iterator и определяет ряд дополнительных методов:</p>
<ul>
...
<div class="nav"><p><a href="5.9.php">Назад</a><a href="./">Содержание</a><a href="6.1.php">Вперед</a></p></div></div>
<div class="socBlock">
