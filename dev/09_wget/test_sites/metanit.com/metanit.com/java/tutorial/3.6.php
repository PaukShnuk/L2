...
<h2>Абстрактные классы</h2><div class="date">Последнее обновление: 20.04.2018</div>
...
<p>При определении абстрактных классов используется ключевое слово <span class="bb">abstract</span>:</p>
...
<pre class="brush:java;">Human h = new Human();</pre>
<p>Кроме обычных методов абстрактный класс может содержать <span class="b">абстрактные методы</span>. Такие методы определяются с помощью 
ключевого слова <code>abstract</code> и не имеют никакой реализации:</p>
<pre class="brush:java;">
...
абстрактный.</p>
<p>Зачем нужны абстрактные классы? Допустим, мы делаем программу для обслуживания банковских операций и определяем в ней три класса: 
...
<p>Другим хрестоматийным примером является система геометрических фигур. В реальности не существует геометрической фигуры как таковой. Есть круг, прямоугольник, 
...
<div class="nav"><p><a href="3.5.php">Назад</a><a href="./">Содержание</a><a href="3.10.php">Вперед</a></p></div></div>
<div class="socBlock">
