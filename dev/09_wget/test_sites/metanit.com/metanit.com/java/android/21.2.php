...
<html >
<head>
<title>Java и Android | Публикация приложения в Play Market</title>
<meta charset="utf-8" />
<meta name="description" content="Публикация приложения Android в Google Play Market">
...
<h2>Публикация приложения в Play Market</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Чтобы наше приложение смогло увидеть и установить как можно больше пользователей, наиболее эфективным шагом будет размещение 
приложения в специальных онлайн-магазинах, из которых самым крупным является Google Play Market. Рассмотрим в деталях публикацию в этом онлайн-магазине.</p>
<p>Преде всего нам необходимо зарегистрироваться в Play Market. Перейдем по ссылке <a href="https://play.google.com/apps/publish/signup/" rel="nofollow">https://play.google.com/apps/publish/signup/</a>. 
Нам будет предложено связать наш аккаунт в Google с консолью разработчика:</p>
<img src="./pics/gplay0.png" alt="Регистрация в Play Market" />
<p>Здесь мы можем связать текущий аккаунт с аккаунтом разработчика, но можем и создать новый.</p>
<p>При регистрации надо учитывать, что нам придется заплатить относительно небольшой регистрационный сбор в 25 американских долларов.</p>
<p>Примем лицензионное соглашение и нажмем внизу страницы на кнопку "Оплатить".</p>
<img src="./pics/gplay3.png" alt="Оплата регистрации в Play Market" />
<p>Для оплаты необходима кредитная или дебетовая карта Visa / MasterCard / AMEX / Discover. Но если у нас нет подходящей карты или нам не хочется использовать 
имеющиеся в нашем распоряжении карточки ради разового платежа, то мы можем использовать вирутальные, создав временную карту через webmoney, яндекс-деньги, qiwi или 
другие подобные сервисы. Как правило, такие карты содаются за пару минут и обладают всей той функцональностью, что и реальные карты Visa или MasterCard.</p>
<p>После ввода персональных данных и сведений о карте нажмем на кнопку "Принять и продолжить". После этого нас перекинет на страницу заполнения профиля</p>
<img src="./pics/gplay1.png" alt="Профиль разработчика в Play Market" />
<p>Введем здесь свои данные и нажмем на кнопку внизу страницы. И затем мы уже попадем собственно в личный кабинет в консоли разработчика.</p>
<img src="./pics/gplay2.png" />
<p>Обработка оплаты может занять некоторое время, поэтому мы пока будем ограничены в правах на время обработки. В тоже время мы уже можем 
загрузить файл apk, полноценная публикация которого произойдет после проверки оплаты.</p>
<p>Для загрузки файла приложения нажмем на кнопку "Опубликовать приложение Android в Google Play"</p>
<img src="./pics/gplay4.png" alt="Загрузка apk в Play Market" />
<p>Введем название и нажмем на кнопку "Загрузить APK". Далее откроется станица приложения, где мы уже непосредственно загружаем файл программы и устанавливаем 
для нее все описание.</p>
<img src="./pics/gplay5.png" />
...
<div class="nav"><p><a href="./21.1.php">Назад</a><a href="./">Содержание</a><a href="./23.1.php">Вперед</a></p></div></div>
<div class="socBlock">
