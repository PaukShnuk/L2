...
<html >
<head>
<title>Java и Android | Изображения из папки assets</title>
<meta charset="utf-8" />
<meta name="description" content="Загрузка изображений из папки assets в ImageView в Android">
...
<h2>Изображения из папки assets</h2><div class="date">Последнее обновление: 16.10.2021</div>
...
<p>В прошлых темах изображения в проекте помещались в папку <span class="ii">res/drawables</span> в качестве ресурсов и выводились в элемент ImageView. Однако изображения необязательно в принципе 
помещать именно в эту папку. Файлы также могут располагаться в папке assets. Рассмотрим, как работать с такими файлами изображений.</p>
<p>Вначале добавим в проект папку assets. Для этого в Android Studio нажмем на каталог <span class="b">app</span> и в появившемся контекстном меню 
выберем <span class="b">New -&gt; Directory</span>:</p>
<img src="./pics/imageview6.png" alt="Добавление папки в Android Studio" />
...
<img src="./pics/imageview6.1.png" alt="Добавление папки assets в Android Studio" />
<p>Добавим в эту папку какое-нибудь изображение:</p>
<img src="./pics/imageview7.png" alt="Drawables в assets в Android Studio и Java" />
<p>Пусть в файле <span class="b">activity_main.xml</span> будет определен элемент ImageView:</p>
<pre class="brush:xml;">
...
<p>Загрузим изображение из папки assets в элемент ImageView в <span class="b">MainActivity</span>:</p>
...
<p>Для загрузки файла необходиом получить поток InputStream с помощью выражения <code>getApplicationContext().getAssets().open(filename)</code>.</p>
<p>Вызов <code>Drawable.createFromStream(inputStream, null)</code> формирует объект Drawable из входного потока.</p>
<p>Метод <code>imageView.setImageDrawable(d)</code> загружает Drawable в ImageView.</p>
<img src="./pics/imageview8.png" alt="Загрузка изображения из assets в Android" />
