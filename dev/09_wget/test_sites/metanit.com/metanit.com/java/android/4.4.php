...
<html >
<head>
<title>Java и Android | DatePicker</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент DatePicker в Android и Java, установка даты, отслеживание изменения дат и OnDateChangedListener">
...
<h2>DatePicker</h2><div class="date">Последнее обновление: 15.10.2021</div>
...
<p><span class="b">DatePicker</span> представляет элемент для выбора даты. Среди его атрибутов можно отметить следующие:</p>
<ul>
<li><p><span class="b">android:calendarTextColor</span>: цвет текста календаря</p></li>
<li><p><span class="b">android:calendarViewShown</span>: указывает, будет ли отображаться вид календаря</p></li>
<li><p><span class="b">android:datePickerMode</span>: устанавливает режим выбора даты</p></li>
<li><p><span class="b">android:dayOfWeekBackground</span>: устанавливает фоновый цвет панели выбора дня недели</p></li>
<li><p><span class="b">android:endYear</span>: устанавливает последний отображаемый год</p></li>
<li><p><span class="b">android:firstDayOfWeek</span>: устанавливает первый день недели</p></li>
<li><p><span class="b">android:headerBackground</span>: устанавливает фоновый цвет для панели выбранной даты</p></li>
<li><p><span class="b">android:maxDate</span>: устанавливает максимальную отображаемую дату в формате mm/dd/yyyy</p></li>
<li><p><span class="b">android:minDate</span>:  устанавливает минимальную отображаемую дату в формате mm/dd/yyyy</p></li>
<li><p><span class="b">android:spinnersShown</span>: указывает, будет ли отображаться спиннер в виджете</p></li>
<li><p><span class="b">android:startYear</span>: устанавливает начальный отображаемый год</p></li> 
<li><p><span class="b">android:yearListSelectorColor</span>: устанавливает цвет для поля выбора года</p></li> 
</ul>
<p>Среди методов DatePicker можно отметить следующие:</p>
<ul>
<li><p><code>int getDayOfMonth()</code>: возвращает номер выбранного дня </p></li>
<li><p><code>int getMonth()</code>: возвращает номер выбранного месяца (от 0 до 11)</p></li>
<li><p><code>int getYear()()</code>: возвращает номер выбранного года</p></li>
<li><p><code>void init(int year, int monthOfYear, int dayOfMonth, DatePicker.OnDateChangedListener onDateChangedListener)</code>: 
устанавливает начальную дату. Последний параметр устанавливает слушатель изменения выбранной даты</p></li>
<li><p><code>void setOnDateChangedListener(DatePicker.OnDateChangedListener onDateChangedListener)</code>: устанавливает слушатель изменения выбранной даты</p></li>
<li><p><code>void setFirstDayOfWeek(int firstDayOfWeek)</code>: устанавливает первый день недели</p></li>
<li><p><code>void updateDate(int year, int month, int dayOfMonth)</code>: программно обновляет выбранную дату</p></li>
</ul>
<p>Пусть в <span class="b">activity_main.xml</span> определен элемент DatePicker:</p>
<pre class="brush:xml;">
...
<p>Применим некоторые методы DatePicker для управления его поведением:</p>
...
<p>Используя метод <code>datePicker.init();</code> устанавливаем дату по умолчанию - 1 марта 2020 года, так как отсчет месяцев идет с нуля. 
...
будет выбирать дату, будет срабатывать метод <span class="b">onDateChanged()</span> объекта DatePicker.OnDateChangedListener. Этот метод принимает 
четыре параметра - view (элемент DatePicker), year (выбранный год), monthOfYear (выбранный месяц), dayOfMonth (выбранный день).</p> 
<p>Далее мы можем получить выбранные день, месяц и год. Причем для можно использовать как параметры метода onDateChanged, так и методы самого DatePicker</p>
<p>Начальное состояние перед выбором - установлена дата 1 марта 2020 года.</p>
<img src="./pics/datepicker1.png" alt="Отображение даты и DatePicker в Android и Java" />
<p>Выбор произвольной даты (20 мая 2020 года):</p>
<img src="./pics/datepicker2.png" alt="OnDateChangedListener и DatePicker в Android и Java" />
<p>DatePicker по умолчанию отображается в режиме календаря, но мы можем использовать добавить другой режим - спиннер с помощью атрибута <code>android:datePickerMode</code>:</p>
<pre class="brush:xml;">
&lt;DatePicker android:id="@+id/datePicker"
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
...
<img src="./pics/datepicker3.png" alt="Spinner в DatePicker в Android и Java" />
<p>В данном случае спиннер отображается слева от календаря. Если мы вовсе не хотим отображать календаря, то можно установить атрибут <code>android:calendarViewShown="false"</code></p>
<pre class="brush:xml;">
&lt;DatePicker android:id="@+id/datePicker"
        android:layout_width="wrap_content"
        android:layout_height="wrap_content"
...
<div class="nav"><p><a href="./4.3.php">Назад</a><a href="./">Содержание</a><a href="./4.16.php">Вперед</a></p></div></div>
<div class="socBlock">
