...
<html >
<head>
<title>Java и Android | TextView</title>
<meta charset="utf-8" />
<meta name="description" content="Текстовое поле TextView, его основные свойства и использование в Android">
...
<h2>TextView</h2><div class="date">Последнее обновление: 15.10.2021</div>
...
<p>Для простого вывода текста на экран предназначен элемент <span class="b">TextView</span>. Он просто отображает текст без возможности его 
редактирования. Некоторые его основные атрибуты:</p>
<ul>
<li><p><span class="b">android:text</span>: устанавливает текст элемента</p></li>
<li><p><span class="b">android:textSize</span>: устанавливает высоту текста, в качестве единиц измерения для указания высоты используются <span class="b">sp</span></p></li>
<li><p><span class="b">android:background</span>: задает фоновый цвет элемента в виде цвета в шестнадцатиричной записи или в виде цветового ресурса</p></li>
<li><p><span class="b">android:textColor</span>: задает цвет текста</p></li>

<li><p><span class="b">android:textAllCaps</span>: при значении true делает все символы в тексте заглавными</p></li>

<li><p><span class="b">android:textDirection</span>: устанавливает направление текста. По умолчанию используется направление слева направо, но с помощью значения 
<span class="b">rtl</span> можно установить направление справо налево</p></li>
<li><p><span class="b">android:textAlignment</span>: задает выравнивание текста. Может принимать следующие значения:</p>
	<ul>
	<li><p><code>center</code>: выравнивание по центру</p></li>
	<li><p><code>textStart</code>: по левому краю</p></li>
	<li><p><code>textEnd</code>: по правому краю</p></li>
	<li><p><code>viewStart</code>: при направлении текста слева направо выравнивание по левому краю, при направлении справа налево - по правому</p></li>
	<li><p><code>viewEnd</code>: при направлении текста слева направо выравнивание по правому краю, при направлении справа налево - по левому</p></li>
	</ul>
</li>
<li><p><span class="b">android:fontFamily</span>: устанавливает тип шрифта. Может принимать следующие значения:</p>
	<ul>
	<li><p>monospace</p></li>
	<li><p>serif</p></li>
	<li><p>serif-monospace</p></li>
	<li><p>sans-serif</p></li>
	<li><p>sans-serif-condensed</p></li>
	<li><p>sans-serif-smallcaps</p></li>
	<li><p>sans-serif-light</p></li>
	<li><p>casual</p></li>
	<li><p>cursive</p></li>
	<li><p>cursive</p></li>
	</ul>
...
<p>Например, определим три текстовых поля:</p>
<pre class="brush:xml;">
...
<img src="./pics/textview1.png" alt="Атрибуты TextView в Android Studio" />
<p>Установка элемента в коде тоже не отличается сложностью. Например, создадим элемент и выведем его на экран:</p>
...
<img src="./pics/textview2.png" alt="Создание TextView в Java в Android Studio" />
<p>Иногда необходимо вывести на экран какую-нибудь ссылку, либо телефон, по нажатию на которые производилось бы определенное действие. Для этого 
в TextView определен атрибут <span class="b">android:autoLink</span>:</p>
<pre class="brush:xml;">
&lt;TextView 
...
<img src="./pics/autolink.png" alt="autolink in Android" />
<p>android:autoLink может принимать несколько значений:</p>
<ul>
<li><p><code>none</code>: отключает все ссылки</p></li>
<li><p><code>web</code>: включает все веб-ссылки</p></li>
<li><p><code>email</code>: включает ссылки на электронные адреса</p></li>
<li><p><code>phone</code>: включает ссылки на номера телефонов</p></li>
<li><p><code>map</code>: включает ссылки на карту</p></li>
<li><p><code>all</code>: включает все вышеперечисленные ссылки</p></li>
</ul>
<p>То есть при настройке android:autoLink="web" если в тексте есть упоминание адреса url, то этот адрес будет выделяться, а при нажатии на него 
...
<code>android:autoLink="web|email"</code></p>
...
<div class="nav"><p><a href="./3.14.php">Назад</a><a href="./">Содержание</a><a href="./4.8.php">Вперед</a></p></div></div>
<div class="socBlock">
