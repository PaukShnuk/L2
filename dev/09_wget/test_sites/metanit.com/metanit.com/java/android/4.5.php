...
<html >
<head>
<title>Java и Android | ImageView</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент ImageView в Android, вывод и масштабирование изображений">
...
<h2>ImageView</h2><div class="date">Последнее обновление: 16.10.2021</div>
...
<p>В прошлой теме было рассмотрено, как выводить изображения с помощью элемента ImageView. Теперь рассмотрим некоторые дополнительные моменты по работе 
с этим элементом.</p>
<p>Некоторые основные атрибуты элемента ImageView:</p>
<ul>
<li><p><span class="b">android:cropToPadding</span>: при значении <code>true</code> изображение обрезается в соответствии с установленными отступами</p></li>
<li><p><span class="b">android:scaleType</span>: устанавливает, как изображение будет масштабироваться относительно границ элемента ImageView</p>
<p>Чтобы задать параметры масштабирования, используется одно из значений перечисления <span class="ImageView.ScaleType"</span>:</p>
<ul>
<li><p><code>CENTER</code>: изображение центрируется по центру без масштабирования</p></li>
<li><p><code>CENTER_CROP</code>: изображение центрируется по центру и масштабируется с сохранением аспектного отношения между шириной и высотой. Если какая-то 
часть не помещается в пределы экрана, то она обрезается</p></li>
<li><p><code>CENTER_INSIDE</code>: изображение центрируется по центру и масштабируется с сохранением аспектного отношения между шириной и высотой, 
но ширина и высота не могут быть больше ширины и высоты ImageView</p></li>
<li><p><code>FIT_CENTER</code>: изображение масштабируется и центрируется</p></li>
<li><p><code>FIT_START</code>: изображение масштабируется и устанавливается в начало элемента (вверх при портретной ориентации и влево - при альбомной)</p></li>
<li><p><code>FIT_END</code>: изображение масштабируется и устанавливается в конец элемента (вниз при портретной ориентации и вправо - при альбомной)</p></li>
<li><p><code>FIT_XY</code>: изображение масштабируется без сохранения аспектного отношения межуд шириной и высотой, заполняя все пространство ImageView</p></li>
<li><p><code>MATRIX</code>: изображение масштабируется с применением матрицы изображения</p></li>
</ul></li>
<li><p><span class="b">android:src</span>: ресурс изображения</p></li>
<li><p><span class="b">android:alpha</span>: устанавливает прозрачность (значение от 0.0 - полностью прозрачное до 1.0 - полностью видимо)</p></li>
<li><p><span class="b">android:tint</span>: цвет, который используется для наложения на изображение</p></li>
<li><p><span class="b">android:tintMode</span>: режим, который применяется для наложения цвета на изображения</p></li>
</ul>
<p>Некоторые основные методы класса ImageView:</p>
<ul>
<li><p><span class="b">Drawable	getDrawable()</span>: возвращает ресурс <code>Drawable</code>, который связан с данным ImageView (или <code>null</code>, 
если ресурс для ImageView не устанавлен)</p></li>
<li><p><span class="b">ImageView.ScaleType	getScaleType()</span>: возвращает значение перечисления ImageView.ScaleType, которое 
указывает, как масштабируется изображение относительно границ элемента ImageView</p></li>
<li><p><span class="b">void	setImageDrawable(Drawable drawable)</span>: устанавливает ресурс изображения с помощью объекта Drawable</p></li>
<li><p><span class="b">void	setImageResource(int resId)</span>: устанавливает ресурс изображения с помощью идентификатора ресурса Drawable</p></li>
<li><p><span class="b">void	setImageURI(Uri uri)</span>: устанавливает ресурс изображения с помощью адреса Uri этого ресурса</p></li>
<li><p><span class="b">void	setScaleType(ImageView.ScaleType scaleType)</span>: задает масштабирование изображения</p></li>
<li><p><span class="b">void	setImageAlpha(int alpha)</span>: задает прозрачность изображения - значение от 0.0 до 1.0</p></li>
</ul>
<p>Например, установка значения <code>FIT_XY</code> для атрибута <span class="b">android:scaleType</span> в файле <span class="b">activity_main.xml</span>:</p>
<pre class="brush:xml;">
...
<p>В итоге изображение растянется по вертикали и горизонтали:</p>
<img src="./pics/fitxy2.png" alt="Элемент ImageView с масштабированием в Android" />
<p>Для сравнения аналогичный пример с <code>android:scaleType="center"</code>:</p>
<img src="./pics/center2.png" alt="Элемент ImageView с центрированием в Android" />
<p>Аналогичный пример в коде java:</p>
...
<div class="nav"><p><a href="./2.9.php">Назад</a><a href="./">Содержание</a><a href="./4.15.php">Вперед</a></p></div></div>
<div class="socBlock">
