...
<html >
<head>
<title>Java и Android | Gravity и позиционирование внутри элемента</title>
<meta charset="utf-8" />
<meta name="description" content="Использование атрибутов gravity в  Android и Java для позиционирования содержимого внутри элемент, программная установка параметров">
...
<h2>Gravity</h2><div class="date">Последнее обновление: 15.10.2021</div>
...
<p>Атрибут <span class="b">gravity</span> задает позиционирование содержимого внутри визуального элемента. Он может принимать следующие значения:</p>
<ul>
<li><p><code>top</code>: элементы размещаются вверху</p></li>
<li><p><code>bottom</code>: элементы размещаются внизу</p></li>
<li><p><code>left</code>: элементы размещаются в левой стороне</p></li>
<li><p><code>right</code>: элементы размещаются в правой стороне контейнера</p></li>
<li><p><code>center_vertical</code>: выравнивает элементы по центру по вертикали</p></li>
<li><p><code>center_horizontal</code>: выравнивает элементы по центру по горизонтали</p></li>
<li><p><code>center</code>: элементы размещаются по центру</p></li>
<li><p><code>fill_vertical</code>: элемент растягивается по вертикали</p></li>
<li><p><code>fill_horizontal</code>: элемент растягивается по горизонтали</p></li>
<li><p><code>fill</code>: элемент заполняет все пространство контейнера</p></li>
<li><p><code>clip_vertical</code>: обрезает верхнюю и нижнюю границу элементов</p></li>
<li><p><code>clip_horizontal</code>: обрезает правую и левую границу элементов</p></li>
<li><p><code>start</code>: элемент позиционируется в начале (в верхнем левом углу) контейнера</p></li>
<li><p><code>end</code>: элемент позиционируется в конце контейнера(в верхнем правом углу)</p></li>
</ul>
<p>Например, поместим текст в самый низ в элементе TextView:</p>
<pre class="brush:xml;">
...
<img src="./pics/gravity1.png" alt="Gravity в Android Studio" />
<p>При необходимости мы можем комбинировать значения, разделяя их вертикальной чертой:</p>
<pre class="brush:xml;">
&lt;TextView
...
<img src="./pics/gravity2.png" alt="Gravity right bottom в Android" />
<h3>Программная установка gravity</h3>
<p>Чтобы установить параметр gravity у элемента надо вызвать метод <span class="b">setGravity()</span>. 
В качестве параметра в метод передается одна из констант класса <span class="b">Gravity</span>, которые аналогичны значениям атрибута (за тем исключенем, 
что названия в верхнем регистре):</p>
...
<img src="./pics/gravity4.png" alt="Программная установка layout_gravity в Android" />
<p>Для сочетания нескольких значений также можно использовать вертикальную черту:</p>
<pre class="brush:java;">textView.setGravity(Gravity.BOTTOM | Gravity.CENTER);</pre>
...
<div class="nav"><p><a href="./3.11.php">Назад</a><a href="./">Содержание</a><a href="./3.14.php">Вперед</a></p></div></div>
<div class="socBlock">
