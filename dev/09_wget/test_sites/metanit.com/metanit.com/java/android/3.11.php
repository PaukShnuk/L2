...
<html >
<head>
<title>Java и Android | ScrollView</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер ScrollView в Android, создание прокрутки элементов">
...
<h2>ScrollView</h2><div class="date">Последнее обновление: 15.10.2021</div>
...
<p>Контейнер <span class="b">ScrollView</span> предназначен для создания прокрутки для такого интерфейса, все элементы которого одномоментно не могут поместиться 
на экране устройства. ScrollView может вмещать только один элемент, поэтому если мы хотим разместить несколько элементов, то их надо поместить в какой-нибудь контейнер.</p>
<p>Например, определим ряд TextView с большими текстами:</p>
<pre class="brush:xml;">
&lt;ScrollView
...
<p>Так как в ScrollView можно поместить только один элемент, то все TextView заключены в LinearLayout. И если площадь экрана будет недостаточной, чтобы 
поместить все содержимое LinearLayout, то станет доступной прокрутка:</p>
<img src="./pics/scrollview.png" alt="ScrollView в Android Studio и Java" />
<p>Создание ScrollView программно в коде MainActivity:</p>
