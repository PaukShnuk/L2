...
<html >
<head>
<title>Java и Android | ToggleButton</title>
<meta charset="utf-8" />
<meta name="description" content="Элемент ToggleButton в Android и Java, переключение состояния и обработка нажатия">
...
<h2>ToggleButton</h2><div class="date">Последнее обновление: 15.10.2021</div>
...
<p><span class="b">ToggleButton</span> подобно элементу CheckBox может пребывать в двух состояниях: отмеченном и неотмеченном, причем для каждого состояния мы можем отдельно 
установить свой текст. Например, определим следующий элемент ToggleButton:</p>
<pre class="brush:xml;">
...
<p>Атрибуты <code>android:textOn</code> и <code>android:textOff</code> задают текст кнопки в отмеченном и неотмеченном состоянии соответственно. И также, как и для 
других кнопок, мы можем обработать нажатие на элемент с помощью события <code>onClick</code>. В этом случае определим в классе Activity обработчик события:</p>
...
<img src="./pics/togglebutton.png" alt="ToggleButton в Android в отмеченном состоянии" />
<p>Создание элемента ToggleButton в коде java:</p>
<pre class="brush:java;">
package com.example.viewapp;
...
<div class="nav"><p><a href="./4.3.php">Назад</a><a href="./">Содержание</a><a href="./4.12.php">Вперед</a></p></div></div>
<div class="socBlock">
