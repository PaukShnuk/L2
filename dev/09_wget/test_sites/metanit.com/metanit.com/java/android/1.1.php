...
<html >
<head>
<title>Java и Android | Введение. Установка Android Studio и Android SDK</title>
<meta charset="utf-8" />
<meta name="description" content="Возникновение, значение и история развития платформы, все версии ОС Android, установка Android Studio и Android SDK">
...
<h1>Начало работы с Android</h1><h2>Введение. Установка Android Studio и Android SDK</h2><div class="date">Последнее обновление: 12.10.2021</div>
...
<p>Бурное развитие информационных технологий в последнее время привело к тому, что появилось много новых устройств и технологий, таких, как планшеты, 
...
сегодняшний день является ОС Андроид.</p>
<p>Android используется на самых разных устройствах. Это и смартфоны, и планшеты, и телевизоры, и смарт-часы и ряд других гаджетов. По разным подсчетам за 2020 год этой операционой системой пользуются около 85% владельцев смартфонов, а 
общее количество пользователей сматрфонов на ОС Android оценивается в более чем 2,5 млрд. человек по всему миру.</p>
...
(октябрь 2021 года) последней версией является Android 12.0, которая вышла в октябре 2021 года:</p>
<table class="tab">
...
<h3>Что нужно для разработки?</h3>
<p>Стоит отметить, что разрабатывать приложения под Android можно с помощью различных фреймворков и языков программирования. Так, в качестве языков программирования 
...
<span class="b">Java</span>, как наиболее распространенный и используемый. Поэтому прежде чем приступать к освоению программирования под Android по данному руководству, 
необходимо освоить хотя бы базовые момент языка Java.</p>
<h3>Установка средств разработки</h3>
<p>Существуют разные среды разработки для Android. Рекомендуемой средой разработки  является <span class="b">Android Studio</span>, которая создана специально для разработки под ОС Android. 
Поэтому мы ее и будем использовать. Загрузить файл установщика можно с официального сайта: <a href="https://developer.android.com/studio" rel="nofollow">https://developer.android.com/studio</a>:</p>
<img src="./pics/android_studio.png" alt="Установка Android Studio" />
<p>Кроме самой среды Android Studio для разработки также потребуется набор инструментов, который называется <span class="b">Android SDK</span>. Например, 
если ранее Android SDK еще не было установлено, то при первом обращении к Android Studio она предложит установить ряд дополнительных инструментов, которые необходимы для разработки. 
Прежде всего это Android SDK и ряд дополнительных компонентов:</p>
<img src="./pics/android_studio3.png" alt="Установка Android SDK из Android Studio при старте" />
<p>Нажмем на кнопку <span class="b">Finish</span>, чтобы, наконец, все это установить.</p>
<img src="./pics/android_studio4.png" alt="Начало работы с Android SDK из Android Studio" />
<p>И после завершения установки нажмем на кнопку <span class="b">Finish</span>. И мы можем приступать к созданию приложений.</p>
