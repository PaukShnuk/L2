...
<html >
<head>
<title>Java и базы данных | Добавление, изменение и удаление данных</title>
<meta charset="utf-8" />
<meta name="description" content="Добавление, изменение и удаление данных в БД MySQL в языке программирования Java, класс Statement и метод executeUpdate">
...
<h2>Добавление, изменение и удаление данных</h2><div class="date">Последнее обновление: 08.08.2018</div>
...
<p>Для добавления, редактирования и удаления данных мы можем ипользовать рассмотренный в прошлой теме метод <span class="b">executeUpdate</span>. 
С помощью результата метода мы можем проконтроллировать, сколько строк было добавлено, изменено или удалено.</p>
<h3>Добавление</h3>
<p>Так, возьмем созданную в прошлой теме таблицу Products:</p>
<pre class="brush:sql;">
...
<p>И добавим в эту таблицу несколько объектов:</p>
...
<p>Для добавления данных в БД применяется команда INSERT. В данном случае в таблицу Products добавляется три объекта. И после выполнения программы на консоли мы увидим число добавленных объектов:</p>
<div class="console">
...
<p>А добавленные строки мы можем увидеть в таблице в бд MySQL:</p>
<img src="pics/mysql3.png" alt="executeUpdate в Java JDBC" />
<h3>Редактирование</h3>
<p>Изменим строки в таблице, например, уменьшим цену товара на 5000 единиц. Для изменения применяется команда UPDATE:</p>
<pre class="brush:java;">
import java.sql.*;
...
<h3>Удаление</h3>
<p>Удалим один объект из таблицы с помощью команды DELETE:</p>
<pre class="brush:java;">
import java.sql.*;
...
<p>Как видно из примеров, не так сложно взаимодействовать с базой данных. Достаточно передать в метод executeUpdate нужную команду SQL.</p>
