...
<html >
<head>
<title>C++ | Побитовые операции</title>
<meta charset="utf-8" />
<meta name="description" content="Побитовые операции в языке программирования C++, операции сдвига, поразрядное логическое умножение и сложение, конъюнкция, дизъюнкция, инверсия">
...
<h2>Побитовые операции</h2><div class="date">Последнее обновление: 12.09.2017</div>
...
<p>Побитовые операции выполняются над отдельными разрядами или битами чисел. Данные операции производятся только над целыми числами.</p>
...
<p>Поразрядные операции также проводятся только над соответствующими разрядами целочисленных операндов:</p>
<ul>
...
<li><p><span class="b">~</span>: поразрядное отрицание или инверсия. Инвертирует все разряды операнда. Если разряд равен 1, то он становится равен 0, а если он равен 0, то он получает 
значение 1.</p></li>
</ul>
<p>Применение операций:</p>
<pre class="brush:c;">
