...
<html >
<head>
<title>C++ | Указатели на функции как параметры</title>
<meta charset="utf-8" />
<meta name="description" content="Указатели на функции как параметры других функций в языке программирования C++">
...
<h2>Указатели на функции как параметры</h2><div class="date">Последнее обновление: 01.10.2017</div>
...
<p>В данном случае первый параметр функции operation - <code>int (*op)(int, int)</code> - представляет указатель на функцию, которая возвращает 
значение типа <span class="b">int</span> и принимает два параметра типа <span class="b">int</span>. Результатом функции является вызов той функции, на которую указывает указатель.</p>
