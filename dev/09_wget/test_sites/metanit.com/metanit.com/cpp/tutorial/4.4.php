...
<html >
<head>
<title>C++ | Константы и указатели</title>
<meta charset="utf-8" />
<meta name="description" content="Константы и указатели в языке программирования C++, указатели на константы и константные указатели">
...
<h2>Константы и указатели</h2><div class="date">Последнее обновление: 27.09.2017</div>
...
<p>Указатели могут указывать как на переменные, так и на константы. Чтобы определить указатель на константу, он тоже должен объявляться с ключевым словом <span class="b">const</span>:</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
...
<p>От указателей на константы надо отличать <span class="b">константные указатели</span>. Они не могут изменять адрес, который в них хранится, но могут изменять значение по этому адресу.</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
