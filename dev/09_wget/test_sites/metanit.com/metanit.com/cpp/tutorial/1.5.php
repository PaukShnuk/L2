...
<meta charset="utf-8" />
<meta name="description" content="Локализация и кириллица в консоли в программе на языке C++">
...
<h2>Локализация и кириллица в консоли</h2><div class="date">Последнее обновление: 18.09.2017</div>
...
<p>Если программа при выводе на консоль использует кириллицу, то мы можем столкнуться с ситуацией, когда вместо кириллических 
...
В языке C++ это можно сделать с помощью встроенной функции <span class="b">setlocale()</span>.</p>
...
<img src="pics/locale1.png" alt="Русский язык в C++ в консоли" />
<p>Вместо ожидаемого текста я получаю какие-то непонятные символы. Теперь изменим код, применив функцию setlocale:</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
...
<img src="pics/locale2.png" alt="Кириллица в консоли в C++" />
...
<p>На некоторых платформах, например, Ubuntu, мы можем не столкнуться с подобной проблемой. И в этом случае вызов функции setlocale просто не окажет никакого влияния.</p>
