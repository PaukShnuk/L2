...
<meta charset="utf-8" />
<meta name="description" content="Общий обзор языка программирования C++, его особенности, история развития и стандарты языка">
...
<h1>Введение в C++</h1><h2>Язык программирования C++</h2><div class="date">Последнее обновление: 03.08.2020</div>
...
И еще один ключевой релиз языка намечен на 2017.</p>
<h3>Компиляторы и среды разработки</h3>
<p>Для разработки программ на С++ необходим компилятор - он транслирует исходный код на языке С++ в исполняемый файл, который затем можно запускать. Но 
...
преимущественно будет использоваться свободно распространяемый компилятор <span class="b">g++</span>, разработанный в рамках проекта GNU.</p>
<p>Также для создания программ можно использовать интегрированные среды разработки IDE, такие как Visual Studio, Netbeans, Eclipse, Qt и т.д.</p>
