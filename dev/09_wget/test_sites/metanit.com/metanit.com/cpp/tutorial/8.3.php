...
<html >
<head>
<title>C++ | Чтение и запись текстовых файлов</title>
<meta charset="utf-8" />
<meta name="description" content="Чтение и запись текстовых файлов в языке програмирования C++, функция getline">
...
<h2>Чтение и запись текстовых файлов</h2><div class="date">Последнее обновление: 25.10.2017</div>
...
<p>Потоки для работы с текстовыми файлами представляют объекты, для которых не задан режим открытия <span class="b">ios::binary</span>.</p>
<h3>Запись в файл</h3>
<p>Для записи в файл к объекту ofstream или fstream применяется оператор <span class="b">&lt;&lt;</span> (как и при выводе на консоль):</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
#include &lt;fstream&gt;
...
<p>Данный способ перезаписывает файл заново. Если надо дозаписать текст в конец файла, то для открытия файла нужно использовать режим 
<span class="b">ios::app</span>:</p>
<pre class="brush:cpp;">
...
<p>Если надо считать всю строку целиком или даже все строки из файла, то лучше использовать встроенную функцию <span class="b">getline()</span>, которая принимает 
поток для чтения и переменную, в которую надо считать текст:</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
#include &lt;fstream&gt;
#include &lt;string&gt;
...
<p>Также для чтения данных из файла для объектов ifstream и fstream может применяться оператор <span class="b">&gt;&gt;</span> (также как и при чтении с консоли):</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
#include &lt;fstream&gt;
#include &lt;vector&gt;
...
<p>Используя оператор &gt;&gt;, можно считать последовательно данные в переменные sum и rate и ими инициализировать структуру.</p>
<pre class="brush:cpp;">
while (in &gt;&gt; sum &gt;&gt; rate)
{
	new_operations.push_back(Operation(sum, rate));
