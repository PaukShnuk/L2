...
<html >
<head>
<title>C++ | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования C++, операции отношения и логические операции">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 12.09.2017</div>
...
<p>Условные выражения представляют собой некоторое условие и возвращают значение типа <span class="b">bool</span>, то есть значение <span class="b">true</span> (если условие истинно), 
либо значение <span class="b">false</span> (если условие ложно). К условным выражениям относятся операции отношения и логические операции.</p>
...
<li>
<p><span class="b">&lt;=</span></p>
<p>Операция "меньше или равно". Возвращает true, если первый операнд меньше или равен второму, и false, если первый операнд больше второго:</p>
<pre class="brush:c;">
bool c = 10 &lt;= 4;	// false
bool d = 10 &lt;= 14;	// true
</pre>
...
<li>
<p><span class="b">&gt;=</span></p>
<p>Операция "больше или равно". Возвращает true, если первый операнд больше или равен второму, и false, если первый операнд меньше второго:</p>
<pre class="brush:c;">
bool c = 10 &gt;= 4;	// true
bool d = 10 &gt;= 14;	// false
</pre>
...
<li>
<p><span class="b">!=</span></p>
<p>Операция "не равно". Возвращает true, если первый операнд не равен второму, и false, если оба операнда равны:</p>
<pre class="brush:c;">
bool c = 10 != 4;	// true
bool d = 4 != 4;	// false
</pre>
...
<p>Обычно операции отношения применяются в условных конструкциях типа if...else, которые будут рассмотрены далее.</p>
...
<ul>
<li>
<p><span class="b">!</span> (операция отрицания)</p>
<p>Унарная операция, которая возвращает true, если операнд равен false. Если операнд равен true, операция возвращает false.</p>
<pre class="brush:c;">
bool a = true;
bool b = !a;	// false
bool c =!10&lt;5;	// true
...
<li>
<p><span class="b">&&</span> (конъюнкция, логическое умножение)</p>
<p>Возвращает true, если оба операнда не равны false. Возвращает false, если хотя бы один операнд равен false.</p>
<pre class="brush:c;">
bool a = true;
bool b = false;
bool c = a && b;	// false
...
<li>
<p><span class="b">||</span> (дизъюнкция, логическое сложение)</p>
<p>Возвращает true, если хотя бы один операнд равен true. Возвращает false, если оба операнда равны false.</p>
<pre class="brush:c;">
bool a = true;
bool b = false;
bool c = a || b;		// true
...
<p>Следует обратить внимание, что на консоль выводится не непосредственно true или false, а их числовые эквиваленты - 1 для true и 0 для false.</p>
<p>И также стоит учитывать, что операции отношения имеют больший приоритет, чем логические операции. Поэтому в выражении <code>10 &gt; 5 && 7 &lt; 11</code> 
вначале будут выполняться подвыражения - операции отношения <code>10 &gt; 5</code> и <code>7 &lt; 11</code>, а затем собственно операция логического умножения.</p>
