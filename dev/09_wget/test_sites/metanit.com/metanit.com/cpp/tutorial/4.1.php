...
<html >
<head>
<title>C++ | Что такое указатели</title>
<meta charset="utf-8" />
<meta name="description" content="Указатели в языке программирования C++, получение адреса переменной, создание указателей, извлечение значения по указателю">
...
<h1>Указатели</h1><h2>Что такое указатели</h2><div class="date">Последнее обновление: 22.09.2017</div>
...
<img src="pics/5.2.png" alt="Работа с памятью в языке C++" />
