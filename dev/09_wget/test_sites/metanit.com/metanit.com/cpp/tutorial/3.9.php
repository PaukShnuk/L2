...
<html >
<head>
<title>C++ | Внешние объекты</title>
<meta charset="utf-8" />
<meta name="description" content="Внешние объекты в языке программирования C++, объявление переменных и констант со словом extern">
...
<h2>Внешние объекты</h2><div class="date">Последнее обновление: 22.09.2017</div>
...
<p>Кроме функций внешние файлы могут содержать различные объекты - переменные и константы. Для подключения внешних объектов в файл кода применяется 
ключевое слово <span class="b">extern</span>.</p>
<p>Для объявления объектов определим файл <span class="b">objects.h</span> со следующим содержимым:</p>
<pre class="brush:cpp;">
extern const int x;
extern double y;
</pre>
<p>Здесь объявляются константа x и переменная y. Так как эти объекты будут внешними по отношению к исходному коду, который будет их использовать, 
то они определяются с ключевым словом <span class="b">extern</span>.</p>
<p>Для определения этих объектов добавим новый файл <span class="b">objects.cpp</span>:</p>
<pre class="brush:cpp;">
#include "objects.h"
...
<p>Используем эти объекты в файле <span class="b">app.cpp</span>:</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
#include "objects.h"
...
<img src="pics/4.2.png" alt="extern в c++" />
