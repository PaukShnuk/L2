...
<title>C++ | List</title>
<meta charset="utf-8" />
<meta name="description" content="Контейнер List в языке програмирования C++, двухсвязный список, все операции со списком">
...
<h2>List</h2><div class="date">Последнее обновление: 03.11.2017</div>
...
<p>Контейнер <span class="b">list</span> представляет двухсвязный список. Для его использования необходимо подключить заголовочный файл <span class="b">list</span>.</p>
<p>Создание списка:</p>
<pre class="brush:cpp;">
...
<p>В отличие от других контейнеров для типа list не определена операция обращения по индексу или функция at(), которая выполняет похожую задачу.</p>
<p>Тем не менее для контейнера list можно использовать функции <span class="b">front()</span> и <span class="b">back()</span>, которые возвращают соответственно 
первый и последний элементы.</p>
<p>Чтобы обратиться к элементам, которые находятся в середине (после первого и до последнего элементов), придется выполнять перебор элементов 
с помощью циклов или итераторов:</p>
<pre class="brush:cpp;">
#include &lt;iostream&gt;
#include &lt;list&gt;
...
<h3>Размер списка</h3>
<p>Для получения размера списка можно использовать функцию <span class="b">size()</span>:</p>
<pre class="brush:cpp;">
std::list&lt;int&gt; numbers = { 1, 2, 3, 4, 5 };
...
<p>С помощью функции <span class="b">resize()</span> можно изменить размер списка. Эта функция имеет две формы:</p>
<ul>
...
<ul>
<li><p><span class="b">push_back(val)</span>: добавляет значение val в конец списка</p></li>
<li><p><span class="b">push_front(val)</span>: добавляет значение val в начало списка</p></li>
<li><p><span class="b">emplace_back(val)</span>: добавляет значение val в конец списка</p></li>
<li><p><span class="b">emplace_front(val)</span>: добавляет значение val в начало списка</p></li>
