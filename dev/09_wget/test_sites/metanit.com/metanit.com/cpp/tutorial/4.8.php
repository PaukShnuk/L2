...
<html >
<head>
<title>C++ | Указатели на функции</title>
<meta charset="utf-8" />
<meta name="description" content="Указатели на функции в языке программирования C++, определение и использование, массив указателей на функции">
...
<h2>Указатели на функции</h2><div class="date">Последнее обновление: 01.10.2017</div>
...
<p>Указатель на функцию (function pointer) хранит адрес функции. По сути указатель на функцию содержит адрес первого байта в памяти, по которому располагается выполняемый код функции.</p>
<p>Самым распространенным указателем на функцию является ее имя. С помощью имени функции можно вызывать ее и получать результат ее работы.</p>
<p>Но также указатель на функцию мы можем определять в виде отдельной переменной с помощью следующего синтаксиса:</p>
<pre class="brush:cpp;">тип (*имя_указателя) (параметры);</pre>
...
<pre class="brush:cpp;">void (*message) ();></pre>
<p>В данном случае определен указатель, который имеет имя <span class="b">message</span>. Он может указывать на функции без параметров, которые возвращают 
...
<pre class="brush:cpp;">message=hello;</pre>
...
<pre class="brush:cpp;">message();</pre>
...
значение типа <span class="b">int</span>. Соответственно мы можем присвоить указателю адреса функций add и subtract и вызвать их, передав при вызове указателю некоторые значения для параметров.</p>
...
<p>Например:</p>
<pre class="brush:cpp;">double (*actions[]) (int, int)</pre>
