...
<html >
<head>
<title>С | Логические операции и операции отношения</title>
<meta charset="utf-8" />
<meta name="description" content="Логические операции и операции отношения в языке программирования Си, истинность и ложность выражений, конъюнкция и дизъюнкция">
...
<h2>Логические операции и операции отношения</h2><div class="date">Последнее обновление: 18.05.2017</div>
...
<p>Логические операции и операции сравнения в языке Си оперируют понятиями "истина" и "ложь". Причем "истина" соответствует значению 1, а "ложь" - значению 0. 
Оба этих вида операций применяются к арифметическим операндам, то есть числам.</p>
<h3>Операции отношения</h3>
<p>Операции отношения позволяют сравнить два значения и возвращают 1 (если выражение истинно) или 0 (если выражение ложно). В языке Си есть следующие 
операции отношения:</p>
<ul>
<li>
<p><span class="b">==</span></p>
<p>Операция "равно". Возвращает 1, если оба операнда равны, и 0, если они не равны:</p>
<pre class="brush:c;">
int a = 10;
int b = 4;
int c = a == b;	// 0
...
<li>
<p><span class="b">&gt;</span></p>
<p>Операция "больше чем". Возвращает 1, если первый операнд больше второго, и 0, если первый операнд меньше или равен второму:</p>
<pre class="brush:c;">
int a = 10;
int b = 4;
int c = a &gt; b;	// 1
...
<li>
<p><span class="b">&lt;</span></p>
<p>Операция "меньше чем". Возвращает 1, если первый операнд меньше второго, и 0, если первый операнд больше или равен второму:</p>
<pre class="brush:c;">
int c = 10 &lt; 4;	// 0
</pre>
</li>
<li>
<p><span class="b">&lt;=</span></p>
<p>Операция "меньше или равно". Возвращает 1, если первый операнд меньше или равен второму, и 0, если первый операнд больше второго:</p>
<pre class="brush:c;">
int c = 10 &lt;= 4;	// 0
</pre>
</li>
<li>
<p><span class="b">&gt;=</span></p>
<p>Операция "больше или равно". Возвращает 1, если первый операнд больше или равен второму, и 0, если первый операнд меньше второго:</p>
<pre class="brush:c;">
int c = 10 &gt;= 4;	// 1
</pre>
</li>
<li>
<p><span class="b">!=</span></p>
<p>Операция "не равно". Возвращает 1, если первый операнд не равен второму, и 0, если оба операнда равны:</p>
<pre class="brush:c;">
int c = 10 != 4;	// 1
int d = 4 != 4;		// 0
</pre>
...
<p>Если операнд равен 0, то возвращает 1, иначе возвращает 0.</p>
<pre class="brush:c;">
int c = !2;	// 0
int d = !0;	// 1
</pre>
...
<p>Возвращает 1, если оба операнда не равны 0. Возвращает 0, если хотя бы один операнд равен 0.</p>
<pre class="brush:c;">
int c = -2 && 5;	// 1
int d = 0 && 7;		// 0
</pre>
...
<p>Возвращает 1, если хотя бы один операнд не равен 0. Возвращает 0, если оба операнда равны 0.</p>
<pre class="brush:c;">
int c = -2 || 5;	// 1
int d = 0 || 7;		// 1
int e = 0 || 0;		// 0
...
<pre class="brush:c;">int d = -2 &gt; 5 && 0 &lt; 7 || 0 == 0; 		// 1</pre>
