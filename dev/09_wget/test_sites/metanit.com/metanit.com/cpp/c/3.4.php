...
<html >
<head>
<title>С | Условная компиляция</title>
<meta charset="utf-8" />
<meta name="description" content="Условная компиляция с помощью директив #if, #elif, #else, #endif в языке программирования Си">
...
<h2>Условная компиляция</h2><div class="date">Последнее обновление: 22.05.2017</div>
...
<p>Директивы условной компиляции позволяют в зависимости от условий добавить добавить в файл определенный код.</p>
<p>Прежде всего это такие директивы как <span class="b">#if/#else/#endif</span>, действие которых напоминает условную конструкцию if:</p>
<pre class="brush:c;">
#if условие
текст_1
#else
...
<p>Если условие возвращает ненулевое значение (то есть оно истинно), то в итоговый исходный файл вставляется <span class="ii">текст_1</span>. 
Если же условие возвращает 0 (то есть оно ложно), то вставляется <span class="ii">текст_2</span>. Например:</p>
<pre class="brush:c;">
#include &lt;stdio.h&gt;
#define N 22
...
<p>С помощью директивы <span class="b">#elif</span> можно проверять дополнительные условия:</p>
<pre class="brush:c;">
#include &lt;stdio.h&gt;
#define N 24
...
<p>С помощью директивы <span class="b">#ifdef</span> можно проверять, определен ли идентификатор, и если он определен, вставлять в исходный код определенный текст:</p>
<pre class="brush:c;">
#include &lt;stdio.h&gt;
#define DEBUG
...
<p>Обратным действием обладает директива <span class="b">#ifndef</span> - она включает текст, если идентификатор не определен:</p>
<pre class="brush:c;">
#include &lt;stdio.h&gt;
//#define DEBUG
...
<p>Если нам одновременно надо проверить значения двух идентификаторов, то можно использовать специальный оператор <span class="b">defined</span>:</p>
<pre class="brush:c;">
#include &lt;stdio.h&gt;
#define BETA
#define DEBUG
