...
<html >
<head>
<title>С | Локализация и кириллица в консоли</title>
<meta charset="utf-8" />
<meta name="description" content="Локализация и кириллица в консоли в программе на языке Си">
...
<h2>Локализация и кириллица в консоли</h2><div class="date">Последнее обновление: 18.05.2017</div>
...
<p>При использовании кириллических символов мы можем столкнуться с ситуацией, когда вместо кириллических символов отображаются непонятные знаки. Особенно 
это актуально для ОС Windows. И в этом случае необходимо явным образом задать текущую локаль (культуру) для вывода символов. 
В Си это делается с помощью функции <span class="b">setlocale()</span>, определение которой имеется в заголовочном файле <span class="b">locale.h</span>.</p>
...
<img src="./pics/locale1.png" alt="Русский язык в Си в консоли" />
...
<p>Поскольку функция setlocale определена в файле locale.h, то он подключается с помощью директивы <code>#include &lt;locale.h&gt;</code>.</p>
<p>Повторно компилируем и запустим приложение:</p>
<img src="./pics/locale2.png" alt="Кириллица в консоли в Си" />
...
<p>На некоторых платформах, например, Ubuntu 16.04, мы можем не столкнуться с подобной проблемой. И в этом случае вызов функции setlocale просто не окажет никакого влияния.</p>
...
<div class="nav"><p><a href="./1.7.php">Назад</a><a href="./">Содержание</a><a href="./2.1.php">Вперед</a></p></div></div>
<div class="socBlock">
