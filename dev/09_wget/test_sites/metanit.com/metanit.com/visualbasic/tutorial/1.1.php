...
<html >
<head>
<title>Visual Basic .NET | Введение</title>
<meta charset="utf-8" />
<meta name="description" content="VB.NET или Visual Basic .NET представляет объектно-ориентированный язык программирования от компании Microsoft, который использует бейсикоподобный синтаксис и работает на платформе Microsoft.">
...
<h1>Введение в VB.NET</h1><h2>Язык Visual Basic и платформа .NET</h2><div class="date">Последнее обновление: 15.11.2021</div>
...
<p>VB.NET или Visual Basic .NET представляет объектно-ориентированный язык программирования от компании Microsoft, который использует бейсикоподобный синтаксис и 
работает на платформе Microsoft.</p> 
<p>Хотя VB.NET уступает по популярности таким языкам, как C++, C#, Java в силу различных причин, однако тем не менее также обладает достаточно 
...
и графические программки, и игровые приложения, и сложные высоконагруженные веб-сервисы.</p>
<p>С момента создания в 2002 году VB.NET был призван заменить распространенный на тот момент Visual Basic 6, а новый язык получил название VB 7. В то же время VB.NET, 
имея схожий синтаксис, сильно отличался от своего предшественника. С 2002 года VB.NET прошел большой путь. 
Последняя версия языка - <span class="b">Visual Basic .NET 16.9</span> вышла в 2019 году.</p>
<p>Visual Basic .NET развивается как opensource-проект, который доступен на github по адресу <a href="https://github.com/dotnet/vblang" rel="nofollow">https://github.com/dotnet/vblang</a>.</p>
<h3>Объектно-ориентированность</h3>
<p>Одной из основных особенностей VB.NET является его объектно-ориентированность. VB.NET - полноценный объектно-ориентированный язык. 
...
задачи по построению крупных, но в тоже время гибких, масштабируемых и расширяемых приложений, которые было бы сложнее создавать с помощью традиционного VB 6.0.</p>
<h3>Роль платформы .NET</h3>
<p>Ключевое отличие VB.NET от классического Visaul Basica состоит в использовании платформы .NET. Язык VB.NET был создан специально для работы 
с платформой .NET. Рассмотрим некоторые ее основные черты:</p>
<ul>
<li><p><span class="b">Поддержка различных языков</span>.  Среда поддерживает ряд языков VB.NET, C#, C++, F#, а также различные диалекты других 
...
этих языков компилируется в сборку на общем языке CIL (Common Intermediate Language). Язык CIL является своего рода ассемблером для платформы .NET.</p></li>
<li><p><span class="b">Кроссплатформенность</span>. .NET является переносимой платформой. Например, 
 ...
 писать приложения для этих ОС.</p></li>
<li><p><span class="b">Мощная библиотека классов</span>. Еще одной ключевой особенностью .NET является единая для всех поддерживаемых языков 
библиотеку классов. И при написании любого приложения на VB.NET мы так или иначе задействуем библиотеку классов .NET.</p></li>
<li><p><span class="b">Разнообразие технологий</span>. .NET представляет целый стек технологий, которые программисты могут применять при 
...
<p>Как выше писалось, код на VB.NET компилируется в приложения или сборки с расширениями exe или dll на языке Common Intermediate Language. Затем при запуске 
...
При том уже скомпилированная часть приложения сохраняется до завершения работы программы. В итоге это повышает производительность.</p>
<p>Это были вводные сведения о языке Visual Basic и платформе .NET. А теперь создадим первое приложение.</p>
