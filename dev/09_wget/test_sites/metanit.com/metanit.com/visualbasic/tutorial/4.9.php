...
<html >
<head>
<title>Интерфейсы IEnumerable и IEnumerator в VB.NET</title>
<meta charset="utf-8" />
...
<h2>Интерфейсы IEnumerable и IEnumerator</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Основой для большинства встроенных коллекций является реализация интерфейсов IEnumerable и IEnumerator, которые определяют базовый функционал 
коллекций. Благодаря реализации этих интерфейсов мы можем перебирать объекты коллекции в цикле <code>foreach</code>.</p>
...
<p>Возьмем пример с классом Library из прошлой темы и реализуем в этом классе интерфейс <b>IEnumerable</b>:</p>
<pre class="brush:vb;">
Module Module1
...
<p>Таким образом, благодаря реализации IEnumerable мы сможем пройтись по объекту Library в цикле for each, как по контейнеру элементов.</p>
