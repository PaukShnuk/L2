...
<html >
<head>
<title>Работа с консолью и класс Console в VB.NET</title>
<meta charset="utf-8" />
...
<h2>Работа с консолью в Visual Basic.NET</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Чтобы работать с консолью в Visual Basic.NET, вводить какие-то данные и, наоборот, что-то выводить на экран, нам нужно задействовать класс 
<span class="bb">Console</span>. В предыдущих темах уже использовались ряд его методов, в частности, метод <code>WriteLine</code> для 
вывода на консоль. Теперь же разберем этот класс и его методы более подробно.</p>
<p>При работе с консолью, мы можем использовать следующие методы класса Console:</p>
<ul>
<li><p><span class="bb">Beep</span>: подает звуковой сигнал</p></li>
<li><p><span class="bb">Clear</span>: очищает окно консоли</p></li>
<li><p><span class="bb">WriteLine</span>: выводит строку текста с переводом на новую строку</p></li>
<li><p><span class="bb">Write</span>: выводит строку текста без перевода на новую строку</p></li>
<li><p><span class="bb">ReadLine</span>: считывает введенный пользователем текст</p></li>
<li><p><span class="bb">Read</span>: считывает одиночный введенный символ в виде числового кода данного символа</p></li>
<li><p><span class="bb">ReadKey</span>: считывает нажатую клавишу клавиатуры (<code>Dim key As ConsoleKeyInfo = Console.ReadKey()</code>)</p></li>
</ul>
<p>Также в классе Console определены ряд свойств, с помощью которых мы можем изменить отображение окна консоли:</p>
<ul>
<li><p><span class="bb">BackgroundColor</span>: цвет фона консоли</p></li>
<li><p><span class="bb">ForegroundColor</span>: цвет шрифта консоли</p></li>
<li><p><span class="bb">BufferHeight</span>: высота буфера консоли</p></li>
<li><p><span class="bb">BufferWidth</span>: ширина буфера консоли</p></li>
<li><p><span class="bb">Title</span>: заголовок консоли</p></li>
<li><p><span class="bb">WindowHeight</span> и <span class="bb">WindowWidth</span>: высота и ширина консоли соответственно</p></li>
</ul>
<p>Напишем небольшое приложение. Оно будет принимать два числа, введенные пользователем, и отображать их сумму. Приложение будет 
иметь следующий код:</p>
<pre class="brush:vb;">
Module Module1
...
<p>Вначале устанавливаем цвет шрифта консоли. Все доступные цвета хранятся в перечислении <code>ConsoleColor</code>.</p>
<p>Затем предлагаем пользователю ввести цвет и далее получаем введенное значение с помощью метода <code>Console.ReadLine()</code></p>
<p>Далее переустанавливаем цвет и выводим ранее введенное значение.</p>
<p>Второй вызов метода <code>Console.WriteLine</code> преставляет форматированный вывод. То есть мы можем задать несколько разных значений самых 
разных типов и затем их поместить вместо плейсхолдеров в строку. Выражение <code>{0}</code> является плейсхолдером, указывающим, что вместо него 
надо будет поместить первый параметр метода (так как отсчет начинается с нуля). Но также можно использовать и большее число параметров:</p>
<pre class="brush:vb;">
Dim num1 As Integer = 3
Dim num2 As Integer = 5
Console.WriteLine("Результат умножения чисел {0} и {1} равен {2}", num1, num2, num1 * num2)
</pre>
<p>Здесь три параметра и первым ({0}) идет первый параметр после строки - то есть num1, вторым параметром - num2 и так далее.</p>
...
<div class="nav"><p><a href="2.11.php">Назад</a><a href="./">Содержание</a><a href="3.1.php">Вперед</a></p></div></div>
<div class="socBlock">
