...
<html >
<head>
<title>Очередь Queue(Of T) в Visual Basic.NET</title>
<meta charset="utf-8" />
...
<h2>Очередь Queue</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Класс <code>Queue(Of T)</code> представляет набор однотипных объектов, который работает по алгоритму FIFO ("первый вошел - первый вышел"), 
то есть как стандартная очередь.</p>
<p>Рассмотрим некоторые основные методы класса <code>Queue(Of T)</code>:</p>
<ul>
<li><p><span class="bb">Dequeue</span>: извлекает и возвращает первый элемент очереди</p></li>
<li><p><span class="bb">Enqueue</span>: добавляет элемент в конец очереди</p></li>
<li><p><span class="bb">Peek</span>: просто возвращает первый элемент из начала очереди без его удаления</p></li>
</ul>
<p>Теперь рассмотрим применение класса очереди в программе:</p>
<pre class="brush:vb;">
Module Module1
