...
<html >
<head>
<title>Программа сортировки массива в Visual Basic.NET</title>
<meta charset="utf-8" />
...
<h2>Программа сортировки массива</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Поскольку мы уже обладаем некоторыми начальными знаниями, попробуем создать простую программу, в которой мы будем вводить числа случайным образом. 
А программа будет выводить эти числа по возрастанию. Итак, создадим новое консольное приложение и добавим в него следующий код:</p>
<pre class="brush : vb;">
Module Module1
...
<p>В начале программы мы осуществляем ввод чисел с клавиатуры. За ввод чисел отвечает метод <code>Console.ReadLine()</code>. Но поскольку 
он возвращает введенную строку, нам желательно преобразовать строку в число с помощью метода <code>Int32.Parse</code>. Почему желательно? Потому что 
по умолчанию функция Option Strict имеет значение Off, поэтому допустимо неявное преобразование типов.</p>
<p>Затем происходит собственно сортировка. Мы вводим некоторое значение <code>temp</code>. Потом в коде внутреннего цикла осуществляем через 
эту переменную обмен значениями. В конце программы мы выводим отсортированный массив на экран.</p>
