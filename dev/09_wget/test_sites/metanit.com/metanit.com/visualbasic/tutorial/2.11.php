...
<html >
<head>
<title>Структуры в Visual Basic.NET</title>
<meta charset="utf-8" />
...
<h2>Структуры</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Кроме простых типов данных, типа Integer, в языке VB.NET имеются и составные, которые называются структурами. Они могут, как и модули, 
содержать другие переменные различных типов, а также методы. Объявление структуры начинается со ключевого слова <b>Structure</b>. Создадим структуру 
Book, которая будет хранить переменные для названия, автора и года издания книги и процедуру для вывода на консоль информации о книге:</p>
 <pre class="brush : vb;">
Structure Book
    'Название книги
    Dim name As String
...
<p>Теперь используем эту структуру в программе:</p>
 <pre class="brush : vb;">
Module Module2
	Structure Book
        'Название книги
...
<p>Обратите внимание, что структуру можно задать только на уровне модуля или класса, но никак не в методе. При чем структура Book 
является не просто набором переменных, но и новым типом данных. Мы можем использовать массив структур:</p>
<pre class="brush : vb;">
Dim books(2) As Book
