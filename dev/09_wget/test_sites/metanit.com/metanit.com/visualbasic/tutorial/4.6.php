...
<html >
<head>
<title>Стек Stack(Of T) в Visual Basic.NET</title>
<meta charset="utf-8" />
...
<h2>Стек Stack(Of T)</h2><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Класс <code>Stack(Of T)</code> представляет набор однотипных объектов, которая использует алгоритм LIFO ("последний вошел - первый вышел"), 
...
обратном порядке - извлекается тот элемент, который находится выше всех в стеке и был добавлен позже всех.</p>
<p>Среди методов класса Stack можно выделить два основных, с помощью которых можно управлять добавлением и извлечением элементов:</p>
<ul>
<li><p><span class="bb">Push</span>: добавляет элемент в стек на первое место</p></li>
<li><p><span class="bb">Pop</span>: извлекает и возвращает первый элемент из стека</p></li>
<li><p><span class="bb">Peek</span>: просто возвращает первый элемент из стека без его удаления</p></li>
</ul>
...
<p>Следующий рисунок наглядно иллюстрирует работу стека в данном примере:</p>
<img src="pics/4.1.png" alt="Stack в Visual Basic.NET" />
