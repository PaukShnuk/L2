...
<html >
<head>
<title>Работа с файлами в Visual Basic.NET</title>
<meta charset="utf-8" />
...
<h1>Работа с файлами в Visual Basic.NET</h1><div class="date">Последнее обновление: 30.10.2015</div>
...
<p>Как правило, программы оперируют большими массивами данных, которые могут храниться в различных местах. Чаще всего в качестве хранилища данных 
выстпуают файлы. Поэтому работа с файлами в Visual Basic.NET имеет большое значение. Например, в процессе работы программы нам может 
потребоваться считать текст из файла или произвести в него запись, удалить файл или целый каталог и так далее.</p>
<p>Основные возможности фреймворка .NET по управлению и манипуляции файлами и каталогами по большей части сосредоточены в 
пространстве имен <span class="bb">System.IO</span>. Классы этого пространства имен позволяют управлять файловым вводом-выводом. Рассмотрим некоторые 
из этих классов и их функциональность.</p>
<h2>Работа с дисками</h2>
<p>Для работы с дисками в пространстве имен <code>System.IO</code> имеется специальный класс <span class="bb">DriveInfo</span>.</p>
<p>В этом классе определен статический метод <code>GetDrives</code>, который возвращает имена всех логических дисков компьютера. Также он предоставляет 
ряд полезных свойств:</p>
<ul>
<li><p><span class="bb">AvailableFreeSpace</span>: объем доступного свободного места на диске в байтах</p></li>
<li><p><span class="bb">DriveFormat</span>: имя файловой системы диска</p></li>
<li><p><span class="bb">DriveType</span>: тип диска</p></li>
<li><p><span class="bb">IsReady</span>: готов ли диск (например, DVD-диск может быть не вставлен в дисковод)</p></li>
<li><p><span class="bb">Name</span>: имя диска</p></li>
<li><p><span class="bb">TotalFreeSpace</span>: общий объем свободного места на диске в байтах</p></li>
<li><p><span class="bb">TotalSize</span>: общий размер диска в байтах</p></li>
<li><p><span class="bb">VolumeLabel</span>: получает или устанавливает метку тома</p></li>
</ul>
<p>К примеру, выведем имена всех доступных дисков компьютера на консоль:</p>
<pre class="brush:vb;">
Imports System.IO
...
<img src="pics/5.1.png" alt="Получение жестких дисков в Visual Basic" />
...
<div class="nav"><p><a href="4.10.php">Назад</a><a href="./">Содержание</a><a href="5.2.php">Вперед</a></p></div></div>
<div class="socBlock">
