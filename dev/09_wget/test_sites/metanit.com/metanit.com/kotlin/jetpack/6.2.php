...
<html >
<head>
<title>Jetpack Compose | Ресурсы изображений и ImageBitmap</title>
<meta charset="utf-8" />
<meta name="description" content="Ресурсы изображений и ImageBitmap в Jetpack Compose на языке программирования Kotlin в Android, отображение изображения в Image">
...
<h2>Ресурсы изображений и ImageBitmap</h2><div class="date">Последнее обновление: 24.10.2021</div>
...
<p>Изображение, которое мы хотим отобразить в нашем приложении, может располагаться в различных местах - это может быть сетевой проект, но также изображение может храниться в самом приложении. 
Для хранения изображений в проекте предназначена папка <span class="b">res/drawable</span>:</p>
<img src="./pics/6.2.png" alt="drawable resorces in Jetpack Compose" />
<p>По умолчанию в этой папке уже имеется определения векторной графики в виде файлов <code>ic_launcher_background.xml</code> и 
<code>ic_launcher_foreground.xml</code>, которые применяются для создания иконок приложения.</p>
<p>Теперь добавим в эту папку какой-нибудь файл изображения. Для этого скопируем файл изображения с расширением png или jpg и с помощью стандартной комбинации клавиш Ctrl+V добавим его в папку 
<span class="b">res/drawable</span>. Также можно нажать на папку правой кнопкой мыши и в появившемся меню выбрать пункт <span class="b">Paste</span>:</p>
<img src="./pics/6.3.png" alt="ресурсы изображений drawable в Jetpack Compose и Android" />
<p>Далее нам будет предложено выбрать папку - <span class="b">drawable</span> или <span class="b">drawable-24</span>. 
Для добавления обычных файлов изображений выберем <span class="b">drawable</span>:</p>
<img src="./pics/6.4.png" alt="Добавление изображений в папку drawable в Jetpack Compose и Android" />
<p>При копировании файла нам будет предложено установить для него новое имя (по умолчанию подставляется текущее имя файла)</p>
<img src="./pics/6.5.png" alt="Добавление изображений в Android Studio в Jetpack Compose" />
<p>Можно изменить название файла, а можно оставить так как есть. В моем случае файл называется <span class="b">forest.png</span>. И затем нажмем на кнопку OK. И после этого в папку drawable будет добавлен выбранный нами файл изображения.</p>
<img src="./pics/6.6.png" alt="Изображения в Android Studio и Jetpack Compose" />
<p>При добавлении графических файлов в эту папку для каждого из них Android создает ресурс <span class="b">Drawable</span>. После этого мы можем обратиться к ресурсу следующим образом в коде Kotlin:</p>
<pre class="brush:kt;">R.drawable.имя_файла</pre>
<p>Для отображения растровых изображений, а именно файлов png и jpg, в компоненте Image применяется интерфейс <span class="b">ImageBitmap</span>. 
Этот интерфейс предоставляет статический метод <code>imageResource(идентификатор_ресурса)</code> для получения объекта ImageBitmap из ресурса drawable.</p>
<pre class="brush:kt;">
...
<img src="./pics/6.7.png" alt="Изображения в Image в Jetpack Compose и Kotlin в Android" />
<h3>BitmapPainter</h3>
<p>Также для выведения изображения можно использовать класс Painter, а точнее его класс-наследник <span class="b">BitmapPainter</span>, который отрисовывает изображение. Данное изображение передается в виде объекта ImageBitmap в конструктор 
<code>BitmapPainter</code> в качестве параметра:</p>
<pre class="brush:kt;">
package com.example.helloapp
