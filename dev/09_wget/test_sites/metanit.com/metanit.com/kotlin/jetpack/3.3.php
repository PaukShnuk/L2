...
<html >
<head>
<title>Jetpack Compose | Установка размеров</title>
<meta charset="utf-8" />
<meta name="description" content="Установка размеров компонентов с помощью модификаторов в Jetpack Compose и Kotlin и Android, функция Modifier.width, height, size, fullMaxSize, растяжение по всей длине, минимальная и максимальная ширина и длина">
...
<h2>Установка размеров</h2><div class="date">Последнее обновление: 27.09.2021</div>
...
<p>Для установки размеров компонентов в Jetpack Compose определен целый ряд модификаторов:</p>
<ul>
<li><p><span class="b">Modifier.height()</span>: устанавливает высоту</p></li>
<li><p><span class="b">Modifier.width()</span>: устанавливает ширину</p></li>
<li><p><span class="b">Modifier.fillMaxHeight()</span>: растягивает компонент по всей длине контейнера</p></li>
<li><p><span class="b">Modifier.heightIn()</span>: устанавливает минимальную и максимальную высоту</p></li>
<li><p><span class="b">Modifier.widthIn()</span>: устанавливает минимальную и максимальную ширину</p></li>
<li><p><span class="b">Modifier.size()</span>: устанавливает размер</p></li>
<li><p><span class="b">Modifier.sizeIn()</span>: устанавливает минимальный и максимальный размер</p></li>
</ul>
<p>Для установки применяются единицы <span class="b">dp</span> (device-independent pixels или независимые от устройства пиксели).</p>
<p>Например, установим для компонента Text высоту и ширину:</p>
<pre class="brush:kt;">
...
<p>Обратите внимание, как устанавливаются значения - после числа перед <code>dp</code> идет точка.</p>
<img src="./pics/3.4.png" alt="Установка высоты и ширины и Modifier.size в Jetpack Compose и Kotlin в Android" />
<p>С помощью модификатора <code>size()</code> можно объединить установку высоты и ширины:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<p>Если высота и ширина совпадают, то можно передать в функцию <code>size()</code> только одно общее значение. 
Например, установка ширины и высоты в 300 единиц:</p>
<pre class="brush:kt;">modifier = Modifier.background(color=Color.Yellow).size(300.dp)</pre>
<h3>Установка минимальных и максимальных размеров</h3>
<p>Модификаторы <code>heightIn()</code> и <code>widthIn()</code> принимают два значения - минимальные и максимальные значения. Например:</p>
<pre class="brush:kt;">
modifier = Modifier.background(color=Color.Yellow)
                    .widthIn(min = 100.dp, max = 400.dp)
                    .heightIn(min=50.dp, max=300.dp)
</pre>
<p>С помощью <code>sizeIn</code> можно сократить определение размеров:</p>
<pre class="brush:kt;">
modifier = Modifier.background(color=Color.Yellow)
                    .sizeIn(minWidth = 100.dp, maxWidth = 400.dp, minHeight= 50.dp, maxHeight= 300.dp)
</pre>
<h3>Растяжение по всей длине и ширине контейнера</h3>
<p>Отдельная группа модификаторов позволяет растянуть компонент по все длине и(или) ширине контейнера:</p>
<ul>
<li><p><span class="b">Modifier.fillMaxWidth()</span>: растягивает компонент по всей ширине контейнера</p></li>
<li><p><span class="b">Modifier.fillMaxHeight()</span>: растягивает компонент по всей высоте контейнера</p></li>
<li><p><span class="b">Modifier.fillMaxSize()</span>: растягивает компонент по всей длине и ширине контейнера</p></li>
</ul>
<p>Например, растянем компонент Text по всей ширине и длине контейнера:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<img src="./pics/3.5.png" alt="растяжение на весь экран и Modifier.fillMaxSize в Jetpack Compose и Kotlin в Android" />
<p>В качестве параметра модификаторы <code>Modifier.fillMaxWidth()</code>, <code>Modifier.fillMaxHeight()</code> и <code>Modifier.fillMaxSize()</code> 
принимают множитель, который устанавливает, какую часть от размеров контейнера займет компонент. Это значение имеет тип Float и находится в диапазоне от 0.0 до 1.0. Например:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<p>Переданное в функцию <code>fillMaxSize()</code> значение <code>0.5f</code> указывает, что компонент получит половину (или 0.5) от ширины и длины контейнера.</p>
<img src="./pics/3.6.png" alt="растяжение на всей длине и ширине контейнера и Modifier.fillMaxSize в Jetpack Compose и Kotlin в Android" />
