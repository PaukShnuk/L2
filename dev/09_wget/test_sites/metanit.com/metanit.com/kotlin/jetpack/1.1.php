...
<html >
<head>
<title>Jetpack Compose | Введение в Jetpack Compose</title>
<meta charset="utf-8" />
...
<h1>Введение в Jetpack Compose</h1><h2>Что такое Jetpack Compose</h2><div class="date">Последнее обновление: 22.09.2021</div>
...
которая применяется далее в дальнейших статьях данного руководства.</p>
...
Отличительной же чертой Jetpack Compose является то, что он предлагает кардинально другой подход к созданию приложений.</p>
...
Для этого можно обратиться к <a href="//metanit.com/kotlin/tutorial">руководству по языку Kotlin</a> на этом сайте.</p>
<p>Jetpack уменьшает объем кода.</p>
...
если ранее Android SDK еще не было установлено, то при первом обращении к Android Studio она сообщит, что Android SDK отсутствует.</p>
<img src="./pics/android_studio1.png" alt="Отсутствует Android SDK" />
<p>Мы можем отдельно вручную загрузить Android SDK с официального сайта и установить его. Либо мы можем сделать это непосредственно из Android Studio. 
Так, нажмем на кнопку <span class="b">Next</span>. И на следующем экране нам будет предложено загрузить Android SDK для последней версии API (в данном случае для Android 11):</p>
<img src="./pics/android_studio2.png" alt="Установка Android SDK" />
<p>Здесь же мы можем указать место для установки Android SDK, если путь по умолчанию нас не устраивает.</p>
<p>Нажмем на кнопку <span class="b">Next</span>, и далее нам отобразится окно со сводкой того, что именно будет установлено:</p>
