...
<html >
<head>
<title>Jetpack Compose | Ресурсы Color</title>
<meta charset="utf-8" />
<meta name="description" content="Ресурсы Color в Jetpack Compose на языке программирования Kotlin в Android, определение цветов в xml, функция colorResource">
...
<h2>Ресурсы Color</h2><div class="date">Последнее обновление: 25.10.2021</div>
...
<p>Ресурсы Color хранят определения цветов. Они должны храниться в проекте в каталоге <span class="b">res/values</span> и 
также, как и ресурсы строк, заключены в тег <code>&lt;resources&gt;</code>. Так, по умолчанию при создании самого простого проекта в 
папку <span class="b">res/values</span> добавляется файл <span class="b">colors.xml</span>:</p>
<img src="./pics/7.10.png" alt="Ресурсы Color в Android Studio в Kotlin и Jetpack Compose " />
<p>По умолчанию он имеет следующее определение:</p>
<pre class="brush:xml;">
...
<img src="./pics/7.11.png" alt="Использование цвета в Android Studio и Jetpack Compose и ресурсы color" />
...
<p>В файлах кода мы можем ссылаться на эти ресурсы через их идентификатор, который имеет следующий вид:</p>
<pre class="brush:kt;">R.color.название_ресурса</pre>
<p>Например, обращение к ресурсу <code>textViewBackColor</code>:</p>
<pre class="brush:kt;">R.color.textViewBackColor</pre>
<p>Чтобы получить ресурс color в коде Kotlin, применяется встроенная функция <span class="b">androidx.compose.ui.res. colorResource()</span>, в 
которую передается идентификатор ресурса и которая возвращает объект <span class="b">Color</span>.</p>
<p>Используем ресурсы Color в коде Kotlin:</p>
<pre class="brush:kt;">
...
<img src="./pics/7.12.png" alt="Ресурсы Color в Kotlin и Jetpack Compose и Android " />
...
<div class="nav"><p><a href="./7.2.php">Назад</a><a href="./">Содержание</a><a href="./6.1.php">Вперед</a></p></div></div>
<div class="socBlock">
