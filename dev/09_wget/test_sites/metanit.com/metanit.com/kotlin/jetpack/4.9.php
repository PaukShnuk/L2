...
<html >
<head>
<title>Jetpack Compose | FloatingActionButton и ExtendedFloatingActionButton</title>
<meta charset="utf-8" />
<meta name="description" content="Кнопки FloatingActionButton и ExtendedFloatingActionButton в Jetpack Compose на языке программирования Kotlin в Android, обработка нажатия иконок, настройка иконки и текста кнопок">
...
<h2>FloatingActionButton и ExtendedFloatingActionButton</h2><div class="date">Последнее обновление: 20.10.2021</div>
...
<p>Компонент <span class="b">FloatingActionButton</span> представляет кнопку, которая обычно располагается внизу экрана поверх основного содержимого 
и приглашает к некотором действию. Этот компонент имеет следующие параметры:</p>
<pre class="brush:kt;">
@Composable
...
<li><p><code>elevation</code>: объект типа <span class="b">FloatingActionButtonElevation</span>, который определяет анимацию при нажатии 
кнопки. По умолчанию равно <code>FloatingActionButtonDefaults.elevation()</code></p></li> 	
<li><p><code>shape</code>: объект типа <span class="b">Shape</span>, который устанавливает форму кнопки. По умолчанию равно <code>MaterialTheme.shapes.small.copy(CornerSize(percent = 50))</code></p></li> 
<li><p><code>backgroundColor</code>: фоновый цвет компонента. По умолчанию имеет значение <code>MaterialTheme.colors.secondary</code></p></li> 	
<li><p><code>contentColor</code>: цвет содержимого компонента. По умолчанию устанавливается функцией <code>contentColorFor(backgroundColor)</code>, которая устанавливает цвет в 
зависимости от фонового цвета</p></li> 	
...
<p>Определим простейший элемент FloatingActionButton:</p>
<pre class="brush:kt;">
...
<p>В данном случае кнопка никак не обрабатывает нажатия и просто отображает иконку <code>Icons.Filled.Add</code> из стандартного набора иконок.</p>
<img src="./pics/4.33.png" alt="FloatingActionButton в Jetpack Compose и Kotlin в Android" />
<p>Как и в обычных кнопках, мы можем обработать нажатия:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<h3>ExtendedFloatingActionButton</h3>
<p>Jetpack Compose также предоставляет похожий компонент, который по сути расширяет FloatingActionButton - компонент <span class="b">ExtendedFloatingActionButton</span>:</p>
<pre class="brush:kt;">
@Composable
...
<p>В отличие от FloatingActionButton вместо одного параметра <code>content</code> для установки содержимого применяются два параметра:</p>
<ul>
<li><p><code>text</code>: устанавливает текст кнопки</p></li> 	
<li><p><code>icon</code>: устанавливает иконку кнопку</p></li> 	
</ul>
...
<img src="./pics/4.34.png" alt="ExtendedFloatingActionButton в Jetpack Compose и Kotlin в Android" />
<p>Добавим обработку нажатия:</p>
<pre class="brush:kt;">
package com.example.helloapp
...
<p>В данном случае по нажатию изменяем текст и иконку кнопки:</p>
<img src="./pics/4.35.png" alt="нажатие на кнопку ExtendedFloatingActionButton в Jetpack Compose и Kotlin в Android" />
