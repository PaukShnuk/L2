...
<html >
<head>
<title>Jetpack Compose | Установка цвета</title>
<meta charset="utf-8" />
<meta name="description" content="Установка цвета с помощью модификаторов в Jetpack Compose и Kotlin и Android, функция Modifier.background, класс Color">
...
<h2>Установка цвета</h2><div class="date">Последнее обновление: 27.09.2021</div>
...
<p>Для установки фонового цвета применяется модификатор <span class="b">background()</span>. Есть две версии этой функции. Первая версия:</p>
<pre class="brush:kt;">
fun Modifier.background(color: Color, shape: Shape = RectangleShape): Modifier
</pre>
<ul>
<li><p><code>color</code>: значение цвета в виде объекта Color</p></li>
<li><p><code>shape</code>: закрашиваемая форма - объект <code>Shape</code>. По умолчанию это прямоугольная форма</p></li>
</ul>
<p>Вторя версия:</p>
<pre class="brush:kt;">
...
<ul>
<li><p><code>brush</code>: применяемая для покрытия цветом кисть в виде объекта <span class="b">Brush</span></p></li>
<li><p><code>shape</code>: закрашиваемая форма - объект <code>Shape</code>. По умолчанию это прямоугольная форма</p></li>
<li><p><code>alpha</code>: значение прозрачности. Оно должно находится в диапазоне от 0 (полностью прозрачно) до 1 (отсутствие прозрачности)</p></li>
</ul>
<p>В данном случае разберем только установку цвета.</p>
<h3>Color. Определение цвета</h3>
<p>В Jetpack Compose цвет представлен классом <span class="b">Color</span> из пакета <span class="b">androidx.compose.ui.graphics.</span>.</p>
<p>Есть несколько способов создания цвета. Рассмотрим некоторые:</p>
<ul>
<li><p><code>Color(value)</code>: в конструктор передается шестнадцатеричное значение цвета. Например</p>
<pre class="brush:kt;">val myColor: Color = Color(0xFF0000FF)</pre>
</li>
<li><p><code>Color(red, green, blue, alpha)</code>: в конструктор передается числовые значения для каждой отдельной компоненты цвета.</p>
<pre class="brush:kt;">val myColor: Color = Color(red = 0xFF, green = 0xFF, blue = 0xFF, alpha = 0xFF)</pre>
</li>
</ul>

<p>Например, зададим фоновый цвет для компонента Text:</p>
<pre class="brush:kt;">
...
<img src="./pics/3.3.png" alt="Установка цвета и Modifier.background в Jetpack Compose и Kotlin в Android" />
<p>Также есть ряд встроенных значений:</p>
<ul>
<li><p><code>Color.Black</code></p></li>
<li><p><code>Color.Blue</code></p></li>
<li><p><code>Color.Cyan</code></p></li>
<li><p><code>Color.DarkGray</code></p></li>
<li><p><code>Color.Gray</code></p></li>
<li><p><code>Color.Green</code></p></li>
<li><p><code>Color.LightGray</code></p></li>
<li><p><code>Color.Magenta	</code></p></li>
<li><p><code>Color.Red	</code></p></li>
<li><p><code>Color.Transparent</code></p></li>
<li><p><code>Color.White</code></p></li>
<li><p><code>Color.Yellow</code></p></li>
</ul>
