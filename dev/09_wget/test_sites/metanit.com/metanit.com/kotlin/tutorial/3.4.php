...
<html >
<head>
<title>Kotlin | Однострочные и локальные функции</title>
<meta charset="utf-8" />
<meta name="description" content="Однострочные функции в языке программирования Kotlin, локальные функции внутри других функций">
...
<h2>Однострочные и локальные функции</h2><div class="date">Последнее обновление: 25.05.2021</div>
...
<p>Однострочные функции (single expression function) используют сокращенный синтаксис определения функции в виде одного выражения. 
Эта форма позволяет опустить возвращаемый тип и оператор return.</p>
<pre class="brush:kt;">fun имя_функции (параметры_функции) = тело_функции</pre>
...
<pre class="brush:kt;">fun square(x: Int) : Int = x * x</pre>
