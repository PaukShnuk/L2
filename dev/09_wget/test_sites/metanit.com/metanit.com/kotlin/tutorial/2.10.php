...
<html >
<head>
<title>Kotlin | Консольный ввод и вывод</title>
<meta charset="utf-8" />
<meta name="description" content="Консольный ввод и вывод в языке программирования Kotlin, функции print, println и readLine">
...
<h2>Консольный ввод и вывод</h2><div class="date">Последнее обновление: 24.05.2021</div>
...
<p>Для вывода информации на консоль в Kotlin есть две встроенные функции:</p>
<pre class="brush:kt;">
print()
println()
</pre>
<p>Обе эти функции принимают некоторый объект, который надо вывести на консоль, обычно это строка. Различие между ними состоит в том, 
что функция <code>println()</code> при выводе на консоль добавляет перевод на новую строку:</p>
<pre class="brush:kt;">
fun main() {
...
<p>Причем функция <code>println()</code> необязательно должна принимать некоторое значения. Так, здесь применяется пустой вызов функции, который просто перевод консольный 
вывод на новую строку:</p>
<pre class="brush:kt;">println()</pre>
...
<p>Для ввода с консоли применяется встроенная функция <span class="b">readLine()</span>. Она возвращает введенную строку. Стоит отметить, что результат 
этой функции всегда представляет объект типа <span class="b">String</span>. Соответственно введеную строку мы можем передать в переменную типа <code>String</code>:</p>
<pre class="brush:kt;">
fun main() {
...
<p>Здесь сначала выводится приглашение к вводу данных. Далее введенное значение передается в переменную <code>name</code>. Результат работы программы:</p>
<div class="console">
<pre class="consoletext">
Введите имя: Евгений
Ваше имя: Евгений
...
<p>Подобным образом можно вводить разные данные:</p>
<pre class="brush:kt;">
fun main() {
