...
<html >
<head>
<title>Kotlin | Функции count, take и drop. Количество элементов в потоке</title>
<meta charset="utf-8" />
<meta name="description" content="Функция count объекта Flow, получение количества элементов в асинхронном потоке в Kotlin, ограничение количества объектов потока, функции take и drop">
...
<h2>Функции count, take и drop. Количество элементов в потоке</h2><div class="date">Последнее обновление: 28.06.2021</div>
