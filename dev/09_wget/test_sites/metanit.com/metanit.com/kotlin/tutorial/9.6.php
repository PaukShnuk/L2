...
<html >
<head>
<title>Kotlin | Преобразование данных. Функции map и transform</title>
<meta charset="utf-8" />
<meta name="description" content="Преобразование данных в потоке Flow в Kotlin, функции map и transform">
...
<h2>Преобразование данных. Функции map и transform</h2><div class="date">Последнее обновление: 28.06.2021</div>
...
<pre class="brush:kt;">person -&gt; person.name </pre>
...
<pre class="brush:kt;">collect { personName -&gt; println(personName) }</pre>
