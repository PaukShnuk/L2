...
<h2>Типы данных</h2><div class="date">Последнее обновление: 23.05.2021</div>
...
<p>Однако нельзя сначала объявить переменную бз указания типа, а потом где-то в программе присвоить ей какое-то значение:</p>
<pre class="brush:kt;">
...
<h3>Статическая типизация и тип Any</h3>
...
<p>Однако в Kotlin также есть тип <span class="b">Any</span>, который позволяет присвоить переменной данного типа 
любое значение:</p>
<pre class="brush:kt;">
fun main() {
...
<div class="nav"><p><a href="./2.1.php">Назад</a><a href="./">Содержание</a><a href="./2.10.php">Вперед</a></p></div></div>
<div class="socBlock">
