...
<html >
<head>
<title>Kotlin | Async, await и Deferred</title>
<meta charset="utf-8" />
<meta name="description" content="Создание корутины с помощью построителя корутин async в Kotlin, интерфейс Deferred и его методы, метод await и получение результата корутины, отложенное выполнение lazy">
...
<h2>Async, await и Deferred</h2><div class="date">Последнее обновление: 21.06.2021</div>
...
<pre class="brush:kt;">async{ getMessage()}</pre>
...
<pre class="brush:kt;">val message: Deferred&lt;String&gt; = async{ getMessage()}</pre>
...
<pre class="brush:kt;">val text: String = message.await()</pre>
...
<div class="nav"><p><a href="./8.3.php">Назад</a><a href="./">Содержание</a><a href="./8.7.php">Вперед</a></p></div></div>
<div class="socBlock">
