...
<html >
<head>
<title>Kotlin | Data-классы</title>
<meta charset="utf-8" />
<meta name="description" content="Data-классы в языке программирования Kotlin, реализация функций hashCode, toString, copy">
...
<h2>Data-классы</h2><div class="date">Последнее обновление: 29.05.2021</div>
...
<li><p><span class="b">copy()</span>: копирует данные объекта в другой объект</p></liv>
</ul>
...
<pre class="brush:kt;">data class Person(val name: String, val age: Int)</pre>
...
<pre class="brush:kt;">data class Person(var name: String, var age: Int)</pre>
...
<div class="nav"><p><a href="./4.7.php">Назад</a><a href="./">Содержание</a><a href="./4.13.php">Вперед</a></p></div></div>
<div class="socBlock">
