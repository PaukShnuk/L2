...
<html >
<head>
<title>Kotlin | Функции first, last, single</title>
<meta charset="utf-8" />
<meta name="description" content="Функции first, last, single объекта Flow, получение первого, последнего и единственного элемента в асинхронном потоке в Kotlin, функции firstOrNull, lastOrNull, singleOrNull">
...
<h2>Функции first, last, single</h2><div class="date">Последнее обновление: 23.06.2021</div>
