...
<h2>Первая программа на Kotlin в IntelliJ IDEA</h2><div class="date">Последнее обновление: 10.10.2021</div>
...
<p>Для разработки приложений на языке Kotlin можно использовать такую среду разработки как <span class="b">IntelliJ IDEA</span> от компании JetBrains. 
Загрузить ее можно по адресу <a href="https://www.jetbrains.com/idea/download/" rel="nofollow">https://www.jetbrains.com/idea/download/</a>. Данная среда 
...
В данном случае загрузим и установим бесплатный выпуск IntelliJ IDEA Community (если есть желание и соответствующие средства, то можно использовать и платный выпуск Ultimate).</p>
<h3>Установка IntelliJ IDEA</h3>
<p>Запустим программу установки:</p>
<img src="./pics/idea1.png" alt="Установка IntelliJ IDEA" />
<p>На приветственном окне нажмем на кнопку Next. Далее нам отобразится путь, по которому будет устанавливаться среда.</p>
<img src="./pics/idea2.png" alt="Путь к IntelliJ IDEA" />
<p>Можно оставить по умолчанию, а можно и изменить. И далее нажмем на кнопку Next.</p>
<p>Затем отобразится окно некоторых конфигурационных настроек, где можно, например, связать среду с типами файлов или настороить создание иконок среды на рабочем столе. 
Но в данном случае просто нажмем на кнопку Next:</p>
<img src="./pics/idea3.png" alt="Настройка конфигурации IntelliJ IDEA" />
<p>Далее откроется окно для выбора каталога в меню Пуск, где можно будет найти программу:</p>
<img src="./pics/idea4.png" alt="Выбор папки установки IntelliJ IDEA" />
<p>Оставим значение по умолчанию и нажмем на кноку Intall. И будет запущена установка</p>
<img src="./pics/idea5.png" alt="Install IntelliJ IDEA" />
<p>После окончания установки запустим среду. Для этого отметим на финальном окне пункт <code>Run IntelliJ IDEA Community Edition</code> и 
нажмем на кнопку Finish</p>
<img src="./pics/idea6.png" alt="Запуск IntelliJ IDEA" />
<h3>Создание проекта</h3>
<p>Запустим IntelliJ IDEA. Нам откроется стартовое окно программы:</p>
<img src="./pics/1.1.png" alt="Среда разработки IntelliJ IDEA Community Edition" />
<p>Выберем на нем пункт <span class="b">New Project</span>. После этого откроется окно выбора шаблона проекта и установки его настроек:</p>
<img src="./pics/1.2.png" alt="Создание проекта на Kotlin в IntelliJ IDEA" />
<p>IntelliJ IDEA предоставляет ряд типов проекто для создания приложения на языке Kotlin. Выберем самый простой тип. Итак, слева в окне создания проекта выберем <span class="b">Java</span>, а справа в качестве шаблона проекта выберем <span class="b">Kotlin/JVM</span>. То есть проект будет использовать JVM (виртуальную машину Java). 
Поэтому в верху окна в поле <span class="b">Project SDK:</span> установим используемую версию JDK. В данном случае нам надо установить каталог, где установлен 
JDK. И после этого нажмем кнопку <span class="b">Next</span>.</p>
<p>Затем появится окно установки имени проекта. Допустим, проект будет называться <span class="b">HelloKotlin</span>:</p>
<img src="./pics/1.3.png" alt="Создание проекта в IntelliJ IDEA" />
<p>После нажатия на кнопку Finish будет создан новый проект. По умолчанию проект не содержит никакого кода, он пуст. И поэтому добавим в него 
файл с кодом на языке Kotlin. Для этого нажмем правой кнопкой мыши на папку <span class="b">src</span> и в появившемся контекстном меню выберем 
<span class="b">New -&gt; Kotlin File/Class</span>:</p>
<img src="./pics/1.4.png" alt="Создание класса на языке Kotlin" />
<p>Далее назовем файл <span class="b">app</span>:</p>
<img src="./pics/1.5.png" alt="Первый класс на языке Kotlin" />
<p>И в папку <span class="ii">src</span> будет добавлен файл <span class="b">app.kt</span> (kt - расширение для файлов на языке Kotlin). По умолчанию 
этот файл открывается в центральной части IntelliJ IDEA. Но файл пуст. Поэтому добавим в него пакой-нибудь примитивный код:</p>
<pre class="brush:kt;">
fun main(){
...
<img src="./pics/1.6.png" alt="Первая программа на Kotlin" />
...
<img src="./pics/1.7.png" alt="Первая программа на Kotlin в IntelliJ IDEA" />
<p>После этого будет выполнено построение проекта, и скомпилированная программа будет запущена в консоли 
в IntelliJ IDEA:</p>
<img src="./pics/1.8.png" alt="Запуск программы на Kotlin в IntelliJ IDEA" />
...
<div class="nav"><p><a href="./1.1.php">Назад</a><a href="./">Содержание</a><a href="./2.9.php">Вперед</a></p></div></div>
<div class="socBlock">
