...
<html >
<head>
<title>Kotlin | Проверка элементов</title>
<meta charset="utf-8" />
<meta name="description" content="Проверка элементов коллекций и последовательностей Sequence и Iterable в языке программирования Kotlin на соответствие условию, функции all, any, none, contains, containsAll">
...
<h2>Проверка элементов</h2><div class="date">Последнее обновление: 24.01.2022</div>
...
<h3>Проверка соответствия элементов условию</h3>
<p>Отдельный вид операций позволяет проверить наличие элементов.</p>
<p>Функция <span class="b">all</span> проверяет, все ли элементы коллекции/последовательности соответствуют условию предиката:</p>
<pre class="brush:kt;">
all(predicate: (T) -&gt; Boolean): Boolean
</pre>
<p>Функция предиката получает каждый элемент и возвращает true, если элемент соответствует условию.</p>
<p>Функция <span class="b">any</span> проверяет, соответствует хотя бы один элемент коллекции/последовательности условию предиката:</p>
<pre class="brush:kt;">
any(predicate: (T) -&gt; Boolean): Boolean
</pre>
<p>Еще одна функция - <span class="b">none</span> возвращает true, если ни один из элементов НЕ соответствует условию предиката:</p>
<pre class="brush:kt;">
none(predicate: (T) -&gt; Boolean): Boolean
</pre>
<p>Проверка элементов на соответствие условию:</p>
<pre class="brush:kt;">
...
<p>Также функции <span class="b">any()</span> и <span class="b">none()</span> имеют версии без параметров. В этом случае функция 
<span class="b">any()</span> возвращает true, если коллекция/последовательность содержит хотя бы один элемент, а функция 
<span class="b">none()</span> возвращает true, если коллекция/последовательность пуста:</p>
<pre class="brush:kt;">
val people = listOf("Tom", "Kate", "Sam", "Alice", "Bob")
...
<p>Функция <span class="b">contains()</span> возвращает true, если в коллекции/последовательности есть определенный элемент:</p>
<pre class="brush:kt;">
val people = listOf("Tom", "Sam", "Kate", "Bob", "Alice")
println(people.contains("Sam"))     // true
println(people.contains("Bill"))     // false
</pre>
<p>Еще одна функция - <span class="b">containsAll()</span> возвращает true, если коллекция содержит все элементы другой коллекции:</p>
<pre class="brush:kt;">
val people = listOf("Tom", "Sam", "Kate", "Bob", "Alice")
