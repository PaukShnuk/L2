...
<html >
<head>
<title>Kotlin | Диапазоны</title>
<meta charset="utf-8" />
<meta name="description" content="Диапазоны в языке программирования Kotlin, функции downTo, step, until, перебор диапазона">
...
<h2>Диапазоны</h2><div class="date">Последнее обновление: 24.05.2021</div>
...
<p>Диапазон представляет набор значений или неокторый интервал. Для создания диапазона применяется оператор <span class="b">..</span>:</p>
<pre class="brush:kt;">
val range = 1..5	// диапазон [1, 2, 3, 4, 5]
</pre>
<p>Этот оператор принимает два значения - границы диапазона, и все элементы между этими значениями (включая их самих) составляют диапазон.</p>
<p>Диапазон необязательно должна представлять числовые данные. Например, это могут быть строки:</p>
<pre class="brush:kt;">
val range =  "a".."d"
</pre>
<p>Оператор <span class="b">..</span> позволяет создать диапазон по нарастающей, где каждый следующий элемент будет больше предыдущего. 
С помощью специальной функции <span class="b">downTo</span> можно построить диапазон в обратном порядке:</p>
<pre class="brush:kt;">
val range1 =  1..5		// 1 2 3 4 5
val range2 =  5 downTo 1	// 5 4 3 2 1
</pre>
<p>Еще одна специальная функция <span class="b">step</span> позволяет задать шаг, на который будут изменяться последующие элементы:</p>
<pre class="brush:kt;">
val range1 = 1..10 step 2       	// 1 3 5 7 9
val range2 = 10 downTo 1 step 3     // 10 7 4 1
</pre>
<p>Еще одна функция <span class="b">until</span> позволяет не включать верхнюю границу в диапазон:</p>
<pre class="brush:kt;">
val range1 = 1 until 9          // 1 2 3 4 5 6 7 8
val range2 = 1 until 9 step 2   // 1 3 5 7
</pre>
<p>С помощью специальных операторов можно проверить наличие или отсутствие элементов в диапазоне:</p>
<ul>
<li><p><span class="b">in</span>: возвращает true, если объект имеется в диапазоне</p></li>
<li><p><span class="b">!in</span>: возвращает true, если объект отсутствует в диапазоне</p></li>
</ul>
<pre class="brush:kt;">
fun main() {
...
<h3>Перебор диапазона</h3>
<p>С помощью цикла for можно перебирать диапазон:</p>
<pre class="brush:kt;">
