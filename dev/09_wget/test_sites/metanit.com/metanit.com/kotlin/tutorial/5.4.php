...
<html >
<head>
<title>Kotlin | Инфиксная нотация</title>
<meta charset="utf-8" />
<meta name="description" content="Инфиксная нотация в языке программирования Kotlin, оператор infix, инфиксные функции, их определение и использование">
...
<h2>Инфиксная нотация</h2><div class="date">Последнее обновление: 22.01.2022</div>
...
<p>Инфиксная нотация представляет помещение оператора или функции перед операндами или аргументами. Для определения инфиксной функции вначале ее определения указывается ключевое слово 
...
<pre class="brush:kt;">acc put 150</pre>
...
<pre class="brush:kt;">val lCount = hello wordCount 'l'</pre>
...
<div class="nav"><p><a href="./5.7.php">Назад</a><a href="./">Содержание</a><a href="./7.1.php">Вперед</a></p></div></div>
<div class="socBlock">
