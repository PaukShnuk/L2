...
<html >
<head>
<title>Kotlin | Лямбда-выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Лямбда-выражения в языке программирования Kotlin, передача параметров в лямбды и возвращение результата из лямбда-выражений">
...
<h2>Лямбда-выражения</h2><div class="date">Последнее обновление: 12.12.2021</div>
...
<pre class="brush:kt;">{println("hello")}</pre>
...
<pre class="brush:kt;">val hello: ()-&gt;Unit = {println("Hello Kotlin")}</pre>
...
<p>Здесь лямбда-выражение принимает один параметр типа String, значение которого выводится на консоль. Переменная <code>printer</code> в данном случае имеет тип <code>(String) -&gt; Unit</code>.</p></p>
...
<pre class="brush:kt;">doOperation(3, 4, {a, b -&gt; a * b}) // 12</pre>
...
<pre class="brush:kt;">else -&gt; return {x, y -&gt; 0 }</pre>
...
<pre class="brush:kt;">else -&gt; return {_, _ -&gt; 0 }</pre>
