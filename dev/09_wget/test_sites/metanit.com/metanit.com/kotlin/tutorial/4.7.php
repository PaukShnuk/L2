...
<html >
<head>
<title>Kotlin | Вложенные классы и интерфейсы</title>
<meta charset="utf-8" />
<meta name="description" content="Вложенные классы и интерфейсы в языке программирования Kotlin, nested class, inner class, доступ к свойствам и функциям внешнего класса">
...
<h2>Вложенные классы и интерфейсы</h2><div class="date">Последнее обновление: 29.05.2021</div>
...
<p>В Kotlin классы и интерфейсы могут быть определены в других классах и интерфейсах. Такие классы (вложенные классы или <span class="b">nested classes</span>) 
обычно выполняют какую-то вспомогательную роль, а определение их внутри класса или интерфейса
позволяет разместить их как можно ближе к тому месту, где они непосредственно используются.</p>
...
<p>В данном случае класс Account является вложенным, а класс Person{ - внешним.</p>
<p>По умолчанию вложенные классы имеют модификатор видимости public, то есть они видимы в любой части программы. Но для обращения к вложенному классу надо использовать 
имя внешнего класса. Например, создание объекта вложенного класса:</p>
<pre class="brush:kt;">
fun main() {
...
<h3>Внутренние (inner) классы</h3>
<p>Стоит учитывать, что вложенный (nested) класс по умолчанию не имеет доступа к свойствам и функциям внешнего класса. Например, в следующем случае при попытке 
обратиться к свойству внешнего класса мы получим ошибку:</p>
<pre class="brush:kt;">
...
<p>В данном случае у нас определен класс банковского счета BankAccount, который определяет свойство <code>sum</code> - сумма на счете и функцию <code>display()</code> для вывода информации о 
счете.</p>
<p>Кроме того, в классе BankAccount определен вложенный класс Transaction, который представляет операцию по счету. В данном случае класс Transaction 
определяет функцию <code>pay()</code> для оплаты со счета. Однако в нем мы не можем обратиться в свойствам и функциям внешнего класса BankAccount.</p>
<p>Чтобы вложенный класс мог иметь доступ к свойствам и функциям внешнего класса, необходимо определить вложенный класс с ключевым словом <span class="b">inner</span>. 
Такой класс еще называют внутренним классом (inner class), чтобы отличать от обычных вложенных классов. Например:</p>
<pre class="brush:kt;">
fun main() {
...
<p>Теперь класс Transaction определен с ключевым словом inner, поэтому имеет полный доступ к свойствам и функциям внешнего класса BankAccount. Но теперь если мы хотим использовать объект 
подобного вложенного класса, то необходимо создать объект внешнего класса:</p>
<pre class="brush:kt;">
val acc = BankAccount(3400);
    acc.Transaction().pay(2500)
</pre>
<h3>Совпадение имен</h3>
<p>Но что если свойства и функции внутреннего класса называются также, как и свойства и функции внешнего класса? В этом случае внутренний класс может обратиться к свойствам и функциям внешнего 
через конструкцию <code>this@название_класса.имя_свойства_или_функции</code>:</p>
<pre class="brush:kt;">
class A{
	private val n: Int = 1
	inner class B{
...
<p>Например, перепишем случай выше с классами Account и Transaction следующим образом:</p>
<pre class="brush:kt;">
fun main() {
...
<div class="nav"><p><a href="./4.8.php">Назад</a><a href="./">Содержание</a><a href="./4.12.php">Вперед</a></p></div></div>
<div class="socBlock">
