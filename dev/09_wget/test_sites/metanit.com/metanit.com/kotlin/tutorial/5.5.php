...
<html >
<head>
<title>Kotlin | Функции расширения</title>
<meta charset="utf-8" />
<meta name="description" content="Функции расширения (extension function) в языке программирования Kotlin, добавление функционала к уже существующим классом">
...
<h2>Функции расширения</h2><div class="date">Последнее обновление: 30.05.2021</div>
...
<p>Функции расширения (extension function) позволяют добавить функционал к уже определенным типам. При этом типы могут быть определены где-то в другом месте, например, в стандартной библиотеке.</p>
