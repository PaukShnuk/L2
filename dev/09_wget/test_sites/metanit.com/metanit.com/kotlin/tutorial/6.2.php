...
<html >
<head>
<title>Kotlin | Ограничения обобщений</title>
<meta charset="utf-8" />
<meta name="description" content="Generics в языке программирования Kotlin, ограничения обобщений - generic constraints">
...
<h2>Ограничения обобщений</h2><div class="date">Последнее обновление: 01.06.2021</div>
...
<pre class="brush:kt;">параметр_типа: ограничений</pre>
...
<pre class="brush:kt;">val outlook = Messenger&lt;EmailMessage&gt;()</pre>
<p>В качестве альтернативы можно было бы явным образом указать тип переменной:</p>
<pre class="brush:kt;">val outlook: Messenger&lt;EmailMessage&gt; = Messenger()</pre>
