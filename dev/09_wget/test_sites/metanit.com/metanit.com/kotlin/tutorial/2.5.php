...
<html >
<head>
<title>Kotlin | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования Kotlin, логические операции и операции отношения, тип Boolean, true, false">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 23.05.2021</div>
...
<p>Условные выражения представляют некоторое условие, которое возвращает значение типа <span class="b">Boolean</span>: либо 
<span class="b">true</span> (если условие истинно), либо <span class="b">false</span> (если условие ложно).</p>
<h3>Операции отношения</h3>
<ul>
<li><p><span class="b">&gt;</span> (больше чем): возвращает true, если первый операнд больше второго. Иначе возвращает false</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c : Boolean =  a &gt; b
...
<li><p><span class="b">&lt;</span> (меньше чем): возвращает true, если первый операнд меньше второго. Иначе возвращает false</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c =  a &lt; b	// true
...
<li><p><span class="b">&gt;=</span> (больше чем или равно): возвращает true, если первый операнд больше или равен второму</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c = a &gt;= b      // false
...
<li><p><span class="b">&lt;=</span> (меньше чем или равно): возвращает true, если первый операнд меньше или равен второму.</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c = a &lt;= b      // true
...
<li><p><span class="b">==</span> (равно): возвращает true, если оба операнда равны. Иначе возвращает false</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c = a == b		// false
...
<li><p><span class="b">!=</span> (не равно): возвращает true, если оба операнда НЕ равны</p>
<pre class="brush:kt;">
val a = 11
val b = 12
val c = a != b		// true
...
<p>Операндами в логических операциях являются два значения типа Boolean. Нередко логические операции объединяют несколько операций отношения:</p>
<ul>
<li><p><span class="b">and</span>: возвращает true, если оба операнда равны true.</p>
<pre class="brush:kt;">
val a = true
val b = false
val c = a and b      					// false
...
<li><p><span class="b">or</span>: возвращает true, если хотя бы один из операндов равен true.</p>
<pre class="brush:kt;">
val a = true
val b = false
val c = a or b      					// true
...
<li><p><span class="b">xor</span>: возвращает true, если только один из операндов равен true. Если операнды равны, возвращается false</p>
<pre class="brush:kt;">
val a = true
val b = false
val c = a xor b      			// true
...
<li><p><span class="b">!</span>: возвращает true, если операнд равен false. И, наоборот, если операнд равен true, возвращается false.</p>
<pre class="brush:kt;">
val a = true
val b = !a  // false
val c = !b  // true
</pre>
<p>В качестве альтернативы оператору ! можно использовать метод <span class="b">not()</span>:</p>
<pre class="brush:kt;">
val a = true
val b = a.not()  // false
val c = b.not()  // true
...
<li><p><span class="b">in</span>: возвращает true, если операнд имеется в некоторой последовательности.</p>
<pre class="brush:kt;">
val a = 5
...
<p>Выражение <code>1..6</code> создает последовательность чисел от 1 до 6. И в данном случае оператор in проверяет, есть ли значение 
переменной a в этой последовательности. Поскольку значение переменной a имеется в данной последовательности, то возвращается 
true.</p>
<p>А выражение <code>11..15</code> создает последовательность чисел от 11 до 15. И поскольку значение переменной с в эту последовательность 
не входит, поэтому возвращается false.</p>
<p>Если нам, наоборот, хочется возвращать <code>true</code>, если числа <span class="b">нет</span> в указанной последовательности, 
то можно применить комбинацию операторов <span class="b">!in</span>:</p>
<pre class="brush:kt;">
val a = 8
