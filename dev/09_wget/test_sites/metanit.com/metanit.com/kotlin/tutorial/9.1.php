...
<html >
<head>
<title>Kotlin | Введение в асинхронные потоки</title>
<meta charset="utf-8" />
<meta name="description" content="Введение в асинхронные потоки в Kotlin, Asynchronous Flow, функция flow, emit">
...
<h1>Асинхронные потоки</h1><h2>Введение в асинхронные потоки</h2><div class="date">Последнее обновление: 22.01.2022</div>
...
<pre class="brush:kt;">fun getUsers(): Flow&lt;String&gt;</pre>
...
<pre class="brush:kt;">emit(item) // передаем значение в поток</pre>
...
<pre class="brush:kt;">getUsers().collect { user -&gt; println(user) }</pre>
