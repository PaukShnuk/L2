...
<html >
<head>
<title>Kotlin | Анонимные классы и объекты</title>
<meta charset="utf-8" />
<meta name="description" content="Анонимные классы и объекты в языке программирования Kotlin, анонимный объект как аргумент и результат функции, анонимный класс и наследование">
...
<h2>Анонимные классы и объекты</h2><div class="date">Последнее обновление: 02.06.2021</div>
...
<p>Анонимные классы не используют ключевое слово <span class="b">class</span> для определения. Они не имеют имени, но как и обычные классы могут наслдовать другие классы или 
...
<p>После ключевого слова <span class="b">object</span> идет блок кода в фигурных скобках, в которые помещается определение объекта. Как и в обычном классе, анонимный объект может содержать 
свойства, функции. И далее по имени переменной мы можем обращаться к свойствам и функциям этого объекта.</p>
...
<div class="nav"><p><a href="./4.4.php">Назад</a><a href="./">Содержание</a><a href="./6.1.php">Вперед</a></p></div></div>
<div class="socBlock">
