...
<html >
<head>
<title>Kotlin | Фильтрация </title>
<meta charset="utf-8" />
<meta name="description" content="Фильтрация коллекций и последовательностей Sequence и Iterable в языке программирования Kotlin, функции filter, filterIndexed, filterNotNull">
...
<h2>Фильтрация</h2><div class="date">Последнее обновление: 24.01.2022</div>
...
<pre class="brush:kt;">filter(predicate: (T) -&gt; Boolean): List&lt;T&gt;/Map&lt;K, V&gt;/Sequence&lt;T&gt;</pre>
...
<pre class="brush:kt;">filterIndexed(predicate: (index: Int, T) -&gt; Boolean): List&lt;T&gt;</pre>
...
<pre class="brush:kt;">filterNotNull(): List&lt;T&gt;/Sequence&lt;T&gt;</pre>
<p>Например:</p>
<pre class="brush:kt;">
fun main(){
