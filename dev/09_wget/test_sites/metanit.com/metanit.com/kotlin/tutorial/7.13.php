...
<html >
<head>
<title>Kotlin | Сложение, вычитание и объединение коллекций</title>
<meta charset="utf-8" />
<meta name="description" content="Сложение, вычитание и объединение коллекций и последовательностей в языке Kotlin, функции plus, minus, zip">
...
<h2>Сложение, вычитание и объединение коллекций</h2><div class="date">Последнее обновление: 24.01.2022</div>
...
<p>С помощью функции <span class="b">plus</span> можно складывать коллекции/последовательности с другими элементами или коллекциями/последовательностями. 
Данная функция принимает как одиночный элемент, так и коллекцию/последовательность:</p>
<pre class="brush:kt;">
fun main(){
...
<p>Обратите внимание, что начальная коллекция, у которой вызывается функция <code>minus()</code> (в примере выше коллекция people), не изменяется, результатом объединения является новая коллекция.</p>
<p>Вместо функции <code>plus()</code> можно использовать оператор <span class="b">+</span></p>
<pre class="brush:kt;">
fun main(){
    val people = listOf("Tom", "Bob", "Sam")
...
<p>Аналогичным образом можно использовать функцию <span class="b">minus()</span> для вычитания либо одиночного объекта, либо коллекции/последовательности:</p>
<pre class="brush:kt;">
fun main(){
...
<p>Начальная коллекция, у которой вызывается функция <code>minus()</code>, также не изменяется, результатом вычитания является новая коллекция.</p>
<p>Вместо функции <code>minus()</code> можно использовать оператор <span class="b">-</span></p>
<pre class="brush:kt;">
val people = listOf("Tom", "Bob", "Sam", "Kate")
...
<h3>Объединение</h3>
<p>Для объединения двух разных коллекций/последовательностей в одну применяется функция <span class="b">zip()</span>:</p>
<pre class="brush:kt;">
zip(other: Iterable&lt;R&gt;/Sequence&lt;R&gt;): List&lt;Pair&lt;T, R&gt;&gt;/Sequence&lt;Pair&lt;T, R&gt;&gt;
</pre>
<p>В качестве параметра она принимает другую коллекцию/последовательность и возвращает набор из объектов типа <span class="b">Pair</span></p>
<p>Например, объединим два списка в один:</p>
<pre class="brush:kt;">
...
<p>Здесь каждому элементу из списка english сопоставляется элемент на соответствующей позиции из списка russian. Результатом функции будет 
список из объектов <code>Pair&lt;String, String&gt;</code>, где свойство <code>first</code> хранит значение из текущей коллекции, а свойство <code>second</code> 
- значение из коллекции, переданной в качестве параметра:</p>
<div class="console">
...
<p>Если в одной из коллекций меньше элементов, чем в другой, то сопоставляется столько элементов, сколько в наименьшей коллекции.</p>
<p>Функция <span class="b">zip()</span> имеет еще одну версию, которая в качестве второго параметра получает функцию преобразования, 
применяемую к элементам обоих коллекций/последовательностей:</p>
<pre class="brush:kt;">
...
<p>Также в Kotlin есть обратная функция -  <span class="b">unzip</span>, которая позволяет обратно получить две коллекции</p>
<pre class="brush:kt;">unzip(): Pair&lt;List&lt;T&gt;, List&lt;R&gt;&gt;</pre>
<p>Пример использования:</p>
<pre class="brush:kt;">
