...
<html >
<head>
<title>F# | Арифметические операции</title>
<meta charset="utf-8" />
<meta name="description" content="Арифметические операции в языке программирования F#, сложение, вычитание, умножение, деление, возведение в степень">
...
<h2>Арифметические операции</h2><div class="date">Последнее обновление: 20.07.2021</div>
...
<p>Язык F# имеет поддержку основных арифметических операций. Все арифметические операции в F# - бинарные, то есть выполняются над двумя числами. Рассмотрим все виды арифметических операций:</p>
<ul>
...
<pre class="brush:f#;">let z = 10 /  4; //результат равен 2</pre>
<p>Для выхода из этой ситуации необходимо определять литералы или переменные, участвующие в операции, именно как типы double/float/float32/decimal:</p>
<pre class="brush:f#;">let z = 10.0 /  4.0; //результат равен 2.5</pre>
</li>
...
<li><p><span class="b">**</span></p><p>Операция возведения числа в степень:</p>
<pre class="brush:f#;">
let x = 5.0
let z = x ** 3.0  // возводим число x (5) в степень 3	
printfn $"z = {z}"  // z = 125
</pre>
<p>Стоит отметить, что эта операция не поддерживает целые числа, поэтому в примере выше применяются числа с плавающей точкой</p>
</li>
</ul>
