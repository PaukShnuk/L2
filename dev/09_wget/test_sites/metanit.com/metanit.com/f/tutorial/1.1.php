...
<html >
<head>
<title>F# | Введение</title>
<meta charset="utf-8" />
<meta name="description" content="F# (F Sharp или Эф шарп) - это функциональный статически типизированный язык программирования общего пользования, который создан и развивается компанией Microsoft и который предназначен для широкого круга задач.">
...
<h1>Введение в F#</h1><h2>Что такое F#</h2><div class="date">Последнее обновление: 14.07.2021</div>
...
<p>F# (F Sharp или Эф шарп) - это функциональный статически типизированный язык программирования общего пользования, который создан и развивается компанией Microsoft и который предназначен для широкого круга задач.</p>
<p>Отличительной чертой F# является то, что он работает поверх платформы .NET и тем самым позволяет в 
...
выполнением этого приложения.</p>
<p>Кроме того, благодаря этому мы можем в проекте на F# использовать вспомогательные библиотеки, написанные с помощью других .NET-языков (например, 
на C# или VB.NET). Подобным образом мы можем на F# написать библиотеку и затем подключить ее в проекты на других .NET-языках.</p>

<p>F# кроссплатформенный, не привязанный к определенной операционной системе, на нем можно разрабатывать на Windows, MacOS и Linux.</p>
<p>F# - достаточно зрелый язык программирования. Его первая версия вышла в мае 2005 года. Последней версией на данный момент является F# 5.0, 
которая вышла в ноябре 2020 года вместе с .NET 5.0.</p>
<p>F# развивается как проект с открытым кодом, все его исходники можно найти в репозитории на github по адресу <a href="https://github.com/dotnet/fsharp" rel="nofollow">https://github.com/dotnet/fsharp</a>. 
Кроме собственно начального разработчика языка - компании Microsoft, язык также развивается некоммерческой организацией F# Software Foundation. 
Кроме того, активный вклад в развитие вносит сообщество.</p>
<p>Для разработки на F# необходимо установить .NET SDK. Для написания кода можно выбрать любой текстовый редактор, а компилировать приложения в консоли. Однако для упрощения разработки 
на Windows также можно использовать такую бесплатную среду разработки как <span class="b">Visual Studio</span> от Microsoft, которая имеет полноценную поддержку работы с данным языком и 
необходимые шаблоны проектов. Под MacOS есть бесплатный аналог - <span class="b">Visual Studio for Mac</span></p>
<p>В качестве альтернативы также можно выбрать другую - платную среду разработки - <span class="b">Rider</span> от компании JetBrains, которая также имеет поддержку F# и которая работает, как на Windows, так и на MacOS и Linux.</p>
<p>F# позволяет создавать самые разные приложения - простые консольные приложения, серверные веб-приложения, веб-сервисы, 
...
F# в код JavaScript и тем самым писать на F# браузерные (клиентские) веб-приложения.</p>
