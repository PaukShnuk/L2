...
<html >
<head>
<title>F# | Операции сравнения и логические операции</title>
<meta charset="utf-8" />
<meta name="description" content="Операции сравнения и логические операции в языке программирования F#, операторы &&, || и not">
...
<h2>Операции сравнения и логические операции</h2><div class="date">Последнее обновление: 20.07.2021</div>
...
<p>Отдельный набор операций представляет условные выражения. К подобным операциям относятся операции сравнения и логические операции. Такие операции возвращают логическое значение, то есть 
значение типа <span class="b">bool</span>: <span class="b">true</span>, если выражение истинно, и <span class="b">false</span>, если выражение ложно.</p>
<h3>Операции сравнения</h3>
<p>В операциях сравнения сравниваются два операнда и возвращается <span class="b">true</span>, если выражение верно, 
...
<p>Обратите внимание, что оператор равенства выглядит также, как и оператор присвоения значения.</p></li>
...
<p>Также в F# определены логические операторы, которые также возвращают значение типа <span class="b">bool</span>. В качестве операндов они 
принимают значения типа <span class="b">bool</span>. Как правило, они объединяют несколько операций сравнения.</p>
<ul>
<li><p><span class="b">||</span></p>
<p>Операция логического сложения. Возвращает <span class="b">true</span>, если хотя бы один из операндов возвращает <span class="b">true</span>.</p>
<pre class="brush:f#;">
...
<p>Оператор <span class="b">||</span> выполняется по укороченной схеме (short-circuit operator), то есть если первый операнд равен <code>true</code>, то оценивать второй операнд (вне зависимости равен он 
true или false) не имеет значения, поскольку в любом случае оператор <span class="b">||</span> в этом случае возвратит <code>true</code></p>
</li>
<li><p><span class="b">&amp;&amp;</span></p>
...
<p>Оператор <span class="b">&&</span> выполняется по укороченной схеме (short-circuit operator), то есть если первый операнд равен <code>false</code>, то оценивать второй операнд (вне зависимости равен он 
true или false) не имеет значения, поскольку в любом случае оператор <span class="b">&&</span> в этом случае возвратит <code>false</code></p>
</li>

<li><p><span class="b">not</span></p>
<p>Операция логического отрицания. Производится над одним операндом и возвращает <span class="b">true</span>, если операнд равен <span class="b">false</span>. 
Если операнд равен <span class="b">true</span>, то операция возвращает <span class="b">false</span>:</p>
<pre class="brush:f#;">
let x = true
let z = not x
printfn $"z = {z}"  // z = False
