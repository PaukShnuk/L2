...
<html >
<head>
<title>Rust | Ассоциированные функции</title>
<meta charset="utf-8" />
<meta name="description" content="Ассоциированные функции структур в языке программирования Rust, оператор impl и ::, статические методы">
...
<h2>Ассоциированные функции</h2><div class="date">Последнее обновление: 18.04.2021</div>
...
<p><span class="b">Ассоциированные функции</span> в отличие от методов относятся не к конкретному объекту структуры, а ко всей структуре в целом. В некоторых языках программирования 
есть похожая концепция - <span class="b">статические методы</span>. В Rust ассоциированные функции часто применяются для создания объекта структуры.</p>
<p>Ассоциированные функции, как и методы, определяются с помощью блока <span class="b">impl</span>:</p>
<pre class="brush:rs;">
impl структура {
	fn название_функции(){
...
<p>После оператора <span class="b">impl</span> указывается название структуры, к которой относится функция. Но в отличие от метода ассоциированная функция не принимает 
ссылку на текущий объект <code>self</code>, так как относится ко всей структуре, а не к отдельному объекту.</p>
<p>Для вызова ассоциированной функции применяется оператор <span class="b">::</span>:</p>
<pre class="brush:rs;">название_структуры::функция();</pre>
<p>После названия структуры идет оператор <span class="b">::</span>, а затем имя функции, после которой в скобках указываются значения для ее параметров.</p>
<p>Распространенным примером ассоциированной функции является встроенная функция <span class="b">String::from()</span>, которая принимает строковый слайс <code>&amp;str</code> и возвращает 
объект структуры <code>String</code>. Например:</p>
<pre class="brush:rs;">
fn main(){
...
<p>Теперь определим свою простейшую ассоциированную функцию, которая будет создавать объект структуры:</p>
<pre class="brush:rs;">
fn main(){
...
<p>Здесь для структуры Person определена ассоциированная функция <code>create()</code>, которая принимает два параметра - строку и число и по ним создает 
объект Person, который возвращается функцией.</p>
<p>В функции main с помощью данной функции создаем объект Person:</p>
<pre class="brush:rs;">let tom = Person::create("Tom", 36);</pre>
