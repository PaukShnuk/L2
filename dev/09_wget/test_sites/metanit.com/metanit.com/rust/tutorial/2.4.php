...
<html >
<head>
<title>Rust | Арифметические операции</title>
<meta charset="utf-8" />
<meta name="description" content="Арифметические операции в языке программирования Rust, сложение, вычитание, умножение, деление по модулю">
...
<h2>Арифметические операции</h2><div class="date">Последнее обновление: 04.04.2021</div>
...
<p>Rust поддерживает все базовые арифметические операции. Арифметические операции производятся над числами, а именно над значениями, 
которые представляют типы <code>i8, i16, i32, i64, i128, isize, u8, u16, u32, u64, u128, usize, f32, f64</code>.</p>
<p>Рассмотрим бинарные арифметические операции:</p>
<ul>
...
<p>Стоит отметить, что если оба операнда операции представляют целые числа, то при делении от дробного результата возвращается только целая часть:</p>
<pre class="brush:rs;">let number = 29 / 6;	// number = 4</pre>
</li>
<li><p><span class="b">%</span></p>
...
<p>Ряд операций сочетают арифметические операции и операцию присваивания (=):</p>
<ul>
<li><p><span class="b">+=</span></p>
<p>Присваивание после сложения. Присваивает левому операнду сумму левого и правого операндов: <span class="b">A += B</span> эквивалентно <span class="b">A = A + B</span>.</p>
<pre class="brush:rs;">
let mut number = 12;
number += 6;	// number = 18
</pre>
...
<li><p><span class="b">-=</span></p>
<p>Присваивание после вычитания. Присваивает левому операнду разность левого и правого операндов: <span class="b">A -= B</span> эквивалентно <span class="b">A = A - B</span>.</p>
<pre class="brush:rs;">
let mut number = 12;
number -= 6;	// number = 6
</pre>
...
<li><p><span class="b">*=</span></p>
<p>Присваивание после умножения. Присваивает левому операнду произведение левого и правого операндов: <span class="b">A *= B</span> эквивалентно <span class="b">A = A * B</span></p>
<pre class="brush:rs;">
let mut number = 12;
number *= 6;	// number = 72
</pre>
...
<li><p><span class="b">/=</span></p>
<p>Присваивание после деления. Присваивает левому операнду частное левого и правого операндов: <span class="b">A /= B</span> эквивалентно <span class="b">A = A / B</span></p>
<pre class="brush:rs;">
let mut number = 12;
number /= 6;	// number = 2
</pre>
...
<li><p><span class="b">%=</span></p>
<p>Присваивание после деления по модулю. Присваивает левому операнду остаток от целочисленного деления левого операнда на правый: <span class="b">A %= B</span> эквивалентно <span class="b">A = A % B</span></p>
<pre class="brush:rs;">
let mut number = 15;
number %= 6;	// number = 3
</pre>
