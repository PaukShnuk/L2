...
<html >
<head>
<title>Rust | Поразрядные операции</title>
<meta charset="utf-8" />
<meta name="description" content="Поразрядные операции в языке программирования Rust, операции сдвига и логические операции, логическое сложение и умножение, исключающее ИЛИ">
...
<h2>Поразрядные операции</h2><div class="date">Последнее обновление: 04.04.2021</div>
...
<p>Поразрядные операции выполняются над отдельными разрядами или битами чисел. Данные операции производятся только над целыми числами.</p>
<h3>Операции сдвига</h3>
<p>Каждое целое число в памяти представлено в виде определенного количества разрядов. И операции сдвига позволяют сдвинуть битовое представление числа на несколько разрядов вправо или влево. Операции сдвига применяются только к целочисленным операндам. 
Есть две операции:</p>
<ul>
<li>
<p><span class="b">&lt;&lt;</span></p>
<p>Сдвигает двоичное представление числа, представленного первым операндом, влево на определенное количество разрядов, которое задается вторым операндом.</p>
</li>
<li>
<p><span class="b">&gt;&gt;</span></p>
<p>Сдвигает двоичное представление числа вправо на определенное количество разрядов.</p>
</li>
</ul>
...
<p>Для более наглядного представления еще можно использовать двоичный формат чисел:</p>
<pre class="brush:rs;">
let a = 0b0010 &lt;&lt; 2;
let b = 0b10000 &gt;&gt; 3;
println!("a = {}  b= {}", a, b);
</pre>
<p>Еще два оператора сочетают операции присваивания и сдвига:</p>
<ul>
<li>
<p><span class="b">&lt;&lt;=</span></p>
<p>Присваивание после сдвига разрядов влево. Присваивает левому операнду результат сдвига его битового представления влево на 
определенное количество разрядов, равное значению правого операнда: <span class="b">A &lt;&lt;= B</span> эквивалентно <span class="b">A = A &lt;&lt; B</span></p>
</li>
<li>
<p><span class="b">&gt;&gt;=</span></p>
<p>Присваивание после сдвига разрядов вправо. Присваивает левому операнду результат сдвига его битового представления вправо на 
определенное количество разрядов, равное значению правого операнда: <span class="b">A &gt;&gt;= B</span> эквивалентно <span class="b">A = A &gt;&gt; B</span></p>
</li>
</ul>
...
<h3>Поразрядные логические операции</h3>
<p>Поразрядные логические операции также проводятся только над соответствующими разрядами целочисленных операндов:</p>
<ul>
...
<p>Опять же для большей наглядности можно использовать двоичный формат чисел:</p>
<pre class="brush:rs;">
let a = 0b101 | 0b010;
let b = 0b110 & 0b010;
let c = 0b101 ^ 0b010;
</pre>
<p>Еще ряд операций объединяет поразрядные логические операции и операции присваивания:</p>
<ul>
<li><p><span class="b">&amp;=</span>: присваивание после поразрядной конъюнкции. Присваивает левому операнду результат поразрядной 
конъюнкции его битового представления с двоичным представлением правого операнда: <span class="b">A &= B</span> эквивалентно <span class="b">A = A & B</span></p></li>
<li><p><span class="b">|=</span>: присваивание после поразрядной дизъюнкции. Присваивает левому операнду результат поразрядной 
дизъюнкции его битового представления с двоичным представлением правого операнда: <span class="b">A |= B</span> эквивалентно <span class="b">A = A | B</span></p></li>
<li><p><span class="b">^=</span>: присваивание после операции исключающего ИЛИ. Присваивает левому операнду результат операции 
исключающего ИЛИ его битового представления с двоичным представлением правого операнда: <span class="b">A ^= B</span> эквивалентно <span class="b">A = A ^ B</span></p></li>
</ul>
