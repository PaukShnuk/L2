...
<html >
<head>
<title>Rust | Условные выражения</title>
<meta charset="utf-8" />
<meta name="description" content="Условные выражения в языке программирования Rust, операции сравнения и логические операции">
...
<h2>Условные выражения</h2><div class="date">Последнее обновление: 04.04.2021</div>
...
<p>Условные выражения представляют собой некоторое условие и возвращают значение типа <span class="b">bool</span>: значение <span class="b">true</span> 
(если условие истинно), либо значение <span class="b">false</span> (если условие ложно). 
К условным выражениям относятся операции сравнения и логические операции.</p>
<h3>Операции сравнения</h3>
<p>Операции сравнения сравнивают два значения и в зависимости от результата сравнения возвращают true или false. 
В языке Rust имеются следующие операции сравнения:</p>
<ul>
<li>
...
<p>Логические операции обычно объединяют несколько операций сравнения. К логическим операциям относят следующие:</p>
<ul>
<li>
